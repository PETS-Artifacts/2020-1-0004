                ...
                <TR>
                	...
                	<TD>
                    	<DIV id="chat" style="height:22px;width:240px;overflow:hidden;">
                        	<DIV id="chat1">
							                        	        					                        	                        	                        	        					        						<DIV class="ico_contact ico_email" title="E-Mail" align="left"><A href="mailto:ray%40sun-usb.com?subject=Inquiry about Order ">ray@sun-usb.com</A></DIV>
                        		<DIV style="clear:both;"></DIV>
                        	</DIV>
                        	<DIV id="chat2"></DIV>
                    	</DIV>
