...
<!-- End Google Tag Manager (noscript) -->    <a class="sr-only" href="#content">Skip to main content</a>
        ...
        <div class="text-right toolbar-row row hidden-print">
          <div class="col-md-24 row-toolbar-col">
            <ul class="list-inline">
              <li><a class="toolbar-link" href="https://accounts.eclipse.org/user/login/?takemeback=http%3A%2F%2Fwww.eclipse.org%2Flegal%2Fprivacy.php"><i class="fa fa-sign-in"></i> Log in</a></li>
    ...
    <div class="row" id="header-row">
        ...
        <div class="wrapper-logo-default"><a href="http://www.eclipse.org/"><img class="logo-eclipse-default hidden-xs" alt="logo" width="160" src="//www.eclipse.org/eclipse.org-common/themes/solstice/public/images/logo/eclipse-foundation-white-orange.svg"/></a></div>
    ...
    <div class="navbar-header">
      ...
      <div class="wrapper-logo-mobile"><a class="navbar-brand visible-xs" href="http://www.eclipse.org/"><img class="logo-eclipse-default-mobile img-responsive" alt="logo" width="160" src="//www.eclipse.org/eclipse.org-common/themes/solstice/public/images/logo/eclipse-foundation-white-orange.svg"/></a></div>    </div>
  </div>
</div>
    </div>
  </div>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-sm-24"><ol class="breadcrumb"><li><a href="/">Home</a></li><li><a href="http://www.eclipse.org/legal">Legal</a></li><li class="active">Eclipse Foundation Website Privacy ...</li></ol></div>
        </div>
      </div>
    </section> <!-- /#breadcrumb -->
      <main>
...
<div id="rightcolumn" class="margin-top-20">
  ...
  <a class="visible-xs" href="#top">Back to the top</a>
    ...
    <div class="featured-footer featured-footer-newsletter background-secondary" style="background-image:url('https://www.eclipse.org/photon/public/images/photon-home-bg.jpg');">
      <div class="container">
        <div class="row">
          <div class="col-sm-24">
