  ...
  <div class="navbar yamm" id="main-menu">
    ...
    <section class="hidden-print default-breadcrumbs" id="breadcrumb">
      <div class="container">
        ...
        <div class="row">
          <div class="col-sm-16 padding-left-30"><ol class="breadcrumb"><li><a href="https://www.eclipse.org/">Home</a></li><li><a href="https://www.eclipse.org/legal">Legal</a></li><li class="active">Eclipse.org Privacy Policy</li></ol></div>
