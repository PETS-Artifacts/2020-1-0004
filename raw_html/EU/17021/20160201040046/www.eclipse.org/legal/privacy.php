...
<html lang="en">
  <head>
    ...
    <meta name="author" content="Mike Milinkovich, Nov. 22, 2005" />
      ...
      <div class="container">
        ...
        <div id="row-logo-search">
          <div id="header-left" class="col-sm-14 col-md-16 col-lg-19">
            <div class="row">
              <div class="hidden-xs">
                <a href="http://www.eclipse.org/"><img src="/eclipse.org-common/themes/solstice/public/images/logo/eclipse-426x100.png" alt="Eclipse.org logo" class="logo-eclipse-default"/></a>              </div>
        ...
        <h3 class="sr-only">Breadcrumbs</h3>
          <div class="col-xs-24">
            <ol class="breadcrumb"><li><a href="http://www.eclipse.org/">Home</a></li><li><a href="http://www.eclipse.org/legal">Legal</a></li><li class="active">Eclipse.org Privacy Policy</li></ol>          </div>
                    </div>
        </section>
