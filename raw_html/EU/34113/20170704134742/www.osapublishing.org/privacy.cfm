					...
					<div class="col-sm-6">
						<ul>
							<li class="nav-link-heading">Newly Published</li>
								...
								<li><a href="/conference.cfm?meetingid=154&yr=2017">Freeform Optics</a></li>
							
								<li><a href="/conference.cfm?meetingid=22&yr=2017">International Optical Design Conference</a></li>
							
								<li><a href="/conference.cfm?meetingid=30&yr=2017">Optical Fabrication and Testing</a></li>
							
								<li><a href="/conference.cfm?meetingid=177&yr=2017">3D Image Acquisition and Display: Technology, Perception and Applications</a></li>
							
								<li><a href="/conference.cfm?meetingid=104&yr=2017">Applied Industrial Optics: Spectroscopy, Imaging and Metrology</a></li>
...
<div class="modal fade" id="userLogin">
  <div class="modal-dialog login-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <div class="col-xs-12" style="text-align: left"><a href="https://auth.osa.org/connect/authorize?client_id=osap&response_type=id_token&scope=openid email profile affiliation&redirect_uri=https%3A%2F%2Fwww%2Eosapublishing%2Eorg%2Fdefault%2Ecfm&state=D8127F5D-E39D-455C-880B937C622D2267|https%3A%2F%2Fwww%2Eosapublishing%2Eorg%2Fprivacy%2Ecfm%3F&nonce=D8127F5D-E39D-455C-880B937C622D2267&acr_values=idp:cstnet&response_mode=form_post">CAoS Institutions (China) Login</a></div>
      </div>
      <div class="modal-footer">
