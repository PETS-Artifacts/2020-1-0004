					...
					<div class="col-sm-6">
						<ul>
							<li class="nav-link-heading">Newly Published</li>
								...
								<li><a href="/conference.cfm?meetingid=150&yr=2017">Photonic Networks and Devices</a></li>
							
								<li><a href="/conference.cfm?meetingid=35&yr=2017">Photonics in Switching</a></li>
				...
				<div class="row">
					...
					<div class="col-sm-6">
						<ul>
							...
							<li><a href="/osadigitalarchive.cfm">Digital Archive Products</a></li>
...
<div class="modal fade" id="userLogin">
  <div class="modal-dialog login-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <div class="col-xs-12" style="text-align: left"><a href="https://auth.osa.org/connect/authorize?client_id=osap&response_type=id_token&scope=openid email profile affiliation&redirect_uri=https%3A%2F%2Fwww%2Eosapublishing%2Eorg%2Fdefault%2Ecfm&state=AC71D60C-7809-41CF-AC77413818E765E9|https%3A%2F%2Fwww%2Eosapublishing%2Eorg%2Fprivacy%2Ecfm%3F&nonce=AC71D60C-7809-41CF-AC77413818E765E9&acr_values=idp:cstnet&response_mode=form_post">CAoS Institutions (China) Login</a></div>
      </div>
      <div class="modal-footer">
