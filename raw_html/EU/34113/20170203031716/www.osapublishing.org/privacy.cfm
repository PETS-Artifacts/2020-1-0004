...
<head>
  ...
  <link rel="stylesheet" href="/css/app.css?v=12082016">
					...
					<div class="col-sm-6">
						<ul>
							<li class="nav-link-heading">Newly Published</li>
								...
								<li><a href="/conference.cfm?meetingid=139&yr=2016">International Conference on Fibre Optics and Photonics</a></li>
							
								<li><a href="/conference.cfm?meetingid=40&yr=2016">Fourier Transform Spectroscopy</a></li>
							
								<li><a href="/conference.cfm?meetingid=44&yr=2016">Hyperspectral Imaging and Sounding of the Environment</a></li>
							
								<li><a href="/conference.cfm?meetingid=131&yr=2016">Optical Nanostructures and Advanced Materials for Photovoltaics</a></li>
							
								<li><a href="/conference.cfm?meetingid=174&yr=2016">Optics and Photonics for Energy and the Environment</a></li>
...
<div class="modal fade" id="userLogin">
  <div class="modal-dialog login-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <div class="col-xs-12" style="text-align: left"><a href="https://auth.osa.org/connect/authorize?client_id=osap&response_type=id_token&scope=openid email profile affiliation&redirect_uri=https%3A%2F%2Fwww%2Eosapublishing%2Eorg%2Fdefault%2Ecfm&state=E511B703-963E-44C4-9744906025A33723|https%3A%2F%2Fwww%2Eosapublishing%2Eorg%2Fprivacy%2Ecfm%3F&nonce=E511B703-963E-44C4-9744906025A33723&acr_values=idp:cstnet&response_mode=form_post">CAoS Institutions (China) Login</a></div>
      </div>
      <div class="modal-footer">
