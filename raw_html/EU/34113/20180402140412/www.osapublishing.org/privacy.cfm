					...
					<div class="col-sm-6">
						<ul>
							<li class="nav-link-heading">Newly Published</li>
								...
								<li><a href="/conference.cfm?meetingid=173&yr=2018">Optical Tomography and Spectroscopy</a></li>
							
								<li><a href="/conference.cfm?meetingid=163&yr=2018">Optics and the Brain</a></li>
							
								<li><a href="/conference.cfm?meetingid=175&yr=2018">Compact EUV & X-ray Light Sources</a></li>
...
<div class="modal fade" id="userLogin">
  <div class="modal-dialog login-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <div class="col-xs-12" style="text-align: left"><a href="https://auth.osa.org/connect/authorize?client_id=osap&response_type=id_token&scope=openid email profile affiliation&redirect_uri=https%3A%2F%2Fwww%2Eosapublishing%2Eorg%2Fdefault%2Ecfm&state=4302EC44-81DE-4122-A704C56AB6600F66|https%3A%2F%2Fwww%2Eosapublishing%2Eorg%2Fprivacy%2Ecfm%3F&nonce=4302EC44-81DE-4122-A704C56AB6600F66&acr_values=idp:cstnet&response_mode=form_post">CAoS Institutions (China) Login</a></div>
      </div>
      <div class="modal-footer">
