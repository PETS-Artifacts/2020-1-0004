...
<head>
  ...
  <link rel="stylesheet" href="/css/app.css?v=10162018">
					...
					<div class="col-sm-6">
						<ul>
							<li class="nav-link-heading">Newly Published</li>
								...
								<li><a href="/conference.cfm?meetingid=5&yr=2019">Optical Fiber Communication Conference</a></li>
							
								<li><a href="/conference.cfm?meetingid=117&yr=2018">Latin America Optics and Photonics Conference</a></li>
							
								<li><a href="/conference.cfm?meetingid=40&yr=2018">Fourier Transform Spectroscopy</a></li>
							
								<li><a href="/conference.cfm?meetingid=44&yr=2018">Hyperspectral Imaging and Sounding of the Environment</a></li>
							
								<li><a href="/conference.cfm?meetingid=174&yr=2018">Optics and Photonics for Energy and the Environment</a></li>
...
<p><strong>Date last modified: 24 May 2018</strong></p>

<p>The Optical Society and the OSA Foundation (collectively &ldquo;OSA&rdquo;) is committed to protecting your personal data.&nbsp; This notice outlines how we collect, share and use your personal data, and how you can exercise your privacy rights involving your data.</p>

<h4>Where We Collect Personal Data From</h4>

<p>OSA receives your personal data from these sources:</p>

<ul>
    <li>Websites (OSA owned or managed), including <a href="http://osa.org/">osa.org</a>, <a href="http://osapublishing.org/">osapublishing.org</a> and <a href="http://prism.osapublishing.org/">prism.osapublishing.org</a> where you create accounts to access products and services.</li>
    <li>Mobile applications; for example, a conference planner app.</li>
    <li>OSA-contracted vendors who provide a specific service related to the delivery of a product or service, including those for which you provide registration information such as, paper submissions, conference registrations, career searches, grant applications.</li>
    <li>Third-party individuals, including
    <ul>
        <li>Corresponding authors providing information about you as a co-author or potential reviewer</li>
        <li>Nominators submitting information about you as a nominee for an award or potential reference</li>
    </ul>
    </li>
    <li>OSA-contracted partners, including co-sponsors for meetings and peer societies.</li>
    <li>Your correspondence to us via mail, email or fax.</li>
</ul>

<h4>What Personal Data We Collect</h4>

<p>The personal data collected by OSA falls into these categories:</p>

<ul>
    <li>Identifying data, including name, ORCID ID and photo.</li>
    <li>Contact data, including email addresses, physical addresses and telephone numbers.</li>
    <li>Demographic data, including nationality, birth year, gender, dietary restrictions, family member names and emergency contact.</li>
    <li>Financial data, including transaction details about purchases you have made, and payments to and from you.</li>
    <li>Professional data, including CVs, technical and research interests, educational background, and employers.</li>
    <li>OSA-related activity data, including author and reviewer history, volunteer activities, customer service communications, and video interviews.</li>
    <li>Technical data, including internet protocol (IP) address, browser type and version, broad geographic location, device type, operating system and other technical information. We may also collect information about how your device has interacted with our websites, including the web pages accessed and links clicked on.</li>
</ul>

<h4>How We Use Personal Data</h4>

<p>OSA uses your personal data to:</p>

<ul>
    <li>Process and deliver a product or service you have ordered.
    <ul>
        <li>In some cases, this will require OSA to share your data with a third-party provider.&nbsp; In these cases, a contractual arrangement is in place to ensure the protection of the data and the minimal transfer of data necessary to complete the task that is shared. &nbsp;For example, accepted manuscripts &ndash; which include author contact information &ndash; are shared with our publishing vendors to prepare the article for publication.&nbsp;</li>
        <li>In other cases, OSA contracts with a partner to provide a product or service and data is shared with or received from the partner.&nbsp; For example, a co-sponsor of a meeting, a peer society that processes joint memberships, or a sister society that provides a member benefit (e.g., <em>Physics Today</em>).</li>
    </ul>
    </li>
    <li>Provide information to you about other relevant OSA programs and services based on your interests.</li>
    <li>Consider you for an award, grant or recognition.&nbsp; For example, membership and OSA-related activity data may be shared with the review committee along with the nomination/application materials.</li>
    <li>Include your information in our online directory.&nbsp;</li>
    <li>Improve your online experience.&nbsp; For example, we keep track of what&rsquo;s in your shopping cart or keep you logged in to our network as you read online journal content.</li>
    <li>Share conference registration lists with other attendees.</li>
    <li>Monitor OSA content and services to prevent potentially abusive activities.</li>
    <li>Share mailing addresses with OSA Industry members.</li>
    <li>Respond to a competent law enforcement body, regulatory, government agency, court or other third party where we believe disclosure is legally required; to exercise, establish or defend our legal rights; or to protect your vital interests or those of any person.</li>
</ul>

<p>In connection with any proposed purchase, merger or acquisition of any part of our business, your data may be sold or transferred as part of that transaction with the stipulation that the conditions of this privacy policy transfer with the data.</p>

<h4>Your Data Rights</h4>

<p>You may access the majority of the information that OSA maintains on you in our database in the My Account feature of our system (account.osa.org).&nbsp; Author and reviewing information is contained in OSA Publishing Digital Library and Prism. Questions or concerns about your data may be sent to <a href="mailto:custserv@osa.org">custserv@osa.org</a>.&nbsp; If you are an individual covered by European data protection rules and wish to exercise a specific data right, contact <a href="mailto:privacynotice@osa.org">privacynotice@osa.org</a>.</p>

<h4>Cookies and Other Tracking Technologies</h4>

<p>To enhance the performance and functionality of our site, we use session, persistent and third-party &ldquo;cookies&rdquo; that store a small text file on your computer and collect certain information about your visit to our site. We also use cookies to understand users&rsquo; browsing and buying activities so that we can measure the success of online advertising campaigns we run on the site. Our site may use web beacons, flash cookies and other tracking technologies (either directly or from our partners or service providers), along with cookies, to determine if a user has visited a particular webpage. These beacons help us to provide you more relevant information, as well to measure the success of a marketing campaign. To find out more information about cookies and other tracking technologies and to manage your preferences please see our <a href="/cookies.cfm">Cookie Notice</a>.</p>

<h4>Log Files</h4>

<p>Web site log files store information such as internet protocol (IP) addresses, browser type, internet service provider (ISP), referring/exit pages, platform type, date/time stamp, and number of clicks. Normally, an IP address will change each time you connect to the internet; in some cases, however, you may have a static address, and your IP address may be deemed identifiable.&nbsp; Log files are used to analyze trends, administer the site, track users&#39; movements within the site and gather broad demographic information for aggregate use. The log files are used by utility tracking software to analyze user movement.</p>

<h4>Transfer of Information to Other Countries</h4>

<p>OSA is a global organization headquartered in the United States but with activities, members, customers, vendors and consultants around the world.&nbsp; In the course of normal business, OSA may transfer information to other countries as necessary for us to provide our products and services.&nbsp; By submitting your information to OSA (electronically or in hard copy), you consent to such transfers and to the processing of this information in other countries.</p>

<h4>Modifications to this Notice</h4>

<p>OSA may modify, add or remove portions of this Privacy Notice at any time. Where such changes are material in nature, OSA will provide additional notice via email or notification on the Websites. The date of the last update is displayed at the top of this Privacy Notice.</p>

<h4>Contact Information</h4>

<p>If you have any questions or suggestions regarding this Privacy Notice, please contact OSA at:</p>

<p><strong>The Optical Society (OSA) </strong><br />
2010 Massachusetts Ave NW<br />
Washington, DC 20036<br />
+1.202.223.8130 Ph<br />
+1.202.223.1096 Fax<br />
email: <a href="mailto:privacynotice@osa.org">privacynotice@osa.org</a></p>
...
<div class="modal fade" id="userLogin">
  <div class="modal-dialog login-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <div class="col-xs-12" style="text-align: left"><a href="https://auth.osa.org/connect/authorize?client_id=osap&response_type=id_token token&scope=openid email profile affiliation&redirect_uri=https%3A%2F%2Fwww%2Eosapublishing%2Eorg%2Fdefault%2Ecfm&state=8A1061F9-3867-4E49-A091B71BB911599F|https%3A%2F%2Fwww%2Eosapublishing%2Eorg%2Fprivacy%2Ecfm%3F&nonce=8A1061F9-3867-4E49-A091B71BB911599F&acr_values=idp:cstnet&response_mode=form_post">CAoS Institutions (China) Login</a></div>
      </div>
      <div class="modal-footer">
