					...
					<div class="col-sm-6">
						<ul>
							<li class="nav-link-heading">Newly Published</li>
								...
								<li><a href="/conference.cfm?meetingid=56&yr=2018">Frontiers in Optics</a></li>
							
								<li><a href="/conference.cfm?meetingid=69&yr=2018">Laser Science</a></li>
...
<div class="modal fade" id="userLogin">
  <div class="modal-dialog login-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <div class="col-xs-12" style="text-align: left"><a href="https://auth.osa.org/connect/authorize?client_id=osap&response_type=id_token token&scope=openid email profile affiliation&redirect_uri=https%3A%2F%2Fwww%2Eosapublishing%2Eorg%2Fdefault%2Ecfm&state=3041EC82-42CA-4578-83C6AE2573A36D16|https%3A%2F%2Fwww%2Eosapublishing%2Eorg%2Fprivacy%2Ecfm%3F&nonce=3041EC82-42CA-4578-83C6AE2573A36D16&acr_values=idp:cstnet&response_mode=form_post">CAoS Institutions (China) Login</a></div>
      </div>
      <div class="modal-footer">
