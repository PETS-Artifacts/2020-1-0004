					...
					<div class="col-sm-6">
						<ul>
							<li class="nav-link-heading">Newly Published</li>
								...
								<li><a href="/conference.cfm?meetingid=175&yr=2016">Compact EUV & X-ray Light Sources</a></li>
							
								<li><a href="/conference.cfm?meetingid=119&yr=2016">High Intensity Lasers and High Field Phenomena</a></li>
							
								<li><a href="/conference.cfm?meetingid=152&yr=2016">Mid-Infrared Coherent Sources</a></li>
							
								<li><a href="/conference.cfm?meetingid=5&yr=2016">Optical Fiber Communication Conference</a></li>
							
								<li><a href="/conference.cfm?meetingid=144&yr=2015">Asia Communications and Photonics Conference</a></li>
...
<script type="text/javascript" src="/js/search/ApiClient.js"></script>
<script type="text/javascript" src="/js/search/Bus.js"></script>
<script type="text/javascript" src="/js/search/Config.js"></script>
<script type="text/javascript" src="/js/search/Constants.js"></script>
<script type="text/javascript" src="/js/search/Template.js"></script>
<script type="text/javascript" src="/js/search/Facet.js"></script>
    ...
    <li class="sr-item">
        ...
        <div class="sri-summary">
            ...
            <ul class="sri-details">
                ...
                <li class="sri-journal"><i class="<%= access%>"></i> <%= name %><strong>&nbsp; View: <%= htmlLinks %><%= pdfLinks %></strong><%= binaryText %></li>
