...
<link rel="stylesheet" type="text/css" media="all" href="https://www.drivethrurpg.com/themes/dtrpg/stylesheet.css.php?v=1525979262&site=">
<link rel="stylesheet" type="text/css" media="all" href="/themes/dtrpg/960_12_10_10.css" />
<link rel="stylesheet" type="text/css" media="all" href="https://www.drivethrurpg.com/includes/drivethru.css.php?v=1534351962&site=" />
...
<div class="site-tag-line">
    ...
    <a href="https://plus.google.com/105998655056511187373/posts " target="_blank" title="G+"><img src="https://www.drivethrurpg.com/shared_images/icon_gplus_hea.png"/></a>
</div>
            	<div id="actionswrapper" style="cursor: pointer">
...
<input id="field-form-time" name="field-form-time" class="form-parent-create_account form-hidden form-field-form-time" value="1538452192" type="hidden"  />
<input id="field-form-token" name="field-form-token" class="form-parent-create_account form-hidden form-field-form-token" value="771f2151f8b55265907dbb880a5b969f" type="hidden"  />
...
<input id="field-form-ajax-id" name="field-form-ajax-id" class="form-parent-create_account form-hidden form-field-form-ajax-id" value="" type="hidden"  />
			...
			<div class="last social-buttons-wrapper"><a href="https://www.facebook.com/v2.10/dialog/oauth?client_id=181736421874745&state=1510883c74574f43ff8660e8c7519721&response_type=code&sdk=php-sdk-5.6.1&redirect_uri=https%3A%2F%2Fwww.drivethrurpg.com%2Ffacebook%2Ffacebook_sign_up_action.php&scope=email%2Cpublic_profile%2Cuser_friends" class="site-button btn-facebook"><i class="fa fa-2x fa-facebook"></i>Log In with Facebook</a></div>
		</div>
			</div>
</div>
<script type="text/javascript">
...
<input id="field-form-time" name="field-form-time" class="form-parent-login form-hidden form-field-form-time" value="1538452192" type="hidden"  />
<input id="field-form-token" name="field-form-token" class="form-parent-login form-hidden form-field-form-token" value="e58d4431ff8be9699c5201d8c22896ea" type="hidden"  />
...
<input id="field-form-ajax-id" name="field-form-ajax-id" class="form-parent-login form-hidden form-field-form-ajax-id" value="" type="hidden"  />
			...
			<div id="login_failure_warning" style="display: none;">
				<span class="warning" >
					...
					<div class="popup-content standardText popup-content-right">
				<div class="last social-buttons-wrapper"><a href="https://www.facebook.com/v2.10/dialog/oauth?client_id=181736421874745&state=dd4091e01000d4db3f4b2b62ed8abba3&response_type=code&sdk=php-sdk-5.6.1&redirect_uri=https%3A%2F%2Fwww.drivethrurpg.com%2Ffacebook%2Ffacebook_sign_up_action.php&scope=email%2Cpublic_profile%2Cuser_friends" class="site-button btn-facebook"><i class="fa fa-2x fa-facebook"></i>Log In with Facebook</a></div>
			</div>
			</div>
...
<!-- footer_eof -->
<br />
<script type="text/javascript">window.NREUM||(NREUM={});NREUM.info={"beacon":"bam.nr-data.net","licenseKey":"29914f8841","applicationID":"1953057","transactionName":"ZgcGZEZWW0FSARJbVl9NMUJdGEVAWhQHUUAfEgxA","queueTime":0,"applicationTime":493,"atts":"SkAFEg5MSE8=","errorBeacon":"bam.nr-data.net","agent":""}</script></body>
</html>
