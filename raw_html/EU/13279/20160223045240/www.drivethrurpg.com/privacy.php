...
<input id="field-form-time" name="field-form-time" class="form-parent-create_account form-hidden form-field-form-time" value="1456203160" type="hidden"  />
<input id="field-form-token" name="field-form-token" class="form-parent-create_account form-hidden form-field-form-token" value="49c29aab820b6634b4202aae31b216d7" type="hidden"  />
...
<input id="field-form-time" name="field-form-time" class="form-parent-login form-hidden form-field-form-time" value="1456203160" type="hidden"  />
<input id="field-form-token" name="field-form-token" class="form-parent-login form-hidden form-field-form-token" value="5258ea0a3e114bad9958a5e047bcddaa" type="hidden"  />
...
<div class="grid" id="footer">
    <div class="grid_6 alpha linkswrapper">
        <div class="grid_3 alpha">
            ...
            <div class="widget-links-link">
                <a href="http://www.drivethrurpg.com/Troubleshooting.php" target="_blank">Troubleshooting</a>            </div>
            <div class="widget-links-link">
