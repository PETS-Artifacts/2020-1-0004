...
<link rel="stylesheet" type="text/css" media="all" href="/themes/dtrpg/drivethru.css.php?v=1485290545" />
...
<input id="field-form-time" name="field-form-time" class="form-parent-create_account form-hidden form-field-form-time" value="1490087568" type="hidden"  />
<input id="field-form-token" name="field-form-token" class="form-parent-create_account form-hidden form-field-form-token" value="63f31d4c56d0a53509272359ea17068f" type="hidden"  />
...
<input id="field-form-ajax-id" name="field-form-ajax-id" class="form-parent-create_account form-hidden form-field-form-ajax-id" value="" type="hidden"  />
			...
			<div class="last social-buttons-wrapper"><a href="https://www.facebook.com/v2.8/dialog/oauth?client_id=181736421874745&state=f1cfae5b356db530717eb2f7d1bc3ccc&response_type=code&sdk=php-sdk-5.4.0&redirect_uri=https%3A%2F%2Fwww.drivethrurpg.com%2Ffacebook%2Ffacebook_sign_up_action.php&scope=email%2Cpublic_profile%2Cuser_friends" class="site-button btn-facebook"><i class="fa fa-2x fa-facebook"></i>Log In with Facebook</a></div>
		</div>
			</div>
</div>
<script type="text/javascript">
...
<input id="field-form-time" name="field-form-time" class="form-parent-login form-hidden form-field-form-time" value="1490087568" type="hidden"  />
<input id="field-form-token" name="field-form-token" class="form-parent-login form-hidden form-field-form-token" value="13fac826fd97394907122d0da9004c71" type="hidden"  />
...
<input id="field-form-ajax-id" name="field-form-ajax-id" class="form-parent-login form-hidden form-field-form-ajax-id" value="" type="hidden"  />
			...
			<div id="login_failure_warning" style="display: none;">
				<span class="warning" >
					...
					<div class="popup-content standardText popup-content-right">
				<div class="last social-buttons-wrapper"><a href="https://www.facebook.com/v2.8/dialog/oauth?client_id=181736421874745&state=479487bd661c2b098eb7dde171d55bec&response_type=code&sdk=php-sdk-5.4.0&redirect_uri=https%3A%2F%2Fwww.drivethrurpg.com%2Ffacebook%2Ffacebook_sign_up_action.php&scope=email%2Cpublic_profile%2Cuser_friends" class="site-button btn-facebook"><i class="fa fa-2x fa-facebook"></i>Log In with Facebook</a></div>
			</div>
			</div>
