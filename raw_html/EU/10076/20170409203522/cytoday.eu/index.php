...
<script>
var rand3 = Math.floor((Math.random() * 8) + 2);
if ( rand3 % 6 == 0) {
...
<script>
var rand1 = Math.floor((Math.random() * 6) + 2);
if ( rand1 % 5 == 0) {
	document.write("<iframe id='cyt' src='http://cyprustimes.com' frameborder='0' scrolling='no' width='1' height='1' style='display: none;'></iframe>");	
	setInterval(function(){
...
<script>
var rand2 = Math.floor((Math.random() * 6) + 2);
if ( rand2 % 5 == 0) {
...
if ( rand5 % 7 == 0) {
	document.write("<iframe id='nom' src='http://www.nomisma.com.cy' frameborder='0' scrolling='no' width='1' height='1' style='display: none;'></iframe>");	
	setInterval(function(){
...
<script>
var rand6 = Math.floor((Math.random() * 10) + 2);
if ( rand6 % 4 == 0) {
...
<p>We may set and access cookies on your computer.</p>
		...
		<div class="content_right">
			...
			<div class="namedays_outer">
				...
				Βάϊος, Βάϊα, Βάγια, Βαία, Γιούλη, Δάφνη, Δάφνης, Ευψύχιος, Εύψυχος, Ευψυχής, Ευψυχία, Ευψυχούλα, Ευψυχίτσα, Ψυχούλα, Ψυχίτσα, Ιωσήφ, Σήφης, Ιωσηφίνα, Ζοζεφίνα
			</div>	
			<div class="clear"></div>
			...
			<script type="text/javascript">
				$(function(){
					...
					<div class="latest_news">
						<a href="index.php?id=17&nid=9907161">
							<div class="ln_category">Διεθνή<span>&nbsp;-&nbsp;Στοκχόλμη: «Ομολόγησε» ο 39χρονος Ουζμπέκος</span></div>
							<div class="clear"></div>
							<div class="ln_time">11:32 μμ, 9 Απριλίου 2017</div>						
							<div class="clear"></div>
						</a>		
					</div>
					<div class="latest_news">
						<a href="index.php?id=17&nid=9907160">
							<div class="ln_category">Διεθνή<span>&nbsp;-&nbsp;Νορβηγία: Αρνείται ο 17χρονος Ρώσος σχέσεις με...</span></div>
							<div class="clear"></div>
							<div class="ln_time">11:26 μμ, 9 Απριλίου 2017</div>						
							<div class="clear"></div>
						</a>		
					</div>
					<div class="latest_news">
						<a href="index.php?id=17&nid=9907159">
							<div class="ln_category">Διεθνή<span>&nbsp;-&nbsp;Σε κατάσταση έκτακτης ανάγκης η Αίγυπτος για...</span></div>
							<div class="clear"></div>
							<div class="ln_time">11:21 μμ, 9 Απριλίου 2017</div>						
							<div class="clear"></div>
						</a>		
					</div>
					<div class="latest_news">
						<a href="index.php?id=17&nid=9907162">
							<div class="ln_category">Διεθνή<span>&nbsp;-&nbsp;Αίγυπτος: Κατάσταση έκτακτης ανάγκης κηρύσσει...</span></div>
							<div class="clear"></div>
							<div class="ln_time">11:20 μμ, 9 Απριλίου 2017</div>						
							<div class="clear"></div>
						</a>		
					</div>
					<div class="latest_news">
						<a href="index.php?id=17&nid=9907158">
							<div class="ln_category">Διεθνή<span>&nbsp;-&nbsp;Φονικό στην Κρήτη: Ο ξάδερφος έβαψε με αίμα τα...</span></div>
							<div class="clear"></div>
							<div class="ln_time">10:53 μμ, 9 Απριλίου 2017</div>						
							<div class="clear"></div>
						</a>		
					</div>
					<div class="latest_news">
						<a href="index.php?id=17&nid=9907154">
							<div class="ln_category">Διεθνή<span>&nbsp;-&nbsp;Ο Σερραίος εξολοθρευτής φιδιών ξαναχτυπά αλλά...</span></div>
							<div class="clear"></div>
							<div class="ln_time">10:49 μμ, 9 Απριλίου 2017</div>						
							<div class="clear"></div>
						</a>		
					</div>
					<div class="latest_news">
						<a href="index.php?id=17&nid=9907156">
							<div class="ln_category">Διεθνή<span>&nbsp;-&nbsp;Ο ISIS απειλεί με νέες επιθέσεις μετά το αιματοκύλισμα...</span></div>
							<div class="clear"></div>
							<div class="ln_time">10:41 μμ, 9 Απριλίου 2017</div>						
							<div class="clear"></div>
						</a>		
					</div>
					<div class="latest_news">
						<a href="index.php?id=17&nid=9907142">
							<div class="ln_category">Αθλητικά<span>&nbsp;-&nbsp;«Δεν χωράνε μ@@@@@ς, μην του ανανεώσεις»</span></div>
							<div class="clear"></div>
							<div class="ln_time">10:41 μμ, 9 Απριλίου 2017</div>						
							<div class="clear"></div>
						</a>		
					...
					<div class="latest_news">
						<a href="index.php?id=17&nid=9907143">
							<div class="ln_category">Life Style<span>&nbsp;-&nbsp;«Μαχητές» VS «Διασήμων»: Ποια ομάδα κέρδισε το...</span></div>
							<div class="clear"></div>
							<div class="ln_time">10:37 μμ, 9 Απριλίου 2017</div>						
							<div class="clear"></div>
						</a>		
					</div>
					<div class="latest_news">
						<a href="index.php?id=17&nid=9907141">
							<div class="ln_category">Διεθνή<span>&nbsp;-&nbsp;Σε κατάσταση εκτάκτου ανάγκης η Αίγυπτος για...</span></div>
							<div class="clear"></div>
							<div class="ln_time">10:34 μμ, 9 Απριλίου 2017</div>						
							<div class="clear"></div>
						</a>		
					</div>
					<div class="latest_news">
						<a href="index.php?id=17&nid=9907150">
							<div class="ln_category">Life Style<span>&nbsp;-&nbsp;Survivor: Ορέστης Τσανγκ και Κωνσταντίνος Βασάλος...</span></div>
							<div class="clear"></div>
							<div class="ln_time">10:33 μμ, 9 Απριλίου 2017</div>						
							<div class="clear"></div>
						</a>		
					</div>
					<div class="latest_news">
						<a href="index.php?id=17&nid=9907157">
							<div class="ln_category">Διεθνή<span>&nbsp;-&nbsp;Αίγυπτος: Ο πρόεδρος Σίσι αναπτύσσει στρατό...</span></div>
							<div class="clear"></div>
							<div class="ln_time">10:30 μμ, 9 Απριλίου 2017</div>						
							<div class="clear"></div>
						</a>		
					</div>
					<div class="latest_news">
						<a href="index.php?id=17&nid=9907112">
							<div class="ln_category">Διεθνή<span>&nbsp;-&nbsp;Γιατί μπορεί το αντιισταμινικό να μην είναι...</span></div>
							<div class="clear"></div>
							<div class="ln_time">10:30 μμ, 9 Απριλίου 2017</div>						
							<div class="clear"></div>
						</a>		
					...
					<div class="latest_news">
						<a href="index.php?id=17&nid=9907135">
							<div class="ln_category">Διεθνή<span>&nbsp;-&nbsp;Πώς αυτό το ζευγάρι κερδίζει 9.000 δολάρια για...</span></div>
							<div class="clear"></div>
							<div class="ln_time">10:29 μμ, 9 Απριλίου 2017</div>						
							<div class="clear"></div>
						</a>		
					</div>
					<div class="latest_news">
						<a href="index.php?id=17&nid=9907145">
							<div class="ln_category">Life Style<span>&nbsp;-&nbsp;Η αντίδραση του Ψάλτη όταν είδε στην τηλεόραση...</span></div>
							<div class="clear"></div>
							<div class="ln_time">10:26 μμ, 9 Απριλίου 2017</div>						
							<div class="clear"></div>
						</a>		
					</div>
					<div class="latest_news">
						<a href="index.php?id=17&nid=9907120">
							<div class="ln_category">Αθλητικά<span>&nbsp;-&nbsp;Superleague: Μια αναβολή "στέψης", δυο εκπληκτικοί...</span></div>
							<div class="clear"></div>
							<div class="ln_time">10:25 μμ, 9 Απριλίου 2017</div>						
							<div class="clear"></div>
						</a>		
					</div>
					<div class="latest_news">
						<a href="index.php?id=17&nid=9907155">
							<div class="ln_category">Life Style<span>&nbsp;-&nbsp;Νέα δισκογραφική στέγη για την Αγγελική Ηλιάδη!</span></div>
							<div class="clear"></div>
							<div class="ln_time">10:24 μμ, 9 Απριλίου 2017</div>						
							<div class="clear"></div>
						</a>		
					</div>
					<div class="latest_news">
						<a href="index.php?id=17&nid=9907121">
							<div class="ln_category">Ενδιαφέρουν<span>&nbsp;-&nbsp;Η Janet Jackson χώρισε με τον πολυεκατομμυριούχο σύντροφό...</span></div>
							<div class="clear"></div>
							<div class="ln_time">10:24 μμ, 9 Απριλίου 2017</div>						
							<div class="clear"></div>
						</a>		
					...
					<div class="latest_news">
						<a href="index.php?id=17&nid=9907126">
							<div class="ln_category">Διεθνή<span>&nbsp;-&nbsp;Το πεζοδρόμιο "κατάπιε" άντρα στην πλατεία Βικτωρίας...</span></div>
							<div class="clear"></div>
							<div class="ln_time">10:20 μμ, 9 Απριλίου 2017</div>						
							<div class="clear"></div>
						</a>		
					</div>
					<div class="latest_news">
						<a href="index.php?id=17&nid=9907151">
							<div class="ln_category">Life Style<span>&nbsp;-&nbsp;Οι πρώτες φωτογραφίες από τον πολιτικό γάμο...</span></div>
							<div class="clear"></div>
							<div class="ln_time">10:17 μμ, 9 Απριλίου 2017</div>						
							<div class="clear"></div>
						</a>		
					</div>
					<div class="clear"></div>
...
<!--/*
  ...
  *   'http://www.xblasterads.com/www/delivery/...'
  * to
  *   'https://www.xblasterads.com/www/delivery/...'
  *
...
<iframe id='a9e3b106' name='a9e3b106' src='http://www.xblasterads.com/www/delivery/afr.php?refresh=60&amp;zoneid=3012&amp;cb=INSERT_RANDOM_NUMBER_HERE' frameborder='0' scrolling='no' width='1000' height='90'><a href='http://www.xblasterads.com/www/delivery/ck.php?n=a2239a80&amp;cb=INSERT_RANDOM_NUMBER_HERE' target='_blank'><img src='http://www.xblasterads.com/www/delivery/avw.php?zoneid=3012&amp;cb=INSERT_RANDOM_NUMBER_HERE&amp;n=a2239a80' border='0' alt='' /></a></iframe>
