    ...
    <div class="cc-container cc-float-fix ">
        ...
        <ul class="cc-top-menu cc-float-fix">
            <li class="hidden-xs">
                ...
                <a href="/quick-upload/">
                    <div class='cc-quick-upload-btn cc-fast-upload-button button-pure button-pure-orange' >
                        <i class="icon icon-cloud-upload"></i> Quick Upload                    </div>
                </a>
            </li>
            ...
            <div class="ff-bottom-follow-container cc-float-fix">
                <div class="ff-bottom-col">
                    ...
                    <div class="contact-email">
                        <a href="mailto:support@fliphtml5.com ">support@fliphtml5.com </a>
                    </div>
