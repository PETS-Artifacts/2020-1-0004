...
<link rel="icon" href="//fliphtml5.com/favicon.ico" type="image/x-icon" />
<script type="text/javascript" language="javascript" src="js/jquery-1.10.2.min.js"></script>

<meta http-equiv="X-UA-Compatible" content="IE=edge"><meta http-equiv="Content-Language" content="en" /><meta name="viewport" content="width=device-width, initial-scale=1"><link type="text/css" rel="stylesheet" href="/css/build/build.min.css"/>
</head>
...
<script type="text/javascript">
    var fh5 = {
        ...
        quickUploadLink: "/login.php?register"
            ...
            <div class="ff-bottom-web-container cc-float-fix">
                <div class="ff-bottom-col">
                    ...
                    <ul>
                        ...
                        <li>
                            <a href="//focusky.com/" target="_blank">Presentation Software</a>
                        </li>
                    </ul>
                </div>
                <div class="ff-bottom-col">
            ...
            <div class="ff-bottom-follow-container cc-float-fix">
                ...
                <div class="ff-bottom-col" style="margin-right: 0px; width: 200px;">
                    ...
                    <div class="ff-bottom-download-content">
                        ...
                        <a href="//fliphtml5.com/download/flip-html5.zip" onclick="ga('send', 'event', 'Download', this.href, document.location.pathname);" rel="nofollow">
                            <div class="ff-bottom-download-btn">
                                <i class="fa fa-download"></i><span>&nbsp;&nbsp;Download For Windows</span>
                            </div>
                        </a>
                        <a href="//fliphtml5.com/download/fliphtml5.zip" onclick="ga('send', 'event', 'Download', this.href, document.location.pathname);" rel="nofollow">
                            <div class="ff-bottom-download-btn">
    ...
    <div class="container bottom-top-container">
        <div class="row">
            ...
            <div class="col-md-3 col-sm-6 col-xs-10 col-xs-offset-2 col-sm-offset-0">
                ...
                <a class="window-download" href="//fliphtml5.com/download/flip-html5.zip" onclick=" if (typeof ga == 'function') { ga('send', 'event', 'Download', this.href, document.location.pathname); }" rel="nofollow"><span class="download-icon"></span>Download For Windows</a>
                <a class="mac-download" href="//fliphtml5.com/download/fliphtml5.zip" onclick=" if (typeof ga == 'function') { ga('send', 'event', 'Download', this.href, document.location.pathname); }" rel="nofollow"><span class="download-icon"></span>Download For Mac</a>
            </div>
        </div>
    </div>
...
//             new QrcodePanel("//fliphtml5.com", "FlipHTML5 for Mobile", "visit fliphtml5.com on mobile devices.");
//         });
