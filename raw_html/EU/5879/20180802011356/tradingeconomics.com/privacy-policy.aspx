...
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="rpffyzU4bV6F9l03KAeSG9NdPE9KCOFIG4zE9ECKaL22dRIav5EdehHnL58hvlKPaiyseKxOSpHREWI4Zdtu9uIIb9aWjVpg5CW2F4B6/1DndDGANIafSfprbSe3bNZvIhNhMDeg+vKMD/A2FQhQHtDWeHmR8CJZnqkiAhS0E3TlZWSu" />
</div>
            ...
            <ul class="nav navbar-nav">
               ...
               <li class="dropdown ">
                ...
                <ul class="dropdown-menu">
                 ...
                 <li id="ctl00_NavigationUC1_menuGuest" class="dropdown pull-right">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        <i class="glyphicon glyphicon-th-large" style="color: #ff6a00"></i>
                        <span class="hidden-sm hidden-md" style="color: #ff6a00">&nbsp;APPS<b class="caret hidden-sm"></b></span></a>
                    <div class="dropdown-menu list-group pull-right" style="min-width: 300px;">
                        
                        <a href="/analytics/features.aspx" class="list-group-item" target="_self">
                            <b class="list-group-item-heading"><i class="glyphicon glyphicon-floppy-disk"></i>&nbsp;DATA</b><br>
                            <span class="list-group-item-text">Download historical data for 20 million indicators using your browser.</span>
                        </a>

                        <a href="https://sso.tradingeconomics.com/?returnurl=https://tradingeconomics.com/privacy-policy.aspx" class="list-group-item" style="padding-top: 3px; padding-bottom: 3px;" target="_blank">Already a user? Login
                        </a>
...
<script>
    ...
    function downloadData(data, filename, format) {
        if (format == 'csv') {
            ...
            if (format == 'json') {
                var dataStr = "data:text/json;charset=utf-8," + encodeURI(JSON.stringify(data));
            } else {
                var dataStr = "data:text/plain;charset=utf-8," + new XMLSerializer().serializeToString(data.documentElement);
            }
...
<script>
    ...
    var feedback_uv = '<div style="float:top; box-shadow: rgba(255, 255, 255, 0.247059) 1px 1px 1px inset, rgba(0, 0, 0, 0.498039) 0px 0px 2px; font-style: normal; font-variant: normal; font-weight: bold; font-size: 14px; line-height: 1em; font-family: Arial, sans-serif; position: fixed; right: 0px; top: 35%; z-index: 9999; margin-top: 42px; background: 50% 0px no-repeat #E7E7E7;" class="uv-tab uv-slide-right ">'
    feedback_uv += '<a onClick="Feedback();return false;" style="background-color: transparent; display:block;padding:11px 12px 10px 6px;text-decoration:none;" href="javascript:return false;"><img src="https://d3fy651gv2fhd3.cloudfront.net/images/feedback-tab.png?t=Feedback&amp;c=00000&amp;r=-90" alt="Feedback" style="border:0; background-color: transparent; padding:0; margin:0;"></a>'
    feedback_uv += '</div>'
    $("body").append(feedback_uv)
    function Feedback() {
        var subject = window.location.pathname;
        if (subject.indexOf(":") > -1) subject += "%20market%20feedback";
        var redirectURL = "https://tradingeconomics.com/contact.aspx";
