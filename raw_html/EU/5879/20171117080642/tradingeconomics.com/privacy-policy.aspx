...
<script type="text/javascript">if(!window.console){console={}; console.log = function(){}; console.dir = function(){}; console.error = function(){};console.info = function(){};console.warn = function(){};}</script><link rel="canonical" href="https://tradingeconomics.com" /></head>
<body>
    <form method="post" action="privacy-policy.aspx" id="aspnetForm">
<div class="aspNetHidden">
<input type="hidden" name="__EVENTTARGET" id="__EVENTTARGET" value="" />
<input type="hidden" name="__EVENTARGUMENT" id="__EVENTARGUMENT" value="" />
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="/wEPDwUKMTg5NzEwMzU2MQ8WAh4TVmFsaWRhdGVSZXF1ZXN0TW9kZQIBFgJmD2QWAgIBD2QWAgIJDxYCHgdWaXNpYmxlaBYCAgMPDxYCHwFoZGRk" />
</div>
...
<script src="/WebResource.axd?d=pynGkmcFUV13He1Qd6_TZBMhXpY-76SACKbmnGHSZE-ofY595en_c0qcOkCvri7A5kw1ug2&amp;t=635207426953880130" type="text/javascript"></script>
...
<br />
    ...
    <div class="container">
        <div class="row">
            ...
            <br />
            <a href="https://itunes.apple.com/us/app/trading-economics/id1142178921?mt=8" style="display: inline-block; overflow: hidden; background: url(//linkmaker.itunes.apple.com/assets/shared/badges/en-us/appstore-lrg.svg) no-repeat; width: 135px; height: 40px; background-size: contain;"></a>
            </div>
...
<div class="container">
    ...
    <br />
    <span style="color: #E7E7EF">Copyright ©2017 TRADING ECONOMICS<br />
    ...
    function doSearch() {
        ...
        document.location.href = "https://tradingeconomics.com/search.aspx?q=" + query;
    } //$('#ImageChart').load
...
<div id="ctl00_js_ctl02_PanelProduction">
...
function TE_UpdateTable(d, isSnap) {
    ...
    if (p0 != d.p.toFixed(dec)) {
        ...
        fg = d.p > d.prev ? 'darkgreen' : d.p < d.prev ? 'darkred' : 'black';

        if (d.nch) {
            fg = d.nch > 0 ? 'darkgreen' : d.nch < 0 ? 'darkred' : 'black';
        }
        
        triangle = d.p > d.prev ? '<span class="market-positive-image"></span>' : d.p < d.prev ? '<span class="market-negative-image"></span>' : '<span class="market-neutral-image"></span>';
...
<script src="https://d3fy651gv2fhd3.cloudfront.net/scripts/search.js?v=20171022" type="text/javascript"></script>
