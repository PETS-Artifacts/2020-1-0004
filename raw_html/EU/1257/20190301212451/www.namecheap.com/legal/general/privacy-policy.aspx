...
;NREUM.info={beacon:"bam.nr-data.net",errorBeacon:"bam.nr-data.net",licenseKey:"177830d136",applicationID:"5867736",sa:1} </script>
	...
	<!-- CSS STARTS --><link rel="stylesheet" type="text/css" href="https://02.files.namecheap.com/cdn/612/assets/css/v612.global-style.min.css" nc:bundle="none" />


    <script type="text/javascript" src="https://01.files.namecheap.com/cdn/0/assets/js/jquery/1.8.3/v612.jquery.min.js"></script>
    <!--[if lt IE 9]>
        <script type="text/javascript" src="https://01.files.namecheap.com/cdn/0/assets/js/v612.html5shiv.js"></script>

        <script type="text/javascript" src="https://nc-img.com/assets/js/respond.min.js"></script>

	<![endif]-->
	<!--[if IE 9]>
        <script type="text/javascript" src="https://01.files.namecheap.com/cdn/0/assets/js/v612.media.match.min.js"></script>
	<![endif]-->
        
    
    
    <script src="https://ap.www.namecheap.com/siteservices/navigationscript?fromCMS=true&fromCMSIdentity=de2d2754-fb46-4aea-b039-1deb0fe81f13" async></script>
 ...
 <!-- from head -->
    ...
    <link rel="canonical" href="https://www.namecheap.com/legal/general/privacy-policy.aspx" /><meta name="Description" content="Namecheap.com privacy policy" />
<style type="text/css">
...
<div>
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="" />
</div>
...
<div>
	...
	<input type="hidden" name="__EVENTVALIDATION" id="__EVENTVALIDATION" value="0rd/j4Df/foy/0H1lOz3nh5d5vK3RLLPgMhf6YTJvqGP2ynAJmRl+8lgYCa0ALKk5uMkR5hjgPPCQ21tzyoQVDFvP3A8fPA/zzCV/s0/yHMdxeVt1DjEJQN95oZ5icQGkRXRMQ==" />
</div>
    ...
    <header id="header" class="group" role="banner" style="">
		<nav role="navigation">
			...
			<div class="logo"><a href="/"><img src="https://02.files.namecheap.com/cdn/612/assets/img/logos/namecheap.svg" id="ctl00_ctl00_ctl00_ctl00_base_content_web_base_content_nclogo" alt="Namecheap" /></a></div>
    ...
    <div class="panel">
        ...
        <li class="">
            <a href="/domains/domain-name-search/" 
        ...
        <li class="">
            <a href="/security/premiumdns/" rel="follow"
    ...
    <div class="panel">
        ...
        <li class="">
            <a href="/hosting/dedicated-servers/clearance-dedicated-servers/" rel="follow"
                onclick="if (typeof (LogGAEvent) === 'function') LogGAEvent('Hosting', 'click', 'clearance servers');">Clearance Servers
            </a>            
        </li>
        ...
        <li class="">
            <a href="/hosting/hosting-migrate-to-namecheap/" 
    ...
    <div class="panel">
        ...
        <li class="">
            <a href="/hosting/shared/" rel="follow"
    ...
    <div class="panel">
        ...
        <li class="">
            <a href="/security/totp-two-factor-authentication/" 
                onclick="if (typeof (LogGAEvent) === 'function') LogGAEvent('Security', 'click', 'totp 2fa');">TOTP 2FA
            </a>            
        </li>
					...
					<li class="expandable hidewhenloggedin sign-in-box">
						...
						<div class="panel">
                            ...
                            <fieldset>
					            ...
					            <a href="https://www.namecheap.com/myaccount/login/" id="ctl00_ctl00_ctl00_ctl00_base_content_web_base_content_topNavLoginLink" class="head-loginb ncRedirectButton btn sign-in-btn btn-block" rel="follow">Sign In</a>
...
<footer id="footer" >
	...
	<div class="grid-row">
		<div class="grid-col one-third">
			...
			<div class="logo"><a href="/"><img src="https://02.files.namecheap.com/cdn/612/assets/img/logos/namecheap-dkbg.png" id="ctl00_ctl00_ctl00_ctl00_base_content_web_base_content_footerControl_footerLogo" alt="Namecheap" /></a></div> 
...
<!-- SUBSCRIBE BUTTON ENDS-->
    ...
    <b class=""><a href="/hosting/" 
        ...
        <li class="">
            <a href="/hosting/dedicated-servers/clearance-dedicated-servers/" rel="follow"
                onclick="if (typeof (LogGAEvent) === 'function') LogGAEvent('Footer:Hosting', 'click', 'clearance servers');">Clearance Servers</a>
        </li>
    ...
    <b class="get-started f-weight"><a href="/security/whoisguard/" 
    ...
    <b class="get-started f-weight"><a href="/security/totp-two-factor-authentication/" 
        onclick="if (typeof (LogGAEvent) === 'function') LogGAEvent('Footer:TOTP 2FA', 'click', 'totp 2fa');">TOTP 2FA</a></b>
    ...
    <b class=""><a href="/security/ssl-certificates/" 
        ...
        <li class="">
            <a href="/security/ssl-certificates/comodo/" 
                onclick="if (typeof (LogGAEvent) === 'function') LogGAEvent('Footer:SSL Certificates', 'click', 'comodo');">Comodo</a>
        </li>
    
        <li class="">
            <a href="/security/ssl-certificates/organization-validation/" 
        ...
        <li class="">
            <a href="/security/ssl-certificates/domain-validation/" 
    ...
    <b class=""><a href="/resellers/ssl-certificates/join-the-program.aspx" rel="follow"
        ...
        <li class="">
            <a href="/hosting/reseller/" rel="follow"
    ...
    <div class="causes">
		<div>
			<b>We Support</b>
			<div class="img-eff"><img src="https://02.files.namecheap.com/cdn/612/assets/img/logos/eff.png" id="ctl00_ctl00_ctl00_ctl00_base_content_web_base_content_footerControl_effImage" alt="Electronic Frontier Foundation" /></div>
			<div class="img-fftf"><img src="https://02.files.namecheap.com/cdn/612/assets/img/logos/fftf.png" id="ctl00_ctl00_ctl00_ctl00_base_content_web_base_content_footerControl_fftfImage" alt="Fight For The Future" /></div>
		</div>
	</div>
		...
		<ul>
            <li>
                <a href="https://secure.comodo.com/ttb_searcher/trustlogo?v_querytype=W&v_shortname=SC5&v_search=https://www.namecheap.com/&x=6&y=5"
                    ...
                    <img src="https://02.files.namecheap.com/cdn/612/assets/img/logos/comodo_secure_seal_100x85_transp.png" id="ctl00_ctl00_ctl00_ctl00_base_content_web_base_content_footerControl_ComodoSecure" oncontextmenu="return false;" alt="Comodo Security Seal" style="border: none" />
                </a>
            </li>
            <li>
                <a href="https://nc1.app.link/W1qV0gjLZG" target="_blank" rel="" title="Android app on google play"><!--
                                --><img src="https://02.files.namecheap.com/cdn/612/assets/img/logos/googleplay.png" id="ctl00_ctl00_ctl00_ctl00_base_content_web_base_content_footerControl_GooglePlay" oncontextmenu="return false;" alt="Android app on google play" style="border: none" />
                </a>
            </li>

            <li>
                <a href="https://nc1.app.link/W1qV0gjLZG" target="_blank" rel="" title="iOS App Store"><!--
                                --><img src="https://02.files.namecheap.com/cdn/612/assets/img/logos/appstore.png" id="ctl00_ctl00_ctl00_ctl00_base_content_web_base_content_footerControl_iOSStore" oncontextmenu="return false;" alt="iOS App Store" style="border: none" />
                </a>
            </li>
    ...
    <script type="text/javascript" src="https://01.files.namecheap.com/cdn/0/assets/js/v612.global-script.min.js"></script>
