...
<!-- End Google Tag Manager -->
	...
	<!-- CSS STARTS --><link rel="stylesheet" type="text/css" href="https://02.files.namecheap.com/cdn/253/assets/css/v253.global-style.min.css" nc:bundle="none" />


    <script type="text/javascript" src="https://01.files.namecheap.com/cdn/0/assets/js/jquery/1.8.3/v253.jquery.min.js"></script>

    <!--[if lt IE 9]>
        <script type="text/javascript" src="https://01.files.namecheap.com/cdn/0/assets/js/v253.html5shiv.js"></script>
        <script type="text/javascript" src="https://01.files.namecheap.com/cdn/0/assets/js/v253.respond.min.js"></script>
	...
	<![endif]-->
	<!--[if IE 9]>
        <script type="text/javascript" src="https://01.files.namecheap.com/cdn/0/assets/js/v253.media.match.min.js"></script>
	<![endif]-->
...
<div>
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="" />
</div>
...
<div>
	...
	<input type="hidden" name="__EVENTVALIDATION" id="__EVENTVALIDATION" value="66shcAkewY8Sgo8BW/TGGnDFCWlKvsBCO9qiSjri+hvISj9WNUnufr/Sv3oCh1VZ5FEioCXKdNpyK2PVDUIaAPJ+glk9t2tCipns6lVCh/80Hqcnqo4JwDQiG+Pwka1K/4BaFA==" />
</div>
    ...
    <header id="header" class="group" role="banner" style="">
		<nav role="navigation">
			...
			<div class="logo"><a href="/"><img src="https://02.files.namecheap.com/cdn/253/assets/img/logos/namecheap.png" id="ctl00_ctl00_ctl00_ctl00_base_content_web_base_content_nclogo" alt="Namecheap" /></a></div>
...
<footer id="footer" >
	...
	<div class="grid-row">
		<div class="grid-col one-third">
			...
			<div class="logo"><a href="/"><img src="https://02.files.namecheap.com/cdn/253/assets/img/logos/namecheap-dkbg.png" id="ctl00_ctl00_ctl00_ctl00_base_content_web_base_content_footerControl_footerLogo" alt="Namecheap" /></a></div> 
...
<!-- SUBSCRIBE BUTTON ENDS-->
    ...
    <div class="causes">
		<div>
			<b>We Support</b>
			<div class="img-eff"><img src="https://02.files.namecheap.com/cdn/253/assets/img/logos/eff.png" id="ctl00_ctl00_ctl00_ctl00_base_content_web_base_content_footerControl_effImage" alt="Electronic Frontier Foundation" /></div>
			<div class="img-fftf"><img src="https://02.files.namecheap.com/cdn/253/assets/img/logos/fftf.png" id="ctl00_ctl00_ctl00_ctl00_base_content_web_base_content_footerControl_fftfImage" alt="Fight For The Future" /></div>
		</div>
	</div>
		...
		<ul>
            <li>
                <a href="https://secure.comodo.com/ttb_searcher/trustlogo?v_querytype=W&v_shortname=SC5&v_search=https://www.namecheap.com/&x=6&y=5"
                    ...
                    <img src="https://02.files.namecheap.com/cdn/253/assets/img/logos/comodo_secure_seal_100x85_transp.png" id="ctl00_ctl00_ctl00_ctl00_base_content_web_base_content_footerControl_ComodoSecure" oncontextmenu="return false;" alt="Comodo Security Seal" style="border: none" />
                </a>
            </li>
            <li>
                <a href="https://app.adjust.com/ohxkew" target="_blank" rel="" title="Android app on google play"><!--
                                --><img src="https://02.files.namecheap.com/cdn/253/assets/img/logos/googleplay.png" id="ctl00_ctl00_ctl00_ctl00_base_content_web_base_content_footerControl_GooglePlay" oncontextmenu="return false;" alt="Android app on google play" style="border: none" />
                </a>
            </li>

            <li>
                <a href="https://app.adjust.com/jnbcjz" target="_blank" rel="" title="iOS App Store"><!--
                                --><img src="https://02.files.namecheap.com/cdn/253/assets/img/logos/appstore.png" id="ctl00_ctl00_ctl00_ctl00_base_content_web_base_content_footerControl_iOSStore" oncontextmenu="return false;" alt="iOS App Store" style="border: none" />
                </a>
            </li>
    ...
    <script type="text/javascript" src="https://01.files.namecheap.com/cdn/0/assets/js/v253.global-script.min.js"></script>
