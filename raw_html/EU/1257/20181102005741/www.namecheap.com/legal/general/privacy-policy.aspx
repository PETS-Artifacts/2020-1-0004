...
<head>
    ...
    <script type="text/javascript"> window.userAllowedScripsProcessor=function(){function e(){var t,e,n,r=(t="OptanonConsent",(e=document.cookie.match(new RegExp("(^| )"+t+"=([^;]+)")))?decodeURIComponent(e[2]):void 0),a="groups=",i=[];return r?(r.split("&").some(function(t){return 0===t.trim().indexOf(a)&&(n=t.substring(a.length,t.length),!0)}),n&&n.split(",").forEach(function(t){var e=t.indexOf(":1");if(-1<e){var n=t.substring(0,e);i.push(n)}})):i=[1,2,3,4,101,102,103,104,105,106,107,108,109,110],i}return{activateUserAllowedScripts:function(){var t=e();t&&0<t.length&&t.forEach(function(t){var e=document.querySelectorAll("script.nc-cookie-category-"+t+"[type='text/plain']");e&&0<e.length&&e.forEach(function(t){var e=document.createElement("script");if(t.attributes)for(var n=0;n<t.attributes.length;n++){var r=t.attributes[n];e.setAttribute(r.name,r.value)}e.type="text/javascript",e.innerText=t.innerText,t.parentElement.appendChild(e),t.parentElement.removeChild(t)})})},addActiveGroupsToDataLayer:function(){window.dataLayer||(window.dataLayer=[]);var t=e();window.dataLayer.push({OnetrustActiveGroups:","+t.join(",")+","})}}}(); </script>
...
;NREUM.info={beacon:"bam.nr-data.net",errorBeacon:"bam.nr-data.net",licenseKey:"177830d136",applicationID:"5867736",sa:1} </script>
	...
	<!-- CSS STARTS --><link rel="stylesheet" type="text/css" href="https://02.files.namecheap.com/cdn/548/assets/css/v548.global-style.min.css" nc:bundle="none" />


    <script type="text/javascript" src="https://01.files.namecheap.com/cdn/0/assets/js/jquery/1.8.3/v548.jquery.min.js"></script>
    <!--[if lt IE 9]>
        <script type="text/javascript" src="https://01.files.namecheap.com/cdn/0/assets/js/v548.html5shiv.js"></script>

        <script type="text/javascript" src="https://nc-img.com/assets/js/respond.min.js"></script>

	<![endif]-->
	<!--[if IE 9]>
        <script type="text/javascript" src="https://01.files.namecheap.com/cdn/0/assets/js/v548.media.match.min.js"></script>
	<![endif]-->
        
    
    
    <script src="https://ap.www.namecheap.com/siteservices/navigationscript?fromCMS=true&fromCMSIdentity=f5bab6ff-84cb-44a3-b93a-0704a512877b" async></script>
...
<div>
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="" />
</div>
...
<div>
	...
	<input type="hidden" name="__EVENTVALIDATION" id="__EVENTVALIDATION" value="ZKLC6XNoL7ncVm9ptb/BLnHI5ZpbAHl1ESK/+quAyhsqyukO1hC1YTao5gGxixlzZccStMOibg1AfvXhBcOHN9Uyg5R6nwcn/NJd7gozFjU5cYOkgBswmWFDrkFahmZTrJQzJQ==" />
</div>
    ...
    <header id="header" class="group" role="banner" style="">
		<nav role="navigation">
			...
			<div class="logo"><a href="/"><img src="https://02.files.namecheap.com/cdn/548/assets/img/logos/namecheap-black.png" id="ctl00_ctl00_ctl00_ctl00_base_content_web_base_content_nclogo" alt="Namecheap" /></a></div>
    ...
    <div class="panel">
        ...
        <li class="">
            <a href="/domains/whois.aspx" 
                onclick="if (typeof (LogGAEvent) === 'function') LogGAEvent('Domains', 'click', 'whois');">Whois
            </a>            
        </li>
...
<footer id="footer" >
	...
	<div class="grid-row">
		<div class="grid-col one-third">
			...
			<div class="logo"><a href="/"><img src="https://02.files.namecheap.com/cdn/548/assets/img/logos/namecheap-dkbg.png" id="ctl00_ctl00_ctl00_ctl00_base_content_web_base_content_footerControl_footerLogo" alt="Namecheap" /></a></div> 
...
<!-- SUBSCRIBE BUTTON ENDS-->
    ...
    <b class="get-started"><a href="/vpn/" rel="follow"
    ...
    <div class="causes">
		<div>
			<b>We Support</b>
			<div class="img-eff"><img src="https://02.files.namecheap.com/cdn/548/assets/img/logos/eff.png" id="ctl00_ctl00_ctl00_ctl00_base_content_web_base_content_footerControl_effImage" alt="Electronic Frontier Foundation" /></div>
			<div class="img-fftf"><img src="https://02.files.namecheap.com/cdn/548/assets/img/logos/fftf.png" id="ctl00_ctl00_ctl00_ctl00_base_content_web_base_content_footerControl_fftfImage" alt="Fight For The Future" /></div>
		</div>
	</div>
		...
		<ul>
            <li>
                <a href="https://secure.comodo.com/ttb_searcher/trustlogo?v_querytype=W&v_shortname=SC5&v_search=https://www.namecheap.com/&x=6&y=5"
                    ...
                    <img src="https://02.files.namecheap.com/cdn/548/assets/img/logos/comodo_secure_seal_100x85_transp.png" id="ctl00_ctl00_ctl00_ctl00_base_content_web_base_content_footerControl_ComodoSecure" oncontextmenu="return false;" alt="Comodo Security Seal" style="border: none" />
                </a>
            </li>
            <li>
                <a href="https://nc1.app.link/W1qV0gjLZG" target="_blank" rel="" title="Android app on google play"><!--
                                --><img src="https://02.files.namecheap.com/cdn/548/assets/img/logos/googleplay.png" id="ctl00_ctl00_ctl00_ctl00_base_content_web_base_content_footerControl_GooglePlay" oncontextmenu="return false;" alt="Android app on google play" style="border: none" />
                </a>
            </li>

            <li>
                <a href="https://nc1.app.link/W1qV0gjLZG" target="_blank" rel="" title="iOS App Store"><!--
                                --><img src="https://02.files.namecheap.com/cdn/548/assets/img/logos/appstore.png" id="ctl00_ctl00_ctl00_ctl00_base_content_web_base_content_footerControl_iOSStore" oncontextmenu="return false;" alt="iOS App Store" style="border: none" />
                </a>
            </li>
    ...
    <script type="text/javascript" src="https://01.files.namecheap.com/cdn/0/assets/js/v548.global-script.min.js"></script>
