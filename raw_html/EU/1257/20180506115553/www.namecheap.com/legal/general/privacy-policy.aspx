...
<!-- End Google Tag Manager -->
	...
	<!-- CSS STARTS --><link rel="stylesheet" type="text/css" href="https://02.files.namecheap.com/cdn/437/assets/css/v437.global-style.min.css" nc:bundle="none" />


    <script type="text/javascript" src="https://01.files.namecheap.com/cdn/0/assets/js/jquery/1.8.3/v437.jquery.min.js"></script>
    <!--[if lt IE 9]>
        <script type="text/javascript" src="https://01.files.namecheap.com/cdn/0/assets/js/v437.html5shiv.js"></script>

        <script type="text/javascript" src="https://nc-img.com/assets/js/respond.min.js"></script>

	<![endif]-->
	<!--[if IE 9]>
        <script type="text/javascript" src="https://01.files.namecheap.com/cdn/0/assets/js/v437.media.match.min.js"></script>
	<![endif]-->
        
    
    
    <script src="https://ap.www.namecheap.com/siteservices/navigationscript?fromCMS=true&fromCMSIdentity=4c20e779-21c5-4c75-a873-9a6f46dfc80c" async></script>
...
<div>
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="" />
</div>
...
<div>
	...
	<input type="hidden" name="__EVENTVALIDATION" id="__EVENTVALIDATION" value="Um32Io24227xBcWHAEM48GlPx46h/34dqNTFz3p7wgBs/IK92roFCoKds5nMxQ7UxR4lHzFzm0jvqtpdlgmX94fi8AjHK0DV0eYiCyybo0CTJWxOFbYh7ZABCCNtaxb3/ps7qg==" />
</div>
    ...
    <header id="header" class="group" role="banner" style="">
		<nav role="navigation">
			...
			<div class="logo"><a href="/"><img src="https://02.files.namecheap.com/cdn/437/assets/img/logos/namecheap.png" id="ctl00_ctl00_ctl00_ctl00_base_content_web_base_content_nclogo" alt="Namecheap" /></a></div>
    ...
    <div class="panel">
        ...
        <li class="">
            <a href="/domains/domain-name-search.aspx" 
                onclick="if (typeof (LogGAEvent) === 'function') LogGAEvent('Domains', 'click', 'domain name search');">
                Domain Name Search
        ...
        <li class="">
            <a href="/domains/new-tlds/explore.aspx" rel="follow"
        ...
        <li class="">
            <a href="/domains/marketplace/buy-domains.aspx" rel="follow"
    ...
    <div class="panel">
        ...
        <li class="">
            <a href="/hosting/wordpress-hosting/" 
                onclick="if (typeof (LogGAEvent) === 'function') LogGAEvent('Hosting', 'click', 'wordpress hosting');">
                WordPress Hosting
    ...
    <li class="expandable ">
    <a href="/online-marketing/business-promoter-small-business/" rel="follow"
        onclick="if (typeof (LogGAEvent) === 'function') LogGAEvent('Online Marketing', 'click', 'online marketing');">
        Online Marketing
    ...
    <div class="panel">
        ...
        <li class="">
            <a href="/online-marketing/business-promoter-small-business/" 
                onclick="if (typeof (LogGAEvent) === 'function') LogGAEvent('Online Marketing', 'click', 'business promoter');">
                Business Promoter
    ...
    <ul>
        ...
        <li class=""><a href="https://status.namecheap.com/" rel="follow">
            Status Updates</a></li>
...
<li class="L0"><a href="refund-policy.aspx" class="refund-policy">Refund Policy</a>
	...
	<div class="promo-chat">
		<div class="grid-row group">
			...
			<div class="grid-col one-half">
                <p><a href="/support/live-chat" target="_blank" class="btn green">Chat with a Live Person</a></p>
			</div>
		</div>
	</div>
...
<footer id="footer" >
	...
	<div class="grid-row">
		<div class="grid-col one-third">
			...
			<div class="logo"><a href="/"><img src="https://02.files.namecheap.com/cdn/437/assets/img/logos/namecheap-dkbg.png" id="ctl00_ctl00_ctl00_ctl00_base_content_web_base_content_footerControl_footerLogo" alt="Namecheap" /></a></div> 
...
<!-- SUBSCRIBE BUTTON ENDS-->
    ...
    <b class=""><a href="/online-marketing/business-promoter-small-business/" rel="follow"
        onclick="if (typeof (LogGAEvent) === 'function') LogGAEvent('Footer:Online Marketing', 'click', 'online marketing');">Online Marketing</a></b>
    
        <ul>
    
        <li class="">
            <a href="/online-marketing/business-promoter-small-business/" 
                onclick="if (typeof (LogGAEvent) === 'function') LogGAEvent('Footer:Online Marketing', 'click', 'business promoter');">Business Promoter</a>
        </li>
    ...
    <b class="get-started"><a href="/resellers/ssl-certificates.aspx" rel="follow"
    ...
    <b class="get-started"><a href="/support.aspx" 
        ...
        <li class="">
            <a href="https://status.namecheap.com/" rel="follow"
	...
	<div class="legal" role="contentinfo">
		<p class="copyright">The entirety of this site is protected by <span>copyright &copy; 2001–2018 Namecheap.com.</span></p>
		<ul>
    ...
    <div class="causes">
		<div>
			<b>We Support</b>
			<div class="img-eff"><img src="https://02.files.namecheap.com/cdn/437/assets/img/logos/eff.png" id="ctl00_ctl00_ctl00_ctl00_base_content_web_base_content_footerControl_effImage" alt="Electronic Frontier Foundation" /></div>
			<div class="img-fftf"><img src="https://02.files.namecheap.com/cdn/437/assets/img/logos/fftf.png" id="ctl00_ctl00_ctl00_ctl00_base_content_web_base_content_footerControl_fftfImage" alt="Fight For The Future" /></div>
		</div>
	</div>
		...
		<ul>
            <li>
                <a href="https://secure.comodo.com/ttb_searcher/trustlogo?v_querytype=W&v_shortname=SC5&v_search=https://www.namecheap.com/&x=6&y=5"
                    ...
                    <img src="https://02.files.namecheap.com/cdn/437/assets/img/logos/comodo_secure_seal_100x85_transp.png" id="ctl00_ctl00_ctl00_ctl00_base_content_web_base_content_footerControl_ComodoSecure" oncontextmenu="return false;" alt="Comodo Security Seal" style="border: none" />
                </a>
            </li>
            <li>
                <a href="https://nc1.app.link/W1qV0gjLZG" target="_blank" rel="" title="Android app on google play"><!--
                                --><img src="https://02.files.namecheap.com/cdn/437/assets/img/logos/googleplay.png" id="ctl00_ctl00_ctl00_ctl00_base_content_web_base_content_footerControl_GooglePlay" oncontextmenu="return false;" alt="Android app on google play" style="border: none" />
                </a>
            </li>

            <li>
                <a href="https://nc1.app.link/W1qV0gjLZG" target="_blank" rel="" title="iOS App Store"><!--
                                --><img src="https://02.files.namecheap.com/cdn/437/assets/img/logos/appstore.png" id="ctl00_ctl00_ctl00_ctl00_base_content_web_base_content_footerControl_iOSStore" oncontextmenu="return false;" alt="iOS App Store" style="border: none" />
                </a>
            </li>
    ...
    <script type="text/javascript" src="https://01.files.namecheap.com/cdn/0/assets/js/v437.global-script.min.js"></script>
