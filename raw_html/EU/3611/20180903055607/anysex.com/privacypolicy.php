...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-124604203-1"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-124604203-1');
</script>
...
<script type="text/javascript">
    (function () {
        ...
        ExoLoader.serve({"script_url":"/jxwd/qgtZhEPjLf.php"});
                                                                                                                                    ...
                                                                                                                                    <script src="/3y5jpptvjy7n/advertisement.jsx"></script>
<script>
    typeof yl !=="undefined" || typeof iiiiiiii !== "undefined" || document.write('<scr'+'ipt src="/3y5jpptvjy7n.jsx"></'+'scr'+'ipt>');
</script>
<!-- QM0FuqF6eWp7yCUF -->
</body></html>