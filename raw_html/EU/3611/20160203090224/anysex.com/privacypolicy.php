...
<head>
    ...
    <script type="text/javascript" src="http://anysex.com/js/KernelTeamVideoSharingSystem.js?v=3.4.2"></script>
    

    <script type="text/javascript" src="http://anysex.com/js/KernelTeamImageRotator_3.4.2.jsx"></script>
...
<div class="adv_block no_pop" style="clear:both">
      <iframe src="/b/f.html" width="1244" height="250" vspace="0" marginheight="0" marginwidth="0" scrolling="no" frameborder="0" allowtransparency="true" class="clear_both"></iframe>
</div>
</div>
</div>
<div id="footer">
