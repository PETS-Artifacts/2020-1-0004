...
<script data-id="script_async_bidder" type="text/javascript">
    ...
    var adStart = Date.now(),
        ...
        timeToSlotRenderEnded = Date.now(),
        slotRenderCount = 0,
...
<link rel="shortcut icon" href="http://i.investopedia.com/public/img/favicon.ico" type="image/vnd.microsoft.icon" />
          ...
          <link rel="stylesheet" type="text/css" href="http://i.investopedia.com/public/css/tablet.css?v=5.380"/>
  ...
  <!-- End Page Taxonomy -->	<script type="text/javascript">
    var idc_slots = {};
    ...
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/1.7.2/jquery.min.js"></script>
            <script language="javascript" type="text/javascript" src="http://i.investopedia.com/public/js/main.min.js?v=5.380"></script>
        
      <script>
    var initLayer = _pageTaxonomy;
    initLayer['country'] = invGCookie.geoCountry();
    initLayer['state'] = invGCookie.geoStateProvince();
    initLayer['asset_version'] = '5.380';
    initLayer['device'] = 'desktop';
    dataLayer = [initLayer];
  </script>

    <script data-id="script_optimizely" src="//cdn.optimizely.com/js/3135740712.js"></script>
    <script language="javascript" type="text/javascript" src="http://i.investopedia.com/public/js/streamsense.min.js?v=5.380"></script>
...
<!-- Current time is: 06/02/2016 01:09:27 am -->
                    ...
                    <div class="inner page-width">
                      ...
                      <div class="col new" style="width:35%;">
                        <div class="title">What's New</div>
                                                  <a href="/articles/insights/060116/yahoo-make-20-stock-back-balance-yhoo.asp" class="article new">
                            <img src="http://i.investopedia.com/content/commentary/yahoo_make_20_from/yahoo_ap090420043011_crop.jpg?quality=60&width=200&height=200">
                            <span class="article-title">Yahoo: Make 20% from a Stock Back in Balance (YHOO)</span>
                          </a>
                                                    <a href="/articles/insights/060116/donald-trumps-biggest-leaker-donald-trump.asp" class="article new">
                            <img src="http://i.investopedia.com/content/commentary/is_donald_trumps_bi/ap_867863841782.jpg?quality=60&width=200&height=200">
                            <span class="article-title">Is Donald Trump’s Biggest Leaker Donald Trump?</span>
                          </a>
                                                </div
                  ...
                  <div class="menu-panel">
                    <div class="inner page-width">
                      ...
                      <div class="col tod" style="width:30%;">
                        ...
                        <a href="/terms/h/hawk.asp" class="tod-term">
                          <div class="term-title">Hawk</div>
                          <div class="term-desc">A policymaker or advisor who is predominantly concerned with interest rates as they ... </div>
                          <div class="term-btn">Read More &raquo;</div>
                        </a>
                      </div
                      ><div class="col video" style="width:30%;">
                        <a class="title" href="/video/">Latest Videos</a>
                                                  <a href="/video/play/what-are-mortgage-backed-securities/" class="article video">
                            <img src="http://i.investopedia.com/thumbnails/live/51_mortgagebackedsecurities_421x236.jpg?quality=60&width=200&height=200">
                            <span class="article-title">Understanding Mortgage-Backed Securities</span>
                          </a>
                                                    <a href="/video/play/are-bestperforming-funds-always-your-best-bet/" class="article video">
                            <img src="http://i.investopedia.com/content/video/are_the_bestperform/bestperforming.png?width=200&height=200">
                            <span class="article-title">Are the Best-Performing Funds Always Your Best Bet?</span>
                          </a>
                                                </div
...
<input type="submit" id="edit-submit" name="op" value="Search" class="form-submit" /></div><input type="hidden" name="form_build_id" value="form-yFRlR3mE9jmv7L_8zgY-Q-QPAJxkPO1AF86Rh68opbU" />
