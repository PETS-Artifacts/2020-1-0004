...
<head profile="http://www.w3.org/1999/xhtml/vocab">
    ...
    <script>var investopedia = {"device":"desktop"};</script>
    ...
    <script language="javascript" type="text/javascript">
        ...
        var updateAup = function(aUp) {
            ...
            var utms = null;    
            try {
                utms = investopedia.url.getParam("utm_source");
            } catch (e) {}
...
<link rel="shortcut icon" href="//i.investopedia.com/public/img/favicon.ico" type="image/vnd.microsoft.icon" />
  ...
  <link rel="stylesheet" href="//fonts.googleapis.com/css?family=Source+Sans+Pro:200,200i,300,300i,400,400i,600,600i,700,700i,900,900i">
          ...
          <link rel="stylesheet" type="text/css" href="//i.investopedia.com/public/css/tablet.css?v=5.625"/>
...
<script type="text/javascript">
    ...
    if (hash != null) {
        if (typeof hash.startsWith === "function") {
            if (hash.startsWith("#ec") || hash.startsWith("#ra") || window.location.pathname.endsWith("/anxiety-index/")) {
                idc_slots.includes = [];
            }
        }
    }
...
</script>    <script data-id="script_dfp" type='text/javascript'>
  targetingList = {
  ...
  idc_targeting = targetingList || {};
        ...
        <!--js start-->
    <script language="javascript" type="text/javascript" data-id="script_invmin" src="//i.investopedia.com/dest/js/inv.min.js?v=5.625"></script>
        <script src="https://ajax.googleapis.com/ajax/libs/jquery/1.7.2/jquery.min.js"></script>
    <script language="javascript" type="text/javascript" src="//i.investopedia.com/dest/js/deepblue.min.js?v=5.625"></script>
    <script language="javascript" type="text/javascript">
        var noDfp = false;
        var ecLayout = false;
        var raLayout = false;
...
<script data-id="script-populate-datalayer-node">
  dataLayer.push({
    'node_id' : "152715", 
      ...
      <script data-id="script_optimizely"
            src="//cdn.optimizely.com/js/3135740712.js"></script>
    ...
    <!-- Nativo -->
          <script type="text/javascript">
        if(invGCookie.geoCountry() !== "IN" && !noDfp && !ecLayout) {
...
<!-- Current time is: 07/08/2017 03:35:45 pm -->
<div class="page-wrapper">
    ...
    header .academy:hover,
    body .header.meganav .academy:hover {
      background: #444;
    }

    header .academy:after,
    body .header.meganav .academy:after {
      content: 'NEW';
      font-size: 9px;
      position: absolute;
      top: 50%;
    ...
    @media screen and (max-width: 740px) {
      header .primary .academy,
      body .header.meganav .primary .academy {
        display: block !important;
        padding: 18px 8px 17px 16px !important;
      }

      header .primary .academy:after,
      body .header.meganav .primary .academy:after {
        left: 75px;
        right: auto;
      }

      header .secondary .academy,
      body .header.meganav .secondary .academy {
    ...
    .header.meganav .secondary .academy {
        display: inline-block;
        padding: 0 15px;
        line-height: 56px;
        height: 100%;
    ...
    .header.meganav .secondary .academy:hover {
        background: #444;
    }
...
<div class="header meganav gaEvent " data-module-type="nav" data-module="main">
    <div class="inner page-width">
        ...
        ><div class="menus">
                                ...
                                <div class="inner page-width">
                                    ...
                                    <div class="col new" style="width:35%;">
                                        <div class="title">What's New</div>
                                                                                        <a href="/news/why-theres-still-room-rally/"
                                                  class="article new" 
                                                  data-content-type="Commentary" 
                                                  data-type="title">
                                                  <div 
                                                    class="article-image"
                                                    style="background-image: url(
                                                      //i.investopedia.com/content/untitled27448/3d_stock_istock641607690.jpg?quality=60&width=200&height=200                                                    );"
                                                  >
                                                  </div>
                                                  <span class="article-title">Opinion: There's Still Room in this Rally</span>
                                                </a>
                                                                                                <a href="/partner/reuters/us-jobs-data-lifts-wall-street-tech-financials-advance/"
                                                  class="article new" 
                                                  ...
                                                  <div 
                                                    class="article-image"
                                                    style="background-image: url(
                                                      //i.investopedia.com/content/untitled42062/shutterstock_178709456_people_standing_in_front_of_a_stock_screen.jpg?quality=60&width=200&height=200                                                    );"
                                                  >
                                                  </div>
                                                  <span class="article-title">U.S. Jobs Data Lifts Wall Street as Tech, Financials Advance</span>
                                                </a>
                                                                                    </div
                                    ...
                                    ><div class="col topics" style="width:65%;">
                                        ...
                                        <ul class="links topics">
                                            ...
                                            <li><a href="/special-reports/2017/navigating-market-etf/">Navigating with ETFs</a></li>
                                            ...
                                            <li><a href="/special-reports/2017/adaptable-advisor/" data-content-type="topics" data-type="title">The Adaptable Advisor</a></li>
                                        </ul>
                                    </div>
                            ...
                            <div class="menu-panel">
                                <div class="inner page-width">
                                    ...
                                    <div class="col tod" style="width:30%;">
                                        ...
                                        <a href="/terms/c/capitalmarkets.asp" class="tod-term" data-content-type="term" data-type="title">
                                            <div class="term-title">Capital Markets</div>
                                            <div class="term-desc">Capital markets are markets for buying and selling equity and debt instruments. May ... </div>
                                    ...
                                    ><div class="col video" style="width:30%;">
                                        <a class="title" href="/video/" data-content-type="topics" data-type="title">Latest Videos</a>
                                                                                    <a href="/video/play/quantitative-analysis/" class="article video" data-content-type="video" data-type="title">
                                                <img src="//i.investopedia.com/content/video/quantitative_analysi/quant_analysis.jpg?quality=60&width=200&height=200">
                                                <span class="article-title">What is Quantitative Analysis?</span>
                                            </a>
                                                                                        <a href="/video/play/why-international-diversification-still-matters/" class="article video" data-content-type="video" data-type="title">
                                                <img src="//i.investopedia.com/content/video/why_international_di/webinar_international_diversification.jpg?quality=60&width=200&height=200">
                                                <span class="article-title">Why International Diversification Still Matters</span>
                                            </a>
                                                                                </div
            ...
            ><div class="secondary">
                                    <a href="/academy/" class="menu academy menu-item-header">
                        Academy
                    </a>
...
<script language = "JavaScript">
    var url = window.location.href;
    if (url.includes("accounts/signup-newsletter-fb")||url.includes("accounts/facebook-coreg")){
        $( ".menus").hide();
        $(".subchannels").hide();
    }
</script>
