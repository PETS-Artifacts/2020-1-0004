...
<link rel="shortcut icon" href="http://i.investopedia.com/public/img/favicon.ico" type="image/vnd.microsoft.icon" />
          ...
          <link rel="stylesheet" type="text/css" href="http://i.investopedia.com/public/css/tablet.css?v=5.458"/>
...
<script type="text/javascript">
  ...
  idc_targeting = targetingList || {};
        ...
        <!--js start-->
    <script language="javascript" type="text/javascript" data-id="script_invmin" src="http://i.investopedia.com/dest/js/inv.min.js?v=5.458"></script>
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/1.7.2/jquery.min.js"></script>
            <script language="javascript" type="text/javascript" src="http://i.investopedia.com/public/js/main.min.js?v=5.458"></script>
        <script language="javascript" type="text/javascript">
        var noDfp = false;
        var ecLayout = false;
        var raLayout = false;
...
<script data-id="script-populate-datalayer-node">
  dataLayer.push({
    ...
    <script language="javascript" type="text/javascript"
            src="http://i.investopedia.com/public/js/streamsense.min.js?v=5.458"></script>
...
<!-- Current time is: 01/01/2017 07:35:03 am -->
                    ...
                    <div class="inner page-width">
                      ...
                      <div class="col new" style="width:35%;">
                        <div class="title">What's New</div>
                                                    <a href="/news/korean-actor-sues-tesla-claiming-model-x-crashed-house-tsla/"
                               class="article new">
                              <img
                                src="http://i.investopedia.com/content/daily_blog/tesla_model_x_owner_/tesla_interior.jpg?quality=60&width=200&height=200">
                              <span
                                class="article-title">Korean Actor Sues Tesla, Claiming Model X Crashed Into House</span>
                            </a>
                                                        <a href="/articles/insights/122816/twitters-2016-wild-timeline-year-review-twtr-fb.asp"
                               class="article new">
                              <img
                                src="http://i.investopedia.com/content/article/twitters_2016_wild_/shutterstock_161823989.jpg?quality=60&width=200&height=200">
                              <span
                                class="article-title">Twitter&#039;s 2016 Wild Timeline: A Year in Review</span>
                            </a>
                                                  </div
                  ...
                  <div class="menu-panel">
                    <div class="inner page-width">
                      ...
                      <div class="col tod" style="width:30%;">
                        ...
                        <a href="/terms/c/cdo.asp" class="tod-term">
                          <div class="term-title">Collateralized Debt Obligation - CDO</div>
                          <div class="term-desc">An investment-grade security backed by a pool of bonds, loans and other assets. CDOs ... </div>
                          <div class="term-btn">Read More &raquo;</div>
                        </a>
                      </div
                      ><div class="col video" style="width:30%;">
                        <a class="title" href="/video/">Latest Videos</a>
                                                  <a href="/video/play/steps-to-building-a-budget/" class="article video">
                            <img src="http://i.investopedia.com/content/video/how_to_build_a_budge/budget.jpg?quality=60&width=200&height=200">
                            <span class="article-title">How To Build A Budget</span>
                          </a>
                                                    <a href="/video/play/economist-ken-rogoff-says-us-should-cut-100-bill/" class="article video">
                            <img src="http://i.investopedia.com/content/video/economist_ken_rogoff/ken_rogoff_curse_of_cash.jpg?quality=60&width=200&height=200">
                            <span class="article-title">Kill Benjamin! Why Rogoff Says Drop the C-Note</span>
                          </a>
                                                </div
...
<input type="submit" id="edit-submit" name="op" value="Search" class="form-submit" /></div><input type="hidden" name="form_build_id" value="form-HkT5ANmhT74k-DTpFwyIGUOc3OiUhXcM1B6XMlpxk-g" />
