...
<link rel="shortcut icon" href="http://i.investopedia.com/public/img/favicon.ico" type="image/vnd.microsoft.icon" />
          ...
          <link rel="stylesheet" type="text/css" href="http://i.investopedia.com/public/css/tablet.css?v=5.434"/>
    
    <script type="text/javascript">
    
    
        var geoData = {"FIN_state":"CA","city":"San Francisco","FIN_zip":"94107","country_code":"US","IP":"207.241.229.72"};
  ...
  <!-- End Page Taxonomy -->    <!-- Eof Taxonomy -->
          <!--js start-->
    <script language="javascript" type="text/javascript" data-id="script_invmin" src="http://i.investopedia.com/dest/js/inv.min.js?v=5.434"></script>
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/1.7.2/jquery.min.js"></script>
            <script language="javascript" type="text/javascript" src="http://i.investopedia.com/public/js/main.min.js?v=5.434"></script>
        <script language="javascript" type="text/javascript">
        var noDfp = false;
        var ecLayout = false;
        var raLayout = false;
...
<script data-id="script-populate-datalayer-node">
  dataLayer.push({
    ...
    <script language="javascript" type="text/javascript" src="http://i.investopedia.com/public/js/streamsense.min.js?v=5.434"></script>
...
<!-- Current time is: 11/07/2016 06:11:04 pm -->
                    ...
                    <div class="inner page-width">
                      ...
                      <div class="col new" style="width:35%;">
                        <div class="title">What's New</div>
                                                  <a href="/news/trump-win-would-dump-5-sp-500-citi/" class="article new">
                            <img src="http://i.investopedia.com/content/homepage_news_allnew/27151701353_b03f887b0e_k_flickr_donald_trump.jpg?quality=60&width=200&height=200">
                            <span class="article-title">A Trump Win Would Dump 5% Off S&amp;P 500: Citi</span>
                          </a>
                                                    <a href="/news/earnings-election-ate-my-lunch-mcd-sbxdnkn/" class="article new">
                            <img src="http://i.investopedia.com/content/daily_blog/earnings_the_electi/shutterstock_114348031.jpg?quality=60&width=200&height=200">
                            <span class="article-title">Earnings: The Election Ate My Lunch</span>
                          </a>
                                                </div
                  ...
                  <div class="menu-panel">
                    <div class="inner page-width">
                      ...
                      <div class="col tod" style="width:30%;">
                        ...
                        <a href="/terms/i/ira.asp" class="tod-term">
                          <div class="term-title">Individual Retirement Account - IRA</div>
                          <div class="term-desc">An investing tool used by individuals to earn and earmark funds for retirement savings. ... </div>
                          <div class="term-btn">Read More &raquo;</div>
                        </a>
                      </div
                      ><div class="col video" style="width:30%;">
                        <a class="title" href="/video/">Latest Videos</a>
                                                  <a href="/video/play/investors-guide-postgolden-age-returns/" class="article video">
                            <img src="http://i.investopedia.com/content/video/investors_guide_to_/mee.jpg?quality=60&width=200&height=200">
                            <span class="article-title">Investor's Guide to Post-Golden Age Returns</span>
                          </a>
                                                    <a href="/video/play/john-mauldin-investopedia-profile/" class="article video">
                            <img src="http://i.investopedia.com/content/video/john_mauldin_invest/mauldin.jpg?quality=60&width=200&height=200">
                            <span class="article-title">John Mauldin: Investopedia Profile</span>
                          </a>
                                                </div
...
<input type="submit" id="edit-submit" name="op" value="Search" class="form-submit" /></div><input type="hidden" name="form_build_id" value="form-wfR0DDivqK9lUpQEPL_iSVospcLNhksf06sGnkGMUEw" />
