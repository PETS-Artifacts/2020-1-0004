...
<link rel="shortcut icon" href="http://i.investopedia.com/public/img/favicon.ico" type="image/vnd.microsoft.icon" />
          ...
          <link rel="stylesheet" type="text/css" href="http://i.investopedia.com/public/css/tablet.css?v=5.447"/>
    
    <script type="text/javascript">
    
    
        var geoData = {"FIN_state":"CA","city":"San Francisco","FIN_zip":"94118","country_code":"US"};
  ...
  //<![CDATA[
    var _pageTaxonomy = {"Hashkey":null,"Path":"/corp/privacypolicy.aspx","Channel":"Investing","SubChannel":"Investing Strategy","Advertising":"Investing","SubAdvertising":"Investing","DfpTarget":"Investing/Investing","LeadGenTarget":null,"Tags":[],"Taggroup":[],"Type":"Corp","Lucrativeness":null,"Timelessness":"Timeless","Feature":null,"Design":null,"InterestLevel":null,"Index":"True","NoIndexParams":"False","Follow":"True","Master":"False","ServerName":"tax003","Microtags":["cookies","California","Privacy Policy","Swiss","URL","EU","zip code","Oakland, CA","direct marketing","nbsp","Mobile","web browser","Better Business Bureaus","social networking","GIF","alternative dispute resolution","Network Advertising Initiative","Digital Advertising Alliance","Do Not Track","Safe Harbor Principles","data integrity","DNS","IAC","Firefox","IAC/InterActiveCorp","Internet Explorer","time zone","Internet","online advertising","operating system","Federal Trade Commission","GPS","latitude","United States","device identifier","web beacons","California Civil Code","Google","Apple"],"SecondarySubChannel":["Investing Strategy"]};
  //]]>
  </script>
...
<script type="text/javascript">
  ...
  idc_targeting = targetingList || {};
        ...
        <!--js start-->
    <script language="javascript" type="text/javascript" data-id="script_invmin" src="http://i.investopedia.com/dest/js/inv.min.js?v=5.447"></script>
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/1.7.2/jquery.min.js"></script>
            <script language="javascript" type="text/javascript" src="http://i.investopedia.com/public/js/main.min.js?v=5.447"></script>
        <script language="javascript" type="text/javascript">
        var noDfp = false;
        var ecLayout = false;
        var raLayout = false;
...
<script data-id="script-populate-datalayer-node">
  dataLayer.push({
    ...
    <!-- Lead Gen redirect to Remove Infinite Scroll on Terms For US users and Not Robo-->
    ...
    <script language="javascript" type="text/javascript"
            src="http://i.investopedia.com/public/js/streamsense.min.js?v=5.447"></script>
...
<!-- Current time is: 12/01/2016 05:03:06 am -->
                    ...
                    <div class="inner page-width">
                      ...
                      <div class="col new" style="width:35%;">
                        <div class="title">What's New</div>
                                                  <a href="/news/goldman-sachs-nears-alltime-high-treasury-news-gs-xlf/" class="article new">
                            <img src="http://i.investopedia.com/content/daily_blog/goldman_sachs_nears_/shutterstock_143213317_goldman_sachs_headquarters_arial_shot.jpg?quality=60&width=200&height=200">
                            <span class="article-title">Goldman Sachs Nears All-Time High on Treasury News</span>
                          </a>
                                                    <a href="/news/mallinckrodt-tops-4q-earnings-shares-tumble-mnk/" class="article new">
                            <img src="http://i.investopedia.com/content/daily_blog/mallinckrodt_tops_4q/shutterstock_85654102_science_bio_pharma_drug.jpg?quality=60&width=200&height=200">
                            <span class="article-title">Mallinckrodt Tops 4Q Earnings, Shares Tumble</span>
                          </a>
                                                </div
                      ...
                      ><div class="col topics" style="width:65%;">
                        ...
                        <ul class="links topics">
                          ...
                          <li><a href="/special-reports/2016/annual-financial-planning-guide/">Financial Planning Guide</a></li>
                          <li></li>
                          <li></li>
                  ...
                  <div class="menu-panel">
                    <div class="inner page-width">
                      ...
                      <div class="col tod" style="width:30%;">
                        ...
                        <a href="/terms/i/inflation-linkedsavingsbonds.asp" class="tod-term">
                          <div class="term-title">Inflation-Linked Savings Bonds (I Bonds)</div>
                          <div class="term-desc">U.S. government-issued debt securities similar to regular savings bonds, except they ... </div>
                          <div class="term-btn">Read More &raquo;</div>
                        </a>
                      </div
                      ><div class="col video" style="width:30%;">
                        <a class="title" href="/video/">Latest Videos</a>
                                                  <a href="/video/play/do-you-have-emergency-savings/" class="article video">
                            <img src="http://i.investopedia.com/content/video/do_you_have_emergenc/zgainer.jpg?quality=60&width=200&height=200">
                            <span class="article-title">Do You Have Emergency Savings?</span>
                          </a>
                                                    <a href="/video/play/strategic-asset-allocation-0/" class="article video">
                            <img src="http://i.investopedia.com/content/video/strategic_asset_allo/ssa.png?width=200&height=200">
                            <span class="article-title">Strategic Asset Allocation to Rebalance Portfolios</span>
                          </a>
                                                </div
...
<input type="submit" id="edit-submit" name="op" value="Search" class="form-submit" /></div><input type="hidden" name="form_build_id" value="form-eREgZlmPg7PsqMEOi2gBWxh_wXoFrf4wq8OFNJAgwq0" />
