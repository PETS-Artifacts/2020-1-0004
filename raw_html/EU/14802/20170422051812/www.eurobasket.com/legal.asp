...
<script type="text/javascript" src="http://www.eurobasket.com/ndscripts2.js?v=4/21/2017 10:18:10 PM"></script> 
...
<!--<a href="/rdaction.asp?url=http://go.ad2up.com/afu.php?id=1174947" target="_blank"><img src="/banners/propellerad.jpg"></a>-->
	...
	<table id="verytopfull" style="display:none;" width="100%" cellpadding="0" cellspacing="0" border="0">
		<tr><td><a href="http://kbl.or.kr/news/notice/news_content.asp?num=21683&amp;page=1" target="_blank"><img  WIDTH="728" HEIGHT="90" border="0" align="left" src="http://www.eurobasket.com/banners/Ad-Banner_KBL.jpg"onerror="this.src='';"></a>
</td></tr>
	</table>
	...
	<table id="verytopthin" style="display:none;" width="100%" cellpadding="0" cellspacing="0" border="0">
		<tr>
			<td>
				<a href="http://www.eurobasket.com/subscribe.asp?service=make_IT_pro" target="_blank"><img  border="0" align="left" src="http://www.eurobasket.com/banners/Make-It-Pro_.gif"onerror="this.src='';"></a>
	...
	<tr>
		<td align="center">
<a href="http://www.eurobasket.com/job/index.asp" target="_blank"><img  border="0" align="left" src="http://www.eurobasket.com/banners/TopBanner_JobMarket.jpg"onerror="this.src='';"></a>
	...
	<script>
		...
		document.getElementById("verytopfull").style.display = "block";
		document.getElementById("verytopthin").style.display = "none";
...
Eurobasket.com	
	...
	<tr>
        ...
        <ul>
                ...
                <li><a class="bullet" href="mailto:4marek@eurobasket.com?subject=Member Support">Member Support</a></li>
...
content of the site, nor will you attempt to do so.
	...
	<style>ins.adsbygoogle, #div-gpt-ad-1486062060280-0{margin-bottom:10px;}</style>
<html xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
<div style="z-index:1;"><embed type="application/x-shockwave-flash" width="160px" height="60px" src="/banners/ibcminibanner.swf" wmode="transparent"></embed></div><div class="justspace"></div>
<script id="mNCC" language="javascript">
   medianet_width = "160";
   medianet_height = "90";
   medianet_crid = "720734338";
   medianet_versionId = "111299";
   (function() {
       var isSSL = 'https:' == document.location.protocol;
       var mnSrc = (isSSL ? 'https:' : 'http:') + '//contextual.media.net/nmedianet.js?cid=8CU3Y256Q' + (isSSL ? '&https=1' : '');
...
(adsbygoogle = window.adsbygoogle || []).push({});
	...
	for (var i = 0; i < document.getElementsByClassName("aleftmenutd").length; i++) {
		var element = document.getElementsByClassName("aleftmenutd")[i];
		if (element && element.innerHTML && element.innerHTML.toLowerCase() == '<b>women</b>') {
			
			element.innerHTML = element.innerHTML + '<div style="z-index:9999;height: 2px; position: absolute; width: 72px; ">&nbsp;&nbsp;</div>';
		}
	}
	</script>
...
<!--include VIRTUAL="../global/ourcolors.asp"-->
