...
<link rel="icon" type="image/png" href="/favicon.png" sizes="16x16">
            ...
            <![endif]--><script type="text/javascript">FinvizSettings = {hasUserPremium: false, name: ""};</script><script src="/script/boxover.js?rev=107" type="text/javascript"></script>
<script src="/script/lightup.js?rev=107" type="text/javascript"></script>
<script type="text/javascript" src="/js/libs/shims.min.js?rev=107"></script><script type="text/javascript" src="/js/libs/d3-json.js"></script></head>
<body class="" style="margin:0" bgcolor="#ffffff"><div id="unsupported-browser">Your browser is no longer supported. Please, <a href="http://whatbrowser.org/" target="_blank">upgrade your browser.</a></div>
        ...
        <div class="about" style="width: 670px">
            ...
            <script type="text/javascript" src="/js/dist/header.bundle.js?rev=107"></script>
...
<div id="modal-elite-ad" class="modal-elite-ad">
                         ...
                         </div><script src="/js/pv.js?rev=107" async></script><script src="/script/libs/bowser.min.js?rev=107" type="text/javascript"></script></body>
</html>
