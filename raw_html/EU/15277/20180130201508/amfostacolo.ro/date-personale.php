          ...
          <li class="pull-right" style="z-index:2147483647;">
              ...
              <li class="dropdown hidden-xs ">
                  ...
                  <ul id="lv-concurs" class="dropdown-menu linkWait9 dm-icon pull-right" style="">
                    ...
                    <li><a  class="linkWait9M CuRosu" href="/topw.php?y=2018&w=05"><i class="zmdi zmdi-cocktail"></i> Top «Hot» Users / Săpt. crt.</a></li>
    ...
    <!-- meniul lateral stânga + meniul dreapta-->
        ...
        <ul class="main-menu m-t-0">
            ...
            <li class="sub-menu">
                ...
                <ul>
                    <li><a class="linkWait9 CuRosu" href="/topw.php?y=2018&w=5"><i class="zmdi zmdi-cocktail"></i> Top «Hot» Users</a></li>
            ...
            <li class="sub-menu">
                ...
                <ul>
                  <li><a class="linkWait9" href="/art_weekly.php?wk=5">Săptămâna curentă [#<b>5</b>]</a></li><li><a class="linkWait9" href="/art_weekly.php?wk=4">Săptămâna anterioară [#4]</a></li>                </ul>
            </li>

            <li class="sub-menu">
                <a href=""><i class="zmdi zmdi-trending-up"></i>Cele mai votate <b>fotografii</b></a>
                <ul>
                  <li><a class="linkWait9" href="/photo-weekly.php?wk=5">Săptămâna curentă [<b>#5</b>]</a></li><li><a class="linkWait9" href="/photo-weekly.php?wk=4">Săptămâna anterioară [#4]</a></li>                </ul>
            </li>
...
<div align="center" style="clear:both; font-size:8pt; margin-bottom:20px;">pagină generată în 0.00369501113892 sec </div>      </div>
