          ...
          <li class="pull-right" style="z-index:2147483647;">
              ...
              <li class="dropdown hidden-xs ">
                  ...
                  <ul id="lv-concurs" class="dropdown-menu linkWait9 dm-icon pull-right" style="">
                    ...
                    <li><a  class="linkWait9M CuRosu" href="/topw.php?y=2017&w=23"><i class="zmdi zmdi-cocktail"></i> Top «Hot» Users / Săpt. crt.</a></li>
 ...
 <li class="dropdown hidden-xs">
                            ...
                            <div class="dropdown-menu pull-right dropdown-menu-lg">
                                <div class="listview">
                                    ...
                                    <a class="lv-footer c-white linkWait9" style="background-color:red;" href="/solicitare-oferta.php">SOLICITĂ OFERTĂ PERSONALIZATĂ</a>
                                </div>
                            </div>
                        </li>
    ...
    <!-- meniul lateral stânga + meniul dreapta-->
        ...
        <ul class="main-menu m-t-0">
            ...
            <li class="sub-menu">
                ...
                <ul>
                    <li><a class="linkWait9 CuRosu" href="/topw.php?y=2017&w=23"><i class="zmdi zmdi-cocktail"></i> Top «Hot» Users</a></li>
            ...
            <li class="sub-menu">
                ...
                <ul>
                  <li><a class="linkWait9" href="/art_weekly.php?wk=23">Săptămâna curentă [#<b>23</b>]</a></li><li><a class="linkWait9" href="/art_weekly.php?wk=22">Săptămâna anterioară [#22]</a></li>                </ul>
            </li>

            <li class="sub-menu">
                <a href=""><i class="zmdi zmdi-trending-up"></i>Cele mai votate <b>fotografii</b></a>
                <ul>
                  <li><a class="linkWait9" href="/photo-weekly.php?wk=23">Săptămâna curentă [<b>#23</b>]</a></li><li><a class="linkWait9" href="/photo-weekly.php?wk=22">Săptămâna anterioară [#22]</a></li>                </ul>
            </li>
...
<div align="center" style="clear:both; font-size:8pt; margin-bottom:20px;">pagină generată în 0.012442111969 sec </div>      </div>
