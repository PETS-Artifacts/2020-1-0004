          ...
          <li class="pull-right">
              ...
              <li class="dropdown hidden-xs ">
                  ...
                  <ul id="lv-concurs" class="dropdown-menu linkWait9 dm-icon pull-right" style="">
                      <li class="divider"></li>
                      <li><a href="/filtru-destinatii.php">Alege o secțiune (ţară)</a></li>
                      <li class="divider"></li>
                      <li class="skin-switch">Concursuri, clasamente, premii</li>
                    <li><a href="/topw.php?y=2017&w=04"><i class="zmdi zmdi-cocktail"></i> <span class="CuRosu">Top «Hot» Users / Săpt. crt.</a></li>
                            <li><a href="/top-users.php?ac=1&tx=500"><i class="zmdi zmdi-cake"></i> <b>Clasament 2017</b></a></li>
                            <li><a href="/clas-final-an.php?a=2016"><i class="zmdi zmdi-code-smartphone"></i> Clasament Final 2016</a></li>                      <li class="divider"></li>
                      <li><a href="/cafenea/">FORUM</a></li>
                      <li><a href="http://amfostacolo.ro/cafenea/index.php?/topic/246-teleconferin%c8%9ba-de-alocare-minipremii-saptamanale-2013-2014/page__view__getlastpost">Fir teleconferinţă premii</a></li>
                      <li><a href="/blog/">AmFostAcolo.Blog</a></li>
                      <li class="divider"></li>
                      <li><a href="/feedback.php"><b>Contact / Feedback</b></a></li>
                                ...
                                <div class="listview">
                                    ...
                                    <div id="lv-oferte" class="lv-body" style="min-height: 100px; max-height: 350px;"">
                                        <div style="text-align:center !important">
                                          <img src="/images/loading_spinner_200.gif" border="0" style="width:100%" /> 
                                          <br />Rog aşteptaţi.. (în curând)
                                          
                                        </div>
                                    </div>
                                    <a class="lv-footer c-white" style="background-color:red;" href="/solicitare-oferta.php">SOLICITĂ OFERTĂ PERSONALIZATĂ</a>
                                </div>
                            </div>
                        </li>
                          ...
                          <div class="lc-block toggled" id="l-login" style="margin:10px; padding:10px;">
                            <form action="javascript:;" onsubmit="VerificaUserPass(1);">
                                <li class="m-b-20"><i class="zmdi zmdi-face"></i> Aveţi cont? » <b>Autentificaţi-vă</b>
                                  ...
                                  <a id="go9" onclick="javascript: PlsWait9(); VerificaUserPass(1); " class="submit btn btn-login btn-danger btn-float" style="z-index:99; cursor:pointer;"><i class="zmdi zmdi-arrow-forward"></i></a>
                               </form>   
                          </div>
...
<section id="main" data-layout="layout-1">
    ...
    <!-- meniul lateral stânga + meniul dreapta-->
        ...
        <ul class="main-menu m-t-0">
            ...
            <li><a class="linkWait9" href="/filtru-destinatii.php"><i class="zmdi zmdi-globe"></i> <b>ALEGE SECŢIUNEA</b></span></a></li>
            ...
            <li class="sub-menu">
                ...
                <ul>
                    <li><a class="linkWait9" href="/topw.php?y=2017&w=4"><i class="zmdi zmdi-cocktail"></i> <span class="CuRosu">Top «Hot» Users</a></li>
            ...
            <li class="sub-menu">
                ...
                <ul>
                  <li><a class="linkWait9" href="/art_weekly.php?wk=4">Săptămâna curentă [#<b>4</b>]</a></li><li><a class="linkWait9" href="/art_weekly.php?wk=3">Săptămâna anterioară [#3]</a></li>                </ul>
            </li>

            <li class="sub-menu">
                <a href=""><i class="zmdi zmdi-trending-up"></i>Cele mai votate <b>fotografii</b></a>
                <ul>
                  <li><a class="linkWait9" href="/photo-weekly.php?wk=4">Săptămâna curentă [<b>#4</b>]</a></li><li><a class="linkWait9" href="/photo-weekly.php?wk=3">Săptămâna anterioară [#3]</a></li>                </ul>
            </li>

            <li class="sub-menu ">
                <a class="" href=""><i class="zmdi zmdi-view-list"></i> <span class="bgm-bluegray c-white p-10">Listele negre AFA</span></a>
                <ul>
...
<p>[C] Copyright 2008-2017 AmFostAcolo.ro // Reproducerea integrală sau parţială a conţinutului este interzisă<br />AmFostAcolo® este marcă înregistrată</p><!--/Start Trafic.ro/-->
<script type="text/javascript">t_rid="AmFostAcolo";</script>
<script type="text/javascript" src="http://storage.trafic.ro/js/trafic.js"></script><noscript><a href="http://www.trafic.ro/top/?rid=AmFostAcolo" target="_blank"><img border="0" alt="trafic ranking"  src="http://log.trafic.ro/cgi-bin/pl.dll?rid=AmFostAcolo"/></a></noscript>
<!--/End Trafic.ro/-->
...
<div align="center" style="clear:both; font-size:8pt; margin-bottom:20px;">pagină generată în 0.00323796272278 sec </div>      </div>
