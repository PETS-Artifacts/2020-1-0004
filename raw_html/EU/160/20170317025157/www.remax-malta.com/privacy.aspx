...
<script src="/common/js/commonjs?v=4uwQYyhUNSyMSBbRNT4NW9yT488d7bSGFnS6vk7-woQ1"></script>
<script src="/common/bootstrap/js/bootstrap?v=UihKjhCeIOEpfM-q4caZz1NZMxGVTpMNo1GdBH0QQ781"></script>
<link href="/common/css/commoncss?v=GXRUQCQGJeLIfLhXCCREFppSMnOdkttlzHWNzoEWA-01" rel="stylesheet"/>
...
<div>
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="/wEPDwUKLTI5NTIyNTM2NGRkb+pxcFnyZb/vp6OO6JkG4upYXCY="/>
</div>
<script type="text/javascript">
 ...
 //ApplicationInstanceId = "0007b513-fb54-481b-8bb7-b43bbb548a53";
 </script>
<div>
...
<script type="text/javascript">
            $(document).ready(function () {
                $.ajax({
                    type: "GET",
                    url: "/handlers/MyProfileLogin.ashx?Lang=" + "MLT"  + "&refUrl=" + encodeURIComponent('http://' + window.location.hostname + window.location.pathname),
...
<div id="Header" PlaceholderDisplayMode="Display"><style>.userdropdown{top:16px;}@media (max-width:767px) {.userdropdown{top:10px!important;}}</style>
<link href="/sites/remaxmalta/regionalweb/documents/css/header.css" rel="stylesheet" type="text/css">
...
<div class="container">
<div class="row">
<div class="col-xs-12 col-sm-8 col-md-9"><div id="LeftMain" PlaceholderDisplayMode="Display"><span class="FirstLastSSItem"></span> 
<div id="holder">
<div class="top">
...
<ul>
<li class="full"><a ssid="64c56ff3-e58c-4a67-8521-b5cf0dcc9b34" href="/AdvancedListingSearch.aspx">Property For Sale in Malta</a></li>
...
<input type="hidden" id="GTFLTCHK" name="GTFLTCHK" value="5)71)4671&5<37<31&GK" />
	</body>
</html>