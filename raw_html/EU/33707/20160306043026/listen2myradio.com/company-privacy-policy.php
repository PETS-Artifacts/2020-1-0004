...
<head>
<title>Listen2MyRadio / Privacy Policy</title>
...
<link rel="stylesheet" href="css/styles.css+menu.css+styles-products.css.pagespeed.cc.FB8KvT2tGr.css" type="text/css"/>
...
<script src="js/jquery.tools.min.js.pagespeed.jm.3YnPtzKwaP.js" type="text/javascript"></script>
<script src="js/hovereffect.js.pagespeed.jm.lQ2l7ByzUc.js" type="text/javascript"></script>
</head>
<body>
<!-- Header -->
<div id="header">
...
<img src="xlisten2myradio_banner2.jpg.pagespeed.ic.Be_FFgF_xU.jpg" alt="Discount Promotion"/>
</div>
<!-- Overlay - Language -->
<div class="overlay">
	...
	<ul>
        ...
        <li><a href="lang/es/" class="es">Spanish</a></li>
        <li><a href="lang/pt/" class="pt">Portuguese</a></li>
        
        <li><a href="lang/gr/" class="gr">Greek</a></li><li><a href="lang/it/" class="it">Italian</a></li><li><a href="lang/fr/" class="fr">French</a></li><li><a href="lang/de/" class="de">German</a></li>
    </ul>
</div>
<!-- Menu Frame -->
         ...
         <ul id="menu">
            ...
            <li><a href="#" class="radio" title="Radio Streaming"></a>
            	<ul>
                    ...
                    <li><a href="http://flashplayer.listen2myradio.com">Flash Player</a></li><li><a href="lang/iphone-app.php">iPhone Mobile App</a></li>
                </ul>
            </li>
...
<div id="content">
<!-- Wide Box -->
    <div class="wideBox"> <span class="wideboxtop"></span> <br/>
      <p align="center"><span class="style12"><br/>Privacy Policy</span><br> 
<OL> 
<LI> 
<B>Policy</B>: Company values users' and websites' privacy and therefore has set up this extensive Privacy-Policy in order to notify you when is data stored, what is being processed and what is being disclosed to our clients, which are the websites you visit, in order to allow them better services to you, as a client.</FONT></P> 
<LI> 
Though Company is not a US based organisation, its privacy policy is in strict compliance with the US Export Authority's Safe Harbour Principles (http://www.export.gov/safeharbor) and is in full and strict compliance with all Israeli privacy regulations.</FONT></P> 
<LI> 
<B>Data Collected: </B>Company collects data about user activity in Website and Shoutcast Streams brought by Company including aggregated non-personal information, personal information and clickstream information. This information will only be shared with our affiliates1 according to this Privacy Policy</FONT></P> 
<LI> 
<B>Data not collected</B>: Company is working with accordance to international regulation and EU standards of privacy and therefore shall never retain or request and information regarding ethnic origin, political opinions, religious or philosophical beliefs, trade-union or political party membership, personal health, personal sexual preferences or personal sex life. Company shall never retain or request data regarding exact name, personal financial transactions. You should immediately report the privacy officer at Company should you encounter any person or electronic service claiming to receive such information.</FONT></P> 
<LI> 
<B>Personal Data</B>: Company retains information which canmay identify with specific references to personal preferences and interests. </FONT></P> 
<LI> 
<B>Nonpersonal Data: </B>Company retains non-personal information including, but not only, identifying the computer you are browsing from, your IP address, your session time, your visiting preferences in our website and your visiting time to each webpage.</FONT></P> 
<LI> 
<B>Collection of Data: </B>Both non-identifiable personal and nonpersonal data are collected in the same manner: when You browse our Wwebsite, both a cookie is placed in your computer and we Company logs all traffic from Your IP; A Cookie is a small text file placed on your computer by your browser which identifies you as a specific user. This cookie identifies you with ourCompany's servers and allows usCompany to log which pages have you visitedidentify You as, what you preferred to see in these pages, what content were you looking for and other information which may be able to assist usCompany in understanding needs and preferences. </FONT></P> 
<LI> 
<B>Data Erasure: </B>Cookies are stored on yYour computer for a period of 24 hours and will automatically be erased if you have logged out of our Platform.</FONT></P> 
<LI> 
<B>Use of Data: </B><SPAN>Some of the Djs or, Radio Managers or Listeners may be subjected to Personal Information and/or Collected data, including, but not only, IP addresses, User Account names and other information which may be used to provide You with Better Service. </SPAN><B>You </B>must adhere to a privacy policy which complies with either a EU Member State regulation or the US Safe Harbour regulation in order to receive information from Company. </FONT></P> 
<LI> 
<B>Security: </B>Data is collected and stored on ourCompany's own servers or servers of 3rd parties operating on our behalf. Our Company's records which include stored data will not be disclosed to any party unless we are compelled to do so by a judicial order or law; We Company shall use our best efforts to protect this database from any malicious activity. and we request our affiliates strict confidentiality regarding use of the data disclosed. </FONT></P> 
<LI> 
<B>Removal of data: </B>You may view your user profile at any time and send us comments regarding incorrect user information stored at our database; these requests should be made by emailing us to this address: </FONT><FONT color=#94BF00><U><A href='mailto:admin@listen2myradio.com'><FONT style='FONT-SIZE: 9pt' size=2>admin@listen2myradio.com</FONT></A></U></FONT></P> 
<LI> 
You may also request to remove all personal data stored on our servers relating to direct marketing. However, you must understand that as data retention is being made by automated computer processes, aggregated non-identifiable information can not be erased. Should you request to remove all personal information stored about you, please email us to that address: </FONT><FONT color=#94BF00><U><A href='mailto:admin@listen2myradio.com'><FONT style='FONT-SIZE: 9pt' size=2>admin@listen2myradio.com</FONT></A></U></FONT></P> 
<LI> 
...
<LI> 
<B>Accountability: </B>As our users' data is valuable to us, we have appointed a privacy officer in-charge of the execution of this privacy policy. If you feel that your privacy and rights according to this privacy policy had been violated, please contact us at Privacy Matters, MediaHosting Ltd. P.O Box 3220, Acre, 24132, Israel or at </FONT><FONT color=#94BF00><U><A href='mailto:privacy@listen2myradio.com'><FONT style='FONT-SIZE: 9pt' size=2>privacy@listen2myradio.com</FONT></A></U></FONT></P> 
<LI> 
We shall take the best of means to assure that your data shall be retained and processed by the best of means and that every dispute shall be taken care of and resolved. Our privacy officer shall compile quarterly reports regarding privacy complaints and violations and provide details as to actions taken and remedies.</FONT></P> 
<LI> 
<B>Dispute Resolution: </B>Any dispute arising by breach of this privacy policy which was not handled by our privacy officer may be brought to the proper regulatory authorities for inspection. We shall provide full cooperation should it be necessary.</FONT></P></LI></OL> 
<LI> 
<B>Copyright Policies</B></FONT></P> 
<OL> 
<LI> 
<SPAN><I>Content</I>: You, as well as other Users, may upload, share and publish your Content, including, but not only, audiovisual materials, audio recordings, texts and interpretation of texts, and other creative content (Hereinafter: Content) via Platform. In order to do so, </SPAN><B>You warrant that any content shared or Used by you on Platform or Application is owned by You in whole and that you have the full copyright for Content, including permission to allow redistribution of that content, including any derivative works for any means</B><SPAN>.</SPAN></FONT></P> 
<LI>
We recommend to use CC-licensed music, CC offers free copyright licenses that anyone can use (without a lawyer) to mark their creative work with the freedoms they want it to carry. Several sites offer music published under Creative Commons flexible copyright licenses. for more info, you can visit http://creativecommons.org/legalmusicforvideos. Please check out the terms of each song license before you use/stream it.</FONT></P> 
<LI> 
<B>License</B>: You hereby grant Company and Users of Platform a royalty-free, non-exclusive right to listen but not record, save, reperform or download , use, reperform or download Content or any part thereof shared by you on Platform. You hereby state that you obtained all relevant rights and copyrights to content shared by you and that you permit any use of content via Platform for its operation and use.</FONT></P> 
<LI> 
<B>Copyright Infringement:</B> Any use of Content not according to this clause 4 to these Terms shall be constructed as Copyright Infringement and you undertake to compensate Company for its damages and for any other revenue generated to You, or any other 3rd Party, from such Copyright Infringement.</FONT></P> 
<LI> 
<B>No Liability:</B> You understand that all Content provided by you, whether publicly posted or privately transmitted, are at your sole responsibility. <B>Company does not control the Content posted via the Platform and, as such, does not guarantee the accuracy, integrity, or quality of Content</B>. You commit to not use the Platform to convey, post, publish, or otherwise transmit any Content that is violation with Clause 2.43 of these Terms. You are solely responsible for any posting of Content, and agree to indemnify Company for any damage arising from such activity violating any laws or terms of service.</FONT></P> 
<LI> 
<B>Prescreen</B>: You acknowledge that Company cannot pre-screen all Content, but that it shall have the right (but not the obligation) in their sole discretion to refuse or move any Content or User Account that is available via the Platform. Company shall have the right to remove any Content or Account that violates these Terms or is otherwise objectionable.</FONT></P> 
<LI> 
<B>Disclosure of Content</B>: You acknowledge and agree that Company may preserve Content and may also disclose Content if required to do so by law or in the good faith belief that such preservation or disclosure is reasonably necessary to: (a) comply with legal process; (b) enforce these Terms; (c) respond to claims that any Content violates the rights of third-parties; or (d) protect the rights, property, or personal safety of Company, its Users, and the public. You understand that the technical processing and transmission of the Service, including your Content, may involve (a) transmissions over various networks and (b) changes to conform and adapt to technical requirements of connecting networks or devices. </FONT></P> 
<LI> 
<B>Harmless:</B> You agree and warrant to hold Company and Users harmless and to immediately indemnify Company or Users for any claim of copyright infringement, trademark dilution or patent infringement for any use of Content according to these Terms. You also agree to indemnify Company and/or Users for any 3rd party lawsuit for Copyright infringement due to their use of Content made available by You.</FONT></P> 
<LI> 
<B>Cease and Decist:</B> Company values others copyright, and therefore shall comply with all state regulations regarding 3rd party copyright. Should you encounter any Content which you believe to be in violation of Copyright Laws and you are the sole owner of, Please file a copyright infringement complaint at our Copyright officer: </FONT><FONT color=#94BF00><U><A href='mailto:abuse@listen2myradio.com'><FONT style='FONT-SIZE: 9pt' size=2>abuse@listen2myradio.com</FONT></A></U></FONT><FONT style='FONT-SIZE: 9pt' size=2> ; Our copyright officer shall examine your complaint and shall forward it to the user who published said Content for his answer. Should Your complaint be false, harassing or in order to prevent legal use of service, you shall bear all liability to compensate the Radio Manager and/or User which you reported as infringing copyright.</FONT></P></LI></OL> 
<center>
      <span class="wideboxbottom"></span> </div>
  </div>
<!-- Footer -->
<div id="footer">
<ul>
