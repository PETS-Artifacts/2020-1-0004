...
<head>
	...
	<link href="/assets/css/style.min.css?v=1486635436" rel="stylesheet">

	<script>
		// Picture element HTML5 shiv
		document.createElement("picture");
		//Paths
		var config = {"paths":{"assets":"","api":""}};	</script>
...
<header class="header" role="banner">
    ...
    <section class="header__menu">
        ...
        <div class="header__main clearfix">
                    ...
                    <ul class="nav-desktop__list">
                        <li class="nav-desktop__item nav-desktop__item--menu">
                            ...
                            <ul class="nav-desktop__list nav-desktop__list--submenu">
                                <li class="nav-do-search nav-desktop__item ">
                                    <a href="/" class="nav-desktop__link">Recently added</a>
                                </li>
                                <li class="nav-desktop__item ">
                                    <a href="/showphotos.php?catsearch=16777216" class="nav-desktop__link">Today's most popular</a>
                                </li>
                                <li class="nav-desktop__item ">
                        ...
                        <li class="nav-desktop__item nav-desktop__item--menu">
                            ...
                            <ul class="nav-desktop__list nav-desktop__list--submenu">
                                <li class="nav-desktop__item">
                                    <a href="http://forums.jetphotos.com" target="_blank" class="nav-desktop__link">Forum</a>
                                </li>
                                <li class="nav-desktop__item">
            ...
            <div class="header__account">
                ...
                <nav id="header-logged-in" class="hidden" role="navigation">
                    <ul class="nav-desktop__list nav-desktop__list--username">
                        <li class="nav-desktop__item nav-desktop__item--menu">
                            <div id="nav-desktop-menu" href="#" class="nav-desktop__link clearfix">
                                <span class="nav-desktop-username"></span>
            ...
            <nav role="navigation">
                <div class="wrapper">
                    <ul class="nav__list">
                            ...
                            <div class="grid">
                                <div class="col-6">
                                    <a href="/" class="nav-do-search nav__link">Recently added</a>
                                    <a href="/showphotos.php?catsearch=16777216" class="nav__link">Today's most popular</a>
        		...
        		<section class="main__section">
                    ...
                    <div class="wrapper">
                        ...
                        <div class="wrapper__flex">
                            <div class="wrapper__flexCol wrapper__flexCol--pad-r-medium">
	...
	<a id="modal-share-twitter" class="resp-sharing-button__link" href="#" target="_blank" aria-label="Share on Twitter">
			...
			<div class="footer__col">
				<div class="wrapper__content wrapper__content--medium">
					<p class="footer__copyright">
						Copyright &copy; 2002-2017 JetPhotos All Rights Reserved.
					</p>
				</div>
			</div>
	...
	<script src="/assets/js/scripts.min.js?v=1486635436"></script>
	<script src="/assets/js/templates/templates.js?v=1486635436"></script>
