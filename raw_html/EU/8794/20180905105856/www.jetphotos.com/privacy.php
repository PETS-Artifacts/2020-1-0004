...
<head>
	...
	<link href="/assets/css/style.min.css?v=1535959994" rel="stylesheet">
...
<header class="header" role="banner">
        		...
        		<section class="main__section">
                    ...
                    <div class="wrapper">
                            ...
                            <div class="wrapper__content wrapper__content--large">
                                ...
                                <p>Like most web sites, we use small bits of data called cookies stored on users' computers. Cookies are parcels of text sent by a server to a web browser and then sent back unchanged by the client each time it accesses that server. Cookies are saved on your computer and do not harm or damage your system in any way. Furthermore they make your navigation easier as they save your settings. For example, a cookie is used to remember users login credentials when they login to the website. You are able to view and control cookies through your web browser.</p>
                                <p>JetPhotos and its partners use cookies to deliver targeted advertisements on an anonymous basis- we do not pass on any personal data to 3rd parties. Information gathered by cookies may be shared with our advertising partners to help measure the effectiveness of an advertising campaign. </p>
                                <p>By using JetPhotos you are giving consent to cookies being used.</p>
                                <h3>List of cookies being used by JetPhotos</h3>
	...
	<script src="/assets/js/scripts.min.js?v=1535959994"></script>
	<script src="/assets/js/templates/templates.js?v=1535959994"></script>
