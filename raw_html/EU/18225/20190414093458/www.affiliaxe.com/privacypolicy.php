    ...
    <section class="blurrMe" style="background-image: url(img/web_bg.jpg);">
    	<div class="centeredContainer">
			...
			<div class="privacy_content">
				...
				<p>Thanks for visiting affiliaXe's Privacy Policy, updated and in sync with the new data protection regulation, in effect from May 25th, 2018.</p>
				<p>This Privacy Policy Agreement between affiliaXe LTD (collectively &ldquo;We,&rdquo; &ldquo;Us, or affiliaXe&rdquo;) and the User ("You") was created to govern the way affiliaXe collects, uses, processes and disclose information collected from users of affiliaXe.com (&ldquo;Website&rdquo;). This Privacy Policy applies to the website, mobile applications, products and services offered by affiliaxe. By visiting the Website, you accept&nbsp;the terms and conditions contained in this Privacy Policy. Users of the Website include consumers who visit the Site, affiliates, and advertisers who work with affiliaXe via the Site and provide us with personal information.</p>
				<p><strong>About affiliaXe</strong></p>
				<p>As an affiliate network, affiliaXe provides services via the Internet to both Publishers and Advertisers. The Website acts as an intermediary agent between a person, entity, affiliate or its agent ("Publisher") and an "Advertiser" (another person, company, or entity).</p>
				<p>A Publisher is operating Website(s) (internet domain, or a portion of a domain), and other promotional methods to drive traffic to another Website or Website content. The Publisher may earn financial compensation ("Payouts") for "Transactions" (actions made by Visitors as defined by the Advertiser). The "Visitor" (any person or entity that is not the Publisher, the Publisher's agent, or the advertiser) is making an action (registration, purchase, signup, etc.) which is referred to the Publisher through an Internet connection ("Link") to a Website operated by the Advertiser. The Advertiser compensates the Publisher on actions, by this Agreement and the Program Payout specifications.</p>
				<p><strong>Which personal data we collect</strong></p>
				<p><strong>Website Users </strong></p>
				<p>We collect data from you when you register to the Website. We consider personal data to be, but not limited to:</p>
				<ul>
					<li>Full name</li>
					<li>Title</li>
					<li>Email address</li>
				...
				<p><br> For partners who work with us on a monthly payment basis, we may also ask for the additional identification details to be compliant with international and local KYC (Know Your Customer) regulations.</p>
				<p>We may also collect non-personal identification information about users whenever they interact with our Site. The non-personal identification information may include:</p>
				<ul>
					<li>Browser name</li>
					...
					<li>Unique mobile device ID number if you access our services via a mobile application</li>
				...
				<p>You can always refuse to supply personal information, however, please consider that not providing personal information may prevent you from conducting any Site related activities and our being able to provide certain services to you and to interact with you as a Site user, such as in an affiliate or advertiser relationship with us. &nbsp;</p>
				<p><br> <strong>Website Visitors </strong></p>
				<p>For visitors to the Site (non-affiliates and non-advertisers) who do not share any information with us, we may collect information such as IP address, browser name, computer and technical connection information to our Website, mobile device type, network and unique ID. We do not, however, collect the e-mail address of such visitors to our Site. &nbsp;</p>
				<p><strong>Data processing &amp; use</strong></p>
				<p>We use external platforms to process and maintain the Personal Information of the User. These platforms act as data processors for the personal data for which we are the data controller.</p>
				<p>The data processors have taken reasonable technical and organizational measures to protect against the information being accidentally or illegally destroyed, becoming lost or deteriorating, and to protect against the information being disclosed to unauthorized persons, being misused, or in other ways being processed in violation of data protection laws.</p>
				<p>We may store personal data, and any other kind of data strictly in compliance with applicable international and local data protection and privacy legislation and our contractual duties and will prevent unauthorized access to data to the best of our abilities.</p>
				<p>Provided you have given your consent or have not objected &ndash; where legal provisions allow so &ndash; we may use your personal data for advertising. You may withdraw your consent at any time and ask us to delete your Personal Information. When you register to affiliaXe and yet to click 'Submit,' your personal</p>
				<p><br> information will be retained for 30 days. Once you click 'Submit,' your personal information will be automatically processed by third-party platforms as stated in the Data Controller and Processor section above.</p>
				<p><strong>&nbsp;</strong></p>
				<p><strong>Why We Collect Personal Data </strong><br> Any of the information we collect from you may be used in one of the following ways:<br></p>
				<ul>
					...
					<li>We may process information to personalize user experience on affiliaXe.com, respond to<br> inquiries and provide users with relevant content.</li>
					<li>Your contact information is used for, but not limited to, sending periodic administrative emails, updates and notifications regarding your account, promotional emails &amp; further notifications relating your activity, and any changes to our terms, conditions, and</li>
					...
					<li>We may use cookies, pixel tags and other tracking technologies to measure and improve our services and develop features and&nbsp;functionalities on our sites, apps, and</li>
					<li>We may use IP Addresses for administration and security purposes, such as calculating usage levels of our site, app, andAPI, helping diagnose server problems, and detecting fraud and spam behavior.</li>
				</ul>
				<p>Your information, whether public or private, will not be sold, exchanged, transferred, or given to any other company for any reason whatsoever, without your consent.</p>
				<p><strong>How we protect your personal data</strong></p>
				<p>We implement a variety of security measures to keep your personal information safe when you enter, submit, or access your personal information.</p>
				<ul>
				...
				<p><strong>Data Collection Technologies </strong><br> <br> <strong>'Cookies'</strong><br> We may use 'cookies' to enhance your experience. We use 'Cookies' to store your preferences for future visits, record information and user-specific information, such as what pages users access or visit. Cookies are small files that a site or its service provider transfers to your computer's hard drive through your Web browser (if you allow). Cookies enable the sites or service provider systems to recognize your browser, capture and remember certain information. You may choose to turn off 'cookies,' however, if you do, some features will be disabled - features which make your site experience more efficient and without them affiliaXe may not function properly.</p>
				<p><strong>Clear GIFs, pixel tags, and other technologies <br> </strong>Our service providers or we may use clear GIFs (also known as web beacons, web bugs or pixel tags), in connection with our Site to track the actions of Website users and visitors to our Site, help us manage content, and compile statistics about Site usage.</p>
				<p>Our service providers or we may also use clear GIFs in HTML emails to our users, to help us track e-mail response rates, identify when our emails are viewed, and track whether our emails are forwarded.</p>
				<p><strong>Third-party analytics<br> </strong>We use service providers, such as Google Analytics, to evaluate the use of our Site and Services. Our service providers or we use automated devices and applications to evaluate the use of our Site and Services. Our service providers or we use these tools to help us improve our Site, Services, performance, and user experiences.</p>
				<p><strong><br> Re-targeting technologies </strong></p>
				<p>Our website utilizes re-targeting technologies that enable us to advertise directly to our visitors and users from our partners&rsquo; websites. Re-targeting technologies analyze your cookies and display advertisement based on your past surfing behavior. We believe that the display of a personalized, interest-based advertising is more beneficial for our website users. <br> We also work with other companies who use tracking technologies to serve ads on our behalf across the Internet. These companies may collect information about your visits to our websites or (mobile) applications and your interaction with our communications, including advertising.&nbsp;</p>
				<p><br> <br> <strong>Our disclosure of your personal data</strong></p>
				<p>We consider your information to be a vital part of our relationship with you. Therefore, we do not sell, trade, or otherwise transfer your personal information to outside parties without your consent or as otherwise specified in this Privacy Policy.</p>
				<p>Here are the following circumstances in which we may share your information with certain third parties:</p>
				<ul>
					...
					<li>We sometimes hire related third-parties to perform certain business-related functions, which may include mailing information, maintaining databases and processing payments.</li>
					<li>Following the&nbsp;Law, we&nbsp;may&nbsp;disclose your information&nbsp;to third parties if&nbsp;we&nbsp;determine that such disclosure&nbsp;is reasonably&nbsp;necessary&nbsp;to&nbsp;comply&nbsp;with the&nbsp;law, protect our rights or prevent fraud or abuse of affiliaXe, our users, and</li>
				...
				<p><br> <br> <strong>Links to third-party websites</strong><br> Occasionally, at our discretion, we may include or offer third party products or services. These third-party sites have separate and independent privacy policies. We, therefore, have no responsibility or liability for the content and activities of these linked sites. Nonetheless, we seek to protect the integrity of our site and welcome any feedback about these sites. We highly advise you to read the Privacy Policy and Terms &amp; Conditions of such third-parties before any use. <br> <strong><br> Your Rights</strong></p>
				<p>Your principal rights under the data protection law are:</p>
				<ul>
					<li>The right to visit the Website anonymously.</li>
					<li>The right to access your personal information.</li>
					<li>The right to change your email settings under <a href="http://e-mail.affiliaxe.com/wf/click?upn=2bliMlpxEtzAVgJsmdVAh7-2BKht0KEdMvv24VZRg6ongqs-2B9XN-2BDua9NvGKKy5FJsXTO8IJMASdfDPQQiK0Bd7ZjOwTknSfzkiyDO-2B3VxIbG0cY-2FOPSgsAUarj8tMsdCQ4mY-2ByumEtEc7Usnxe8FIRJ4CWPLJPau-2BniogauRgYyMCVTqYVVu6ILrpyA2NnagbmT84FDvB-2FWweq83hCguxWypz3mvm2M8usTWhyMrFAYjDaN0NWTzs2HADwKTklusOJYK974FZMM-2Fj7mBS-2BG10y7Kf28kYENd28WtD5s3D5yZGjLm1YJbC1Q3cAV5KQ6BZe1JbkQp8xibGd8qig1hKdtzN-2FfeU5wOW04Ew6yxMqUu6CXwELaoc7HQ-2BUiLmVgv2_ZuFOCEi8muBK8Zb9Tc3-2FvYYTmv5OZr-2FER5EX91dNdvLqmJlQKp8XvYs4Cg27qtfUoUd9ISCfhc6g5miW597RjPjylFpNkIBXYT5yr5QMjkxWg6zVUEbFkhfssQ4CXFdoFed39jjvOAsl4LDeina562GBtACwrJIVVF7SuZ-2FI-2BQWRxKkUs-2FXjeAAlLEA4P8ztJambwQ8M5Ixl-2BzPlj2keDg-3D-3D">unsubscribe</a>.</li>
				...
				<p>Because you have submitted your email address upon registration, we may send periodic emails with information on new products, new offers, notifications, services or upcoming events. If you do not wish to receive emails from us, you may <a href="http://e-mail.affiliaxe.com/wf/click?upn=2bliMlpxEtzAVgJsmdVAh7-2BKht0KEdMvv24VZRg6ongqs-2B9XN-2BDua9NvGKKy5FJsXTO8IJMASdfDPQQiK0Bd7ZjOwTknSfzkiyDO-2B3VxIbG0cY-2FOPSgsAUarj8tMsdCQ4mY-2ByumEtEc7Usnxe8FIRJ4CWPLJPau-2BniogauRgYyMCVTqYVVu6ILrpyA2NnagbmT84FDvB-2FWweq83hCguxWypz3mvm2M8usTWhyMrFAYjDaN0NWTzs2HADwKTklusOJYK974FZMM-2Fj7mBS-2BG10y7Kf28kYENd28WtD5s3D5yZGjLm1YJbC1Q3cAV5KQ6BZe1JbkQp8xibGd8qig1hKdtzN-2FfeU5wOW04Ew6yxMqUu6CXwELaoc7HQ-2BUiLmVgv2_ZuFOCEi8muBK8Zb9Tc3-2FvYYTmv5OZr-2FER5EX91dNdvLqmJlQKp8XvYs4Cg27qtfUoUd9ISCfhc6g5miW597RjPjylFpNkIBXYT5yr5QMjkxWg6zVUEbFkhfssQ4CXFdoFed39jjvOAsl4LDeina562GBtACwrJIVVF7SuZ-2FI-2BQWRxKkUs-2FXjeAAlLEA4P8ztJambwQ8M5Ixl-2BzPlj2keDg-3D-3D">unsubscribe</a>.</p>
				<p>If you supply us your postal address, we may send you periodic mailings with information on new products and services or upcoming events. If you do not wish to receive such mailings, please let us know by calling us at the number provided below, writing to us at the below address, or e-mailing us at partners@affiliaxe.com.</p>
				<p>Persons who supply us with their telephone numbers may receive telephone contact from us with information regarding new products and services or upcoming events. If you do not wish to receive such telephone calls, please let us know by calling us at the number provided below, writing to us at the below address, or e-mailing us at partners@affiliaxe.com.</p>
				<p><strong><br> How Does affiliaXe Comply with GDPR Regulations</strong><br> affiliaXe serves as a data controller under the GDPR and adheres to the principles and rules of the GDPR.</p>
				<p>Under GDPR, affiliaXe takes the following measures about the personal data of EU residents:</p>
				<ul>
				...
				<p><strong><br> EU-U.S. Privacy Shield</strong></p>
				<p>affiliaXe LTD. fully respect the Personal Information we receive from our customers in the U.S, EU, and Switzerland. The company complies with the U.S.-EU Privacy Shield Framework as set forth by the U.S. Department of Commerce regarding the collection, use, and retention of personal information transferred from the European Union to the United States. If there is any conflict between the terms of this privacy policy and the Privacy Shield Principles, the Privacy Shield Principles shall govern. To learn more about Privacy Shield, please visit&nbsp;<a href="http://www.privacyshield.gov/">www.privacyshield.gov</a>.</p>
				<p><strong>COPPA (Children Online Privacy Protection Act)</strong></p>
				<p>Under the Children&rsquo;s Online Privacy Protection Act (COPPA), our Website, Products and Services are not intended for children under 13 years of age or the relevant age of majority, and we do not knowingly collect personal information from children under that age. If you are under 13 years of age or the age of majority, you are not permitted to create an account on affiliaXe and submit any personal information to us. If you are the parent or legal guardian of a child under 13 years old and you believe we have received personal information from your child, please contact us at&nbsp;partners@affiliaxe.com.</p>
				<p><strong>&nbsp;</strong></p>
				<p><strong>CAN-SPAM</strong><strong> Act</strong></p>
				<p>The CAN-SPAM Act law sets the rules for commercial email, establishes requirements for commercial messages, gives recipients the right to have emails stopped from being sent to them, and spells out tough penalties for violations.</p>
				<p>We collect your email address to:<br> &nbsp;&bull;&nbsp;Send information, respond to inquiries, and other requests or questions<br> <br> To be by CAN-SPAM, we agree to the following:</p>
				<ul>
				...
				<p><br> <strong>Online Privacy Policy Only</strong>&nbsp;<br> This online privacy policy applies only to information collected through our website and not to information collected offline.</p>
				<p><strong>Changes to our Privacy Policy</strong><br> We reserve the right to change this Privacy Policy from time to time. Once we do, we will revise the updated date at the bottom of the page. We may notify you of such changes and updates via email or post them on this site. We highly advise to re-visit our Privacy Policy page to remain informed on how we collect and protect your personal information.</p>
				<p><strong>&nbsp;</strong></p>
				<p><strong>Your Consent</strong><br> By using our site, you signify your consent to this privacy policy. If you do not agree to this policy, please do not use our Site. <br> <br> <strong>Contacting Us</strong></p>
				<p>If you have any questions or concerns regarding our privacy policy or that you believe affiliaXe LTD has failed to follow its Principles regarding your data, please contact us, and we will do our best to resolve any such disputes or complaints promptly.</p>
				<p><strong>Data Protection Authority: </strong></p>
				<p><strong>GDPR Officer</strong><br> reut@affiliaxe.com</p>
				<p><strong>affiliaXe Support</strong><br> <a href="mailto:partners@affiliaxe.com">partners@affiliaxe.com</a></p>
				<p><strong>affiliaXe</strong><strong> LTD.</strong><br> http://www.affiliaXe.com/<br> 90 Begin Road<br> Tel Aviv, Israel 68037, Israel</p>
			</div>
			<div></div>
		</div>    
    </section>
            ...
            <footer>
                        ...
                        <div class="row top_footer"><!-- end .col --><!-- end .col -->
                            ...
                            <div class="col-md-4 contact">
                                <div class="activepublishers">
                                    <span style="color:#FFF;">22,333</span>
                                ...
                                <div class="liveoffers">
									...
									<span class="grayfootertext serversLink">
										<span style="color:#8e8e8e;">Servers Online</span>
									</span>
								</div>
                            </div>
                            <!-- end .col -->
                ...
                <div class="fullspan copy">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="footerleft">&copy; 2010-2019 affiliaXe Ltd.</div>
