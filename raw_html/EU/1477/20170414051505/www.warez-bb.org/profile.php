...
<script type="text/javascript">
  var SID = '09aec7dd904f8a218908095bc72675a9';
    </script>
    ...
    <div id="header" style="background-image: url(https://img11.warez-bb.org/wbb3_theme/logos/cellpic_bkg.jpg); background-repeat: repeat-x;">
        ...
        <div id="slogan">
            <div class="header"><h2>Come as guests, stay as family.</h2></div>
                        ...
                        <div class="sub-text">New here? Why not check out our <a href="./viewforum.php?f=40">Introduction Section</a>? Tell us who you are to get to know you better.</div>
                    </div>
            </div>
</div>
        ...
        <div class="inner">
            <div class="general-links">
            	<div class="visit-times">
                	                    <span>The time is Fri Apr 14, 2017 5:15 am</span>
                                    </div>
