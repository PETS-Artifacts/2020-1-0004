...
<script type="text/javascript">
  var SID = 'b0a0a0ded9111b2c7955430f70474e46';
    </script>
    ...
    <div id="header" style="background-image: url(https://img12.warez-bb.org/wbb3_theme/logos/cellpic_bkg.jpg); background-repeat: repeat-x;">
        ...
        <div id="slogan">
            <div class="header"><h2>Come as guests, stay as family.</h2></div>
                        ...
                        <div class="sub-text">Litesurf can make Warez-BB load faster. <a href="https://www.warez-bb.org/viewtopic.php?t=21569">More Info</a></div>
                    </div>
            </div>
</div>
        ...
        <div class="inner">
            <div class="general-links">
            	<div class="visit-times">
                	                    <span>The time is Mon May 06, 2019 1:52 am</span>
                                    </div>
