...
<script type="text/javascript">
  var SID = '92dff7f9ae83b63380a39010f68cc8d6';
    </script>
    ...
    <div id="header" style="background-image: url(https://img12.warez-bb.org/wbb3_theme/logos/cellpic_bkg.jpg); background-repeat: repeat-x;">
        ...
        <div id="slogan">
            <div class="header"><h2>Come as guests, stay as family.</h2></div>
                        ...
                        <div class="sub-text">Watch out for phishing emails. <a href=./../viewtopic.php?t=1186680>Learn how to tell the difference here.</a></div>
                    </div>
            </div>
</div>
        ...
        <div class="inner">
            <div class="general-links">
            	<div class="visit-times">
                	                    <span>The time is Tue Nov 06, 2018 11:58 pm</span>
                                    </div>
