...
<script type="text/javascript">
  var SID = 'a1277ce2132f145bebfaec59129e787e';
    </script>
    ...
    <div id="header" style="background-image: url(https://img12.warez-bb.org/wbb3_theme/logos/cellpic_bkg.jpg); background-repeat: repeat-x;">
        ...
        <div id="slogan">
            <div class="header"><h2>Come as guests, stay as family.</h2></div>
                        ...
                        <div class="sub-text">If you cannot find something on the site, please use the Request Forums. <b><u><i>DO NOT</u></i></b> make requests in the regular forums!</div>
                    </div>
            </div>
</div>
        ...
        <div class="inner">
            <div class="general-links">
            	<div class="visit-times">
                	                    <span>The time is Thu Feb 01, 2018 6:13 am</span>
                                    </div>
