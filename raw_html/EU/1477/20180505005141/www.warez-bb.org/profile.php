...
<script type="text/javascript">
  var SID = 'd958e6011420848bb80aaa78f56abc58';
    </script>
    ...
    <div id="header" style="background-image: url(https://img12.warez-bb.org/wbb3_theme/logos/cellpic_bkg.jpg); background-repeat: repeat-x;">
        ...
        <div id="slogan">
            <div class="header"><h2>Come as guests, stay as family.</h2></div>
                        ...
                        <div class="sub-text">If you come across dead links <img alt="report" src="https://img11.warez-bb.org/images/icon_report.gif" /> it! Don't ignore it! Complaining in the topic doesn't help you or the site!</div>
                    </div>
            </div>
</div>
        ...
        <div class="inner">
            <div class="general-links">
            	<div class="visit-times">
                	                    <span>The time is Sat May 05, 2018 12:51 am</span>
                                    </div>
