...
<script type="text/javascript">
  var SID = '3817b034ad8b48c42f79b0f791508067';
    </script>
    ...
    <div id="header" style="background-image: url(https://img12.warez-bb.org/wbb3_theme/logos/cellpic_bkg.jpg); background-repeat: repeat-x;">
        ...
        <div id="slogan">
            <div class="header"><h2>Come as guests, stay as family.</h2></div>
                        ...
                        <div class="sub-text">A 502 error is really a pain to get but can be fixed by you just by deleting your browser cookies and clearing your cache</div>
                    </div>
            </div>
</div>
        ...
        <div class="inner">
            <div class="general-links">
            	<div class="visit-times">
                	                    <span>The time is Sat Mar 24, 2018 3:21 am</span>
                                    </div>
