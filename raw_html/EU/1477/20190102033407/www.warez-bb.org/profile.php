...
<script type="text/javascript">
  var SID = 'a9f600b699bf30f756a52095520aec00';
    </script>
...
<div id="header-wrapper">
    <div id="header" style="background-image: url(https://img12.warez-bb.org/images/cellpic_bkg_hny.jpg); background-repeat: repeat-x;">
        <div id="logo">
            <div><a href="/index.php"><img src="https://img12.warez-bb.org/images/wbb_logo_hny.jpg"  alt="Warez-BB.org" title="Warez-BB.org" /></a></div>
        </div>
        <div id="slogan">
            <div class="header"><h2>Come as guests, stay as family.</h2></div>
        
                        
                        <div class="sub-text">Our members and our staff are here to help. You're a topic away from getting answers.</div>
                    </div>
                <div id="right-logo">
            <div><img src="https://img12.warez-bb.org/images/wbb_right_hny.jpg" alt="Warez-BB.org" title="Warez-BB.org" width="350" height="110" /></div>
        </div>
            </div>
</div>
        ...
        <div class="inner">
            <div class="general-links">
            	<div class="visit-times">
                	                    <span>The time is Wed Jan 02, 2019 3:34 am</span>
                                    </div>
