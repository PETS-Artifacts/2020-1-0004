...
<script type="text/javascript">
  var SID = '0e123bbd9c505b9c8d33cf74654039db';
    </script>
...
<div id="header-wrapper">
    <div id="header" style="background-image: url(https://img11.warez-bb.org/images/cellpic_bkg.jpg); background-repeat: repeat-x;">
        <div id="logo">
            <div><a href="/index.php"><img src="https://img11.warez-bb.org/images/wbb_logo_chny.jpg"  alt="Warez-BB.org" title="Warez-BB.org" /></a></div>
        </div>
        <div id="slogan">
            <div class="header"><h2>Come as guests, stay as family.</h2></div>
                ...
                <div id="right-logo">
            <div><img src="https://imageshack.com/a/img924/922/hn209g.png" alt="Warez-BB.org" title="Warez-BB.org" width="290" height="110" /></div>
        </div>
            </div>
</div>
        ...
        <div class="inner">
            <div class="general-links">
            	<div class="visit-times">
                	                    <span>The time is Thu Feb 02, 2017 5:57 am</span>
                                    </div>
