...
<script type="text/javascript">
  var SID = '57440864adf178a11384d42dd3e38aab';
    </script>
...
<div id="header-wrapper">
    <div id="header" style="background-image: url(https://img11.warez-bb.org/wbb3_theme/logos/cellpic_bkg.jpg); background-repeat: repeat-x;">
        <div id="logo">
            <div><a href="/index.php"><img src="https://img11.warez-bb.org/wbb3_theme/logos/wbb_logo_v3.jpg"  alt="Warez-BB.org" title="Warez-BB.org" /></a></div>
        </div>
        <div id="slogan">
            <div class="header"><h2>Come as guests, stay as family.</h2></div>
        
                        
                        <div class="sub-text">@warez-bb.org added you on IM? <u>Block</u> it immediately as this is not any staff. <u>Never</u> give your password out!</div>
                    </div>
            </div>
</div>
        ...
        <div class="inner">
            <div class="general-links">
            	<div class="visit-times">
                	                    <span>The time is Tue Dec 06, 2016 12:21 am</span>
                                    </div>
