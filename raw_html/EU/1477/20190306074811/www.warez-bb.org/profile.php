...
<script type="text/javascript">
  var SID = '5176c24d5f97f964cbfd72c239e66b12';
    </script>
...
<div id="header-wrapper">
    <div id="header" style="background-image: url(https://img12.warez-bb.org/wbb3_theme/logos/cellpic_bkg.jpg); background-repeat: repeat-x;">
        <div id="logo">
            <div><a href="/index.php"><img src="https://img12.warez-bb.org/wbb3_theme/logos/wbb_logo_v3.jpg"  alt="Warez-BB.org" title="Warez-BB.org" /></a></div>
        </div>
        <div id="slogan">
            <div class="header"><h2>Come as guests, stay as family.</h2></div>
        
                        
                        <div class="sub-text">If you start getting a "502 Error (Bad Gateway)" try deleting your Cookies in most cases this will fix your problem</div>
                    </div>
            </div>
</div>
        ...
        <div class="inner">
            <div class="general-links">
            	<div class="visit-times">
                	                    <span>The time is Wed Mar 06, 2019 7:48 am</span>
                                    </div>
