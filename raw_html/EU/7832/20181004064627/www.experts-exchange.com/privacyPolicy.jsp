...
<html>
  <head>
    ...
    <link rel="stylesheet" href="https://cdn.experts-exchange.com/css/2/58ed0e340aab68b3ea084f48a5487b9a8c7509b202afe83c82792fb3717e9d7d.css" media="all" />
    <link rel="stylesheet" href="https://cdn.experts-exchange.com/css/2/7fc20297d298d6187df4d9611594ec1303f6a957c267eb36a7a7874603cf22d6.css" media="all" />
    <script src="https://cdn.experts-exchange.com/js/2/4a2bbc4500edb076adabcb8ffac3f3c8a6ec53b94fee2073ba831989b8575934.js" type="text/javascript"></script>
    <script src="https://cdn.experts-exchange.com/js/2/432abeb30596927e521a606a1597f3449908e857856ef185c07b880c60f4fa69.js" type="text/javascript"></script>
  ...
  <body class="desktop cloudClassNewHeader" itemscope="itemscope" itemtype="http://schema.org/WebPage">
    <script type="text/javascript">
        dataLayer = [{"continent":"NA","country":"USA","environment":"Live","experienceStateTreatment":"LO-LO_CLEAN_SLATE"}]
    </script>
    <noscript>
      ...
      <div id="wrapper1">
        <div id="wrapper2">
          <div id="header">
            <div id="headerInnerWrap">
                  ...
                  <div class="topHeader-inner">
                    <div class="headerLogo">
                      <div class="component textComponent" id="textComponent">
                        <div class="body">
                          <div class="section">
                            <a href="/" title="Experts Exchange" class="topHeader-logo"><span>Experts Exchange</span></a>
                          </div>
                        </div>
                      </div>
                    </div>
                    <div class="headerSearch" id="headerSearch">
                      <div class="searchFrag">
                        <span id="headerSearchToggle" class="headerSearchToggle" title="Search"><span></span></span>
                    ...
                    <div class="headerMainLinks">
                      <div class="component textComponent" id="textComponent-id3">
                        <div class="body">
                          <div class="section">
                            <a class="techSupport" alt="Technology Support" href="/askQuestion.jsp"><span>Technology Support</span></a>
                            
                            <ul class="navSub">
                              <li id="mobileSubNav">
                                <a class="headerCourses" alt="Training Courses" href=""><span>Training Courses</span></a>
                                <ul class="coursesSubNav">
                                  <li><a href="/courses/">Individual</a></li>
                                  <li><a href="/courses/business.jsp">Business</a></li>
                                </ul>
                              </li>
                            </ul>
                      ...
                      <script type="text/javascript">
                      $("a.headerCourses").click(function(event){
                          event.preventDefault();
                      });
                      </script>
                      <script type="text/javascript" id="contentJavascript-id5">
                        jqToggleClassOnClick("a.headerCourses", "ul.coursesSubNav", "menuOpen");
                      </script>
                    </div>
                    <div class="headerHamburgerWrapper">
                      <div class="component textComponent" id="textComponent-id5">
                        <div class="body">
                          <div class="section">
                            <span id="headerHamburgerButton" class="headerHamburgerButton"></span>
                          </div>
                        </div>
                      </div>
                      <div class="headerHamburgerMenu hidden header2018" id="headerHamburgerMenu">
                        <div class="headerMainLinks">
                        ...
                        <div class="headerLogin">
                          <div class="component adaptiveText topHeader-login" id="adaptiveText">
                            <div class="body">
                              <div class="section">
                                <a href="/login.jsp?redirect=/privacyPolicy.jsp" class="login loginPopup"><span>Log In</span></a>
                              </div>
                            </div>
                          </div>
                        ...
                        <div class="headerCta-Lo">
                          <div class="component textComponent" id="textComponent-id8">
                            <div class="body">
                              <div class="section">
                                <ul class="navSubPremium">
                                  <li>
                                    <a class="headerPremium" alt="Go Premium" href="#no"><span>Go Premium</span></a>
                                    <ul>
                          ...
                          <script type="text/javascript" id="contentJavascript-id8">
                            jqToggleClassOnClick(".headerPremium", ".headerPremium", "openMenu");
                          </script>
                        </div>
                      </div>
                    ...
                    <div class="headerLogin">
                      <div class="component adaptiveText topHeader-login" id="adaptiveText-id2">
                        <div class="body">
                          <div class="section">
                            <a href="/login.jsp?redirect=/privacyPolicy.jsp" class="login loginPopup"><span>Log In</span></a>
                          </div>
                    ...
                    <div class="headerCta-Lo">
                      <div class="component textComponent" id="textComponent-id9">
                        <div class="body">
                          <div class="section">
                            <ul class="navSubPremium">
                              <li>
                                <a class="headerPremium" alt="Go Premium" href=""><span>Go Premium</span></a>
                                <ul>
                                  <li><a href="/individualLicense.jsp">Individual</a></li>
                                  <li><a href="/business.jsp">Business</a></li>
                                </ul>
                              </li>
                            </ul>
                      ...
                      <script type="text/javascript">
                      $("a.headerPremium").click(function(event){
                          event.preventDefault();
                      });
                      </script>
                    </div>
              ...
              <script type="text/javascript" id="contentJavascript-id11">
                ...
                [UA_EE.Product.PREMIUM_MEMBERSHIP],
                'privacyPolicy_LO',
                'Experts Exchange',
                'Go Premium');
              </script>
          ...
          <div id="bodyWrapper">
            <div id="columnsWrapper">
              <div class="component textComponent stlco privacyPolicy component-alt-bg2" id="textComponent-id11">
                <header class="head">
                ...
                <div class="body">
                  <div class="section">
                    ...
                    <p>You have the right to request a copy of the personal information Experts Exchange holds about you and to have any inaccuracies corrected. All such enquiries should be sent to our Chief Privacy Officer. Additionally, you may at any time change your information by updating your profile and/or settings.</p>
                    ...
                    <p>This service verifies adherence to both the EU and Swiss Privacy Shield Policy by means of in-house verification by the management of this company. Experts Exchange, LLC is subject to the investigatory and enforcement powers of the Federal Trade Commission.</p>
                    
                    <p>Finally, as a last resort and in limited situations, EU and Swiss individuals may seek redress from the Privacy Shield Panel, a binding arbitration mechanism.</p>
                    
                    <p><br>
                    <i>This policy was last modified on 24 September, 2018</i></p>
        ...
        <div id="footer">
          <div id="footerInnerWrap">
            <div class="footer2017Q4">
              <div class="footer2017Q4Wrapper">
                <div class="footerSection footerSectionPrimary">
                  <div class="component textComponent" id="textComponent-id12">
                    <div class="body">
                      <div class="section">
                        <dl>
                        <dt>Services</dt>
                        <dd><a href="/plansAndPricing.jsp">Plans and Pricing</a></dd>
                        <dd><a href="/business.jsp">For Business</a></dd>
                        <dd><a href="/contribute.jsp">Become an Expert</a></dd>
                        <dd><a href="/vpsHowItWorks.jsp">Advertise</a></dd>
                        </dl>
                        
                        <dl>
                        <dt>Our Mission</dt>
                        <dd><a href="/whoWeAre.jsp">Who We Are</a></dd>
                        <dd><a href="/careers.jsp">Careers</a></dd>
                        <dd><a href="http://blog.experts-exchange.com" target="_blank">Blog</a></dd>
                        <dd><a href="/contactUs.jsp">Contact Us</a></dd>
                        
                        <dd><a href="/reviews.jsp">Reviews</a></dd>
                        <dd><a href="/hallOfFame.jsp">Expert Hall of Fame</a></dd>
                        </dl>
                      </div>
                    </div>
                  </div>
                </div>
                <div class="footerSection footerSectionSecondary">
                  <div class="component textComponent" id="textComponent-id13">
                    <div class="body">
                      <div class="section">
                        <a href="/" title="Experts Exchange" class="footerLogo"><span>Experts Exchange</span></a>
                      </div>
                    </div>
                  </div>
                  <div class="component textComponent footerSocialLinks" id="textComponent-id14">
                    <div class="body">
                      <div class="section">
                        <a class="blog" href="/topics/experts-exchange/" target="_blank"></a>
                        ...
                        <a class="instagram" href="https://www.instagram.com/experts_exchange/" target="_blank"></a>
                  ...
                  <div class="component textComponent footerCopyright" id="textComponent-id15">
                    <div class="body">
                      <div class="section">
                  ...
                  <div class="component textComponent footerSupportLinks" id="textComponent-id16">
                    <div class="body">
                      <div class="section">
            ...
            <div id="deprecatedBrowserWarning">
              <span class="component textComponent" id="textComponent-id17"></span>
            </div>
            <span class="component textComponent" id="textComponent-id18"></span>
            <script type="text/javascript" id="contentJavascript-id13">
              bpBrickHeight();
            </script>
            <script type="text/javascript" id="contentJavascript-id14">
              bpPlanCount();
            </script>
    ...
    <script type="text/javascript">window.NREUM||(NREUM={});NREUM.info={"errorBeacon":"bam.nr-data.net","licenseKey":"a5f224d161","agent":"","beacon":"bam.nr-data.net","applicationTime":480,"applicationID":"3642000,7293104","transactionName":"ZQNRMkZYW0tXW0QPXFxJAUl4dhUVFkhCD0VTBUo2W1VcW08WWhVD","queueTime":0,"atts":""}</script>
  </body>
</html>
