...
<html>
  <head>
    ...
    <link rel="stylesheet" href="https://cdn.experts-exchange.com/css/2/22b76f29c484b238d271991e47cb3adfbbd813b6d8a16421fd815d555c07c3a2.css" media="all" />
    <link rel="stylesheet" href="https://cdn.experts-exchange.com/css/2/cc23e4f2f293a1d6a9e7e4a1f7d409762b481017e51e466df5c17d96ffcce94c.css" media="all" />
    <script src="https://cdn.experts-exchange.com/js/2/370b0ee13e06441a4ac97f31d2e6436dd12bda2cebf67f6eae7c5f82b37f4847.js" type="text/javascript"></script>
    <script src="https://cdn.experts-exchange.com/js/2/48077a137a7c1beeaedf18adf50438a4efe0e6f21653b4e22d522926b59debcf.js" type="text/javascript"></script>
  ...
  <body class="desktop" itemscope="itemscope" itemtype="http://schema.org/WebPage">
          ...
          <div id="header">
            <div id="headerInnerWrap">
              <div id="topHeaderBannerWrap">
                <div class="component topBanner bannerColorOrange securityQuestionsBannerWrapper" id="topBanner" data-ptype="UNKNOWN" data-refid="283" data-rtid="810" data-taid="0">
                  <div class="body securityQuestionsBannerWrapper">
                    <div class="section">
                      <div class="nolinks content">
                        <!--- Priority Questions Banner
                        
                        outside class securityQuestionsBannerWrapper -->
                        
                        
                        <style>
                        #securityQuestionsBanner { 
                            background: url(//blog.experts-exchange.com/wp-content/uploads/2017/11/securityQuestionsBanner.png);
                            background-size: cover;
                            background-position: top;
                            margin: 0 auto;  
                            text-align: center;
                        }
                        #securityQuestionsBanner  .securityQuestionText {
                            background: #222;
                            padding: 10px 25px;
                            display: inline-block;
                            border-width: 0 3px 0 3px;
                            border-style: solid;
                            -webkit-border-image: -webkit-gradient(linear, 0 0, 0 100%, from(#CFA902), to(#9F8100)) 1 87%;
                            -webkit-border-image: -webkit-linear-gradient(#CFA902, #9F8100) 1 87%;
                            -moz-border-image: -moz-linear-gradient(#CFA902, #9F8100) 1 87%;
                            -o-border-image: -o-linear-gradient(#CFA902, #9F8100) 1 87%;
                            border-image: linear-gradient(to bottom, #CFA902, #9F8100) 1 87%;
                        }
                        .securityQuestionsBanner .section { 
                            width: 100%;  
                            position: relative; 
                            height: auto;
                        }
                         .securityQuestionsBannerWrapper .section .close { 
                            position: absolute; 
                            right: 0; 
                            top: 0; 
                            color: transparent;
                        ...
                        .securityQuestionsBannerWrapper .section a.close:after {
                            color: #fff;
                            content: "+";
                            font-size: 2rem;
                            position: absolute;
                        ...
                        .securityQuestionsBanner .section a.close span {
                            display: none;
                        }
                        #securityQuestionsBanner p { 
                            margin-right: 25px; 
                            color: #fff;
                            font-size: 1.6rem; 
                            display: inline-block; 
                        ...
                        #securityQuestionsBanner .accentedGold {
                           color: #CFA902;
                        }
                        #securityQuestionsBanner .bannerButton { 
                            padding: 0 20px; 
                            font-size: 1.2rem; 
                            height: 30px; 
                            line-height: 3rem; 
                        ...
                        #securityQuestionsBanner .bannerButton:hover {  
                            background: #9F8100;
                        ...
                        <div id="securityQuestionsBanner">
                        <div class="securityQuestionText">
                        <p><strong>Question Security</strong> <span class="accentedGold">|</span> Adjust the privacy of each question you ask.</p>
                         
                                <a class="bannerButton" href="/register.jsp?cid=questionsecuritytopbannerLO&utm_source=experts-exchange&utm_medium=top%20banner&utm_campaign=security_questionLO&regActId=560&redirect=/askQuestion.jsp">Join to Ask</a>
                        
                        </div>
                        </div>
                        
                        <script>
                        openMixedRegistrationInExistingFeatherlight('#securityQuestionsBanner .bannerButton', 'securityQuestionBanner',  false );
                        </script>
                      </div>
                    </div>
                    <script type="text/javascript">
    ...
    <script type="text/javascript">
      jqReady(function(e){setTimeout(function(e){jqPost('/async/nb.jsp',{asid: 'brlc', iasid: 'brlc', brai: '{"uUID":"8d792790-90cb-435b-8681-0d834aeaf752","trackingEventTypeIds":[410],"nonBounceInterval":"FIVE_SECONDS","cmsSiteId":2,"memberId":0,"referenceId":0,"experienceStateId":43,"experienceTreatment":"LO_FEED_2COL","trackingPagename":"LO - privacyPolicy.jsp","trackingIdentifier":"","remoteAddress":"207.241.229.74","date":"Jan 3, 2018 10:04:37 PM","today":"Jan 3, 2018 12:00:00 AM","sessionId":"1DECEAEF2986D649D954A8F54FED6D47","isEntryPage":false,"isSubTACategoryPage":false,"isPageViewOnly":false}'})},5000);setTimeout(function(e){jqPost('/async/nb.jsp',{asid: 'brlc', iasid: 'brlc', brai: '{"uUID":"8d792790-90cb-435b-8681-0d834aeaf752","trackingEventTypeIds":[410],"nonBounceInterval":"TEN_SECONDS","cmsSiteId":2,"memberId":0,"referenceId":0,"experienceStateId":43,"experienceTreatment":"LO_FEED_2COL","trackingPagename":"LO - privacyPolicy.jsp","trackingIdentifier":"","remoteAddress":"207.241.229.74","date":"Jan 3, 2018 10:04:37 PM","today":"Jan 3, 2018 12:00:00 AM","sessionId":"1DECEAEF2986D649D954A8F54FED6D47","isEntryPage":false,"isSubTACategoryPage":false,"isPageViewOnly":false}'})},10000);});
    </script>
    <script type="text/javascript">
        <!--
          var sOmniture = setUpOmnitureVariable('eexchangeprod');
          sOmniture.pageName='LO - privacyPolicy.jsp';
          sOmniture.server='cms-b1.prod.aws.redsrci.com';
          sOmniture.channel='/';
          sOmniture.pageType='';
          sOmniture.list1='';
          sOmniture.eVar31='207.241.229.74';
    ...
    <script type="text/javascript">
          sOmniture.eVar40='LO (Not India)-LO_FEED_2COL';
          sOmniture.eVar22='481';
    ...
    <!-- cms-b1.prod.aws.redsrci.com:80 - Page: 75648 -->
    <script type="text/javascript">window.NREUM||(NREUM={});NREUM.info={"errorBeacon":"bam.nr-data.net","licenseKey":"a5f224d161","agent":"","beacon":"bam.nr-data.net","applicationTime":431,"applicationID":"3642000,7293104","transactionName":"ZQNRMkZYW0tXW0QPXFxJAUl4dhUVFkhCD0VTBUo2W1VcW08WWhVD","queueTime":0,"atts":""}</script>
  </body>
</html>
