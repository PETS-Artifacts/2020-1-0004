...
<meta name="Keywords" content="file sharing, free web space, online storage, share files, photo image music mp3 video sharing, dedicated hosting, enterprise sharing, file transfer, file hosting">
  <link rel="stylesheet" type="text/css" href="http://static.4shared.com/css/common_n.4min.css?ver=-527534704"/>
...
<script type="text/javascript">
  ...
  Config.revisionNum = 56053;
  Config.syncDomain = 'https://www.4sync.com/';
  Config.cdDomain = '//dc595.4shared.com/';
...
<div class="copy">
        <div class="centered">
          <div class="floatLeft alignRight">
             Copyright <span title='dc566, rev=56053'>&copy;</span> 2005-2016 4shared.com </div>
          <div class="clear"></div>
        </div>
      </div>
    </div>
