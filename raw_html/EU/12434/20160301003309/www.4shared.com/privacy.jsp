...
<script type="text/javascript">
  ...
  Config.revisionNum = 52989;
  Config.syncDomain = 'https://www.4sync.com/';
  Config.cdDomain = '//dc591.4shared.com/';
...
<script type="text/javascript" src="http://static.4shared.com/js/uponitCounter.4min.js?ver=3735305055"></script>
<script type="text/javascript">
...
<div class="copy">
        <div class="centered">
          <div class="floatLeft alignRight">
             Copyright <span title='dc558, rev=52989'>&copy;</span> 2005-2016 4shared.com </div>
          <div class="clear"></div>
        </div>
      </div>
    </div>
