...
<meta name="Keywords" content="file sharing, free web space, online storage, share files, photo image music mp3 video sharing, dedicated hosting, enterprise sharing, file transfer, file hosting">
  <link rel="stylesheet" type="text/css" href="http://static.4shared.com/css/common_n.4min.css?ver=2118177915"/>
<link rel="stylesheet" type="text/css" href="http://static.4shared.com/css/ui/elements.4min.css?ver=1246632214"/>
<link rel="stylesheet" type="text/css" href="http://static.4shared.com/auth-popup.4min.css?ver=-2080519390"/>
<link rel="stylesheet" type="text/css" href="http://static.4shared.com/css/themes/account/icons.4min.css?ver=-1551370407"/>
...
<script type="text/javascript">
  ...
  Config.revisionNum = 56358;
  Config.syncDomain = 'https://www.4sync.com/';
  Config.cdDomain = '//dc622.4shared.com/';
...
<script type="text/javascript" src="http://static.4shared.com/js/header.4min.js?ver=-342863918"></script>
...
<script type="text/javascript" src="http://static.4shared.com/js/utils.4min.js?ver=-181902233"></script>
...
<div id="fstickcontainer"><div id="fstickcontent"> <link rel="stylesheet" type="text/css" href="http://static.4shared.com/css/header.4min.css?ver=102486382"/>
<link rel="stylesheet" type="text/css" href="http://static.4shared.com/css/common.4min.css?ver=-1385293216"/>
<link rel="stylesheet" type="text/css" href="http://static.4shared.com/css/mainWithoutCommon.4min.css?ver=1249453934"/>
<link rel="stylesheet" type="text/css" href="http://static.4shared.com/css/tempHeaderStyles.4min.css?ver=-233610394"/>
<!--[if ie 9]>
  ...
  <!--[if lte ie 9]>
    ...
    <![endif]-->
<link rel="stylesheet" type="text/css" href="http://static.4shared.com/css/popup_n.4min.css?ver=244703502"/>
...
<div id="confirmPopup" style="display:none;">
  ...
  <div class="clear"></div>
</div><link rel="stylesheet" type="text/css" href="http://static.4shared.com/css/notifyBlock.4min.css?ver=-978123093"/>
...
<script type="text/javascript" src="http://static.4shared.com/js/AjaxSuggestion.4min.js?ver=-1668710369"></script>
<div class=" jsHeader newHeader mainHeader">
<div class="centered clearFix">

<div class="floatLeft logo gaClick" data-element="h1">
  <a href="http://www.4shared.com/" title="Free file sharing">
    <img src="http://static.4shared.com/images/spacer.gif?ver=1912669180" alt="Free file sharing"/>
  </a>
</div>

<div class="floatLeft paddingL15 paddingR5 min">
  <img src="http://static.4shared.com/images/newUi/hLogo-arrow.png?ver=-1973830473"/>
</div>
<script type="text/javascript" src="http://static.4shared.com/js/search.4min.js?ver=-1880420596"></script>
...
<div class="sign item absmid">
  <div class="textlink gaClick jsSignupLink" data-element="h23"><i>Sign Up</i></div>
      ...
      <div class="wr">
        <form class="loginform" name="signupForm" action="https://www.4shared.com/web/acc/signup" method="post" id="signup_head"
          ...
          <div class="input-light-small round4 marginT5 gaClick" data-element="h23.1">
            <input type="text" id="regloginfield" name="login" tabindex="1" placeholder="E-mail" autocomplete="off" />
          </div>
          <div class="input-light-small round4 marginT5 gaClick" data-element="h23.2">
            <input type="password" id="regpassfield" name="password" tabindex="2" placeholder="Password" autocomplete="off" />
          </div>
          <div class="input-light-small round4 marginT5 gaClick" data-element="h23.3">
            <input type="password" id="regpassfield2" name="password2" tabindex="3" placeholder="Confirm Password"/>
          </div>
...
<div class="inline login item absmid">
  <div class="llink textlink gaClick jsLoginLink" data-element="h10">
    <i>Log In</i>
  </div>
      ...
      <div class="i round4 headLoginDropdown">
        ...
        <div class="wr">
          <div class="input-light-small round4 marginT5 gaClick" data-element="h10_1">
            <input type="text" class="jsInputLogin" name="login" placeholder="Login" autocomplete="on"/>
          </div>
          <div class="input-light-small round4 marginT5 gaClick" data-element="h10.2">
            <input type="password" class="jsInputPassword" name="password" placeholder="Password" autocomplete="on"/>
          </div>
          ...
          <div class="paddingT10 floatRight">
            <input type="submit" value="Log In" class="submit-light round4 gaClick" data-element="h11" style="width: 100%;"/>
          </div>
          ...
          <div class="socialLogin f11">
            <div class="ii lucida">
              <a href="http://www.4shared.com//remindPassword.jsp" class="gaClick remindPassLink marginT5" data-element="h10.3">Forgot password?</a>
              ...
              <div class="socialButtons">
                ...
                <div class="floatRight">
                  <a href="https://www.4shared.com/servlet/signin/twitter?fp=http%3A%2F%2Fwww.4shared.com%2Fprivacy.jsp" class="tw floatLeft sprite1 gaClick" data-element="h12"></a>
                  <a href="https://www.4shared.com/servlet/signin/facebook?fp=http%3A%2F%2Fwww.4shared.com%2Fprivacy.jsp" class="fb floatLeft sprite1 gaClick" data-element="h13"></a>
                  <a href="https://www.4shared.com/servlet/signin/google?fp=http%3A%2F%2Fwww.4shared.com%2Fprivacy.jsp" class="go floatLeft sprite1 gaClick" data-element="h14"></a>
                  </div>
                <div class="clear"></div>
              </div>
            </div>
...
<div class="inline settings item absmid">
  <div class="gear piclink sprite1 gaClick jsSettingsLink" data-element="h15"><i>&nbsp;</i></div>
...
<a href="http://www.4shared.com/faq.jsp" class="clear gaClick" data-element="h19">FAQ</a>
        <a href="http://www.4shared.com/web/helpCenter" class="gaClick" data-element="h20">Help</a>
        <a href="#" onclick="reportAbuse(); $('.jsUserSettingsButton').click()" class="gaClick" data-element="h22">Report abuse</a>

        <hr/>
        <a href="#" id="changeLang" class="jsChangeLang gaClick" data-element="h18" onclick=" $('.settings .gear').click();">
          <span class="floatLeft">Language</span>
          <span class="pr floatRight paddingR5">en</span>
        </a>
      </div>
    </div>
  </div>
...
<div class="copy">
        <div class="centered">
          <div class="floatLeft alignRight">
             Copyright <span title='dc571, rev=56358'>&copy;</span> 2005-2016 4shared.com </div>
          <div class="clear"></div>
        </div>
      </div>
    </div>
