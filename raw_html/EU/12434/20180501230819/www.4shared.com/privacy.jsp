...
<script type="text/javascript" src="/web/escript/423671.js?ver=59875"></script>
...
<div class="centered mob_regular">
    ...
    <div style="padding-top: 20px; text-align:justify;">
      ...
      <b class="big">Disclosure of Personal Data to Third Parties, Onward Transfer</b><br/><br/>
      We may share (a combination of) Personal Data elements with:<br/><br/>
      <strong style="margin-left: 10px"> -  Third-party Service Providers</strong><br/><br/>
      We may share your Personal Data with third-party service providers who may assist us in responding to your inquiries or requests, or otherwise perform some business or operational function for us.<br/><br/>
      We require that such third-party service providers confirm their Personal Data Privacy and Protection practices are consistent with those applicable via our Digital Properties.<br/><br/>
      Any use of Personal Data by such Service Providers for the purposes other than performing business or operational function for 4shared and its Digital Properties is strictly prohibited.<br/><br/>
      <strong style="margin-left: 10px"> -  Third-party Advertising Partners</strong><br/><br/>
      We partner with third-party ad networks to display advertising within our Digital Properties. Our ad network partners use Web beacons and log files to collect data about your activities on our Digital Properties to provide you targeted advertising based upon your interests.<br/><br/>
      This data is collected, stored and disclosed in the pseudonymized manner and can not be attributed separately to identify or reveal a natural person individual identity.<br/><br/>
      The use of cookies and beacons by our partners is not covered by our privacy statement. We do not have access or control over these cookies.<br/><br/>
      <strong style="margin-left: 10px"> -  Third-party targeted interest-based advertising data providers</strong><br/><br/>
      We may also disclose some Personal Data, in the pseudonymized manner, with third-party targeted interest-based advertising data providers for the purpose of facilitating advertising services for their customers, such as ad networks and other third-party websites and applications.<br/><br/>
      For more details on collection, use and disclosure of Personal Data, and instructions on how to opt out of interest-based advertising, please refer to information provided below or visit websites of advertising networks and data providers:<br/><br/>
      <strong>Airpush, Inc.</strong> collects Data relating to your use of 4shared App, other apps and your device, in a pseudonymized manner, that may include (a combination of) Personal Data elements, such as:<br/>
      (a) Bluetooth beacon data<br/>
      (b) Hashed or encrypted values of your email or phone number<br/>
      (c) Geolocation, and<br/>
      (d) other permission-based user information.<br/><br/>
      You will see the &darr; icon whenever data is being collected. Collected data will be shared with third parties for advertising, analytics and market research purposes.<br/><br/>
      For further information about Airpush, Inc.'s data collection and use practices, please see Airpush, Inc.'s <a target="_blank" href="http://www.airpush.com/technology_privacy/">Technology Privacy Statement</a> and <a target="_blank" href="http://www.airpush.com/privacypolicy/">Privacy Policy</a>. To opt out of data collection by AirPush, Inc., please use the <a target="_blank" href="https://optout.mobi.info/">AirPush, Inc. opt-out link</a>.<br/><br/>
      <strong>OpenSignal, Inc.</strong> We share data relating to your use of 4shared App, other apps and your device, in a pseudonymized manner, that may include (a combination of) Personal Data elements, such as:<br/>
          (a) Location<br/>
          (b) Network diagnostic information<br/>
          (c) Sensor diagnostic information, and<br/>
          (d) other data related to your use of our application.<br/><br/>
      OpenSignal will use the information that we share about you to create aggregated anonymous data and OpenSignal is the sole owner of that data.<br/><br/>
      To learn more about the use of aggregated anonymous data, we recommend that you review OpenSignal <a target="_blank" href="https://opensignal.com/privacypolicy">Privacy Policy</a>. To opt out of our sharing of this information with OpenSignal, Inc., please contact us at <a href="mailto:legal@4shared.com">legal@4shared.com</a> with a request that we not share your information with OpenSignal, Inc.<br/><br/>
      <strong>Oracle America, Inc.</strong> We share data relating to your use of 4shared App, other apps and your device, in a pseudonymized manner, that may include (a combination of) Personal Data elements, such as:<br/>
            (a) Online behavioral information<br/>
            (b) IP address<br/>
            (c) Interest data<br/>
            (d) Unique advertising IDs<br/><br/>
      Oracle will use the Data we share about you to for the following purposes, including but not limited to:<br/>
          (i) Creation of segments for targeted advertising and marketing purposes;<br/>
          (ii) Oracle's internal system improvements, product improvement, statistical analysis, and research, and development.<br/><br/>
      For more information about the use of data by Oracle, please refer to Oracle's <a target="_blank" href="https://www.oracle.com/legal/privacy/marketing-cloud-data-cloud-privacy-policy.html">Privacy Policy</a>. To opt out of data collection by Oracle America, Inc., please refer to <a target="_blank" href="http://www.bluekai.com/consumers.php#optout">Oracle's Opt Out tool page</a>.<br/><br/>
      For more details, please refer to opt-out instructions on websites of self-regulatory organizations:<br/><br/>
      <strong>Recommended for U.S.-based users:</strong><br/>
          Network Advertising Initiative (NAI) opt-out program: <a target="_blank" href="http://optout.networkadvertising.org/">optout.networkadvertising.org</a><br/>
          Digital Advertising Alliance (DAA) opt-out program: <a target="_blank" href="http://optout.aboutads.info/">optout.aboutads.info</a><br/><br/>
      <strong>Recommended for Canada-based users:</strong><br/>
          Digital Advertising Alliance Canada (DAAC): <a target="_blank" href="http://youradchoices.ca/choices">youradchoices.ca/choices</a><br/><br/>
      <strong>Recommended for EU/EEA-based users:</strong><br/>
          Digital Advertising Alliance EU (EDAA) opt-out program: <a target="_blank" href="http://youronlinechoices.eu/">youronlinechoices.eu</a><br/><br/>
      To opt out of data collection via mobile applications, please visit the DAA AppChoices page: <a target="_blank" href="http://youradchoices.com/appchoices">youradchoices.com/appchoices</a><br/><br/>
      Please note that even if you opt out of interest-based advertising, 4shared may continue to collect data for other purposes, 4shared will still display generic ads (i.e. not targeted to you), while using our Digital Properties.<br/><br/>
        <div style="padding-left: 10px">- We may also disclose your Personal Data if required by law, including without limitation, by search warrant, subpoena or court order; to protect our and third-party rights; and for purposes disclosed at time of collection.</div><br/><br/>
