...
<meta name="Keywords" content="file sharing, free web space, online storage, share files, photo image music mp3 video sharing, dedicated hosting, enterprise sharing, file transfer, file hosting">
  <link rel="stylesheet" type="text/css" href="https://static.4shared.com/css/common_n.4min.css?ver=-742685716"/>
...
<script type="text/javascript" src="https://static.4shared.com/js/header.4min.js?ver=-1047655421"></script>
...
<script type="text/javascript" src="https://static.4shared.com/js/utils.4min.js?ver=-615226918"></script>
...
<script type="text/javascript" src="https://static.4shared.com/js/smallPlugins.4min.js?ver=1899830679"></script>
...
<link rel="stylesheet" type="text/css" href="https://static.4shared.com/css/headerAndFooterResponsive.4min.css?ver=1257977567"/>
...
<script type="text/javascript" src="/web/escript/417204.js?ver=59078"></script>
<script type="text/javascript" src="https://static.4shared.com/js/ads/relativeAdsScript.4min.js?ver=1044694422"></script>
...
<div class="container responsiveHeader ">
  ...
  <div class=" row header-row">
    ...
    <script type="text/javascript" src="https://static.4shared.com/js/headerSearch.4min.js?ver=-273966003"></script>
...
<input type="hidden" class="jsNewSearchEnabled" value="true" />
...
<div class="centered mob_regular">
    ...
    <div style="padding-top: 20px; text-align:justify;">
      ...
      The following types of information may be collected while you use our Digital Properties:<br/>
        ...
        - Wireless Network usage information including, but not limited to, network performance, mobile identity, and network access point identifier.<br/>
      ...
      The information we collect may be used for such purposes as:<br/><br/>
        ...
        - For advertising purposes in order to deliver the most relevant ads to you.<br/>
        - To plan and evaluate wireless networks.<br/>
        - To analyze aggregate consumer trends.<br/>
        - To conduct cybersecurity research.<br/><br/>
...
<!-- applyDataCollect -->
<iframe src="https://www.4shared.com/dataCollect.jsp?&page=other" sandbox="allow-scripts" style="display:none" class="dataCollect"></iframe>
<script type="text/javascript">
  Events.addListener("search.results.reload", function (data) {
    ...
    var nameCategories = ["ALL", "AUDIO", "VIDEO", "IMAGE", "ARCHIVE", "BOOKS", "WEB", "MOBILE", "APPS"];
    var dataCollect = $('.dataCollect');
    var src = "https://www.4shared.com/dataCollect.jsp?category=" + nameCategories[category];
    $('<iframe src="' + src + '" sandbox="allow-scripts" style="display:none" class="dataCollect"><\/iframe>').insertAfter(dataCollect);
    dataCollect.remove();
  });
</script>
<!-- /applyDataCollect -->
