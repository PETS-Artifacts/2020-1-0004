...
<link rel="shortcut icon" href="https://www2.bac-assets.com/pa/global-assets/1.0/graphic/favicon.ico" type="image/ico" />
			...
			<script src="https://www2.bac-assets.com/pa/components/bundles/text-decompressed/xengine/PBI-WEB/2018.05.0/script/pbi-web-ps-jawr.js" type="text/javascript"></script>	
				...
				<link href="https://www2.bac-assets.com/pa/components/layouts/fsd-2c-700lt-layout/33.1/style/fsd-2c-700lt-layout.css" rel="stylesheet" type="text/css">
		...
		<div class="fsd-skin sup-ie">
			<ul class="nav-list">
					...
					<li>
								...
								<a href="/privacy/faq/collecting-information-faq.go" class="top-menu-item selected"
    ...
    <div class="main-well-skin com-main-well-content table-vzd3-common table-vzd3-com ">
      ...
      <ul class="faq-main">
						...
						<li>
									...
									<div class="faq-content-area hide">
										<p>Yes. But, if you choose to delete Flash objects from our sites, then you may not be able to access and use all or part of the site or benefit from the information and services offered.</p>
									</div>
						</li>
						<li>
						...
						<li>
									...
									<div class="faq-content-area hide">
										<p>Online behavioral advertising helps us provide you with information about products and services you might find interesting and useful. Here&rsquo;s how it works: We gather information about your online activities, such as the searches you conduct on our sites and the pages you visit. This information may be used to deliver advertising on our sites as well as offline that&rsquo;s customized to meet specific interests you may have.</p>
									</div>
						</li>
						<li>
									<span class="question-link closed"><a href="javascript:void(0);" name="Why_does_Bank_of_America_use_Online_Behavioral_Advertising" id="Why_does_Bank_of_America_use_Online_Behavioral_Advertising">
									<span class="ada-hidden ada-action">Show </span>Why does Bank of America use Online Behavioral Advertising?</a></span>
									<div class="faq-content-area hide">
										<p>Online behavioral advertising helps us provide you with information about products and services you might find interesting and useful.</p>
									</div>
						</li>
						<li>
									...
									<div class="faq-content-area hide">
										<p>Yes. If you prefer that we not use information about your online site activities to deliver advertising on our sites and offline (for example, by phone, email and direct mail), you can opt out of online behavioral advertising. If you opt out, though, you may still receive generic advertising. In addition, financial advisors/Client Managers may continue to use information collected online to provide product and service information in accordance with account agreements.</p>
<p>Also, if you opt out of online behavioral advertising, you may still see ads when you sign in to your account, for example through Online Banking or MyMerrill. These ads are based on your specific account relationships with us. Remember that your browser must be set to accept cookies in order for opt-outs to work.</p>
						...
						<li>
									...
									<div class="faq-content-area hide">
										<p>On third-party sites where we advertise, Bank of America uses the <a class="com-interstitial-modal-link" rel="http://www.aboutads.info/" name="aboutads" href="javascript:void(0);">Advertising Options Icon</a> on our behavioral ads (excluding ads appearing on platforms that do not accept the icon). Anyone receiving a behavioral ad may click on the displayed icon to receive more information and can opt out at that time or by visiting the third-party site's privacy policy for an opt out mechanism.</p>
<p>You may also opt out of receiving behavioral ads from many sites through the <a name="network_advertising"></a><a title="Network Advertising" href="http://www.bankofamerica.com/weblinking/?referredby=networkadvertising" target="_self">Network Advertising Initiative's Opt Out Tool</a>&nbsp;or other tools provided by the publishing platform.</p>
