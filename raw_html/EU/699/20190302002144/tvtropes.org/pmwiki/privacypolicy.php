...
<link rel="stylesheet" href="https://static.tvtropes.org/design/assets/bundle.css?rev=242" />
<script>
...
<div id="random-box">
<a href="/pmwiki/pmwiki.php/Main/Canon" class="button-random-trope" rel="nofollow" onclick="ga('send', 'event', 'button', 'click', 'random trope');"></a>
<a href="/pmwiki/pmwiki.php/Music/Spiritualized" class="button-random-media" rel="nofollow" onclick="ga('send', 'event', 'button', 'click', 'random media');"></a>
</div>
</div>
</div>
...
<ul>
<li><a href="https://policies.google.com/technologies/partner-sites" target="_blank">Google Cookie Policy</a></li>
<li><a onclick="window.__cmp('displayConsentUi')">Partner Cookie Policies</a></li>
</ul>
</p>
...
<script type="text/javascript">
        ...
        elem.src = 'https://static.tvtropes.org/design/assets/bundle.js?rev=242';
