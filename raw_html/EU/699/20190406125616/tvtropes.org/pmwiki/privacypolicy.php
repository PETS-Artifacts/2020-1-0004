...
<link rel="stylesheet" href="https://static.tvtropes.org/design/assets/bundle.css?rev=250" />
<script>
...
<div id="random-box">
<a href="/pmwiki/pmwiki.php/Main/WrongNameOutburst" class="button-random-trope" rel="nofollow" onclick="ga('send', 'event', 'button', 'click', 'random trope');"></a>
<a href="/pmwiki/pmwiki.php/Music/InTheAeroplaneOverTheSea" class="button-random-media" rel="nofollow" onclick="ga('send', 'event', 'button', 'click', 'random media');"></a>
</div>
</div>
</div>
...
<script type="text/javascript">
        ...
        elem.src = 'https://static.tvtropes.org/design/assets/bundle.js?rev=250';
