<!DOCTYPE html>
	<html>
	    ...
	    <link rel="icon" sizes="192x192" href="https://static.tvtropes.org/img/icons/favicon-192x192.png" type="image/png">
			...
			<link rel="stylesheet" href="https://static.tvtropes.org/design/css/icomoon.css?rev=177" >
						<link rel="stylesheet" href="https://static.tvtropes.org/design/css/main.css?rev=177" />
			...
			<script type="text/javascript" src="https://static.tvtropes.org/design/js/jquery-3.2.1.min.js"></script>
						<script type="text/javascript" src="https://static.tvtropes.org/design/js/ads.js?rev=1531111189" ></script>
			<script type="text/javascript" src="https://static.tvtropes.org/design/js/stickykit-min.js" ></script>

							<script type="text/javascript" src="https://static.tvtropes.org/design/js/main.min.js?rev=177" ></script>
				...
				<script src="https://static.tvtropes.org/design/js/google-adblock.js"></script>
 ...
 <body class="">
    ...
    <header id="main-header-bar" class="headroom-element ">
        <div id="main-header-bar-inner">
            ...
            <div id="main-header-bar-right">
                ...
                <div id="random-box">
                    <a href="/pmwiki/pmwiki.php/Main/OneGameForThePriceOfTwo" class="button-random-trope" rel="nofollow" onclick="ga('send', 'event', 'button', 'click', 'random trope');"></a>
                    <a href="/pmwiki/pmwiki.php/Film/WonderWomen" class="button-random-media" rel="nofollow" onclick="ga('send', 'event', 'button', 'click', 'random media');"></a>
                </div>
    ...
    <div class="nav-wrapper">
        ...
        <a href="/pmwiki/yk_activity.php">YKTTW</a>
