<!DOCTYPE html>
	<html>
		<head lang="en">
            ...
            <link rel="stylesheet" href="https://static.tvtropes.org/design/css/main.css?rev=187" />
    ...
    <header id="main-header-bar" class="headroom-element ">
        <div id="main-header-bar-inner">
            ...
            <div id="main-header-bar-right">
                ...
                <div id="random-box">
                    <a href="/pmwiki/pmwiki.php/Main/TheShortGuyWithGlasses" class="button-random-trope" rel="nofollow" onclick="ga('send', 'event', 'button', 'click', 'random trope');"></a>
                    <a href="/pmwiki/pmwiki.php/Manga/Kagetora" class="button-random-media" rel="nofollow" onclick="ga('send', 'event', 'button', 'click', 'random media');"></a>
                </div>
...
<div class='proper-ad-unit ad-sticky'>
  <div id='proper-ad-tvtropes_sticky_1'> <script>propertag.cmd.push(function() { proper_display('tvtropes_sticky_1'); });</script> </div>
    ...
    <script type="text/javascript" src="https://d1il9t8pu4dsoj.cloudfront.net/script.js" defer></script>    <script type='text/javascript'>
        window.special_ops =  {
            member : 'no',
            isolated : 0,
            tags : ['unknown']
        ...
        <script type="text/javascript" src="https://global.proper.io/tvtropes.min.js" defer></script>
    ...
    <script type="text/javascript" src="https://static.tvtropes.org/design/js/ads.js?rev=1538597984" defer></script>

    <script>var adblock_check = true;</script>        <script type="text/javascript" src="https://static.tvtropes.org/design/js/main.min.js?rev=187" defer></script>
