...
<link rel="stylesheet" href="https://static.tvtropes.org/design/assets/bundle.css?rev=259" />
<script>
...
<div id="random-box">
<a href="/pmwiki/pmwiki.php/Main/NoirEpisode" class="button-random-trope" rel="nofollow" onclick="ga('send', 'event', 'button', 'click', 'random trope');"></a>
<a href="/pmwiki/pmwiki.php/WebVideo/SteveDMonster" class="button-random-media" rel="nofollow" onclick="ga('send', 'event', 'button', 'click', 'random media');"></a>
</div>
</div>
</div>
...
<a href="#video-feedback" class="float-right" data-modal-target="login">Feedback</a>
</p>
</div>
</div>
</div>
...
<script type="text/javascript">
        ...
        var snoozable = "";
                    ...
                    var adblock_check = snoozed && snoozable ? false : true;
        
        var elem = document.createElement('script');
        elem.async = true;

        elem.src = 'https://static.tvtropes.org/design/assets/bundle.js?rev=259';
