...
<head id="ctl00_Head1"><title>
    ...
    <script type="text/javascript">
        ...
        ga('create', MXT.MxGA_Account, { cookieDomain: 'mxtoolbox.com' });
...
<div id="mdlLogin" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="lblMdlLogin" aria-hidden="true">
    ...
    <script id="template_master_nav" type="text/x-jquery-tmpl">
        ...
        {{if !IsPaidUser}}
            ...
            <li class="divider-vertical"></li>
        {{else}}
            <li class="blackNavInvestigator"><a class="menu_item_text" href="https://mxtoolbox.com/Public/Investigator">Investigator</a> </li>
        {{/if}}
    ...
    <!-- Generated at 7/4/2017 3:37:54 PM for Mozilla/5.0 (compatible; heritrix/3.3.0-SNAPSHOT-20140702-2247 +http://archive.org/details/archive.org_bot) -->
</body>
</html>
