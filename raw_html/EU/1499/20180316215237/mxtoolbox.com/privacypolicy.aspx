...
<head id="ctl00_Head1"><title>
    ...
    <!-- don't allow compatibility mode in IE -->
    <meta http-equiv="X-UA-Compatible" content="IE=EDGE;IE=8" />

    <!--Open Graph Tags http://ogp.me  - Mostly for FaceBook-->
    ...
    <!-- stylesheets -->
    <link type='text/css' rel='stylesheet' href='https://maxcdn.bootstrapcdn.com/bootstrap/2.3.1/css/bootstrap.min.css' /><link type='text/css' rel='stylesheet' href='https://mxtoolbox.com/Public/stylesheets/mx-styles-preload.css?serial=1632018' /><link type='text/css' rel='stylesheet' href='https://mxtoolbox.com/Public/stylesheets/mx-styles-postload.css?serial=1632018' async defer />    
    ...
    <script>
        // Putting these backend-to-frontend variables here allows us to put all the script blocks into files in the future
        (function (MXT) {
    ...
    <script type="text/javascript">
        // this is the best practice by google to defer loading of analytics
        ...
        //NOTE: _trackPageView at end of page
        ga('create', 'UA-196877-1', { cookieDomain: 'mxtoolbox.com' }); // SP
        //Google Optimize
        ...
        <!-- Ascend - Commented out for now -->
        <!-- <script src="/Public/scripts/3rdParty/ascend.js" type="text/javascript"></script> -->
        <script src="/bundles/mxShared.js?v=EwJSneGEMpkoGWY5luh3URD4O_FTsj-OiYruI-7Aw0k1"></script>
<script src="/bundles/mxClassicPreload.js?v=Gvo77xtod9vjj6nQXq9oVsEK2wtjEYr82EuLhJkw97g1"></script>
    ...
    <link rel="apple-touch-icon" href="&lt;%= Request.Url.Scheme %>://mxtoolbox.com/Public/Images/apple-touch-icon.png" />
...
<script src="/WebResource.axd?d=GEqJzpPzLAGHpUpS8v5-ALroEvTo2fD3EGxONClqa5xCOszERmdomPDrS1tUayJlr2p9X0wyagezGT0jArXJjv6uPIo1&amp;t=636354726046607314" type="text/javascript"></script>


<script src="/ScriptResource.axd?d=GTYGyF87e4jlmVq0AzrGOxn_i5IC2ia1CA2FBAEMop3BHZt8nHMLeDx-IhO-4N-CPHwFbdKPHasBbKEKYDc1WaOFIlp80pdXngFthl6Pkg4SvLu7sl8enpx9ir2DncIRjarQBmuYLa__owp0h_pHS51ogayu5QLKBvQtnicSGai6lRM10&amp;t=3d6efc1f" type="text/javascript"></script>
<script src="/ScriptResource.axd?d=vyBfJcRxUJSSvud5QoCutZGTlXZlEMv-Ew7oAvHmMuxddsP2XbkqQs4uHqg0SkbZka1ydmeCEWuA6GeDKgpTCZpNKUIuC0uGSui9hQzyl5mmZQJxKL5YRHGB7X-YVK6R69eRgEznO-8rQa2aZx3N472Vic44pBkpy149UzHTr-glKM-O0&amp;t=3d6efc1f" type="text/javascript"></script>
<div class="aspNetHidden">

	<input type="hidden" name="__VIEWSTATEGENERATOR" id="__VIEWSTATEGENERATOR" value="D7968906" />
	<input type="hidden" name="__EVENTVALIDATION" id="__EVENTVALIDATION" value="" />
</div>
                ...
                <tr>
                    ...
                    <td id="tdCenter" style="max-width: 1024px;">
                        ...
                        <table id="tableContent" cellpadding="0" cellspacing="0">
                            <!-- added width:100% -->
                            <tr id="ctl00_trDisabledUser" style="display: none">
	<td>
                            ...
                            <tr id="ctl00_pnlMenu">
	<td>
                                    <div id="menu_table" class="navbar navbar-inverse main" style="display: none">
                                        
                                        <div id="master_nav_container" class="navbar-inner main">
                                            <ul class="mxMasterNav nav">
                                                ...
                                                <li class="blackNavWorkbench divider-vertical"></li>
                                                ...
                                                <li class="divider-vertical"></li>
                                                <li class="blackNavFreeMonitoring"><a class="menu_item_text" href="https://mxtoolbox.com/services_servermonitoring2.aspx">Free Monitoring</a> </li>
                                                <li class="blackNavFreeMonitoring divider-vertical"></li>
                                                ...
                                                <li class="blackNavDNSLookup divider-vertical"></li>
                                        ...
                                        <div id="supertool_picker_container" class="navbar-inner main" style="display: none; padding: 5px 10px">
                                            <div class="supertool_picker">
                                                <div class="st_command_info clickable" onclick="togglePickerModal();">
                                                    <img id="supertool_picker_image" width="16" src="/Pro/img/ToolIcons/mx.png" />
                                                    <span id="supertool_picker_text">mx</span>:
                                                </div>
                                                <input type="text" class="st_input" id="txtInput_picker" placeholder="Lookup anything..." />
                                                <div class="st_buttons btn-group">
                                                    <a href="#" class="btn btn-mx" onclick="doLookup2(); return false;"><span>Lookup</span></a>
                                                    <a href="#" class="btn btn-mx" onclick="togglePickerModal(); return false;">
                                                        <span class="caret" style="border-top-color: #FFF; border-bottom-color: #ffffff;"></span>
                                                    </a>
                                                </div>
                                            </div>
                                            <ul class="mxPickerNav nav pull-right" style="margin-top: 6px">
                                            </ul>
                                        </div>
                                        <div class="supertool_modal" style="display: none">
                                        </div>
                                    </div>
                                </td>
</tr>
            ...
            If you have any questions about our Privacy Policy, please contact us at <a href="mailto:info@mxtoolbox.com">info@mxtoolbox.com</a>.
                            ...
                            <tr id="footer">
                                <td class="copyright">Your IP is: <a id="lnkIp" href='https://mxtoolbox.com/WhatIsMyIP/'></a>
                                    <br />
                                    &copy; Copyright 2004-2018, <a href="https://mxtoolbox.com/AboutUs.aspx">MXToolBox, Inc</a>, All rights reserved&nbsp;|&nbsp; <a href="mailto:feedback@mxtoolbox.com">Feedback</a>
...
<div id="mdlLogin" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="lblMdlLogin" aria-hidden="true">
    ...
    <script id="template_loggedIn_menu" type="text/x-jquery-tmpl">
        <ul class="nav">
            <li>
                <a id="ctl00_hlMobile1" class="header_menu_items hlMobile" style="display: none">Mobile Site</a></li>
            {{if !IsPaidUser}}
            ...
            <li id="topNavResponsive" class="--switch-responsive-mode" style="display: none"><a onclick="MXT.switchResponsive()" href="#">Responsive Beta</a></li>
    ...
    <script id="template_notLoggedIn_menu" type="text/x-jquery-tmpl">
        <ul class="nav">
            <li>
                <a id="ctl00_hlMobile2" class="header_menu_items hlMobile" style="display: none">Mobile Site</a></li>
    ...
    -->
    <script src="/bundles/mxClassic.js?v=WwafzELbRWdhc4T013-sxF7IqVoo-Mr7nhlBVNlFECc1"></script>
    ...
    <!-- Generated at 3/16/2018 4:51:28 PM for Mozilla/5.0 (compatible; heritrix/3.3.0-SNAPSHOT-20140702-2247 +http://archive.org/details/archive.org_bot) -->
</body>
</html>
