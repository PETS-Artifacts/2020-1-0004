...
<head id="ctl00_Head1"><title>
    ...
    <meta property="og:type" content="website" /><meta property="og:site_name" content="MxToolbox" /><meta property='og:image' content='//mxtoolbox.com/Public/Images/logo_square_1900.png' /><meta property='og:title' content='MxToolbox - Privacy - Managed IT Services for Small Business' /><meta property='og:url' content='https://mxtoolbox.com/Public/Content/PrivacyPolicy.aspx' /><meta property="fb:admins" content="622566608" />

    <!-- stylesheets -->
    <link type='text/css' rel='stylesheet' href='https://maxcdn.bootstrapcdn.com/bootstrap/2.3.1/css/bootstrap.min.css' /><link type='text/css' rel='stylesheet' href='//mxtoolbox.com/Public/stylesheets/mx-styles-preload.css?serial=642018' /><link type='text/css' rel='stylesheet' href='//mxtoolbox.com/Public/stylesheets/mx-styles-postload.css?serial=642018' async defer />    
                        ...
                        <div id="header">
                            <div class="navbar navbar-static-top">
                                <div>
                                    ...
                                    <a class="pull-left" href="//mxtoolbox.com/SuperTool.aspx">
                                        <img id="imgLogo" src="//mxtoolbox.com/public/images/Mx-Logo-590x150.png" alt="MxToolbox Logo" border="0" style="height: 75px; width: 295px; position: absolute" />
                                    </a>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div id="menu_table" class="navbar navbar-inverse main" style="display: none">
                                        ...
                                        <div id="master_nav_container" class="navbar-inner main">
                                            <ul class="mxMasterNav nav">
                                                <li class="home"><a class="menu_item_text" href="//mxtoolbox.com/SuperTool.aspx"></a></li>
                                                ...
                                                <li class="blackNavMxLookup"><a class="menu_item_text" href="//mxtoolbox.com/">MX Lookup</a></li>
                                                <li class="divider-vertical"></li>
                                                <li class="blackNavBlacklists"><a class="menu_item_text" href="//mxtoolbox.com/blacklists.aspx">Blacklists</a> </li>
                                                <li class="divider-vertical"></li>
                                                <li class="blackNavDianostics"><a class="menu_item_text" href="//mxtoolbox.com/diagnostic.aspx">Diagnostics</a> </li>
                                                <li class="divider-vertical"></li>
                                                <li class="blackNavDomainHealth"><a class="menu_item_text" href="//mxtoolbox.com/domain/">Domain Health</a></li>
                                                <li class="divider-vertical"></li>
                                                <li class="blackNavAnalyzeHeaders"><a class="menu_item_text" href="//mxtoolbox.com/EmailHeaders.aspx">Analyze Headers</a> </li>
                                                <li class="divider-vertical"></li>
                                                <li class="blackNavFreeMonitoring"><a class="menu_item_text" href="//mxtoolbox.com/services_servermonitoring2.aspx">Free Monitoring</a> </li>
                                                <li class="blackNavFreeMonitoring divider-vertical"></li>
                                                <li class="blackNavDMARC"><a class="menu_item_text" href="//mxtoolbox.com/DMARC.aspx">DMARC</a> </li>
                                                <li class="divider-vertical"></li>
                                                <li class="blackNavInvestigator"><a class="menu_item_text" href="//mxtoolbox.com/Public/FreeInvestigator.aspx">Investigator</a> </li>
                                                <li class="divider-vertical"></li>
                                                <li class="blackNavDNSLookup" id="liNavDNSLookup"><a class="menu_item_text" href="//mxtoolbox.com/DNSLookup.aspx">DNS Lookup</a> </li>
                                                <li class="blackNavDNSLookup divider-vertical"></li>
                                                <li class="blackNavMore">
                                                    <a class="dropdown-toggle menu_item_text" href="//mxtoolbox.com/NetworkTools.aspx">More
                                                        <b class="caret"></b>
                                                    </a>
                                                </li>
                                            </ul>
...
<script id="template_ad_paid" type="text/x-jquery-tmpl">
    ...
    of MxToolbox, which may be found here: <strong><a href="//mxtoolbox.com/TermsAndConditions.aspx">Terms and Conditions</a></strong>
        </p>
        <p>
...
You can opt out of DoubleClick's use of cookies by visiting the<a href="https://www.google.com/settings/ads/onweb#display_optout">DoubleClick opt-out page</a> or the    <a href="http://www.networkadvertising.org/managing/opt_out.asp">Network Advertising Initiative opt-out page</a>.
        ...
        You may <a href="//mxtoolbox.com/public/unsubscribe.aspx">visit our unsubscribe page</a> to manage email communication preferences for your account.  With this tool, you can adjust your preferences about how you receive monitoring emails and
reports we send as part of the monitoring services we offer.
        ...
        <p>
            ...
            If you have any questions about our Privacy Policy, please contact us at <a href="mailto:info@mxtoolbox.com">info@mxtoolbox.com</a>.
                            ...
                            <tr id="footer">
                                <td class="copyright">Your IP is: <a id="lnkIp" href='//mxtoolbox.com/WhatIsMyIP/'></a>
                                    <br />
                                    &copy; Copyright 2004-2018, <a href="//mxtoolbox.com/AboutUs.aspx">MXToolBox, Inc</a>, All rights reserved&nbsp;|&nbsp; <a href="mailto:feedback@mxtoolbox.com">Feedback</a>
                                    | <a href="//mxtoolbox.com/Public/Content/AboutUs.aspx">Contact</a> | <a href="//mxtoolbox.com/TermsAndConditions.aspx">Terms
                                                & Conditions</a>&nbsp;|&nbsp;<a href="//mxtoolbox.com/sitemap.aspx">Site
                                                    Map</a>&nbsp;|&nbsp;<a href="//mxtoolbox.com/c/products/mxtoolboxapi">API</a>
                                    <br />
                                    Phone: (866)-MXTOOLBOX / (866)-698-6652 |&nbsp; <a href="mailto:info@mxtoolbox.com">info@mxtoolbox.com</a> &nbsp;| <a href="//mxtoolbox.com/privacypolicy.aspx">Privacy</a>
                                </td>
                                <td class="chiclets">
                                    <a href="https://twitter.com/mxtoolbox">
                                        <img src="//mxtoolbox.com/public/images/twitter-icon.png"
                                            alt="Follow us on Twitter" border="0" class="icon" /></a> <a href="https://www.facebook.com/pages/MxToolBox/121238494564485">
                                                <img src="//mxtoolbox.com/public/images/fb-icon.png" alt="Become our fan on Facebook"
                                                    border="0" class="icon" /></a> <a href="https://blog.mxtoolbox.com/">
                                                        <img src="//mxtoolbox.com/public/images/rss-icon.png" alt="Blog"
...
<div id="mdlLogin" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="lblMdlLogin" aria-hidden="true">
    ...
    <div class="modal-footer">
        <div id="divFooterLinks" style="float: left; color: lightblue; padding-top: 5px; display: none;">
            <span style="padding-left: 10px;"><a href="//mxtoolbox.com/TermsAndConditions.aspx" target="_blank">Terms</a></span>
            <span style="padding-left: 10px;"><a href="//mxtoolbox.com/privacypolicy.aspx" target="_blank">We respect your privacy</a></span>
    ...
    <script id="template_loggedIn_menu" type="text/x-jquery-tmpl">
        <ul class="nav">
            ...
            {{if !IsPaidUser}}
                <li id="topNavUpgrade"><a style="color: #d47a1d; font-weight: bold" href="//mxtoolbox.com/Public/UpgradeV2.aspx?feature=no-feature-selected&source=upgrade-top-masterpage">Upgrade</a></li>
            {{/if}}
            <li>
                <a id="hlReEnableMonitors" style="display:none" href="#">Re-enable Monitors</a></li>
            {{if IsAdmin}}
                <li><a href="//mxtoolbox.com/Admin/SB/login.aspx">ServiceBox</a></li>
            <li><a href="//mxtoolbox.com/Admin/Default.aspx">Admin</a></li>
            {{/if}}
            ...
            <li id="topNavAPI"><a href="//mxtoolbox.com/c/products/mxtoolboxapi">API</a></li>
            <li id="topNavProducts"><a href="//mxtoolbox.com/Public/Content/Products/index.aspx">Products</a></li>
            <li id="topNavAboutUs"><a href="//mxtoolbox.com/AboutUs.aspx">About Us</a></li>
            <li id="topNavSupport"><a href="//mxtoolbox.com/support.aspx">Support</a></li>
            ...
            <li id="topNavSettings" class="dropdown">
                <a class="dropdown-toggle" data-toggle="dropdown" data-target="#" href="#">
                    <img src="//mxtoolbox.com/public/images/icon-settings.png" alt="Settings" style="vertical-align: middle; width: 20px; margin-top: -2px;" />
                    <b class="caret"></b>
                </a>
                <ul id="ddmSettings" class="dropdown-menu" style="z-index: 1055">
                    {{if IsPaidUser}}
                        <li><a href="//mxtoolbox.com/Pro/#/user">{{>UserName}}</a></li>
                    <li class="divider"></li>
                    <li><a href="//mxtoolbox.com/Pro/wf/ProSubnetResults.aspx">Blacklist Monitors</a></li>
                    <li><a href="//mxtoolbox.com/Pro/#/user">Settings</a></li>
                    <li><a href="//mxtoolbox.com/Pro/#/monitor/notifications">Notifications</a></li>
                    <li><a href="//mxtoolbox.com/Pro/#/user?tab=filters">Custom Filters</a></li>
                    {{else}}
                        <li><a href="//mxtoolbox.com/User/Dashboard/Settings.aspx">{{>UserName}}</a></li>
                    <li class="divider"></li>
                    <li><a href="//mxtoolbox.com/subnet/default.aspx?filter=monitors&source=monitors">Blacklist Monitors</a></li>
                    <li><a href="//mxtoolbox.com/User/Dashboard/Settings.aspx">Settings</a></li>
                    <li><a href="//mxtoolbox.com/User/Dashboard/Notifications.aspx">Notifications</a></li>
                    {{/if}}
                    <li class="--switch-responsive-mode" style="display: none"><a onclick="MXT.switchResponsive()" href="#">Switch Responsive</a></li>
                    <li class="divider"></li>
                    <li><a href="//mxtoolbox.com/Public/Login.aspx?logout=true">Logout</a></li>
                </ul>
            </li>
    ...
    <script id="template_notLoggedIn_menu" type="text/x-jquery-tmpl">
        <ul class="nav">
            ...
            <li><a href="//mxtoolbox.com/c/products/mxtoolboxapi">API</a></li>
            <li><a href="//mxtoolbox.com/Public/Content/Products/">Products</a></li>
            <li><a href="//mxtoolbox.com/AboutUs.aspx">About Us</a></li>
            <li><a href="//mxtoolbox.com/support.aspx">Support</a></li>
            <li class="--switch-responsive-mode" style="display: none"><a onclick="MXT.switchResponsive()" href="#">Switch Responsive</a></li>
            <li style="margin-right: 15px"><a href="//mxtoolbox.com/Public/Login.aspx?page=pp">Login</a></li>
        </ul>
    </script>
    ...
    <!-- Generated at 4/6/2018 6:08:52 PM for Mozilla/5.0 (compatible; heritrix/3.3.0-SNAPSHOT-20140702-2247 +http://archive.org/details/archive.org_bot) -->
</body>
</html>
