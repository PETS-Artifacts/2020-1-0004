...
<div id="mdlLogin" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="lblMdlLogin" aria-hidden="true">
    ...
    <script id="template_loggedIn_menu" type="text/x-jquery-tmpl">
        <ul class="nav">
            ...
            {{if !IsPaidUser}}
                <li><a style="color: #d47a1d; font-weight: bold" href="https://mxtoolbox.com/Public/UpgradeV2.aspx?feature=no-feature-selected&source=upgrade-top-masterpage">Upgrade</a></li>
            {{/if}}
            <li>
                </li>
            {{if IsAdmin}}
    ...
    -->
    <script src="/bundles/mxClassic.js?v=5e2wue2qVQcZkbTFqmP8ElzYnn9RNlT-3IXQt3HYo8s1"></script>
    ...
    <!-- Generated at 6/2/2017 10:04:57 PM for Mozilla/5.0 (compatible; heritrix/3.3.0-SNAPSHOT-20140702-2247 +http://archive.org/details/archive.org_bot) -->
</body>
</html>
