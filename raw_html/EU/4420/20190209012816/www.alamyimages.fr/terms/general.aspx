...
<link href="https://www.alamy.com/styles/globals/main-1.4159.10-min.css" rel="stylesheet">
					...
					<li class="dropdown bs-l-li pl-6" id="download-pack">
						...
						<ul class="dropdown-menu">
						  <li>
							...
							<a id="automationBuyAnotherDownloadPack" class="buyanotherdp" href="https://www.alamyimages.fr/download-packs.aspx">Acheter un autre forfait de téléchargement</a>
						  </li>
						</ul>
					</li>
      ...
      <div class="container">
         ...
         <div class="row m-0">
            <div class="col-md-12 b-ln bw-1 bs-b">
               <div id="image-cont-display" class="tagline-txt light-navy">156 771 880 images, vecteurs et vidéos</div>
            </div>
         </div>
         <div class="row mr-ie m-0">
            <div class="col-md-12 col-xs-12 mb-15 copy light-navy h6 mt-50">
               <p class="text-center">Alamy et ses logos sont des marques commerciales d’Alamy Ltd. et sont déposées dans certains pays. Droit d’auteur&copy; 09/02/2019 Alamy Ltd. Tous droits réservés.</p>
            </div>
         </div>
      </div>
   </div>
...
<script type="text/javascript" src="https://static.alamy.com/scripts/branding/FooterResponsive-min-1.4172.14.js"></script>
