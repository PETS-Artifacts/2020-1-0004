...
<link href="https://www.alamy.com/styles/globals/main-1.4159.15-min.css" rel="stylesheet">
...
<!--Mobile Purchase path styles (Affect in mobile devices only)-->
		...
		<link rel="stylesheet" href="https://static.alamy.com/styles/globals/bg-header-imgs-1.991.3.css" />
		<!--static responsive styles-->
		<link rel="stylesheet" href="https://static.alamy.com/styles/sections/static-responsive-1.4099.12.css" />
		<!--end-->
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        if( isIE || isEdge){
        var image = 'https://static.alamy.com/images/branding/sections/logo/logo-white-ie.png';
        $(".logo").attr('src',image);
        }
    });
</script>
...
<script type="text/javascript">
    ...
    var captchaEnabledForgotPwd=true;
...
<script type='text/javascript' src='https://c.la1-c2-frf.salesforceliveagent.com/content/g/js/41.0/deployment.js' async></script>
<script type='text/javascript'>
...
<nav class="navbar navbar-inverse" role="navigation">
    <div class="container container-fluid-home">
        <div class="row">
            <div class="col-md-12 p-0" itemscope itemtype="https://schema.org/Organization">
            <!-- Brand and toggle get grouped for better mobile display -->
                <a href="https://www.alamyimages.fr/" itemprop="url">
                    <img id="automationAlamyLogo" height="47" src="https://static.alamy.com/images/branding/sections/logo/alamy-logo-white.png"
                    title="Alamy" alt="Alamy" class="pull-left ml-2 logo" itemprop="logo"/>
                </a>
    ...
    <!--Image count display-->            
               ...
               <link href="https://static.alamy.com/styles/globals/header-style-1.4180.12.css" rel="stylesheet"/>
                
                    
                <ul class="nav navbar-nav navbar-right pr-10" id="signinmenu">
                        <li class="dropdown bs-r-li mr-5 ml-5  bs-l-li">
                        <a class="cart" id="automationShoppingCartGuest" href="https://www.alamyimages.fr/order-view.aspx" title="Afficher le panier d’achat">
                            ...
                            <span class="cartItems bold  ml-5 pull-left" id="automationGuestCartItemCount"></span>
                        </a>
                    </li>

					<li class="dropdown bs-r-li mr-5" id="download-pack">
						...
						<ul class="dropdown-menu">
						  <li>
							...
							<a href="https://www.alamyimages.fr/download-packs.aspx" rel="nofollow">Acheter un autre forfait de téléchargement</a>
						  </li>
						</ul>
					</li>
                                ...
                                <div class="bg-dark-grey">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-12 pull-right">
                                                ...
                                                <button type="button" class="btn btn-cyan pull-right btn-inline-navbar"  onclick="return ValidateLogin(this.form)" id="automationBtnLogin"><strong>Se connecter</strong></button>
                ...
                <ul class="nav navbar-nav navbar-right pr-10" id="signedmenu" style="display:none">
                    ...
                    <li class="dropdown">
                        <a class="cart pl-5 mr-5" id="automationShoppingCartNormalUser" href="https://www.alamyimages.fr/order-view.aspx" title="Afficher le panier d’achat">
                             <i class="icon-cart mt-2 hidden-xs visible-sm visible-md visible-lg pull-left bold mr-5"></i>
                             <strong class="visible-xs hidden-sm hidden-md hidden-lg pull-left"> Panier d’achat &nbsp;</strong>
                             <span class="cartItems bold" id="automationCartItemCount"></span>  
                             
                        </a>
                    </li>

					<li class="dropdown bs-l-li pl-6" id="download-pack">
						<a class="dropdown-toggle btn-inline-navbar" data-toggle="dropdown" href="#" title="">
							 <i class="icon-download mt-2 hidden-xs visible-sm visible-md visible-lg pull-left bold mr-5"></i>
						...
						<ul class="dropdown-menu">
						  <li>
							...
							<a id="automationBuyAnotherDownloadPack" class="buyanotherdp" href="https://www.alamyimages.fr/download-packs.aspx" rel="nofollow">Acheter un autre forfait de téléchargement</a>
						  </li>
						</ul>
					</li>

                    <li class="dropdown bs-l-li ml-5 pl-5 my-cart" id="my-alamy">
				...
				<ul class="hidden-xs hidden-sm nav navbar-nav pull-right">
					    ...
					    <li class="dropdown lang-li bs-r-li ">
						<a data-toggle="dropdown" class=" int-a-lang  lang-selector dropdown-toggle btn btn-inline-navbar text-uppercase pr-14"><i class="icon-globe"></i><strong  id="automationHttpCulture" class="uppercase"title="">fr</strong></a>
						<ul class="dropdown-menu lang-dd">                         
                            <li class="int-en"><a id="automationHttpCultureEnglish" href="https://www.alamy.com" onclick="javascript:switchLanguages('com')" rel="nofollow" >English</a></li><li class="int-de"><a id="automationHttpCultureDeutsch" href="https://www.alamy.de" onclick="javascript:switchLanguages('de')" rel="nofollow" >Deutsch</a></li><li class="int-es"><a id="automationHttpCultureSpanish" href="https://www.alamy.es" onclick="javascript:switchLanguages('es')" rel="nofollow" >Español</a></li><li class="int-it"><a id="automationHttpCultureItalian" href="https://www.alamy.it" onclick="javascript:switchLanguages('it')" rel="nofollow" >Italiano</a></li>
						</ul>
					</li>
...
<script type="text/javascript">
    function switchLanguages(lanCode) {
        ...
        if ((intranetmode == "1" ) || intranetmode == "0") {
            ...
            document.cookie = "userLanguage=fr;Secure=true;path= /;domain= " + cookieDomain + exp;
            var slinkparam="";
            ...
            if(window.location.href.indexOf("/" + compurl_foldername + "-") != -1 && window.location.href.indexOf("?returnurl") == -1){
                var url="";
                url= 'https://www.alamyimages.fr'.replace(cookieDomain, (lanCode == "fr")? ".alamyimages." + lanCode : ".alamy." + lanCode) + '/mediacomp/imagedetails.aspx?ref='+'';
...
<script type="text/javascript">
    ...
    var URLPortion = ''
    var imgTypeValue = '0'
    var CaptchaAction = '/international/terms/general.aspx'
    $(document).ready(function () {
...
$('#search').attr('style','padding-right:'+($("#select_searchoptions").parents('.dropdown-trigger').outerWidth(true) + 23)+'px !important');
$('.search-clear-icon').attr('style','right:'+($("#select_searchoptions").parents('.dropdown-trigger').outerWidth(true) +42)+'px !important');
...
var ClearFocus = function(e) {
    ...
    function SubmitSearch() {      
        ...
        alamyRef = encodeURIComponent(alamyRef);
        ...
        var searchstring;
        if ('0' == '1')
            searchstring = 'qt=' + alamyRef + '&customgeoip=' + '' + '&mode=1';
        else
            searchstring = 'qt=' + alamyRef;
								...
								<div class="dropdown-wrapper">
									...
									<ul class="dropdown-menu mr-fix" id="dropdown_searchoptions" style="display: none;">
										...
										<li  data-media-name="Illustrations">
                                         ...
                                         <li  data-media-name="360_images">
											<label class="pl-20"><input type="radio" name="media_type" value="16" class="hidden" id="360_images">Images 360°</label>
										</li>
                    ...
                    <div class="col-md-4 col-xs-12 pb-0 p-10 adj-mt">
						...
						<div class="relative">
							...
							<ol class="jump-to">
								...
								<li><a href="#data-usage" class="dark-navy h16">How we use data</a></li>
								<li><a href="#unsubscribe" class="dark-navy h16">How to unsubscribe</a></li>
							</ol>
							<h3 class="dark-navy h18"><a href="#Our-policy" class="h-link dark-navy">Cookie policy</a></h3>
							<ol class="jump-to">
								<li><a href="#WhatCookiesAre" class="dark-navy h16">What Cookies are</a></li>
								<li><a href="#AlamyCookies" class="dark-navy h16">Alamy Cookies</a></li>
								<li><a href="#CookieConfigurations" class="dark-navy h16">Cookie Configurations</a></li>
							</ol>
					...
					<div class="col-md-8 col-xs-12 pb-0 p-10 bs-l bw-1 b-lg right-content">
						...
						<ol class="parent">
							...
							<li class="light-navy">
								...
								<ul class="disc-type">
									<li  class="light-navy">In any way that breaches any applicable local, national or international law or regulation;</li>
									<li  class="light-navy">In any way that is unlawful or fraudulent, or has any unlawful or fraudulent purpose or effect;</li>
									<li  class="light-navy">To transmit, or procure the sending of, any unsolicited or unauthorised advertising or promotional material or any other form of similar solicitation (spam);</li>
								...
								<ul class="disc-type">
									<li  class="light-navy">Not to reproduce, duplicate, copy or re-sell any part of our site in contravention of this agreement; and </li>
									<li  class="light-navy">Not to access without authority, interfere with, damage or disrupt any part of our website.</li>
								</ul>
							</li>
							<li class="light-navy">
                        ...
                        <p class="light-navy">Version 1.1</p>
                        ...
                        <p class="light-navy">This site is owned by Alamy Ltd ("Alamy", "we" or "us") whose registered office is at <span class="dark-navy"> 6 - 8 West Central, 127 Olympic Avenue, Milton Park, Abingdon, Oxon, OX14 4SA, United Kingdom</span> and our company registration number is 3807789, and we are the 'data controller' of the personal information you provide to us.  Alamy acts on behalf of all Alamy group companies, i.e. all parent and subsidiary undertakings</p>
                        ...
                        <p class="light-navy">We will review and update this Privacy Policy from time to time and all changes will be posted to this page.</p>
                        <p class="light-navy">This page was last updated on <span class="italics">15/10/2018</span>.</p>
						<ol class="parent" id="credit-account-section">
							...
							<li class="light-navy">
								...
								<p class="dark-navy" id="data-usage">What information do we collect and how may we use it?</p>
                                <ul class="disc-type">
                                    <li>All visitors to the site:
                                        ...
                                        <ul class="disc-type">
                                            <li class="light-navy">To administer any account you have with us</li>
                                            <li class="light-navy">To perform our contractual obligations to you</li>
                                            <li class="light-navy">To respond to your queries and requests</li>
                                            <li class="light-navy">To communicate with you</li>
                                            <li class="light-navy">To notify you of any changes to our services</li>
                                            <li class="light-navy">To ensure that the content of our site is presented in the most effective manner</li>
                                            <li class="light-navy">To provide you with the information, products and services requested from us</li>
                                            <li class="light-navy">To provide you with helpful information about our products or services</li>
                                            <li class="light-navy">To allow you to participate in interactive features of our service, should you choose to do so</li>
                                            <li class="light-navy">To administer competition entries and to notify winners</li>
                                            <li class="light-navy">Alamy market research</li>
                                            <li class="light-navy">To make improvements to the service we provide you</li>
                                        </ul>
                                    ...
                                    <li>Customers and registered users:
                                    ...
                                    <li>Contributeurs couvrant l’actualité :
                                ...
                                <p class="dark-navy">Social Media</p>
                                ...
                                <p class="dark-navy">How do we store and protect your data?</p>
                                ...
                                <p class="dark-navy">Third parties who provide services on our behalf</p>
                                ...
                                <ul class="disc-type">
                                    <li class="light-navy">Other Alamy group companies</li>
                                    <li class="light-navy">Our partners or advisors for the purposes of completing or investigating a transaction with you or answering a question you raise with us</li>
                                    <li class="light-navy">Translators we engage to translate into different languages image captions and tags (keywords) and other information associated with an image</li>
                                    <li class="light-navy">Marketing agencies appointed to provide services to us</li>
                                    <li class="light-navy">The service providers operating this site on our behalf</li>
                                    <li class="light-navy">Social media platforms</li>
                                    <li class="light-navy">Accountants, auditors, law firms, payment processors, information technology support providers</li>
                                    <li class="light-navy">Advertising services, analytics services, content providers</li>
                                </ul>
                                ...
                                <p class="dark-navy">How long do we store your data?</p>
                                ...
                                <p class="dark-navy">Your rights</p>
                                ...
                                <p class="dark-navy">Public areas</p>
                                ...
                                <p class="dark-navy">No data collected from children</p>
                                ...
                                <p class="dark-navy">Third Party Websites</p>
                        ...
                        <p class="light-navy">We explain what cookies are, how Alamy use them and how you can manage or remove them.</p>
						<ol class="parent" id="credit-account-section">
							<li class="light-navy">
								<h4 class="dark-navy h16 inline-block" id="WhatCookiesAre">What are cookies?</h4>
							...
							<li class="light-navy">
								<h4 class="dark-navy h16 inline-block" id="AlamyCookies">What sort of cookies does the Alamy website use?</h4>
								...
								<p class="break-all">In addition to our own cookies, we use third party tools which also use cookies.</p>
								...
								<p>If, after reading this information you have any questions or concerns about our cookie policy please contact us at <a href="mailto:sales@alamy.com">sales@alamy.com</a> or read our <a href="#privacy-policy">privacy policy</a>.</p>
							
								<h4 class="dark-navy h16 inline-block" id="Alamy-cookies">We are using the different types of cookies listed below:</h4>
								...
								<table cellspacing="0" class="mw-100percent terms-table">
									...
									<tbody>
										<tr>
											<th class="row break-all"" scope="row"> Strictly Necessary </th>
										<td class="row p-10"><p>These cookies are essential for the operation of our websites.</p><p>For example, they keep track of what you have in your basket and identify you as being logged in to the website and allows us to recognise you as a customer or contributor.</p><p>If you block these cookies we cannot guarantee the website will perform correctly.</p></td>      
										</tr>
										<tr>
											<th class="row break-all" scope="row"><label>Performance</label></th>
										<td class="row p-10"><p>We use these cookies to analyse how our visitors use our websites and to monitor website performance.</p><p>For example, we might use them to keep track of which pages are most popular, test new website's design and operability and to see why some pages are receiving error messages.</p></td>      
										</tr>
										<tr>
											<th class="row break-all" scope="row">Functionality</th>
										<td class="row p-10"><p> We use functionality cookies to remember choices you make such as which regional edition of the website you want to see when you log in.</p><p>These cookies recall any customisation you make to pages on the website during your visit.</p><p>If you block these cookies certain features and services may be affected and we cannot be sure how the Website will perform during your visit.</p></td>      
										</tr>
										<tr class="">
											<th class="row break-all" scope="row">Marketing</th>
										<td class="row p-10"><p>These cookies are used to track our visitors browsing habits and activity across our websites. They can be used to build up a profile of search and/or browsing history for every visitor. Identifiable or unique data may be collected. Anonymized data may be shared with third parties.</p><p>This information is linked to site functionality provided by other websites, and may be shared with other organisations (such as advertising networks).</p></td>      
										</tr>
										<tr>
											<th class="row break-all" scope="row">Third party</th>
							...
							<li class="light-navy">
								<h4 class="dark-navy h16 inline-block" id="CookieConfigurations">How do I control my cookies?</h4>
      ...
      <div class="container">
               ...
               <div class="row mr-ie" id="footer-top-border">
                  <div class="col-md-3 col-sm-3 col-xs-12 h4-size lh-12 m-0 mb-10 pr-0" id="useful-links">
                     <ul class="remove-bullet p-0 mb-0">
                        <li>
                           <div class="h16 light-navy " id="automationUsefulLinks">Liens utiles</div>
                           <ul class="remove-bullet p-0 mb-0 h6 list">
                              <li><a id="automationImageCategories" href="https://www.alamyimages.fr/category.aspx" onclick="windowListener(this.href);">Catégories d’images</a></li>
                              <li><a id="automationReleasesExplained" href="https://www.alamyimages.fr/help/what-is-model-release-property-release.aspx" onclick="windowListener(this.href);">Guide relatif aux autorisations</a></li>
                              <li><a id="automationrStockPhotoThemes" href="https://www.alamyimages.fr/themes.aspx" onclick="windowListener(this.href);">Thèmes des photos</a></li>
							  <li><a id="automationrContributorHomepage" href="https://www.alamyimages.fr/contributors.aspx" onclick="windowListener(this.href);">Page d’accueil des contributeurs</a></li>
							  <li><a id="automationrSiteMap" href="https://www.alamyimages.fr/sitemap.aspx" onclick="windowListener(this.href);">Plan du site</a></li>
							  <li><a id="automationTermsAndCondition" href="https://www.alamyimages.fr/terms/terms.aspx" onclick="windowListener(this.href);">Conditions générales</a></li>
							  <li><a id="automationPrivacyPolicy"  href="https://www.alamyimages.fr/terms/general.aspx#Our-privacy-policy" onclick="windowListener(this.href);">Politique de confidentialité</a></li>
							  <li><a id="automationCookiePolicy" href="https://www.alamyimages.fr/terms/general.aspx#Our-policy" onclick="windowListener(this.href);">Politique relative aux cookies</a></li>
                              <li><a id="automationCopyrightComplaints" href="https://www.alamyimages.fr/terms/general.aspx#complaints" onclick="windowListener(this.href);">Réclamations droits d'auteur</a></li>
                           </ul>
                        </li>
                     </ul>
                  </div>
                  <div class="col-md-3 col-sm-3 col-xs-12 h4-size lh-12 m-0 mb-10 pr-0" id="get-in-touch">
                     <ul class="remove-bullet p-0 mb-0">
                        <li>
                           <div class="h16 light-navy" id="automationGetInTouch">Contactez-nous</div>
                           <ul class="remove-bullet p-0 mb-0 h6 list">
						   ...
						   <ul class="p-0 mb-0 h6 list mt-5 print-remove-bullet" id="connect-with-us-list">
								<li>
								  <div class=" alt-social" id="socialnet_Notemailsubscribed">
									 <a href="https://www.facebook.com/alamy" id="automationFacebook" title="Retrouvez-nous sur Facebook" target="_blank" class="social-icon-footer snetwork" rel="nofollow"><i class="icon-fb light-navy mr-10 "></i></a>
									 <a href="https://www.twitter.com/alamy" id="automationTwitter" title="Suivez-nous sur Twitter" target="_blank" class="social-icon-footer snetwork" rel="nofollow"><i class="icon-twitter light-navy mr-10 "></i></a>
									 <a href="https://instagram.com/alamyinstagram" id="automationInstragram" title="Suivez-nous sur Instagram" target="_blank" class="social-icon-footer snetwork" rel="nofollow"><i class="icon-instagram light-navy mr-10 "></i></a>
									 <a href="https://www.pinterest.com/alamy" id="automationPinterest" title="Pinterest" target="_blank" class="social-icon-footer snetwork" rel="nofollow"><i class="icon-pinterest light-navy mr-10 "></i></a>
									 <br class="hidden-sm hidden-xs">
									 <a href="https://www.linkedin.com/company/alamy" id="automationLinkedin" title="Linkedin" target="_blank" class="social-icon-footer snetwork" rel="nofollow"><i class="icon-linkedin light-navy mr-10 "></i></a>
									 <a href="https://www.youtube.com/user/Alamylimited" id="automationYoutube" title="YouTube" target="_blank" class="social-icon-footer snetwork" rel="nofollow"><i class="icon-youtube light-navy mr-10 "></i></a>
         ...
         <div class="row m-0">
            <div class="col-md-12 b-ln bw-1 bs-b">
               <div id="image-cont-display" class="tagline-txt light-navy">158 367 132 images, vecteurs et vidéos</div>
            </div>
         </div>
         <div class="row mr-ie m-0">
            <div class="col-md-12 col-xs-12 mb-15 copy light-navy h6 mt-50">
               <p class="text-center">Alamy et ses logos sont des marques commerciales d’Alamy Ltd. et sont déposées dans certains pays. Droit d’auteur&copy; 23/04/2019 Alamy Ltd. Tous droits réservés.</p>
            </div>
         </div>
      </div>
   </div>
...
<script type="text/javascript">
 ...
 var Secureurl = 'https://www.alamyimages.fr';
    ...
    var HTTP_Path_Static = 'https://static.alamy.com';
    var Href = 'https://www.alamyimages.fr/';
    var HrefPath = 'https://www.alamyimages.fr/';
    var IsBotrequestEnabled = 'true'; 
    var footerResourceString = '{"lblCountryChangeText":"Nous pensons que vous vous trouvez en @@countryName. Si nous avons tort,","lblCountryChangeTextWithoutWordThe":"Nous pensons que vous vous trouvez en @@countryName. Si nous avons tort,","germany":"Allemagne","us":"États-Unis","canada":"Canada","auAndnz":"Australie et Nouvelle-Zélande","india":"Inde","uk":"Royaume-Uni","clickHere":"Cliquez ici","emailNotValidText":"Désolé. Cette adresse mail n&#146;est pas valide.","optionNotSelecedText":"Veuillez sélectionner au moins une option.","emailSubscriptionSuccessMessage":"Terminé ! Vous êtes abonné(e) au bulletin d’information.","alreadySignUpMessage":"Vous êtes déjà inscrit(e) pour recevoir nos mails.","JoinOver230000":"Tenez-vous informé(e) de l’actualité d’Alamy et recevez nos offres, ainsi que celles de certains de nos partenaires triés sur le volet."}';
    var footerResources = {};
...
<!-- Below is the content from gtm.js - for site speed -->
<script type="text/javascript">
    function SendAddToCartDataforGoogle(e) { for (var n = [], i = 0; i < e.length; i++) { var o, t, a, r, s, c, d, m, u, y, p, g, l, h, v, f, C; e[i].category, r = e[i].Currency, o = e[i].id, e[i].id, t = e[i].price, a = e[i].category, quantity = 1, s = e[i].dimension14, c = e[i].dimension22, d = e[i].dimension23, m = e[i].dimension24, u = e[i].dimension25, y = e[i].dimension26, p = e[i].dimension27, g = e[i].dimension28, l = e[i].dimension29, h = e[i].dimension30, v = e[i].dimension31, f = e[i].dimension32, C = e[i].dimension33, "Images" == a || "Vector" == a || "360" == a ? c ? n.push({ id: o, name: "", category: a, price: t, quantity: 1, dimension14: s, dimension22: c, dimension23: d, dimension24: m, dimension25: u, dimension26: y, dimension27: p, dimension28: g, dimension29: l, dimension30: h, dimension31: v, dimension32: f, dimension33: C }) : n.push({ id: o, name: "", category: a, price: t, quantity: 1, dimension14: s }) : n.push({ id: o, name: "", category: a, price: t, quantity: 1 }) } dataLayer.push({ event: "addToCart", ecommerce: { currencyCode: r, add: { products: n } } }) } function SendremoveFromCartDataforGoogle(e) { for (var n = [], i = 0; i < e.length; i++) { var o, t, a, r, s; e[i].category, r = e[i].Currency, o = e[i].id, e[i].name, t = e[i].price, a = e[i].category, quantity = 1, s = e[i].dimension14, "Images" == a ? n.push({ id: o, name: "", category: a, price: t, quantity: 1, dimension14: s }) : n.push({ id: o, name: "", category: a, price: t, quantity: 1 }) } dataLayer.push({ event: "Removefromcart", ecommerce: { currencyCode: r, remove: { products: n } } }) } GTM = function (e) { this.category = e }, GTM1 = function () { }, GTM.prototype.setValues = function (e, n, i) { dataLayer.push({ category: this.category, action: e, label: n, value: i, event: "click" }) }, GTM1.prototype.setValueswithCategory = function (e, n, i, o) { dataLayer.push({ category: e, action: n, label: i, value: o, event: "click" }) }, GTM.prototype.setEventValues = function (e, n, i, o) { dataLayer.push({ category: this.category, action: e, label: n, value: i, event: o }) }, GTM.prototype.clearValues = function () { this.category = "", this.action = "", this.label = "", this.value = "" };
</script> 

<script type="text/javascript" src="https://static.alamy.com/scripts/branding/FooterResponsive-min-1.4172.15.js"></script>
