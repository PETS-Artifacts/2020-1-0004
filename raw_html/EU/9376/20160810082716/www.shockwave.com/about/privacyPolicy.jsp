...
<script>
    ...
    var dartGenre = 'sports';
    var dartCategory = 'sports';
    var dartKeyword = 'free-kick-2012';
</script>
<script type="text/javaScript" >
    SW.adSettings = {};
    SW.adSettings.DoubleClickDartSite = 'sw.nol';
    SW.adSettings.DoubleClickPositionThreshold = '1';
    SW.adSettings.DoubleClickSections='sports/free-kick-2012';
    SW.adSettings.DoubleClickKeyValues = '!category=sports;!category=pop;!category=float;!category=expand;';
