...
<script>
    ...
    var dartGenre = 'shooters';
    var dartCategory = 'shooters';
    var dartKeyword = '_mn';
</script>
<script type="text/javaScript" >
    SW.adSettings = {};
    ...
    SW.adSettings.DoubleClickSections='shooters/_mn';
    SW.adSettings.DoubleClickKeyValues = '!category=shooters;!category=pop;!category=float;!category=expand;';
            ...
            <div class="pseudo-tabs">
                ...
                <ul>
                    ...
                    <li class="search-games">
                        <form id="globalSearch" name="globalSearch" method="get" action="/search.jsp">
