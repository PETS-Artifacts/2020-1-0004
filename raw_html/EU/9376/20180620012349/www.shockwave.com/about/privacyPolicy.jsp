...
<html xmlns="http://www.w3.org/1999/xhtml"
	...
	<head prefix="og: http://ogp.me/ns# shockwavegames: http://ogp.me/ns/apps/shockwavegames#">
		<title>
...
<script>
	window.SW = window.SW || {};
	SW.envConfig = SW.envConfig || {};

	
	
	var userInfo = {
		"signedInState": "NotSignedIn",
		"signedInStateCode": "NSI",
		"memberId": "",
		"memberCookie": "",
		"email": "",
		"screenName": "",
	...
	SW.userInfo = userInfo;

	var eventManagerBaseUrl = "http://eventmanager.shockwave.com";
	...
	var myGameDescription = "";
	var gameArchiveValue = "";
	var gameKeyword = "";
	var gameTitle = "";
	var gameGenre = "";
	var isLiveEnvironment = "prod";

	SW.envConfig = {
		googleAnalyticsAcct : 'UA-52115930-2',
		eventManagerBaseUrl : eventManagerBaseUrl,
		currentTokenBalance : currentTokenBalance,
		currentCashBalance : currentCashBalance,
		useFacebook : useFacebook,
		myGameDescription : myGameDescription,
		gameArchiveValue : gameArchiveValue,
    ...
    var dartGenre = 'puzzle';
    var dartCategory = 'puzzle';
    var dartKeyword = '_mn';
</script>
<script type="text/javaScript" >
    SW.adSettings = {};
    SW.adSettings.DoubleClickDartSite = 'sw.nol';
    SW.adSettings.DoubleClickPositionThreshold = '1';
    SW.adSettings.DoubleClickSections='puzzle/_mn';
    SW.adSettings.DoubleClickKeyValues = '!category=puzzle;!category=pop;!category=float;!category=expand;';
    SW.adSettings.DoubleClickAutoDcopt=true;
</script>
		...
		<meta name="keywords" content="play games, free online games, free downloadable games" />
		<meta name="description" content="Play Games - Free Online Games, Free Downloadable Games from Shockwave.com" />

		<meta http-equiv="X-UA-Compatible" content="IE=7" />

		<meta name="verify-v1" content="B4FxWt76XJ3beIqm6ZNU4C6YtzJ8F686ViAOipQxQq0=" />
		<meta name="verify-v1" content="jtVqN9qAF2t85hagC75TyhzOkaO4sqkroQCA3mlB+q0=" />
		<meta name="y_key" content="563a3e22a432f0e9" />
		<meta name="google-site-verification" content="osO2rmq9s2pGwNaYtnhFoWu2834j91XkwwDmorkTiOk" />
		<meta name="msvalidate.01" content="296061D9BF3B715425A06285092FF05D" />

		
		
		<meta property="fb:admins" content="1474163203,690197317,671820682,29900452,100001282501617,611128152,100002337691955,100002295361980,eniac.tube" />
		...
		<link rel="canonical" href="http://localhost:8080/about/privacyPolicy.jsp" />
		...
		<meta property="og:site_name" content="Shockwave.com" />
		<meta property="og:type"	content="game" />
		<meta property="og:title"	content="Shockwave - Privacy Policy" />
		<meta property="og:image"	content="http://www.shockwave.com/i/picons/s_logo_whi_on_blue_100x120.png" />
		<meta property="og:description"	content="Play Games - Free Online Games, Free Downloadable Games from Shockwave.com" />
        <meta property="og:url"	content="http://localhost:8080/about/privacyPolicy.jsp" />
		<meta itemprop="name" content="Shockwave.com">
        <meta itemprop="description" content="Play Games - Free Online Games, Free Downloadable Games from Shockwave.com">
        <meta itemprop="image" content="http://www.shockwave.com/i/picons/s_logo_whi_on_blue_100x120.png"/>
		...
		<link href=/min/css/global.css type="text/css" rel="stylesheet"/>
				...
				<!-- if[IE 9]>
				<style type="text/css">
						#mainNav .swTicker ul li.tickerNSI DIV.tickerData { margin-top: 0px; }
				</style>
				<![endif]-->
...
})(window,document,'script','dataLayer','GTM-KTF7V8');</script>
<!-- /Google Tag Manager, Header bidding account -->
...
<script type="text/javascript" src="//pubportal.brkmd.com/tms/hblt3191922f29e72fc8f4b94dd9b1e57070.js"></script>
...
<script>
    ...
    window.SW = window.SW || {};
    SW.globals = SW.globals || {};

    SW.globals.GPT_REFRESHRATE = 120000; // Refresh every 2 minutes
    ...
    googletag.cmd.push(function() {
    	<!-- The 2 300x250 ad units on the right hand-side will alway be displayed unless the wide game is displayed -->
    	
    	  
    	  
    	  
    	    googletag.defineSlot('/4678/shockwave_web/ros-right-atf', [[300, 250]], 'ad300x250-right-atf').addService(googletag.companionAds()).addService(googletag.pubads());
    	    googletag.defineSlot('/4678/shockwave_web/ros-right-mid', [[300, 250]], 'ad300x250-right-mid').addService(googletag.companionAds()).addService(googletag.pubads());
    	  
    	
    	
        <!-- In the home page the leaderboard ad can be only 728 wide. -->
        <!-- Also beween Word & Strategy games there are 2 300x250 ad units. -->
        <!-- In all other pages, the leaderboard ad can be 728x90 OR 970x90. -->
    	
    	  
          
            googletag.defineSlot('/4678/shockwave_web/ros-top', [[728, 90],[970,90], [960,1]], 'ad728x90-top').addService(googletag.pubads());
          
        
    	
    	googletag.defineSlot('/4678/shockwave_web/ros-bottom', [[728, 90],[970, 250]], 'ad728x90-bottom').addService(googletag.pubads());
    	googletag.defineSlot('/4678/shockwave_web/ros-top-popout', [[728, 90],[960,1]], 'ad728x90-top-popout').addService(googletag.pubads());
	...
	<body id="online" class="NotSignedIn  about-privacy  false" >
...
<!-- Google Tag Manager -->
<noscript><iframe src="//www.googletagmanager.com/ns.html?id=GTM-MV9FHH"
                  height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
<script>(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':
        new Date().getTime(),event:'gtm.js'});var f=d.getElementsByTagName(s)[0],
        j=d.createElement(s),dl=l!='dataLayer'?'&l='+l:'';j.async=true;j.src=
        '//www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);
})(window,document,'script','dataLayer','GTM-MV9FHH');</script>

<!-- Google Tag Manager, header bidding account noscript -->
<noscript><iframe src="//www.googletagmanager.com/ns.html?id=GTM-KTF7V8"
                  height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
<!-- End Google Tag Manager -->
		...
		<script type="text/javascript" src=/min/js/globalJsBodyPreTEMP.min.js></script>
	
	
	


	<script type="text/javascript" src=/js/sw-coda/sw-coda.js></script>

	

	
		<script type="text/javascript" src=/min/js/globalJsBodyPostTEMP.min.js></script>
	...
	<script type="text/javascript">
		if(!gameID){
			// Check for global game ID, if it doesn't exist create it
			var gameID = '';
		}
	</script>
...
<div id="games-header-nav" class="games-header-nav">
    <div class="wrapper clearfix">
        <div class="user-bar clearfix">
			...
			<div id="logo">
			   <a href="/home.jsp">
				   ...
				   <img src="/i/common/logos/shockwave_logo.png" alt="" />
			   </a>
			</div>
            <div class="create-account">
                        ...
                        <div class="user-loginSignup">
                            <a href="#" class="staticSignInLink">log in</a>
                             |
                            <a href="#" class="headerLoginSW staticRegisterLink">sign up</a>
                        </div>
        ...
        <div class="link-smash clearfix">
            <div class="pseudo-tabs">
                
                <ul>
                    <li><a title="Online Games" href="/home.jsp" class="online-tab">online games</a></li>
                    <li><a title="Download Games" href="/download.jsp" class="download-tab">download games</a></li>
                    <li><a title="Free Online Gaming Community" href="/myShockwave.jsp" class="shockwave-tab">my shockwave</a></li>
                    <li class="search-games">
                        <form id="globalSearch" name="globalSearch" method="get" action="/games/find.jsp">
                            <input id="globalSearchInput" type="text" value="" placeholder="Search Games" name="q" class="ui-autocomplete-input" autocomplete="off" role="textbox" aria-autocomplete="list" aria-haspopup="true" />
                            <input type="submit" id="game-search-submit" value=" " />
                        </form>
                    </li>
                </ul>
            </div>
            <div class="game-links" id="sw-subnav">
            ...
            <ul class="clearfix">
                ...
                <li id="subtab-1" ><a title="All Free Online Games" href="/online/all-games.jsp">All Games</a></li>
                    ...
                    <li id="daily" class="">
                        ...
                        <a title="Daily Games" href="/online/daily-games.jsp">Daily Games</a>
                    </li>
                    ...
                    <li id="jigsaws" class="">
                        ...
                        <a title="Jigsaw Puzzle Games" href="/online/jigsaws-games.jsp">Jigsaw</a>
                    </li>
                    ...
                    <li id="puzzle" class="">
                        ...
                        <a title="Online Puzzle Games" href="/online/puzzle-games.jsp">Puzzle</a>
                    </li>
                    ...
                    <li id="word" class="">
                        ...
                        <a title="Online Word Games" href="/online/word-games.jsp">Word</a>
                    </li>
                    ...
                    <li><b class="buffer"><!-- --></b> </li>
                    <li id="hidden-object" class="">

                        
                        
                        <a title="Online Hidden Object Games" href="/online/hidden-object-games.jsp">Hidden Object</a>
                    </li>
                    ...
                    <li><b class="buffer"><!-- --></b> </li>
                    <li id="strategy" class="">

                        
                        
                        <a title="Online Strategy Games" href="/online/strategy-games.jsp">Strategy</a>
                    </li>
                    ...
                    <li><b class="buffer"><!-- --></b> </li>
                    <li id="matching" class="">

                        
                        
                        <a title="Online Matching Games" href="/online/matching-games.jsp">Matching</a>
                    </li>
                    ...
                    <li id="racing" class="">
                        ...
                        <a title="Online Racing Games" href="/online/racing-games.jsp">Racing</a>
                    </li>
                    ...
                    <li><b class="buffer"><!-- --></b> </li>
                    <li id="time-management">
                        <a title="Time Management Games" href="/online/time-management-games.jsp">Time Management</a>
                    </li>
                    ...
                    <li><b class="buffer"><!-- --></b> </li>
                    <li id="card-board">
                        <a title="Card Games & Board Games" href="/online/card-board-games.jsp">Card & Board</a>
                    </li>
                    ...
                    <li><b class="buffer"><!-- --></b> </li>
                    <li id="adventure">
                        <a title="Adventure Games" href="/online/adventure-games.jsp">Adventure</a>
                    </li>
                    ...
                    <li><b class="buffer"><!-- --></b> </li>
                    <li id="action">
                        <a title="Action Games" href="/online/action-games.jsp">Action</a>
                    </li>
                    ...
                    <li><b class="buffer"><!-- --></b> </li>
                    <li id="shooters">
                        <a title="Shooting Games" href="/online/shooters-games.jsp">Shooters</a>
                    </li>
                    ...
                    <li><b class="buffer"><!-- --></b> </li>
                    <li id="car-racing">
                        <a title="Car Racing Games" href="/online/car-racing-games.jsp">Car Racing</a>
                    </li>
                    ...
                    <li><b class="buffer"><!-- --></b> </li>
                    <li id="sports">
                        <a title="Sports Games" href="/online/sports-games.jsp">Sports</a>
                    </li>
                    ...
                    <li><b class="buffer"><!-- --></b> </li>
                    <li id="family-kids">
                        <a title="Family & Kids Games" href="/online/family-kids-games.jsp">Family & Kids</a>
                    </li>
                
                <!-- EMPIRE LINK -->
                    <li><b class="buffer"><!-- --></b></li>
                    <li id="empire" class="empireLink">
                        <a title="Empire" href="/empire.jsp" data-ga="SecondaryNav:Click:Empire"><img src="/i/sponsors/empire/crown.png" alt="Empire Logo">EMPIRE</a>
                    </li>
                <!-- /EMPIRE LINK -->
            </ul >
    ...
    <!-- Leaderboard Ad - gamePlayDefault -->
	...
	<div class="bannerWrapperAdLeaderboard">
		<div class="banner">
			<div id="ad728x90-top" style="height:90px;overflow:hidden;">
				<script>
					googletag.cmd.push(function() {
						
							googletag.display("ad728x90-top");
...
<h1 class="pageTitle">About Shockwave</h1>
<div class="col col3">
	

  <ul class="listNav">
		<li ><a href="/about/index.jsp">About Shockwave</a></li>
		<li ><a href="/about/advertising.jsp">Advertising</a></li>
		<li ><a href="/about/developers.jsp">Game Developers</a></li>
        <li ><a href="/about/careers.jsp">Careers</a></li>
		<li ><a href="/about/terms.jsp">Terms of Use</a></li>
		<li class="active"><a href="/about/privacyPolicy.jsp">Privacy Policy</a></li>
		<li ><a href="/about/virtualCurrencyAgreement.jsp">Virtual Currency Purchasing Agreement</a></li>
		<li ><a href="/about/copyrightTrademark.jsp">Copyright and Trademark</a></li>
		<li ><a href="/about/copyrightCompliance.jsp">Copyright Compliance Policy</a></li>
		<li ><a href="/about/submissionAgreement.jsp">User Submission Agreement</a></li>
		<li ><a href="/about/contact.jsp">Contact Us</a></li>
  </ul>

</div>
<div class="col col8 subSection nickFrame">
	<div class="pod podWhite">
		<div class="podContent newPodContent" style="padding:10px 20px 20px 20px; margin-top:-2px;">
			<!-- <img class="headline" src="/i/subSections/hdPrivacyAndLegal.png" alt="hdPrivacyAndLegal.png" width="436" height="59" /> -->
			...
			<p align="center">
				<strong>LAST UPDATED: 5/25/2018</strong>
			</p>
			<p>
			...
			<p>
				For your convenience, the following is a quick summary of our Privacy Policy.<br>
			...
			<table border="1" cellspacing="0" cellpadding="0" width="100%">
				...
				<tr>
					...
					<td>
						<p>
							DEFY is a member of the NAI (Network Advertising Initiative) and adheres to the NAI Code of Conduct, which may be found <a href="http://www.networkadvertising.org/code-enforcement/code" target="_blank">here</a>, and the Digital Advertising Alliance's Self-Regulatory Principles for Online Behavioral Advertising, which may be found <a href="http://www.aboutads.info/obaprinciples" target="_blank">here</a>.
						</p>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td>
						...
						<p>
							DEFY Media, LLC<br>
							366 5th Avenue, 4th Floor<br>
							New York, NY 10001<br>
							Attn: California Privacy<br>
			...
			<p>
				You may view or change your information at any time; if you'd like to do so, please <a target="_blank" href="mailto:privacy@defymedia.com?subject=Site%20Personal%20Information%20Request">CONTACT US</a>. Please include documents that prove your identity and a clear and precise description of the information to which you request access.
			</p>
			<p>
			...
			<p>
				<strong>Personal Information Gathered Under Previous Versions of This Privacy Policy.</strong>
			</p>
			<p>
			...
			<p>
				If you would prefer not to receive marketing or promotional e-mails from us that may relate, for example, to new services or offerings, you may opt-out of receiving these communications - <a target="_blank" href="mailto:privacy@defymedia.com?subject=Site%20Personal%20Information%20Request">CONTACT US</a> to (i) deregister your account; or (ii) change or edit your preferences. You may also use the opt-out mechanism that is contained in an email.
			</p>
			<p>
				If you would like to opt-out of receiving marketing or promotional postal mail from us, please <a target="_blank" href="mailto:privacy@defymedia.com?subject=Site%20Personal%20Information%20Request">CONTACT US</a> or let us know in writing via letter addressed to: Attn: Privacy, DEFY Media, LLC 366 5th Avenue, 4th Floor, New York, NY 10001. For all postal mail opt-out requests, please include your name, street address, city, state, and zip code. We cannot accept postal mail opt-out requests via telephone or facsimile, nor will we be responsible for notices that are not labeled or sent properly or lack complete information. Please note that we may require up to sixty (60) days to fully remove your postal mail information from our mailings.
			</p>
			<p>
			...
			<p>
				A new European Union law, referred to as the General Data Protection Regulation or "GDPR", gives certain rights to individuals in relation to their personal data. Accordingly, and so as to ensure we are compliant with applicable law and regulation, we do not collect nor utilize personal data of our European Union users and have implemented certain steps to geoblock the Site and restrict access to such users; we invite those users to visit our various programming channels. If you have any questions about your privacy, your rights, or how to exercise them, please <a target="_blank" href="mailto:privacy@defymedia.com?subject=Site%20Personal%20Information%20Request">CONTACT US</a>. We will respond to your request within a reasonable period of time upon verification of your identity.
			</p>
			<p>
				<strong>How You Can Access or Correct Your Personal Information.</strong>
			</p>
			<p>
				For instructions on how you can access the personal information that we have collected about you online, or how to correct any errors in such information, please <a target="_blank" href="mailto:privacy@defymedia.com?subject=Site%20Personal%20Information%20Request">CONTACT US</a>.
			</p>
			<p>
			...
			<p>
				If you have any questions or concerns about this privacy policy you may <a target="_blank" href="mailto:privacy@defymedia.com?subject=Site%20Personal%20Information%20Request">CONTACT US</a> or write to the following address:
			</p>
			<p>
				DEFY Media, LLC<br>
				366 5th Avenue, 4th Floor<br>
		...
			    <div id="footer" class="clearfix">											<div class="footer">				<h2>Free Online Games and More</h2>												<p>Part of the Addicting Games network.</p>				<ul class="clear aboutUs corpLinks">					<li><a href="/help/contact_us.jsp" class="corpLinks btnOnlinePlain">CONTACT US</a></li>					<li><a href="/about/index.jsp" class="corpLinks">About Us</a></li>										<li><a href="/help/index.jsp" class="corpLinks">Help</a></li>					<li><a href="/about/advertising.jsp" class="corpLinks">Advertising</a></li>														</ul>				<ul class="clear corpLinks">					<li><a href="/about/terms.jsp" class="corpLinks">Terms of Use</a></li>					<li><a href="/about/virtualCurrencyAgreement.jsp" class="corpLinks">Virtual Currency Purchasing Agreement</a></li>					<li><a href="/about/privacyPolicy.jsp" class="corpLinks">Privacy Policy</a></li>					<li><a href="/about/copyrightCompliance.jsp" class="corpLinks">Copyright Compliance Policy</a></li>									</ul>				<div class="clear" id="footerLogo">Copyright &copy; 2018 Defy Media, LLC; all rights reserved.<br />				Third-party trademarks are used solely for distributing the games indexed herein and no license or other affiliation is implied.</div>			</div>						</div><div id="dynamicContent" class="dimmerMessage"></div>	

	
		<script type="text/javascript" src=/min/js/globalFooterTEMP.min.js></script>
...
    <div id="fb-root"></div>    <script src="https://connect.facebook.net/en_US/sdk.js"></script><script>    SW = SW || {};    SW.globals = SW.globals || {};    SW.globals.contentBaseUrl = 'http://www.shockwave.com';        SW.globals.facebook = {        isFacebookConnected : false,        isFacebookAutoPublish : false,        disabledPermissions : [],        facebookUserName : '',        facebookAuthToken : '',    };    window.fbAsyncInit = function() {    	FB.init({            appId: '187708801677',            status: true,            cookie: true,            xfbml: true,            oauth:true,            version: 'v2.7'        });    };    document.addEventListener("DOMContentLoaded", function(event) {                                                                                                    SW.globals.facebook.isFacebookConnected = false                                                                            SW.globals.facebook.isFacebookAutoPublish = false                        });</script><!-- PAGEOK -->
...
<script>
	...
	_comscore.push({ c1: "2", c2: "4000003" , c4: "www.shockwave.com/&amp"});
	(function() {
...
<noscript>
	<img src="http://b.scorecardresearch.com/p?c1=2&c2=4000003&c4=www.shockwave.com&cv=2.0&cj=1" />
</noscript>
<!-- End comScore Tag -->
...
<!-- END Nielsen Online SiteCensus V6.0 -->
		...
		<!-- Ad Blocker Test & Tracking -->
		<script type="text/javascript" src="http://media5.break.com/campaigns/block-test/advertisement.js"></script>

<script>
	(function(){
		
		SW.globals.customDimensionAdsBlocked =  window.canRunAds === undefined ? 'ad-blocked' : 'not-ad-blocked';
	}());
</script>
	...
	<div id="ad1x1">
		<script>
			googletag.cmd.push(function() {
				googletag.defineOutOfPageSlot('/4678/shockwave_web/ros-interstitial', 'ad1x1').addService(googletag.pubads());
				googletag.display('ad1x1');
			});
		</script>
	</div>
