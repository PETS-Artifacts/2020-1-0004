...
<script>
    ...
    var dartGenre = 'Jigsaw';
    var dartCategory = 'Jigsaw';
    var dartKeyword = 'jigsawpuzzles';
</script>
<script type="text/javaScript" >
    SW.adSettings = {};
    SW.adSettings.DoubleClickDartSite = 'sw.nol';
    SW.adSettings.DoubleClickPositionThreshold = '1';
    SW.adSettings.DoubleClickSections='Jigsaw/jigsawpuzzles/_mn';
    SW.adSettings.DoubleClickKeyValues = '!category=Jigsaw;!category=pop;!category=float;!category=expand;';
