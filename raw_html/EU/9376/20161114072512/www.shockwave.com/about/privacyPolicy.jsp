...
<script>
    ...
    SW.globals.GTM_TIMEOUT = 5000; // Wait 5 seconds
    ...
    googletag.cmd.push(function() {
    	    ...
    	    googletag.defineSlot('/4678/shockwave_web/ros', [[300, 250]], 'ad300x250').addService(googletag.companionAds()).addService(googletag.pubads());
    	  
    	
    	googletag.defineSlot('/4678/shockwave_web/ros', [[728, 90],[960,1]], 'ad728x90').addService(googletag.pubads());
            ...
            <div class="pseudo-tabs">
                ...
                <ul>
                    ...
                    <li class="search-games">
                        <form id="globalSearch" name="globalSearch" method="get" action="/games/elasticsearch.jsp">
			...
			<div id="ad728x90">
				<script>
					googletag.cmd.push(function() {
							...
							// Moved to adSlots.jsp
							// googletag.defineSlot('/4678/shockwave_web/ros-top', [[728, 90],[960,1]], 'ad728x90').addService(googletag.pubads());

							googletag.display('ad728x90');
