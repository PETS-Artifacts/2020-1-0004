...
<script>
    ...
    var dartGenre = 'strategy';
    var dartCategory = 'strategy';
    var dartKeyword = 'three-slices';
</script>
<script type="text/javaScript" >
    SW.adSettings = {};
    SW.adSettings.DoubleClickDartSite = 'sw.nol';
    SW.adSettings.DoubleClickPositionThreshold = '1';
    SW.adSettings.DoubleClickSections='strategy/three-slices';
    SW.adSettings.DoubleClickKeyValues = '!category=strategy;!category=pop;!category=float;!category=expand;';
