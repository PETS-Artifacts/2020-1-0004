...
<link rel="preload" href="/css/main.css?exp=1552928045" as="style">
<link rel="preload" href="/images/uk-essays.png" as="image">
<link rel="shortcut icon" href="/favicon.ico">
<link href="/css/main.css?exp=1552928045" rel="stylesheet" type="text/css">
...
<li class="ml-auto"><a href="/order/?product=1" class="btn btn-lg btn-success btn-block px-5 py-1">Place an Order</a></li>
</ul>
</div>
</nav>
...
<footer class="g-footer bg-black py-4 py-md-5 text-white" data-track="Footer new">
<div class="container">
<div class="bg-dark px-5 py-4 rounded d-sm-flex justify-content-between align-items-center my-md-5 text-center text-sm-left">
<h3 class="mb-4 mb-sm-0">Looking for Academic Assistance?</h3>
<a href="/order/?product=1" class="btn btn-success btn-lg" data-track-name="Last call CTA">Place an Order</a>
</div>
...
<a href="https://plus.google.com/+UkessaysOfficial" target="_blank" rel="nofollow noopener" data-track-name="Google Plus" aria-label="Google Plus">
...
<div class="g-service-reveal reveal bg-success pt p-3 text-center text-white" data-reveal="global-desktop" data-offset="600" data-track="Service reveal (b-1)">
<div class="container position-relative">
<button type="button" class="close text-white" aria-label="Close" data-track-name="Close">
<span aria-hidden="true">&times;</span>
</button>
<h3><a href="/order/?product=1" class="text-white"><u>Looking for Academic Assistance?</u></a></h3>
</div>
</div>

<script src="/js/bundle.js?exp=1552928044"></script>
