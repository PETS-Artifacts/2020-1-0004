...
#tooltip{ width:20em; color: #fff; background: #555; font-size: 12px; font-weight: normal; padding: 5px; border: 3px solid #333; text-align: left; }
	...
	<script type="text/javascript">ginf={url:'http://bgproxy.org',script:'browse.php',target:{h:'',p:'',b:'',u:''},enc:{u:'bHMYcZnPiymIsG3v9P2UmOyAZmF7nWDorfar2l7aJjHZPAlMdbwpOTND3jzh32tk5uBVFyUdFr2iPbUSbh6PYJgRQFWJxgTqAjc3HW4bdVjSW4yX9uCX2JCIepiAvZOT',e:'1',x:'',p:''},b:'13'}</script>
