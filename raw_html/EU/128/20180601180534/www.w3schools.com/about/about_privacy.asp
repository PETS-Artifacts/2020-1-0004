...
//var startingAds = [gptAdSlots[0],gptAdSlots[1],gptAdSlots[2],gptAdSlots[3]];
//snhb.addAdditionalAdSlotsToRefresh(startingAds);
...
<ul>
  <li>Collect any personally identifiable information (without your express permission)</li><li>Collect any sensitive information (without your express permission)</li><li>Pay sales commissions</li>
</ul>
...
<ul>
  ...
  <li>aolcloud.net</li>
  <li>appnexus.com</li>
  <li>beachfront.com</li>
  <li>brightcom.com</li>
  <li>contextweb.com</li>
  <li>conversantmedia.com</li>
  <li>districtm.io</li>
  <li>freewheel.tv</li>
  <li>fyber.com</li>
  <li>imonomy.com</li>
  <li>improvedigital.com</li>
  <li>indexexchange.com</li>
  <li>lijit.com</li>
  <li>lkqd.com</li>
  <li>lkqd.net</li>
  <li>openx.com</li>
...
<hr>
<h2>Using Google Drive in our Tryit Editor</h2>
<p>Our Tryit Editor allows users to store code to, or import code from, Google 
Drive.</p>
<p>This allows users to:</p>
<ul>
  <li>Store examples/code to their Google Drive</li><li>Share examples/code 
  through Google Drive</li>
</ul>
<p>W3Schools does not keep for ourselves, or share this information with third 
parties.</p>
<hr>
<h2>Links</h2>
      ...
      <div id='div-gpt-ad-1472547360578-0'>
        <script>
          if (Number(w3_getStyleValue(document.getElementById("main"), "height").replace("px", "")) > 2200) {
            if (document.getElementById("div-gpt-ad-1493883843099-0")) {
              snhb.queue.push(function(){
                var startingAds = [gptAdSlots[0],gptAdSlots[1],gptAdSlots[2],gptAdSlots[3],gptAdSlots[4],gptAdSlots[5]];
                snhb.addAdditionalAdSlotsToRefresh(startingAds);
              });
            }
            else {
              snhb.queue.push(function(){
                var startingAds = [gptAdSlots[0],gptAdSlots[1],gptAdSlots[2],gptAdSlots[3],gptAdSlots[4]];
                snhb.addAdditionalAdSlotsToRefresh(startingAds);
              });
            }
          }
              ...
              if (document.getElementById("div-gpt-ad-1493883843099-0")) {
              snhb.queue.push(function(){
                var startingAds = [gptAdSlots[0],gptAdSlots[1],gptAdSlots[2],gptAdSlots[3],gptAdSlots[5]];
                snhb.addAdditionalAdSlotsToRefresh(startingAds);
              });
              }
          }
