    ...
    <div id='nav_examples' class='w3-bar-block w3-card-2'>
      ...
      <div class='w3-row-padding' style="padding:24px 48px">
        ...
        <div class='w3-col l3 m6'>
          ...
          <a class="w3-bar-item w3-button" href='/jquery/jquery_exercises.asp' target='_top'>jQuery Exercises</a>
        ...
        <div class='w3-col l3 m6'>
          ...
          <a class="w3-bar-item w3-button" href='/python/python_examples.asp'>Python Examples</a>
          <a class="w3-bar-item w3-button" href='/python/python_exercises.asp'>Python Exercises</a>
          <a class="w3-bar-item w3-button" href='/java/java_examples.asp'>Java Examples</a>
...
<hr>
<div class="w3-light-grey w3-padding w3-center w3-margin-bottom" id="err_form" style="display:none;position:relative">
