		...
		(function() {
			...
			if(!Skiddle.mustard) {
				...
				Skiddle.globalChain = $LAB
					...
					.script("https://d1plawd8huk6hh.cloudfront.net/applets/responsive/base.20142.min.js").wait(
...
<!--GA Ends -->
    ...
    <!-- Google Analytics -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=UA-231221-33"></script>
    <script>
      window.dataLayer = window.dataLayer || [];
      function gtag(){dataLayer.push(arguments);}
      gtag('js', new Date());

      gtag('config', 'UA-231221-33', {'groups':'GaUniversTest'});
    </script>
    <script>
...
<script type="text/javascript">window.NREUM||(NREUM={});NREUM.info={"beacon":"bam.nr-data.net","licenseKey":"71fcbeae84","applicationID":"199759","transactionName":"Z1JUZRNWDERSW0MMXF4YY0MIGBZSQVVESkNCXkBQAk5MR1tI","queueTime":0,"applicationTime":1,"atts":"SxVXE1tMH0o=","errorBeacon":"bam.nr-data.net","agent":""}</script></body>
</html>
