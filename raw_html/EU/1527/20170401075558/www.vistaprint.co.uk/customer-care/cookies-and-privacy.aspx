...
window._vp_page_guid = 'ec38b0fd-8f87-4ed2-a34c-cfd40fca0efa';
...
try {
window._sessionCacheToken = "NKs-RtLE3qY4YHgjTKXfNg";
}
 catch (jsEx) { vp.bootstrap.logException(jsEx); }
//]]>
</script>
...
<link rel="apple-touch-icon" sizes="60x60" href="/vp/images/vp-site/common/logo/vistaprint-favorites-60-60-2014.png"/>
        ...
        <img src="//vispri.d2.sc.omtrdc.net/b/ss/vispri.vprt.bot/1/G.5--NS/636266157782661423?ns=vispri&g=http://www.vistaprint.co.uk/customer-care/cookies-and-privacy.aspx&pageName=No Page Name:Unknown&v5=152400&c43=ANY:HCP:T:" style="display: none;">
<script type="text/javascript">
var utag_data = {
...
vp.sales.Taxonomy.TrackElements(jQuery('a.menu-top-button[data-item=17050]'), '954|1');
vp.sales.Taxonomy.TrackElements(jQuery('a.menu-top-button[data-item=17341]'), '954|1');
vp.sales.Taxonomy.TrackElements(jQuery('a.menu-top-button[data-item=16602]'), '954|1');
...
<div class="menu-container menu-skin-taxonomy" id="taxonomyItem14896">
    <div class="menu-item">
		...
		<div class="menu-item">
			<a href="/business-cards/sizes-and-shapes/rounded-corner-business-cards" data-item="17802">
...
<div class="menu-container menu-skin-taxonomy" id="taxonomyItem16783">
    <div class="menu-item">
        ...
        <header class="header-vat">
                    ...
                    <span>Are you a non-business customer? <a href="#footer">Go to the bottom of the page</a> to switch to prices with VAT.</span>
...
<div id="divMachineId" style="display:none">0a4e00f380bdce763e06ea59b599cbd5</div>
