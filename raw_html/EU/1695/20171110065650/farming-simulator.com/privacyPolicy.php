...
<head>
    ...
    <link rel="stylesheet" href="css/main22.css" async="true">
...
<div id="gallery" class="gallery" style="max-width:1920px;margin:0px auto;">
    <div class="gallery-cell">
        <a href="dlc-detail.php?lang=en&country=us&amp;dlc_id=fs17platinum">
            <picture>
                <source media="(max-width: 39.9375em)" srcset="img/content/slider/slider18-fs17platinumpreorder-sml_en.jpg">
                <img src="img/content/slider/slider18-fs17platinumpreorder_en.jpg" alt="news">
            </picture>
        </a>
    </div>
    <div class="gallery-cell">
        <a href="https://farming-simulator.com/championship">
            <picture>
                <source media="(max-width: 39.9375em)" srcset="img/content/slider/slider19-fsc-sml_en.jpg">
                <img src="img/content/slider/slider19-fsc_en.jpg" alt="news">
            </picture>
        </a>
    </div>
    <div class="gallery-cell">
    ...
    <div class="gallery-cell">
        <a href="dlc-detail.php?lang=en&country=us&amp;dlc_id=fs17bigbud">
            <picture>
                <source media="(max-width: 39.9375em)" srcset="img/content/slider/slider15-fs17bigbudrelease-sml_en.jpg">
                <img src="img/content/slider/slider15-fs17bigbudrelease_en.jpg" alt="news">
            </picture>
        </a>
    </div>
    <div class="gallery-cell">
...
<section class="home-news">
        ...
        <div class="medium-8 columns">
            ...
            <div class="row">
                <div class="large-6 medium-12 columns">
                    <div class="media-object">
                        <div class="media-object-section">
                            <a class="link-img" href="newsArticle.php?lang=en&country=us&amp;news_id=75"><img src="img/content/news/img-news-75.jpg"></a>
                        </div>
                        <div class="media-object-section">Free FS18 content update for iOS and Android</div>
                    </div>
                </div>
                ...
                <div class="large-6 medium-12 columns">
                    <div class="media-object">
                        <div class="media-object-section">
                            <a class="link-img" href="newsArticle.php?lang=en&country=us&amp;news_id=74"><img src="img/content/news/img-news-74.jpg"></a>
                        </div>
                        <div class="media-object-section">Farming Simulator Championship 2017 at Agritechnica</div>
                    </div>
                </div>
            </div><div class="row">
                <div class="large-6 medium-12 columns">
                    <div class="media-object">
                        <div class="media-object-section">
                            <a class="link-img" href="newsArticle.php?lang=en&country=us&amp;news_id=73"><img src="img/content/news/img-news-73.jpg"></a>
                        </div>
                        <div class="media-object-section">Farming Simulator - Nintendo Switch Edition revealed in first trailer!</div>
                    </div>
                </div>
                ...
                <div class="large-6 medium-12 columns">
                    <div class="media-object">
                        <div class="media-object-section">
                            <a class="link-img" href="newsArticle.php?lang=en&country=us&amp;news_id=72"><img src="img/content/news/img-news-72.jpg"></a>
                        </div>
                        <div class="media-object-section">Free DLC for Farming Simulator 18 on smartphones</div>
                    </div>
                </div>
            </div><div class="row">
                <div class="large-6 medium-12 columns">
                    <div class="media-object">
                        <div class="media-object-section">
                            <a class="link-img" href="newsArticle.php?lang=en&country=us&amp;news_id=71"><img src="img/content/news/img-news-71.jpg"></a>
                        </div>
                        <div class="media-object-section">The DLC proposal – Next steps</div>
                    </div>
                </div>
                ...
                <div class="large-6 medium-12 columns">
                    <div class="media-object">
                        <div class="media-object-section">
                            <a class="link-img" href="newsArticle.php?lang=en&country=us&amp;news_id=70"><img src="img/content/news/img-news-70.jpg"></a>
                        </div>
                        <div class="media-object-section">Pre-order the Platinum Expansion now</div>
                    </div>
                </div>
            </div>        </div>
        <div class="medium-4 columns">
                ...
                <img src="img/content/products/dlc-fs17kuhn-novelty.jpg">
                <div class="expanded button-group">
                    <a class="button button-mod button-more button-no-border" href="dlc-detail.php?lang=en&country=us&amp;dlc_id=fs17kuhn">MORE INFO</a>
                    <a class="button button-mod button-buy" href="dlc-detail.php?lang=en&country=us&amp;dlc_id=fs17kuhn">BUY NOW</a>
                </div>
            </div>
        </div>
    </div>
...
RT <a href="https://www.twitter.com/FocusHome">@FocusHome</a>: RT &amp; Follow for a chance to win Farming Simulator 17 Platinum Edition's exclusive steelbook and the game on the platform of…</p>
            </div>
        </div>
    </div>
</section>
