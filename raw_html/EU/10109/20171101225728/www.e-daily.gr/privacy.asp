...
<div id="todayTabs" class="tab-container" style=overflow: hidden">
  ...
  <div id="tabs-recent" class="postEntries small">
	...
	<a href="/viral/94968/h-trelh-oikogeneia-poy-ta-poylhse-ola-kai-kanei-to-gyro-toy-kosmoy-pics" target="_parent">
        <div class="cropimg absolute-center">
	        <div class="media"><span class="icon-picture"></span></div>
            <img data-src="http://cdn.e-daily.gr/repository/2017/zevgari_around_6.jpg" alt="Η «τρελή» οικογένεια που τα πούλησε όλα και κάνει το γύρο του κόσμου" border="0" class="lazyload">
        </div>
        <div><span class="category ">ΠΑΡΑΞΕΝΑ</span><span class="when">00:11</span></div>
        <h3>Η «τρελή» οικογένεια που τα πούλησε όλα και κάνει το γύρο του κόσμου</h3>
        <h4></h4>
	</a>

	<a href="/life/94967/aytoi-einai-oi-anthrwpoi-poy-o-syntrofos-sas-einai-pio-pithano-na-sas-apathsei-pics" target="_parent">
        <div class="cropimg absolute-center">
	        <div class="media"><span class="icon-picture"></span></div>
            <img data-src="http://cdn.e-daily.gr/repository/2017/main_ap_1.jpg" alt="Αυτοί είναι οι άνθρωποι που ο σύντροφός σας είναι πιο πιθανό να σας απατήσει" border="0" class="lazyload">
        </div>
        <div><span class="category ">ΣΧΕΣΕΙΣ</span><span class="when">00:11</span></div>
        <h3>Αυτοί είναι οι άνθρωποι που ο σύντροφός σας είναι πιο πιθανό να σας απατήσει</h3>
        <h4></h4>
	</a>

	<a href="/life/94965/poso-diaferei-h-pragmatikothta-apo-tis-kart-postal-pics" target="_parent">
        <div class="cropimg absolute-center">
	        <div class="media"><span class="icon-picture"></span></div>
            <img data-src="http://cdn.e-daily.gr/repository/2017/1474621222_gunjan1.jpg" alt="Πόσο διαφέρει η πραγματικότητα από τις καρτ ποσταλ" border="0" class="lazyload">
        </div>
        <div><span class="category ">ΤΑΞΙΔΙΑ</span><span class="when">00:11</span></div>
        <h3>Πόσο διαφέρει η πραγματικότητα από τις καρτ ποσταλ</h3>
        <h4></h4>
	</a>

	<a href="/viral/94953/oi-anekshghtes-eikones-poy-exei-katagrapsei-to-google-earth-pics" target="_parent">
        <div class="cropimg absolute-center">
	        <div class="media"><span class="icon-picture"></span></div>
            <img data-src="http://cdn.e-daily.gr/repository/2017/IMG_20170605_112017_507.jpg" alt="Οι ανεξήγητες εικόνες που έχει καταγράψει το Google Earth" border="0" class="lazyload">
        </div>
        <div><span class="category ">ΠΑΡΑΞΕΝΑ</span><span class="when">00:11</span></div>
        <h3>Οι ανεξήγητες εικόνες που έχει καταγράψει το Google Earth</h3>
        <h4></h4>
	</a>

	<a href="/themata/94948/h-daskala-apo-th-parelash-sta-xania-mas-thymise-ti-tha-pei-ellada-pics" target="_parent">
        <div class="cropimg absolute-center">
	        <div class="media"><span class="icon-picture"></span></div>
            <img data-src="http://cdn.e-daily.gr/repository/2017/kriti93.jpg" alt="Η δασκάλα από τη παρέλαση στα Χανιά μας θύμισε τι θα πει Ελλάδα" border="0" class="lazyload">
        </div>
        <div><span class="category ">ΑΦΙΕΡΩΜΑ</span><span class="when">00:11</span></div>
        <h3>Η δασκάλα από τη παρέλαση στα Χανιά μας θύμισε τι θα πει Ελλάδα</h3>
        <h4></h4>
	</a>
  ...
  <div id="tabs-hl" class="postEntries small">
	...
	<a href="http://www.e-daily.gr/themata/94640/h-ellhnida-kai-o-marokinos-poy-gnwristhkan-sthn-eidomenh-kai-ekanan-oikogeneia-pics-reportaz-apokleistiko" target="_blank">
        <div class="cropimg absolute-center">
	        <div class="media"><span class="icon-mic-outline"></span></div>
            <img data-src="http://cdn.e-daily.gr/repository/2017/08466666.jpg" alt="Η Ελληνίδα και ο Μαροκινός που γνωρίστηκαν στην Ειδομένη και έκαναν οικογένεια" border="0" class="lazyload">
        </div>
        <div><span class=alert>ΡΕΠΟΡΤΑΖ</span><span class="category ">ΑΝΘΡΩΠΟΙ</span> <span class="when">01/11</span></div>
        <h3>Η Ελληνίδα και ο Μαροκινός που γνωρίστηκαν στην Ειδομένη και έκαναν οικογένεια</h3>
        <h4></h4>
	</a>

	<a href="/life/94750/an-h-kopela-soy-kanei-ayta-sto-seks-tote-sigoyra-den-exei-opgasmo" target="_parent">
        <div class="cropimg absolute-center">
	        
            <img data-src="http://cdn.e-daily.gr/repository/2017/sxeseiskrebatiantrasgunaika2.jpg" alt="Aν η κοπέλα σου κάνει αυτά στο σeξ, τότε σίγουρα δεν έχει οpγασμό" border="0" class="lazyload">
        </div>
        <div><span class="category ">ΣΧΕΣΕΙΣ</span> <span class="when">01/11</span></div>
        <h3>Aν η κοπέλα σου κάνει αυτά στο σeξ, τότε σίγουρα δεν έχει οpγασμό</h3>
        <h4></h4>
	</a>

	<a href="/news/94884/elas-sta-xeria-mas-o-dolofonos-toy-zafeiropoyloy" target="_parent">
        <div class="cropimg absolute-center">
	        
            <img data-src="http://cdn.e-daily.gr/repository/2017/dolofonos_zaf_1.jpeg" alt="ΕΛΑΣ: Στα χέρια μας ο δολοφόνος του Ζαφειρόπουλου" border="0" class="lazyload">
        </div>
        <div><span class="category ">ΕΛΛΑΔΑ</span> <span class="when">01/11</span></div>
        <h3>ΕΛΑΣ: Στα χέρια μας ο δολοφόνος του Ζαφειρόπουλου</h3>
        <h4></h4>
	</a>

	<a href="/life/94755/ta-zwdia-toy-mhna-noemvrios-pics" target="_parent">
        <div class="cropimg absolute-center">
	        <div class="media"><span class="icon-picture"></span></div>
            <img data-src="http://cdn.e-daily.gr/repository/2017/zodis9e33.jpg" alt="Τα ζώδια του μήνα: Nοέμβριος" border="0" class="lazyload">
        </div>
        <div><span class="category ">ΖΩΔΙΑ</span> <span class="when">01/11</span></div>
        <h3>Τα ζώδια του μήνα: Nοέμβριος</h3>
        <h4></h4>
	</a>

	<a href="/news/94855/fylakizetai-kai-pali-o-akhs-tsoxatzopoylos" target="_parent">
        <div class="cropimg absolute-center">
	        
            <img data-src="http://cdn.e-daily.gr/repository/2017/tsoxatzopoulos-929933.jpg" alt="Φυλακίζεται και πάλι ο Ακης Τσοχατζόπουλος" border="0" class="lazyload">
        </div>
        <div><span class="category ">ΕΛΛΑΔΑ</span> <span class="when">31/10</span></div>
        <h3>Φυλακίζεται και πάλι ο Ακης Τσοχατζόπουλος</h3>
        <h4></h4>
	</a>
...
<div id="topTabs" class="tab-container" style="height:550px; overflow: hidden;">
  ...
  <div id="tabs-news" class="postEntries top">
	...
	<a href="/news/94819/pote-tha-paroyn-ews-3000-eyrw-anadromika-oi-syntaksioyxoi" target="_parent">
        <div class="cropimg absolute-center">
	        
            <img data-src="http://cdn.e-daily.gr/repository/2017/152670.jpg" alt="Πότε θα πάρουν έως 3000 ευρώ αναδρομικά οι συνταξιούχοι" border="0" class="lazyload">
        </div>
        <div><span class="category ">ΕΛΛΑΔΑ</span> <span class="when">31/10</span></div>
        <h3>Πότε θα πάρουν έως 3000 ευρώ αναδρομικά οι συνταξιούχοι</h3>
        <h4></h4>
	</a>

	<a href="/news/94761/ews-kai-1400-eyrw-tha-epistrafoyn-se-ena-ekatommyrio-syntaksioyxoys" target="_parent">
        <div class="cropimg absolute-center">
	        
            <img data-src="http://cdn.e-daily.gr/repository/2017/synt_314.jpg" alt="Έως και 1.400 ευρώ θα επιστραφούν σε ένα εκατομμύριο συνταξιούχους" border="0" class="lazyload">
        </div>
        <div><span class="category ">ΟΙΚΟΝΟΜΙΑ</span> <span class="when">30/10</span></div>
        <h3>Έως και 1.400 ευρώ θα επιστραφούν σε ένα εκατομμύριο συνταξιούχους</h3>
        <h4></h4>
	</a>

	<a href="/news/94802/aytoktonhse-sth-doyleia-toy-pateras-dyo-paidiwn" target="_parent">
        <div class="cropimg absolute-center">
	        
            <img data-src="http://cdn.e-daily.gr/repository/2017/ekav42342.jpg" alt="Αυτοκτόνησε στη δουλειά του πατέρας δυο παιδιών" border="0" class="lazyload">
        </div>
        <div><span class="category ">ΕΛΛΑΔΑ</span> <span class="when">31/10</span></div>
        <h3>Αυτοκτόνησε στη δουλειά του πατέρας δυο παιδιών</h3>
        <h4></h4>
	</a>

	<a href="/news/94719/diplwmatiko-epeisodio-me-ton-presvh-ths-ispanias" target="_parent">
        <div class="cropimg absolute-center">
	        
            <img data-src="http://cdn.e-daily.gr/repository/2017/kotzias.jpg" alt="Διπλωματικό επεισόδιο με τον πρέσβη της Ισπανίας" border="0" class="lazyload">
        </div>
        <div><span class="category ">ΠΟΛΙΤΙΚΗ</span> <span class="when">30/10</span></div>
        <h3>Διπλωματικό επεισόδιο με τον πρέσβη της Ισπανίας</h3>
        <h4></h4>
	</a>

	<a href="/news/94816/isovia-sth-voylgara-poy-skotwse-ton-antra-ths-kai-ton-evale-ston-katapsykth" target="_parent">
        <div class="cropimg absolute-center">
	        
            <img data-src="http://cdn.e-daily.gr/repository/2017/boulgara382.jpg" alt="Ισόβια στη Βουλγάρα που σκότωσε τον άντρα της και τον έβαλε στον καταψύκτη" border="0" class="lazyload">
        </div>
        <div><span class="category ">ΕΛΛΑΔΑ</span> <span class="when">31/10</span></div>
        <h3>Ισόβια στη Βουλγάρα που σκότωσε τον άντρα της και τον έβαλε στον καταψύκτη</h3>
        <h4></h4>
	</a>
  ...
  <div id="tabs-themata" class="postEntries top">
	...
	<a href="http://www.e-daily.gr/themata/94324/zei-to-kamaki-pws-flertarei-o-ellhnas-shmera-reportaz" target="_blank">
        <div class="cropimg absolute-center">
	        <div class="media"><span class="icon-mic-outline"></span></div>
            <img data-src="http://cdn.e-daily.gr/repository/2017/flirtmm7.jpg" alt="Ζει το καμάκι; Πώς φλερτάρει ο Έλληνας σήμερα" border="0" class="lazyload">
        </div>
        <div><span class=alert>ΡΕΠΟΡΤΑΖ</span><span class="category ">ΣΧΕΣΕΙΣ</span> <span class="when">29/10</span></div>
        <h3>Ζει το καμάκι; Πώς φλερτάρει ο Έλληνας σήμερα</h3>
        <h4></h4>
	</a>

	<a href="http://www.e-daily.gr/themata/94326/milwntas-me-thn-kristi-thn-idiokthtria-toy-monadikoy-mpar-gia-trans-sth-thessalonikh-pics-reportaz" target="_blank">
        <div class="cropimg absolute-center">
	        <div class="media"><span class="icon-mic-outline"></span></div>
            <img data-src="http://cdn.e-daily.gr/repository/2017/Kristy-out.jpg" alt="Περάσαμε μια νύχτα στο Ts14, το μοναδικό τρανς μπαρ στη Θεσσαλονίκη" border="0" class="lazyload">
        </div>
        <div><span class=alert>ΡΕΠΟΡΤΑΖ</span><span class="category ">ΑΝΘΡΩΠΟΙ</span> <span class="when">25/10</span></div>
        <h3>Περάσαμε μια νύχτα στο Ts14, το μοναδικό τρανς μπαρ στη Θεσσαλονίκη</h3>
        <h4></h4>
	</a>

	<a href="http://www.e-daily.gr/themata/94482/o-20xronos-poy-ntynei-ta-playmobil-me-paradosiakes-foresies-synenteyksi" target="_blank">
        <div class="cropimg absolute-center">
	        
            <img data-src="http://cdn.e-daily.gr/repository/2017/playmogreek.jpg" alt="Ο 20χρονος που ντύνει τα Playmobil με παραδοσιακές φορεσιές" border="0" class="lazyload">
        </div>
        <div><span class="category ">ΤΕΧΝΕΣ</span> <span class="when">28/10</span></div>
        <h3>Ο 20χρονος που ντύνει τα Playmobil με παραδοσιακές φορεσιές</h3>
        <h4></h4>
	</a>

	<a href="/themata/94353/oi-kotes-to-oplo-twn-iapwnwn-gia-ton-karkino" target="_parent">
        <div class="cropimg absolute-center">
	        
            <img data-src="http://cdn.e-daily.gr/repository/2017/kotes0303.jpg" alt="Οι κότες το όπλο των Ιαπώνων για τον καρκίνο" border="0" class="lazyload">
        </div>
        <div><span class="category ">ΕΠΙΣΤΗΜΗ</span> <span class="when">27/10</span></div>
        <h3>Οι κότες το όπλο των Ιαπώνων για τον καρκίνο</h3>
        <h4></h4>
	</a>

	<a href="/themata/94630/rich-kids-of-tirana-deite-ta-asynhthista-ploysiopaida-ths-alvanias-pics" target="_parent">
        <div class="cropimg absolute-center">
	        <div class="media"><span class="icon-picture"></span></div>
            <img data-src="http://cdn.e-daily.gr/repository/2017/richkidsoftirana2.jpg" alt="Rich Kids of Τirana: Δείτε τα ασυνήθιστα πλουσιόπαιδα της Αλβανίας " border="0" class="lazyload">
        </div>
        <div><span class="category ">ΚΟΣΜΟΣ</span> <span class="when">27/10</span></div>
        <h3>Rich Kids of Τirana: Δείτε τα ασυνήθιστα πλουσιόπαιδα της Αλβανίας </h3>
        <h4></h4>
	</a>
  ...
  <div id="tabs-life" class="postEntries top">
	...
	<a href="/life/94509/to-mystiko-ths-eytyxias-symfwna-me-ton-aistain-poy-poylhthhke-gia-15-ek-eyrw" target="_parent">
        <div class="cropimg absolute-center">
	        
            <img data-src="http://cdn.e-daily.gr/repository/2017/einstein993434.jpg" alt="Το μυστικό της ευτυχίας σύμφωνα με τον Αϊστάιν που πουλήθηκε για 1,5 εκ. ευρώ" border="0" class="lazyload">
        </div>
        <div><span class="category ">BODY+MIND</span> <span class="when">26/10</span></div>
        <h3>Το μυστικό της ευτυχίας σύμφωνα με τον Αϊστάιν που πουλήθηκε για 1,5 εκ. ευρώ</h3>
        <h4></h4>
	</a>

	<a href="/life/94335/giati-ston-idio-xwro-oi-andres-zestainontai-kai-oi-gynaikes-krywnoyn" target="_parent">
        <div class="cropimg absolute-center">
	        
            <img data-src="http://cdn.e-daily.gr/repository/2017/meoisnwomencoldhit.jpg" alt="Γιατί στον ίδιο χώρο οι άνδρες ζεσταίνονται και οι γυναίκες κρυώνουν;" border="0" class="lazyload">
        </div>
        <div><span class="category ">BODY+MIND</span> <span class="when">27/10</span></div>
        <h3>Γιατί στον ίδιο χώρο οι άνδρες ζεσταίνονται και οι γυναίκες κρυώνουν;</h3>
        <h4></h4>
	</a>

	<a href="http://www.e-daily.gr/life/94485/halloween-weekend-idees-protaseis-gia-diaskedash-kai-syntages" target="_blank">
        <div class="cropimg absolute-center">
	        
            <img data-src="http://cdn.e-daily.gr/repository/2017/hlwoens2.jpg" alt="Halloween Weekend: Ιδέες, προτάσεις για διασκέδαση και συνταγές" border="0" class="lazyload">
        </div>
        <div><span class="category ">ΣΠΙΤΙ</span> <span class="when">29/10</span></div>
        <h3>Halloween Weekend: Ιδέες, προτάσεις για διασκέδαση και συνταγές</h3>
        <h4></h4>
	</a>

	<a href="/life/94545/5-istories-gia-kathhmerina-faghta-poy-anakalyfthhkan-kata-lathos-pics" target="_parent">
        <div class="cropimg absolute-center">
	        <div class="media"><span class="icon-picture"></span></div>
            <img data-src="http://cdn.e-daily.gr/repository/2017/corn_12.jpg" alt="5 ιστορίες για καθημερινά φαγητά που ανακαλύφθηκαν κατά λάθος" border="0" class="lazyload">
        </div>
        <div><span class="category ">FOOD</span> <span class="when">26/10</span></div>
        <h3>5 ιστορίες για καθημερινά φαγητά που ανακαλύφθηκαν κατά λάθος</h3>
        <h4></h4>
	</a>

	<a href="/life/94070/mathe-ti-einai-o-pandanos-prin-ginei-moda-pics" target="_parent">
        <div class="cropimg absolute-center">
	        <div class="media"><span class="icon-picture"></span></div>
            <img data-src="http://cdn.e-daily.gr/repository/2017/fagito993.jpg" alt="Μάθε τι είναι ο πάνδανος πριν γίνει μόδα" border="0" class="lazyload">
        </div>
        <div><span class="category ">FOOD</span> <span class="when">29/10</span></div>
        <h3>Μάθε τι είναι ο πάνδανος πριν γίνει μόδα</h3>
        <h4></h4>
	</a>
  ...
  <div id="tabs-viral" class="postEntries top">
	...
	<a href="/viral/94678/to-anatrixiastiko-entomo-poy-exei-anastatwsei-thn-aystralia-pics-video" target="_parent">
        <div class="cropimg absolute-center">
	        <div class="media"><span class="icon-play"></span></div>
            <img data-src="http://cdn.e-daily.gr/repository/2017/moth_main.jpg" alt="Το ανατριχιαστικό έντομο που έχει αναστατώσει την Αυστραλία" border="0" class="lazyload">
        </div>
        <div><span class="category ">ΠΑΡΑΞΕΝΑ</span> <span class="when">30/10</span></div>
        <h3>Το ανατριχιαστικό έντομο που έχει αναστατώσει την Αυστραλία</h3>
        <h4></h4>
	</a>

	<a href="/viral/94748/etaireia-sto-ntoympai-zhta-ypallhlo-xwris-prophresia-me-mistho-226000-eyrw-ton-xrono" target="_parent">
        <div class="cropimg absolute-center">
	        
            <img data-src="http://cdn.e-daily.gr/repository/2017/dub_315.jpg" alt="Εταιρεία στο Ντουμπάι ζητά υπάλληλο χωρίς προϋπηρεσία με μισθό 226.000 ευρώ τον χρόνο" border="0" class="lazyload">
        </div>
        <div><span class="category ">ΚΟΣΜΟΣ</span> <span class="when">31/10</span></div>
        <h3>Εταιρεία στο Ντουμπάι ζητά υπάλληλο χωρίς προϋπηρεσία με μισθό 226.000 ευρώ τον χρόνο</h3>
        <h4></h4>
	</a>

	<a href="/viral/94726/nearoi-kapnizan-marixoyana-dipla-ston-makron-kai-ekeinos-toys-phre-myrwdia" target="_parent">
        <div class="cropimg absolute-center">
	        
            <img data-src="http://cdn.e-daily.gr/repository/2017/makron.jpg" alt="Νεαροί κάπνιζαν μαριχουάνα δίπλα στον Μακρόν και εκείνος τους πήρε... μυρωδιά!" border="0" class="lazyload">
        </div>
        <div><span class="category ">ΚΟΣΜΟΣ</span> <span class="when">30/10</span></div>
        <h3>Νεαροί κάπνιζαν μαριχουάνα δίπλα στον Μακρόν και εκείνος τους πήρε... μυρωδιά!</h3>
        <h4></h4>
	</a>

	<a href="/viral/94762/koino-kai-krites-pagwsan-sto-ellada-exeis-talento-video" target="_parent">
        <div class="cropimg absolute-center">
	        <div class="media"><span class="icon-play"></span></div>
            <img data-src="http://cdn.e-daily.gr/repository/2017/kr_koi_33.jpg" alt="Κοινό και κριτές πάγωσαν στο «Ελλάδα Έχεις Ταλέντο»" border="0" class="lazyload">
        </div>
        <div><span class="category ">MEDIA</span> <span class="when">30/10</span></div>
        <h3>Κοινό και κριτές πάγωσαν στο «Ελλάδα Έχεις Ταλέντο»</h3>
        <h4></h4>
	</a>
	...
	<a href="/viral/36107/nearh-kanei-stomatiko-se-filh-ths-mesa-se-treno-kai-ginetai-viral-video" target="_parent">
        ...
        <div><span class="category ">SEXY</span> <span class="when">31/03</span></div>
