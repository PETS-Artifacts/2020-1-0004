...
<link href="/_css/style.css?v=2.7" rel="stylesheet" type="text/css"/>
<link href="/_css/newsentries.css?v=2.6" rel="stylesheet" type="text/css"/>
<link href="/_css/navigation.css?v=2.5" rel="stylesheet" type="text/css"/>
<link href="/_css/mobilemenu.css?v=2.5" rel="stylesheet" type="text/css" media="screen"/>
<link href="/_css/structure.css?v=2.6" rel="stylesheet" type="text/css"/>
...
<script type="text/javascript" src="/_js/helios.js?v=1.5"></script>
<!--[if lt IE 9]>
...
<a href="/eurovision"><img src="/_img/feeds/16.png" border="0" alt="Eurovision Feed"/></a>
...
<a class="icon-twitter-bird right_item twitter" href="http://www.twitter.com/edailygr" target="_blank" style="padding:17px 10px 17px 10px; box-sizing:border-box; height:44px"></a>
<a class="icon-instagram right_item instagram" href="http://www.instagram.com/edailygr" target="_blank" style="padding:17px 10px 17px 10px; box-sizing:border-box; height:44px"></a>
<a class="icon-youtube-play right_item youtube" href="http://www.youtube.com/c/edailygr" target="_blank" style="padding:17px 10px 17px 10px; box-sizing:border-box; height:44px"></a>
<a class="icon-facebook right_item facebook" href="http://www.facebook.com/edailygr" target="_blank" style="padding:17px 0 17px 10px; box-sizing:border-box; height:44px"></a>
</div>
</div>
</div>
...
<div id="5799488"></div>
<script>
ADTECH.config.placements[5799488] = {params: { alias: '', kv72890:"2sSqXk"+ASPQ_2sSqXk, kv970250:"r61GJ2"+ASPQ_r61GJ2, key:'',target: '_blank' }};
...
<div id="todayTabs" class="tab-container" style=overflow: hidden">
  ...
  <div id="tabs-recent" class="postEntries small">
	...
	<a href="/viral/82168/survivor-marianna-kallergh-kata-marioy-iwannidh-miloyse-asxhma-den-sevotan-video" target="_parent">
        <div class="cropimg absolute-center">
	        <div class="media"><span class="icon-play"></span></div>
            <img data-src="http://cdn.e-daily.gr/repository/2017/170512_MarianaKallergi.jpg" alt="Survivor: Μαριάννα Καλλέργη κατά Μάριου Ιωαννίδη! «Μιλούσε άσχημα, δεν σεβόταν…»" border="0" class="lazyload">
        </div>
        <div><span class="category ">TABLOID</span><span class="when">20:34</span></div>
        <h3>Survivor: Μαριάννα Καλλέργη κατά Μάριου Ιωαννίδη! «Μιλούσε άσχημα, δεν σεβόταν…»</h3>
        <h4></h4>
	</a>

	<a href="/viral/82167/indonhsia-mysthriwdes-plasma-15-metrwn-ksevrasthke-se-paralia-video" target="_parent">
        <div class="cropimg absolute-center">
	        <div class="media"><span class="icon-play"></span></div>
            <img data-src="http://cdn.e-daily.gr/repository/2017/170512_SeaCreatureIndonesia.jpg" alt="Ινδονησία: Μυστηριώδες πλάσμα 15 μέτρων ξεβράστηκε σε παραλία" border="0" class="lazyload">
        </div>
        <div><span class="category ">ΠΑΡΑΞΕΝΑ</span><span class="when">19:59</span></div>
        <h3>Ινδονησία: Μυστηριώδες πλάσμα 15 μέτρων ξεβράστηκε σε παραλία</h3>
        <h4></h4>
	</a>

	<a href="/viral/82162/norvhgia-11xronos-prigkipas-ekane-dab-kata-th-diarkeia-epishmhs-teleths-video" target="_parent">
        <div class="cropimg absolute-center">
	        <div class="media"><span class="icon-play"></span></div>
            <img data-src="http://cdn.e-daily.gr/repository/2017/170512_NorwayDab.jpg" alt="Νορβηγία: 11χρονος πρίγκιπας έκανε... dab κατά τη διάρκεια επίσημης τελετής" border="0" class="lazyload">
        </div>
        <div><span class="category ">ΚΟΣΜΟΣ</span><span class="when">18:40</span></div>
        <h3>Νορβηγία: 11χρονος πρίγκιπας έκανε... dab κατά τη διάρκεια επίσημης τελετής</h3>
        <h4></h4>
	</a>

	<a href="/viral/82145/h-viral-aggelia-ergasias-apo-thn-skopelo-poy-moiazei-ekswpragmatikh" target="_parent">
        <div class="cropimg absolute-center">
	        
            <img data-src="http://cdn.e-daily.gr/repository/2017/aggelia_skopelos_12.jpg" alt="H viral αγγελία εργασίας από την Σκόπελο που μοιάζει εξωπραγματική" border="0" class="lazyload">
        </div>
        <div><span class="category ">ΕΛΛΑΔΑ</span><span class="when">15:43</span></div>
        <h3>H viral αγγελία εργασίας από την Σκόπελο που μοιάζει εξωπραγματική</h3>
        <h4></h4>
	</a>

	<a href="/life/82129/ta-zwdia-shmera-13-maoy" target="_parent">
        <div class="cropimg absolute-center">
	        
            <img data-src="http://cdn.e-daily.gr/repository/2017/clrsss.jpg" alt="Τα ζώδια σήμερα: 13 Μαΐου " border="0" class="lazyload">
        </div>
        <div><span class="category ">ΖΩΔΙΑ</span><span class="when">13:08</span></div>
        <h3>Τα ζώδια σήμερα: 13 Μαΐου </h3>
        <h4></h4>
	</a>
  ...
  <div id="tabs-hl" class="postEntries small">
	...
	<a href="/news/82109/pethane-h-eyaggelia-vlamh-figoyra-toy-lesviakoy-aktivismoy" target="_parent">
        <div class="cropimg absolute-center">
	        
            <img data-src="http://cdn.e-daily.gr/repository/2017/evgvlami.jpg" alt="Πέθανε η Ευαγγελία Βλάμη, φιγούρα του λεσβιακού ακτιβισμού" border="0" class="lazyload">
        </div>
        <div><span class="category ">ΕΛΛΑΔΑ</span></div>
        <h3>Πέθανε η Ευαγγελία Βλάμη, φιγούρα του λεσβιακού ακτιβισμού</h3>
        <h4></h4>
	</a>

	<a href="http://www.e-daily.gr/themata/82091/h-paraksenh-istoria-me-ton-anthony-hopkins-kai-to-vivlio-sto-metro-pics-video" target="_blank">
        <div class="cropimg absolute-center">
	        <div class="media"><span class="icon-play"></span></div>
            <img data-src="http://cdn.e-daily.gr/repository/2017/petrovka_2.jpg" alt="Η παράξενη ιστορία με τον Anthony Hopkins και το βιβλίο στο μετρό" border="0" class="lazyload">
        </div>
        <div><span class="category ">ΣΙΝΕΜΑ</span></div>
        <h3>Η παράξενη ιστορία με τον Anthony Hopkins και το βιβλίο στο μετρό</h3>
        <h4></h4>
	</a>

	<a href="http://www.e-daily.gr/agenda/82074/vasilias-arthoyros-ma-poso-seksi-aytos-o-charlie-hunnam-pia-video" target="_blank">
        <div class="cropimg absolute-center">
	        <div class="media"><span class="icon-play"></span></div>
            <img data-src="http://cdn.e-daily.gr/repository/2017/kingarthur17.jpg" alt="Βασιλιάς Αρθούρος: Μα πόσο σέξι αυτός ο Charlie Hunnam πια;" border="0" class="lazyload">
        </div>
        <div><span class="category eventCategory category136">ΣΙΝΕΜΑ</span></div>
        <h3>Βασιλιάς Αρθούρος: Μα πόσο σέξι αυτός ο Charlie Hunnam πια;</h3>
        <h4><SPAN CLASS="EVENTCITIES">ΑΘΗΝΑ - ΘΕΣΣΑΛΟΝΙΚΗ</SPAN></h4>
	</a>

	<a href="/quiz/82029/mathe-thn-tyxh-soy-anoikse-ena-fortune-cookie-quiz" target="_parent">
        <div class="cropimg absolute-center">
	        <div class="media"><span class="icon-doc-text"></span></div>
            <img data-src="http://cdn.e-daily.gr/repository/2017/FRTCOKI.jpg" alt="Μάθε την τύχη σου, άνοιξε ένα fortune cookie!" border="0" class="lazyload">
        </div>
        <div><span class=alert>QUIZ</span><span class="category eventCategory category136">ΧΙΟΥΜΟΡ</span></div>
        <h3>Μάθε την τύχη σου, άνοιξε ένα fortune cookie!</h3>
        <h4></h4>
	</a>

	<a href="/viral/82083/mia-aplh-fwtografia-enos-zeygarioy-metatraphke-se-oti-pio-avolo-exete-dei-sthn-zwh-sas-pics" target="_parent">
        <div class="cropimg absolute-center">
	        <div class="media"><span class="icon-picture"></span></div>
            <img data-src="http://cdn.e-daily.gr/repository/2017/paixnidia_myalou_2.jpg" alt="Μια απλή φωτογραφία ενός ζευγαριού μετατράπηκε σε ότι πιο άβολο έχετε δει στην ζωή σας" border="0" class="lazyload">
        </div>
        <div><span class="category eventCategory category136">ΠΑΡΑΞΕΝΑ</span></div>
        <h3>Μια απλή φωτογραφία ενός ζευγαριού μετατράπηκε σε ότι πιο άβολο έχετε δει στην ζωή σας</h3>
        <h4></h4>
	</a>
...
<div id="topTabs" class="tab-container" style="height:550px; overflow: hidden;">
  ...
  <div id="tabs-news" class="postEntries top">
	...
	<a href="/news/82133/o-pateras-toy-52xronoy-viasth-ths-dafnhs-paredwse-to-pistopoihtiko-tyflothtas-pics" target="_parent">
        <div class="cropimg absolute-center">
	        <div class="media"><span class="icon-picture"></span></div>
            <img data-src="http://cdn.e-daily.gr/repository/2017/dafnh_312.jpg" alt="Ο πατέρας του 52χρονου βιαστή της Δάφνης παρέδωσε το πιστοποιητικό τυφλότητας" border="0" class="lazyload">
        </div>
        <div><span class="category ">ΕΛΛΑΔΑ</span></div>
        <h3>Ο πατέρας του 52χρονου βιαστή της Δάφνης παρέδωσε το πιστοποιητικό τυφλότητας</h3>
        <h4></h4>
	</a>

	<a href="/news/82154/eixe-11-hmeres-sto-spiti-th-soro-ths-3xronhs-korhs-ths" target="_parent">
        <div class="cropimg absolute-center">
	        
            <img data-src="http://cdn.e-daily.gr/repository/2017/kopela_paidi1.jpg" alt="Είχε 11 ημέρες στο σπίτι τη σορό της 3χρονης κόρης της" border="0" class="lazyload">
        </div>
        <div><span class="category ">ΚΟΣΜΟΣ</span></div>
        <h3>Είχε 11 ημέρες στο σπίτι τη σορό της 3χρονης κόρης της</h3>
        <h4></h4>
	</a>

	<a href="/news/82134/kavala-ton-dagkwse-oxia-alla-den-toy-dothhke-oros-sto-nosokomeio-epeidh-htan-savvato" target="_parent">
        <div class="cropimg absolute-center">
	        
            <img data-src="http://cdn.e-daily.gr/repository/2017/oxia_ellada_1.jpg" alt="Καβάλα: Τον δάγκωσε οχιά αλλά δεν του δόθηκε ορός στο νοσοκομείο επειδή ήταν... Σάββατο" border="0" class="lazyload">
        </div>
        <div><span class="category ">ΕΛΛΑΔΑ</span></div>
        <h3>Καβάλα: Τον δάγκωσε οχιά αλλά δεν του δόθηκε ορός στο νοσοκομείο επειδή ήταν... Σάββατο</h3>
        <h4></h4>
	</a>

	<a href="/news/82166/samothrakh-kremasthke-sthn-aylh-toy-kai-entopisthke-meta-apo-24-wres" target="_parent">
        <div class="cropimg absolute-center">
	        
            <img data-src="http://cdn.e-daily.gr/repository/2017/170512_Samothraki.jpg" alt="Σαμοθράκη: Κρεμάστηκε στην αυλή του και εντοπίστηκε μετά από 24 ώρες" border="0" class="lazyload">
        </div>
        <div><span class="category ">ΕΛΛΑΔΑ</span></div>
        <h3>Σαμοθράκη: Κρεμάστηκε στην αυλή του και εντοπίστηκε μετά από 24 ώρες</h3>
        <h4></h4>
	</a>
  ...
  <div id="tabs-themata" class="postEntries top">
	...
	<a href="/themata/81955/oi-fylakes-ths-gitarama-einai-h-ensarkwsh-ths-kolashs-pics" target="_parent">
        <div class="cropimg absolute-center">
	        <div class="media"><span class="icon-picture"></span></div>
            <img data-src="http://cdn.e-daily.gr/repository/2017/fyalkh92.jpg" alt="Οι φυλακές της Gitarama είναι η ενσάρκωση της κόλασης" border="0" class="lazyload">
        </div>
        <div><span class="category ">ΑΦΙΕΡΩΜΑ</span></div>
        <h3>Οι φυλακές της Gitarama είναι η ενσάρκωση της κόλασης</h3>
        <h4></h4>
	</a>

	<a href="/themata/81857/hells-angels-h-symmoria-poy-skorpaei-ton-tromo-panw-se-dyo-troxoys-pics" target="_parent">
        <div class="cropimg absolute-center">
	        <div class="media"><span class="icon-picture"></span></div>
            <img data-src="http://cdn.e-daily.gr/repository/2017/symmoria902.jpg" alt="Hells Angels: Η συμμορία που σκορπάει τον τρόμο πάνω σε δύο τροχούς" border="0" class="lazyload">
        </div>
        <div><span class="category ">ΑΦΙΕΡΩΜΑ</span></div>
        <h3>Hells Angels: Η συμμορία που σκορπάει τον τρόμο πάνω σε δύο τροχούς</h3>
        <h4></h4>
	</a>
	...
	<a href="/themata/81939/giati-eksafanizontai-oi-anthrwpoi-sthn-iapwnia-pics" target="_parent">
        <div class="cropimg absolute-center">
	        <div class="media"><span class="icon-picture"></span></div>
            <img data-src="http://cdn.e-daily.gr/repository/2017/exfanis892.jpg" alt="Γιατί εξαφανίζονται οι άνθρωποι στην Ιαπωνία;" border="0" class="lazyload">
        </div>
        <div><span class="category ">ΚΟΣΜΟΣ</span></div>
        <h3>Γιατί εξαφανίζονται οι άνθρωποι στην Ιαπωνία;</h3>
        <h4></h4>
	</a>

	<a href="/themata/81548/h-krymmenh-aylh-ekklhsias-me-tis-fer-forze-sth-thessalonikh-pics" target="_parent">
        <div class="cropimg absolute-center">
	        <div class="media"><span class="icon-picture"></span></div>
            <img data-src="http://cdn.e-daily.gr/repository/2017/FRFORZE2.jpg" alt="Η... κρυμμένη αυλή εκκλησίας με τις φερ φορζέ στη Θεσσαλονίκη" border="0" class="lazyload">
        </div>
        <div><span class="category ">CITYΛΑΙΦ</span></div>
        <h3>Η... κρυμμένη αυλή εκκλησίας με τις φερ φορζέ στη Θεσσαλονίκη</h3>
        <h4></h4>
	</a>
  ...
  <div id="tabs-life" class="postEntries top">
	...
	<a href="/life/81843/to-ypogeio-koytoyki-sthn-kardia-ths-athhnas-pics" target="_parent">
        <div class="cropimg absolute-center">
	        <div class="media"><span class="icon-picture"></span></div>
            <img data-src="http://cdn.e-daily.gr/repository/2017/ddiporto2.jpg" alt="Το υπόγειο κουτούκι στην καρδιά της Αθήνας" border="0" class="lazyload">
        </div>
        <div><span class="category ">CITYΛΑΙΦ</span></div>
        <h3>Το υπόγειο κουτούκι στην καρδιά της Αθήνας</h3>
        <h4></h4>
	</a>

	<a href="/life/82009/aytoi-einai-oi-treis-pio-syxnoi-logoi-poy-mporei-na-ksypnas-koyrasmenos" target="_parent">
        <div class="cropimg absolute-center">
	        
            <img data-src="http://cdn.e-daily.gr/repository/2017/tired_21.jpg" alt="Αυτοί είναι οι τρείς πιο συχνοί λόγοι που μπορεί να ξυπνάς κουρασμένος" border="0" class="lazyload">
        </div>
        <div><span class="category ">BODY+MIND</span></div>
        <h3>Αυτοί είναι οι τρείς πιο συχνοί λόγοι που μπορεί να ξυπνάς κουρασμένος</h3>
        <h4></h4>
	</a>

	<a href="/life/81729/to-apolyto-kolpo-gia-na-mhn-ksypnate-koyrasmenoi-meta-apo-enan-kako-ypno" target="_parent">
        <div class="cropimg absolute-center">
	        
            <img data-src="http://cdn.e-daily.gr/repository/2017/badsleep.jpg" alt="Το απόλυτο κόλπο για να μην ξυπνάτε κουρασμένοι μετά από έναν κακό ύπνο" border="0" class="lazyload">
        </div>
        <div><span class="category ">BODY+MIND</span></div>
        <h3>Το απόλυτο κόλπο για να μην ξυπνάτε κουρασμένοι μετά από έναν κακό ύπνο</h3>
        <h4></h4>
	</a>

	<a href="/life/81736/gemise-alata-h-vrysh-sto-mpanio-paneykolh-lysh" target="_parent">
        <div class="cropimg absolute-center">
	        
            <img data-src="http://cdn.e-daily.gr/repository/2017/brusu35.jpg" alt="Γέμισε άλατα η βρύση στο μπάνιο; Πανεύκολη λύση" border="0" class="lazyload">
        </div>
        <div><span class="category ">ΣΠΙΤΙ</span></div>
        <h3>Γέμισε άλατα η βρύση στο μπάνιο; Πανεύκολη λύση</h3>
        <h4></h4>
	</a>

	<a href="/life/81777/mia-anatreptikh-protash-twn-episthmonwn-gia-osoys-agxwnontai-sth-doyleia" target="_parent">
        <div class="cropimg absolute-center">
	        
            <img data-src="http://cdn.e-daily.gr/repository/2017/panic3.jpeg" alt="Μια ανατρεπτική πρόταση των επιστημόνων για όσους αγχώνονται στη δουλειά" border="0" class="lazyload">
        </div>
        <div><span class="category ">BODY+MIND</span></div>
        <h3>Μια ανατρεπτική πρόταση των επιστημόνων για όσους αγχώνονται στη δουλειά</h3>
        <h4></h4>
	</a>
  ...
  <div id="tabs-viral" class="postEntries top">
	...
	<a href="/viral/82079/h-nea-fwtografish-ths-52xronhs-monica-bellucci-me-zartieres-pics" target="_parent">
        <div class="cropimg absolute-center">
	        <div class="media"><span class="icon-picture"></span></div>
            <img data-src="http://cdn.e-daily.gr/repository/2017/moni_be_21.jpg" alt="Η νέα φωτογράφιση της 52χρονης Monica Bellucci με ζαρτιέρες" border="0" class="lazyload">
        </div>
        <div><span class="category ">SEXY</span></div>
        <h3>Η νέα φωτογράφιση της 52χρονης Monica Bellucci με ζαρτιέρες</h3>
        <h4></h4>
	</a>

	<a href="/viral/82104/o-vasilhs-karras-mphke-sto-vivlio-gkines-mazepse-17-xiliades-kosmo-sth-sofia-video" target="_parent">
        <div class="cropimg absolute-center">
	        <div class="media"><span class="icon-play"></span></div>
            <img data-src="http://cdn.e-daily.gr/repository/2017/170511_VasilisKarras.jpg" alt="Ο Βασίλης Καρράς μπήκε στο Βιβλίο Γκίνες: Μάζεψε 17 χιλιάδες κόσμο στη Σόφια!" border="0" class="lazyload">
        </div>
        <div><span class="category ">ΜΟΥΣΙΚΗ</span></div>
        <h3>Ο Βασίλης Καρράς μπήκε στο Βιβλίο Γκίνες: Μάζεψε 17 χιλιάδες κόσμο στη Σόφια!</h3>
        <h4></h4>
	</a>

	<a href="/viral/81912/eurovision-2017-ston-teliko-ellada-kai-kypros-meta-apo-5-xronia-pics-video" target="_parent">
        <div class="cropimg absolute-center">
	        <div class="media"><span class="icon-play"></span></div>
            <img data-src="http://cdn.e-daily.gr/repository/2017/dem_telikos3.jpg" alt="Eurovision 2017: Στον τελικό Ελλάδα και Κύπρος μετά από 5 χρόνια " border="0" class="lazyload">
        </div>
        <div><span class="category ">ΜΟΥΣΙΚΗ</span></div>
        <h3>Eurovision 2017: Στον τελικό Ελλάδα και Κύπρος μετά από 5 χρόνια </h3>
        <h4></h4>
	</a>

	<a href="/quiz/44424/aparadektoi-mega-quiz-gia-dynatoys-lytes-quiz" target="_parent">
        <div class="cropimg absolute-center">
	        <div class="media"><span class="icon-doc-text"></span></div>
            <img data-src="http://cdn.e-daily.gr/repository/2015/aparadektoi4.jpg" alt="Απαράδεκτοι: Μega Quiz για δυνατούς λύτες" border="0" class="lazyload">
        </div>
        <div><span class=alert>QUIZ</span><span class="category ">MEDIA</span></div>
        <h3>Απαράδεκτοι: Μega Quiz για δυνατούς λύτες</h3>
        <h4></h4>
	</a>
