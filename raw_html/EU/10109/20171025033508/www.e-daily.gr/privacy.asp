...
<!--
     ...
     Copyright 2015-2017 Tzilas Kostantinos
     ________________________________________________________
...
<link rel="dns-prefetch" href="//www.e-daily.gr" />
<link rel="dns-prefetch" href="//cdn.e-daily.gr" />
...
<link href="/_img/edailyicons/css/edaily.css" rel="stylesheet" type="text/css" />
...
<link href="/_css/mobilemenu.css?v=2.19" rel="stylesheet" type="text/css" media="screen" />
<link href="/_css/structure.css?v=2.19" rel="stylesheet" type="text/css" />
<link href="/_js/mmenu/jquery.ma.infinitypush.css"  rel="stylesheet" type="text/css"/>
...
<script src="//js.agkn.com/prod/v0/tag.js" async="async"></script>
...
<div id="wrapper">
	...
	<ul class="sections">
		...
		<li><a href="/quiz">Κουίζ</a>
		<li><a href="/life">Life</a>
		<li><a href="/popculture">Pop Culture</a>
		<li><a href="/videos">Videos</a>

		<li><a href="/agenda">Ε-Agenda</a>
	...
	<ul class="sections topics">
		<li><a href="/agenda">Ε-Agenda</a>
		<li><a href="/agenda/epiloges">Επιλογές</a>
		<li><a href="/agenda/cinema">Σινεμά</a>
		<li><a href="/agenda/music">Μουσική</a>
		<li><a href="/agenda/theater">Θέατρο+Χορός</a>
		<li><a href="/agenda/arts">Τέχνες</a>
		<li><a href="/agenda/festival">Φεστιβάλ</a>
		<li><a href="/agenda/kids">Παιδικά</a>
		<li><a href="/agenda/cityfile">Cityλάιφ</a>
		<li><a href="/agenda/nightlife">Nightλάιφ</a>
    </ul>
...
<div id="topHeaderWarper">
    <div id="topHeader">
        ...
        <div id="topHeaderA">
        	<a href="http://www.e-daily.gr/news/82909/e8209dailygr-3-vraveia-dime-ston-prwto-xrono-leitoyrgias"><img src="/_img/dime17_minibanner.png" alt="3 ΒΡΑΒΕΙΑ στα Digital Media Awards 2017" border="0" /></a>
			<span class="ataka" style="display:none">ΤΑ ΝΕΑ ΤΗΣ ΗΜΕΡΑΣ ΚΑΙ ΟΤΙ ΣΟΥ ΚΑΝΕΙ ΚΛΙΚ</span>
        </div>
        <div id="topHeaderB">

           
           <a href="/"><img src="/_img/edailygr_logo.png" border="0" alt="E-Daily Τα Νέα της ημέρας και ότι σου κάνει κλικ!"/></a>
           
        </div>
        <div id="topHeaderC" class="feedIcons">
			...
			<a href="/retro" class="hideOnSmallMenu"><img src="/_img/feeds/110.png" border="0" alt="Retro Feed" /></a>
			<a href="/alist" class="hideOnSmallMenu"><img src="/_img/feeds/91.png" border="0" alt="A-List Feed" /></a>
...
<div id="mainmenu_right">
	<a class="icon-search right_item search" href="/search" style="padding:17px 10px 19px 10px; box-sizing:border-box; height:54px"></a>
	<a class="icon-twitter-bird right_item twitter hideOnSmallMenu" href="http://www.twitter.com/edailygr" target="_blank" style="padding:17px 10px 17px 10px; box-sizing:border-box; height:44px"></a>
	<a class="icon-instagram right_item instagram hideOnSmallMenu" href="http://www.instagram.com/edailygr" target="_blank" style="padding:17px 10px 17px 10px; box-sizing:border-box; height:44px"></a>
	<a class="icon-youtube-play right_item youtube hideOnSmallMenu" href="http://www.youtube.com/c/edailygr" target="_blank" style="padding:17px 10px 17px 10px; box-sizing:border-box; height:44px"></a>
	<a class="icon-facebook right_item facebook hideOnSmallMenu" href="http://www.facebook.com/edailygr" target="_blank" style="padding:17px 0 17px 10px; box-sizing:border-box; height:44px"></a>
</div>
...
<ul id="mainTabs">
	...
	<li id="tabNews">
		<div id="tabNewsMenu" class="menuPanelContainer">
			<a href="/news" class="menuTab menuTabWhite2">ΕΙΔΗΣΕΙΣ</a>
            <div class="menuFrame">
				<div class="menuOptions">
					...
					<a href="/sansimera">ΣΑΝ ΣΗΜΕΡΑ</a>
				</div>
            </div>
		</div>
		<a href="/news" id="tabNews" class="menuTab menuTabWhite1 hasMenu ">ΕΙΔΗΣΕΙΣ</a>
	</li>
	<li id="tabThemata">
		<div id="tabThemataMenu" class="menuPanelContainer">
			<a href="/themata" class="menuTab menuTabWhite2">ΘΕΜΑΤΑ</a>
            <div class="menuFrame">
				<div class="menuOptions">
		...
		<a href="/themata" id="tabThemata" class="menuTab hasMenu menuTabWhite1 ">ΘΕΜΑΤΑ</a>
	</li>
	<li id="tabViral">
		...
		<a href="/viral" id="tabViral" class="menuTab hasMenu menuTabWhite1 ">VIRAL</a>
	</li>
	<li id="tabQuiz">
		<a href="/quiz" id="tabQuiz" class="menuTab menuTabWhite1 ">ΚΟΥΙΖ</a>
	</li>
	<li id="tabLife">
		...
		<a href="/life" id="tabLife" class="menuTab hasMenu menuTabWhite1 ">LIFE</a>
	</li>
	<li id="tabPopCulture">
		<div id="tabPopcultureMenu" class="menuPanelContainer">
			<a href="/popculture" class="menuTab menuTabWhite2">POP CULTURE</a>
            <div class="menuFrame">
				<div class="menuOptions">
					<a href="/popculture">ΤΕΛΕΥΤΑΙΑ θΕΜΑΤΑ</a>
					<a href="/tv-series">TV ΣΙΡΙΑΛ</a>
		...
		<a href="/popculture" id="tabPopculture" class="menuTab hasMenu menuTabWhite1 ">POP CULTURE</a>
	</li>
	<li id="tabVideos">
		<div id="tabVideosMenu" class="menuPanelContainer">
			<a href="/videos" class="menuTab menuTabWhite2">VIDEOS</a>
            <div class="menuFrame">
				<div class="menuOptions">
					<a href="/videos" >ΤΕΛΕΥΤΑΙΑ VIDEO</a>
					<a href="/top-of-pop" >TOP OF POP</a>
		...
		<a href="/videos" id="tabVideos" class="menuTab hasMenu menuTabWhite1 ">VIDEOS</a>
	</li>
	<li id="tabEAgenda">        
		<div id="tabEAgendaMenu" class="menuPanelContainer">
			<a href="/agenda" class="menuTab menuTabWhite3"><img src="/_img/blank.png" height="20" width="107" /></a>
            <div class="menuFrame eagenda">
				<div class="menuOptions">
					<a href="/agenda">ATZENTA ΣΗΜΕΡΑ</a>
					<a href="/agenda/music">ΜΟΥΣΙΚΗ</a>
					<a href="/agenda/cinema">ΣΙΝΕΜΑ</a>
					<a href="/agenda/theater">ΘΕΑΤΡΟ+ΧΟΡΟΣ</a>
					<a href="/agenda/arts">ΤΕΧΝΕΣ</a>
					<a href="/agenda/citylife">CITYΛΑΙΦ</a>
					<a href="/agenda/nightlife">NIGHTΛΑΪΦ</a>
				</div>
            </div>
		</div>
		<a href="/agenda" id="tabEAgenda"class="menuTab menuTabWhite1 hasMenu nextwebchannels "><img src="/_img/eagendagr_logo_menu.png" height="20" width="107" /></a>
	</li>
	<li id="extras">
		<a href="http://www.e-radio.gr" target="_blank" class="nextwebchannels"><img src="/_img/eradiogr_logo_menu.png" height="20" /></a>
	</li>
</ul>    
</div>
...
<div class="adActive adMovable">
<div id="adsBillboard" class="">
<center>
<div id="5799488"></div>
<script>
ADTECH.config.placements[5799488] = {params: { alias: '', key:'',target: '_blank' }};
ADTECH.loadAd(5799488);
...
<script>
ADTECH.config.placements[5799491] = {params: { alias: '', key:'',target: '_blank' }};
ADTECH.loadAd(5799491);
</script>
</center>
...
<div id="todayTabs" class="tab-container" style=overflow: hidden">
  <ul class="etabs">
    <li class="tab"><a href="#tabs-recent">ΡΟΗ ΕΙΔΗΣΕΩΝ</a></li>
    <li class="tab"><a href="#tabs-hl">TRENDING</a></li>
  </ul>
  <div id="tabs-recent" class="postEntries small">
    
	<a href="/life/94471/10-apofthegmata-gia-na-soy-paei-kala-h-mera-pics" target="_parent">
        <div class="cropimg absolute-center">
	        <div class="media"><span class="icon-picture"></span></div>
            <img data-src="http://cdn.e-daily.gr/repository/2017/better_day_1.jpg" alt="10 αποφθέγματα για να σου πάει καλά η μέρα" border="0" class="lazyload">
        </div>
        <div><span class="category ">ΑΝΘΡΩΠΟΙ</span><span class="when">00:31</span></div>
        <h3>10 αποφθέγματα για να σου πάει καλά η μέρα</h3>
        <h4></h4>
	</a>

	<a href="/life/94467/to-hlektroniko-tsigaro-prokalei-ths-idies-astheneies-me-to-kanoniko-tsigaro" target="_parent">
        <div class="cropimg absolute-center">
	        
            <img data-src="http://cdn.e-daily.gr/repository/2017/el_cig_1.jpg" alt="Το ηλεκτρονικό τσιγάρο προκαλεί της ίδιες ασθένειες με το «κανονικό» τσιγάρο" border="0" class="lazyload">
        </div>
        <div><span class="category ">BODY+MIND</span><span class="when">00:31</span></div>
        <h3>Το ηλεκτρονικό τσιγάρο προκαλεί της ίδιες ασθένειες με το «κανονικό» τσιγάρο</h3>
        <h4></h4>
	</a>

	<a href="/life/94445/mporeite-kai-eseis-na-vapseis-ta-mallia-soy-me-nutella-video" target="_parent">
        <div class="cropimg absolute-center">
	        <div class="media"><span class="icon-play"></span></div>
            <img data-src="http://cdn.e-daily.gr/repository/2017/merenta1.jpg" alt="Μπορείτε και εσείς να βάψεις τα μαλλιά σου με Nutella!" border="0" class="lazyload">
        </div>
        <div><span class="category ">STYLE</span><span class="when">00:31</span></div>
        <h3>Μπορείτε και εσείς να βάψεις τα μαλλιά σου με Nutella!</h3>
        <h4></h4>
	</a>

	<a href="/themata/94442/san-shmera-pethane-o-ksypolhtos-marathwnodromos-ampempe-mpikila-pics" target="_parent">
        <div class="cropimg absolute-center">
	        <div class="media"><span class="icon-picture"></span></div>
            <img data-src="http://cdn.e-daily.gr/repository/2017/abebe_4.jpg" alt="Σαν σήμερα: Πέθανε ο «ξυπόλητος» μαραθωνοδρόμος Αμπέμπε Μπικίλα" border="0" class="lazyload">
        </div>
        <div><span class="category ">ΣΑΝ ΣΗΜΕΡΑ</span><span class="when">00:31</span></div>
        <h3>Σαν σήμερα: Πέθανε ο «ξυπόλητος» μαραθωνοδρόμος Αμπέμπε Μπικίλα</h3>
        <h4></h4>
	</a>

	<a href="/viral/94372/ta-14-pio-akriva-lathh-sthn-istoria-pics" target="_parent">
        <div class="cropimg absolute-center">
	        <div class="media"><span class="icon-picture"></span></div>
            <img data-src="http://cdn.e-daily.gr/repository/2017/16619910-17881410-12-0-1507707071-1507707076-650-1-1507707076-650-7041eaefe1-1508505822 (1).jpg" alt="Τα 14 πιο ακριβά λάθη στην ιστορία" border="0" class="lazyload">
        </div>
        <div><span class="category ">ΠΑΡΑΞΕΝΑ</span><span class="when">00:31</span></div>
        <h3>Τα 14 πιο ακριβά λάθη στην ιστορία</h3>
        <h4></h4>
	</a>

  </div>
  <div id="tabs-hl" class="postEntries small">
    
	<a href="/news/94280/nekros-vrethhke-32xronos-mesa-se-kazani-oinopoieioy-sth-thessalonikh" target="_parent">
        <div class="cropimg absolute-center">
	        
            <img data-src="http://cdn.e-daily.gr/repository/2017/kzankie.jpg" alt="Νεκρός βρέθηκε 32χρονος μέσα σε καζάνι οινοποιείου στη Θεσσαλονίκη" border="0" class="lazyload">
        </div>
        <div><span class="category ">ΕΛΛΑΔΑ</span> <span class="when">23/10</span></div>
        <h3>Νεκρός βρέθηκε 32χρονος μέσα σε καζάνι οινοποιείου στη Θεσσαλονίκη</h3>
        <h4></h4>
	</a>

	<a href="http://www.e-daily.gr/themata/90655/linta-giga-o-pothos-twn-antrwn-th-dekaetia-toy-80-pics" target="_blank">
        <div class="cropimg absolute-center">
	        <div class="media"><span class="icon-picture"></span></div>
            <img data-src="http://cdn.e-daily.gr/repository/2017/lintagiga2.jpg" alt="Λίντα Γίγα, ο πόθος των αντρών τη δεκαετία του 80" border="0" class="lazyload">
        </div>
        <div><span class="category ">ΑΝΘΡΩΠΟΙ</span> <span class="when">23/10</span></div>
        <h3>Λίντα Γίγα, ο πόθος των αντρών τη δεκαετία του 80</h3>
        <h4></h4>
	</a>

	<a href="/quiz/94302/mporeite-na-vreite-poia-faghta-exoyn-ta-perissotera-lipara-quiz" target="_parent">
        <div class="cropimg absolute-center">
	        <div class="media"><span class="icon-doc-text"></span></div>
            <img data-src="http://cdn.e-daily.gr/repository/2017/foodaquizaliparaandonemainena.jpg" alt="Μπορείτε να βρείτε ποια φαγητά έχουν τα περισσότερα λιπαρά;" border="0" class="lazyload">
        </div>
        <div><span class=alert>QUIZ</span><span class="category ">FOOD</span> <span class="when">24/10</span></div>
        <h3>Μπορείτε να βρείτε ποια φαγητά έχουν τα περισσότερα λιπαρά;</h3>
        <h4></h4>
	</a>

	<a href="/viral/94340/petakse-thn-anthodesmh-kai-thn-phre-o-xaros-video" target="_parent">
        <div class="cropimg absolute-center">
	        <div class="media"><span class="icon-play"></span></div>
            <img data-src="http://cdn.e-daily.gr/repository/2017/bride12.jpg" alt="Πέταξε την ανθοδέσμη και την... πήρε ο Χάρος!" border="0" class="lazyload">
        </div>
        <div><span class="category ">ΚΟΣΜΟΣ</span> <span class="when">24/10</span></div>
        <h3>Πέταξε την ανθοδέσμη και την... πήρε ο Χάρος!</h3>
        <h4></h4>
	</a>

	<a href="/life/94253/ksexna-to-zwdio-soy-vres-th-selhnh-soy-kai-mathe-perissotera-gia-sena" target="_parent">
        <div class="cropimg absolute-center">
	        
            <img data-src="http://cdn.e-daily.gr/repository/2017/mmsniugn2.jpg" alt="Ξέχνα το ζώδιό σου, βρες τη Σελήνη σου και μάθε περισσότερα για σένα" border="0" class="lazyload">
        </div>
        <div><span class="category ">ΖΩΔΙΑ</span> <span class="when">24/10</span></div>
        <h3>Ξέχνα το ζώδιό σου, βρες τη Σελήνη σου και μάθε περισσότερα για σένα</h3>
        <h4></h4>
	</a>
...
<div id="5799492"></div>
<script>
ADTECH.config.placements[5799492] = {params: { alias: '', key:'',target: '_blank' }};
ADTECH.loadAd(5799492);
...
<div class="postsRedHeader">ΔΗΜΟΦΙΛΕΣΤΕΡΑ</div>
<div id="topTabs" class="tab-container" style="height:550px; overflow: hidden;">
  <ul class="etabs">
  ...
  <div id="tabs-news" class="postEntries top">
	...
	<a href="/news/92577/anatroph-sthn-ypothesh-me-ta-anthrwpina-osta-poy-vrethhkan-sto-soynio-video" target="_parent">
        <div class="cropimg absolute-center">
	        <div class="media"><span class="icon-play"></span></div>
            <img data-src="http://cdn.e-daily.gr/repository/2017/osta_sounio_1.jpg" alt="Ανατροπή στην υπόθεση με τα ανθρώπινα οστά που βρέθηκαν στο Σούνιο" border="0" class="lazyload">
        </div>
        <div><span class="category ">ΕΛΛΑΔΑ</span> <span class="when">29/09</span></div>
        <h3>Ανατροπή στην υπόθεση με τα ανθρώπινα οστά που βρέθηκαν στο Σούνιο</h3>
        <h4></h4>
	</a>

	<a href="/news/92586/poy-strefontai-oi-ereynes-ths-astynomias-gia-ton-sako-me-osta-poy-vrethhke-sto-soynio" target="_parent">
        <div class="cropimg absolute-center">
	        
            <img data-src="http://cdn.e-daily.gr/repository/2017/170930_Bones.jpg" alt="Που στρέφονται οι έρευνες της Αστυνομίας για τον σάκο με οστά που βρέθηκε στο Σούνιο" border="0" class="lazyload">
        </div>
        <div><span class="category ">ΕΛΛΑΔΑ</span> <span class="when">30/09</span></div>
        <h3>Που στρέφονται οι έρευνες της Αστυνομίας για τον σάκο με οστά που βρέθηκε στο Σούνιο</h3>
        <h4></h4>
	</a>

	<a href="/news/92549/poso-tha-plhrwnoyme-gia-thn-kathe-plastikh-sakoyla-sta-soyper-market" target="_parent">
        <div class="cropimg absolute-center">
	        
            <img data-src="http://cdn.e-daily.gr/repository/2017/skoules.jpg" alt="Πόσο θα πληρώνουμε για την κάθε πλαστική σακούλα στα σούπερ μάρκετ" border="0" class="lazyload">
        </div>
        <div><span class="category ">ΕΛΛΑΔΑ</span> <span class="when">29/09</span></div>
        <h3>Πόσο θα πληρώνουμε για την κάθε πλαστική σακούλα στα σούπερ μάρκετ</h3>
        <h4></h4>
	</a>

	<a href="/news/92511/o-theos-den-kanei-lathh-eipan-nearoi-goneis-kai-afhsan-neogennhto-na-pethanei-apo-iktero" target="_parent">
        <div class="cropimg absolute-center">
	        
            <img data-src="http://cdn.e-daily.gr/repository/2017/dfgd1.jpg" alt="«Ο Θεός δεν κάνει λάθη» είπαν νεαροί γονείς και άφησαν νεογέννητο να πεθάνει από ίκτερο" border="0" class="lazyload">
        </div>
        <div><span class="category ">ΚΟΣΜΟΣ</span> <span class="when">29/09</span></div>
        <h3>«Ο Θεός δεν κάνει λάθη» είπαν νεαροί γονείς και άφησαν νεογέννητο να πεθάνει από ίκτερο</h3>
        <h4></h4>
	</a>

	<a href="/news/91955/syntrivh-aeroskafoys-sto-aerodromio-atatoyrk-pics" target="_parent">
        <div class="cropimg absolute-center">
	        <div class="media"><span class="icon-picture"></span></div>
            <img data-src="http://cdn.e-daily.gr/repository/2017/dsfqw4tdfs.jpg" alt="Συντριβή αεροσκάφους στο αεροδρόμιο Ατατούρκ" border="0" class="lazyload">
        </div>
        <div><span class="category ">ΚΟΣΜΟΣ</span> <span class="when">22/09</span></div>
        <h3>Συντριβή αεροσκάφους στο αεροδρόμιο Ατατούρκ</h3>
        <h4></h4>
	</a>
  ...
  <div id="tabs-themata" class="postEntries top">
	...
	<a href="/themata/91990/giati-h-vasilissa-elisavet-den-prokeitai-na-pathsei-pote-to-podi-ths-sthn-ellada-pics" target="_parent">
        <div class="cropimg absolute-center">
	        <div class="media"><span class="icon-picture"></span></div>
            <img data-src="http://cdn.e-daily.gr/repository/2017/eli1.jpg" alt="Γιατί η Βασίλισσα Ελισάβετ δεν πρόκειται να πατήσει ποτέ το πόδι της στην Ελλάδα;" border="0" class="lazyload">
        </div>
        <div><span class="category ">ΚΟΣΜΟΣ</span> <span class="when">26/09</span></div>
        <h3>Γιατί η Βασίλισσα Ελισάβετ δεν πρόκειται να πατήσει ποτέ το πόδι της στην Ελλάδα;</h3>
        <h4></h4>
	</a>

	<a href="/themata/92026/giati-vafoyn-leykoys-toys-dromoys-sto-los-antzeles-ksodeyontas-ekatommyria-pics-video" target="_parent">
        <div class="cropimg absolute-center">
	        <div class="media"><span class="icon-play"></span></div>
            <img data-src="http://cdn.e-daily.gr/repository/2017/Coolpavement2-1280x720.jpg" alt="Γιατί βάφουν λευκούς τους δρόμους στο Λος Αντζελες ξοδεύοντας εκατομμύρια;" border="0" class="lazyload">
        </div>
        <div><span class="category ">ΠΕΡΙΒΑΛΛΟΝ</span> <span class="when">25/09</span></div>
        <h3>Γιατί βάφουν λευκούς τους δρόμους στο Λος Αντζελες ξοδεύοντας εκατομμύρια;</h3>
        <h4></h4>
	</a>

	<a href="/themata/91803/diashmes-popnes-ths-elladas-pics" target="_parent">
        <div class="cropimg absolute-center">
	        <div class="media"><span class="icon-picture"></span></div>
            <img data-src="http://cdn.e-daily.gr/repository/2017/preoj43n34.jpg" alt="Διάσημες... «πόpνες» της Ελλάδας" border="0" class="lazyload">
        </div>
        <div><span class="category ">ΣΙΝΕΜΑ</span> <span class="when">25/09</span></div>
        <h3>Διάσημες... «πόpνες» της Ελλάδας</h3>
        <h4></h4>
	</a>

	<a href="/themata/92241/oi-pio-anatrixiastikes-aytoktonies-poy-exoyn-katagrafei-pics" target="_parent">
        <div class="cropimg absolute-center">
	        <div class="media"><span class="icon-picture"></span></div>
            <img data-src="http://cdn.e-daily.gr/repository/2017/friki3903.jpg" alt="Οι πιο ανατριχιαστικές αυτοκτονίες που έχουν καταγραφεί" border="0" class="lazyload">
        </div>
        <div><span class="category ">ΑΦΙΕΡΩΜΑ</span> <span class="when">28/09</span></div>
        <h3>Οι πιο ανατριχιαστικές αυτοκτονίες που έχουν καταγραφεί</h3>
        <h4></h4>
	</a>

	<a href="/themata/92172/san-shmera-h-17n-dolofonei-sto-kolwnaki-ton-paylo-mpakogiannh-pics" target="_parent">
        <div class="cropimg absolute-center">
	        <div class="media"><span class="icon-picture"></span></div>
            <img data-src="http://cdn.e-daily.gr/repository/2017/pavlos_1.jpg" alt="Σαν σήμερα: Η «17Ν» δολοφονεί στο Κολωνάκι τον Παύλο Μπακογιάννη" border="0" class="lazyload">
        </div>
        <div><span class="category ">ΣΑΝ ΣΗΜΕΡΑ</span> <span class="when">26/09</span></div>
        <h3>Σαν σήμερα: Η «17Ν» δολοφονεί στο Κολωνάκι τον Παύλο Μπακογιάννη</h3>
        <h4></h4>
	</a>
  ...
  <div id="tabs-life" class="postEntries top">
	...
	<a href="/life/92384/oi-gynaikes-apanthsan-sto-ti-prepei-na-exei-enas-antras-gia-na-toys-xarisei-enan-dynato-opgasmo" target="_parent">
        <div class="cropimg absolute-center">
	        
            <img data-src="http://cdn.e-daily.gr/repository/2017/women_humor_1.jpg" alt="Οι γυναίκες απάντησαν στο τι πρέπει να έχει ένας άντρας για να τους χαρίσει έναν δυνατό οpγασμό" border="0" class="lazyload">
        </div>
        <div><span class="category ">BODY+MIND</span> <span class="when">29/09</span></div>
        <h3>Οι γυναίκες απάντησαν στο τι πρέπει να έχει ένας άντρας για να τους χαρίσει έναν δυνατό οpγασμό</h3>
        <h4></h4>
	</a>

	<a href="/life/91619/h-nea-tash-sth-diakosmhsh-toixoy-poy-tha-latrepsoyn-oi-neoteroi-pics" target="_parent">
        <div class="cropimg absolute-center">
	        <div class="media"><span class="icon-picture"></span></div>
            <img data-src="http://cdn.e-daily.gr/repository/2017/colaz89.jpg" alt="Η νέα τάση στη διακόσμηση τοίχου που θα λατρέψουν οι νεότεροι" border="0" class="lazyload">
        </div>
        <div><span class="category ">ΣΠΙΤΙ</span> <span class="when">25/09</span></div>
        <h3>Η νέα τάση στη διακόσμηση τοίχου που θα λατρέψουν οι νεότεροι</h3>
        <h4></h4>
	</a>

	<a href="/life/92493/ti-tha-symvei-an-stamathsoyme-na-koimomaste-ena-alhthino-peirama-video" target="_parent">
        <div class="cropimg absolute-center">
	        <div class="media"><span class="icon-play"></span></div>
            <img data-src="http://cdn.e-daily.gr/repository/2017/38766492-awake.jpg" alt="Τι θα συμβεί αν σταματήσουμε να κοιμόμαστε - Ένα αληθινό πείραμα" border="0" class="lazyload">
        </div>
        <div><span class="category ">BODY+MIND</span> <span class="when">29/09</span></div>
        <h3>Τι θα συμβεί αν σταματήσουμε να κοιμόμαστε - Ένα αληθινό πείραμα</h3>
        <h4></h4>
	</a>

	<a href="/life/90375/oi-psyxologoi-ekshgoyn-gia-poio-logo-epilegoyme-toys-lathos-syntrofoys" target="_parent">
        <div class="cropimg absolute-center">
	        
            <img data-src="http://cdn.e-daily.gr/repository/2017/fidiflspeople.jpg" alt="Οι ψυχολόγοι εξηγούν για ποιο λόγο επιλέγουμε τους λάθος συντρόφους" border="0" class="lazyload">
        </div>
        <div><span class="category ">ΣΧΕΣΕΙΣ</span> <span class="when">25/09</span></div>
        <h3>Οι ψυχολόγοι εξηγούν για ποιο λόγο επιλέγουμε τους λάθος συντρόφους</h3>
        <h4></h4>
	</a>

	<a href="/life/92108/poios-einai-o-mesos-oros-diarkeias-toy-seks" target="_parent">
        <div class="cropimg absolute-center">
	        
            <img data-src="http://cdn.e-daily.gr/repository/2017/sxeseis93.jpg" alt="Ποιος είναι ο μέσος όρος διάρκειας του σeξ" border="0" class="lazyload">
        </div>
        <div><span class="category ">BODY+MIND</span> <span class="when">25/09</span></div>
        <h3>Ποιος είναι ο μέσος όρος διάρκειας του σeξ</h3>
        <h4></h4>
	</a>
  ...
  <div id="tabs-viral" class="postEntries top">
	...
	<a href="/viral/92403/ti-epaikse-sto-stoixhma-o-takhs-tsoykalas-gia-to-gioyventoys-olympiakos-pics" target="_parent">
        <div class="cropimg absolute-center">
	        <div class="media"><span class="icon-picture"></span></div>
            <img data-src="http://cdn.e-daily.gr/repository/2017/tsouk_juv_2.jpg" alt="Τι έπαιξε στο στοίχημα ο Τάκης Τσουκαλάς για το Γιουβέντους - Ολυμπιακός" border="0" class="lazyload">
        </div>
        <div><span class="category ">ΑΘΛΗΤΙΣΜΟΣ</span> <span class="when">28/09</span></div>
        <h3>Τι έπαιξε στο στοίχημα ο Τάκης Τσουκαλάς για το Γιουβέντους - Ολυμπιακός</h3>
        <h4></h4>
	</a>

	<a href="/viral/92428/to-oyrliaxto-ths-reporter-on-air-poy-pagwse-thn-ert-video" target="_parent">
        <div class="cropimg absolute-center">
	        <div class="media"><span class="icon-play"></span></div>
            <img data-src="http://cdn.e-daily.gr/repository/2017/samothrak303.jpg" alt="Το ουρλιαχτό της ρεπόρτερ on air που «πάγωσε» την ΕΡΤ!" border="0" class="lazyload">
        </div>
        <div><span class="category ">ΕΛΛΑΔΑ</span> <span class="when">28/09</span></div>
        <h3>Το ουρλιαχτό της ρεπόρτερ on air που «πάγωσε» την ΕΡΤ!</h3>
        <h4></h4>
	</a>

	<a href="/viral/92179/15-aspromayres-fwtografies-poy-den-exoyn-kamia-logikh-ekshghsh-pics" target="_parent">
        <div class="cropimg absolute-center">
	        <div class="media"><span class="icon-picture"></span></div>
            <img data-src="http://cdn.e-daily.gr/repository/2017/paraxenes_photo_main.jpg" alt="15 ασπρόμαυρες φωτογραφίες που δεν έχουν καμία λογική εξήγηση" border="0" class="lazyload">
        </div>
        <div><span class="category ">ΧΙΟΥΜΟΡ</span> <span class="when">28/09</span></div>
        <h3>15 ασπρόμαυρες φωτογραφίες που δεν έχουν καμία λογική εξήγηση</h3>
        <h4></h4>
	</a>

	<a href="/viral/92435/mikroyla-eklepse-ta-pop-korn-toy-prigkipa-xari-mesa-sta-matia-toy-video" target="_parent">
        <div class="cropimg absolute-center">
	        <div class="media"><span class="icon-play"></span></div>
            <img data-src="http://cdn.e-daily.gr/repository/2017/babygirl8888.jpg" alt="Μικρούλα έκλεψε τα... ποπ κορν του Πρίγκιπα Χάρι μέσα στα μάτια του!" border="0" class="lazyload">
        </div>
        <div><span class="category ">ΚΟΣΜΟΣ</span> <span class="when">28/09</span></div>
        <h3>Μικρούλα έκλεψε τα... ποπ κορν του Πρίγκιπα Χάρι μέσα στα μάτια του!</h3>
        <h4></h4>
	</a>

	<a href="/viral/92402/h-alhtheia-pisw-apo-6-gnwsta-magika-kolpa-pics" target="_parent">
        <div class="cropimg absolute-center">
	        <div class="media"><span class="icon-picture"></span></div>
            <img data-src="http://cdn.e-daily.gr/repository/2017/Mind_Warehouse_Magic_001.jpg" alt="Η αλήθεια πίσω από 6 γνωστά μαγικά κόλπα" border="0" class="lazyload">
        </div>
        <div><span class="category ">ΠΑΡΑΞΕΝΑ</span> <span class="when">28/09</span></div>
        <h3>Η αλήθεια πίσω από 6 γνωστά μαγικά κόλπα</h3>
        <h4></h4>
	</a>
...
<div id="footerBgWide" style="background: #e9ecee; z-index: 10;">
<center>
<div id="footerMain">

	<div class="footer hideOnSmallScreen" style="width:12%;">			
	
		<div class="footer_optionsHeader"><a href="/news">Ειδήσεις</a></div>
	...
	<div class="footer hideOnSmallScreen" style="width:12%;">
		<div class="footer_optionsHeader"><a href="/themata">Θέματα</a></div>
		<div class="footer_optionsHeader"><a href="/quiz">Κουίζ</a></div>    
		<div class="footer_optionsHeader"><a href="/viral">Viral</a></div>
        <br>
		<div class="footer_optionsHeader"><a href="/woman">WOMAN</a></div>
		...
		<div class="footer_optionsHeader"><a href="/lgbt">LGBT</a></div>
		<div class="footer_optionsHeader"><a href="/retro">RETRO</a></div>
		<div class="footer_optionsHeader"><a href="/Cute">CUTE</a></div>
		<div class="footer_optionsHeader"><a href="/win">WIN</a></div>
        
    </div>
    
	<div class="footer hideOnSmallScreen" style="width:12%;">
       
		<div class="footer_optionsHeader"><a href="/videos">Videos</a></div>
		<div class="footer_options">
			<a href="/top-of-pop">TOP of POP</a>
			<a href="/lol-videos">LOL Videos</a>
			<a href="/trivia">Trivia</a>
        ...
        <br>
		<div class="footer_optionsHeader"><a href="/popculture">Pop Culture</a></div>
		<div class="footer_options">
			<a href="/tv-series">Τηλεόραση - Σειρές</a>
			<a href="/music">Μουσική</a>
			<a href="/cinema">Σινεμά</a>
			<a href="/paper">Paper</a>
			<a href="/gaming">Gaming</a>
			<a href="/top-of-pop">Videos</a>
		</div>
	...
	<div class="footer hideOnSmallScreen" style="width:12%;">			
		...
		<div class="footer_optionsHeader"><a href="/life">Life</a></div>
		<div class="footer_options">
			<a href="/food">Food</a>
	...
	<div class="footer hideOnSmallScreen" style="width:12%;">
		...
		<div class="footer_optionsHeader"><a href="/agenda">E-Agenda</a></div>
		<div class="footer_options">
			<a href="/agenda/epiloges">Επιλογές</a>
			<a href="/agenda/cinema">Σινεμά</a>
			<a href="/agenda/music">Μουσική</a>
			<a href="/agenda/theater">Θέατρο+Χορός</a>
			<a href="/agenda/arts">Τέχνες</a>
			<a href="/agenda/festival">Φεστιβάλ</a>
			<a href="/agenda/kids">Παιδικά</a>
			<a href="/agenda/nightlife">Nightλάιφ</a>
			<a href="/agenda/citylife">Cityλάιφ</a>
		</div>
       
	</div> 
    
	<div class="footer fullOnSmallScreen" style="width:26%;">
		<div class="footer_optionsHeader">Newsletter</div><br>	
		<style type="text/css">
#ms-sub-form{ margin:0; padding:0 }
#edaily_newsletter_form{ display:table; clear:both; text-align: left; line-height: normal;}

#edaily_newsletter_form .mc-field-group{ display:table; margin:10px 0 10px 0; padding:0; width: 100%}
#edaily_newsletter_form li{ display:block; float:left; margin-top: 12px; width:33.333%; padding:0; font-weight: 400; font-size: 1.25em;}

#edaily_newsletter_form .checkbox {width:22px; height:22px; border:1px solid #e3e3e3; background:#fff; margin:0; padding:0}
#edaily_newsletter_form .checkbox:before {content:""; display:block; width:23px; height:23px; background:transparent url('http://img2-1.timeinc.net/people/static/i/footer/footer-newsletter-sprite.png') 0 0 no-repeat;}
#edaily_newsletter_form .checkbox:checked:before {background:transparent url('http://img2-1.timeinc.net/people/static/i/footer/footer-newsletter-sprite.png') -32px 0 no-repeat;}
#edaily_newsletter_form label {margin-left:5px; padding-top: -5px;}

#edaily_newsletter_form .email{ font-weight:normal; height:45px; width:55%; float:left; display: inline-block;
...
#edaily_newsletter_form .email.focus {color:#000;}
#edaily_newsletter_form .email.placeholder{color:#e3e3e3;}

#edaily_newsletter_form .submit-button { background:#0079ff; text-align:center; float:left; width:30%; height:47px; border:none; font-size:14px; text-transform:uppercase; color:#FFF; letter-spacing:1px; cursor:pointer; display:inline-block; padding-top:6px; margin-left:3px; -webkit-border-radius:3px; -moz-border-radius:3px; border-radius:3px; }
#edaily_newsletter_form .submit-button:hover {background:#2e78b3; text-decoration:none;}

.clearfix{ padding:0; margin:0 }

</style>

<div id="edaily_newsletter_form" class="clearfix">

        <form action="https://app.moosend.com/subscribe/1dedecf4-3788-4aee-a6d7-95505a061e48" method="post" id="ms-sub-form" target="_blank">
			...
			<ul class="mc-field-group input-group">
				<li>
                   	<input type="checkbox" checked="checked" name="ms-Τα νέα της ημέρας" id="Τα νέα της ημέρας" value="true" onchange="document.getElementById('h_Τα νέα της ημέρας').name=(this.checked ? '' : this.name)" /><input id="h_Τα νέα της ημέρας" name="Τα νέα της ημέρας" type="hidden" value="false"  />
					<label for="Τα νέα της ημέρας">Τα νέα της ημέρας</label>
                </li>
                <li>
					<input type="checkbox" checked="checked" name="ms-Ότι σου κάνει κλικ!" id="Ότι σου κάνει κλικ!" value="true" onchange="document.getElementById('h_Ότι σου κάνει κλικ!').name=(this.checked ? '' : this.name)" /><input id="h_Ότι σου κάνει κλικ!" name="Ότι σου κάνει κλικ!" type="hidden" value="false"  />
					<label for="Ότι σου κάνει κλικ!">Ότι σου κάνει κλικ!</label>
                </li>
                <li>
					<input type="checkbox" checked="checked" name="ms-Woman Feed" id="Woman Feed" value="true" onchange="document.getElementById('h_Woman Feed').name=(this.checked ? '' : this.name)" /><input id="h_Woman Feed" name="Woman Feed" type="hidden" value="false"  />
					<label for="Woman Feed">Woman Feed</label>
                </li>
                <li>
                    <input type="checkbox" checked="checked" name="ms-E-Agenda" id="E-Agenda" value="true" onchange="document.getElementById('h_E-Agenda').name=(this.checked ? '' : this.name)" /><input id="h_E-Agenda" name="E-Agenda" type="hidden" value="false"  />
                    <label for="E-Agenda">E-Agenda</label>
                </li>
                <li>
					<input type="checkbox" checked="checked" name="ms-E-Weekly" id="E-Weekly" value="true" onchange="document.getElementById('h_E-Weekly').name=(this.checked ? '' : this.name)" /><input id="h_E-Weekly" name="E-Weekly" type="hidden" value="false"  />
                    <label for="E-Weekly">E-Weekly</label>
                </li>
                <li></li>
			</ul>
			<div class="mc-field-group" style="margin-top:25px;">
				<input type="email" value="" name="ms-email" class="email" placeholder="Συμπληρώστε το email σας" required>
				<input type="submit" class="submit-button" value="ΕΓΓΡΑΦΗ" name="subscribe">
			</div>
		</form>
...
<center>
<div id="footerMain" style="background: #e9ecee; z-index: 10;">
...
<script language="javaScript" type="text/javascript" src="/_js/footer.js?v=2.6"></script>
<script language="javaScript" type="text/javascript" src="/_js/billboard.js?v=2.5"></script>
...
<script async="async" language="javaScript" type="text/javascript" src="//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-551bf8914936f63f"></script>
<script type="text/javascript">
  ...
  ga('send', 'pageview');
	...
	window.ATInternet = {
		onTrackerLoad:function(){
			window.ATTag = new window.ATInternet.Tracker.Tag({log:"logw312",logSSL:"logws1312",site:581865,domain:"ati-host.net"});
...
window.cookieconsent.initialise({
  ...
  "content": {
    "dismiss": "ΟΚ",
    "href": "http://www.e-daily.gr/privacy.asp"
  }
})});
</script>
...
document.write('<scr'+'ipt language="javascript1.1" src="http://adserver.adtech.de/addyn/3.0/1370/6479201/0/16/ADTECH;loc=100;target=_blank;grp='+window.adgroupid+';misc='+new Date().getTime()+'"></scri'+'pt>');
//-->
</script>
<noscript><a href="http://adserver.adtech.de/adlink/3.0/1370/6479201/0/16/ADTECH;loc=300" target="_blank"><img src="http://adserver.adtech.de/adserv/3.0/1370/6479201/0/16/ADTECH;loc=300" border="0" width="1" height="1"></a></noscript>
<div id="5796318"></div>
<script>
ADTECH.config.placements[5796318] = {params: { alias: '', key:'',target: '_blank' }};
ADTECH.loadAd(5796318);
</script>
