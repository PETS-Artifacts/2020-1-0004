...
<link href="/_css/style.css?v=2.85" rel="stylesheet" type="text/css" />
<link href="/_css/newsentries.css?v=2.85" rel="stylesheet" type="text/css" />
<link href="/_css/navigation.css?v=2.85" rel="stylesheet" type="text/css" />

<link href="/_css/mobilemenu.css?v=2.85" rel="stylesheet" type="text/css" media="screen" />
<link href="/_css/structure.css?v=2.86" rel="stylesheet" type="text/css" />
...
<script language="javaScript" type="text/javascript" src="/_js/jquery.ba-throttle-debounce.min.js"></script>
...
<script language="javaScript" type="text/javascript" src="/_js/tools_v2.js?v=2.5"></script>
...
<script type="text/javascript">
    window.cookieconsent_options = {"message":"This website uses cookies to ensure you get the best experience on our website","dismiss":"Got it!","learnMore":"More info","link":"http://www.e-daily.gr/privacy.asp","theme":"light-floating"};
</script>
...
<div id="topHeaderWarper2">
	...
	<li id="tabNews">
		...
		<a href="/news" class="menuTab menuTabWhite1 ">ΕΙΔΗΣΕΙΣ</a>
	</li>
	<li id="tabThemata">
		...
		<a href="/themata" class="menuTab menuTabWhite1 ">ΘΕΜΑΤΑ</a>
	</li>
	<li id="tabViral">
	...
	<li id="tabQuiz">
		<div id="tabQuizMenu" class="menuPanelContainer">
			<a href="/quiz" class="menuTab menuTabWhite2">ΚΟΥΙΖ</a>
		</div>
		<a href="/quiz" class="menuTab menuTabWhite1 ">ΚΟΥΙΖ</a>
	</li>
	<li id="tabLife">
	...
	<li id="tabPopCulture">
		...
		<a href="/popculture" class="menuTab menuTabWhite1 ">POP CULTURE</a>
	</li>
	<li id="tabVideos">
		...
		<a href="/videos" class="menuTab menuTabWhite1 ">VIDEOS</a>
	</li>
	<li id="tabEAgenda">        
		...
		<a href="/agenda" class="menuTab menuTabWhite1 nextwebchannels "><img src="/_img/eagendagr_logo.png" height="20" width="107" /></a>
	</li>
	<li id="extras">
...
<div id="todayTabs" class="tab-container" style=overflow: hidden">
  ...
  <div id="tabs-recent" class="postEntries small">
	...
	<a href="/viral/91544/mystikos-gamos-sthn-patmo-gia-gnwsto-zeygari-hthopoiwn-pics" target="_parent">
        <div class="cropimg absolute-center">
	        <div class="media"><span class="icon-picture"></span></div>
            <img data-src="http://cdn.e-daily.gr/repository/2017/ekklisia920.jpg" alt="Μυστικός γάμος στην Πάτμο για γνωστό ζευγάρι ηθοποιών " border="0" class="lazyload">
        </div>
        <div><span class="category ">TABLOID</span><span class="when">10:06</span></div>
        <h3>Μυστικός γάμος στην Πάτμο για γνωστό ζευγάρι ηθοποιών </h3>
        <h4></h4>
	</a>

	<a href="/viral/91542/oi-dhlwseis-ths-elenhs-rantoy-gia-thn-apistia-poy-tha-syzhththoyn" target="_parent">
        <div class="cropimg absolute-center">
	        
            <img data-src="http://cdn.e-daily.gr/repository/2017/apistia3.jpg" alt="Οι δηλώσεις της Ελένης Ράντου για την απιστία, που θα συζητηθούν" border="0" class="lazyload">
        </div>
        <div><span class="category ">TABLOID</span><span class="when">09:50</span></div>
        <h3>Οι δηλώσεις της Ελένης Ράντου για την απιστία, που θα συζητηθούν</h3>
        <h4></h4>
	</a>

	<a href="/news/91541/kthnwdia-14xronh-viasthke-se-parko-enw-htan-gemato-kosmo-pics" target="_parent">
        <div class="cropimg absolute-center">
	        <div class="media"><span class="icon-picture"></span></div>
            <img data-src="http://cdn.e-daily.gr/repository/2017/parko3003.jpg" alt="Κτηνωδία: 14χρονη βιάστηκε σε πάρκο ενώ ήταν γεμάτο κόσμο" border="0" class="lazyload">
        </div>
        <div><span class="category ">ΚΟΣΜΟΣ</span><span class="when">09:32</span></div>
        <h3>Κτηνωδία: 14χρονη βιάστηκε σε πάρκο ενώ ήταν γεμάτο κόσμο</h3>
        <h4></h4>
	</a>

	<a href="/news/91540/kairos-sta-ypsh-shmera-h-thermokrasia" target="_parent">
        <div class="cropimg absolute-center">
	        
            <img data-src="http://cdn.e-daily.gr/repository/2017/thermokrasia9.jpeg" alt="Καιρός: Στα ύψη σήμερα η θερμοκρασία" border="0" class="lazyload">
        </div>
        <div><span class="category ">ΕΛΛΑΔΑ</span><span class="when">09:23</span></div>
        <h3>Καιρός: Στα ύψη σήμερα η θερμοκρασία</h3>
        <h4></h4>
	</a>

	<a href="/news/91539/meta-thn-irma-nea-apeilh-gia-thn-karaivikh-erxetai-o-tyfwnas-maria" target="_parent">
        <div class="cropimg absolute-center">
	        
            <img data-src="http://cdn.e-daily.gr/repository/2017/uiglhsui.jpg" alt="Μετά την Ίρμα, νέα απειλή για την Καραϊβική έρχεται ο τυφώνας Μαρία" border="0" class="lazyload">
        </div>
        <div><span class="category ">ΕΛΛΑΔΑ</span><span class="when">09:13</span></div>
        <h3>Μετά την Ίρμα, νέα απειλή για την Καραϊβική έρχεται ο τυφώνας Μαρία</h3>
        <h4></h4>
	</a>
  ...
  <div id="tabs-hl" class="postEntries small">
	...
	<a href="http://www.e-daily.gr/popculture/82662/10-rok-star-poy-paradoksws-den-ta-tinaksan-apo-ta-narkwtika-video" target="_blank">
        <div class="cropimg absolute-center">
	        <div class="media"><span class="icon-play"></span></div>
            <img data-src="http://cdn.e-daily.gr/repository/2017/photoozzy.jpg" alt="10 Ροκ Σταρ που παραδόξως δεν τα τίναξαν από τα ναρκωτικά" border="0" class="lazyload">
        </div>
        <div><span class="category ">TOP OF POP</span> <span class="when">17/09</span></div>
        <h3>10 Ροκ Σταρ που παραδόξως δεν τα τίναξαν από τα ναρκωτικά</h3>
        <h4></h4>
	</a>

	<a href="/themata/91497/allazei-mia-lampa-kai-pairnei-mistho-20000-dolaria-video" target="_parent">
        <div class="cropimg absolute-center">
	        <div class="media"><span class="icon-play"></span></div>
            <img data-src="http://cdn.e-daily.gr/repository/2017/allazeilampes.jpg" alt="Αλλάζει μια λάμπα και παίρνει μισθό 20.000 δολάρια" border="0" class="lazyload">
        </div>
        <div><span class="category ">ΚΟΣΜΟΣ</span> <span class="when">18/09</span></div>
        <h3>Αλλάζει μια λάμπα και παίρνει μισθό 20.000 δολάρια</h3>
        <h4></h4>
	</a>

	<a href="/news/91411/ekrhksh-se-stathmo-metro-toy-londinoy-pics-video" target="_parent">
        <div class="cropimg absolute-center">
	        <div class="media"><span class="icon-play"></span></div>
            <img data-src="http://cdn.e-daily.gr/repository/2017/rtrmslond2.jpg" alt="Έκρηξη σε σταθμό μετρό του Λονδίνου" border="0" class="lazyload">
        </div>
        <div><span class="category ">ΚΟΣΜΟΣ</span> <span class="when">15/09</span></div>
        <h3>Έκρηξη σε σταθμό μετρό του Λονδίνου</h3>
        <h4></h4>
	</a>

	<a href="/viral/91513/h-gynaika-mysthrio-toy-kim-giongk-oyn" target="_parent">
        <div class="cropimg absolute-center">
	        
            <img data-src="http://cdn.e-daily.gr/repository/2017/wet23434dasdfs.jpg" alt="Η γυναίκα-μυστήριο του Κιμ Γιονγκ Ουν" border="0" class="lazyload">
        </div>
        <div><span class="category ">ΚΟΣΜΟΣ</span> <span class="when">18/09</span></div>
        <h3>Η γυναίκα-μυστήριο του Κιμ Γιονγκ Ουν</h3>
        <h4></h4>
	</a>

	<a href="/news/91500/o-kwnstantinos-mpogdanos-phre-ekpomph" target="_parent">
        <div class="cropimg absolute-center">
	        
            <img data-src="http://cdn.e-daily.gr/repository/2017/konstantinosbogdanos.jpg" alt="Ο Κωνσταντίνος Μπογδάνος πήρε εκπομπή" border="0" class="lazyload">
        </div>
        <div><span class="category ">MEDIA</span> <span class="when">18/09</span></div>
        <h3>Ο Κωνσταντίνος Μπογδάνος πήρε εκπομπή</h3>
        <h4></h4>
	</a>
...
<div id="topTabs" class="tab-container" style="height:550px; overflow: hidden;">
  ...
  <div id="tabs-news" class="postEntries top">
	...
	<a href="/news/89817/erxetai-dihmero-me-vroxes-kai-kataigides" target="_parent">
        <div class="cropimg absolute-center">
	        
            <img data-src="http://cdn.e-daily.gr/repository/2017/vroxesektaktoskerosgia2meresmainenaagaiena.jpg" alt="Έρχεται διήμερο με βροχές και καταιγίδες " border="0" class="lazyload">
        </div>
        <div><span class="category ">ΕΛΛΑΔΑ</span> <span class="when">28/08</span></div>
        <h3>Έρχεται διήμερο με βροχές και καταιγίδες </h3>
        <h4></h4>
	</a>

	<a href="/news/89869/telos-stis-panelladikes-eksetaseis-opws-tis-gnwrizame" target="_parent">
        <div class="cropimg absolute-center">
	        
            <img data-src="http://cdn.e-daily.gr/repository/2017/ekpaideusi992.jpg" alt="Τέλος στις πανελλαδικές εξετάσεις, όπως τις γνωρίζαμε" border="0" class="lazyload">
        </div>
        <div><span class="category ">ΕΛΛΑΔΑ</span> <span class="when">29/08</span></div>
        <h3>Τέλος στις πανελλαδικές εξετάσεις, όπως τις γνωρίζαμε</h3>
        <h4></h4>
	</a>

	<a href="/news/89881/stegnwse-h-limnh-twn-iwanninwn-pics" target="_parent">
        <div class="cropimg absolute-center">
	        <div class="media"><span class="icon-picture"></span></div>
            <img data-src="http://cdn.e-daily.gr/repository/2017/lakeexo.jpg" alt="«Στέγνωσε» η λίμνη των Ιωαννίνων" border="0" class="lazyload">
        </div>
        <div><span class="category ">ΕΛΛΑΔΑ</span> <span class="when">29/08</span></div>
        <h3>«Στέγνωσε» η λίμνη των Ιωαννίνων</h3>
        <h4></h4>
	</a>

	<a href="/news/89889/ksekinhse-to-skapsimo-gia-to-xameno-thhsayro-sth-tripolh-video" target="_parent">
        <div class="cropimg absolute-center">
	        <div class="media"><span class="icon-play"></span></div>
            <img data-src="http://cdn.e-daily.gr/repository/2017/skapsimo02.jpg" alt="Ξεκίνησε το σκάψιμο για το χαμένο θησαυρό στη Τρίπολη" border="0" class="lazyload">
        </div>
        <div><span class="category ">ΕΛΛΑΔΑ</span> <span class="when">29/08</span></div>
        <h3>Ξεκίνησε το σκάψιμο για το χαμένο θησαυρό στη Τρίπολη</h3>
        <h4></h4>
	</a>

	<a href="/news/89880/vinteo-ntokoymento-prin-th-dolofonia-toyrkoy-paroysiasth-video" target="_parent">
        <div class="cropimg absolute-center">
	        <div class="media"><span class="icon-play"></span></div>
            <img data-src="http://cdn.e-daily.gr/repository/2017/ksenodoxeio003.jpg" alt="Βίντεο ντοκουμέντο πριν τη δολοφονία Τούρκου παρουσιαστή" border="0" class="lazyload">
        </div>
        <div><span class="category ">ΚΟΣΜΟΣ</span> <span class="when">29/08</span></div>
        <h3>Βίντεο ντοκουμέντο πριν τη δολοφονία Τούρκου παρουσιαστή</h3>
        <h4></h4>
	</a>
  ...
  <div id="tabs-themata" class="postEntries top">
	...
	<a href="/themata/88997/san-shmera-h-nyxta-toy-agioy-vartholomaioy-pics" target="_parent">
        <div class="cropimg absolute-center">
	        <div class="media"><span class="icon-picture"></span></div>
            <img data-src="http://cdn.e-daily.gr/repository/2016/Nyxta_Agiou_Vartholomaiou_1.jpg" alt="Σαν σήμερα: Η νύχτα του Αγίου Βαρθολομαίου" border="0" class="lazyload">
        </div>
        <div><span class="category ">ΣΑΝ ΣΗΜΕΡΑ</span> <span class="when">24/08</span></div>
        <h3>Σαν σήμερα: Η νύχτα του Αγίου Βαρθολομαίου</h3>
        <h4></h4>
	</a>

	<a href="/themata/89788/h-24xronh-samprina-pithanotata-na-einai-o-epomenos-ainstain-pics-video" target="_parent">
        <div class="cropimg absolute-center">
	        <div class="media"><span class="icon-play"></span></div>
            <img data-src="http://cdn.e-daily.gr/repository/2017/aenstain123.jpg" alt="Η 24χρονη Σαμπρίνα πιθανότατα να είναι ο επόμενος Αϊνστάιν" border="0" class="lazyload">
        </div>
        <div><span class="category ">ΚΟΣΜΟΣ</span> <span class="when">28/08</span></div>
        <h3>Η 24χρονη Σαμπρίνα πιθανότατα να είναι ο επόμενος Αϊνστάιν</h3>
        <h4></h4>
	</a>

	<a href="/themata/88999/san-shmera-h-ellhnikh-voylh-pshfizei-thn-anagnwrish-ths-ethnikhs-antistashs-pics-video" target="_parent">
        <div class="cropimg absolute-center">
	        <div class="media"><span class="icon-play"></span></div>
            <img data-src="http://cdn.e-daily.gr/repository/2017/ethniki_antistash_1.jpg" alt="Σαν σήμερα: Η ελληνική Βουλή ψηφίζει την αναγνώριση της Εθνικής Αντίστασης" border="0" class="lazyload">
        </div>
        <div><span class="category ">ΣΑΝ ΣΗΜΕΡΑ</span> <span class="when">23/08</span></div>
        <h3>Σαν σήμερα: Η ελληνική Βουλή ψηφίζει την αναγνώριση της Εθνικής Αντίστασης</h3>
        <h4></h4>
	</a>

	<a href="/themata/89638/17-yles-pio-akrives-kai-apo-xryso-pics" target="_parent">
        <div class="cropimg absolute-center">
	        <div class="media"><span class="icon-picture"></span></div>
            <img data-src="http://cdn.e-daily.gr/repository/2017/erewtqergdfgc.jpg" alt="17 ύλες πιο ακριβές και από χρυσό" border="0" class="lazyload">
        </div>
        <div><span class="category ">ΕΠΙΣΤΗΜΗ</span> <span class="when">25/08</span></div>
        <h3>17 ύλες πιο ακριβές και από χρυσό</h3>
        <h4></h4>
	</a>

	<a href="/themata/89842/san-shmera-termatizetai-o-emfylios-polemos-sthn-ellada-pics" target="_parent">
        <div class="cropimg absolute-center">
	        <div class="media"><span class="icon-picture"></span></div>
            <img data-src="http://cdn.e-daily.gr/repository/2017/emfylios_1.jpg" alt="Σαν σήμερα: Τερματίζεται ο Εμφύλιος Πόλεμος στην Ελλάδα" border="0" class="lazyload">
        </div>
        <div><span class="category ">ΣΑΝ ΣΗΜΕΡΑ</span> <span class="when">29/08</span></div>
        <h3>Σαν σήμερα: Τερματίζεται ο Εμφύλιος Πόλεμος στην Ελλάδα</h3>
        <h4></h4>
	</a>
  ...
  <div id="tabs-life" class="postEntries top">
	...
	<a href="/life/89534/ayth-einai-h-tash-sth-moda-poy-erxetai-to-fthinopwro-kai-tha-th-deite-pantoy-pics" target="_parent">
        <div class="cropimg absolute-center">
	        <div class="media"><span class="icon-picture"></span></div>
            <img data-src="http://cdn.e-daily.gr/repository/2017/neamodaoversized.jpg" alt="Αυτή είναι η τάση στη μόδα που έρχεται το φθινόπωρο και θα τη δείτε παντού" border="0" class="lazyload">
        </div>
        <div><span class="category ">STYLE</span> <span class="when">28/08</span></div>
        <h3>Αυτή είναι η τάση στη μόδα που έρχεται το φθινόπωρο και θα τη δείτε παντού</h3>
        <h4></h4>
	</a>

	<a href="http://www.e-daily.gr/life/89313/poia-trends-toy-2017-tha-fygoyn-me-to-poy-teleiwsei-h-xronia-pics" target="_blank">
        <div class="cropimg absolute-center">
	        <div class="media"><span class="icon-picture"></span></div>
            <img data-src="http://cdn.e-daily.gr/repository/2017/trebsjfs.jpg" alt="Ποια trends του 2017 θα φύγουν με το που τελειώσει η χρονιά" border="0" class="lazyload">
        </div>
        <div><span class="category ">STYLE</span> <span class="when">26/08</span></div>
        <h3>Ποια trends του 2017 θα φύγουν με το που τελειώσει η χρονιά</h3>
        <h4></h4>
	</a>

	<a href="http://www.e-daily.gr/life/89590/5-diaites-gia-na-xasete-kila-meta-tis-diakopes-list" target="_blank">
        <div class="cropimg absolute-center">
	        <div class="media"><span class="icon-th-list"></span></div>
            <img data-src="http://cdn.e-daily.gr/repository/2017/diaitai42.jpg" alt="5 δίαιτες για να χάσετε κιλά μετά τις διακοπές" border="0" class="lazyload">
        </div>
        <div><span class="category ">FOOD</span> <span class="when">27/08</span></div>
        <h3>5 δίαιτες για να χάσετε κιλά μετά τις διακοπές</h3>
        <h4></h4>
	</a>

	<a href="/life/89793/de-tha-pistepsete-poioi-einai-oi-kalyteroi-tropoi-gia-na-diathrhsete-neo-to-myalo-sas" target="_parent">
        <div class="cropimg absolute-center">
	        
            <img data-src="http://cdn.e-daily.gr/repository/2017/mina899.jpg" alt="Δε θα πιστέψετε ποιοι είναι οι καλύτεροι τρόποι για να διατηρήσετε νέο το μυαλό σας" border="0" class="lazyload">
        </div>
        <div><span class="category ">BODY+MIND</span> <span class="when">28/08</span></div>
        <h3>Δε θα πιστέψετε ποιοι είναι οι καλύτεροι τρόποι για να διατηρήσετε νέο το μυαλό σας</h3>
        <h4></h4>
	</a>

	<a href="/life/89838/h-episthmh-milhse-aytos-einai-o-mesos-oros-seksoyalikwn-syntrofwn-toy-anthrwpoy" target="_parent">
        <div class="cropimg absolute-center">
	        
            <img data-src="http://cdn.e-daily.gr/repository/2017/sintrof561.jpg" alt="Η επιστήμη μίλησε: Αυτός είναι ο μέσος όρος σeξουαλικών συντρόφων του ανθρώπου" border="0" class="lazyload">
        </div>
        <div><span class="category ">ΣΧΕΣΕΙΣ</span> <span class="when">28/08</span></div>
        <h3>Η επιστήμη μίλησε: Αυτός είναι ο μέσος όρος σeξουαλικών συντρόφων του ανθρώπου</h3>
        <h4></h4>
	</a>
  ...
  <div id="tabs-viral" class="postEntries top">
	...
	<a href="/viral/89796/larisa-h-vaftish-poy-afhse-epoxh-logw-ths-idiaiterhs-diakosmhshs-ths-pics" target="_parent">
        <div class="cropimg absolute-center">
	        <div class="media"><span class="icon-picture"></span></div>
            <img data-src="http://cdn.e-daily.gr/repository/2017/vaptism45.jpg" alt="Λάρισα: Η βάφτιση που άφησε εποχή λόγω της... ιδιαίτερης διακόσμησης της" border="0" class="lazyload">
        </div>
        <div><span class="category ">ΕΛΛΑΔΑ</span> <span class="when">28/08</span></div>
        <h3>Λάρισα: Η βάφτιση που άφησε εποχή λόγω της... ιδιαίτερης διακόσμησης της</h3>
        <h4></h4>
	</a>

	<a href="/viral/89696/deite-ti-allazei-stis-tavernes-allazontas-gia-panta-to-ellhniko-tavernaki-pics" target="_parent">
        <div class="cropimg absolute-center">
	        <div class="media"><span class="icon-picture"></span></div>
            <img data-src="http://cdn.e-daily.gr/repository/2017/ladi3993.jpg" alt="Δείτε τι αλλάζει στις ταβέρνες αλλάζοντας για πάντα το ελληνικό ταβερνάκι" border="0" class="lazyload">
        </div>
        <div><span class="category ">ΠΑΡΑΞΕΝΑ</span> <span class="when">28/08</span></div>
        <h3>Δείτε τι αλλάζει στις ταβέρνες αλλάζοντας για πάντα το ελληνικό ταβερνάκι</h3>
        <h4></h4>
	</a>

	<a href="/viral/89792/vinteo-sok-zeygari-kanei-seks-se-stathmo-trenoy-sto-londino-pics-video" target="_parent">
        <div class="cropimg absolute-center">
	        <div class="media"><span class="icon-play"></span></div>
            <img data-src="http://cdn.e-daily.gr/repository/2017/lond89.jpg" alt="Βίντεο - σοκ: Ζευγάρι κάνει σeξ σε σταθμό τρένου στο Λονδίνο" border="0" class="lazyload">
        </div>
        <div><span class="category ">ΚΟΣΜΟΣ</span> <span class="when">28/08</span></div>
        <h3>Βίντεο - σοκ: Ζευγάρι κάνει σeξ σε σταθμό τρένου στο Λονδίνο</h3>
        <h4></h4>
	</a>

	<a href="/viral/89834/aplhsiasto-oneiro-tha-einai-gia-ton-kosmo-to-iphone-8-tetrapshfia-fhmologeitai-h-timh-toy" target="_parent">
        <div class="cropimg absolute-center">
	        
            <img data-src="http://cdn.e-daily.gr/repository/2017/iphon891.jpg" alt="Απλησίαστο όνειρο θα είναι για τον κόσμο το iPhone 8 -  Τετραψήφια φημολογείται η τιμή του" border="0" class="lazyload">
        </div>
        <div><span class="category ">ΚΟΣΜΟΣ</span> <span class="when">29/08</span></div>
        <h3>Απλησίαστο όνειρο θα είναι για τον κόσμο το iPhone 8 -  Τετραψήφια φημολογείται η τιμή του</h3>
        <h4></h4>
	</a>

	<a href="/viral/89761/to-thriamveytiko-antio-toy-floyd-mayweather-ekane-to-50-0-sthn-kariera-toy" target="_parent">
        <div class="cropimg absolute-center">
	        
            <img data-src="http://cdn.e-daily.gr<p style="text-align: center;"><img src="/repository/2017/mayweath23.jpg"></p>" alt="Το θριαμβευτικό αντίο του Floyd Mayweather - Έκανε το 50-0 στην καριέρα του!" border="0" class="lazyload">
        </div>
        <div><span class="category ">ΚΟΣΜΟΣ</span> <span class="when">27/08</span></div>
        <h3>Το θριαμβευτικό αντίο του Floyd Mayweather - Έκανε το 50-0 στην καριέρα του!</h3>
        <h4></h4>
	</a>
