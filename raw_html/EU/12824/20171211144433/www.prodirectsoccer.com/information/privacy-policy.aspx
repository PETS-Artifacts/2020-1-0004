...
-->
    ...
    <!-- style sheets -->
    <link href="/bundles/styles.css?v=XiTvTgqfiCz_7_Ls8S5VUPJpgNEMrSKS5yIcqTvSRPI1" rel="stylesheet"/>
    ...
    <!-- scripts -->
    <script src="/bundles/scripts.js?v=s7DqMHK-j9px91L2YctHoeo_K1rVxlr7OxTRo4w0xdg1"></script>
<script>
...
<body>
    ...
    <!-- End Google Tag Manager -->
    <div id="page" class="christmas">
        
        
<div id="cookie" data-cookie="Mon, 18 Dec 2017 14:44:33 GMT">
    <div class="inner">
    ...
    <div class="mobile-menu-holder">
        ...
        <div class="mobile-menu">
            <ul>
                ...
                <li class="first-level"><a style="background-color: #c7a46a;" href="/information/christmas-delivery.aspx">CHRISTMAS DELIVERY</a></li>
                <li class="first-level"><a style="background-color: #c7a46a;"  href="/christmas.aspx">Christmas Gift Guide</a></li>
                ...
                <div class="drop-down">
                    <div class="inner">
                        ...
                        <div class="block">
                            ...
                            <ul class="sub-menu">
                                <li><a href="/lists/adidas-football-boots.aspx?silo=Predator">adidas Predator</a></li>
