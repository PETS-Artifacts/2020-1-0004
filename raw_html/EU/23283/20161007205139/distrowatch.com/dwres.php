      ...
      <table style="width: 468px">
        ...
        <tr>
          <td style="border: 0px; width: 230px; text-align: center">
            ...
            <input style="width: 160px; font-size: 10px"; type="text" name="distribution" value="ادخل اسم التوزيعة" onfocus="value=''" maxlength="36" />
            <input style="width: 50px" type="submit" value="انطلق" />
            </form>
          </td>
          <td style="border: 0px; width: 230px; text-align: center">
            <form style="height: 1%" action="table.php" method="get">
            <select style="width: 160px" name="distribution" onchange="location = this.options[this.selectedIndex].value;">
<option selected value="">اختيار التوزيعة</option>
...
<form action="//distrowatch.com/" id="cse-search-box">
  <div style="text-align: center">
    ...
    <input style="width: 50px" type="submit" name="sa" value="انطلق" />
  </div>
</form>
<script type="text/javascript" src="//www.google.com/cse/brand?form=cse-search-box&amp;lang=en"></script>
          ...
          <td style="border: 0px; width: 230px; text-align: center">
            ...
            <input style="width: 214px; vertical-align: top" type="submit" value="توزيعة عشوائية" />
            </form>
          </td>
        </tr>
      </table>    </td>
