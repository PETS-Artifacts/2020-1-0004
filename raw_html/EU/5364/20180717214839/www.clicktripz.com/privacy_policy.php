		...
		<html class="no-js" lang="en">
			<head>
				...
				<link rel="stylesheet" href="http://static.clicktripz.com/home/stylesheets/app.css?v=1.05" />
...
<body>
    ...
    <div class="row">
        <div class="medium-12 columns">
            ...
            <p>Cookies are alphanumeric identifiers that we transfer to your computer’s hard drive through your web browser to enable our systems to recognize your browser and to provide certain features. The Help portion of the toolbar on most browsers will tell you how to prevent your browser from accepting new cookies, how to have the browser notify you when you receive a new cookie, or how to disable cookies altogether. Clicktripz collects and processes user's travel criteria, including through the use of cookies, to provide relevant offers from partnering travel websites around the web.</p>
