		...
		<html class="no-js" lang="en">
			<head>
		    	...
		    	<link rel="shortcut icon" type="image/ico" href="https://static.clicktripz.com/images/favicon.ico" />
				<link rel="stylesheet" href="https://static.clicktripz.com/home/stylesheets/app.css?v=1.04" />
				<script src="https://static.clicktripz.com/home/bower_components/modernizr/modernizr.js"></script>
				<script>
...
<body>
    ...
    <div class="row">
      ...
      <form action="https://www.clicktripz.com/home/mailer.php" method="POST" id="contact" name="contact">
        ...
        <div class="row">
            <div class="large-12 columns">
                <p>For our conversion booster program, we are currently accepting all hotel brands of ANY size. For all other monetization tools, at this time, we are only accepting sites with monthly unique visitors in excess of 200,000.</p>
            </div>
        </div>
