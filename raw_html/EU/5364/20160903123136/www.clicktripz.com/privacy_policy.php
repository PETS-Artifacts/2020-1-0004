          ...
          <footer>
            <div class="row">
              <div class="medium-6 columns text-left small-only-text-center">
                ...
                <p class="shim-down-2">&copy 2016, Clicktripz. <a href="/privacy_policy.php" title="Privacy Policy">Privacy Policy</a>.</p>
              </div>
