...
.hide,.code-style,.box-size,.bottom-link,.footer,.code-style,.snippets,.report-error,.badge,.social,.mobile-only{display:none}
.skyscraper{width:160px;height:600px;overflow:hidden;margin-bottom:20px;background:#ebecf0}
.bottom-ad{margin-top:30px;padding:24px;background:url(/lib/images/smooth-line.png) no-repeat center #f9f9f9}
...
.bottom-ad{height:auto;background:none;padding:32px 0 0;margin:37px 0 0;text-align:center;position:relative}
...
.leaderboard{margin:15px 0 30px}
h1{font-size:28px}
h2{font-size:24px}
h3{font-size:20px}
}
