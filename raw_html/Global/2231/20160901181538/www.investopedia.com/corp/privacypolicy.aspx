...
<link rel="shortcut icon" href="http://i.investopedia.com/public/img/favicon.ico" type="image/vnd.microsoft.icon" />
          ...
          <link rel="stylesheet" type="text/css" href="http://i.investopedia.com/public/css/tablet.css?v=5.412"/>
  ...
  <!-- End Page Taxonomy -->    <!-- Eof Taxonomy -->
    ...
    <script language="javascript" type="text/javascript" src="http://i.investopedia.com/dest/js/inv.min.js?v=5.412"></script>
            <script language="javascript" type="text/javascript" src="http://i.investopedia.com/public/js/main.min.js?v=5.412"></script>
        <script language="javascript" type="text/javascript">
        var noDfp = false;
        var ecLayout = false;
...
<script type="text/javascript">
  ...
  dataLayer.push({
    ...
    <script language="javascript" type="text/javascript" src="http://i.investopedia.com/public/js/streamsense.min.js?v=5.412"></script>
...
<!-- Current time is: 09/01/2016 12:15:38 pm -->
                    ...
                    <div class="inner page-width">
                      ...
                      <div class="col new" style="width:35%;">
                        <div class="title">What's New</div>
                                                  <a href="/news/spacex-rocket-explodes-during-test-fb-tsla/" class="article new">
                            <img src="http://i.investopedia.com/content/daily_blog/spacex_rocket_explod/shutterstock_375998050_spacex_musk_tesla.jpg?quality=60&width=200&height=200">
                            <span class="article-title">SpaceX Rocket Explodes During Test</span>
                          </a>
                                                    <a href="/news/british-manufacturing-shrugs-brexit-now/" class="article new">
                            <img src="http://i.investopedia.com/content/daily_blog/british_manufacturin/shutterstock_338831222_brexit.jpg?quality=60&width=200&height=200">
                            <span class="article-title">British Manufacturing Shrugs off Brexit, For Now</span>
                          </a>
                                                </div
                  ...
                  <div class="menu-panel">
                    <div class="inner page-width">
                      ...
                      <div class="col tod" style="width:30%;">
                        ...
                        <a href="/terms/l/lifelearningcredit.asp" class="tod-term">
                          <div class="term-title">Lifetime Learning Credit</div>
                          <div class="term-desc">A provision of the U.S. federal income tax code that lets parents and students lower ... </div>
                          <div class="term-btn">Read More &raquo;</div>
                        </a>
                      </div
                      ><div class="col video" style="width:30%;">
                        <a class="title" href="/video/">Latest Videos</a>
                                                  <a href="/video/play/evolution-everything-pages/" class="article video">
                            <img src="http://i.investopedia.com/content/video/the_evolution_of_eve/pages_evolution.png?width=200&height=200">
                            <span class="article-title">The Evolution of Everything: PAGES</span>
                          </a>
                                                    <a href="/video/play/whats-bear-market-investotrivia/" class="article video">
                            <img src="http://i.investopedia.com/content/video/whats_a_bear_market/bearmarket.png?width=200&height=200">
                            <span class="article-title">What's a Bear Market? InvestoTrivia</span>
                          </a>
                                                </div
...
<input type="submit" id="edit-submit" name="op" value="Search" class="form-submit" /></div><input type="hidden" name="form_build_id" value="form-qRMFuPm_8OikUBHYHMBZeWPESjiVQZJoaAJM0haYHTk" />
