...
<head profile="http://www.w3.org/1999/xhtml/vocab">
	...
	</script>    <script data-id="script_async_bidder" type="text/javascript">
    "use strict";
    var isDesktop = true;
        var adStart = Date.now(),
        OX_dfp_ads,
        attachScriptAsync, targetingComplete, oxDone, gptCallIntiated = false,
        completedTargeting = {},
        gptApp = gptApp || {},
        isVideoOnPage = "",
        isVideoAutoPlay = "",
...
<link rel="shortcut icon" href="http://i.investopedia.com/public/img/favicon.ico" type="image/vnd.microsoft.icon" />
          ...
          <link rel="stylesheet" type="text/css" href="http://i.investopedia.com/public/css/tablet.css?v=5.339"/>
  ...
  <!-- End Page Taxonomy -->	<!-- Eof Taxonomy -->
    ...
    <!--js start-->
    <script language="javascript" type="text/javascript" src="http://i.investopedia.com/public/js/jquery.min.js?v=5.339"></script>
            <script language="javascript" type="text/javascript" src="http://i.investopedia.com/public/js/main.min.js?v=5.339"></script>
    

    <script data-id="script_optimizely" src="//cdn.optimizely.com/js/3135740712.js"></script>
    <script language="javascript" type="text/javascript" src="http://i.investopedia.com/public/js/streamsense.min.js?v=5.339"></script>
...
<!-- Current time is: 01/01/2016 08:56:35 pm -->
...
<input type="submit" id="edit-submit" name="op" value="Search" class="form-submit" /></div><input type="hidden" name="form_build_id" value="form--F_1ux5gF2l5dbGQ2WP6xswhKLi9EGl7Ther5RuJk-g" />
...
<input type="submit" id="edit-submit--2" name="op" value="Search" class="form-submit" /></div><input type="hidden" name="form_build_id" value="form-ZTQvjDi0m0g21aTXWna72cet7UidIw7OWt2SFIJKWP0" />
<input type="hidden" name="form_id" value="market_api_form" />
</div></form>        </span>
    </div>
        ...
        <ul class="menulist">
            ...
            <li class="MenuMarkets">
                    ...
                    <ul class="sub-menulist layout-size clear">
                                                                                ...
                                                                                <li><a href="http://investopedia.ar.wilink.com"><img class="nav-FARL-1" src="http://i.investopedia.com/public/img/precision-ir-nav-icon.gif" alt="Free Annual Reports Logo" /><img class="nav-FARL-2" src="http://i.investopedia.com/public/img/logo_precision.png" alt="Free Annual Reports Logo" /> Free Annual Reports</a></li>
                                            </ul>
                </div>
                    </li>
...
<input type="submit" id="edit-submit--3" name="op" value="Search" class="form-submit" /></div><input type="hidden" name="form_build_id" value="form-jtRAVmErvXQeRfMpoleBiJ_4sOYSKLWBywZiBaLyVNc" />
<input type="hidden" name="form_id" value="market_api_form" />
</div></form>        </div>
    </div>
</div>                </div>
                ...
                <div class="column-list clear">
                    <div class="col-l">
                        <ul>
                            ...
                            <li><a href="http://investopedia.ar.wilink.com/" rel="nofollow"><img alt="" src="http://i.investopedia.com/public/img/logo_precision.png">Free Annual Reports</a></li>
