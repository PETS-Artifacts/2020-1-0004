...
<link rel="shortcut icon" href="http://i.investopedia.com/public/img/favicon.ico" type="image/vnd.microsoft.icon" />
          ...
          <link rel="stylesheet" type="text/css" href="http://i.investopedia.com/public/css/tablet.css?v=5.405"/>
  ...
  <!-- End Page Taxonomy -->    <!-- Eof Taxonomy -->
    ...
    <script language="javascript" type="text/javascript" src="http://i.investopedia.com/dest/js/inv.min.js?v=5.405"></script>
            <script language="javascript" type="text/javascript" src="http://i.investopedia.com/public/js/main.min.js?v=5.405"></script>
        <script language="javascript" type="text/javascript">
        var noDfp = false;
        var ecLayout = false;
        ...
        if (window.location.hash.substring(0, 3) === "#ec") {
            ...
            setCookie('AdViewed', '1', { expires: invCookieExpires, path: '/', domain: host });
                ...
                if (window.location.hash === "#ra" || window.location.href.endsWith("/anxiety-index/")) {
            noDfp = true;
            ecLayout = false;
        }
    </script>
    <script type="text/javascript" src="https://ajax.googleapis.com/ajax/libs/jquery/1.4.4/jquery.min.js"></script>
<script type="text/javascript" src="http://i.investopedia.com/misc/jquery.once.js"></script>
<script type="text/javascript" src="http://i.investopedia.com/misc/drupal.js"></script>
<script type="text/javascript">
<!--//--><![CDATA[//><!--
jQuery.extend(Drupal.settings, {"basePath":"\/","pathPrefix":"","ajaxPageState":{"theme":"deepblue","theme_token":"HnsTZFEt7f6eHxLAmGrpLDAy1lSQtyVTXVAERVjV9Io","js":{"https:\/\/ajax.googleapis.com\/ajax\/libs\/jquery\/1.4.4\/jquery.min.js":1,"misc\/jquery.once.js":1,"misc\/drupal.js":1},"css":{"sites\/all\/modules\/ldap\/ldap_servers\/ldap_servers.admin.css":1}}});
//--><!]]>
</script>
    <script language="javascript" type="text/javascript">
...
<script type="text/javascript">
  ...
  dataLayer.push({
    ...
    <script language="javascript" type="text/javascript" src="http://i.investopedia.com/public/js/streamsense.min.js?v=5.405"></script>
...
<!-- Current time is: 08/11/2016 09:45:06 pm -->
                    ...
                    <div class="inner page-width">
                      ...
                      <div class="col new" style="width:35%;">
                        <div class="title">What's New</div>
                                                  <a href="/news/hillary-clintons-economic-speech/" class="article new">
                            <img src="http://i.investopedia.com/content/homepage_news_allnew/shutterstock_448638568_hillary_clinton.jpg?quality=60&width=200&height=200">
                            <span class="article-title">Clinton Pillories Trump Tax Plan in Economy Speech</span>
                          </a>
                                                    <a href="/news/nassim-taleb-believes-market-crash-horizon/" class="article new">
                            <img src="http://i.investopedia.com/content/daily_blog/nassim_taleb_believe/shutterstock_371470147.jpg?quality=60&width=200&height=200">
                            <span class="article-title">Nassim Taleb Believes Market Crash on Horizon </span>
                          </a>
                                                </div
                  ...
                  <div class="menu-panel">
                    <div class="inner page-width">
                      ...
                      <div class="col tod" style="width:30%;">
                        ...
                        <a href="/terms/s/sovereign-debt.asp" class="tod-term">
                          <div class="term-title">Sovereign Debt</div>
                          <div class="term-desc">Bonds issued by a national government in a foreign currency, in order to finance ... </div>
                          <div class="term-btn">Read More &raquo;</div>
                        </a>
                      </div
                      ><div class="col video" style="width:30%;">
                        <a class="title" href="/video/">Latest Videos</a>
                                                  <a href="/video/play/peter-mackey-influence/" class="article video">
                            <img src="http://i.investopedia.com/content/video/peter_mackey_influe/peter_mackey_influence.jpg?quality=60&width=200&height=200">
                            <span class="article-title">Peter Mackey: Influence</span>
                          </a>
                                                    <a href="/video/play/optionality-my-favorite-term/" class="article video">
                            <img src="http://i.investopedia.com/content/video/optionality_my_favo/optionality.png?width=200&height=200">
                            <span class="article-title">Optionality: My Favorite Term</span>
                          </a>
                                                </div
        ...
        ><div class="secondary"><div class="menu search">
          ...
          ><div class="menu member">
            ...
            <ul class="menu-items">
              ...
              <li>
                <a href="/advisor-network/login/" rel="nofollow" class="menu-item-title">Advisor Log In</a>
              </li>
            </ul>
          </div>
        </div>
...
<input type="submit" id="edit-submit" name="op" value="Search" class="form-submit" /></div><input type="hidden" name="form_build_id" value="form-1r3UFW8-YGhjdKkuaoP2hstaE9O7GhLkv6G2hAjz4JQ" />
<input type="hidden" name="form_id" value="market_api_form" />
                ...
                <div class="column-list clear">
                    ...
                    <div class="col-r">
                        ...
                        <a target="_blank" title="Go to the Investopedia Facebook Page." href="http://www.facebook.com/Investopedia" class="footicon fb"></a>
                        <a target="_blank" title="Go to the Investopedia Twitter Page." href="http://twitter.com/#!/investopedia" class="footicon twtr"></a>
                        <a target="_blank" title="Go to the Investopedia LinkedIn Page." href="http://www.linkedin.com/company/investopedia-ulc" class="icon lnkd"></a>
                        <a title="Subscribe to Investopedia RSS news feeds here." href="/rss/" class="footicon rss"></a>
                        <a target="_blank" title="Go to the Investopedia Stocktwits Page." class="icon-st" href="http://stocktwits.com/investopedia"></a>
                        <a target="_blank" title="Go to the Investopedia YouTube Page." class="icon-youtube" href="https://www.youtube.com/user/investopediacom"></a>
                    </div>
                </div>
