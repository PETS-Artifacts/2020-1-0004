				...
				function tryWelcomeAd()
		{
			...
			function isWelcomeAdEnabled() {
					...
					return false;
								...
								if( isUsTraffic() && false) {
					return true;
				}

								if( document.referrer == null || document.referrer == "" || getUrlParam('utm_medium') == 'email' ) {
					...
					invGCookie.countryMap = {
						...
						"SE" : true, "CH" : true,
						"GB" : true };
					if ( invGCookie.geoIsInCountryMap() == null ) {
			...
			function isTaxonomyAllowed()
			{
				...
				if (_pageTaxonomy["Type"].toLowerCase() == "corp") return false;

				return true;
			}

			function isOptActive() {
				if (typeof optimizely.activeExperiments !== "undefined") {
...
<script data-id="script_async_bidder" type="text/javascript">
    ...
    gptApp.displaySlots = function() {
        ...
        var _displaySlots = function() {
            ...
            if (!isVideoOnPage || (isVideoOnPage && !isVideoAutoPlay) ) {
                googletag.pubads().refresh(deferredR);
            }
        };

        var _deferredSlots = function() {
            for (var d = 0; d < deferredR.length; d++) {
                if (deferredR[d].isCompanion) {
                    if (isVideoOnPage) {
                        if (isVideoAutoPlay) {
                            if (!disableCompanions) {
                                continue;
                            }
                        }
                    }
                }
                googletag.pubads().refresh([deferredR[d]]);
            }
        };

        var refreshAdsAfterVideoAd = function () {
            jwplayer().on("adImpression", function(e) {
                if ("adsystem" in e && typeof validAdSystems[e.adsystem] !== "boolean" ) {
                    disableCompanions = true;
                }
                rF();
            });
        ...
        if (isVideoOnPage
            ...
            var pubAdsTimeoutId = setTimeout(function() {
                disableCompanions = true;
                rF();
            }, 5000);
...
<link rel="shortcut icon" href="http://i.investopedia.com/public/img/favicon.ico" type="image/vnd.microsoft.icon" />
          ...
          <link rel="stylesheet" type="text/css" href="http://i.investopedia.com/public/css/tablet.css?v=5.374"/>
  ...
  <!-- End Page Taxonomy -->	<!-- Eof Taxonomy -->
    ...
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/1.7.2/jquery.min.js"></script>
            <script language="javascript" type="text/javascript" src="http://i.investopedia.com/public/js/main.min.js?v=5.374"></script>
    
      <script>
    var initLayer = _pageTaxonomy;
    initLayer['country'] = invGCookie.geoCountry();
    initLayer['state'] = invGCookie.geoStateProvince();
    initLayer['asset_version'] = '5.374';
    dataLayer = [initLayer];
  </script>

    <script data-id="script_optimizely" src="//cdn.optimizely.com/js/3135740712.js"></script>
    <script language="javascript" type="text/javascript" src="http://i.investopedia.com/public/js/streamsense.min.js?v=5.374"></script>
...
<!-- Current time is: 05/17/2016 12:36:29 am -->
      ...
      ><div class="menus">
                    ...
                    <div class="inner page-width">
                      ...
                      <div class="col new" style="width:35%;">
                        <div class="title">What's New</div>
                                                  <a href="/articles/markets/051616/how-long-can-oil-stay-50-barrel-gs.asp" class="article new">
                            <img src="http://i.investopedia.com/content/daily_blog/how_long_can_oil_sta/1thinkstockphotos465305891.jpg?quality=60&width=200&height=200">
                            <span class="article-title">How Long Can Oil Stay at $50 per Barrel?</span>
                          </a>
                                                    <a href="/articles/insights/051616/buffett-and-icahns-take-apple-aapl.asp" class="article new">
                            <img src="http://i.investopedia.com/content/daily_blog/buffett_v_ichan_who/thinkstockphotos101563575.jpg?quality=60&width=200&height=200">
                            <span class="article-title">Buffett and Ichan&#039;s Take on Apple </span>
                          </a>
                                                </div
                  ...
                  <div class="menu-panel">
                    <div class="inner page-width">
                      ...
                      <div class="col tod" style="width:30%;">
                        ...
                        <a href="/terms/m/magna-cum-laude.asp" class="tod-term">
                          <div class="term-title">Magna Cum Laude</div>
                          <div class="term-desc">An academic level of distinction used by educational institutions to signify an academic ... </div>
                          <div class="term-btn">Read More &raquo;</div>
                        </a>
                      </div
                      ><div class="col video" style="width:30%;">
                        <a class="title" href="/video/">Latest Videos</a>
                                                  <a href="/video/play/how-are-futures-used-hedge-position/" class="article video">
                            <img src="http://i.investopedia.com/content/video/how_are_futures_used/howarefuturesusedtohedgeaposition.png?width=200&height=200">
                            <span class="article-title">How Are Futures Used To Hedge A Position?</span>
                          </a>
                                                    <a href="/video/play/what-are-differences-among-real-estate-agent-broker-and-realtor/" class="article video">
                            <img src="http://i.investopedia.com/content/video/what_are_the_differe/screen_shot_20160516_at_11.11.54_am.png?width=200&height=200">
                            <span class="article-title">What Are The Differences Among A Real Estate Agent, A Broker And A Realtor?</span>
                          </a>
                                                </div
        ...
        ><div class="secondary"><div class="menu search">
          ...
          ><div class="menu newsletters">
            <a href="/accounts/signupnewsletter/?subid=header&source=header" class="menu-icon"><span class="icon-txt">Newsletters</span></a>
          </div
...
<input type="submit" id="edit-submit" name="op" value="Search" class="form-submit" /></div><input type="hidden" name="form_build_id" value="form-zZTNzoZrCCEZCh3VIAtnr3eMOnJMej-Rb_3fdLH9PUI" />
                ...
                <div class="column-list clear">
                    ...
                    <div class="col-r">
                        <ul class="menu-items">
                            ...
                            <li><a href="/accounts/signupnewsletter/?subid=footer&source=footer" class="icon-newsletter">Newsletters</a></li>
                        </ul>
                    </div>
                </div>
            </div>
