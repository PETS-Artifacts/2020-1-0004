...
<link rel="shortcut icon" href="http://i.investopedia.com/public/img/favicon.ico" type="image/vnd.microsoft.icon" />
          ...
          <link rel="stylesheet" type="text/css" href="http://i.investopedia.com/public/css/tablet.css?v=5.366"/>
  ...
  <!-- End Page Taxonomy -->	<!-- Eof Taxonomy -->
    ...
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/1.7.2/jquery.min.js"></script>
            <script language="javascript" type="text/javascript" src="http://i.investopedia.com/public/js/main.min.js?v=5.366"></script>
    
      <script>
    var initLayer = _pageTaxonomy;
    initLayer['country'] = invGCookie.geoCountry();
    initLayer['state'] = invGCookie.geoStateProvince();
    initLayer['asset_version'] = '5.366';
    dataLayer = [initLayer];
  </script>

    <script data-id="script_optimizely" src="//cdn.optimizely.com/js/3135740712.js"></script>
    <script language="javascript" type="text/javascript" src="http://i.investopedia.com/public/js/streamsense.min.js?v=5.366"></script>
...
<!-- Current time is: 04/15/2016 08:10:40 am -->
                    ...
                    <div class="inner page-width">
                      ...
                      <div class="col new" style="width:35%;">
                        <div class="title">What's New</div>
                                                  <a href="/articles/investing/041516/clinton-punishes-sanders-over-wall-street-reform.asp" class="article new">
                            <img src="http://i.investopedia.com/content/deepblue_home_carous/presidential_debate_stage_banner.jpg?quality=60&width=200&height=200">
                            <span class="article-title">Clinton Punishes Sanders Over Wall Street Reform</span>
                          </a>
                                                    <a href="/articles/investing/041516/mcdonalds-discontinues-snack-wraps-mcd.asp" class="article new">
                            <img src="http://i.investopedia.com/content/daily_blog/mcdonalds_discontin/shutterstock_330094487.jpg?quality=60&width=200&height=200">
                            <span class="article-title">McDonald&#039;s Discontinues Snack Wraps</span>
                          </a>
                                                </div
                  ...
                  <div class="menu-panel">
                    <div class="inner page-width">
                      ...
                      <div class="col tod" style="width:30%;">
                        ...
                        <a href="/terms/c/command-economy.asp" class="tod-term">
                          <div class="term-title">Command Economy</div>
                          <div class="term-desc">A system where the government, rather than the free market, determines what goods ... </div>
                          <div class="term-btn">Read More &raquo;</div>
                        </a>
                      </div
                      ><div class="col video" style="width:30%;">
                        <a class="title" href="/video/">Latest Videos</a>
                                                  <a href="/video/play/my-favorite-financial-term-moat/" class="article video">
                            <img src="http://i.investopedia.com/content/video/moat/moatfavterm3.png?width=200&height=200">
                            <span class="article-title">My Favorite Financial Term: Moat</span>
                          </a>
                                                    <a href="/video/play/my-favorite-financial-term-capital-allocation/" class="article video">
                            <img src="http://i.investopedia.com/content/video/capital_allocation/capitalallocation.png?width=200&height=200">
                            <span class="article-title">My Favorite Financial Term: Capital Allocation</span>
                          </a>
                                                </div
...
<input type="submit" id="edit-submit" name="op" value="Search" class="form-submit" /></div><input type="hidden" name="form_build_id" value="form-SJ9tNmZwtswyQpYfV3XVj7pZcPAD_ieu4yEfPZUin68" />
