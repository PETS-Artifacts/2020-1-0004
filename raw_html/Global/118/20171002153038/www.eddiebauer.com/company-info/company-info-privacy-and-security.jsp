...
<link rel="stylesheet" href="/static/css/combined.css?id=7b86327515e9973_1" >
...
<link rel="stylesheet" href="/static/css/combined.css?id=7fa1230a15e9973_1" >
<link rel="stylesheet" href="/static/css/combined.css?id=50572b1915e9973_0"  media="print">
...
<script src="/static/js/combined.js?id=fb2b49ed15e9973_1"></script>
...
<input type="hidden" value="false" id="railBannerFlag"/>
<script>
$(document).ready(function () {
var railBannerFlag = $('#railBannerFlag').val();
//console.log("RailBannerFlag : "+railBannerFlag);
loadHeaderRail("/xhr/freeshipping-sitewide-rail.jsp", "#headContentHolder");
if(railBannerFlag=="false"){
...
<span aria-expanded="false" id="header_signin_create" role="button" class="bold dk-loyal" style="letter-spacing:0.035em;" tabindex="0">SIGN IN / CREATE</span><span aria-hidden="true" class="downArrow">&nbsp;&#9660;</span>
</div>
...
<span class="left"><a tabindex="0" id="shoppingChangeColor"  href="/checkout/bag.jsp" >
BAG
<img id="headBagIcon" role="presentation" src="/static/img/icon_bag.svg" alt="" />
</a></span>
</li>
</ul>
<script>
...
<form id="languageSwitcher" name="languageSwitcher" action="/includes/?_DARGS=/includes/languages.jsp.languageSwitcher" method="post"><input name="_dyncharset" value="UTF-8" type="hidden"></input><input name="_dynSessConf" value="8282711526765546861" type="hidden"></input><input id="locale" name="locale" value="en_US" type="hidden"><input name="_D:locale" value=" " type="hidden"><input name="/atg/userprofiling/ProfileFormHandler.update" value="go" type="hidden"><input name="_D:/atg/userprofiling/ProfileFormHandler.update" value=" " type="hidden"><input name="/atg/userprofiling/ProfileFormHandler.loginErrorURL" value="login.jsp" type="hidden"><input name="_D:/atg/userprofiling/ProfileFormHandler.loginErrorURL" value=" " type="hidden"><input name="/atg/userprofiling/ProfileFormHandler.loginSuccessURL" value="login.jsp" type="hidden"><input name="_D:/atg/userprofiling/ProfileFormHandler.loginSuccessURL" value=" " type="hidden"><input name="_DARGS" value="/includes/languages.jsp.languageSwitcher" type="hidden"></input></form></li>
</ul>
</div>
</div>
...
Gear</a>
<li role="menuitem">
<a id="nav-shopbyactivity" class="" href="#?cm_sp=topnav-_-ShopByActivity-_-main&previousPage=GNAV" aria-controls="flyout-shopbyactivity" aria-expanded="false" aria-owns="flyout-shopbyactivity" aria-haspopup="true">
Shop By Activity</a>
<li role="menuitem">
...
<li role="listitem"><p class="category-focus" aria-level="2">Shop by category</p></li><li><a href="/browse/outerwear/men/_/N-276b?cm_sp=sub-_-Men-_-Outerwear&currentNode=outerwear&tab=men&previousPage=GNAV">Outerwear</a></li><li><a href="/browse/shirts/men/_/N-277c?cm_sp=sub-_-Men-_-Shirts&currentNode=shirts&tab=men&previousPage=GNAV">Shirts</a></li><li><a href="/browse/pants/men/_/N-276h?cm_sp=sub-_-Men-_-Pants&currentNode=pants&tab=men&previousPage=GNAV">Pants</a></li><li><a href="/browse/fleece/men/_/N-27ap?cm_sp=sub-_-Men-_-Fleece&currentNode=fleece&tab=men&previousPage=GNAV">Fleece</a></li><li><a href="/browse/sweaters/men/_/N-2774?cm_sp=sub-_-Men-_-Sweaters&currentNode=sweaters&tab=men&previousPage=GNAV">Sweaters</a></li><li><a href="/browse/sweatshirts---hoodies/men/_/N-2778?cm_sp=sub-_-Men-_-SweatshirtsHoodies&currentNode=sweatshirts---hoodies&tab=men&previousPage=GNAV">Sweatshirts & Hoodies</a></li><li><a href="/browse/baselayers/men/_/N-2767?cm_sp=sub-_-Men-_-Baselayers&currentNode=baselayers&tab=men&previousPage=GNAV">Baselayers</a></li><li><a href="/browse/shorts/men/_/N-276z?cm_sp=sub-_-Men-_-Shorts&currentNode=shorts&tab=men&previousPage=GNAV">Shorts</a></li><li><a href="/browse/jeans/men/_/N-276a?cm_sp=sub-_-Men-_-Jeans&currentNode=jeans&tab=men&previousPage=GNAV">Jeans</a></li><li><a href="/browse/sleepwear/men/_/N-2773?cm_sp=sub-_-Men-_-Sleepwear&currentNode=sleepwear&tab=men&previousPage=GNAV">Sleepwear</a></li><li><a href="/browse/shoes/men/_/N-276q?cm_sp=sub-_-Men-_-Shoes&currentNode=shoes&tab=men&previousPage=GNAV">Shoes</a></li><li><a href="/browse/accessories/men/_/N-26y4?cm_sp=sub-_-Men-_-Accessories&currentNode=accessories&tab=men&previousPage=GNAV">Accessories</a></li><style type="text/css">
...
<div class="f-col left" role="columnheader">
	<ul class="nav-list" role="list">
		...
		<li role="listitem">
			<a href="/campaign/alpine?previouspage=GNAV&amp;cm_sp=topnav-_-men-_-ALPINEKIT1" role="link">Alpine Kit</a></li>
		<li role="listitem">
		...
		<li role="listitem">
			<a href="/campaign/ski?previousPage=GNAV&amp;cm_sp=topnav-_Ski" role="link">Ski Kit</a></li>
		<li role="listitem">
			<a href="/campaign/evertherm?previousPage=GNAV&amp;cm_sp=topnav-_EverTherm" role="link">EverTherm</a></li>
		<li role="listitem">
			<p>
...
<div class="f-col left" role="columnheader">
	<ul class="nav-list" role="list">
		...
		<li role="listitem">
			<a href="/campaign/outfitting-women?cm_sp=topnav-_-women-_-outfits&amp;Previouspage=GNAV" role="link">Shop the Look</a></li>
		<li role="listitem">
			<a href="/campaign/ilariaurbinati?previousPage=GNAV&amp;cm_sp=topnav-_-IlariaLearn_170924" role="link">Ilaria Urbinati Collection</a></li>
		<li role="listitem">
		...
		<li role="listitem">
			<a href="/campaign/alpine?previouspage=GNAV&amp;cm_sp=topnav-_-women-_-ALPINEKIT1" role="link">Alpine Kit</a></li>
		<li role="listitem">
			<a href="/browse/sport-shop/_/N-277n?tab=sport-shop&amp;cm_sp=topnav-_-SportShop-_-main&amp;previousPage=GNAV" role="link">Fishing &amp; Field</a></li>
		<li role="listitem">
			<a href="/campaign/ski?previousPage=GNAV&amp;cm_sp=topnav-_Ski" role="link">Ski Kit</a></li>
		<li role="listitem">
			<a href="/campaign/evertherm?previousPage=GNAV&amp;cm_sp=topnav-_EverTherm" role="link">EverTherm</a></li>
...
<div class="f-col left">
<ul class="nav-list">
<li role="listitem"><p class="category-focus" aria-level="2">Shop By Category</p></li><li><a href="/browse/boys/kids/_/N-275o?cm_sp=sub-_-Kids-_-Boys&currentNode=boys&tab=kids&previousPage=GNAV">Boys</a></li><li><a href="/browse/girls/kids/_/N-275t?cm_sp=sub-_-Kids-_-Girls&currentNode=girls&tab=kids&previousPage=GNAV">Girls</a></li><style type="text/css">
#pdpShare {clear:both;}
.custom-jcarousel-prev, 
...
<div class="f-col left f-sep-dark">
<ul class="nav-list f-sep-light">
<li role="listitem"><p role="heading"><a role="link" href="/browse/men/_/N-1z13xm6Z26y3?Endeca_user_segments=sale&currentNode=men&tab=sale&previousPage=GNAV">Men</a></p></li><li><a href="/browse/outerwear/men/_/N-276bZ1z13xm6?cm_sp=sub-_-Sale-_-Outerwear&currentNode=outerwear&tab=sale&previousPage=GNAV">Outerwear</a></li><li><a href="/browse/shirts/men/_/N-277cZ1z13xm6?cm_sp=sub-_-Sale-_-Shirts&currentNode=shirts&tab=sale&previousPage=GNAV">Shirts</a></li><li><a href="/browse/pants/men/_/N-276hZ1z13xm6?cm_sp=sub-_-Sale-_-Pants&currentNode=pants&tab=sale&previousPage=GNAV">Pants</a></li><li><a href="/browse/fleece/men/_/N-27apZ1z13xm6?cm_sp=sub-_-Sale-_-Fleece&currentNode=fleece&tab=sale&previousPage=GNAV">Fleece</a></li><li><a href="/browse/sweaters/men/_/N-2774Z1z13xm6?cm_sp=sub-_-Sale-_-Sweaters&currentNode=sweaters&tab=sale&previousPage=GNAV">Sweaters</a></li><li><a href="/browse/sweatshirts---hoodies/men/_/N-2778Z1z13xm6?cm_sp=sub-_-Sale-_-SweatshirtsHoodies&currentNode=sweatshirts---hoodies&tab=sale&previousPage=GNAV">Sweatshirts & Hoodies</a></li><li><a href="/browse/baselayers/men/_/N-2767Z1z13xm6?cm_sp=sub-_-Sale-_-Baselayers&currentNode=baselayers&tab=sale&previousPage=GNAV">Baselayers</a></li><li><a href="/browse/shorts/men/_/N-276zZ1z13xm6?cm_sp=sub-_-Sale-_-Shorts&currentNode=shorts&tab=sale&previousPage=GNAV">Shorts</a></li><li><a href="/browse/jeans/men/_/N-276aZ1z13xm6?cm_sp=sub-_-Sale-_-Jeans&currentNode=jeans&tab=sale&previousPage=GNAV">Jeans</a></li><li><a href="/browse/sleepwear/men/_/N-2773Z1z13xm6?cm_sp=sub-_-Sale-_-Sleepwear&currentNode=sleepwear&tab=sale&previousPage=GNAV">Sleepwear</a></li><li><a href="/browse/shoes/men/_/N-276qZ1z13xm6?cm_sp=sub-_-Sale-_-Shoes&currentNode=shoes&tab=sale&previousPage=GNAV">Shoes</a></li><li><a href="/browse/accessories/men/_/N-26y4Z1z13xm6?cm_sp=sub-_-Sale-_-Accessories&currentNode=accessories&tab=sale&previousPage=GNAV">Accessories</a></li></ul>
</div>
<div class="f-col left f-sep-dark">
<ul class="nav-list f-sep-light">
<li role="listitem"><p role="heading"><a role="link" href="/browse/women/_/N-1z13xm6Z278f?Endeca_user_segments=sale&currentNode=women&tab=sale&previousPage=GNAV">Women</a></p></li><li><a href="/browse/outerwear/women/_/N-2792Z1z13xm6?cm_sp=sub-_-Sale-_-Outerwear&currentNode=outerwear&tab=sale&previousPage=GNAV">Outerwear</a></li><li><a href="/browse/tops/women/_/N-279zZ1z13xm6?cm_sp=sub-_-Sale-_-Tops&currentNode=tops&tab=sale&previousPage=GNAV">Tops</a></li><li><a href="/browse/sweaters/women/_/N-27bhZ1z13xm6?cm_sp=sub-_-Sale-_-Sweaters&currentNode=sweaters&tab=sale&previousPage=GNAV">Sweaters</a></li><li><a href="/browse/sweatshirts---hoodies/women/_/N-27bgZ1z13xm6?cm_sp=sub-_-Sale-_-SweatshirtsHoodies&currentNode=sweatshirts---hoodies&tab=sale&previousPage=GNAV">Sweatshirts & Hoodies</a></li><li><a href="/browse/fleece/women/_/N-27asZ1z13xm6?cm_sp=sub-_-Sale-_-Fleece&currentNode=fleece&tab=sale&previousPage=GNAV">Fleece</a></li><li><a href="/browse/baselayers/women/_/N-278qZ1z13xm6?cm_sp=sub-_-Sale-_-Baselayers&currentNode=baselayers&tab=sale&previousPage=GNAV">Baselayers</a></li><li><a href="/browse/pants---capris/women/_/N-2798Z1z13xm6?cm_sp=sub-_-Sale-_-PantsCapris&currentNode=pants---capris&tab=sale&previousPage=GNAV">Pants & Capris</a></li><li><a href="/browse/jeans/women/_/N-2791Z1z13xm6?cm_sp=sub-_-Sale-_-Jeans&currentNode=jeans&tab=sale&previousPage=GNAV">Jeans</a></li><li><a href="/browse/shorts/women/_/N-278uZ1z13xm6?cm_sp=sub-_-Sale-_-Shorts&currentNode=shorts&tab=sale&previousPage=GNAV">Shorts</a></li><li><a href="/browse/dresses---skirts/women/_/N-278yZ1z13xm6?cm_sp=sub-_-Sale-_-DressesSkirts&currentNode=dresses---skirts&tab=sale&previousPage=GNAV">Dresses & Skirts</a></li><li><a href="/browse/blazers---jackets/women/_/N-278tZ1z13xm6?cm_sp=sub-_-Sale-_-BlazersJackets&currentNode=blazers---jackets&tab=sale&previousPage=GNAV">Blazers & Jackets</a></li><li><a href="/browse/sleepwear/women/_/N-279oZ1z13xm6?cm_sp=sub-_-Sale-_-Sleepwear&currentNode=sleepwear&tab=sale&previousPage=GNAV">Sleepwear</a></li><li><a href="/browse/shoes/women/_/N-279fZ1z13xm6?cm_sp=sub-_-Sale-_-Shoes&currentNode=shoes&tab=sale&previousPage=GNAV">Shoes</a></li><li><a href="/browse/accessories/women/_/N-278gZ1z13xm6?cm_sp=sub-_-Sale-_-Accessories&currentNode=accessories&tab=sale&previousPage=GNAV">Accessories</a></li><li><a href="/browse/swimwear/women/_/N-279yZ1z13xm6?cm_sp=sub-_-Sale-_-Swimwear&currentNode=swimwear&tab=sale&previousPage=GNAV">Swimwear</a></li><style type="text/css">
hr {
...
<div class="f-col left f-sep-dark">
<ul class="nav-list f-sep-light">
<li role="listitem"><p role="heading"><a role="link" href="/browse/kids/_/N-1z13xm6Z275n?Endeca_user_segments=sale&currentNode=kids&tab=sale&previousPage=GNAV">Kids</a></p></li><li><a href="/browse/boys/kids/_/N-275oZ1z13xm6?cm_sp=sub-_-Sale-_-Boys&currentNode=boys&tab=sale&previousPage=GNAV">Boys</a></li><li><a href="/browse/girls/kids/_/N-275tZ1z13xm6?cm_sp=sub-_-Sale-_-Girls&currentNode=girls&tab=sale&previousPage=GNAV">Girls</a></li><li role="listitem"><p role="heading" class="f-cat-break"><a role="link" href="/browse/gear/_/N-1z13xm6Z2752?Endeca_user_segments=sale&currentNode=gear&tab=sale&previousPage=GNAV">Gear</a></p></li><li><a href="/browse/backpacks/gear/_/N-2754Z1z13xm6?cm_sp=sub-_-Sale-_-Backpacks&currentNode=backpacks&tab=sale&previousPage=GNAV">Backpacks</a></li><li><a href="/browse/duffels---luggage/gear/_/N-2755Z1z13xm6?cm_sp=sub-_-Sale-_-DuffelsLuggage&currentNode=duffels---luggage&tab=sale&previousPage=GNAV">Duffels & Luggage</a></li><li><a href="/browse/travel-accessories/gear/_/N-275dZ1z13xm6?cm_sp=sub-_-Sale-_-TravelAccessories&currentNode=travel-accessories&tab=sale&previousPage=GNAV">Travel Accessories</a></li><li><a href="/browse/hydration/gear/_/N-2756Z1z13xm6?cm_sp=sub-_-Sale-_-Hydration&currentNode=hydration&tab=sale&previousPage=GNAV">Hydration</a></li><li><a href="/browse/lighting/gear/_/N-2758Z1z13xm6?cm_sp=sub-_-Sale-_-Lighting&currentNode=lighting&tab=sale&previousPage=GNAV">Lighting</a></li><li><a href="/browse/tote-bags/gear/_/N-27bsZ1z13xm6?cm_sp=sub-_-Sale-_-ToteBags&currentNode=tote-bags&tab=sale&previousPage=GNAV">Tote Bags</a></li><li><a href="/browse/sunglasses/gear/_/N-27buZ1z13xm6?cm_sp=sub-_-Sale-_-Sunglasses&currentNode=sunglasses&tab=sale&previousPage=GNAV">Sunglasses</a></li><li role="listitem"><p role="heading" class="f-cat-break"><a role="link" href="/browse/home/_/N-1z13xm6Z275e?Endeca_user_segments=sale&currentNode=home&tab=sale&previousPage=GNAV">Home</a></p></li><li><a href="/browse/sheets---pillowcases/home/_/N-275lZ1z13xm6?cm_sp=sub-_-Sale-_-SheetsPillowcases&currentNode=sheets---pillowcases&tab=sale&previousPage=GNAV">Sheets & Pillowcases</a></li><li><a href="/browse/duvet-covers---shams/home/_/N-275hZ1z13xm6?cm_sp=sub-_-Sale-_-DuvetCoversShams&currentNode=duvet-covers---shams&tab=sale&previousPage=GNAV">Duvet Covers & Shams</a></li><li><a href="/browse/blankets---throws/home/_/N-275fZ1z13xm6?cm_sp=sub-_-Sale-_-BlanketsThrows&currentNode=blankets---throws&tab=sale&previousPage=GNAV">Blankets & Throws</a></li><li><a href="/browse/comforters/home/_/N-275gZ1z13xm6?cm_sp=sub-_-Sale-_-Comforters&currentNode=comforters&tab=sale&previousPage=GNAV">Comforters</a></li><li><a href="/browse/pillows/home/_/N-275jZ1z13xm6?cm_sp=sub-_-Sale-_-Pillows&currentNode=pillows&tab=sale&previousPage=GNAV">Pillows</a></li></ul>
</div>
<div class="f-col left f-sep-dark">
<ul class="nav-list f-sep-light">
...
$(document).ready(function () {
loadHeaderRail("/xhr/freeshipping-sitewide-rail.jsp", "#headContentHolder");
//loadHeaderRail("/xhr/freeshipping-sitewide-rail-loyalty-signup.jsp", "#freeShippingRailLoyaltySignUp");
loadHeaderRail("/xhr/headerRail.jsp?bodyClass=custserv-page customer-service company-info company-info-privacy-and-security","#header-rail");
});
</script>
...
<!--
DO NOT REMOVE THIS []
Server Name: 761157-rsatgprd3.eddiebauer.com:8852
Profile: u1703377058
Order: A1710918063
mode: 
Server is alive... />
...
This Privacy Statement describes how we collect and use your information and gives you choices as to how we use it. We suggest that you review this Privacy Statement periodically as we may update it from time to time. This policy was last updated on January 26, 2016.</p>
<div class="container">
...
<p class="last">
Every time you visit our website, we automatically collect your Internet service provider's address, the Web page from which you came, and a record of your activity on our site.</p>
<p class="last">
When you purchase from Eddie Bauer or request a catalog, we collect information that you volunteer such as your name, email address, postal address, phone number and other information necessary to process your order or send you the catalog.</p>
<p class="last">
We collect the information you provide to us when you register for "My Account", participate in a contest or sweepstakes promotion, fill out a survey or questionnaire, or contact us (for example via email, "Ask Eddie" or "Live Chat".)</p>
<p class="last">
...
<p class="last">
The information we receive allows us to tailor our product offer and improve your shopping experience, making shopping easier and more enjoyable. It also enables us to process your purchases, confirm your orders, customize the content and layout of our pages, notify you about updates to our websites and products, and provide you with marketing information.</p>
<p class="last">
The information you supply to us is added to our customer database. You may receive periodic mailings or telephone calls from us about new products and services, discounts, special promotions or upcoming events. If you do not want to receive such mailings or telephone calls from us, please<a class="links" href="#unsubscribefromebemail">click here</a> for contact information.</p>
<p class="last">
...
<p class="last">
A "cookie" is a small data file stored on your computer. At Eddie Bauer, we place a unique identifier in the cookie and use the cookie to connect your computer with the information we store for you in our database. Some examples of the data we store in our database includes your account preferences, items added to your shopping bag, user-specific information on pages accessed, and previous visits to our site. Through cookies we may: alert you to new areas that we think might be of interest to you when you return to our site; record past activity at our site; provide advertisements that are tailored to your interests; or, customize Web page content.</p>
<p class="last">
We do not use cookies to store any of your personal or financial information on your computer.</p>
<p class="last">
We recognize that you have a choice to refuse cookies. However, by choosing to accept an Eddie Bauer cookie you allow us to maintain the preferences stored in your Eddie Bauer "My Account" and process your order. If you choose not to accept the cookie, purchasing is not possible on the Eddie Bauer site.</p>
<p class="last">
...
<p class="last">
We provide you access to the following information if you send us an email, call us or write to us:</p>
<ul class="bulletedList">
...
<li>Transaction information (dates on which you made purchases, amounts and types of Purchases)</li>
<li>Contact information (name, address, phone number)</li>
</ul>
<p class="last">
???company.info.privacy.and.security.content.msg42a???<!-- We provide you with the ability to delete personally identifiable information if you send us an email, call us or write to us -->
</p>
<p class="last">
We evaluate each request and will reply in an appropriate manner and in a form of communication that ensures the security of the information you have requested. Any questions, please<a class="links" target="_blank" href="/custserv/ask-eddie-email.jsp?sectionId=24448">contact us</a>.
</p>
<div class="returnLink">
^<a href="#" class="anchor">Return to top</a>
...
<ol class="how-to-report-fraud"><li>receiving an email that contains mistakes such as misspelled words or grammatical errors, and</li><li>
receiving an email that asks for your confidential information or asks you to take immediate action on your account.</li></ol></p>
<p>We encourage all of our customers to protect themselves and their information:<br>
<ol class="how-to-report-fraud"><li>do not share your credentials or account information with any third party, and</li><li>
make sure that your system is properly patched, running anti-virus and a personal firewall.</li></ol></p>
...
<p class="last">
Eddie Bauer does not seek to solicit information from anyone under the age of thirteen (a "Child"). If a Child submits information to us and we know that the person submitting the information is a Child, we will not use it for any purpose. We will delete the information as soon as we discover it and we will not disclose it to third parties.</p>
</div>
<div class="container">
...
<p class="aboveSubheader">
<a class="links" href="mailto:CustomerCare@csc.eddiebauer.com">
...
or call 1-800-426-8020. Please include your full name and mailing address as it appears on your catalog. We will remove your name from our mailing list as soon as possible. Please recognize that you may receive another catalog before we are able to remove you. If you wish to be placed on our &quot;Do Not Call&quot; list, please let us know during the call,<a class="links" href="mailto:CustomerCare@csc.eddiebauer.com?subject=Please Add To Do Not Call List">
contact us</a> or call 1-800-426-8020.</p>
<p class="last">
We also, on occasion, share a portion of our catalog mailing list with other reputable organizations. If you wish to have your name and address not shared with other organizations, please<a class="links" href="mailto:CustomerCare@csc.eddiebauer.com?subject=Do Not Share Name and Address">contact us</a> or call 1-800-426-8020.</p>
<div class="returnLink">
^<a href="#" class="anchor">Return to top</a>
</div>
</div>
...
<a href="#" class="verisign-modal-link" title="Safe and Secure Shopping. VeriSign Secured."><span class="icon"><span class="visually-hidden">Verisign secured</span></span></a>
</div>
</div>
</div>
</div>
...
<li>
<a href="/career/career-overview.jsp">Careers</a>
</li>
<li>
...
<div class="foot-item">
<h5>EDDIE BAUER PRODUCTS ARE GUARANTEED FOR LIFE</h5>
<p>As an outdoor guide, Eddie Bauer built products to stand up to the rigors of his adventures. He built them&mdash;and guaranteed them&mdash; to last. We carry on that legacy. Every product carries a lifetime warranty. If you're ever unhappy with it for any reason, return it for an exchange or refund and we'll help you find what you need to Live Your Adventure.</p>
</div>
</div>
...
<img src="/static/img/site/170303_svg_us_flag.svg" width="36px;" height="23px;"/>US
<a title="" class="siteSwitchLayer" data-linkUrl="http://www.eddiebauer.ca/company-info/company-info-privacy-and-security.jsp?atg.multisite.remap=false" href="#"><img src="/static/img/site/170303_svg_canadian_flag_gray_off.svg" width="36px;" height="23px;"/>CANADA
</a></div>
</div>
</div>
...
<em class="foot-tagline">Live Your Adventure<sup>&reg;</sup></em>
<div class="foot-info-wrapper clearfix">
<p class="policy-info left">©2017 Eddie Bauer LLC. All rights reserved. eddiebauer.com® is a registered trademark of Eddie Bauer Licensing Services LLC.</p>
...
<script src="/static/js/combined.js?id=8ba7ce0215e9973_1"></script>
...
<script src="/static/js/combined.js?id=12585a3415e9973"></script>
