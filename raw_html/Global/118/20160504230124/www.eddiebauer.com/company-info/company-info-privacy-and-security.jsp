...
<link rel="stylesheet" href="/static/css/combined.css?id=7b863275153355b_7" >
<link rel="stylesheet" href="/static/css/main.css">



<link rel="stylesheet" href="/static/css/combined.css?id=7fa1230a153355b_7" >
<link rel="stylesheet" href="/static/css/combined.css?id=50572b19153355b"  media="print">
...
<script src="/static/js/combined.js?id=fb2b49ed153355b_7"></script>
<script async src="/static/js/shoprunner/production/js/shoprunner_init.js"></script>
<!-- Oracle Chat Checkout -->
<!-- Oracle Chat Checkout Footer -->
<!-- Oracle Chat -->
...
">
        ...
        FREE SHIPPING ON ORDERS OF $99 OR
        <br>
        MORE. USE CODE: GOOSE | DETAILS

    </a>
</p>
<div id="hc_container" style="display: none;">
    <div id="hc_disclaimer">
        <img src="//eddiebauer.scene7.com/is/image/EBContent/m_160425_promo_details_png?fmt=png-alpha&scl=1" alt="FREE SHIPPING ON ORDERS OF $99 OR MORE. Free Shipping offer valid for Standard Delivery (7-9 business days) to the U.S. only on orders of $99 or more after any discount is applied. Valid only on online orders at eddiebauer.com. Does not include and cannot be applied to previous or pending orders, or combined with any other offer. Auto-applied at checkout." />
    </div>
</div>
    ...
    <div id="hc_html_disclaimer">
        <script>
            document.addEventListener('DOMContentLoaded', function (event) {
                ...
                paragraph.innerHTML = 'Free standard shipping (7-9 business days delivery, valid in the U.S. only) on orders of $99 or more. Free Shipping offers are valid to the U.S. only, online only at eddiebauer.com. Free shipping offers cannot be applied to previous or pending purchases. All prices in U.S. dollars. <span>Use Code: GOOSE</span>';
            });
        </script>
...
<div class="f-col left">
	<ul class="nav-list">
		...
		<li>
			<a href="/custom?previouspage=GNAV&cm_sp=topnav-_-men-_-CustomNew">Custom</a></li>
		<li>
		...
		<li>
			<a href="/browse/sport-shop/men/_/N-1z13ycxZ26y3?isLeftNav=true&amp;previousPage=GNAV&amp;cm_sp=topnav-_-men-_-Sportshop">Hunting &amp; Fishing</a></li>
		<li>
			&nbsp;</li>
		<li>
			<p>
...
<div class="f-col left">
	<ul class="nav-list">
		...
		<li>
			<a href="/custom?previouspage=GNAV&cm_sp=topnav-_-women-_-customNew">Custom</a></li>
		<li>
...
<a href="/campaign/target?previousPage=GNAV&cm_re=KIDS-_-2_OB_P-_-Target_160302">Baby</a></ul>
</div>
</div>
...
<style type="text/css">
    ...
    #swr_desktop_disclaimer {
        height: 440px;
        width: 480px;
        padding: 36px;
    }

        #swr_desktop_disclaimer h1,
        #swr_disclaimer h1 {
            font-size: 36px !important;
            font-weight: 500;
            margin: 0 0 10px 5px;
        ...
        #swr_desktop_disclaimer span.subtitle2 {
            font-size: 12px;
            font-weight: bold;
            left: 102px;
            position: absolute;
...
<div id="new_rail">
    <img width="995" height="100" style="margin-top:10px !important;" usemap="#m_swr" src="//eddiebauer.scene7.com/is/image/EBContent/160429_site_wide_rail_png?fmt=png-alpha&amp;scl=1" alt="">
    <map name="m_swr" id="m_swr">
        <area title="Shop Men's Sale" alt="Shop Men's Sale"
              href="/browse/men/_/N-1z13xm6Z26y3?Endeca_user_segments=sale&currentNode=men&tab=sale&previousPage=BAN&cm_re=rail-_-1_to_s-_-RailMen_160429&cm_sp=MothersDay-_-r_1-_-RailMen_160429"
              coords="676,0,813,100" shape="rect">

        <area title="Shop Women's Sale" alt="Shop Women's Sale"
              href="/browse/women/_/N-1z13xm6Z278f?Endeca_user_segments=sale&currentNode=women&tab=sale&previousPage=BAN&cm_re=rail-_-1_to_s-_-RailWos_160429&cm_sp=MothersDay-_-r_1-_-RailWos_160429"
              coords="537,0,674,100" shape="rect">

        <area title="Shop Gear Sale" alt="Shop Gear Sale"
              href="/browse/gear/_/N-1z13xm6Z2752?Endeca_user_segments=sale&currentNode=gear&tab=sale&previousPage=BAN&cm_re=rail-_-1_to_s-_-RailGear_160429&cm_sp=MothersDay-_-r_1-_-RailGear_160429"
              coords="815,0,952,100" shape="rect">

        <area alt="See Details" class="floatbox naked" href="#swr_desktop_disclaimer" data-fb-options="type:ajax width:480 height:440 autoEndVideo:false contentScroll:false doAnimations:false" coords="0,0,536,100" shape="rect">
    </map>
</div>
...
<div id="swr_container" style="display: none;">
    <div id="swr_disclaimer">
        <img width="480" height="440" src="//eddiebauer.scene7.com/is/image/EBContent/160503_promo_details_png?fmt=png-alpha&scl=1" alt="" />
    </div>
</div>

<div id="swr_desktop_container" style="display: none;">
    <div id="swr_desktop_disclaimer" ng-app="disclaimerApp">
        <script src="/static/js/jquery/angular.min.js"></script>
        ...
        <script>
            ...
            .controller('DisclaimerCtrl', function ($scope) {
                ...
                var disclaimerList = [{
                    ...
                    description: '*Offer excludes Custom products and Buy-One-Get-One offers. Offer excludes purchases made in Outlet stores. Offer at Eddie Bauer Outlet and Retail stores may vary, see store for details. Offer may not be valid in stores outside the United States. Additional exclusions may apply. Does not include and cannot be applied to previous or pending purchases, credit card balances, taxes, monogramming charges, gift cards, or gift boxes. Unless explicitly stated above, offers cannot be combined with any other offer. Offer details, including end date, are subject to change or cancellation without notice.',
                    description2: 'Free Shipping offer valid for Standard Delivery (7-9 business days) to the U.S. only on orders of $99 or more after any discount is applied. Valid only on online orders at eddiebauer.com. Does not include and cannot be applied to previous or pending orders, or combined with any other offer.',
                    subtitle: 'OFFER VALID:  4/15/16 - 5/8/16',
                    subtitle2: 'USE CODE: GOOSE.',
                    promocode: ''
                }];

                $scope.disclaimers = disclaimerList;

            });
        </script>

        <div ng-controller="DisclaimerCtrl" class="row">
            <div class="col-xs-8">
                <div ng-repeat="disclaimer in disclaimers" style="clear: both;">
                    <h1 ng-bind="disclaimer.title"></h1>
                    <h5 ng-bind="disclaimer.subtitle"></h5>
                    <p ng-bind="disclaimer.description" class="disclaimer"></p>
                    <p ng-bind="disclaimer.description2" class="disclaimer2"></p><span ng-bind="disclaimer.subtitle2" class="subtitle2"></span>
                    <!--
                    <p ng-bind="disclaimer.description3" class="disclaimer2"></p>
                    <p ng-bind="disclaimer.description4" class="disclaimer2"></p>
                    -->
                </div>
            </div>
        </div>
...
<div data-mobile-content="top-rail" data-bg-color="#c1d72e" data-icon-color="#ffffff" style="display: none !important;">
    <div class="summary">
        <img src="//www.eddiebauer.com/static/img/spacer.gif" data-mobile-src="//eddiebauer.scene7.com/is/image/EBContent/m_160429_eb-top-rail?fmt=png-alpha&scl=1" alt="Everything On Sale - Exclusions apply">
    </div>
    <div class="details">
        <div class="body">
            <div class="body">
                <a href="/browse/men/_/N-1z13xm6Z26y3?Endeca_user_segments=sale&currentNode=men&tab=sale&previousPage=BAN&cm_re=mobile-_-1_to_s-_-mRailMen_160429&cm_sp=MothersDay-_-mobile_1-_-mRailMen_160429">
                    <img alt="Shop Men's Sale" data-mobile-src="//eddiebauer.scene7.com/is/image/EBContent/m_160301_top-rail-cta-left?$jpg12$&amp;scl=1" src="//www.eddiebauer.com/static/img/spacer.gif">
                </a>
                <a href="/browse/women/_/N-1z13xm6Z278f?Endeca_user_segments=sale&currentNode=women&tab=sale&previousPage=BAN&cm_re=mobile-_-1_to_s-_-mRailWos_160429&cm_sp=MothersDay-_-mobile_1-_-mRailWos_160429">
                    <img alt="Shop Women's Sale" data-mobile-src="//eddiebauer.scene7.com/is/image/EBContent/m_160301_top-rail-cta-right?$jpg12$&amp;scl=1" src="//www.eddiebauer.com/static/img/spacer.gif">
                </a>
            </div>
        </div>
        <div class="footer">
            <img src="//www.eddiebauer.com/static/img/spacer.gif" data-mobile-src="//eddiebauer.scene7.com/is/image/EBContent/m_160425_top-rail-footer-left?fmt=png-alpha&scl=1" alt="See Details">
...
<div data-mobile-content="bottom-rail" data-bg-color="#5f6062" data-icon-color="#efe9e5" style="display: none !important;">
    <div class="summary">
        <img src="//www.eddiebauer.com/static/img/spacer.gif" data-mobile-src="//eddiebauer.scene7.com/is/image/EBContent/m_160425_bottom-rail-summary?fmt=png-alpha&scl=1" alt="Free Shipping On Orders Of $99 Or More">
    </div>
    <div class="details">
        <div class="body">
        ...
        <div class="footer">
            <img src="//www.eddiebauer.com/static/img/spacer.gif" data-mobile-src="//eddiebauer.scene7.com/is/image/EBContent/mobi%5F150822%5Fbottom%2Drail%2Dfooter%2Dleft?$jpg12$&amp;scl=1" alt="Free Shipping On Orders Of $99 Or More">
...
<div class="contactUsHead"><img src="/static/img/chat-phone_contact-us.png" /></div>
</div>
<div id="myChatLinkContainerCstSrv" class="clearfix contactUsHead">
<div id="myChatLinkCstSrv">
<div id="myChatLinkInfoCstSrv"><img src="/static/img/chat-phone-live-chat_unavail.png" /></div>
</div>
</div>
...
<form id="CatalogQuickOrder" name="CatalogQuickOrder" action="/xhr/submit.jsp?_DARGS=/includes/eob-form.jsp.CatalogQuickOrder" method="post"><input name="_dyncharset" value="UTF-8" type="hidden"></input><input value="-2420446547588918577" type="hidden"></input><p>Enter a three-part item number.</p>
<fieldset class="formItem">
...
<script src="/static/js/combined.js?id=8ba7ce02153355b_0"></script>
...
<script src="/static/js/combined.js?id=12585a34153e57a"></script>
