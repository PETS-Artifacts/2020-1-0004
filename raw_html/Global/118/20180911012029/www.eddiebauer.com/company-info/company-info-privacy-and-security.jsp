...
<link rel="stylesheet" href="/static/css/combined.css?id=7b863275164b227" >
...
<link rel="stylesheet" href="/static/css/combined.css?id=7fa1230a164b227" >
<link rel="stylesheet" href="/static/css/combined.css?id=50572b19164b227"  media="print">
...
<script src="/static/js/combined.js?id=fb2b49ed164b227_0"></script>
<!-- Oracle Chat -->
...
<form id="languageSwitcher" name="languageSwitcher" action="/includes/?_DARGS=/includes/languages.jsp.languageSwitcher" method="post"><input name="_dyncharset" value="UTF-8" type="hidden"></input><input name="_dynSessConf" value="6944940564829019028" type="hidden"></input><input id="locale" name="locale" value="en_US" type="hidden"><input name="_D:locale" value=" " type="hidden"><input name="/atg/userprofiling/ProfileFormHandler.update" value="go" type="hidden"><input name="_D:/atg/userprofiling/ProfileFormHandler.update" value=" " type="hidden"><input name="/atg/userprofiling/ProfileFormHandler.loginErrorURL" value="login.jsp" type="hidden"><input name="_D:/atg/userprofiling/ProfileFormHandler.loginErrorURL" value=" " type="hidden"><input name="/atg/userprofiling/ProfileFormHandler.loginSuccessURL" value="login.jsp" type="hidden"><input name="_D:/atg/userprofiling/ProfileFormHandler.loginSuccessURL" value=" " type="hidden"><input name="_DARGS" value="/includes/languages.jsp.languageSwitcher" type="hidden"></input></form></li>
</ul>
</div>
</div>
...
<div class="f-col left" role="columnheader">
	<ul class="nav-list" role="list">
		...
		<li role="listitem">
			<a href="/search/a-search.jsp?sTerm=MensFlannelShop&cm_sp=topnav-_-men-_-MFlannelShop_180817&previousPage=GNAV" role="link">Flannel Shop</a></li>
		<li role="listitem">
...
<div class="f-col left f-sep-dark">
<ul class="nav-list f-sep-light">
<li role="listitem"><p class="category-focus" aria-level="2">Shop by Category</p></li><li><a href="/browse/outerwear/women/_/N-2792?cm_sp=sub-_-Women-_-Outerwear&currentNode=outerwear&tab=women&previousPage=GNAV">Outerwear</a></li><li><a href="/browse/fleece/women/_/N-27as?cm_sp=sub-_-Women-_-Fleece&currentNode=fleece&tab=women&previousPage=GNAV">Fleece</a></li><li><a href="/browse/pants---capris/women/_/N-2798?cm_sp=sub-_-Women-_-PantsCapris&currentNode=pants---capris&tab=women&previousPage=GNAV">Pants & Capris</a></li><li><a href="/browse/tops/women/_/N-279z?cm_sp=sub-_-Women-_-Tops&currentNode=tops&tab=women&previousPage=GNAV">Tops</a></li><li><a href="/browse/t-shirts---tanks/women/_/N-27cc?cm_sp=sub-_-Women-_-TShirtsTanks&currentNode=t-shirts---tanks&tab=women&previousPage=GNAV">T-Shirts & Tanks</a></li><li><a href="/browse/jeans/women/_/N-2791?cm_sp=sub-_-Women-_-Jeans&currentNode=jeans&tab=women&previousPage=GNAV">Jeans</a></li><li><a href="/browse/shorts/women/_/N-278u?cm_sp=sub-_-Women-_-Shorts&currentNode=shorts&tab=women&previousPage=GNAV">Shorts</a></li><li><a href="/browse/dresses---skirts/women/_/N-278y?cm_sp=sub-_-Women-_-DressesSkirts&currentNode=dresses---skirts&tab=women&previousPage=GNAV">Dresses & Skirts</a></li><li><a href="/browse/blazers---jackets/women/_/N-278t?cm_sp=sub-_-Women-_-BlazersJackets&currentNode=blazers---jackets&tab=women&previousPage=GNAV">Blazers & Jackets</a></li><li><a href="/browse/sweatshirts---hoodies/women/_/N-27bg?cm_sp=sub-_-Women-_-SweatshirtsHoodies&currentNode=sweatshirts---hoodies&tab=women&previousPage=GNAV">Sweatshirts & Hoodies</a></li><li><a href="/browse/sweaters/women/_/N-27bh?cm_sp=sub-_-Women-_-Sweaters&currentNode=sweaters&tab=women&previousPage=GNAV">Sweaters</a></li><li><a href="/browse/sleepwear/women/_/N-279o?cm_sp=sub-_-Women-_-Sleepwear&currentNode=sleepwear&tab=women&previousPage=GNAV">Sleepwear</a></li><li><a href="/browse/baselayers/women/_/N-278q?cm_sp=sub-_-Women-_-Baselayers&currentNode=baselayers&tab=women&previousPage=GNAV">Baselayers</a></li><li><a href="/browse/shoes/women/_/N-279f?cm_sp=sub-_-Women-_-Shoes&currentNode=shoes&tab=women&previousPage=GNAV">Shoes</a></li><li><a href="/browse/accessories/women/_/N-278g?cm_sp=sub-_-Women-_-Accessories&currentNode=accessories&tab=women&previousPage=GNAV">Accessories</a></li><li><a href="/browse/swimwear/women/_/N-279y?cm_sp=sub-_-Women-_-Swimwear&currentNode=swimwear&tab=women&previousPage=GNAV">Swimwear</a></li></ul>
</div>
<div class="f-col left f-sep-dark">
<ul class="nav-list f-sep-light">
<div class="f-col left" role="columnheader">
	<ul class="nav-list" role="list">
		...
		<li role="listitem">
			<a href="/search/a-search.jsp?sTerm=WomensFlannelShop&cm_sp=topnav-_-women-_-WFlannelShop_180817&previousPage=GNAV" role="link">Flannel Shop</a></li>
		<li role="listitem">
		...
		<li role="listitem">
			<a href="/lookbooks/summertops" role="link">T-Shirt Shop</a></li>
		<li role="listitem">
...
<div class="f-col left" role="columnheader">
	<ul class="nav-list" role="list">
		...
		<li role="listitem">
			<a href="//www.outdoorpacific.com" target="_blank">Outdoor Furniture NEW!</a></li>
		<li role="listitem">
...
<a title="" class="siteSwitchLayer" data-linkUrl="http://www.eddiebauer.ca/?atg.multisite.remap=false" href="#"><img src="/static/img/site/170303_svg_canadian_flag_gray_off.svg" width="36px;" height="23px;"/>CANADA
</a></div>
</div>
</div>
...
<script src="/static/js/combined.js?id=8ba7ce02164b227_9"></script>
<script>
//var timeout="30";
...
<script src="/static/js/combined.js?id=12585a34164b227"></script>
