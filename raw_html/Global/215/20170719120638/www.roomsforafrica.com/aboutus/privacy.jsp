...
<head>
    ...
    <link rel="stylesheet" href="/css/multidatepicker_newlook.1497530511000.css" type="text/css"/>
    <link rel="stylesheet" href="/css/bootstrap.min.1425392193000.css" >
    <link rel="stylesheet" href="/css/site_new_look.1499407199000.css" type="text/css"/>

    <!--overrides-->
    <link rel="stylesheet" href="/css/default.1493735296000.css" type="text/css" />
    <link rel="stylesheet" href="/css/media.1493735296000.css" type="text/css" />
    <link rel="stylesheet" href="/css/animate.min.1493735296000.css" type="text/css" />
    ...
    <link rel="stylesheet" href="/css/multidatepicker_newlook.1497530511000.css" type="text/css"/>
    <!--[if lt IE 10]>
    <link rel="stylesheet" href="/css/newlook/IE8.1497534004000.css" type="text/css" />
    <![endif]-->
    <!--[if IE 9]>
    <link rel="stylesheet" href="/css/newlook/IE8.1497534004000.css" type="text/css" />
    <![endif]-->
    ...
    <script src="/js/ui-bootstrap-tpls-0.12.1.min.1493735296000.js"></script>
    <script src="/js/angular-animate.min.1494531826000.js"></script>
    <script src="/js/angular_card_input.1494531826000.js"></script>
    <script src="/js/checklist-model.1494531826000.js"></script>
    ...
    <script src="/cdn_backups/js/rzslider.1497530511000.js"></script>
    ...
    <script src="/js/underscore-min.1494531826000.js"></script>
    <script src="/js/waiting.1494531826000.js"></script>
    <script src="/js/moment.min.1494531826000.js"></script>
...
<body onload="" class="" >
                        ...
                        <div>
                            ...
                            <nav class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-right" id="cbp-spmenu-s2">
                                ...
                                <a ng-href="/mytravel/bookings.do?trh={{traveller.webHandle}}" target="_blank">Bookings</a>
                                    ...
                                    <a ng-href="/travellers/referafriend.do?trh={{traveller.webHandle}}" ng-show="traveller.canReferFriends">Refer Friends</a>
                                    ...
                                    <div id="logOutTrigger" class="hidden-xs">
                                        ...
                                        <div id="logOutAction" class="bubble" style="display: none;">
                                            ...
                                            <div class="bubble--items">
                                                ...
                                                <div ng-show="traveller.canReferFriends">
                                                    <hr>
                                                    <div class="bubble--items">
                                                        
                                                        <div>
                                                            <a ng-href="/travellers/referafriend.do?trh={{traveller.webHandle}}">Refer Friends</a>
                                                        </div>
                                                        <div class="bubble--items__icons"><i class="fa fa-gift" aria-hidden="true"></i></div>
                                                    </div>
                                                </div>
    ...
    <link rel="stylesheet" href="/css/plugins/menu/component.1497530511000.css" type="text/css" />
    <script src="/js/plugins/menu/classie.1494531826000.js"></script>
    <script>
  ...
  <div class="row">
    ...
    <li>200 travel videos, 1000+ virtual tours</li>
                        ...
                        <div class="col-xs-12 text-center">
                            &copy; Copyright 2002 - Wed Jul 19 14:06:37 SAST 2017 RoomsForAfrica.com<br><br>
                        </div>
                    </div>
                </div>
            </div>
