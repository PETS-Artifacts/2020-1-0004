...
<head>
    ...
    <link rel="stylesheet" href="/css/multidatepicker_newlook.1503385841000.css" type="text/css"/>
    <link rel="stylesheet" href="/css/bootstrap.min.1425392193000.css" >
    <link rel="stylesheet" href="/css/site_new_look.1505794887000.css" type="text/css"/>
    ...
    <link rel="stylesheet" href="/css/animate.min.1503385841000.css" type="text/css" />
    ...
    <link rel="stylesheet" href="/css/multidatepicker_newlook.1503385841000.css" type="text/css"/>
    <!--[if lt IE 10]>
    <link rel="stylesheet" href="/css/newlook/IE8.1503385841000.css" type="text/css" />
    <![endif]-->
    ...
    <script src="/js/ui-bootstrap-tpls-0.12.1.min.1503385842000.js"></script>
    <script src="/js/angular-animate.min.1503385842000.js"></script>
    <script src="/js/angular_card_input.1503385842000.js"></script>
    <script src="/js/checklist-model.1503385842000.js"></script>
    ...
    <script src="/cdn_backups/js/rzslider.1503385841000.js"></script>
    ...
    <script src="/js/underscore-min.1503385842000.js"></script>
    <script src="/js/waiting.1503385842000.js"></script>
    <script src="/js/moment.min.1503385842000.js"></script>
...
<body onload="" class="" >
    ...
    <link  itemprop="url" rel="stylesheet" href="/css/plugins/menu/component.1503385841000.css" type="text/css" />
    <script src="/js/plugins/menu/classie.1503385842000.js"></script>
    <script>
  ...
  <div class="row">
    ...
    <li>200 travel videos, 1000+ virtual tours</li>
                        ...
                        <div class="col-xs-12 text-center">
                            &copy; Copyright 2002 - Wed Sep 20 21:40:29 SAST 2017 RoomsForAfrica.com<br><br>
                        </div>
                    </div>
                </div>
            </div>
