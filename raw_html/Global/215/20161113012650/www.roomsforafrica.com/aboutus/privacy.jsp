...
<head>
    ...
    <link rel="stylesheet" href="/css/multidatepicker_newlook.1475216008000.css" type="text/css"/>
    <link rel="stylesheet" href="/css/bootstrap.min.1425392193000.css" >
    <link rel="stylesheet" href="/css/site_new_look.1478576572000.css" type="text/css"/>
    ...
    <script>
        roomsApp = angular.module("roomsApp", ['ui.bootstrap','creditCardInput','checklist-model','ngSanitize'])
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-xs-12 text-center">
                            &copy; Copyright 2002 - Sun Nov 13 03:26:50 SAST 2016 RoomsForAfrica.com<br><br>
                        </div>
                    </div>
                </div>
            </div>
