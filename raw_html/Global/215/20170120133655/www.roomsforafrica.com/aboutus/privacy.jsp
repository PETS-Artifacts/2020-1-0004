...
<head>
    ...
    <link rel="stylesheet" href="/css/site_new_look.1484886197000.css" type="text/css"/>
    ...
    <script>
        roomsApp = angular.module("roomsApp",
                ['ui.bootstrap', 'creditCardInput', 'checklist-model', 'ngSanitize','ngStorage'],
  ...
  <div class="row">
    ...
    <li>200 travel videos, 1000+ virtual tours</li>
                        ...
                        <div class="col-xs-12 text-center">
                            &copy; Copyright 2002 - Fri Jan 20 15:36:54 SAST 2017 RoomsForAfrica.com<br><br>
                        </div>
                    </div>
                </div>
            </div>
