...
<head>
    ...
    <link rel="stylesheet" href="/css/multidatepicker_newlook.1480927700000.css" type="text/css"/>
    <link rel="stylesheet" href="/css/bootstrap.min.1425392193000.css" >
    <link rel="stylesheet" href="/css/site_new_look.1489723341000.css" type="text/css"/>
    ...
    <script src="/js/checklist-model.1476418376000.js"></script>
    ...
    <script src="/cdn_backups/js/rzslider.1481616719000.js"></script>
    ...
    <script>
        ...
        if (ie8 == false) {
            roomsApp.requires.push('rzModule');
            roomsApp.requires.push('ngSanitize');
            roomsApp.requires.push('ngStorage');
//            roomsApp.requires.push('ngTagsInput');
        }
  ...
  <div class="row">
    ...
    <li>200 travel videos, 1000+ virtual tours</li>
                        ...
                        <div class="col-xs-12 text-center">
                            &copy; Copyright 2002 - Tue Mar 21 22:26:55 SAST 2017 RoomsForAfrica.com<br><br>
                        </div>
                    </div>
                </div>
            </div>
