...
<!--[if lt IE 9]>
  <script src="/media/redesign/js/html5shiv.min.js?v=23583"></script>
  <script src="/media/redesign/js/ie.js?v=23583"></script>
<![endif]-->


  <link rel="stylesheet" type="text/css" href="/media/redesign/css/headerFooter_v2.css?v=23583" />

        <link rel="stylesheet" type="text/css" href="/media/redesign/css/headerFooter_nonRedesign.css?v=23583" />
...
<script type="text/javascript" src="/media/redesign/lib/js/jquery-1.11.0.js?v=23583"></script>
<script type="text/javascript" src="/media/redesign/lib/js/bootstrap.js?v=23583"></script>
<script type="text/javascript" src="/media/redesign/js/headerFooter_v2.js?v=23583"></script>
<script type="text/javascript" src="/media/redesign/lib/js/jquery.dotdotdot.min.js?v=23583"></script>
<script type="text/javascript">
...
<script type="text/javascript" src="/media/redesign/js/mainUtils.js?v=23583"></script>
<script type="text/javascript" src="/media/redesign/js/cookie.js?v=23583"></script>
<script type="text/javascript" src="/media/redesign/js/matchMedia.js?v=23583"></script>
<script type="text/javascript" src="/media/redesign/js/newsLetterModule.js?v=23583"></script>
<script type="text/javascript" src="/media/redesign/js/trackingModule.js?v=23583"></script>
<script type="text/javascript" src="/media/redesign/js/navigation.js?v=23583"></script>
<script type="text/javascript" src="/media/redesign/js/jquery.tmpl.js?v=23583"></script>
<script type="text/javascript" src="/media/redesign/lib/js/jquery.dotdotdot.min.js?v=23583"></script>
<script type="text/javascript" src="/media/redesign/js/header.autocomplete.js?v=23583"></script>
...
<table border="0" cellpadding="6" cellspacing="0" width="760">
  <tr>
	...
	<div class="privacyTextWrapper">
        ...
        <p>Effective Date: June 7, 2017</p>
        <p>Artnet Worldwide Corporation (hereafter "artnet") has created this Privacy Policy to demonstrate its firm commitment to privacy. This Privacy Policy describes how artnet handles your personal information, and applies to the websites <a href="http://www.artnet.com">www.artnet.com</a>, <a href="http://www.artnet.de">www.artnet.de</a>, <a href="http://www.artnet.fr">www.artnet.fr</a>, and its affiliated sites, including our newsletters, and any other digital offerings.</p>

        <p>artnet participates in and has certified its compliance with the EU-US Privacy Shield Framework and the Swiss-US Privacy Shield Framework. We are committed to subjecting all personal data received from European Union (EU) member countries, in reliance on the Privacy Shield Framework, to the Framework’s applicable principles. To learn more about the Privacy Shield Framework, visit the U.S. Department of Commerce’s Privacy Shield List at <a href="http://www.privacyshield.gov/list">www.privacyshield.gov/list</a>.</p>
        ...
        <p>
            For all personal information collected from EU customers, you may contact us at Oranienstrasse 164, Berlin, Germany. If you have an unresolved privacy or data use concern that we have not addressed satisfactorily, please contact our US-based third-party dispute resolution provider (free of charge) at <a href="http://feedback-form.truste.com/watchdog/request">feedback-form.truste.com/watchdog/request</a>.
        </p>

        <p>
            Under certain conditions, more fully described on the Privacy Shield website, <a href="http://www.privacyshield.gov/article?id=How-to-Submit-a-Complaint">www.privacyshield.gov/article?id=How-to-Submit-a-Complaint</a>, you may invoke binding arbitration when other dispute resolution procedures have been exhausted.
        </p>
        <strong>Collection and Use of Personal and Non-Personal Information</strong>
        <p>You can browse artnet websites without revealing any personal information. Personal data is collected if you choose to provide them. In compliance with applicable law, artnet collects information from different points on its sites, and is the sole owner of the information collected. </p>

        <p>artnet may collect and store the following personal information, or any other information specified in this Privacy Policy:</p>
        <ul>
        ...
        <p>
            artnet also collects the following non-personal information, if you wish to provide it:
        </p>
        <ul>
        ...
        <p>
            This may also include information collected from surveys or contests, which may include contact information and demographic information. artnet may, in compliance with applicable law, combine your information with information lawfully acquired from other organizations, and use it to improve and personalize services, content, and advertising.
        </p>

        <p>artnet may use this information in the following ways:</p>
        <ul>
            ...
            <li>To allow you to participate in interactive features of artnet products or services, when you choose to do so</li>
        ...
        <p>You may at several different points on the artnet website request information (e.g., how to become an advertiser, or how to become a member gallery). To submit a request using the forms provided on the website, you must supply contact information (e.g., name, email, phone number). This information is used by artnet to provide the information requested.</p>
        <strong>Testimonials</strong>
        <p>artnet posts customer testimonials that may contain personally identifiable information, such as the customer's name. artnet obtains customer consent to post names prior to posting the testimonial. If you wish to remove personal information that is being publicly displayed on an artnet website, <a href="#" onclick="window.open('/misc/formMailer.aspx?email=D98007E45173526C0763BE5FEB53A38DFA948A43A50CE355','formMailer','location=no,scrollbars=yes,menubar=no,toolbars=no,resizable=yes')">contact us</a>.</p>
        <strong>Information Obtained from Third Parties</strong>
        <p>artnet obtains credit information about you from an outside credit reporting agency to help us with customer authentication and credit-related decisions. </p>
        ...
        <p>artnet will share your personal information with third parties only in the ways that are described in this Privacy Policy. artnet does not sell your personal information to third parties. </p>

        <p>artnet may provide your personal information to companies that provide services to help with our business activities, such as credit card payment systems. These companies are authorized to use your personal information only as necessary to provide these services. </p>
        ...
        <p>artnet makes your contact information available to other users that you interact with to help complete the transaction.</p>
        <strong id="Cookies">Cookies and Other Tracking Technologies</strong>
        <p>A cookie is a piece of data stored on the user's hard drive containing information about the user. While cookies can be used to identify a user’s computer, they do not contain information that can be used to identify a user by name. artnet and its partners use cookies and similar technologies on certain pages to help analyze webpage flow, customize services, content, and advertising, as well as measure promotional effectiveness. artnet may use cookies, for example, to keep track of your preferences and profile information. Cookies are also used to collect general usage and volume statistical information. Cookies may be permanent or temporary (also called session cookies).</p>

        <p>Important things to know about cookies:</p>
        <ul>
        ...
        <p>artnet partners with third-party advertising companies to either display advertising on their website or to manage their advertising on other sites. These companies use cookies or similar technologies to collect and use non-personally identifiable information (e.g., persistent IDs, browser type, time and date, page visits, and other information) during your visit to this and other websites to provide advertisements about goods or services likely to be of greater interest to you (i.e., interest-based advertising). They may also use persistent identifiers to track your internet usage over time and cross other websites in their networks beyond our website. artnet does not provide these companies with your personally identifiable information, such as your name, address, telephone number, or email address. If you wish to opt out of interest-based advertising, click <a href="http://http://preferences-mgr.truste.com/">here</a> (or if located in the European Union, click <a href="http://http://www.youronlinechoices.eu/">here</a>). Please note, you will continue to receive generic ads.</p>
        <p>Your browser or device may include “Do Not Track” functionality. artnet’s information collection and disclosure practices, and the choices that we provide to customers, will continue to operate as described in this Privacy Policy, whether or not a “Do Not Track” signal is received.</p>
        ...
        <p>artnet uses your IP address to help diagnose server problems, and to administer our website. artnet uses your IP addresses to analyze trends and gather broad demographic information for aggregate use. IP addresses are not linked to personally identifiable information. </p>

        <p>Every time you access an artnet website, some data is temporarily stored and processed in a log file, such as anonymous IP addresses, the browser types, the operating systems, the recalled page, or the date and time of the recall. This data is only evaluated for statistical purposes, to help us diagnose problems with our servers, to administer our sites, or to improve our offer.</p>
        <strong>HTML5</strong>
        ...
        <strong>Storage of Information; Transmission to the United States</strong>
        <p>The data that artnet collects from you are transferred and stored on serves in the United States. The data may also be processed by staff operating outside European Economic Area ("EEA"), who work for artnet or one of its suppliers. Such staff may be engaged in, among other things, the fulfilment of your order, the processing of your payment details, and the provision of support services. By submitting your personal data, you agree to this transfer, storing, or processing. artnet will take all steps reasonably necessary to ensure that your data are treated securely and in accordance with this Privacy Policy. </p>

        <p>All information you provide is stored on a secure server. Any payment transactions will be encrypted using reasonable security. Where artnet has given you (or where you have chosen) a password that enables you to access certain parts of the site, you are responsible for keeping this password confidential. artnet asks you not to share a password with anyone</p>
        <strong>Monitoring of Communications</strong>
        <p>artnet may review correspondence between users, which is sent via an artnet website, mobile application, service, or other digital offering in order to investigate violations of the artnet Terms and Conditions and artnet Auctions Terms of Use. artnet will only access such correspondence if it has a basis to believe that such terms are being violated. See the artnet Auctions Terms of Use for further information. </p>

        <p>Gallery and Auction House Clients: </p>
        <div>As a member of the Gallery Network or the Auction House Partnerships program, you may ask artnet to review or retrieve emails sent to your business. artnet will access these emails to provide these services for you.</div>
        <strong>Security</strong>
        <p>When artnet collects personal information directly from you, it follows generally accepted industry standards to protect the personal information submitted: both during transmission and once received. artnet does its best to protect your personal data. Once your information is received, artnet uses strict procedures and security features to try to prevent unauthorized access. However, no method of transmission over the internet, or method of electronic storage, is 100% secure. Therefore, its absolute security cannot be guaranteed; any transmission is at your own risk. If you have any questions about security on the artnet websites, <a href="#" onclick="window.open('/misc/formMailer.aspx?email=D98007E45173526C0763BE5FEB53A38DFA948A43A50CE355','formMailer','location=no,scrollbars=yes,menubar=no,toolbars=no,resizable=yes')">contact us</a>. </p>

        <p>artnet has a companywide commitment to your privacy. To make sure your personal information is secure, please check that you are visiting an artnet authorized website. artnet authorized websites are posted only on the following domains: <a href="http://www.artnet.com">www.artnet.com</a>, <a href="http://www.artnet.de">www.artnet.de</a>, <a href="http://www.artnet.fr">www.artnet.fr</a>, and <a href="http://www.artnetnews.cn">www.artnetnews.cn</a>. artnet emails will only come from these domains. artnet does not permit our employees to send or receive work-related emails from personal accounts or any other address. Do not share your username or password with anyone.</p>
        ...
        <strong>Updating/Accessing/Amending/Correcting Personally Identifiable Information</strong>
        <p>Upon request, artnet will provide you with information about whether we hold or process any of your personal information on behalf of a third party. If your personally identifiable information changes, or if you no longer desire artnet services, you may correct, update, amend, delete/remove, or deactivate it by making the change on the My Account page on artnet, <a href="http://www.artnet.com/my-account/">www.artnet.com/my-account/</a> or artnet Auctions <a href="https://www.artnet.com/auctions/pages/customer/buyer/myaccount.aspx">www.artnet.com/auctions/pages/customer/buyer/myaccount.aspx</a>, or by emailing artnet <a href="#" onclick="window.open('/misc/formMailer.aspx?email=D98007E45173526C0763BE5FEB53A38DFA948A43A50CE355','formMailer','location=no,scrollbars=yes,menubar=no,toolbars=no,resizable=yes')">customer service</a>, or by contacting artnet via telephone; US: +1-800-427-8638 or +1-212-497-9700, for European numbers, visit the <a href="http://http://www.artnet.com/aboutus/contact_us.aspx">contact page</a>). artnet customer service is available Monday through Friday, 9 a.m.–5 p.m. (ET). Users have a right to access, object to, or oppose, for legitimate reasons, the processing of their personal data in accordance with this Privacy Policy. Users may enforce their rights by contacting <a href="mailto:privacy@artnet.com">privacy@artnet.com</a>. artnet will respond to your request to access within 30 days.</p>
        <strong>Note to Parents or Guardians</strong>
        <p>Minors may want to visit artnet on the internet. However, the site is not directed at children under the age of 18, and those under the age of 18 should not provide personal data on the site unless they have received permission from their parents before submitting any personal information. These tools are designed to preclude children from releasing personal information online without the permission of their parents. If artnet becomes aware that a minor has submitted information on its site, artnet reserves the right to request proof that the parent or guardian has permitted use by the minor of the site; otherwise artnet reserves the right to delete the relevant information and the minor's registration on the site.</p>
        <strong>Notification of Privacy Policy Changes</strong>
        ...
        <p>artnet is responsible for the personal data collected from users of this website and determines the purposes and means by which such personal data are used, subject to applicable law. </p>

        <p>If you have any questions about the artnet Privacy Policy or the practices of this site, please contact customer service via email. </p>
        <p>
        ...
        <strong>California Residents: Your California Privacy Rights</strong>
        ...
        <div>
            <a href="//privacy.truste.com/privacy-seal/validation?rid=0e91a1f6-9368-45a5-9f5d-c83ea58e5469" title="TRUSTe Privacy Certification" target="_blank"><img style="border: none" src="//privacy-policy.truste.com/privacy-seal/seal?rid=0e91a1f6-9368-45a5-9f5d-c83ea58e5469" alt="TRUSTe Privacy Certification" /></a>
        </div>
    </div>
	</td>
  </tr>
...
<div class="footer">
            ...
            <p>©2017 Artnet Worldwide Corporation. All rights reserved.</p>
</div>
