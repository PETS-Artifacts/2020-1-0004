...
<!--[if gt IE 8]><!--> <html class="no-js" lang="en"> <!--<![endif]-->
	...
	Privacy Policy | Micro Center
            ...
            <link rel="canonical" href='https://www.microcenter.com/site/customer-support/privacy_policy.aspx' />
...
#cmscontent #content a, #cmscontent #content a:link  {
    line-height: 1.5;
    font-family: Helvetica, Arial, sans-serif;
	font-weight: normal;
	color: #086af6;
...
#cmscontent #content a:visited {
	color: #086af6;
   	text-decoration: none;
}

#cmscontent #content a:hover {
	color: #086af6;
...
#cmscontent #content .BTN-chat {
    padding: 6px;
    background: white;
    background-image: url(https://60a99bedadae98078522-a9b6cded92292ef3bace063619038eb1.ssl.cf2.rackcdn.com/images_buttons_CHATcircle.png);
...
#cmscontent #content .BTN-chat a:link a:visited {
    font-size: 1.25em;
    font-family: Helvetica, Arial, sans-serif;
	font-weight: bold;
	color: #B65850;
...
#cmscontent #content .BTN-chat a:hover {
    font-size: 1.25em;
    font-family: Helvetica, Arial, sans-serif;
	font-weight: bold;
	color: #086af6;
...
.MobileFramework .Info-container .left {
    width: 98%;

}

.MobileFramework .Info-container .right {
    width: 98%;
...
#cmscontent.MobileFramework.noside #content h1 {
    color: #4f6b8f;
...
#cmscontent.noside #content h1 {
    color: #4f6b8f;
    font: 1.875em Helvetica, Arial, sans-serif;
    letter-spacing: normal;
    margin: 1%;
    padding: 0;
    width: 98%;
...
#cmscontent.MobileFramework.noside #content h2 {
    color: #222;
    font: 1.125em Helvetica, Arial, sans-serif;
    margin: 0;
    padding: 0;
...
#cmscontent.MobileFramework.noside #content h3 {
    color: #666666;
...
#cmscontent.MobileFramework.noside #content p {
    font-family: Helvetica,Arial,sans-serif;
    font-size: .875em;
    line-height: 1.5;
    color: #222;
...
#cmscontent.MobileFramework.noside #content .bullets li {
    font-size: .875em;
}
...
<script>
    var $A1Config = {
        key: "$2a$10$xSIzGO/3KA7ACb.so8vlheCYQlIH75I/T06Q/jLDtJoMzngKOcVSa",
        tenantId: 575,
...
<meta name="keywords" content="micro center online; micro center; privacy policy; micro electronics; privacy; policy; retail stores; customer support; in-store pickup" /></head>
    ...
    <body id="cmscontent" class=" Store_Selected_029 DesktopFramework noside">
...
<script type="text/javascript">
    ...
    <ul style="padding:0px; margin:0px; border:0px;">
        <li class="signin clear"><a id="hypSignIn" onclick="ga(&#39;mc.send&#39;,&#39;event&#39;,&#39;header&#39;, &#39;insider_sign_in_click&#39;,&#39;account&#39;);" href="https://account.microcenter.com/Login.aspx?RedirectUrl=https://www.microcenter.com/site/customer-support/privacy_policy.aspx">Sign in</a></li>
...
<option value="101">CA - Tustin</option><option value="181">CO - Denver</option><option value="065">GA - Duluth</option><option value="041">GA - Marietta</option><option value="151">IL - Chicago</option><option value="025">IL - Westmont</option><option value="191">KS - Overland Park</option><option value="121">MA - Cambridge</option><option value="085">MD - Rockville</option><option value="125">MD - Parkville</option><option value="055">MI - Madison Heights</option><option value="045">MN - St. Louis Park</option><option value="095">MO - Brentwood</option><option value="075">NJ - North Jersey/ Paterson</option><option value="171">NY - Westbury</option><option value="115">NY - Brooklyn</option><option value="145">NY - Flushing</option><option value="105">NY - Yonkers</option><option value="141">OH - Columbus</option><option value="051">OH  - Mayfield Heights</option><option value="071">OH - Sharonville</option><option value="061">PA - St. Davids</option><option value="155">TX - Houston</option><option value="131">TX - Dallas</option><option value="081">VA - Fairfax</option><option value="029" selected >Micro Center Web Store</option>
</select>
...
<a href="/site/brands/nvidia.aspx"   role="menuitem" aria-haspopup="false" tabindex="-1"><img src="https://60a99bedadae98078522-a9b6cded92292ef3bace063619038eb1.ssl.cf2.rackcdn.com/thumbnail_C725-NVIDIAnavLogo.jpg" alt="NVIDIA"></a>
...
<!-- END HEADER -->
        ...
        <!-- START CONTENT -->
        <main id="mainContent" class="c_291">
...
<p class="intro">This site is restricted to users from the United States and those not governed by privacy policies of the European Union. Users from the European Union are advised not to disclose personal information on this site.</p>
<p class="intro">By using this site or making purchases at our stores, you consent to this Privacy Policy. You should also review our <a href="/site/customer-support/security.aspx">Safe Shopping Promise</a> for online purchases.</p>
<h2>How is personally identifiable information collected?</h2>
...
<h2>How do we use cookies and technology in our website?</h2>
...
<h2>Who are the third party entities with whom we may share your personally identifiable information?</h2>
<br />
<h3>Third party service providers:</h3>
<p>Micro Center retail stores and Micro Center Online may provide your name, address and email address to reputable organizations that help us to fulfill services to you on our behalf. For example, we may use such third party service providers to authorize credit card transactions, ship packages, activate gift cards and warranties, schedule and perform product installations, administer service programs, help us maintain records and analyze sales data, augment and improve the accuracy of our customer records, and distribute print and digital communications to you with our offers or important information on our behalf. None of these third party service providers are authorized to use your information for any purpose other than to provide the above stated services for which they contract with us to perform.</p>
<h3>Links to Third Party Sites:</h3>
<p>Micro Center Online contains certain links and ads to third party websites, such as our vendors&#8217; websites and links to other websites intended to facilitate our customers&#8217; shopping experience. We are not responsible or liable for the privacy practices or content found on these websites. We recommend that you check the privacy notice of each website you visit. Links to third party websites are provided solely for your convenience and any submission of data to such websites shall be at your sole risk.</p>
<h3>Other Partner Companies</h3>
<p>We may occasionally share your name, mailing address and purchase information on a limited basis with select companies that offer products and services that may be of interest to you. We <strong>never share</strong> email addresses or telephone numbers with any of these third-party companies. If you prefer that we do not share your information with outside partner companies, you may so indicate as noted in the unsubscribe section below.</p>
<h2> How do I unsubscribe from Micro Center sharing my information with other companies?</h2>
<ul class="bullets">
     <li>
     <h3>Unsubscribe Online</h3>
     It's easy. Just access our <a href="http://email.microcentermedia.com/q/Microcenter/microcenter_SubscriptionCenter_PRINT_Updated_122015">Postal Preference Center</a> to express your preferences.
     </li>
     <li>
     <h3>Unsubscribe by Letter</h3>
     Write to us and let us know what you would like to receive or not receive. You can send your letter to:
     Communications Department, 4119 Leap Road, Hilliard, Ohio 43026<br />
...
<div class="right">
<!--start second column-->
<h2>How do I subscribe to / unsubscribe from Micro Center and Micro Center Online emails or postal mailings?</h2>
...
<ul class="bullets">
     <li>
     <h3>Subscribe / Unsubscribe Online</h3>
     <strong>For email,&nbsp;</strong>visit our <a href="https://microcenterinsider.com/pub/sf/ResponseForm?_ri_=X0Gzc2X%3DYQpglLjHJlTQGghNPnvyI3AMpzdX7zdATq3sgwr2sYWUDaVXMtX%3DYQpglLjHJlTQGoPjl1aYUBLJiwzg1gRl4yyPfEqzbzaSfnza&amp;_ei_=Etna52KgJplwhKMdQbhEXcU">Email Preference Center</a> where you can sign up to receive our various marketing promotions or request to no longer receive specified marketing promotions. All promotional emails we send you also contain a link allowing you to opt out of these specific emails in the future. Click on the relevant link and follow the simple instructions.<br />
     ...
     <li>
     <h3>Subscribe / Unsubscribe by Letter</h3>
     Communications Department, 4119 Leap Road, Hilliard, Ohio 43026<br />
...
<h2>How do I make changes in the information I previously provided?</h2>
<p>For registered
users, sign in using online account name and make changes to the information
you previously provided.</p>
<h2>How do we protect the security of your Micro Center Online order information?</h2>
...
<h2>How do we handle information related to children?</h2>
...
<h2>How can you contact us with questions regarding this Privacy Policy?</h2>
...
<h2>How am I notified of Privacy Policy changes?</h2>
...
<p style="text-transform:uppercase; font-weight: bold;">This Privacy Policy is Currently in Effect.
</p>
...
<h2>VeriSign Authentic Site</h2>
<p>Authentic Sites like microcenter.com use a VeriSign Secure Server Digital ID to offer proof of identity, to enable secure communications and to encrypt translations with site visitors through their web browser connections. The only way to be sure of a web site's authenticity is to view the site's Digital ID. Viewing a site's ID assures that you are not being "spoofed" (i.e. the site is real and not an impostor) since it contains:</p>
<ul class="bullets">
     <li>The name of the company which owns the web site (e.g. Micro Electronics, Inc.)</li>
     <li>The site's registered Internet address (e.g. www.microcenter.com)</li>
     <li>The name of the Secure Server Certification Authority under which VeriSign issued the Digital ID (RSA Data Security or VeriSign)</li>
</ul>
</div>
<!--END CONTAINER-->
</div>
