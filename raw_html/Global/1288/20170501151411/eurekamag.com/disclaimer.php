		...
		<div class="block_small_content_01">
			<div class="block_small_content_text">
				<a href="/research/" style="margin-bottom: 0!important;">
					...
					<div class="box_middle_left" style="width:60px; text-align:right;"><b>30,231,403</b></div>	
					<div class="clear_both"></div>
				</a>
				<div class="box_middle_left" style="width:12px"><img src="//eurekamag.com/themes/biology/images/icon_arrow.gif" width="9" height="11" alt="" /></div>
				<div class="box_middle_left" style="width:100px">Abstracts:</div>
				<div class="box_middle_left" style="width:60px; text-align:right">11,426,581</div>	
				<div class="clear_both"></div>
				
				<a href="/news/" style="margin-bottom: 0!important;">
					<div class="box_middle_left" style="width:12px"><img src="//eurekamag.com/themes/biology/images/icon_arrow.gif" width="9" height="11" alt="" /></div>
					<div class="box_middle_left" style="width:100px"><b>PDF News:</b></div>
					<div class="box_middle_left" style="width:60px; text-align:right"><b>631</b></div>	
					<div class="clear_both"></div>
				</a>
				<div class="clear_both"></div>
				...
				<a href="/request/" style="margin-bottom: 0!important;">
					...
					<div class="box_middle_left" style="width:60px; text-align:right"><b>2,258,400</b></div>	
					<div class="clear_both"></div>
				</a>
			</div>
		</div>
