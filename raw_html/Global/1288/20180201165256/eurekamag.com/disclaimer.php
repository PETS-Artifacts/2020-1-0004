		...
		<div class="block_small_content_01">
			<div class="block_small_content_text">
				<a href="/research/" style="margin-bottom: 0!important;">
					...
					<div class="box_middle_left" style="width:60px; text-align:right;"><b>46,701,666</b></div>	
					<div class="clear_both"></div>
				</a>
				<div class="box_middle_left" style="width:12px"><img src="//eurekamag.com/themes/biology/images/icon_arrow.gif" width="9" height="11" alt="" /></div>
				<div class="box_middle_left" style="width:100px">Abstracts:</div>
				<div class="box_middle_left" style="width:60px; text-align:right">27,347,987</div>	
				<div class="clear_both"></div>
				<div class="box_middle_left" style="width:12px"><img src="//eurekamag.com/themes/biology/images/icon_arrow.gif" width="9" height="11" alt="" /></div>
				<div class="box_middle_left" style="width:100px">PDF Full Texts:</div>
				<div class="box_middle_left" style="width:60px; text-align:right">2,339,342</div>	
				<div class="clear_both"></div>
...
<div style="padding-left:2px;padding-right:2px;">
	...
	<form method='get' action="//eurekamag.com/accession.php" style="overflow: auto; padding: 5px 0 10px 0;">
		...
		<div style="overflow: hidden; padding-right: 10px;">
			<input type="number"  min="1" max="60000000" name="accnum" value="" size=9 placeholder="Accession" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Accession'" onkeyup="this.value=this.value.replace(/[^\d]+/,'')" required style="font-size: 15px; border: 1px solid; border-color: #D3D3D3; margin: auto; padding: 2px; width: 100%"/>
		</div>
	</form>
...
Date of Last Revision: <b>10 June 2017</b>
<br /><br />
...
<!-- Go to www.addthis.com/dashboard to customize your tools -->
<script src="/js/addthis_widget.js#pubid=bio&domready=1" async="async"></script>
...
<script>
    window.cookieconsent_options = {"message":"EurekaMag.com uses cookies to ensure you get the best experience","dismiss":"Got it!","learnMore":"More info","link":"/disclaimer.php#cookies","theme":"dark-top"};
</script>
