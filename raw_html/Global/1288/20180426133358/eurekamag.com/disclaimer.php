		...
		<div class="block_small_content_01">
			<div class="block_small_content_text">
				<a href="/research/" style="margin-bottom: 0!important;">
					...
					<div class="box_middle_left" style="width:60px; text-align:right;"><b>47,893,527</b></div>	
					<div class="clear_both"></div>
				</a>
				<div class="box_middle_left" style="width:12px"><img src="//eurekamag.com/themes/biology/images/icon_arrow.gif" width="9" height="11" alt="" /></div>
				<div class="box_middle_left" style="width:100px">Abstracts:</div>
				<div class="box_middle_left" style="width:60px; text-align:right">28,296,643</div>	
				<div class="clear_both"></div>
...
<div style="padding-left:2px;padding-right:2px;">
	...
	<form method='get' action="//eurekamag.com/accession.php" style="overflow: auto; padding: 5px 0 5px 0;">
		...
		<div style="overflow: hidden; padding-right: 10px;">
			<input type="number"  min="1" max="60486182" name="accnum" value="" size=9 placeholder="Accession" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Accession'" onkeyup="this.value=this.value.replace(/[^\d]+/,'')" required style="font-size: 15px; border: 1px solid; border-color: #D3D3D3; margin: auto; padding: 2px; width: 100%"/>
		</div>
	</form>
