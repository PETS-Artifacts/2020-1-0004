             ...
             <div class="grid_12">
                ...
                <div class="grid_16 alpha ">
                    ...
                    <div class="contentboxfullhelp ">
                        <div class="textright">
                            <p>This privacy policy sets out how Guide to PHARMACOLOGY uses and protects any information that you give Guide to PHARMACOLOGY when you use this website. The policy covers the Guide to PHARMACOLOGY and Guide to IMMUNOPHARMACOLOGY domains. Hereafter, reference to the Guide to PHARMACOLOGY include both domains.</p>
