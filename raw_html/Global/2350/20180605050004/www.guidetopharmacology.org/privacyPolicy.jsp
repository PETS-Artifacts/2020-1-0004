                ...
                <div class="grid_16 alpha">
                    ...
                    <div class="contentboxfullhelp">
                        <div class="textright">
                            ...
                            <p>Guide to PHARMACOLOGY may change this policy from time to time by updating this page. You should check this page from time to time to ensure that you are happy with any changes. This policy is effective from 18th May 2018.</p>
                            ...
                            <p>For NC-IUPHAR members, Concise Guide and database contributors in order to attribute authorship to the database content and pages we collect:</p>
                            <ul>
                                <li>ORCIDs</li>
                                <li>Links to departmental webpages and profiles</li>
                                <li>Affiliated Institutions</li>
                            </ul>
                            ...
                            <ul>
                                ...
                                <li>We may share basic contact information with our partner organisations: IUPHAR (International Union of Basic and Clinical Pharmacology) and BPS (British Pharmacological Society) in order to provide updates on relevant news and events</li>
                            </ul>
                            ...
                            <ul>
                                <li>You can opt out of receiving email communication delivered by MailChimp by clicking on the unsubscribe link at the end of every email or <a href="revealEmail.jsp" onclick="window.open('revealEmail.jsp', '', 'toolbar=0,scrollbars=0,location=0,statusbar=0,menubar=0,resizable=0,width=550,height=300'); return false;" title="Reveal this e-mail address">contacting us</a>.</li>
