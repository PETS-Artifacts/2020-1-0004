...
<div style="text-align:right">
 <form method="get" action="/GRAC/DatabaseSearchForward">
                <fieldset class="search_box">
                    <input type="text" id="quick_search" size="18" maxlength="200" name="searchString"/>
       ...
       select: function( event, ui ) {
        ...
        <li>
            ...
            <ul>
                ...
                <li><a href="http://onlinelibrary.wiley.com/doi/10.1111/bph.2013.170.issue-8/issuetoc" target="_blank" onClick="recordEvent(this, 'BJP links', 'http://onlinelibrary.wiley.com/doi/10.1111/bph.2013.170.issue-8/issuetoc', 'CGTP table of contents');return false;">Concise Guide to PHARMACOLOGY</a></li>
        ...
        <li>
                ...
                <div class="grid_16 alpha">
                    ...
                    <div class="contentboxfullhelp">
                        <div class="textright">
                            ...
                            <p>Guide to PHARMACOLOGY may change this policy from time to time by updating this page. You should check this page from time to time to ensure that you are happy with any changes. This policy is effective from 17th March 2014.</p>
                            ...
                            <table class="receptor_data_tables">
                                <tr>
                                    <td class="heading">Cookie Name</td>
                                ...
                                <tr>
                                    <td class="info">__utma<br/>__utmb<br/>__utmc<br/>__utmz</td>
            ...
            <div class="clear"></div>
            <div id="footer">
                <div class="invisible_link" style="line-height: 70px;  width:740px;">
    <a class="logo" href="http://www.wellcome.ac.uk/" target="_blank"><img src="/images/WellcomeTrust_logo_small.png" alt="Wellcome Trust logo" align="left" style="margin-left:5px;margin-top: 5px;"/></a> 
    <a class="logo" href="http://www.bps.ac.uk" target="_blank"><img src="/images/BPS_new_logo_footer.png" alt="British Pharmacological Society (BPS) logo" align="left" style="margin-left:10px;margin-top: 5px;"/></a>
    <a class="logo" href="http://www.iuphar.org" target="_blank"><img src="/images/IUPHARLogoCroppedSmall.png" alt="International Union of Basic and Clinical Pharmacology (IUPHAR) logo" align="left" style="margin-left:10px;margin-top: 5px;"/></a>
    <a class="logo" href="http://www.ed.ac.uk" target="_blank"><img src="/images/UoE_Stacked Logo_small.png" alt="The University of Edinburgh logo" align="left" style="margin-left:10px;margin-top: 5px;"/></a>
</div>
<div>
    <p style="text-align:right;margin: 2px 5px 0px 0px;"><a href="http://www.google.com/recaptcha/mailhide/d?k=01vYhjd4942K8mcJsTfn9STA==&amp;c=gyybhwWR1ziUWzMMiVIf72wtrsNBtTCzJMQcN2lPmvi7B4vjy65HPFlKpsLE3rQ7" onclick="window.open('http://www.google.com/recaptcha/mailhide/d?k\07501vYhjd4942K8mcJsTfn9STA\75\75\46c\75gyybhwWR1ziUWzMMiVIf72wtrsNBtTCzJMQcN2lPmvi7B4vjy65HPFlKpsLE3rQ7', '', 'toolbar=0,scrollbars=0,location=0,statusbar=0,menubar=0,resizable=0,width=500,height=300'); return false;" title="Reveal this e-mail address">Contact us</a></p>
    <p style="text-align:right;margin: 5px 5px 0px 0px;"> <span class="invisible_link"><a href="https://twitter.com/#!/GuidetoPHARM" target="_blank" title="Follow us on Twitter"><img class="logo" style="vertical-align:middle;" src="/images/twitter.png"/></a><a href="https://www.facebook.com/pages/Guide-to-PHARMACOLOGY/231393780304076" target="_blank" title="Like us on Facebook"><img class="logo" style="vertical-align:middle;margin-left:5px;" src="/images/facebook.png"/></a><a href="http://www.linkedin.com/company/guide-to-pharmacology" target="_blank" title="Follow us on LinkedIn"><img class="logo" style="vertical-align:middle;margin-left:5px;" src="/images/LinkedIn.png"/></a><a href="http://blog.guidetopharmacology.org/" target="_blank" title="Visit our blog"><img class="logo" style="vertical-align:middle;margin-left:5px;" src="/images/wpmini-blue.png"/></a><a href="http://www.slideshare.net/GuidetoPHARM" target="_blank" title="View slide sets and posters on SlideShare"><img class="logo" style="vertical-align:middle;margin-left:5px;" src="/images/slideshare_no_name.png"/></a></span></p>
    <p style="text-align:right;margin: 5px 5px 0px 0px;"><small><a href="/privacyPolicy.jsp">Privacy and Cookie Policy</a></small></p>
</div>
<div><p style="text-align:left; margin: 5px 5px 0px 5px; padding: 0px"><a href="/sponsors.jsp">Sponsor list</a></p></div>
