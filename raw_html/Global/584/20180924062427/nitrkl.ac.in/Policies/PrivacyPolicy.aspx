...
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="/wEPDwUJNDMyNDU0NjAzD2QWAmYPZBYCZg9kFgICAw9kFgICrAEPZBYCAgEPDxYCHgRUZXh0BQ5Qcml2YWN5IFBvbGljeWRkZCJ0aM1XzTN9grS48tPPG4dgfkg+4acafdL5HcGKJPeE" />
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <ul class="contact-details" style="float:right;">
                                    ...
                                    <li><a href="http://www.hindi.dptripathi.in">हिंदी प्रकोष्ठ</a>
                                    </li>
                                </ul>
                                <!-- End Social Links -->
                            </div>
                            ...
                            <ul class="nav navbar-nav navbar-right">
                                <li>
                                    ...
                                    <ul class="dropdown">
                                        ...
                                        <li><a href="../Institute/Rules/" id="dl13">Rules & Regulations</a>
                                        </li>
                                    ...
                                    <ul class="dropdown">
                                        <li><a id="dl21">Academic Units </a>
                                            <ul class="sup-dropdown">
                                                ...
                                                <li><a href="../Academics/ResearchCentres/Default.aspx" id="A70">Centres of Research</a></li>
                                                <li><a href="../Academics/SupportCentres/Default.aspx" id="A73">Support Centres</a></li>
                                                <li><a href="../Academics/TSUs/Default.aspx" id="A74">Technical Service Units</a></li>
                                        ...
                                        <li><a href="http://valuedu.nitrkl.ac.in/" id="A116">Value Education</a>
                                        </li>
                                    </ul>
                                </li>
                                <li>
                                ...
                                <li>
                                    ...
                                    <ul class="dropdown">
                                        ...
                                        <li><a href="../Institute/Rules/" id="A115">Rules & Regulations</a>
                                        </li>
                                        <li><a href="../Institute/Forms/" id="A120">Official Forms</a>
                                        </li>
                    ...
                    <ul class="wpb-mobile-menu">
                        <li>
                                    ...
                                    <ul class="dropdown">
                                        ...
                                        <li><a href="http://nitrkl.ac.in/OldWebsite/Institute/RulesNCirculars/Rules_Circulars.aspx" id="A4">Rules & Regulations</a>
                                        </li>
                                    ...
                                    <ul class="dropdown">
                                        <li><a id="A13">Academic Units </a>
                                            <ul class="sup-dropdown">
                                                ...
                                                <li><a href="../Academics/ResearchCentres/Default.aspx" id="A15">Centres of Research</a></li>
                                                <li><a href="../Academics/SupportCentres/Default.aspx" id="A16">Support Centres</a></li>
                                                <li><a href="../Academics/TSUs/Default.aspx" id="A17">Technical Service Units</a></li>
                                        ...
                                        <li><a href="http://valuedu.nitrkl.ac.in/" id="A117">Value Education</a>
                                        </li>
                                    </ul>
                                </li>
                                <li>
                                    ...
                                    <ul class="dropdown">
                                        ...
                                        <li><a id="A47">Online Fee Payment</a>
                                            <ul class="sup-dropdown">
                                                <li><a href="https://eazypay.icicibank.com/homePage" id="A118" target="_blank">Registration Fee</a></li>
                                                <li><a href="http://nitrkl.ac.in/OldWebsite/onlinefeepayment/Student/Registration.aspx" id="A119" target="_blank">Other Fee</a></li>
                                            </ul>
                                        </li>
                                    </ul>
                                </li>
                                <li>
                                    ...
                                    <ul class="dropdown">
                                        ...
                                        <li><a href="../Institute/Rules/" id="A67">Rules & Regulations</a>
                                        </li>
                                        <li><a href="../Institute/Forms/" id="A121">Official Forms</a>
                                        </li>
                        ...
                        <div class="col-md-12 col-xs-12">
                            <div class="footer-widget social-widget">
                                ...
                                <ul class="social-icons">
                                    ...
                                    <li>
                                        <a href="https://josaa.nic.in/" target="_blank" class="outside-link">JoSAA</a>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <a href="http://qip.iitd.ac.in/qipadm2017/" target="_blank" class="outside-link">QIP</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
