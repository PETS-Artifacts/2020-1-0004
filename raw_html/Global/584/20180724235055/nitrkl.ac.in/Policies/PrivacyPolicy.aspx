...
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="/wEPDwUJNDMyNDU0NjAzD2QWAmYPZBYCZg9kFgICAw9kFgICpgEPZBYCAgEPDxYCHgRUZXh0BQ5Qcml2YWN5IFBvbGljeWRkZNP3oFdEVV9lCtszBllFDmYAvNGHmFAxfXYTKBGzSLRi" />
                            ...
                            <ul class="nav navbar-nav navbar-right">
                                ...
                                <li>
                                    ...
                                    <ul class="dropdown">
                                        ...
                                        <li><a href="http://nitrkl.ac.in/OldWebsite/Prospective_Students/6StudentAmenities/Default.aspx" id="dl36">Student Life</a>
                                            <ul class="sup-dropdown">
                                                <li><a href="http://sac.nitrkl.ac.in" id="A95" target="_blank">Student Activity Centre</a></li>
                                        ...
                                        <li><a id="dl312">Online Fee Payment</a>
                                            <ul class="sup-dropdown">
                                                <li><a href="https://eazypay.icicibank.com/homePage" id="A113" target="_blank">Registration Fee</a></li>
                                                <li><a href="http://nitrkl.ac.in/OldWebsite/onlinefeepayment/Student/Registration.aspx" id="A114" target="_blank">Other Fee</a></li>
                                            </ul>
                                        </li>
                                    </ul>
                                </li>
                                <li>
                                    ...
                                    <ul class="dropdown">
                                        ...
                                        <li><a href="../Academics/AcademicProcess/AcademicRegulations.aspx" id="A115">Regulations & Forms</a>
                                        </li>
                        ...
                        <li>
                                ...
                                <li>
                                    ...
                                    <ul class="dropdown">
                                        ...
                                        <li><a href="http://nitrkl.ac.in/Convocation/" id="A27">Convocation</a>
                                        </li>
                                    </ul>
                                </li>
                                <li>
                                    ...
                                    <ul class="dropdown">
                                        ...
                                        <li><a href="http://nitrkl.ac.in/OldWebsite/Prospective_Students/6StudentAmenities/Default.aspx" id="A39">Student Life</a>
                                            <ul class="sup-dropdown">
                                                <li><a href="http://sac.nitrkl.ac.in" id="A40" target="_blank">Student Activity Centre</a></li>
                                ...
                                <li>
                                    ...
                                    <ul class="dropdown">
                                        ...
                                        <li><a href="../Academics/AcademicProcess/AcademicRegulations.aspx" id="A67">Regulations & Forms</a>
                                        </li>
                    ...
                    <div class="row footer-widgets">
                        ...
                        <div class="col-md-3 col-xs-12">
                            <div class="footer-widget twitter-widget">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <p><a href="https://eapplication.nitrkl.ac.in/studentinfo/" target="_blank">Examination and Results</a></p>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-md-3 col-xs-12">
                            <div class="footer-widget twitter-widget">
                                ...
                                <ul>                                    
                                    <li>
                                        <p><a href="http://nitrkl.ac.in/DegreeVerification/">Degree Verification</a></p>
                                    </li>
                                    <li>
                        ...
                        <div class="col-md-3 col-xs-12">
                            <div class="footer-widget social-menu">
                                ...
                                <ul class="social-icons">
                                        <li><a href="https://twitter.com/nitrourkela" target="_blank" class="twitter"><i class="fa fa-twitter"></i></a></li>
                                        <li><a href="https://www.facebook.com/NIT-RKL-209644846287050/?modal=admin_todo_tour" target="_blank" class="facebook"><i class="fa fa-facebook"></i></a></li>
                                        <li><a href="https://www.youtube.com/channel/UCobv4F2xgS0cPzviz7HiNBA?view_as=subscriber" target="_blank" class="youtube"><i class="fa fa-youtube-play"></i></a></li>
                                    </ul>
                            </div>
                        </div>
                        <!-- .col-md-3 -->
                        ...
                        <div class="col-md-3 col-xs-12">
                            <div class="footer-widget contact-widget">
                                ...
                                <ul>
                                    <li>National Institute of Technology Rourkela, Odisha, India, 769008</li>
                                    ...
                                    <li><span>Fax:</span> 0661-246-2022 / 2926</li>                                    
                                    <li style="padding-top:10px;"><a href="/ContactUs/HowtoReach.aspx"><span>How to reach</span></a></li>
                                    <li><a href="/docs/Misc/CommunicationHandBook.pdf"><span>Communication Directories</span></a></li>
                                </ul>                                
                            </div>
                        </div>
                        <!-- .col-md-3 -->
                        ...
                        <div class="col-md-12 col-xs-12">
                            <div class="footer-widget social-widget">
                                ...
                                <ul class="social-icons">
                                    ...
                                    <li>
                                        <a href="#" target="_blank" class="outside-link">ICCR</a>
                                    </li>
                                    <li>
                                        <a href="#" target="_blank" class="outside-link">MEA</a>
                                    </li>
                                    <li>
                                        <a href="#" target="_blank" class="outside-link">GATE</a>
                                    </li>
                                    <li>
                                        <a href="#" target="_blank" class="outside-link">JEE Main</a>
                                    </li>
                                    <li>
                                        <a href="#" target="_blank" class="outside-link">JAM</a>
                                    </li>
                                    <li>
                                        <a href="#" target="_blank" class="outside-link">Ph.D.</a>
                                    </li>
                                    <li>
                                        <a href="#" target="_blank" class="outside-link">PDF</a>
                                    </li>
                                    <li>
                                        <a href="#" target="_blank" class="outside-link">MBA</a>
                                    </li>
                                    <li>
                                        <a href="#" target="_blank" class="outside-link">MA</a>
                                    </li>
                                    <li>
                                        <a href="#" target="_blank" class="outside-link">TEQIP</a>
                                    </li>
                                    <li>
                                        <a href="#" target="_blank" class="outside-link">QIP</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
