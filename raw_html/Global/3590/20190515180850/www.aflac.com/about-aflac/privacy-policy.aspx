...
<link rel="alternate" href="https://www.aflac.com/about-aflac/privacy-policy.aspx" hreflang="en-US"/>
    ...
    <link href="/_global-assets/css/master_cp.css" rel="stylesheet" type="text/css" />
        ...
        <script type="text/javascript"> var tranzTime = '5/15/2019 2:08:49 PM'; </script>
    <script type="text/javascript"> var clTime = '5/15/2019 12:08:49 PM'; </script>      
	<!--[if lt IE 9]>
                            ...
                            <fieldset class="form-step interests">
                                ...
                                <ul class="interest-list">
                                        ...
                                        <div class="checkbox-holder">
                                            <label class="checkbox has-orange-fg" data-manual="1">
                                                <input name="offering_1" type="checkbox" value="Accident">
                                                Accident</label>
                                        </div>
                                    </li>
                                                                        <li>
                                        <div class="checkbox-holder">
                                            <label class="checkbox has-orange-fg" data-manual="1">
                                                <input name="offering_2" type="checkbox" value="Cancer/Specified-Disease">
                                                Cancer/Specified-Disease</label>
                                        </div>
                                    </li>
                                                                        <li>
                                        <div class="checkbox-holder">
                                            <label class="checkbox has-orange-fg" data-manual="1">
                                                <input name="offering_3" type="checkbox" value="Critical Care and Recovery">
                                        ...
                                        <div class="checkbox-holder">
                                            <label class="checkbox has-orange-fg" data-manual="1">
                                                <input name="offering_4" type="checkbox" value="Dental">
                                                Dental</label>
                                        </div>
                                    </li>
                                                                        <li>
                                        <div class="checkbox-holder">
                                            <label class="checkbox has-orange-fg" data-manual="1">
                                                <input name="offering_5" type="checkbox" value="Juvenile Life">
                                                Juvenile Life</label>
                                        </div>
                                    </li>
                                                                    </ul>
                            </fieldset>
                            <fieldset data-di-form-track data-di-form-id="individuals-form-contact-info" class="form-step contact-info">
                                ...
                                <!--<p style="font-size: 10px; line-height: 12px;">By hitting submit, I agree to receive autodialed calls, to include scheduling reminders, and texts from Aflac, an independent contractor Aflac associate, and an Aflac Partner, such as Sutherland Global Services, MG LLC d/b/a TRANZACT or Clear Link Insurance Agency, LLC working at Aflac’s request, at the number provided. Message and data rates may apply. Carriers are not liable for delayed or undelivered messages. I understand I may also receive text messages about the status of my Aflac application and am not required to provide my consent as a condition of accessing Aflac’s website or purchasing Aflac’s products.</p>-->
                            </fieldset>
                            <fieldset class="form-step call-time" data-di-form-track data-di-form-id="individuals-form-call-time">
                                ...
                                <div class="form-disclaimer">
                                    <p>By hitting submit, I agree to receive autodialed calls, to include scheduling reminders, and texts from Aflac, an independent contractor Aflac associate, and an Aflac Partner, such as Sutherland Global Services, MG LLC d/b/a TRANZACT or Clear Link Insurance Agency, LLC working at Aflac’s request, at the number provided. Message and data rates may apply. Carriers are not liable for delayed or undelivered messages. I understand I may also receive text messages about the status of my Aflac application and am not required to provide my consent as a condition of accessing Aflac’s website or purchasing Aflac’s products.</p>
                                </div>
                            </fieldset>
                        </form>
                    </div>
...
<option value="https://my.aflac.com/" target="_blank">Agents</option>
	        ...
	        <div class="w_segmenu__content">
                <ul>
<li>
<a href="/individuals/default-1.aspx" >
...
<li>
<a href="/business/default-1.aspx" >
...
<div id="snippet_4077ca5c-b32a-47d2-864b-3c64c326922b"></div><script async type="text/javascript" src="//snippet.omm.crownpeak.com/s/3f36cd2b-67e6-452e-b3cb-f982243fa714?_wco_embedid=snippet_4077ca5c-b32a-47d2-864b-3c64c326922b"></script><script type="text/javascript">
//<![CDATA[
(function() {
var _analytics_scr = document.createElement('script');
_analytics_scr.type = 'text/javascript'; _analytics_scr.async = true; _analytics_scr.src = '/_Incapsula_Resource?SWJIYLWA=719d34d31c8e3a6e6fffd425f7e032f3&ns=2&cb=1755382047';
