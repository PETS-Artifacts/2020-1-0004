...
<!doctype html><!--[if lt IE 9]><html class="no-js lt-ie9 segment-individuals" lang="EN"><![endif]-->
...
<!--[if gt IE 9]><!--><html class="no-js segment-individuals" lang="EN"><!--<![endif]-->
    ...
    <!--Win8 Metro -->
    <meta name="msapplication-TileColor" content="#0099cc" /><meta name="msapplication-TileImage" content="/_Global-Assets/images/favicons/mstile_144x144.png" />    
...
<meta name="asset_id" content="21439"/>
			...
			<div class="lightbox-content">
				<div class="info-section">
					<div class="top">
						...
						<p>Aflac is insurance that pays you cash directly, to help pay for things that major medical doesn't cover. </p>
					</div>
					<div class="middle">
				...
				<div class="form-section">
					<ol class="progress-indicator">
						<li class="is-current">1. I'm interested in</li>
						...
						<div class="form-steps">
							<form action="#" method="POST">
								...
								<fieldset class="form-step contact-info">
									...
									<p style="font-size: 10px; line-height: 12px;">By hitting submit, I agree to receive autodialed calls from Aflac, an independent contractor Aflac associate, and Sutherland Global Services working at Aflac’s request, at the number provided. Message and data rates may apply. I understand I am not required to provide my consent as a condition of accessing Aflac’s website or purchasing Aflac’s products.</p>
								</fieldset>
                            ...
                            <p class="available">
									Monday - Friday <strong id="mf-start-time">8:00 AM</strong> to <strong id="mf-end-time">11:00 PM</strong> ET<br>
										 Saturday <strong id="sat-start-time">10:00 AM</strong> to <strong id="sat-end-time">6:00 PM</strong> ET<br>
                                         <!-- Sunday  <strong id="sat-start-time">12:00 PM</strong> to <strong id="sat-end-time">8:00 PM</strong> ET -->
										 <!-- Holiday Hours Friday 3/25: <strong id="sat-start-time">8:00 AM</strong> to  <strong id="sat-end-time">8:00 PM</strong> ET -->
									</p>
	...
	<div class="lightbox-content">
		<div class="info-section">
			...
			<div class="middle bottom-aligned">
							    <p>Fill out our <strong>Contact Form</strong> and we'll call you <em>or</em> Call Us now at <a href="tel:800.992.3522">800.992.3522</a></p>
            			</div>
		</div>
		<div class="form-section">
			...
			<div class="form-panel">
				<form>
					<div class="form-fields">
						...
						<div class="row two-part">
							<span class="input-text" data-manual="1">
								<input style="width: 430px" name="addressline1" type="text" placeholder="Address*" title="Address*">
							</span>
							<!-- <span class="input-text" data-manual="1">
								<input name="addressline2" type="text" placeholder="Address Line 2" title="Address Line 2">
							</span> -->
						</div>
...
<option value="1000">1000+</option>
								...
								<div class="captioned-list">
									...
									<ul>
                                        										<li>
											<label class="checkbox" data-manual="1"><input name="individual" type="checkbox" value="Individual"> Individual Policies</label>
										</li>
                                        										<li>
											<label class="checkbox" data-manual="1"><input name="group" type="checkbox" value="Group"> Group Policies</label>
											<span id="bizgroup"></span>
										</li>
                                        										<li>
											<label class="checkbox" data-manual="1"><input name="findout" type="checkbox" value="Find best option"> Working with Aflac to find the best option for me.</label>
										</li>
                                        									</ul>
								</div>
							</div>
...
<body id="rcc"><script type="text/javascript">
	(function(){
...
<option value="https://my.aflac.com/" target="_blank">Employers</option>
...
<h4>Learn how Aflac pays you and your family money for the expenses that Major Medical doesn't cover.</h4>
...
<div class="hover-bg"></div>
<div class="text-container">
<h6 class="is-small">Employers</h6>
<h4>Aflac lets you provide your employees with the best benefits without costing you a penny.</h4>
<div class="icon-holder">
<div class="icon"></div>
</div>
</div>
...
<h4>Explore the unlimited potential and flexibility that comes with a new career as an Aflac insurance agent.</h4>
<div class="icon-holder">
<div class="icon"></div>
</div>
</div>
		        ...
		        <div class="content">
                    ...
                    <a class="logo" alt="Aflac" href="/about-aflac/default.aspx"></a>
						<a href="#" class="menu-toggle"></a>
				        						<div class="contact-trigger contact-button">
					        Request a Quote
				        </div>
															        </nav>
			        <div class="menu">
...
<li>
<a href="/about-aflac/corporate-citizenship/fighting-pediatric-cancer.aspx">Fighting Pediatric Cancer</a>
</li>
<li>
...
<div class="i-title">
<p><strong><a href="#scope-consent">Scope and consent</a></strong></p>
</div>
<div class="i-info">
...
<div class="i-title">
<p><strong><a href="#information-collection">Information Collection</a></strong></p>
</div>
<div class="i-info">
...
<div class="i-info">
<p><strong><a href="#registration-enrollment">(a) Registration, Enrollment, and Account Information:</a></strong> When you create an account for the Services, you voluntarily give us personal information.</p>
</div>
</div>
<div class="clear"></div>
...
<div class="i-title"></div>
<div class="i-info">
<p><strong><a href="#claims-information">(b) Claims Information:</a></strong> You may give us your personal information when you submit, change or update a claim.</p>
</div>
</div>
<div class="clear"></div>
...
<div class="i-title"></div>
<div class="i-info">
<p><strong><a href="#information-to-respond">(c) Information to Respond to Your Requests:</a></strong> You may give us your personal information so we can respond to your requests for information, respond to and process applications, and send you newsletters and other communications.</p>
</div>
</div>
<div class="clear"></div>
...
<div class="i-title"></div>
<div class="i-info">
<p><strong><a href="#social-media">(d) Social Media Information:</a></strong> When you sign in or engage with our Site through third-party social media sites, you agree to give us on-going access to your personal information.</p>
</div>
</div>
<div class="clear"></div>
...
<div class="i-title"></div>
<div class="i-info">
<p><strong><a href="#video-information">(e) Video Information:</a></strong> We may collect analytical information about the videos you view on the Site. You consent to our collection of video viewing information on the Site and sharing this information with our affiliates and vendors.</p>
</div>
</div>
<div class="clear"></div>
...
<div class="i-title"></div>
<div class="i-info">
<p><strong><a href="#survey-information">(f) Survey Information:</a></strong> From time to time, we may ask you to complete surveys relating to your experiences with the Services. In connection with same, we may obtain your demographic information (e.g., city, state, account ID, date of birth).</p>
</div>
</div>
<div class="clear"></div>
...
<div class="i-title"></div>
<div class="i-info">
<p><strong><a href="#information-about-others">(g) Information About Others:</a></strong> If you are an employer, Aflac broker or agent, you may submit applications or other information for your employees or clients. If you make a donation on the Site (e.g., <a href="http://duckprints.aflac.com" target="new">duckprints.aflac.com</a>), you may also submit information about another person. You confirm that you have obtained the required consent to submit this third party information to us.</p>
</div>
</div>
<div class="clear"></div>
...
<div class="i-title"></div>
<div class="i-info">
<p><strong><a href="#information-from-others">(h) Information From Other Sources or Combined by Us:</a></strong> We may, on occasion, combine information from outside sources to customize your experience with the Services.</p>
</div>
</div>
<div class="clear"></div>
<div class="policy-legend-item lt-border"><img style="width: 35px;" alt="item icon" src="/_global-assets/images/policies/icons/registration-enrollment-account-info.jpg"/>
<div class="i-title"></div>
<div class="i-info">
<p><strong><a href="#mobile-information">(i) Mobile Information:</a></strong> We may collect additional information from you if you access our Site through a mobile device (e.g. your unique device identifier, location or GPS/geo-location).</p>
</div>
</div>
<div class="clear"></div>
...
<div class="i-title"></div>
<div class="i-info">
<p><strong><a href="#technical-usage">(j) Technical Usage Information:</a></strong> We use tracking technologies such as cookies and other similar technologies to measure usage. For more information about the use of cookies and similar technologies on our Site, please review our <a href="/about-aflac/cookies-and-tracking-technology-policy.aspx">Cookies and Tracking Technologies Policy</a>.</p>
</div>
</div>
<div class="clear"></div>
...
<div class="i-title"></div>
<div class="i-info">
<p><strong><a href="#geolocation">(k) Geolocation:</a></strong> By using the site you expressly consent to our use of your geolocation to respond to your requests.</p>
</div>
</div>
<div class="clear"></div>
...
<div class="i-title"></div>
<div class="i-info">
<p><strong><a href="#call-center">(l) Call Center Information:</a></strong> When you call our Call Center, we may collect your name, account ID and other information to assist you.</p>
</div>
</div>
<div class="clear"></div>
...
<div class="i-title"></div>
<div class="i-info">
<p><strong><a href="#site-participation-submit">(m) Information You Submit To Participate in Site Activities:</a></strong> When you visit some of our Sites (e.g., <a href="http://duckprints.aflac.com" target="new">duckprints.aflac.com</a>), you may have the opportunity to provide certain Personal Information to participate in an activity. We will collect and store this information to effectuate your choices to participate in an activity.</p>
</div>
</div>
<div class="clear"></div>
<div class="policy-legend-item border"><img style="width: 35px;" alt="item icon" src="/_global-assets/images/policies/icons/shopping-cart.jpg"/>
<div class="i-title"></div>
<div class="i-info">
<p><strong><a href="#shopping-cart">(n) Information You Submit to Purchase Products:</a></strong> When you visit some of our Sites (e.g., <a href="http://duckprints.aflac.com" target="new">duckprints.aflac.com</a>), you may have the opportunity to purchase products and make donations. We collect this information to process your payments.</p>
</div>
</div>
<div class="clear"></div>
...
<div class="i-title">
<p><strong><a href="#uses-retention">Uses and Retention</a></strong></p>
</div>
<div class="i-info">
...
<div class="i-title">
<p><strong><a href="#disclosure">Disclosures</a></strong></p>
</div>
<div class="i-info">
...
<div class="i-title">
<p><strong><a href="#hipaa-notice">HIPAA Notice of Privacy Practices</a></strong></p>
</div>
<div class="i-info">
...
<div class="i-title">
<p><strong><a href="#your-choices">Your Choices</a></strong></p>
</div>
<div class="i-info">
...
<div class="i-title">
<p><strong><a href="#cookies-tracking">Cookies and Tracking Technologies</a></strong></p>
</div>
<div class="i-info">
<p>We use tracking technologies (including cookies) to recognize you, protect your privacy, customize your experience on the Site, and target the content/advertising you see, including providing videos customized to your interests. You consent to our tracking of your video viewing through the Site or third-party social media.</p>
</div>
</div>
<div class="clear"></div>
...
<div class="i-title">
<p><strong><a href="#access-review-options">Access and Review Options</a></strong></p>
</div>
<div class="i-info">
...
<div class="i-title">
<p><strong><a href="#california-privacy">California Privacy Rights</a></strong></p>
</div>
<div class="i-info">
...
<div class="i-title">
<p><strong><a href="#third-party">Third-Parties</a></strong></p>
</div>
<div class="i-info">
<p>We are not responsible for the privacy practices of third-party websites that are linked to or from our Site.</p>
</div>
</div>
<div class="clear"></div>
...
<div class="i-title">
<p><strong><a href="#security">Security</a></strong></p>
</div>
<div class="i-info">
...
<div class="i-title">
<p><strong><a href="#childrens-privacy">Children&rsquo;s Privacy</a></strong></p>
</div>
<div class="i-info">
...
<div class="i-title">
<p><strong><a href="#international-transfer">International Transfer</a></strong></p>
</div>
<div class="i-info">
...
<div class="i-title">
<p><strong><a href="#notification-updates">Notification Regarding Updates</a></strong></p>
</div>
<div class="i-info">
...
<div class="i-info">
<p>For more information about our privacy practices, send an email to <a href="mailto:privacyoffice@aflac.com">privacyoffice@aflac.com</a>. If you are a CAIC account or certificate holder, you may send an email to <a href="mailto:aflacgroupprivacyoffice@aflac.com">aflacgroupprivacyoffice@aflac.com</a>.</p>
</div>
</div>
<div class="clear"></div>
</div>
...
<li><strong id="survey-information">Survey Information:</strong> You agree that we may collect and share your demographic information (including city, state, and date of birth), claim number, policy holder or certificate holder information, and other information you may provide to conduct policy holder or certificate holder surveys.</li>
<li><strong id="information-about-others">Information About Others:</strong> Employers, Aflac brokers and agents, and their designees may choose to submit applications for other people, either on the Site or through an affiliate or vendor of ours. The applications for Aflac products and services may contain the applicants&rsquo; personal information. When you visit some of our Sites (e.g., <a href="http://duckprints.aflac.com" target="new">duckprints.aflac.com</a>), you may have the option to make donations on behalf of another person. We will collect certain Personal Information (e.g., name, email) of the other person to connect them to or notify them of the donation. By submitting information on behalf of someone else to us, you represent and confirm that you have obtained consent from them to do so.</li>
<li><strong id="information-from-others">Information From Other Sources or Combined by Us:</strong> The information we collect may be combined with information from outside records (e.g., demographic information, navigation information, and/or additional contact information) that we have acquired in accordance with the law. If you are a policyholder or certificateholder of Aflac, personal information that you provide at Sites may be combined with certain other information we have collected about you through our policy application/administration procedures. In reviewing applications, policies, claims or performing our Services, we may collect additional information from you or others, such as from other insurance companies, consumer reporting agencies and credit bureaus as permitted by the Fair Credit Reporting Act, public records, government agencies, and information clearinghouses. In addition, you will have received a Privacy Notice from us explaining how we protect the privacy and security of information you provide (please see <a href="#hipaa-notice">HIPAA Notice of Privacy Practices</a> below in Section 5).</li>
...
<li><strong id="technical-usage">Technical Usage Information:</strong> When you visit our Site, we collect usage information sent to us by your computer, mobile, or other access device that tells us how you are using the Site (&ldquo;usage information&rdquo;). We use tracking technologies (including <a href="/about-aflac/cookies-and-tracking-technology-policy.aspx#cookies">cookies</a> (<a href="/about-aflac/cookies-and-tracking-technology-policy.aspx#cookies">including cookies stored in HTML-5</a>), <a href="/about-aflac/cookies-and-tracking-technology-policy.aspx#web-beacons">web beacons/GIFs</a>, <a href="/about-aflac/cookies-and-tracking-technology-policy.aspx#embedded-script">embedded scripts</a>, <a href="/about-aflac/cookies-and-tracking-technology-policy.aspx#unique-device-id">unique device ID</a>, and <a href="/about-aflac/cookies-and-tracking-technology-policy.aspx#e-tags">e-tags/cache browsers</a>) to collect usage information.<br/> <br/> We may also collect password information from you when you log in, as well as computer and/or connection information. During some visits we may use software tools to measure and collect session information, pages viewed, including page response times, files downloaded, download errors, time spent on certain pages, page interaction information, applications used, browser type, the user&rsquo;s Internet service provider (ISP), and the user&rsquo;s computer operating system.<br/><br/> Our goal is to collect and use only that information that we think is required for our legitimate business purposes, in order to better understand your interests and improve the Services. To learn more about how we use tracking technologies and cookies, see <a href="#cookies-tracking">Section 7 of this Privacy Policy</a> and also our full <a href="/about-aflac/cookies-and-tracking-technology-policy.aspx">Cookies and Tracking Technologies Policy</a>.</li>
<li><strong id="geolocation">Geolocation Information:</strong> When you visit the Site, we may collect geo-location information to provide certain location-based services that you request (e.g., maps) or any of the reasons set forth in <a href="#uses-retention">Section 3</a> of this Privacy Policy. We may disclose the geolocation data in the manner set forth in <a href="#disclosure">Section 4</a> of this Privacy Policy.</li>
...
<li><strong id="site-participation-submit">Information You Submit To Participate in Site Activities:</strong> When you visit some of our Sites (e.g., <a href="http://duckprints.aflac.com" target="new">duckprints.aflac.com</a>), you may have the opportunity to provide certain Personal Information (e.g., name, email, address information, and health information) to participate in an activity (e.g., Submit Your Story <a href="http://duckprints.aflac.com/footprints" target="new">duckprints.aflac.com/footprints</a> (&ldquo;Site Activity&rdquo;). We will collect and store this information to effectuate your choices to participate in a Site Activity.</li>
<li><strong id="shopping-cart">Information You Submit to Purchase Products:</strong> When you visit some of our Sites (e.g., <a href="http://duckprints.aflac.com" target="new">duckprints.aflac.com</a>), you may have the opportunity to purchase products (e.g., T-shirts, slippers, plush duck) and make donations. We will collect certain Personal Information (e.g., name, phone, email, address, and payment information) to facilitate the purchases you wish to make. We collect this information to process your payments.</li>
</ol></li>
<li><strong id="uses-retention">Uses and Retention</strong><ol>
<li><strong>Provide Our Services:</strong> We use the information collected to (i) respond to your requests; (ii) allow you to manage your policies and claims; (iii) allow us to service your policies and manage your claims; (iv) give you information about your account; (v) provide customer service (e.g., to resolve disputes, problems with your account/profile or the Services); (vi) personalize your experience by providing content to you that we believe may be of most interest to you; (vii) operate our promotions (e.g., provide you with entries to and information regarding our sweepstakes and contests); (viii) manage, administer and improve our operations and Services, including Services via employers, brokers, agents and enrollment systems; (iv) conduct surveys; and (v) provide you with a safe, efficient, and customized experience.</li>
...
<li><strong>Notices of Information We Share Pursuant to State and Federal Laws:</strong> Under various state laws and the Gramm-Leach-Bliley Act, insurers and agents must describe their information practices in addition to providing a HIPAA Notice of Privacy Practices. If you are a resident of the following, please click the links below to obtain more information:
<ul class="pdf-icons">
<li><a title="GLBA Aflac Privacy Practices in California" href="/docs/about-aflac/glba-aflac-privacy-practices-a90070-ca.pdf" target="_blank">California</a></li>
<li><a title="GLBA Aflac Privacy Practices in Delaware" href="/docs/about-aflac/glba-aflac-privacy-practices-a90070-de.pdf" target="_blank">Delaware</a></li>
<li><a title="GLBA Aflac Privacy Practices in Illinois" href="/docs/about-aflac/glba-aflac-privacy-practices-a90070-il.pdf" target="_blank">Illinois</a></li>
<li><a title="GLBA Aflac Privacy Practices in Montana" href="/docs/about-aflac/glba-aflac-privacy-practices-a90070-03-mt.pdf" target="_blank">Montana</a></li>
<li><a title="GLBA Aflac Privacy Practices in New Jersey" href="/docs/about-aflac/glba-aflac-privacy-practices-a90070-nj.pdf" target="_blank">New Jersey</a></li>
<li><a title="GLBA Aflac Privacy Practices in Puerto Rico" href="/docs/about-aflac/glba-aflac-privacy-practices-a90070-pr.pdf" target="_blank">Puerto Rico</a></li>
<li><a title="GLBA Aflac Privacy Practices in Washington" href="/docs/about-aflac/glba-aflac-privacy-practices-a90070-wa.pdf" target="_blank">Washington</a></li>
<li><a title="GLBA Aflac Privacy Practices in all states" href="/docs/about-aflac/glba-aflac-privacy-practices-a90070-all-states.pdf" target="_blank">All other states</a></li>
</ul>
</li>
</ol></li>
<li><strong id="hipaa-notice">HIPAA Notice of Privacy Practices</strong>
<p>The Health Insurance Portability and Accountability Act of 1996 (HIPAA) Privacy Rule provides individuals with the right to receive a notice that describes (1) how their individual health information, personal information and other protected health information (&ldquo;PHI&rdquo;) may be used and/or disclosed, (2) their privacy rights with respect to their PHI (including their right to access their PHI and other rights), and (3) Aflac&rsquo;s obligations with respect to that information. Aflac is fully committed to its compliance with the HIPAA Rules, including the Privacy Rule, in safeguarding PHI.<br/><br/> For its HIPAA-covered insurance policies, Aflac is federally mandated to send a notice (Notice of Privacy Practices) to its insureds and to post the notice on its website. You should be aware that your state law may provide additional access and amendment rights to you which differ from those granted by HIPAA. If you would like additional information concerning the collection and disclosure of PHI and your rights under state law to access and amend such information, it will be furnished upon request. Please e-mail your request to <a href="mailto:privacyoffice@aflac.com">privacyoffice@aflac.com</a>. If you are a CAIC account or certificate holder, please email your request to <a href="mailto:aflacgroupprivacyoffice@aflac.com">aflacgroupprivacyoffice@aflac.com</a>.<br/><br/> In order to access Aflac&rsquo;s HIPAA Notice of Privacy Practices, please select the state or U.S. territory where you live:</p>
<ul class="pdf-icons">
<li><a title="HIPAA Notice of Privacy Practices in Puerto Rico" href="/docs/about-aflac/hipaa-notice-of-privacy-practices-a90069-pr.pdf" target="_blank">Puerto Rico</a></li>
<li><a title="HIPAA Notice of Privacy Practices in all states" href="/docs/about-aflac/hipaa-notice-of-privacy-practices-a90069.pdf" target="_blank">All other states</a></li>
</ul>
</li>
<li><strong id="your-choices">Your Choices</strong>
<p>You can opt-out of notifications from Aflac by following instructions within the notices or emailing your opt-out request to <a href="mailto:webmaster@aflac.com">webmaster@aflac.com</a>. You may not opt-out of administrative emails (for example, emails about your transactions or policy changes) for your registered account. You can opt-out of receiving communications by expressing your preferences to us using one of the mechanisms described in the Contact Us section below.</p>
</li>
<li><strong id="cookies-tracking">Cookies and Tracking Technologies</strong>
<p>When you visit the Site, we and our business partners may use cookies and other tracking technologies for a variety of purposes and to enhance your online experience, for example, by remembering your log-in status and viewing preferences from a previous use of our Site, for when you later return to the Site.<br/><br/> A few additional important things you should know about our use of tracking technologies (e.g., cookies, unique device ID, HTML-5 stored technologies):</p>
<ul>
...
<li>You may encounter tracking technologies/cookies from our third-party service providers that we have allowed on our Site that assist us with various aspects of our <a href="/about-aflac/cookies-and-tracking-technology-policy.aspx#cookies-and-tracking-on-the-aflac-site">Site operations and services</a>, such as Google Analytics.</li>
<li>You also may encounter tracking technologies from third-parties on certain pages of the websites that we do not control and have not authorized. (For example, if you view a web page created by another user, there may be a cookie placed by that web page.)</li>
...
<p>Our Site may contain links to other third-party websites. We are not responsible for the privacy practices or the content of these third-party sites.</p>
</li>
...
<p>If your questions are not answered online through this Policy or websites, you may email us at <a href="mailto:webmaster@aflac.com">webmaster@aflac.com</a>, or contact us as follows:</p>
...
<div>
<p>CAIC<br/> 1600 Williams St.<br/> Columbia, South Carolina 29201<br/> 800.433.3036</p>
</div>
</div>
<div class="address-container two">
<div class="address-inner">
<p><strong>Mailing and Email Address</strong></p>
<p>Aflac Worldwide Headquarters<br/> Attn: Privacy Office<br/> 1932 Wynnton Road<br/> Columbus, Georgia 31999<br/> 800.992.3522<br/> <a href="mailto:privacyoffice@aflac.com">privacyoffice@aflac.com</a></p>
</div>
<div>
<p>CAIC<br/> Attn: Privacy Office<br/> Post Office Box 84075<br/> Columbus, GA 31993<br/> 800.433.3036<br/> <a href="mailto:aflacgroupprivacyoffice@aflac.com">aflacgroupprivacyoffice@aflac.com</a></p>
</div>
</div>
</li>
</ol>
<p class="policy-disclaimer"><sup class="size-15">*</sup> <em>Continental American Insurance Company (CAIC), a proud member of the Aflac group of insurers, is a wholly-owned subsidiary of Aflac Incorporated and underwrites group coverage. CAIC is not licensed to solicit business in New York, Guam, Puerto Rico, or the Virgin Islands. For groups sitused in California, coverage is underwritten by CAIC. For groups sitused in New York, coverage is underwritten by American Family Life Assurance Company of New York.</em></p></div>
</div>
...
<li class="social-buttons_facebook"><a href="https://www.facebook.com/aflacduck" target="_blank"><img src="/_global-assets/images/footer/footer-facebook.png" alt="Share on Facebook"/></a></li><li class="social-buttons_twitter"><a href="https://twitter.com/aflac" target="_blank"><img src="/_global-assets/images/footer/footer-twitter.png" alt="Share on Twitter"/></a></li><li class="social-buttons_gplus"><a href="https://plus.google.com/112479930117560620562" target="_blank"><img src="/_global-assets/images/footer/footer-gplus.png" alt="Share on Google+"/></a></li><li class="social-buttons_linkedin"><a href="https://www.linkedin.com/company/aflac" target="_blank"><img src="/_global-assets/images/footer/footer-linkedin.png" alt="Share on Linkedin"/></a></li><li class="social-buttons_instagram"><a href="http://instagram.com/aflacduck" target="_blank"><img src="/_global-assets/images/footer/footer-instagram.png" alt="Share on Instagram"/></a></li><li class="social-buttons_youtube"><a href="https://www.youtube.com/user/aflac" target="_blank"><img src="/_global-assets/images/footer/footer-youtube.png" alt="Share on Linkedin"/></a></li></ul>
...
<li class="external"><a href="https://www.duckgear.com/index.cfm?" class="textlink " target="_blank">Duck Gear</a></li>
...
<li><a href="/about-aflac/terms-of-use.aspx" class="textlink ">Terms of Use</a></li>
                ...
                <div class="w_footer_legal">
                    <div class="footer_legal-top">
                        <p class="copyright">
                        &copy; 2016 AFLAC INCORPORATED                        </p>
...
try{(new g(30,"v","QSI_S_ZN_5sBiQ8OnUSb0vml","//zn5sbiq8onusb0vml-aflac.siteintercept.qualtrics.com/WRSiteInterceptEngine/?Q_ZID=ZN_5sBiQ8OnUSb0vml&Q_LOC="+encodeURIComponent(window.location.href))).start()}catch(i){}})();
</script><div id='ZN_5sBiQ8OnUSb0vml'><!--DO NOT REMOVE-CONTENTS PLACED HERE--></div>
<!--END SITE INTERCEPT-->
			 
<script type="text/javascript" src="//snippet.omm.crownpeak.com/s/3f36cd2b-67e6-452e-b3cb-f982243fa714"></script>
<script type="text/javascript">
//<![CDATA[
(function() {
