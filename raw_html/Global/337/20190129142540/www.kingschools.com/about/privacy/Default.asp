...
<script type="text/javascript">
    ...
    {
        case "Chrome":
            if (objBrMajorVersion < 49) bShowWarning = true;
            break;

        case "Safari":
            if (objBrMajorVersion < 7) bShowWarning = true;
            break;
        ...
        case "Firefox":
            if (objBrMajorVersion < 11) bShowWarning = true;
            break;
    }

    //if (bShowWarning)
    //{
    //document.write('<div align="center" class="msgBox msgBox-alert" style="padding:5px;border:1px solid #b40001;text-align:center;margin-bottom:5px;"><em><span class="redSubHeader"><b>Important:</b> You are using an outdated browser and due to new required <a href="https://blog.pcisecuritystandards.org/are-you-ready-for-30-june-2018-sayin-goodbye-to-ssl-early-tls" target="_blank" style="font-size:11pt;">security standards</a>,<br />you will not be able to purchase online after June 30th.<br /><a href="https://www.whatismybrowser.com/guides/how-to-update-your-browser/auto" target="_blank" style="font-size:11pt;">Click here</a> for a guide to updating your browser.<br />Please call (800) 854-1001 for questions or to order with one of our friendly pilot advisors.</span></em></div>');
    //}
        ...
        <ul class="dropdown">
        	<li><a href="#">Becoming a Pilot&nbsp;&nbsp;</a>
                <ul class="sub_menu">
                    ...
                    <li><a href="/ground-school/drone-pilot/">Drone&nbsp;Pilot&nbsp;Training</a></li>
                    <li><a href="/drone-pilot-training">Drone Pilot Information</a></li>
                    <li><a href="/pilot-supplies/books/king-online-aviation-library">King Online Aviation Library</a></li>
        	...
        	<li><a href="#">Pro / Turbine&nbsp;&nbsp;</a>
                <ul class="sub_menu">
                    ...
                    <li><a href="/aviation-courses/airline-pilot">Boeing &amp; Airbus Courses</a></li>
                    <li><a href="/pilot-supplies/books/king-online-aviation-library">King Online Aviation Library</a></li>
               	</ul>
        	</li>

            <li><a href="#">Flight Schools&nbsp;&nbsp;</a>
        		<ul class="sub_menu">
                    <li><a href="/CessnaFlightTrainingSystem">Cessna Flight Training System</a></li>
                    <li><a href="https://cessnaflighttraining.kingschools.com" target="_blank">Cessna Pilot Centers</a></li>
                    <li><a href="/CessnaFlightTrainingSystem/FlightSchools">Flight Schools</a></li>
                    <li><a href="/CessnaFlightTrainingSystem/Educators">University, College &amp; High School</a></li>
                    <li><a href="/pilot-supplies/books/king-online-aviation-library">King Online Aviation Library</a></li>
		        </ul>
        	</li>
            ...
            <li><a href="#">Supplies&nbsp;&nbsp;</a>
        		<ul class="sub_menu">
                    <li><a href="/pilot-supplies/books/king-online-aviation-library">King Online Aviation Library</a></li>
                    <li><a href="/pilot-supplies/equipment-kits">Pilot Training Equipment Kits</a></li>
    ...
    <div id="headerSearch">
      ...
      <div class="customershopping2" style="z-index:150;">
        <div class="headerButton">
            <ul id="shoppingAccount2"><div class="myCartText"><a href="/Cart/Cart_Detail.asp?UID=3304012906254002">My Cart&nbsp;&nbsp;&nbsp;<img src="/otherimages/home-page/cart-icon.png" border="0" style="vertical-align:middle; margin-top:3px;" /></a>
      ...
      <div class="bookmark" style="right: -155px;">
...
<div id="address"> &copy; 2019 King Schools, Inc. All Rights Reserved<br />
