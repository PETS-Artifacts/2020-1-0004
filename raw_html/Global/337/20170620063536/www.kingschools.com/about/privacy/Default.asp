    ...
    <div id="headerSearch">
      ...
      <div class="customershopping2" style="z-index:150;">
        <div class="headerButton">
            <ul id="shoppingAccount2"><div class="myCartText"><a href="/Cart/Cart_Detail.asp?UID=3656061923353662">My Cart&nbsp;&nbsp;&nbsp;<img src="/otherimages/home-page/cart-icon.png" border="0" style="vertical-align:middle; margin-top:3px;" /></a>
		        <li class="accountLink">
    		        <ul class="accountItems">
        		        <li><a href="/Cart/Cart_Detail.asp?UID=3656061923353662">My Cart</a></li>
                        <li><a href="https://kingschools.com/login/register.asp?section=MYACCT">My Shopping Account</a></li>
            		    <li><a href="https://kingschools.com/login/?section=OrdStat">My Orders</a></li>
...
<div id="global-footercontainer">
  <div id="footerblock">
    ...
    <div class="footerlinkcontainer">
      <h5>Ordering</h5>
      <ul>
        <li><a href="https://kingschools.com/login/?section=OrdStat"></a></li>
        <li><a href="/shippingInfo.asp?bHideButtons=1" class="ceebox" title="Shipping Options">Shipping Options</a></li>
        <li><a href="https://kingschools.com/login/register.asp?section=MYACCT"></a></li>
      </ul>
    </div>
    <div class="footerlinkcontainer">
      <h5>Resources</h5>
