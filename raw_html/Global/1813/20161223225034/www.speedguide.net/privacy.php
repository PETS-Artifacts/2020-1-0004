...
<!-- PG tag -->
<script type="text/javascript" src="//dsh7ky7308k4b.cloudfront.net/publishers/speedguidenet.min.js"></script>
<!-- dfp tags -->
<script type='text/javascript'>
...
<a href="/"><img src="/images/elem/sglogo5_santa.gif" alt="The Broadband Guide" style="width: 290px; height: 50px; border: 0;"></a>
</div>
...
<div class="twrap1">
	...
	<div class="tbody1">
		<ul class="sgy">
			<li><a href="/broadband-list.php" title="Broadband Hardware Database" class="link2">3700+ Routers</a></li>
...
<a href="http://www.speedguide.net/rss/" target="_blank" rel="nofollow" title="SG RSS feeds"><span class="icon-rss"> </span></a>
</div>
...
<script type="text/javascript">
	...
	var sgsnow=readCookie("sgsnow");


    var randsnow=Math.floor(Math.random()*101);
    if (randsnow > 85 && sgsnow != '0') {
        document.write ("<" + "script type='text/javascript' src='");
        document.write ("http://www.speedguide.net/images/js/snow.js");
