...
<script>
    ...
    var dartGenre = 'music_photos';
    var dartCategory = 'music_photos';
    var dartKeyword = '_mn';
</script>
<script type="text/javaScript" >
    SW.adSettings = {};
    ...
    SW.adSettings.DoubleClickSections='music_photos/_mn';
    SW.adSettings.DoubleClickKeyValues = '!category=music_photos;!category=pop;!category=float;!category=expand;';
