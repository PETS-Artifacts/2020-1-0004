...
<script>
    ...
    var dartGenre = 'time_management';
    var dartCategory = 'time_management';
    var dartKeyword = 'hoteldashsuitesuccess';
</script>
<script type="text/javaScript" >
    SW.adSettings = {};
    SW.adSettings.DoubleClickDartSite = 'sw.nol';
    SW.adSettings.DoubleClickPositionThreshold = '1';
    SW.adSettings.DoubleClickSections='time_management/hoteldashsuitesuccess';
    SW.adSettings.DoubleClickKeyValues = '!category=time_management;!category=pop;!category=float;!category=expand;';
