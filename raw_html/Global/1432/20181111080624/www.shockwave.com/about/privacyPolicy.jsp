...
<script>
    ...
    var dartGenre = 'matching';
    var dartCategory = 'matching';
    var dartKeyword = 'safari-venture';
</script>
<script type="text/javaScript" >
    SW.adSettings = {};
    SW.adSettings.DoubleClickDartSite = 'sw.nol';
    SW.adSettings.DoubleClickPositionThreshold = '1';
    SW.adSettings.DoubleClickSections='matching/safari-venture';
    SW.adSettings.DoubleClickKeyValues = '!category=matching;!category=pop;!category=float;!category=expand;';
