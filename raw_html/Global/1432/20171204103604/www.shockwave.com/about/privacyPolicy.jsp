...
<script>
    ...
    var dartKeyword = 'daily-spot-the-pic';
</script>
<script type="text/javaScript" >
    SW.adSettings = {};
    SW.adSettings.DoubleClickDartSite = 'sw.nol';
    SW.adSettings.DoubleClickPositionThreshold = '1';
    SW.adSettings.DoubleClickSections='puzzle/daily-spot-the-pic';
