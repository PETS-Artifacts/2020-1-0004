...
<script>
    ...
    var dartKeyword = 'wordroundupbingo';
</script>
<script type="text/javaScript" >
    SW.adSettings = {};
    SW.adSettings.DoubleClickDartSite = 'sw.nol';
    SW.adSettings.DoubleClickPositionThreshold = '1';
    SW.adSettings.DoubleClickSections='wordgames/wordroundupbingo';
    ...
    SW.adSettings.DoubleClickAutoDcopt=true;
		...
		<link rel="canonical" href="http://www.shockwave.com/about/privacyPolicy.jsp" />
        ...
        <meta property="og:url"	content="http://www.shockwave.com/about/privacyPolicy.jsp" />
		...
		<link href=http://cdn7.shockwave.com/min/css/global.css type="text/css" rel="stylesheet"/>
...
<!-- End Google Tag Manager -->
		...
		<script type="text/javascript" src=http://cdn7.shockwave.com/min/js/globalJsBodyPreTEMP.min.js></script>
	
	
	


	<script type="text/javascript" src=http://cdn7.shockwave.com/js/sw-coda/sw-coda.js></script>

	

	
		<script type="text/javascript" src=http://cdn7.shockwave.com/min/js/globalJsBodyPostTEMP.min.js></script>
            ...
            <ul class="clearfix">
                ...
                <li id="subtab-1" ><a title="All Free Online Games" href="/online/all-games.jsp">All Games</a></li>
                    ...
                    <li id="99sale" class="">
                        ...
                        <a title="" href="http://www.shockwave.com/download/special/sales.jsp">Sale</a>
                    </li>
                    ...
                    <li><b class="buffer"><!-- --></b> </li>
                    <li id="racing">
                        <a title="Racing Games" href="/online/racing-games.jsp">Racing</a>
                    </li>
...
<div class="col col8 subSection nickFrame">
	<div class="pod podWhite">
		...
		<script type="text/javascript" src=http://cdn7.shockwave.com/min/js/globalFooterTEMP.min.js></script>
