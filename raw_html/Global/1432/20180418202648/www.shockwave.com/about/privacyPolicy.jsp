...
<script>
    ...
    var dartGenre = 'hidden_objects';
    var dartCategory = 'hidden_objects';
    var dartKeyword = 'youda-mystery-stanwick-legacy';
</script>
<script type="text/javaScript" >
    SW.adSettings = {};
    SW.adSettings.DoubleClickDartSite = 'sw.nol';
    SW.adSettings.DoubleClickPositionThreshold = '1';
    SW.adSettings.DoubleClickSections='hidden_objects/youda-mystery-stanwick-legacy';
    SW.adSettings.DoubleClickKeyValues = '!category=hidden_objects;!category=pop;!category=float;!category=expand;';
