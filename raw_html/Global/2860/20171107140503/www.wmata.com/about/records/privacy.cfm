...
<html class="no-js" lang="en" > <head> <meta http-equiv="x-ua-compatible" content="ie=edge"> <title>Privacy Policy and Legal Disclaimer | WMATA</title>
...
layoutID = "1005^Privacy Policy and Legal Disclaimer";
...
<script type="text/javascript" src="/components/NewsAndAlerts.cfc?method=get&newsLayout=1005%5EPrivacy%20Policy%20and%20Legal%20Disclaimer&emergency=0"></script>
<script src="//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-55e066228b32154a" async></script>
<script>
function googleTranslateElementInit() {
new google.translate.TranslateElement({pageLanguage: 'en', includedLanguages: 'en,es,fr,ko,vi,zh-CN', layout: google.translate.TranslateElement.InlineLayout.SIMPLE}, 'google_translate_element');
}
</script>
...
<!-- Page generated at {ts '2017-11-07 09:05:04'} -->
<a name="thetop"></a>
...
<input type="text" id="search" name="q" placeholder="Enter Search Terms" aria-label="Enter Search Terms" tabindex="2">
<input type="submit" value="Go" id="search-submit" aria-label="Activate to open the search input. Activate again to submit any search terms entered." tabindex="1">
</form>
...
<div class="motion-point translate-wrapper">
<div class="dropdown">
<div class="btn btn-default dropdown-toggle" id="motion-point-menu" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
<span class="prompt">Select Language</span>
<span class="caret"></span>
</div>
<ul class="dropdown-menu" aria-labelledby="motion-point-menu">
<li><a href="//es.wmata.com/about/records/privacy.cfm" class="es">Español</a></li>
<li><a href="//fr.wmata.com/about/records/privacy.cfm" class="fr">Français</a></li>
<li><a href="//ko.wmata.com/about/records/privacy.cfm" class="ko">Korean</a></li>
<li><a href="//zs.wmata.com/about/records/privacy.cfm" class="zs">Chinese</a></li>
<li><a href="//vi.wmata.com/about/records/privacy.cfm" class="vi">Vietnamese</a></li>
<li><a href="//www.wmata.com/about/records/privacy.cfm" class="en">English</a></li>
</ul>
</div> <!--.dropdown-->
</div><!--.motion-point-->
</div> <!--.translate-->
<div class="nav-item browse-aloud" id="__ba_panel" aria-label="Browse Aloud" tabindex="1"></div>
</div> <!--.pull-right-->
...
<div>
<a class="footer-button" href="//smartrip.wmata.com/Account/AccountLogin.aspx" target="_blank">Manage Your SmarTrip Account</a>
</div>
<div>
<a class="footer-button" href="//smartrip.wmata.com/storefront" target="_blank">Get a SmarTrip Card</a>
</div>
</div> <!--.mobile-menu-footer-->
</div> <!--.mobile-content-wrapper-->
<nav>
<ul>
<li ><a href="/service/index.cfm" tabindex="1"  title="Open Service options">Service</a>
...
<li><a href="/service/daily-report/"  >Daily Service Reports</a></li>
<li><a href="/service/status/"  >Status and Alerts</a></li>
<li><a href="/service/bikes/"  >Bikes</a></li>
<li><a href="/service/parking/"  >Parking</a></li>
<li><a href="/service/car-sharing.cfm"  >Car Sharing</a></li>
<li><a href="/service/regional-transportation/"  >Other Transportation Options</a></li>
</ul>
</div>   <!--.mm-links-col-inner -->
</div> <!--mm-links-col-->
<div class="mm-promo">
<div class="promo-img-left">        <div class="promo-img">        	<img src="/systemimages/icons/menu-cta-icon.png" alt="signup-alerts">        </div>        <div class="promo-text">            <p>Get MetroAlerts via email or text</p>            <a href="http://www.metroalerts.info/logon.aspx" class="promo-link">SIGN UP</a>        </div>    </div>
</div>
</div> <!-- .mm-content -->
</div> <!-- .mm-dropdown -->
</li>
<li ><a href="/schedules/index.cfm" tabindex="1"  title="Open Schedules & Maps options">Schedules & Maps</a>
<div class="mm-dropdown">
<div class="mm-content">
<div class="mm-links-col">
<div class="mm-links-col-inner">
...
<li ><a href="/rider-guide/index.cfm" tabindex="1"  title="Open Rider Guide options">Rider Guide</a>
<div class="mm-dropdown">
<div class="mm-content">
<div class="mm-links-col">
<div class="mm-links-col-inner">
...
<div class="mm-promo">
<div class="promo-img-left">        <div class="promo-img">        	<img src="/systemimages/icons/menu-train-icon.png" alt="train">        </div>        <div class="promo-text">            <p>View real-time train locations</p>            <a href="https://gis.wmata.com/metrotrain/index.html" class="promo-link">OPEN MAP</a>        </div>    </div>
</div>
</div> <!-- .mm-content -->
</div> <!-- .mm-dropdown -->
</li>
<li ><a href="/fares/index.cfm" tabindex="1"  title="Open Fares options">Fares</a>
<div class="mm-dropdown">
<div class="mm-content">
<div class="mm-links-col">
<div class="mm-links-col-inner">
<ul>
<li><a href="/fares/basic.cfm"  >Base Fares</a></li>
<li><a href="/fares/smartrip/"  >SmarTrip®</a></li>
<li><a href="https://smartrip.wmata.com/storefront"  >Shop Store</a></li>
<li><a href="https://smartrip.wmata.com/Storefront/ShoppingCart/AddAndPurchase?id=6745467"  >Buy Now</a></li>
<li><a href="/fares/stores.cfm"  >Sales Locations</a></li>
<li><a href="https://smartrip.wmata.com/Account/AccountLogin.aspx"  >Log In</a></li>
<li><a href="/fares/reduced.cfm"  >Reduced Fares</a></li>
<li><a href="/fares/farecard-options.cfm"  >Pass Products and DC Student Fares</a></li>
<li><a href="/fares/U-Pass/"  >U·Pass</a></li>
</ul>
</div>   <!--.mm-links-col-inner -->
</div> <!--mm-links-col-->
<div class="mm-promo">
<div class="promo-img-left">        <div class="promo-img">        	<img src="/systemimages/icons/menu-upass-icon.png" alt="U-Pass">        </div>        <div class="promo-text">            <p>Get the University Pass Advantage</p>            <a href="/fares/U-Pass/" class="promo-link">LEARN MORE</a>        </div>    </div>
</div>
</div> <!-- .mm-content -->
</div> <!-- .mm-dropdown -->
</li>
<li ><a href="/initiatives/index.cfm" tabindex="1"  title="Open Initiatives options">Initiatives</a>
<div class="mm-dropdown">
<div class="mm-content">
<div class="mm-links-col">
<div class="mm-links-col-inner">
...
<li><a href="http://planitmetro.com/"  target='_blank'  >PlanIt Metro</a></li>
<li><a href="/initiatives/strategic-plans/"  >Strategic Plans</a></li>
<li><a href="/initiatives/projects/"  >Jurisdictional Projects</a></li>
<li><a href="/initiatives/plans/"  >Capital and Service Plans</a></li>
<li><a href="/initiatives/budget/"  >Budget</a></li>
<li><a href="/initiatives/sustainability/"  >Sustainability </a></li>
...
<div class="mm-promo">
<div class="promo-img-left">        <div class="promo-img">        	<img src="/systemimages/icons/menu-cta-icon.png" alt="news">        </div>        <div class="promo-text">            <p>Keeping Metro Safe, Reliable and Affordable</p>            <a href="/initiatives/budget" class="promo-link">READ MORE</a>        </div>    </div>
</div>
</div> <!-- .mm-content -->
</div> <!-- .mm-dropdown -->
</li>
<li ><a href="/business/index.cfm" tabindex="1"  title="Open Business options">Business</a>
<div class="mm-dropdown">
<div class="mm-content">
<div class="mm-links-col">
<div class="mm-links-col-inner">
...
<li><a href="/business/Deals-Discounts/index.cfm"  >Customer Deals & Discounts</a></li>
<li><a href="/business/adjacent-construction/index.cfm"  >Adjacent Construction Program</a></li>
<li><a href="/business/procurement/index.cfm"  >Procurement & Contracting</a></li>
<li><a href="/business/small-disadvantaged-business/index.cfm"  >Small & Disadvantaged Business Programs</a></li>
<li><a href="/business/real-estate/index.cfm"  >Real Estate & TOD</a></li>
</ul>
</div>   <!--.mm-links-col-inner -->
</div> <!--mm-links-col-->
<div class="mm-promo">
...
<li ><a href="/about/index.cfm" tabindex="1"  title="Open About options">About</a>
<div class="mm-dropdown">
<div class="mm-content">
<div class="mm-links-col">
<div class="mm-links-col-inner">
...
<li><a href="/business/index.cfm/"  >Business with Metro</a></li>
<li><a href="/about/riders-advisory-council/"  >Rider's Advisory Council</a></li>
...
<li><a href="http://www.dcmetrostore.com/"  target='_blank'  >Metro Gifts</a></li>
...
<div class="mm-promo">
<div class="promo-img-left">        <div class="promo-img">        	<img src="/systemimages/icons/menu-members-icon.png" alt="Safe, reliable service">        </div>        <div class="promo-text">            <p>Back2Good: Delivering safe, reliable service to you</p>            <a href="/about/back2good/index.cfm" class="promo-link">READ MORE</a>        </div>    </div>
</div>
</div> <!-- .mm-content -->
</div> <!-- .mm-dropdown -->
</li>
...
<div class="close-tab-panel" aria-label="Close Trip Planner panel" tabindex="1">X</div>
...
<input type="hidden" name="travelby" value="BCFKLRSTX123" />
...
<input type="hidden" name="walk-distance" value=".75" />
<input type="hidden" name="widgetLocationLatLng"  class="localStorageText">
<input type="hidden" name="widgetDestinationLatLng"  class="localStorageText">
<div class="form-group location">
<div class="form-group">
<label for="alerts-widget-trip-planner-from">FROM <span class="visually-hidden">(has autocomplete)</span></label>
<input type="text" id="alerts-widget-trip-planner-from" name="location" class="localStorageText" value="" placeholder="Address, Intersection, or Landmark" required data-error="Please Enter a From Address" tabindex="1">
...
<input type="text" id="alerts-widget-trip-planner-to" name="destination" class="localStorageText" value="" placeholder="Address, Intersection, or Landmark" required data-error="Please Enter a To Address" tabindex="1">
<div class="help-block with-errors" aria-live="polite" aria-atomic="true"></div>
</div>
...
<li>
<a href="/about/records/" tabindex="1">Records</a>
</li>
<li>
Privacy Policy and Legal Disclaimer</li>
</ul>
</nav>
</div>
...
<h2>Privacy Policy and Legal Disclaimer</h2>
<div id="cs_control_1450" class="CS_Element_Schedule"> <div  title="" id="CS_Element_interiorcontainer"> <div id="cs_control_7360" class="cs_control CS_Element_Textblock"> <div class="CS_Textblock_Text"><p>Outlined below is  Metro's privacy policy governing personal data collected on this website. Metro also has a broader <a onmouseover=" return window.status='/upload/9-2-2_Privacy_Policy.pdf'; " onmouseout=" return window.status=''; " href="javascript:HandleLink(&apos;cpe_7360_0&apos;,&apos;CPNEWWIN:_blank^@CP___PAGEID=7361,/upload/9-2-2_Privacy_Policy.pdf&apos;);">corporate privacy policy</a> <img class="icon-img" src="/images/pdf_icon.jpg" alt="PDF Icon" title="PDF Icon" border="0" height="18" hspace="0" vspace="0" width="18"> protecting the privacy of individuals who are the subjects of records maintained in Metro's <a class="CP___PAGEID_7354" href="/about/records/sorn.cfm">systems of records</a>. See <a class="CP___PAGEID_7362" href="/upload/routine_Uses_in_SORN.pdf">explanations for  general routine uses within the systems of records notices</a> <img class="icon-img" src="/images/pdf_icon.jpg" alt="PDF Icon" title="PDF Icon" border="0" height="18" hspace="0" vspace="0" width="18">.  Metro interprets and applies this privacy policy consistent with the federal Privacy Act, 5 U.S.C. § 552a, and federal practice.</p>
<h3>Summary</h3>
<p>Metro respects your privacy. We collect personal data online only if you buy from us online, subscribe to our email subscription service or apply for a job online. If so, we use this information only for fulfilling  your requests. We do not lease, sell or otherwise release your personal information to outside companies for marketing purposes. Metro contractors may collect personal data in order to provide contracted services. These contractors are bound by Metro's privacy policy.</p>
<p>If you do not supply personal information for one of the purposes listed above, we make no attempt to identify you individually. Rather, we track only aggregate usage data to help us improve site content and organization. The policy details section below specifies what information we collect and how we use it.</p>
<p>If you have any questions or concerns about our privacy policy, please <a class="CP___PAGEID_7363" href="/about/contact/comment-form.cfm">contact customer service</a>.</p>
<a name="details" id="details"></a>
<h2>Policy Details</h2>
<ul>
<li>
<a href="#Information">Information Collected and Stored Automatically</a>
</li>
<li>
<a href="#cookies">Cookies</a>
</li>
<li>
<a href="#infocollected">Personal information Collected</a>
</li>
<li>
<a href="#externallinks">Links to Other Sites</a>
</li>
<li>
...
<p>We do not collect personal information when you visit our website unless you choose to provide that information  to us. Every time you visit the Metro site and view pages, we collect the following usage information:</p>
<ul>
<li>the Internet domain, for example, "hostcompany.com" (if you use a private Internet access account) or "theschool.edu" (if you connect from a university's domain) and the IP address (a number automatically assigned to your computer whenever you are surfing the Web) from which you access our website</li>
<li>the type of browser and operating system used to access our site</li>
<li>the date and time of your visit</li>
<li>the pages you visit</li>
<li>if you followed a link to the Metro site, the address of the page from which you came</li>
</ul>
<p>The information collected allows us to see trends in usage: the most commonly viewed pages, what sites link to the Metro site, and information on the browsers used to view the site.</p>
<p>
<span id="top">
<a href="#details">Top</a>
</span>
</p>
<a id="cookies" name="cookies"></a>      
<h3>Cookies</h3>     
<p>Cookies are small files that can  be placed on your computer by Web servers when you visit a site. These  files may contain information such as ID's and passwords, personal information  or preferences. During your visit, the server can access these files to help  personalize pages or allow you to effect e-commerce more easily.</p> 
<p>Metro does not set cookies from any page in the wmata.com domain that store personally identifiable information with the exception of the Trip Planner. The
<a style="" class="CP___PAGEID_3882" href="/schedules/trip-planner/index.cfm">Trip Planner</a> stores your input fields and locations as cookies, so if you plan additional trips during your visit to our website, the input fields will already be  filled in for your convenience. Our e-commerce and vendor registration sites set cookies with login information, but only for the convenience of customers who  use these areas repeatedly. If you are concerned about privacy, you may set up  your browser not to accept cookies or you can delete them from your hard drive  once you leave that section of the website.</p>
<p>
<span id="top">
<a href="#details">Top</a>
</span>
</p>
<a id="infocollected" name="infocollected"></a>
<h4>Personal Information Collected</h4>
<p>There are places on the website where we ask you to provide us with personal information. We collect this information in order to provide you with the specified goods or services you requested. The information collected is owned by Metro and will not be sold or given to any entity outside of Metro except contractors hired by Metro to provide Metro-approved services. These contractors are bound by this policy and are prohibited from using the information except to fulfill the services for which Metro has contracted.</p>
<p>Metro may use the personal information to provide you with Metro-related information, for example, email about upcoming events and promotions. You have the right to opt out of any service or information you receive via a single Web or email command. (Instructions for doing this are included in all Metro email communications.)</p>
<p>Personal information is information that can identify an individual, such as:</p>
<ul>
<li>a first and last name</li>
<li>an address, such as work or home, including city and state</li>
<li>a telephone number</li>
<li>a Social Security number</li>
<li>a credit card number</li>
<li>an email address</li>
</ul>
<p>We are required to release personal information if it is subpoenaed by a court or grand jury. We may also provide statistics based on the
<a href="#Information">information automatically collected from your visit</a> to federal, state, and city officials.</p>
<p>
<strong>Employment Application Information</strong>
</p>
<p>If you fill out an application for employment, the information collected will be used by our human resources personnel to determine whether you qualify for the job. The information will also be shared with the manager of the hiring department. This information will not be given to anyone  outside Metro.</p>
<p>
<span id="top">
<a href="#details">Top</a>
</span>
</p>
<a id="externallinks" name="externallinks"></a>
<h4>Links to Other Sites</h4>
<p>Metro's website links to external sites for services provided by Metro contractors, such as e-commerce. These sites are subject to Metro's privacy policy.</p>
<p>We also provide links to selected sites unconnected to Metro, such as other area transit providers and visitor centers, which we feel would be of benefit to you as transit riders. If you follow these links, you are leaving the Metro  site and are subject to the privacy policies of those sites.</p>
<p>Note that the links we provide to outside sites are offered for your convenience. Metro takes no responsibility for outside sites' content or policies.</p>
<p>
<span id="top">
<a href="#details">Top</a>
</span>
...
<h4>Copyright</h4>
<p>All images and text on the Metro website are copyrighted by Metro and are protected by applicable laws. Anyone wishing to use Metro graphics such as our logo or banners should contact Metro to obtain a license or permit.</p>
<p>Metro diligently protects its intellectual property and will take all steps to prevent unpermitted use, up to and including, litigation. For  more information, see our guidelines on using <a class="CP___PAGEID_7366" href="/about/media-relations/intellectual-property.cfm">Metro intellectual property</a>.</p>
<p>
<span id="top">
<a href="#details">Top</a>
</span>
...
<li><a href="/about/transit-police/">TRANSIT POLICE</a></li>
<li><a href="http://wmata.custhelp.com/app/home/">CUSTOMER COMMENT FORM</a></li>
...
<li><a href="/about/media-relations/">MEDIA RELATIONS</a></li>
<li><a href="/about/records/">PUBLIC RECORDS</a></li>
<li><a href="/business/">BUSINESS WITH METRO</a></li>
<li><a href="/about/careers/">CAREERS</a></li>
...
<div class="copyright">© 2017 WMATA</div>
<div class="footer-bottom-links">
<ul>
<li><a href="/about/records/privacy.cfm ">PRIVACY POLICY AND LEGAL DISCLAIMER</a></li>
<li><a href="/about/contact/">CONTACT</a></li>
...
<script type="text/javascript">var _baTheme=0, _baMode='Browse Aloud', _baUseCookies=true, _baHideOnLoad=true;</script>
...
ga('create', 'UA-80716475-1', 'auto');
ga('send', 'pageview');
</script>
<!-- end page content --><div style="display:block; clear:left; padding:0px; font-family:Verdana,Arial; font-size:10px; color:gray;"></div>
		...
		<!--
			...
			commonspot.csPage = {};
				...
				commonspot.csPage.url = '/about/records/privacy.cfm';
			

			commonspot.csPage.id = 4038;
			commonspot.csPage.title = 'Privacy Policy and Legal Disclaimer';

			commonspot.csPage.pagetype = 0;
			commonspot.csPage.publicationState = 'Published Page';
			commonspot.csPage.siteRoot = '/';
			commonspot.csPage.subsiteRoot = '/about/records/';
			...
			commonspot.csPage.subsiteContext.subsiteid = 18;
			commonspot.csPage.subsiteContext.siteurl = '/';
			commonspot.csPage.subsiteContext.subsiteurl = '/about/records/';
			commonspot.csPage.subsiteContext.sitename = 'WMATA';
			commonspot.csPage.subsiteContext.subsitename = 'records';
			commonspot.csPage.subsiteContext.menucontexttimestamp = '1509808030237';
