...
<!-- Page generated at {ts '2019-05-07 09:56:33'} -->
<a name="thetop"></a>
...
<li><a href="/service/rail/PlatformProject/"  >Platform Improvement</a></li>
</ul>
...
<div id="cs_control_1450" class="CS_Element_Schedule"> <div  title="" id="CS_Element_interiorcontainer"> <div id="cs_control_7360" class="cs_control CS_Element_Textblock"> <div class="CS_Textblock_Text"><p>Outlined below is  Metro's privacy policy governing personal data collected on this website. Metro also has a broader
<a class="CP___PAGEID_7361" href="/upload/9-2-2_Privacy_Policy.pdf" target="_blank" title="corporate privacy policy - opens in new window" style="">corporate privacy policy</a>
<img class="icon-img" src="/images/pdf_icon.jpg" alt="PDF Icon" title="PDF Icon" border="0" height="18" hspace="0" vspace="0" width="18"> protecting the privacy of individuals who are the subjects of records maintained in Metro's
<a class="CP___PAGEID_7354" href="/about/records/sorn.cfm">systems of records</a>. See
<a class="CP___PAGEID_7362" href="/upload/routine_Uses_in_SORN.pdf" target="_blank" title="explanations for&nbsp; general routine uses within the systems of records notices - opens in new window">explanations for  general routine uses within the systems of records notices</a>
<img class="icon-img" src="/images/pdf_icon.jpg" alt="PDF Icon" title="PDF Icon" border="0" height="18" hspace="0" vspace="0" width="18">.  Metro interprets and applies this privacy policy consistent with the federal Privacy Act, 5 U.S.C. § 552a, and federal practice.</p>
<h3>Summary</h3>
...
<a href="http://wmata.custhelp.com/app/home/" style="">contact customer service</a>.</p>
...
<p>Metro diligently protects its intellectual property and will take all steps to prevent unpermitted use, up to and including, litigation. For  more information, see our guidelines on using
<a class="CP___PAGEID_7366" href="/about/media-relations/intellectual-property.cfm">Metro intellectual property</a>.</p>
<p>
<span id="top">
<a href="#details">Top</a>
</span>
...
<!-- end page content --><div style="display:block; clear:left; padding:0px; font-family:Verdana,Arial; font-size:10px; color:gray;"></div>
		...
		<!--
			...
			commonspot.csPage.subsiteContext.menucontexttimestamp = '1556246104135';
