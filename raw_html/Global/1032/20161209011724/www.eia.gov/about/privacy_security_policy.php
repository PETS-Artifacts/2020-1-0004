    ...
    <div id="sticker" class="social-fixed positionable">
      <div class="addthis_toolbox addthis_default_style ">
        <ul class="social shider">
          <li><a href="http://twitter.com/EIAgov" target="_blank"><img src="/global/images/icons/social-twitter.jpg" class="imgalpha"></a>
            <div class="link twt">
              <div class="tweet"><a class="addthis_button_tweet"></a></div>
            </div>
          </li>
          <li><a href="http://www.facebook.com/eiagov" target="_blank"><img src="/global/images/icons/social-facebook.jpg" class="imgalpha"></a>
        ...
        <div class="global_learn_menu">
            ...
            <span class="global_menu_col9">
              <h3><a href="/energy_in_brief/">Energy in Brief</a></h3>
				...
				<p class="no-border global_menu_col10"><a href="/energy_in_brief/article/foreign_oil_dependence.cfm">How dependent are we on foreign oil?&nbsp;&rsaquo;</a><br />
...
<h4>Privacy statement</h4>
    ...
    <div class="side_col left"> 
            ...
            <h4><a href="/about/index.cfm">About EIA</a></h4>
              <ul>
                <li><span>Our Work</span>
                  <ul>
                    <li><a href="/about/mission_overview.cfm">Mission &amp; Overview</a></li>
                    <li><a href="/about/products_services.cfm">Product &amp; Services</a></li>
                    <li><a href="/about/stakeholders.cfm">Customer &amp; Stakeholder Engagement</a></li>
		    		<li><a href="/about/celebrating_2013.cfm">Accomplishments for 2013</a></li>
                    <li><a href="/about/celebrating_2014.cfm">Accomplishments for 2014</a></li>
                    <li><a href="/about/celebrating_2015.cfm">Accomplishments for 2015</a></li>
                  </ul>
                </li>
                ...
                <li><span>EIA Conference</span>
                  <ul>
                    <li><a href="/conference/2016/index.cfm">2016 Annual Conference</a></li>
                                        <li><a href="/pressroom/events/previous_conference.cfm">Previous conferences</a></li>
                  </ul>
                </li>
		...
		<div class="clear">
			...
			<div class="rs_comments">
								<form>
					<p><b>Thank You.</b> We welcome your comments or suggestions <i>(optional)</i>. <a id="closer" style="cursor:pointer;"></a><br />
						<textarea name="comments" id="comments" style="height:100px;"></textarea><br />
						<input type="submit" name="submit" alt="submit comments" class="submit_com" align="absmiddle" border="0" title="Submit comments">
					</p>
				</form>
			</div>
		</div>
		<div id="addbar">
			...
			<h3><a href="/beta/api/">Open Data</a></h3>
			...
			<p><b>Stay Connected</b><br/>
				...
				<a href="http://linkedin.com/company/u-s-energy-information-administration" target="_blank" class="ico_linkedin ft_icon_pad">LinkedIn<span class="external">&nbsp;</span></a><br/>
