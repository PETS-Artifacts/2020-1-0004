...
<link rel="stylesheet" href="root/app_common/css/abbr.css?v=1.2.26">
...
<div class="tagline">
	...
	<h2>Acronyms <span>&amp;</span> Abbreviations</h2>
...
<div class="cblocks"><div id="install-button" class="cblock fflag">
	<hgroup class="clearfix">
		...
		<h4><a id="inst1" onclick="window.open('https://chrome.google.com/webstore/detail/abbreviationscom/benpolaabjjganjkmhbdppijcfimlgdb')">Free, no signup required</a>:</h4>
		<h3 style="font-size: 28px; font-weight: 600; line-height: 36px;"><a id="inst2" onclick="window.open('https://chrome.google.com/webstore/detail/abbreviationscom/benpolaabjjganjkmhbdppijcfimlgdb')">Add to Chrome</a></h3>
	</hgroup>
	<div class="cblock-int clearfix" style="padding: 10px 12px; margin-top: -10px;">
		...
		<div style="margin-top: 10px;"><button type="button" class="btn btn-2 primary" onclick="window.open('https://chrome.google.com/webstore/detail/abbreviationscom/benpolaabjjganjkmhbdppijcfimlgdb')">Two clicks install &raquo;</button></div>
	</div>
</div>
...
<div class="cblocks"><div id="install-button-ff" class="cblock fflag">
	...
	<div class="cblock-int clearfix" style="padding: 10px 12px; margin-top: -10px;">
		<span style="font-size: 14px; color: #777;">Get instant explanation for any acronym or abbreviation that hits you anywhere on the web!</span>
		<div style="margin-top: 10px;"><button type="button" class="btn primary" onclick="location.href='https://addons.mozilla.org/en-US/firefox/addon/abbreviations-com/'">Two clicks install &raquo;</button></div>
	</div>
</div>
				...
				<div class="row">
					<div class="col-xs-6 col-sm-6">
						<ul>
							...
							<li class="ex"><a href="/collection">Your Saved Items</a></li>
...
<div id="s4-network" class="col-xs-12 col-sm-5">
	...
	<div class="clearfix">
		...
		<div id="social-icons">
			...
			<a rel="nofollow" href="https://twitter.com/justadded" target="_blank"><span class="social tw"><i class="fa fa-twitter" aria-hidden="true"></i></span></a>
...
<script src="js/abbr.min.js?v=1.0.38" async></script>
...
_gaq.push(['_trackEvent','Blocking Ads',fUvStgOcbGuo,undefined,undefined,true]);

</script>

</body>
</html>
<!-- Timer: 0.0684 secs | Server: ip-172-30-3-212 -->