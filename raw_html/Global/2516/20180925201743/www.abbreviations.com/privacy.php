...
<link rel="stylesheet" href="root/app_common/css/abbr.css?v=1.1.26">
    ...
    <div class="page-top-search" class="rc5">
        	<div class="page-word-search" style="width: calc(100% - 110px);">
        		<div class="input-group">
        			<input id="search-mob" type="text" class="page-word-search-query form-control rc5" name="st" value="" placeholder="Search abbreviations..." autocomplete="off">
...
<div id="s4-network" class="col-xs-12 col-sm-5">
	...
	<div class="clearfix">
		...
		<div id="social-icons">
			<a rel="nofollow" href="http://www.facebook.com/STANDS4" target="_blank"><div class="social fb"><i class="fa fa-facebook" aria-hidden="true"></i></div></a>
			<a rel="nofollow" href="http://twitter.com/justadded" target="_blank"><div class="social tw"><i class="fa fa-twitter" aria-hidden="true"></i></div></a>
...
<script src="js/abbr.min.js?v=1.0.26" async></script></body>
</html>
<!-- Timer: 0.0961 secs | Server: ip-172-30-2-197 -->