...
<base href="http://www.abbreviations.com/">
...
<link rel="stylesheet" href="root/app_common/css/abbr.css">
...
<link rel="search" type="application/opensearchdescription+xml" title="Abbreviations.com" href="http://www.abbreviations.com/open-search.xml">
...
<header id="header">
	...
	<ul id="network-header-links" style="display:none;">
		...
		<li class="nw-lyrics"><a href="http://www.lyrics.net/">LYRICS</a></li>
...
</form>		<div id="page-top-logo" onclick="location.href='http://www.abbreviations.com/';"><img src="root/app_common/img/top_logo_abbr.png" alt="Abbreviations.com" title="Abbreviations.com"></div>
	</div>
...
if( window.canRunAds === undefined ){
	document.write("<!-- S4_NEW_TRANS_TXT_ONLY_300_600 --><ins class=\"adsbygoogle\" style=\"display:inline-block;width:300px;height:600px\" data-ad-client=\"ca-pub-6071864913982699\" data-ad-slot=\"8649127942\"></ins>");
} else {
	document.write("<!-- S4_NEW_TRANS_300_600 --><ins class=\"adsbygoogle\" style=\"display:inline-block;width:300px;height:600px\" data-ad-client=\"ca-pub-6071864913982699\" data-ad-slot=\"9971115145\"></ins>");
}
</script>
<script>
...
<!--//<![CDATA[
   ...
   document.write ("zoneid=244036");document.write("&amp;nodis=1");
...
//]]>--></script></section>
<section><!-- Async Tag // Tag for network 9533: Marketplace: STANDS4 LLC // Website: Abbreviations.com // Page: Abbreviations.com // Placement: Abbreviations 300x250 ATF (3219700) // created at: Dec 3, 2014 10:07:01 AM -->
<script type="text/javascript" src="http://aka-cdn-ns.adtechus.com/dt/common/DAC.js"></script>
<div id="3219700"></div>
<script>
ADTECH.config.page = { protocol: 'http', server: 'adserver.adtechus.com', network: '9533.1', pageid: 693103, params: { loc: '100' }};
ADTECH.config.placements[3219700] = { sizeid: 170, params: { alias: '', target: '_blank' }};
ADTECH.loadAd(3219700);
</script></section>
<section><script type="text/javascript"><!--
	e9 = new Object();
    e9.size = "300x250";
//--></script>
<script type="text/javascript" src="http://tags.expo9.exponential.com/tags/Abbreviationscom/ROS/tags.js"></script></section>
				...
				<div class="row">
					<div class="col-xs-6 col-sm-6">
						<ul>
							...
							<li class="ex"><a href="mylist.php">Your Saved Items <span>(4)</span></a></li>
...
<div id="s4-network" class="col-xs-12 col-sm-5">
	...
	<div class="clearfix row hidden-xs">
		...
		<div class="col-xs-12 col-sm-4">
			<ul class="last">
				...
				<li class="nw-lyrics"><a rel="nofollow" href="http://www.lyrics.net/">Lyrics</a></li>
	...
	<div class="clearfix">
		<div class="copyright"><strong>&copy; 2001-2016 STANDS4 LLC.</strong><br>All rights reserved.</div>
		<div id="social-icons">
...
<script src="js/abbr.js"></script></body>
</html>
<!-- Timer: 0.0344 secs | Server: 10.93.170.247 -->