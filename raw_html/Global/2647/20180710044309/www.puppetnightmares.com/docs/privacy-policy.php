...
<html xmlns="http://www.w3.org/1999/xhtml">
 ...
 <body>
   ...
   <ol>
     ...
     <li><a href="#S10">Account Deletions</a></li>
   </ol>
...
<p> Beyond your activity on this site, we do not track your browsing activities with cookies or software. 
...
<ul>
  ...
  <li>IP addresses.</li>
  <li>Payment details sent to reduce fraud.</li>
</ul>
<p>Please note that your personal details regarding payments are not 
stored on this server, and most of it, such as 
credit card and bank account numbers, will be held <b>only</b> by PayPal.</p>
...
need to be validated by us after any submissions and changes.</p>

<h4><a name="S6">6) Sharing Information: </a></h4>
<p>Again, Puppet Nightmares (eg. www.puppetnightmares.com) does not share data about its users without 
their consent. However, if you participate in a social media promotion, you should be aware that Facebook, 
Twitter and Google+ collect EVERYTHING about you, so be wary of those offers if privacy is a concern to you.</p>
...
Users are advised to keep themselves informed by frequently checking the news.  </p>

<h4><a name="S8">8) Effective Date of Policy: </a></h4>
<p>This policy has been in effect since December 2nd, 2008, and was last updated on May 25th, 2018.</p>
...
the <a href="/contact.php">Contact</a> page and the child will be banned as soon as possible.</p><h4><a name="S10">10) Account Deletions: </a></h4>
<p>Account deletion requests are not accepted here. This website prides itself on retaining 
user data for long periods of time and unnecessary deletions present the chance of unneeded 
bugs and orphan data occurring.</p>
 </body>
</html>
