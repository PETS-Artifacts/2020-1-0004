...
<body>
	...
	<div style="height: 1px; width: 1px; position: absolute; left: -1px; top: 0; overflow: hidden;"><a href="/user-data/?998" rel="nofollow" onclick="return false">User Data</a></div>
	...
	<div id="inner-wrapper">
		...
		<div id="header"><div class="just">
			...
			<script>
				_bgaw = {id:"tBc50Ft9qm8En"};
			</script>
			<style type="text/css">
				#tBc50Ft9qm8En_u { display: none; }
			</style>
			<div style="position: relative; width: 728px; height: 90px; overflow: hidden;">
		
				<div class="ELoMAdulqUqQB" style="position: absolute; top: 0; left: 0; width: 728px; height: 90px; z-index: 4; pointer-events: none;">
					<script src="//bid.glass/ext/js/mid-adbox-2.js?ad_box_1&ad_channel=2&ad_slot=3&adsize=300x250"></script>
				</div>
		
				<div class="F4QE6mxOrqr" style="position: absolute; top: 0; left: 0; width: 728px; height: 90px; z-index: 5; pointer-events: none;">
	    ...
	    <script type="text/javascript">
	        googletag.cmd.push(function() { googletag.display("div-gpt-ad-1498686723684-4"); });
				...
				<div id="tBc50Ft9qm8En_u" style="position: absolute; top: 0; left: 0; width: 728px; height: 90px; z-index: 1;">
					<a id="HHUexoguog5EX" href="#" style="display: none" target="_blank" rel="nofollow"><img id="HHU0KO8VJKp1" width="728" height="90" /></a>
				</div>
			
			</div>
			<script>
				_bgaw = undefined;
				if( document.getElementById("tBc50Ft9qm8En") ) {
					document.getElementById("tBc50Ft9qm8En_u").style.display = "none";
				} else {
					(function() {
						var css = 'body .F4QE6mxOrqr > * { pointer-events: none; }',
			...
			bgclient.cmd.push(function() {
				...
				bgclient.main.addUnit({"token":"adDPdX9r92CutwZzkK2aotbm0PiZFKV-HFu-xb77rMNnSA8-vf3kobetKPSa4yGEQMVc5VtSK6WpS_1M_LTskmCP8cGxpnAOWBVDwuOcBDZ7TjpxLn_qzRUJWzwG3-Ab1S2ioC-xze9dzZJeRY5E_R8UhS4cht7o_USlhRGd18OyLlswcJg8QIkaWs-rQ0wp6UbPY6zdmdkBE9RxRgg","element_id":"HHUexoguog5EX","img_id":"HHU0KO8VJKp1","img_src":"\/8D\/images\/19a5d7ds47pvEU.jpg","href":"http:\/\/shiningstars.smackjeeves.com\/comics\/2122033\/cover-page\/"});
