...
<head>
	...
	<script src="//www.smackjeeves.com/js/main2.js?v=17"></script>
...
<body>
	...
	<div style="height: 1px; width: 1px; position: absolute; left: -1px; top: 0; overflow: hidden;"><a href="/user-data/?903" rel="nofollow" onclick="return false">User Data</a></div>
	...
	<div id="inner-wrapper">
					...
					<script>
						...
						$('#ut-agree').click(function() {
							...
							SJ.ajax('/ajax/agree_new_terms.php', {v:'cc3i8x0y'}, function( data ) {
