...
<body>
	...
	<div style="height: 1px; width: 1px; position: absolute; left: -1px; top: 0; overflow: hidden;"><a href="/user-data/?769" rel="nofollow" onclick="return false">User Data</a></div>
	...
	<div id="inner-wrapper">
		...
		<div id="header"><div class="just">
			...
			<script>
				_bgaw = {id:"Ty0dHx46e8R"};
			</script>
			<style type="text/css">
				#Ty0dHx46e8R_u { display: none; }
			</style>
			<div style="position: relative; width: 728px; height: 90px; overflow: hidden;">
		
				<div class="GB3QXqURQPE" style="position: absolute; top: 0; left: 0; width: 728px; height: 90px; z-index: 4; pointer-events: none;">
					<script src="//bid.glass/ext/js/mid-adbox-2.js?ad_box_1&ad_channel=2&ad_slot=3&adsize=300x250"></script>
				</div>
		
				<div class="Z9cgzIUs7hs5" style="position: absolute; top: 0; left: 0; width: 728px; height: 90px; z-index: 5; pointer-events: none;">
	    ...
	    <script type="text/javascript">
	        googletag.cmd.push(function() { googletag.display("div-gpt-ad-1498686723684-4"); });
				...
				<div id="Ty0dHx46e8R_u" style="position: absolute; top: 0; left: 0; width: 728px; height: 90px; z-index: 1;">
					<a id="TtiS1t7QcVPmN" href="#" style="display: none" target="_blank" rel="nofollow"><img id="TtiS4xXQ29ZDqi" width="728" height="90" /></a>
				</div>
			
			</div>
			<script>
				_bgaw = undefined;
				if( document.getElementById("Ty0dHx46e8R") ) {
					document.getElementById("Ty0dHx46e8R_u").style.display = "none";
				} else {
					(function() {
						var css = 'body .Z9cgzIUs7hs5 > * { pointer-events: none; }',
			...
			bgclient.cmd.push(function() {
				...
				bgclient.main.addUnit({"token":"NWNAOX8zDKAD4TeaIzq9RloIQoVJZXAVKtTc6D4TAfnzy5I8oDAYDbepXlPebkURT3k9V4vwzjnKxJ1qAGBVUb-anN5d7JWqO9IAqIg0MxnIe9eAkDHtMCw0LxxgTPS2kNvSX_ckIxxyXLmUeFenbaNmkiLiW5u7u9Zw1Niq9Ll25kyKP5MglkumxGmgLnU6jmvMwB79RDhIkhPPkQ","element_id":"TtiS1t7QcVPmN","img_id":"TtiS4xXQ29ZDqi","img_src":"\/8D\/images\/1xe0u9lkq3MrVP.jpg","href":"http:\/\/ageofthegray.smackjeeves.com\/chapters\/59925\/chapter-1-hunted\/"});
