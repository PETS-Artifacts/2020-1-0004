...
<head>
	...
	<link rel="stylesheet" type="text/css" href="//www.smackjeeves.com/style2.css?v=25">
	<script src="//www.smackjeeves.com/js/jquery-3.0.0.min.js"></script>
	<script src="//www.smackjeeves.com/js/all-includes.js"></script>
	<script src="//www.smackjeeves.com/js/main.js?v=11"></script>
		
		
	</head>

<body class="segoe _full _1366 blue">
	...
	<div id="inner-wrapper">
		...
		<div id="side-menu">
			...
			<div class="wrapper">
				<ul>
																<li><a href="https://www.smackjeeves.com/register.php">Create Account</a></li>
						<li><a href="https://www.smackjeeves.com/login.php?ref=%2Fprivacy.php">Log In</a></li>
									</ul>
			</div>
		</div>
		...
		<div id="site-bar">
			<div class="flex">
				<div class="left">
					<a id="site-logo" href="http://www.smackjeeves.com/">Smack Jeeves Webcomic Hosting</a>
					<a class="button" href="http://www.smackjeeves.com/search.php">Comics</a>
					<a class="button" href="https://www.smackjeeves.com/forum/">Forum</a>
					<div class="navbar-search">
						<form action="/search.php" method="get">
				...
				<div class="right">
						...
						<div class="logged-out">
							...
							<a class="bold" href="https://www.smackjeeves.com/register.php">Create Account</a>
