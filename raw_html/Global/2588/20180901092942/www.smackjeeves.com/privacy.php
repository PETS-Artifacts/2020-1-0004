...
<body>
	...
	<div style="height: 1px; width: 1px; position: absolute; left: -1px; top: 0; overflow: hidden;"><a href="/user-data/?902" rel="nofollow" onclick="return false">User Data</a></div>
	...
	<div id="inner-wrapper">
		...
		<div id="header"><div class="just">
			...
			<script>
				_bgaw = {id:"gRXstzNMfSEG"};
			</script>
			<style type="text/css">
				#gRXstzNMfSEG_u { display: none; }
			</style>
			<div style="position: relative; width: 728px; height: 90px; overflow: hidden;">
		
				<div class="Wf02sE2iQHTu" style="position: absolute; top: 0; left: 0; width: 728px; height: 90px; z-index: 4; pointer-events: none;">
					<script src="//bid.glass/ext/js/mid-adbox-2.js?ad_box_1&ad_channel=2&ad_slot=3&adsize=300x250"></script>
				</div>
		
				<div class="nT5vRLDv2udLW" style="position: absolute; top: 0; left: 0; width: 728px; height: 90px; z-index: 5; pointer-events: none;">
					<div id="div-gpt-ad-1534879141639-0">
	    <script type="text/javascript">
	        googletag.cmd.push(function() { googletag.display("div-gpt-ad-1534879141639-0"); });
				...
				<div id="gRXstzNMfSEG_u" style="position: absolute; top: 0; left: 0; width: 728px; height: 90px; z-index: 1;">
					<a id="HMOVBUP8X3pIV9n" href="#" style="display: none" target="_blank" rel="nofollow"><img id="HMOVBscwTQe7X" width="728" height="90" /></a>
				</div>
			
			</div>
			<script>
				_bgaw = undefined;
				if( document.getElementById("gRXstzNMfSEG") ) {
					document.getElementById("gRXstzNMfSEG_u").style.display = "none";
				} else {
					(function() {
						var css = 'body .nT5vRLDv2udLW > * { pointer-events: none; }',
			...
			bgclient.cmd.push(function() {
				...
				bgclient.main.addUnit({"token":"WMuzWBBFXR_Wi4DvzM42P8_DPQ-nYlILst6HAVnBiERypSJUg5kV_nlMTIrnHxAtYF6MQiE2MhFSFyvj72g_m-xCqcv8UZkl8IJ2py0X1GtNhXyFMfpVHDkwJaalxs9feppJVpxzQEtK4k3yeEX1uLtQFT29nQw5SrllpZ5SroNudvB6OG9Yn4FTSQz1cWNFgl_ufVOfm4GpqnWUO1A","element_id":"HMOVBUP8X3pIV9n","img_id":"HMOVBscwTQe7X","img_src":"\/8D\/images\/p8hkyvkpmAHkL.jpg","href":"https:\/\/tapas.io\/episode\/550197"});
