...
<head>
	...
	<link rel="icon" href="http://www.smackjeeves.com/images/new-favicon.ico" type="image/x-icon" />
	<link rel="shortcut icon" href="http://www.smackjeeves.com/images/new-favicon.ico" type="image/x-icon" />

	<link rel="stylesheet" type="text/css" media="screen" href="/style.css.php?version=15" />
	
	<script type="text/javascript" src="/common.js.php?version=5"></script>
...
<body>
	...
	<script type="text/javascript" src="/tooltip.js.php"></script>
	<script type="text/javascript">
		function trigger_request(cid, mature) {
			
			if (mature && 1) {
			
				ddrivetip('<div style="margin: 0 auto;"><img src="http://www.smackjeeves.com/images/mostrecentstrips.gif" height="20" width="136" /></div><img src="http://www.smackjeeves.com/images/mature_content.png" style="padding: 2px;" />');
			
			} else {
				
				ddrivetip('<div style="margin: 0 auto;"><img src="http://www.smackjeeves.com/images/mostrecentstrips.gif" height="20" width="136" /></div><img src="http://www.smackjeeves.com/thumbnail.php?id=' + cid + '" style="padding: 2px;" />');
	...
	<div id="page_container">
		<div id="header">
			<div id="header-top">
				<div id="logo">
					<a href="http://www.smackjeeves.com/"><img src="http://www.smackjeeves.com/images/logo-white.png" alt="Smack Jeeves Webcomic Hosting - Free Online Comics Host" title="Go to Home Page" /></a>
				</div>				
				<div id="top_leaderboard" class="leaderboard_ad">
					<!--  Begin Rubicon Project Tag -->
						<!--  Site: Smack Jeeves   Zone: Above the Fold   Size: Leaderboard  -->
						<!--  PLACEMENT: Above the Fold;   -->
						<script language="JavaScript" type="text/javascript">
						rp_account   = '12434';
						rp_site      = '48874';
						rp_zonesize  = '221268-2';
						rp_adtype    = 'js';
						rp_smartfile = '[SMART FILE URL]';
						</script>
						<script type="text/javascript" src="http://ads.rubiconproject.com/ad/12434.js"></script>
			...
			<div id="header-bottom">
				<div id="header_search">	
					<form action="/search.php" method="get">
						...
						<input id="header_search_box" type="text" name="comic_title" /> <input type="submit" name="submit" value="Search" /> 
						<a href="/search.php?advanced"><img src="/images/advanced-white.png" /></a>
					</form>
				</div>
				
				<a id="hdrCreateAccount" href="/register.php">Create Account</a> or <a id="hdrLogIn" href="/login.php?ref=%2Fprivacy.php">Log In</a>				<div class="clear"></div>
			</div>
		</div>
		<div id="header_2">
			<ul id="site_tabs">
				<li><a id="tab_read_comics" class="tab_anchor" href="/search.php"><span class="shadow"><span class="clicky">
					Browse
				</span></span></a></li>
				<li><a id="tab_create_comics" class="tab_anchor" href="/preview.php" alt="Webcomic Publishing made easy."><span class="shadow"><span class="clicky">
					Create
				</span></span></a></li>
				<li><a id="tab_forums" class="tab_anchor" href="/forum/"><span class="shadow"><span class="clicky">
					Forums
				</span></span></a></li>
				<li><a id="tab_premium" class="tab_anchor" href="/premium.php"><span class="shadow"><span class="clicky">
					Premium
				</span></span></a></li>
			</ul>
			<ul id="user_tabs">
				<!-- <li><a class="tab_anchor" href="#"><span>My Dashboard</span></a></li> -->
				<li><a class="tab_anchor" href="/register.php"><span class="shadow"><span class="clicky">
					My Profile
				</span></span></a></li>
				<li class="dropdown" onMouseOut="hideDropdown('favorites_dropdown')" onMouseOver="preserveDropdown('favorites_dropdown')">
					<a class="tab_anchor" href="/favorites.php"><span class="shadow"><span class="clicky">
						My Favorites
					</span></span></a>
					<div class="selector">
						<span class="arrow" onClick="toggleDropdown('favorites_dropdown')"><span class="shadow"></span></span>
							
						<div id="favorites_dropdown" class="dropdown_content not_logged_in"><div>
									To access your favorite comics, please<br />
									<a href="/register.php">Create an Account</a> or <a href="/login.php?ref=favorites.php">Log In</a>
								</div></div>							
					</div>
				</li>
				<li class="dropdown" onMouseOut="hideDropdown('webcomics_dropdown')" onMouseOver="preserveDropdown('webcomics_dropdown')">
					<a class="tab_anchor" href="sitemanagement.php"><span class="shadow"><span class="clicky">
						My Webcomics
					</span></span></a>
					<div class="selector">
						<span class="arrow" onClick="toggleDropdown('webcomics_dropdown')"><span class="shadow"></span></span>
							
						<div id="webcomics_dropdown" class="dropdown_content not_logged_in"><div>
									To manage your webcomics, please<br />
									<a href="/register.php">Create an Account</a> or <a href="/login.php?ref=sitemanagement.php">Log In</a>
								</div></div>
					</div>
				</li>
				<!-- http://wiki.smackjeeves.com/index.php/Main_Page -->
				<li><a class="tab_anchor" href="http://www.smackjeeves.com/forum/viewforum.php?f=6"><span class="shadow"><span class="clicky">
					Help
				</span></span></a></li>
			</ul>
			<div class="clear"></div>
...
<p>
        ...
        real name and instant messanger contacts. This site does not collect any more personal information than what has been stated.<br /><br />
        
        We do not solicit or knowingly collect information from children under 13 years old, nor will we accept registration from them. 
...
<p>
      ...
      If you have any questions about this privacy statement, the practices of this site, or your dealings with this Web site, you may contact us via the "Contact" page linked at the site's footer.
					...
					<div class="default_skyscraper">
						<iframe src="http://www.smackjeeves.com/ads/pw_skyscraper.html?2645" frameborder="0" scrolling="no" allowtransparency="true" style="border: none; height: 600px; width: 160px; overflow: hidden;"></iframe>					</div>
	...
	<div id="footer">
		...
		<div id="copyright">&copy; 2005-2016 Smack Jeeves Webcomic Hosting<br /><br />
		
			Powered by <a href="http://www.wiredtree.com/230.html" style="color: #7CFC00">WiredTree</a>.
