...
<body>
	...
	<div style="height: 1px; width: 1px; position: absolute; left: -1px; top: 0; overflow: hidden;"><a href="/user-data/?592" rel="nofollow" onclick="return false">User Data</a></div>
	...
	<div id="inner-wrapper">
					...
					<script>
						...
						$('#ut-agree').click(function() {
							...
							SJ.ajax('/ajax/agree_new_terms.php', {v:'1xva3lno9'}, function( data ) {
