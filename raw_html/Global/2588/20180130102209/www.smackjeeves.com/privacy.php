...
<body>
	...
	<div style="height: 1px; width: 1px; position: absolute; left: -1px; top: 0; overflow: hidden;"><a href="/user-data/?383" rel="nofollow" onclick="return false">User Data</a></div>
	...
	<div id="inner-wrapper">
		...
		<div id="header"><div class="just">
			...
			<script>
				_bgaw = {id:"W57361ruW7Iu"};
			</script>
			<style type="text/css">
				#W57361ruW7Iu_u { display: none; }
			</style>
			<div style="position: relative; width: 728px; height: 90px; overflow: hidden;">
		
				<div class="xNbiDiJasok" style="position: absolute; top: 0; left: 0; width: 728px; height: 90px; z-index: 4; pointer-events: none;">
					<script src="//bid.glass/ext/js/mid-adbox-2.js?ad_box_1&ad_channel=2&ad_slot=3&adsize=300x250"></script>
				</div>
		
				<div class="iACsHA213Hk" style="position: absolute; top: 0; left: 0; width: 728px; height: 90px; z-index: 5; pointer-events: none;">
	    ...
	    <script type="text/javascript">
	        googletag.cmd.push(function() { googletag.display("div-gpt-ad-1498686723684-4"); });
				...
				<div id="W57361ruW7Iu_u" style="position: absolute; top: 0; left: 0; width: 728px; height: 90px; z-index: 1;">
					<a id="MhL2LsRaJJWAginR" href="#" style="display: none" target="_blank" rel="nofollow"><img id="MhL208C0kWND2HJ" width="728" height="90" /></a>
				</div>
			
			</div>
			<script>
				_bgaw = undefined;
				if( document.getElementById("W57361ruW7Iu") ) {
					document.getElementById("W57361ruW7Iu_u").style.display = "none";
				} else {
			...
			bgclient.cmd.push(function() {
				...
				bgclient.main.addUnit({
					element_id: 'MhL2LsRaJJWAginR',
					img_id: 'MhL208C0kWND2HJ',
					token: 'foTA9AYG9EbPxQywnRaBzMD4cFHs-QTD6ggqfTKDhpcPawVcbmj4GTWcd9vh5HtbLzVBSy0qc_8YWJ6fbtE_cwZ-K5CL25LJC5lQw21VwRufcVcZcq23WGYFRP4MoXmDQ1wdTfwjvRb-fuShJw4qj4ZI37so5HF8hQfCJTHVt4SbVNTYZk5FWHidvmutdCuVQtbnxKFwnGcL96Ap',
					img_src: "\/8D\/images\/2epvshgzm5FJJc.png",
					href: "http:\/\/stupidshorteeveecomic.smackjeeves.com\/"
				});
