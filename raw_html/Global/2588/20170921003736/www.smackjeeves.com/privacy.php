			...
			(function(SJHB, googletag) {
				...
				if( SJHB.enabledSlots.length ) {
					...
					googletag.cmd.push(function () {
						...
						<script type="text/javascript" src="//www.smackjeeves.com/js/hb/iv.js" async></script>
...
<body>
	...
	<div style="height: 1px; width: 1px; position: absolute; left: -1px; top: 0; overflow: hidden;"><a href="/user-data/?869" rel="nofollow">User Data</a></div>
	...
	<div id="inner-wrapper">
		...
		<div style="position: relative; width: 728px; height: 90px; overflow: hidden;">
			...
			<div class="mrap" style="position: absolute; top: 0; left: 0; width: 728px; height: 90px; z-index: 4; pointer-events: none;">
				<script type="text/javascript" src="http://onezo.org/sj/mid-adbox-1.js?Atj9RL|1&ad_box_1&ad_channel=2&ad_slot=3&adsize=300x250"></script>
			</div>
	    ...
	    <script type="text/javascript">
			...
			<div id="Atj9RL_u" style="position: absolute; top: 0; left: 0; width: 728px; height: 90px; z-index: 1;">
				<a id="ssa_Pa1QyKS5KsRM" href="#" style="display: none" target="_blank" rel="nofollow"><img id="ssi_Pa1QyKS5KsRM" data-src="//www.smackjeeves.com/self-serve/images/aotg_lead_bl.jpg" width="728" height="90" /></a>
			</div>
		
		</div>
		<script type="text/javascript">
			_sjaw = null;
			if( document.getElementById("Atj9RL") ) {
				document.getElementById("Atj9RL_u").style.display = "none";
			} else {
				(function() {
			
			var a = document.getElementById('ssa_Pa1QyKS5KsRM'),
				i = document.getElementById('ssi_Pa1QyKS5KsRM');
						
			i.addEventListener('load', function() {
				document.createElement('img').src = '//www.smackjeeves.com/self-serve/imp.php?id=1&token=Pa1QyKS5KsRM';
			}, false);
			
			i.src = i.dataset.src;
			a.href = '//www.smackjeeves.com/self-serve/out.php?id=1&token=Pa1QyKS5KsRM';
