...
<head>
	...
	<script src="//www.smackjeeves.com/js/main2.js?v=2"></script>
		...
		<script type="text/javascript" src="//www.smackjeeves.com/js/hb/prebid-rx.js?v=2" async></script>
		<script>
				...
				if( SJHB.enabledSlots.length ) {
					...
					googletag.cmd.push(function () {
						for( var i = 0; i < SJHB.enabledSlots.length; i++ ) {
							googletag.defineSlot(SJHB.allInventory[SJHB.enabledSlots[i]].slot, SJHB.allInventory[SJHB.enabledSlots[i]].sizes, SJHB.allInventory[SJHB.enabledSlots[i]].code).addService(googletag.pubads());
						}
...
<body>
	...
	<div id="inner-wrapper">
		...
		<div id="header"><div class="just">
			...
			<div class="ad_ph"><div id="div-gpt-ad-1498686723684-4">
