...
<head>
	...
	<link rel="stylesheet" type="text/css" href="//www.smackjeeves.com/style3.css?v=14">
	...
	<script src="//www.smackjeeves.com/js/main2.js?v=2"></script>
		...
		(function() {
			...
			var debug = window.location.search.indexOf('fsdebug') == -1 ? false : true,
				desktopSlots = ["SmackJeeves_728x90_ATF"],
				mobileSlots = [];
			...
			if( $(window).width() >= 768 ) {
				...
				freestar.config.enabled_slots = desktopSlots;

			} else {

				freestar.config.enabled_slots = mobileSlots;

			}

			if( freestar.config.enabled_slots ) {
			
				!function(a,b){var c=b.getElementsByTagName("script")[0],d=b.createElement("script"),e="https://pub.freestar.io/smackjeeves";e+=debug?"/qa/pubfig.min.js":"/pubfig.min.js",d.async=!0,d.src=e,c.parentNode.insertBefore(d,c)}(window,document);
...
<body>
	...
	<div id="inner-wrapper">
		...
		<div id="header"><div class="just">
			...
			<div class="ad_ph"><div id="SmackJeeves_728x90_ATF">
	    <script data-cfasync="false" type="text/javascript">
	        freestar.queue.push(function () { googletag.display("SmackJeeves_728x90_ATF"); });
	    </script>
	</div></div>
