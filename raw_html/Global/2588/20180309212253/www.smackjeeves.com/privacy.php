...
<body>
	...
	<div style="height: 1px; width: 1px; position: absolute; left: -1px; top: 0; overflow: hidden;"><a href="/user-data/?500" rel="nofollow" onclick="return false">User Data</a></div>
	...
	<div id="inner-wrapper">
		...
		<div id="header"><div class="just">
			...
			<script>
				_bgaw = {id:"OoyVm6MxsVBa"};
			</script>
			<style type="text/css">
				#OoyVm6MxsVBa_u { display: none; }
			</style>
			<div style="position: relative; width: 728px; height: 90px; overflow: hidden;">
		
				<div class="PJqwQAfwUZe" style="position: absolute; top: 0; left: 0; width: 728px; height: 90px; z-index: 4; pointer-events: none;">
					<script src="//bid.glass/ext/js/mid-adbox-2.js?ad_box_1&ad_channel=2&ad_slot=3&adsize=300x250"></script>
				</div>
		
				<div class="ox9XKFoqXpu" style="position: absolute; top: 0; left: 0; width: 728px; height: 90px; z-index: 5; pointer-events: none;">
	    ...
	    <script type="text/javascript">
	        googletag.cmd.push(function() { googletag.display("div-gpt-ad-1498686723684-4"); });
				...
				<div id="OoyVm6MxsVBa_u" style="position: absolute; top: 0; left: 0; width: 728px; height: 90px; z-index: 1;">
					<a id="wZTlAvSOBxIcm" href="#" style="display: none" target="_blank" rel="nofollow"><img id="wZTd22KkWKBOrYH" width="728" height="90" /></a>
				</div>
			
			</div>
			<script>
				_bgaw = undefined;
				if( document.getElementById("OoyVm6MxsVBa") ) {
					document.getElementById("OoyVm6MxsVBa_u").style.display = "none";
				} else {
			...
			bgclient.cmd.push(function() {
				...
				bgclient.main.addUnit({
					element_id: 'wZTlAvSOBxIcm',
					img_id: 'wZTd22KkWKBOrYH',
					token: 'XcgxE1XOOISQUJzDIGuHn_wlep18BCODMFevEgirKutL_W7PdklzZLHOM8rCy2ZwQSrg8QLQir37VSV5x_IuILvzSjpgaNJO4kwmx4XoQwnUsh1ptDDErfzmhE1kq7ZIXE-MGeoJ_PSg-I8Qt70VVcSJAlbCWUyRwC9u9HXrx-UzFS7cqQLrsJUx0KAw5iB9woOP4g9GB-L6ZBjI',
					img_src: "\/8D\/images\/21nzwugy1y3cSN.jpeg",
					href: "http:\/\/ingress.smackjeeves.com\/comics\/2567400\/chapter-1-cover\/"
				});
