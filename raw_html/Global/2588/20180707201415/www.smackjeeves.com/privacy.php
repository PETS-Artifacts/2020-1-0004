...
<body>
	...
	<div style="height: 1px; width: 1px; position: absolute; left: -1px; top: 0; overflow: hidden;"><a href="/user-data/?855" rel="nofollow" onclick="return false">User Data</a></div>
	...
	<div id="inner-wrapper">
		...
		<div id="header"><div class="just">
			...
			<script>
				_bgaw = {id:"uRUtXyIt8Avbm"};
			</script>
			<style type="text/css">
				#uRUtXyIt8Avbm_u { display: none; }
			</style>
			<div style="position: relative; width: 728px; height: 90px; overflow: hidden;">
		
				<div class="dt83NZjCHMhcG" style="position: absolute; top: 0; left: 0; width: 728px; height: 90px; z-index: 4; pointer-events: none;">
					<script src="//bid.glass/ext/js/mid-adbox-2.js?ad_box_1&ad_channel=2&ad_slot=3&adsize=300x250"></script>
				</div>
		
				<div class="xQsyWvlErV" style="position: absolute; top: 0; left: 0; width: 728px; height: 90px; z-index: 5; pointer-events: none;">
	    ...
	    <script type="text/javascript">
	        googletag.cmd.push(function() { googletag.display("div-gpt-ad-1498686723684-4"); });
				...
				<div id="uRUtXyIt8Avbm_u" style="position: absolute; top: 0; left: 0; width: 728px; height: 90px; z-index: 1;">
					<a id="FMPxcq83tcPJ2" href="#" style="display: none" target="_blank" rel="nofollow"><img id="FMPxJ1YUnwSCPyUg" width="728" height="90" /></a>
				</div>
			
			</div>
			<script>
				_bgaw = undefined;
				if( document.getElementById("uRUtXyIt8Avbm") ) {
					document.getElementById("uRUtXyIt8Avbm_u").style.display = "none";
				} else {
					(function() {
						var css = 'body .xQsyWvlErV > * { pointer-events: none; }',
			...
			bgclient.cmd.push(function() {
				...
				bgclient.main.addUnit({"token":"P3uSbQsK40RiEHXO7Nq8ZvpjyvmfokW_7Ej7emz_MJsdgVhLQdsiXdRBELPpjnSb6PAVoBbeh77RRFevuRoLeyQedifu_xdoRFgr68zrBIx5NxqfdexSGUGBpmE1zaRcixjIVmm2X7ZfzI9n9yfTfLySTLSpewDUBN7EYmvv2VU2yjgJkM-AfJMgJVpyTfc4PJ898214pO3SfObvQI0","element_id":"FMPxcq83tcPJ2","img_id":"FMPxJ1YUnwSCPyUg","img_src":"\/8D\/images\/7eyqjcqga2pT.jpeg","href":"http:\/\/rainydaydreams.mariahcurrey.com\/"});
