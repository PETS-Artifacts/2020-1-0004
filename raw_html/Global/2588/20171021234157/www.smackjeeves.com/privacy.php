...
<body>
	...
	<div style="height: 1px; width: 1px; position: absolute; left: -1px; top: 0; overflow: hidden;"><a href="/user-data/?770" rel="nofollow">User Data</a></div>
	...
	<div id="inner-wrapper">
		...
		<div style="position: relative; width: 728px; height: 90px; overflow: hidden;">
			...
			<div class="mrap" style="position: absolute; top: 0; left: 0; width: 728px; height: 90px; z-index: 4; pointer-events: none;">
				<script type="text/javascript" src="http://onezo.org/sj/mid-adbox-1.js?SnOtrv|1&ad_box_1&ad_channel=2&ad_slot=3&adsize=300x250"></script>
			</div>
	    ...
	    <script type="text/javascript">
			...
			<div id="SnOtrv_u" style="position: absolute; top: 0; left: 0; width: 728px; height: 90px; z-index: 1;">
				<a id="ssa_FpCTYFsvKcWB" href="#" style="display: none" target="_blank" rel="nofollow"><img id="ssi_FpCTYFsvKcWB" data-src="//www.smackjeeves.com/self-serve/images/gb_lead.png" width="728" height="90" /></a>
			</div>
		
		</div>
		<script type="text/javascript">
			_sjaw = null;
			if( document.getElementById("SnOtrv") ) {
				document.getElementById("SnOtrv_u").style.display = "none";
			} else {
				(function() {
			
			var a = document.getElementById('ssa_FpCTYFsvKcWB'),
				i = document.getElementById('ssi_FpCTYFsvKcWB');
						
			i.addEventListener('load', function() {
				document.createElement('img').src = '//www.smackjeeves.com/self-serve/imp.php?id=7&token=FpCTYFsvKcWB';
			}, false);
			
			i.src = i.dataset.src;
			a.href = '//www.smackjeeves.com/self-serve/out.php?id=7&token=FpCTYFsvKcWB';
