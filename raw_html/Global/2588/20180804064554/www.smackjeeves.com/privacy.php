...
<body>
	...
	<div style="height: 1px; width: 1px; position: absolute; left: -1px; top: 0; overflow: hidden;"><a href="/user-data/?384" rel="nofollow" onclick="return false">User Data</a></div>
	...
	<div id="inner-wrapper">
		...
		<div id="header"><div class="just">
			...
			<script>
				_bgaw = {id:"GnjNnNgxhEwd"};
			</script>
			<style type="text/css">
				#GnjNnNgxhEwd_u { display: none; }
			</style>
			<div style="position: relative; width: 728px; height: 90px; overflow: hidden;">
		
				<div class="Imdl2jpu1CKNu" style="position: absolute; top: 0; left: 0; width: 728px; height: 90px; z-index: 4; pointer-events: none;">
					<script src="//bid.glass/ext/js/mid-adbox-2.js?ad_box_1&ad_channel=2&ad_slot=3&adsize=300x250"></script>
				</div>
		
				<div class="vPs7rB6sNM6MS" style="position: absolute; top: 0; left: 0; width: 728px; height: 90px; z-index: 5; pointer-events: none;">
	    ...
	    <script type="text/javascript">
	        googletag.cmd.push(function() { googletag.display("div-gpt-ad-1498686723684-4"); });
				...
				<div id="GnjNnNgxhEwd_u" style="position: absolute; top: 0; left: 0; width: 728px; height: 90px; z-index: 1;">
					<a id="IZPk8sDmmVmYl5N5" href="#" style="display: none" target="_blank" rel="nofollow"><img id="IZPkXxHRe8VlzUAt" width="728" height="90" /></a>
				</div>
			
			</div>
			<script>
				_bgaw = undefined;
				if( document.getElementById("GnjNnNgxhEwd") ) {
					document.getElementById("GnjNnNgxhEwd_u").style.display = "none";
				} else {
					(function() {
						var css = 'body .vPs7rB6sNM6MS > * { pointer-events: none; }',
			...
			bgclient.cmd.push(function() {
				...
				bgclient.main.addUnit({"token":"_l6N9JO8rlhdc6oIWaPFS7MChiJw6yd-b_zC8AjEWWD9AM3AWcoJGoayeUgrwQ_9ZyEO2QoEQsm5h7A2v053J4XYHIDhxSmKwTUKsv0eRd_pAn_iEtMWIZxQ1H6yJAZYOA9JwUM9zlF6zT4PUzdMU5VDt1bFP4B7TPG3oX68DEASNpKsVZeC5733zj9wdzZfFLTwHTGAqNCMNyDOrdU","element_id":"IZPk8sDmmVmYl5N5","img_id":"IZPkXxHRe8VlzUAt","img_src":"\/8D\/images\/jtg4vnny9DM8j.png","href":"http:\/\/www.sandraandwoo.com\/2000\/01\/01\/welcome-to-sandra-and-woo\/"});
