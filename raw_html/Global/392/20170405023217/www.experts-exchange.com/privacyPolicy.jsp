...
<html>
  <head>
    ...
    <link rel="stylesheet" href="https://cdn.experts-exchange.com/css/2/163bc739a324874d95f4ce2426337caeeb203f0c8cf244ba8e4c07e1d32a5e4c.css" media="all" />
    <link rel="stylesheet" href="https://cdn.experts-exchange.com/css/2/61789cfda1b322d26d2995b7fad2a7201d1c2a3edc35abc1b2ea09f20b92bec3.css" media="all" />
    <script src="https://cdn.experts-exchange.com/js/2/5289cd398a6caa6bf47b4477ffcfde96299723d54954a9aa994d129d7ad30bdd.js" type="text/javascript"></script>
    <script src="https://cdn.experts-exchange.com/js/2/a3c154bbb8950ff6048988d3594dd9d1f98a08a5d28c45219cce34c62200a076.js" type="text/javascript"></script>
    <script type="text/javascript">
        ...
        _gaq.push(['_trackEvent', 'General', 'Page View Count', undefined, 87]);
  ...
  <body class="desktop" itemscope="itemscope" itemtype="http://schema.org/WebPage">
        ...
        <div id="wrapper2">
                  ...
                  <div class="topHeader-inner">
                    ...
                    <div class="first-section">
                      ...
                      <div class="topHeader-mainNavWrapper mobileNavWrapper">
                        <ul class="mainNavigation">
                           <li class="browse"><a href="#" class="topNavItem" data="browseDropdown" alt="Browse"><span>Browse<span class="arrow"></span></span></a>
                                 ...
                                 <li><a href="/courses/" alt="View Courses" class="courses newLink" data-track="courses_view"><span>Courses</span></a></li>
                        		  </ul>
                           </li>
                        ...
                        <div class="productNav-mobile">
                          <ul class="productNav">
                          	<li>
                          		<a href="#" class="topNavItem productNav-icon" data="productNavDropdown" alt="Experts Exchange "><span>Products<span class="arrow"></span></span></a>
                          		<a class="liveNotifTarget" href="/live?tschatClientsTab=conversations">
                          		</a>
                          		<ul class="productNavDropdown topNavDropDown hidden">
                          			<li class="mobileNavBack">
                          				<a href="#">Back</a><span>Products</span>
                          			</li>
                          			<li>
                          				<a href="/gigs/" alt="Gigs" title="Find freelancers to complete your next tech project" class="gigs" data-track="gigs"><span class="image"></span><span>Gigs</span></a>
                          			</li>
                          			<li>
                          				<a href="/live/" alt="Live" title="Receive real-time tech help" class="live" data-track="live"><span class="image"></span><span>Live</span></a>
                          			</li>
                          			<li>
                          				<a href="/courses/" alt="Courses" title="Learn from other technology professionals" class="courses" data-track="courses"><span class="image"></span><span>Courses</span></a>
                          			</li>
                          			<li>
                          				<a href="/vpsHowItWorks.jsp" alt="Vendor Products" title="Attracting technology buyers has never been easier" class="vps" data-track="vps"><span class="image"></span><span>Vendor Services</span></a>
                          			</li>
                          			<li>
                          				<a href="/groups/" alt="Groups" title="Outlet for networking and discussing specific technology interests" class="groupsLink" data-track="groupsLink"><span class="image"></span><span>Groups</span></a>
                          			</li>
                          			<li>
                          				<a href="/careers/" alt="Careers" title="Find your dream job" class="careers" data-track="careers"><span class="image"></span><span>Careers</span></a>
                          			</li>
                          			<li>
                          				<a href="https://shop.experts-exchange.com/" target="_blank" alt="Store" title="Shop for deals" class="eeStore" data-track="eeStore"><span class="image"></span><span>Store</span></a>
                          			</li>
                          			<li>
                          					<a href="/headlines.jsp" alt="Headlines" title="Headlines from around the tech world" class="headlines" data-track="headlines"><span class="image"></span><span>Headlines</span></a>
                          			</li>
                          			<li>
                          				<a href="/Expert_Testing/" alt="Find bugs, and get Expert feedback on any website" class="bugs" data-track="bugs"><span class="image"></span><span>Website Testing</span></a>
                          			</li>
                          			<li>
                          				<a href="/tools/" alt="Explore our free set of diagnostic and discovery tools, built with your tech solutions in mind" class="tools" data-track="tools"><span class="image"></span><span>Tools</span></a>
                          			</li>
                          		</ul>
                          	</li>
                          </ul>
                      ...
                      <div class="askNavigation">
                        ...
                        <ul>             
                          <li class="help"><span class="button"><a href="#" class="topNavItem btn" data="askHelpDropdown" alt="Ask for Help"><span><span class="text">Ask for Help</span><span class="arrow"></span></span></a></span>
                            <ul class="askHelpDropdown topNavDropDown hidden">
                               ...
                               <li><a href="/getHelp.jsp" alt="Ways to Get Help" class="gettingStarted last" data-track="help_get-started"><span>Ways to Get Help</span></a></li>
                            </ul>
                         </li>
                      </ul>
                      </div>
                    ...
                    <div class="last-sectionWrapper">
                      ...
                      <div class="last-section">
                        ...
                        <script type="text/javascript" id="contentJavascript-id2">
                          featherlightBind('#topHeader .loginPopup','/async/loginHeader.async?asid=login&topnavselect=LO_login&redirect=/privacyPolicy.jsp');
                        </script>
          ...
          <div id="bodyWrapper">
            <div id="columnsWrapper">
              <div class="component textComponent stlco privacyPolicy component-alt-bg2" id="textComponent-id20">
                <header class="head">
                ...
                <div class="body">
                  <div class="section">
                    ...
                    <ul>
                    <li>more detailed contact information (including a picture of yourself);</li>
                    ...
                    <p>You have the right to change or remove the information in your profile at any time by editing your profile.</p>
                    ...
                    <p>More information can be obtained on cookies by visiting <a href="http://www.allaboutcookies.org/manage-cookies/index.html" target="_blank">www.allaboutcookies.org/manage-cookies/index.html</a> which is run by the Interactive Advertising Bureau.</p>
                    ...
                    <p>Experts Exchange periodically contacts members using information supplied by members. Members may opt-out of receiving certain future mailings, such as the Experts Exchange newsletter and marketing mailings, in the following manners: (i) during the registration process, (ii) by clicking the unsubscribe link at the bottom of such mailings, or (iii) by unsubscribing in the Settings page.</p>
                    
                    <p>Experts Exchange may contact you for a number of purposes related to the service you have signed up for. For example, we may wish to notify you that a particular service has been improved or suspended. </p>
                    ...
                    <p>If a member elects to use the Share icon for informing a friend of activity on our site, we ask the member for the friend's name and email address. Experts Exchange will automatically send the friend a one-time email inviting the friend to visit the site. This email will include the name and email address of the member making the referral. Personal information collected in this manner is used in accordance with this Privacy Policy. By sharing the personal information described in this section, you affirm that you have the referred person’s consent for such distribution.</p>
                    ...
                    <p>We reserve the right to disclose your personal information, without prior notice to you, as required by law, or when we believe that disclosure is necessary to protect our rights or comply with a judicial proceeding, court order, or legal process served on our web site. Additionally, we may share your personal information when we believe it is necessary to protect our interests or property, to prevent fraud or other illegal activity perpetrated through the Experts Exchange service or using the Experts Exchange name, or to prevent imminent bodily harm. This may include sharing information with other companies, lawyers, agents or government agencies. Please be aware that Experts Exchange may be required to disclose an individual’s personal information in response to a lawful request by public authorities, including to meet national security or law enforcement requirements. </p>
                    
                    <p>We employ service providers and other companies and individuals to perform functions and provide services on our behalf who may have access to your member information needed to perform their functions and also to provide you with the services that you have requested, but these service providers may not use it for any other purpose. Such service providers may include credit card transaction processors, communication platform providers, and hosting services providers, and the information that could be provided to these service providers may include names, credit card numbers, email addresses and mobile phone numbers. Such service providers will be subject to appropriate contractual arrangements and security obligations as required by applicable law and are contractually obligated to maintain the confidentiality of personal information in accordance with this Privacy Policy and the EU-US Privacy Shield Framework.</p>
                    
                    <h2 class="title">7. Direct Marketing - Opting in and Opting out</h2>
                    
                    <p>We would like to provide you with information via email about new products, promotions, special offers and other information which we think you may find interesting. We fully appreciate that “spam” has become a problem in recent years and this is why we make sure you have the power to choose whether or not you want to receive such mailings. Members may opt-in to receive information from Experts Exchange regarding products or services that are considered of value by us and this is accomplished by selecting to receive such information during registration or by changing the preferences on the member's Settings page.</p>
                    
                    <p>Experts Exchange does not share your information with any third party unless you specifically grant permission to Experts Exchange by consenting via an opt-in offer or promotion. All contracted third parties are contractually obligated to maintain the confidentiality of personal information in accordance with this Privacy Policy and the EU-US Privacy Shield Framework. </p>
                    
                    <p>Experts Exchange is not responsible for removing information from third party lists that members have previously granted authorization to share. To opt-out of receiving future communications, you may do one of the following:</p>
                    
                    <ul>
                    <li>You can send email to <a href="mailto:opt-out@experts-exchange.com">opt-out@experts-exchange.com</a></li>
                    <li>You can send mail to the following postal address: Experts Exchange, LLC, Attn: Chief Privacy Officer, PO Box 1062 San Luis Obispo, CA 93406-1062</li>
                    </ul>
                    
                    <p>Experts Exchange is liable for appropriate onward transfers of personal EU data to third parties.</p>
                    
                    <h2 class="title">8. Our storage of your personal information</h2>
                    
                    <p>We will hold your personal information on our systems for as long as you use the services you have requested. If your membership with Experts Exchange lapses, we will maintain your information for a reasonable period of time after it lapses to permit you re-establish your membership and maintain any benefits you accrued while your prior membership was in effect. In some circumstances it may be necessary to retain your personal information to deal with any disputes. Accordingly, Experts Exchange may store messaging transcript data (including message content, member names, times and dates) arising from the use of Experts Exchange Community services for a period necessary to fulfill such purpose. We will ensure that all personal information supplied is held securely. In accordance with the EU-US Privacy Shield Framework, European Union individuals who wish to delete their personal information may contact Experts Exchange, LLC via the contact information listed in Section 14 of this Privacy Policy. Your contribution to information exchanges on Experts Exchange, may be maintained indefinitely by Experts Exchange in order to serve the site's intended purpose.</p>
                    ...
                    <p>Email: <a href="mailto:privacy@experts-exchange.com">privacy@experts-exchange.com</a></p>
                    
                    <p>Telephone: 805.787.0603</p>
                    
                    <p>You have the right to request a copy of the personal information Experts Exchange holds about you and to have any inaccuracies corrected. There may be a small charge for such administration requests. All such enquiries should be sent to our Chief Privacy Officer. Additionally, you may at any time change your information by updating your profile and/or settings.</p>
                    
                    <h2 class="title">14. Privacy Complaints by European Union and Swiss Citizens, Recourse, Enforcement and Liability</h2>
                    
                    <p>In compliance with the EU-US Privacy Shield Principles, Experts Exchange, LLC commits to resolve complaints about your privacy and our collection or use of your personal information.  European Union individuals with inquiries or complaints regarding this privacy policy should first contact Experts Exchange, LLC at:</p>
                    ...
                    <p>Experts Exchange, LLC has further committed to refer unresolved privacy complaints under the EU-US Privacy Shield Principles to BBB EU PRIVACY SHIELD, a non-profit alternative dispute resolution provider located in the United States and operated by the Council of Better Business Bureaus. If you do not receive timely acknowledgment of your complaint, or if your complaint is not satisfactorily addressed, please visit www.bbb.org/EU-privacy-shield/for-eu-consumers/ for more information and to file a complaint.</p>
                    
                    <p>In compliance with the US-Swiss Safe Harbor Principles, Experts Exchange, LLC commits to resolve complaints about your privacy and our collection or use of your personal information.  Swiss citizens with inquiries or complaints regarding this privacy policy should first contact Experts Exchange, LLC at:</p>
                    ...
                    <p>Experts Exchange, LLC has further committed to refer unresolved privacy complaints under the US-Swiss Safe Harbor to an independent dispute resolution mechanism operated by the Council of Better Business Bureaus. If you do not receive timely acknowledgment of your complaint, or if your complaint is not satisfactorily addressed, please visit www.bbb.org/us/safe-harbor-complaints for more information and to file a complaint.</p>
                    
                    <p>This service verifies adherence to the EU Privacy Shield Policy by means of in-house verification by the management of this company. Experts Exchange, LLC is subject to the investigatory and enforcement powers of the Federal Trade Commission.</p>
                    
                    <p>Finally, as a last resort and in limited situations, EU individuals may seek redress from the Privacy Shield Panel, a binding arbitration mechanism.</p>
                    
                    <p><br>
                    <i>This policy was last modified on 06 September, 2016</i></p>
          ...
          <div id="footerInnerWrap">
            <div class="footerLiAndLoInnerWrapper">
              <div class="footerLiAndLOWrapper">
                <div class="component textComponent footerConditionalLinks" id="textComponent-id21">
                  <div class="body">
                    <div class="section">
                      ...
                      <div class="links aboutUs">
                         ...
                         <ul class="lastColumn">
                            ...
                            <li><a href="https://www.shareasale.com/shareasale.cfm?merchantID=55776" target="_blank">Affiliates</a></li>
                ...
                <div class="component textComponent" id="textComponent-id23">
                  <div class="body">
                    <div class="section">
                      <div class="copyRight">
                      &copy; 1996-2017 <a href="/index.jsp">Experts Exchange, LLC.</a> All rights reserved. Covered by US Patent.
                      </div>
            ...
            <div id="deprecatedBrowserWarning">
              <span class="component textComponent" id="textComponent-id24"></span>
            </div>
            <span class="component textComponent" id="textComponent-id25"></span>
    ...
    <script type="text/javascript">
      jqReady(function(e){setTimeout(function(e){jqPost('/async/nb.jsp',{asid: 'brlc', iasid: 'brlc', brai: '{"uUID":"a648c91c-f9e4-4cfa-9dc1-36300aa1ca0b","trackingEventTypeIds":[410],"nonBounceInterval":"FIVE_SECONDS","cmsSiteId":2,"memberId":0,"referenceId":0,"experienceStateId":43,"experienceTreatment":"LO_ZED","trackingPagename":"LO - privacyPolicy.jsp","trackingIdentifier":"","remoteAddress":"207.241.226.208","date":"Apr 4, 2017 7:32:17 PM","today":"Apr 4, 2017 12:00:00 AM","sessionId":"EED02BCFB6405237854FF79165E54457","isEntryPage":false,"isSubTACategoryPage":false,"isPageViewOnly":false}'})},5000);setTimeout(function(e){jqPost('/async/nb.jsp',{asid: 'brlc', iasid: 'brlc', brai: '{"uUID":"a648c91c-f9e4-4cfa-9dc1-36300aa1ca0b","trackingEventTypeIds":[410],"nonBounceInterval":"TEN_SECONDS","cmsSiteId":2,"memberId":0,"referenceId":0,"experienceStateId":43,"experienceTreatment":"LO_ZED","trackingPagename":"LO - privacyPolicy.jsp","trackingIdentifier":"","remoteAddress":"207.241.226.208","date":"Apr 4, 2017 7:32:17 PM","today":"Apr 4, 2017 12:00:00 AM","sessionId":"EED02BCFB6405237854FF79165E54457","isEntryPage":false,"isSubTACategoryPage":false,"isPageViewOnly":false}'})},10000);});
    </script>
    <script type="text/javascript">
        <!--
        (function() {
    ...
    <script type="text/javascript">
        <!--
          ...
          sOmniture.server='cms-b2.prod.aws.redsrci.com';
          sOmniture.channel='/';
          sOmniture.pageType='';
          sOmniture.list1='';
          sOmniture.eVar31='207.241.226.208';
    ...
    <script type="text/javascript">
          sOmniture.eVar40='LO (Not India)-LO_ZED';
          sOmniture.eVar22='87';
    ...
    <noscript>
        <img
        src="//metrics.experts-exchange.com/b/ss/eexchangeprod/1/H.7--NS/0"
    ...
    <script type="text/javascript">
        ...
        else if(jqGetAttribute(this,'href')!= '#' && jqGetAttribute(this,'href')!== undefined && jqGetAttribute(this,'href').indexOf('https://secure.livechatinc.com') == -1){goToUrl(jqGetAttribute(this,'href'),false,(jqGetAttribute(this,'target')!== undefined && jqGetAttribute(this,'target')=='_blank')); return false;}});
        ...
        function asyncOmniture_418882636(e) { sOmniture.eVar87='LO_eeStore'; sOmniture.events='';sOmniture.t(); sOmniture.eVar87=''; sOmniture.events='';}
        jqOn('#topHeader .eeStore','mouseup keypress click',function(e){if((e.type == "mouseup" && e.which != 2) || (e.type == "keypress" && e.which != 13)){return true;}
        if(e.type != "click" || e.which != 2){asyncOmniture_418882636(e);}
        if(e.which == 2 || (e.which == 1 && (e.metaKey || e.ctrlKey || e.shiftKey))){return true;}
        else if(jqGetAttribute(this,'href')!= '#' && jqGetAttribute(this,'href')!== undefined && jqGetAttribute(this,'href').indexOf('https://secure.livechatinc.com') == -1){goToUrl(jqGetAttribute(this,'href'),false,(jqGetAttribute(this,'target')!== undefined && jqGetAttribute(this,'target')=='_blank')); return false;}});
        //-->
    </script>
    <!-- cms-b2.prod.aws.redsrci.com:80 - Page: 75648 -->
  </body>
</html>
