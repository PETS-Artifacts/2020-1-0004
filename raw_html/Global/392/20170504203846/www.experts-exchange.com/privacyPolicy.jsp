...
<html>
  <head>
    ...
    <link rel="stylesheet" href="https://cdn.experts-exchange.com/css/2/24bc2260cf63303b2c3d9a30479623faaec4707a9c16308393d05418417b20dc.css" media="all" />
    <link rel="stylesheet" href="https://cdn.experts-exchange.com/css/2/42d6fd355eac22ec16d2760f12323116c64d1e779ac2b292ad5725b14526dc55.css" media="all" />
    ...
    <script src="https://cdn.experts-exchange.com/js/2/b600c64c3f266d83e52ae651075bd1f325d84868b8ad855040a29a1cc91c35a5.js" type="text/javascript"></script>
    <script type="text/javascript">
        ...
        _gaq.push(['_trackEvent', 'General', 'Page View Count', undefined, 73]);
  ...
  <body class="desktop" itemscope="itemscope" itemtype="http://schema.org/WebPage">
          ...
          <div id="header">
            <div id="headerInnerWrap">
              <div id="topHeaderBannerWrap">
                <div class="component infoBanner" id="infoBanner">
                  <div class="infoBannerhtml">
                    <div class="section">
                      <div class="nolinks content">
                        ...
                        <style>
                          div.cotmBannerWrap {
                              width: 100%;
                              height: 100px;
                              background: url('/images/experts-exchange/courses/cotmInfoBanner.jpg') no-repeat;
                              background-size: 100% 100%;
                              background-position: 50%;
                          }
                          div.cotmBannerWrap .cotmLogo,
                          div.cotmBannerWrap .cotmButton,
                          div.cotmBannerWrap .cotmCopy {
                          ...
                          h5.cotmLogoText {
                              ...
                              display: block;
                              padding-left: 75px;
                              background: url(/images/experts-exchange/courses/cotm-logo-white.svg) no-repeat 0px 0px;
                              background-size: contain;
                              position: relative;
                              left: 5%;
                              top: -3px;
                          }
                          div.cotmBannerWrap a.courseButton {
                              line-height: 3.5rem;
                              color: #ff671f;
                          ...
                          div.cotmBannerWrap a.courseButton span {
                              font-size: 1.8rem;
                              font-style: normal;
                              line-height: 4.4rem;
                              color: inherit;
                          ...
                          div.cotmBannerWrap a.courseButton:hover {
                              color: #fff;
                              background-color: #ff671f;
                              border: 1px solid #ff671f;
                          }
                          #infoBanner div.cotmBannerWrap p {
                              font-size: 1.2rem;
                              font-weight: 300;
                              padding-left: 30%;
                              color: #fff;
                          ...
                          .infoBannerhtml div.close {
                              display: none;
                          }
                          .loggedIn .infoBannerhtml div.close {
                              display: block;
                              position: absolute;
                              top: 0px;
                              right: 20px;
                          ...
                          .loggedIn .infoBannerhtml .close span {
                              text-indent: -80px;
                              color: #fff;
                          }
                          .loggedIn .infoBannerhtml .close span:after {
                              content: "X";
                              font-size: 1.4rem;
                              font-weight: 500;
                              color: #fff;
                          ...
                          .loggedIn .infoBannerhtml .close a:hover.close span:after {
                              font-weight: 600;
                          }
                          #flex1 > #topHeaderBannerWrap {
                            top: 0;
                          }
                          #bodyWrapper #columnsWrapper .component.textComponent .mainNav {
                            top: 260px;
                          }
                          }
                        ...
                        div#infoBanner .infoBannerhtml div.section {
                            height: auto;
                        }
                        div.cotmBannerWrap {
                            height: 120px;
                        ...
                        <body>
                          <div class="cotmBannerWrap">
                            <div class="cotmLogo">
                              <H5 class="cotmLogoText">Course Of The Month</H5>
                            </div>
                            <div class="cotmButton">
                              <div class="buttonWrapper">
                                <a class="courseButton" alt="Click to View May's Free Course" href="/courses/1001/CompTIA-A-220-901-220-902.html"><span>View May's Free Course</span></a>
                              </div>
                            </div>
                            <div class="cotmCopy">
                              <p>Announcing Course of the Month:</p>
                              <p>Premium Members can unlock a new, free course every month.</p>
                            </div>
                          </div>
                        </body>
                        </html>
                      ...
                      <div class="close">
                        <a href="#" class="button close" title="Close Banner"><span>[X]</span></a>
                      </div>
                      <script type="text/javascript">
                        jqOn('#infoBanner .button','click',function(e){(e).preventDefault();jqHide('#infoBanner');jqAsyncPost('#infoBanner','/async/banner/resetBanner.jsp',[{name:'asyncAction',value:'0'},{name:'iasid',value:'infoBanner'},{name:'asid',value:'infoBanner'},{name:'informationBannerId',value:'568'}]);});
                      </script>
                    </div>
                  </div>
                </div>
              ...
              <div class="component textComponent stlco privacyPolicy component-alt-bg2" id="textComponent-id18">
                ...
                <div class="body">
                  <div class="section">
                    ...
                    <p><br>
                    <i>This policy was last modified on 12 April, 2017</i></p>
    ...
    <script type="text/javascript">
      jqReady(function(e){setTimeout(function(e){jqPost('/async/nb.jsp',{asid: 'brlc', iasid: 'brlc', brai: '{"uUID":"39395dfe-026c-4221-bbe2-20bea22e3393","trackingEventTypeIds":[410],"nonBounceInterval":"FIVE_SECONDS","cmsSiteId":2,"memberId":0,"referenceId":0,"experienceStateId":43,"experienceTreatment":"LO_FVB","trackingPagename":"LO - privacyPolicy.jsp","trackingIdentifier":"","remoteAddress":"207.241.229.78","date":"May 4, 2017 1:38:47 PM","today":"May 4, 2017 12:00:00 AM","sessionId":"262E3F107C432DC38FD3B7D619ADD70B","isEntryPage":false,"isSubTACategoryPage":false,"isPageViewOnly":false}'})},5000);setTimeout(function(e){jqPost('/async/nb.jsp',{asid: 'brlc', iasid: 'brlc', brai: '{"uUID":"39395dfe-026c-4221-bbe2-20bea22e3393","trackingEventTypeIds":[410],"nonBounceInterval":"TEN_SECONDS","cmsSiteId":2,"memberId":0,"referenceId":0,"experienceStateId":43,"experienceTreatment":"LO_FVB","trackingPagename":"LO - privacyPolicy.jsp","trackingIdentifier":"","remoteAddress":"207.241.229.78","date":"May 4, 2017 1:38:47 PM","today":"May 4, 2017 12:00:00 AM","sessionId":"262E3F107C432DC38FD3B7D619ADD70B","isEntryPage":false,"isSubTACategoryPage":false,"isPageViewOnly":false}'})},10000);});
    </script>
    <script type="text/javascript">
        <!--
        (function() {
    ...
    <script type="text/javascript">
        <!--
          ...
          sOmniture.pageType='';
          sOmniture.list1='';
          sOmniture.eVar31='207.241.229.78';
    ...
    <script type="text/javascript">
          sOmniture.eVar40='LO (Not India)-LO_FVB';
          sOmniture.eVar22='73';
    ...
    <script type="text/javascript">window.NREUM||(NREUM={});NREUM.info={"errorBeacon":"bam.nr-data.net","licenseKey":"a5f224d161","agent":"","beacon":"bam.nr-data.net","applicationTime":213,"applicationID":"3642000,7293104","transactionName":"ZQNRMkZYW0tXW0QPXFxJAUl4dhUVFkhCD0VTBUo2W1VcW08WWhVD","queueTime":0,"atts":""}</script>
  </body>
</html>
