...
<html>
  <head>
    ...
    <link rel="stylesheet" href="https://cdn.experts-exchange.com/css/2/f02a76728266e1b8eea0759d313d20e6b75525b3586162c68655081a7a85de32.css" media="all" />
    <link rel="stylesheet" href="https://cdn.experts-exchange.com/css/2/fff6f4f0f8e4d509414fb31433a3a30a320c91c5cced2dc4bacc71768f88d799.css" media="all" />
    <script src="https://cdn.experts-exchange.com/js/2/2eabe7520abc934f393d5691d7e9164962e81570ed15b6d8f1897853b56e0f40.js" type="text/javascript"></script>
    <script src="https://cdn.experts-exchange.com/js/2/71521a313a334696a93677ab5443004017114016c28a7643a80868fd21feb712.js" type="text/javascript"></script>
                            ...
                            <div class="body">
                              <div class="section">
                                <form action="/searchResults.jsp?topnavselect=LO_search&testing=true" method="get" onsubmit="return submitOnce('#searchFormFiltered-compForm');" id="searchFormFiltered-compForm" onsubmit="return submitOnce('#searchFormFiltered-compForm');">
                                  ...
                                  <input name="rtid" type="hidden" value="30" id="searchFormFiltered-compForm-rtid" />
                                  <input name="rtid" type="hidden" value="750" id="searchFormFiltered-compForm-rtid" />
                                  <input name="rtid" type="hidden" value="710" id="searchFormFiltered-compForm-rtid" />
                                  <input name="rtid" type="hidden" value="430" id="searchFormFiltered-compForm-rtid" />
                                  <input name="rtid" type="hidden" value="590" id="searchFormFiltered-compForm-rtid" />
                                  <input name="rtid" type="hidden" value="10" id="searchFormFiltered-compForm-rtid" />
                                  <input name="questionStatusId" type="hidden" value="40" id="searchFormFiltered-compForm-questionStatusId" />
                          ...
                          <div class="component textComponent" id="textComponent-id4">
                            <div class="body">
                              <div class="section">
                                ...
                                <a class="business" alt="Business" href="/business.jsp"><span>SMB</span></a>
                    ...
                    <div class="body">
                      <div class="section">
                        <dl>
                          ...
                          <dd><a href="/business.jsp">SMB</a> | <a href="/courses/business.jsp" class="inlineLink">Training</a></dd>
