            ...
            <li class="mm-my-way-container">
                <span>
                    ...
                    <div class="my-way-learn-more">
                        <img class="my-way-learn-more-img" alt="Crayola My Way" data-pin-no-hover="true" nopin="nopin" src="//shop.crayola.com/on/demandware.static/-/Sites-Crayola-Library/default/dwb9671d7e/images/crayolaMyWay_nav.png" style="height: auto; transition: none 0s ease 0s;">
                            ...
                            <div class="my-way-nav-25 my-way-nav-8ct" style="text-align:center;">
                                <strong>
                                    <a id="nav-crayolamyway-8ct" href="//shop.crayola.com/on/demandware.store/Sites-Crayola-Site/default/OnePageApplication-Start#/templates?ste=X2N1cnJlbnRQcm9kdWN0SWQ9NTIxMDA4MDAwMCZfY3VycmVudFRlbXBsYXRlSWQ9Jl91c2luZ1ByZU1hZGU9LTEmX3VzZURlZmF1bHRDb2xvcnM9MSZfcGVyc29uYWxpemU9MiZfcGxpVVVJRD0%3D" title="8 count Crayola My Way">
                                        <img alt="Personalized 8 Count Crayons" class="super-nav-img" data-pin-no-hover="true" height="146" nopin="nopin" src="//shop.crayola.com/on/demandware.static/-/Sites-Crayola-Library/default/dw2b1148d0/images/8ct_nav.jpg" style="margin-bottom: 10px;" width="146" /><br />
                                        8 Count My Way
                                    </a>
                                </strong>
                            </div>
                            <div class="my-way-nav-25 my-way-nav-64ct" style="text-align:center;">
                                <strong>
                                    <a id="nav-crayolamyway-64ct" href="//shop.crayola.com/on/demandware.store/Sites-Crayola-Site/default/OnePageApplication-Start#/colors?ste=X2N1cnJlbnRQcm9kdWN0SWQ9NTI5MTY0MDAwMCZfY3VycmVudFRlbXBsYXRlSWQ9Jl91c2luZ1ByZU1hZGU9LTEmX3VzZURlZmF1bHRDb2xvcnM9MCZfcGVyc29uYWxpemU9MCZfcGxpVVVJRD0%3D" title="64 count Crayola My Way">
                                        <img alt="Personalized 64 Count Crayons" class="super-nav-img" data-pin-no-hover="true" height="146" nopin="nopin" src="//shop.crayola.com/on/demandware.static/-/Sites-Crayola-Library/default/dw606a4d2a/images/64ct_nav.jpg" style="margin-bottom: 10px;" width="146" /><br />
                                        64 Count My Way
                                    </a>
                                </strong>
                            </div>
                            <div class="my-way-nav-25 my-way-art-kit" style="text-align:center;">
                                <strong>
                                    <a id="nav-crayolamyway-artcase" href="//shop.crayola.com/on/demandware.store/Sites-Crayola-Site/default/OnePageApplication-Start#/sleeves?ste=X2N1cnJlbnRQcm9kdWN0SWQ9MDQ2ODY2MDkwMCZfY3VycmVudFRlbXBsYXRlSWQ9Jl91c2luZ1ByZU1hZGU9LTEmX3VzZURlZmF1bHRDb2xvcnM9MiZfcGVyc29uYWxpemU9MiZfcGxpVVVJRD0%3D" title="Art Case Crayola My Way">
                                        <img alt="Personalized Art Case" class="super-nav-img" data-pin-no-hover="true" height="146" nopin="nopin" src="//shop.crayola.com/on/demandware.static/-/Sites-Crayola-Library/default/dwcef14bc2/images/artCase_nav.jpg" style="margin-bottom: 10px;" width="146" /><br />
                                        Art Case My Way
                                    </a>
                                </strong>
                            </div>
                            <div class="my-way-nav-25 my-way-imaginables" style="text-align:center;">
                                <strong>
                                    <a id="nav-crayolamyway-imaginables" href="http://imaginables.crayola.com/" target="_blank" title="Crayola Imaginables">
                                        <img alt="Crayola Imaginables" class="super-nav-img" data-pin-no-hover="true" height="146" nopin="nopin" src="//shop.crayola.com/on/demandware.static/-/Sites-Crayola-Library/default/dw35cfd57b/images/imaginablesNAVitem.jpg" style="margin-bottom: 10px;" title="" width="146" /><br />
                                        Crayola Imaginables
                                    </a>
                                </strong>
                            </div>
...
<!--  -->
<script>
		if(jQuery('#context_path').val() != location.host) {
			var jsURL = jQuery('#absURLVal').val();
			jQuery.ajax({
				  url: jsURL,
				  dataType: "script",
				  success: function(){},
