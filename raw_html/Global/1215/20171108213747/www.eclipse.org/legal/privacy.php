        ...
        <div class="text-right toolbar-row row hidden-print">
          <div class="col-md-12 col-md-push-12 row-toolbar-col">
            <ul class="list-inline">
              ...
              <li><a href="https://accounts.eclipse.org/user/login/?takemeback=http%3A%2F%2Fwww.eclipse.org%2Flegal%2Fprivacy.php"><i class="fa fa-sign-in fa-fw"></i> Log in</a></li>
              
            </ul>
          </div>
          <div class="text-left col-md-12 col-md-pull-12 row-toolbar-col toolbar-left-content">
            <span>Annual Donation Campaign <a href="/donate">Donate Now</a></span></div>
        </div>
      </div>
  ...
  <div class="navbar yamm" id="main-menu">
    ...
    <section class="hidden-print default-breadcrumbs" id="breadcrumb">
      <div class="container">
        ...
        <div class="row">
          <div class="col-sm-16 padding-left-30"><ol class="breadcrumb"><li><a href="http://www.eclipse.org/">Home</a></li><li><a href="http://www.eclipse.org/legal">Legal</a></li><li class="active">Eclipse.org Privacy Policy</li></ol></div>
        ...
        <ul id="leftnav" class="ul-left-nav fa-ul hidden-print">
              ...
              <a href="/org/documents/epl-2.0/EPL-2.0.pdf" target="_self">
                PDF              </a>
                      ...
                      <li>
              <i class="fa fa-angle-double-right orange fa-fw"></i>
              <a href="/org/documents/epl-2.0/faq.php" target="_self">
                FAQ              </a>
            </li>
