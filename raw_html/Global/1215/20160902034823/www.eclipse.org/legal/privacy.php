  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col-sm-14 donate-text">
        <h2>September Friend Campaign</h2>        <p>Friends of Eclipse,</p>
                                       ...
                                       to improve Eclipse technology. Your contribution counts!</p>        <p>We thank you for this gesture, and for giving back to our community. <i class="fa fa-heart"></i></p>
      ...
      <div class="col-sm-10 text-center donate-form">
        ...
        <form id="donation_default_eclipse_form" action="https://www.eclipse.org/donate/process.php?utm_source=eclipse.org&utm_medium=donate_program&utm_content=donate-banner&utm_campaign=eclipse_org_PROMO_DONATE_BANNER_1" method="POST">
          <div class="row">
            <div class="col-sm-24">
...
</div>    <div class="clearfix toolbar-container-wrapper">
      <div class="container">
