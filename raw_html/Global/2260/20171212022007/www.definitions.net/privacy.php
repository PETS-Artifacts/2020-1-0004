...
if(detectWidth() < screenSizeMobile) mapSizeMRU = [[300, 250]];
  ...
  googletag.cmd.push(function() {
    ...
    googletag.defineSlot('/52304935/'+((detectWidth() < screenSizeMobile) ? 'Definitions_Mobile_LR_300x250_A' : 'Definitions_LR_300x250_A'), mapSizeMRU, 'div-gpt-ad-Definitions_LR_300x250_A').addService(googletag.pubads());
    ...
    googletag.defineSlot('/52304935/Definition_1x1_Slider', [1, 1], 'div-gpt-ad-Definition_1x1_Slider').addService(googletag.pubads());
...
<!-- Timer: 0.0677 secs | Server: ip-10-113-129-74 -->