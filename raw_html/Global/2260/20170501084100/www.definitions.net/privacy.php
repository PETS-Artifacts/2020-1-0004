...
function initHBS() {
  ...
  if(!googletag.pubadsReady && pbjs.retries <= MAX_RETRIES) {
    setTimeout(initHBS, 50); //poll ms can be adjusted as desired.
    pbjs.retries++;
    return;
  }
  googletag.cmd.push(function () {
...
if (detectWidth() < screenSizeMobile) {
    ...
    loadScript('http://www.definitions.net/adunits/prebid-mobile.js');
} else {
      googletag.cmd.push(function () {
         googletag.pubads().setTargeting("device", "desktop");
      });
    loadScript('http://www.definitions.net/adunits/prebid-desktop.js');
}
...
<section><!-- /52304935/Definitions_LR_300x250_A -->
<div id='div-gpt-ad-Definitions_LR_300x250_A'>
<script>
...
<!-- Timer: 0.0434 secs | Server: 127.0.0.1 -->