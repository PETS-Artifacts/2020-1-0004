...
<script>
    ...
    adUnits.push({
            network: dfpNetwork,
            adunit: "Definitions_IA_300x250_A",
            size: [[300, 250]],
            code: 'div-gpt-ad-Definitions_IA_300x250_A',
            assignToVariableName: false // false if not in use
         }); 
    adUnits.push({
            network: dfpNetwork,
            adunit: "Definitions_IA_300x250_B",
            size: [[300, 250]],
            code: 'div-gpt-ad-Definitions_IA_300x250_B',
            assignToVariableName: false // false if not in use
         }); 
    adUnits.push({
            network: dfpNetwork,
            adunit: "Definitions_LR_300x250_A",
            size: mapSizeMRU,
            code: 'div-gpt-ad-Definitions_LR_300x250_A',
            assignToVariableName: false // false if not in use
         }); 
    adUnits.push({
            network: dfpNetwork,
            adunit: "Definitions_LR_300x250_B",
            size: mapSizeMRU,
            code: 'div-gpt-ad-Definitions_LR_300x250_B',
            assignToVariableName: false // false if not in use
         }); 
    adUnits.push({
            network: dfpNetwork,
            adunit: "Definitions_LR_300x250_C",
            size: mapSizeMRU,
            code: 'div-gpt-ad-Definitions_LR_300x250_C',
            assignToVariableName: false // false if not in use
         }); 
    adUnits.push({
            network: dfpNetwork,
            adunit: "Definitions_LR_300x250_D",
            size: mapSizeMRU,
            code: 'div-gpt-ad-Definitions_LR_300x250_D',
            assignToVariableName: false // false if not in use
         }); 
    adUnits.push({
            network: dfpNetwork,
            adunit: "Definitions_LR_125x125",
            size: [[125, 125]],
            code: 'div-gpt-ad-Definitions_LR_125x125',
            assignToVariableName: false // false if not in use
         }); 
...
<script type="text/javascript" async="true" src="http://definitions.net/adunits/prebid.js"></script>    
...
<meta name="google-signin-client_id" content="567628204450-d2poj278l03v4n2u772cob4p4ukhi4qn.apps.googleusercontent.com">
</head>
	...
	<div class="clearfix row hidden-xs">
			...
			<div class="row">
				<div class="col-xs-6 col-sm-6">
					<ul>
						...
						<li class="nw-lyrics"><a rel="nofollow" href="https://www.lyrics.com/">Lyrics</a></li>
				...
				<div class="col-xs-6 col-sm-6">
					<ul>
						...
						<li class="nw-quotes"><a rel="nofollow" href="https://www.quotes.net/">Quotes</a></li>
						<li class="nw-scripts"><a rel="nofollow" href="https://www.scripts.com/">Scripts</a></li>
		...
		<div class="col-xs-12 col-sm-4">
			<ul class="last">
				...
				<li class="nw-grammar"><a rel="nofollow" href="https://www.grammar.com/">Grammar</a></li>
...
<script src="js/defn.js"></script>
<!-- /52304935/Definition_1x1_Slider -->
<div id='div-gpt-ad-Definition_1x1_Slider'>
<script>
googletag.cmd.push(function() { googletag.display('div-gpt-ad-Definition_1x1_Slider'); });
</script>
</div>
</body>
</html>
<!-- Timer: 0.1311 secs | Server: ip-10-113-129-74 -->