...
if( window.canRunAds === undefined ){
	document.write("<!-- DEF_NEW_TRANS_TXT_ONLY_300_600 --><ins class=\"adsbygoogle\" style=\"display:inline-block;width:300px;height:600px\" data-ad-client=\"ca-pub-6071864913982699\" data-ad-slot=\"6735402741\"></ins>");
} else {
	document.write("<!-- DEF_NEW_TRANS_300_600 --><ins class=\"adsbygoogle\" style=\"display:inline-block;width:300px;height:600px\" data-ad-client=\"ca-pub-6071864913982699\" data-ad-slot=\"9052785143\"></ins>");
}
</script>
<script>
...
<!--//<![CDATA[
   ...
   document.write ("zoneid=291866");document.write("&amp;nodis=1");
...
<section><script type="text/javascript"><!--
    ...
    e9.size = "300x250";
//--></script>
<script type="text/javascript" src="http://tags.expo9.exponential.com/tags/Definitionsnet/ROS/tags.js"></script></section>
<section><!-- Async Tag // Tag for network 9533: Marketplace: STANDS4 LLC // Website: Definitions.net // Page: Definitions.net // Placement: Definitions 300x250 ATF (3219702) // created at: Dec 8, 2014 8:38:50 AM -->
<script type="text/javascript" src="http://aka-cdn-ns.adtechus.com/dt/common/DAC.js"></script>
<div id="3219702"></div>
<script>
ADTECH.config.page = { protocol: 'http', server: 'adserver.adtechus.com', network: '9533.1', pageid: 693114, params: { loc: '100' }};
ADTECH.config.placements[3219702] = { sizeid: 170, params: { alias: '', target: '_blank' }};
ADTECH.loadAd(3219702);
</script></section>
	</div>
				...
				<div class="row">
					<div class="col-xs-6 col-sm-6">
						<ul>
							...
							<li class="ex"><a href="http://www.abbreviations.com/mylist.php">Your Saved Items</a></li>
	...
	<div class="clearfix row hidden-xs">
		...
		<div class="col-xs-12 col-sm-4">
			<ul class="last">
				...
				<li class="nw-kamus"><a rel="nofollow" href="http://www.kamus.net/">Kamus</a></li>
...
<!-- Timer: 0.0236 secs | Server: 10.93.170.247 -->