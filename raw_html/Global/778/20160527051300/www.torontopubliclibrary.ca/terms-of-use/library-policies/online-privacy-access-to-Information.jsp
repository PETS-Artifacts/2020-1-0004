...
f5_cspm.go();}());</script><script id="f5_cspm">(function(){var f5_cspm={f5_p:'DKDNEHBNHLJPNLJNKMBENNFMIFHFKNJCILHODJIBPEIBGLNHMEFKJNGJGNHAMNNNIAMHFBJAPNOKNNOMCHLPMAFJNNNOPCEHCBHDMNNLKHENPDDCJIPCPCANCMLHDJKH',setCharAt:function(str,index,chr){if(index>str.length-1)return str;return str.substr(0,index)+chr+str.substr(index+1);},get_byte:function(str,i){var s=(i/16)|0;i=(i&15);s=s*32;return((str.charCodeAt(i+16+s)-65)<<4)|(str.charCodeAt(i+s)-65);},set_byte:function(str,i,b){var s=(i/16)|0;i=(i&15);s=s*32;str=f5_cspm.setCharAt(str,(i+16+s),String.fromCharCode((b>>4)+65));str=f5_cspm.setCharAt(str,(i+s),String.fromCharCode((b&15)+65));return str;},set_latency:function(str,latency){latency=latency&0xffff;str=f5_cspm.set_byte(str,32,(latency>>8));str=f5_cspm.set_byte(str,33,(latency&0xff));str=f5_cspm.set_byte(str,27,2);return str;},wait_perf_data:function(){try{var wp=window.performance.timing;if(wp.loadEventEnd>0){var res=wp.loadEventEnd-wp.navigationStart;if(res<60001){var cookie_val=f5_cspm.set_latency(f5_cspm.f5_p,res);window.document.cookie='aaaaaaaaaaaaaaa='+encodeURIComponent(cookie_val)+';path=/';}
return;}}
catch(err){return;}
setTimeout(f5_cspm.wait_perf_data,100);return;},go:function(){var chunk=window.document.cookie.split(/\s*;\s*/);for(var i=0;i<chunk.length;++i){var pair=chunk[i].split(/\s*=\s*/);if(pair[0]=='f5_cspm'){if(pair[1]=='1234'){var d=new Date();d.setTime(d.getTime()-1);window.document.cookie='f5_cspm=;expires='+d.toUTCString()+';path=/;';setTimeout(f5_cspm.wait_perf_data,100);}}}}}
f5_cspm.go();}());</script>
...
;NREUM.info={beacon:"bam.nr-data.net",errorBeacon:"bam.nr-data.net",licenseKey:"045c9927d3",applicationID:"7276081",sa:1,agent:"js-agent.newrelic.com/nr-593.min.js"}
</script>
...
<meta name="google-translate-customization" content="ac5a9931b4aeb2a1-842f979b42e52049-gcf9b2081eedececc-1b"></meta>
	...
	<div class="header-menu-container">
		...
		<div id="logo-item" ><a href="/"><img class="_alwaysShow" alt="Toronto Public Library Homepage" src="/images/tpl-logo.png"/></a></div>
			...
			<div id="menu-search" role="search">
				...
				<input name="Ntt" id="searchTermsMenu" type="text" onfocus="" value="" /><input id="submit-button" class="button search" value="Search" type="submit" />
				</form>
			</div>
		...
		<ul class="header-top-menu">
					...
					<li id="signin-item"><a id="sign-in-link" onclick="Common.deleteCookie('sessionExpirationWarning')" href="/signin?returnTo=">You are <b>not signed in</b></a></li>
					
					<script type="text/javascript">
						Common.processSignInURL("https://www.torontopubliclibrary.ca:443/signin?returnTo=", "sign-in-link");
					</script>

					<li id="account-item" ><a href="/youraccount">Your Account</a></li>

	  		
			

			<li id="contact-item"><a href="/contact">Contact Us</a></li>

			<li class="homepage-only" id="donate-item"><a class="no-border" href="http://www.tplfoundation.ca/" onClick="tracking('Masthead','Donate Now');">Donate Now</a></li>
...
<div class="header-search homepage-only" id="header-search" role="search">
							...
							<div id="header-bottom-container">
								<nav role="navigation">
								<ul class="header-bottom" id="header-bottom" role="menubar">
									...
									<li id="books-link" role="menuitem" aria-haspopup="true" aria-labelledby="bookLabel"><a class="top-nav" href="/books-video-music/"><span id="bookLabel">Books, Video, Research &amp; More</span></a>
	...
	<ul role="menu"> 
		...
		<a href="/books-video-music/books" onClick="tracking('Books','megamenu - Books, Video & Research');">Books</a> 
			<ul role="menu"> 
				...
				<li class="megamenu-level-1" role="menuitem"> 
				<a href="/books-video-music/new-items.jsp?category=Children Fiction" onClick="tracking('New Children\'s Fiction','megamenu - Books, Video & Research');">New Children's Fiction</a> 
				</li> 
				<li class="megamenu-level-1" role="menuitem"> 
				<a href="/books-video-music/new-items.jsp?category=Teen Fiction" onClick="tracking('New Teen Fiction','megamenu - Books, Video & Research');">New Teen Fiction</a> 
				</li> 
				<li class="megamenu-level-1" role="menuitem"> 
				...
				<li class="megamenu-level-1" role="menuitem"> 
				<a href="/books-video-music/books/booklists" onClick="tracking('We Recommend','megamenu - Books, Video & Research');">We Recommend</a> 
				</li> 
				<li class="megamenu-level-1" role="menuitem"> 
				<a href="/books-video-music/books/book-clubs" onClick="tracking('Book Clubs','megamenu - Books, Video & Research');">Book Clubs</a> 
				</li> 
			</ul> 
		</li> 
	</ul> 
...
<div class="megamenu-column"> 
	<ul role="menu"> 
		...
		<li class="megamenu-level-0" role="menuitem"> 
		<a href="/books-video-music/downloads-ebooks" onClick="tracking('Downloads & eBooks','megamenu - Books, Video & Research');">Downloads &amp; eBooks</a> 
		</li> 
	</ul> 
</div> 
<div class="megamenu-column last"> 
	<ul class="clear-left" role="menu"> 
		...
		<li class="megamenu-level-0" role="menuitem"> 
		<a href="/books-video-music/recommended-websites/" onClick="tracking('Recommended Websites','megamenu - Books, Video & Research');">Recommended Websites</a> 
		</li>  -->
		<li class="megamenu-level-0" role="menuitem"> 
	...
	<a href="#" class="megamenu-close-link"><img alt="Close Menu" src="/images/megamenu-close-button.gif" /></a> 
</div> 
</div> 


									</li>
									<li id="programs-link" role="menuitem" aria-haspopup="true" aria-labelledby="programLabel"><a class="top-nav" href="/programs-and-classes/"><span id="programLabel">Programs, Classes &amp; Exhibits</span></a> 
...
<div class="megamenu-column first"> 
	<ul role="menu"> 
		...
		<li class="megamenu-level-0"  role="menuitem"> 
		<a href="/programs-and-classes/teens/" onClick="tracking('Teens','megamenu - Programs');">Teens</a> 
		</li> 
		<li class="megamenu-level-0"  role="menuitem"> 
...
<div class="megamenu-column last"> 
	...
	<a href="#" class="megamenu-close-link"><img alt="Close Menu" src="/images/megamenu-close-button.gif" /></a> 
									...
									<li id="branches-link" role="menuitem" aria-haspopup="true" aria-labelledby="branchLabel"><a class="top-nav" href="/hours-locations/index.jsp"><span id="branchLabel">Hours &amp; Locations</span></a> 
...
<div class="megamenu-column last"> 
	...
	<a href="#" class="megamenu-close-link"><img alt="Close Menu" src="/images/megamenu-close-button.gif" /></a> 
									...
									<li id="using-link" role="menuitem" aria-haspopup="true" aria-labelledby="usingLabel"><a class="top-nav" href="/using-the-library/"><span id="usingLabel">Using the Library</span></a> 
	...
	<ul role="menu"> 
		...
		<a href="/services/" onClick="tracking('Services','megamenu - Using the Library');">Services</a> 
			<ul role="menu"> 
				...
				<li class="megamenu-level-1"  role="menuitem"> 
				<a href="/using-the-library/room-theatre-rentals/meeting-rooms.jsp" onClick="tracking('Meeting Room Rentals','megamenu - Using the Library');">Meeting Room Rentals</a> 
				</li>
				<li class="megamenu-level-1"  role="menuitem"> 
...
jQuery(document).ready(function() {
	setMegaMenu('#books-link',-0);	setMegaMenu('#programs-link', -0);	setMegaMenu('#branches-link',-0);	setMegaMenu('#using-link',-494);
	 });
</script>
<script type="text/javascript">
function tracking(category, action){
	...
	<div class="main" id="terms-of-use">
		...
		<h1>Online Privacy & Access to Information</h1>
...
<div class="widget" id="section-navigation">
	<nav role="navigation">	
		<!-- <h3>Navigation</h3> -->
		<div class=' section-nav-current'><a href='/terms-of-use'>Library Policies &amp; Terms of Use</a></div><div class=' section-nav-page'><a href='/terms-of-use/library-policies/accessibility-people-disabilities.jsp'>Accessibility for Persons with Disabilities</a></div><div class=' section-nav-page'><a href='/terms-of-use/library-policies/access-to-information-protection-privacy-policy.jsp'>Access to Information and Protection of Privacy Policy</a></div><div class=' section-nav-page'><a href='/terms-of-use/library-policies/advertising-policy.jsp'>Advertising Policy</a></div><div class=' section-nav-page'><a href='/terms-of-use/library-policies/tpl-board-member-code-of-conduct.jsp'>Board Member Code of Conduct</a></div><div class=' section-nav-page'><a href='http://kidsspace.torontopubliclibrary.ca/privacy.html'>Children's Internet Use Policy</a></div><div class=' section-nav-page'><a href='/terms-of-use/library-policies/circulation-and-collection-use.jsp'>Circulation and Collection Use</a></div><div class=' section-nav-page'><a href='/terms-of-use/library-policies/community-and-event-space.jsp'>Community and Event Space Rental</a></div><div class=' section-nav-page'><a href='/terms-of-use/library-policies/displaying-and-distributing-information.jsp'>Display and Distribution of Information to the Public</a></div><div class=' section-nav-page'><a href='/terms-of-use/library-policies/internet-use-policy.jsp'>Internet Use Policy</a></div><div class=' section-nav-page'><a href='/terms-of-use/library-policies/lobbying-disclosure-for-board-members.jsp'>Lobbying Disclosure for Board Members</a></div><div class=' section-nav-page'><a href='/terms-of-use/library-policies/materials-selection-policy.jsp'>Materials Selection Policy</a></div><div class=' section-nav-page'><a href='/terms-of-use/library-policies/online-and-social-media-policy.jsp'>Online and Social Media Policy</a></div><div class=' section-nav-page'><a href='/terms-of-use/library-policies/online-and-social-media-policy-statement.jsp'>Online and Social Media Policy Statement</a></div><div class=' section-nav-page'><a href='/terms-of-use/library-policies/online-and-social-media-terms-of-use.jsp'>Online and Social Media Terms of Use</a></div><div class=' section-nav-page'><div class='section-nav-active'><a href='/terms-of-use/library-policies/online-privacy-access-to-Information.jsp'>Online Privacy &amp; Access to Information</a></div></div><div class=' section-nav-page'><a href='/terms-of-use/library-policies/open-data.jsp'>Open Data</a></div><div class=' section-nav-page'><a href='/terms-of-use/library-policies/privacy-and-retail-affiliate-information.jsp'>Retail Affiliate Program and Privacy</a></div><div class=' section-nav-page'><a href='/terms-of-use/library-policies/rules-of-conduct.jsp'>Rules of Conduct</a></div><div class=' section-nav-page'><a href='/terms-of-use/library-policies/security-video-surveillances-policy.jsp'>Security Video Surveillance Policy</a></div><div class=' section-nav-page'><a href='/terms-of-use/library-policies/toronto-public-library-procedural-by-law.jsp'>Toronto Public Library Procedural By-law</a></div><div class=' section-nav-page'><a href='/terms-of-use/library-policies/use-of-library-space-for-art-exhibits-policy.jsp'>Use of Library Space for Art Exhibits Policy</a></div>
	</nav>
</div>
		</div>

		<a name="Content"></a><div class="grid_8">
...
<h3><a name="policy" id="policy"></a>Our Policy</h3>
...
<p class="indent"><strong>Privacy &amp; Records Management Officer</strong><br />
Toronto Public Library <br />
789 Yonge Street <br />
Toronto, ON <br />
M4W 2G8 <br />
<br />
Phone: 416-395-5658 <br />
Fax: 416-393-7083<br />
E-mail: gnettlefold@torontopubliclibrary.ca</p>
...
Phone: 416-395-5658 <br />
Fax: 416-393-7083<br />
E-mail: gnettlefold@torontopubliclibrary.ca<br />
...
<div id="footer-stripe" class="clearfix">
	<div class="container_16">

		<div class="clear"></div>
        <div class="grid_4 footer-columns">
		...
		<div class="grid_4 footer-columns">
			...
			<ul>
	            ...
	            <li><a href="/accessibility/accessibility-services/">Services for People <br />with Disabilities</a></li>
				<li><a href="/accessibility/collections/">Collections for People<br /> with Disabilities</a></li>
			...
			<h3><a href="/terms-of-use">Library Policies <br />&amp; Terms of Use</a></h3>
			<ul>
				<li><a href="/terms-of-use/">Library Policies</a></li>
				<li><a href="/terms-of-use/library-policies/online-privacy-access-to-Information.jsp">Online Privacy &amp; <br />Access to Information</a></li>
			</ul>

		</div>

		<div class="grid_4 footer-columns">
			<h3><a href="/media/">Media Relations <br />&amp; News Releases</a></h3>
			<ul>
			<li><a href="/media/media-contacts/">Media Contacts</a></li>
			<li><a href="/media/key-facts/">Key Facts</a></li>
			</ul>

            <h3><a href="/support-us">Support Your Library</a></h3>
			<ul>
            <li><a href="http://www.tplfoundation.ca/">TPL Foundation</a></li>
            ...
            <h3><a href="http://www.tplfoundation.ca/">Donate Now</a></h3>

		</div>

		<div class="grid_4 last footer-columns omega">
			<h3><a href="/connect/">Connect with Us</a></h3>
			<ul class="sprite">
				<li><a id="social-news" href="/email-newsletter"><span>Sign Up for Our eNewsletter</span></a></li>
				<li><a id="social-blogs" href="/blogs-publications/"><span>Blogs by Librarians</span></a></li>
				<li><a id="social-facebook" href="http://www.facebook.com/torontopubliclibrary"><span>Facebook</span></a></li>
				<li><a id="social-twitter" href="http://www.twitter.com/torontolibrary"><span>Twitter</span></a></li>
				<li><a id="social-youtube" href="http://www.youtube.com/torontopubliclibrary"><span>YouTube</span></a></li>
				<li><a id="social-flickr" href="http://www.flickr.com/photos/43021516@N06/"><span>Flickr</span></a></li>
				<li><a id="social-pinterest" href="http://www.pinterest.com/torontolibrary"><span>Pinterest</span></a></li>
			</ul>
		</div>
...
<div id="footer-bottom-container" class="clearfix">
	<div class="container_16">
        ...
        <div class="grid_16 alpha">
        	...
        	<div class="grid_3">Toronto Public Library &#169; 2016</div>
			<div class="grid_4"><a href="/using-the-library/help/">Help</a> &nbsp;&nbsp; | &nbsp;&nbsp; <a href="/contact/">Contact Us</a></div>
			<div class="grid_4 push_5"><img class="valign-middle" alt="" src="/images/gtranslate_icon.gif" />&nbsp; <a href="http://translate.google.com/translate?u=http%3a%2f%2fwww.torontopubliclibrary.ca%2fterms-of-use%2flibrary-policies%2fonline-privacy-access-to-Information.jsp%3f&sl=en&tl=fr&js=n&prev=_t&hl=en&ie=UTF-8&layout=2&eotf=1">Google Translate</a></div>
