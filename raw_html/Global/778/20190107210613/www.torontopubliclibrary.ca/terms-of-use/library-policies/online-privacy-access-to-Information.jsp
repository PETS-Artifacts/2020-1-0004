...
<script type="text/javascript">(function(){ if (typeof(___zen) === "undefined") {setTimeout(arguments.callee, 50); return; }___zen.hic("__ZEHIC9606", 1546895173, 1, 0, 60); })()</script><script type="text/javascript" async="async" src="/__zenedge/assets/hic.js?v=1541158593"></script></head>
		...
		<ul class="clear-left" role="menu">
			<li class="megamenu-level-0" role="menuitem">
				<ul role="menu"> 
					...
					<li class="megamenu-level-1" role="menuitem"> 
						<a href="/kidsspace/" onClick="tracking('KidsSpace','megamenu - For Kids');">KidsSpace</a> 
					</li> 
				</ul>
			</li>
		</ul>
	        		...
	        		<li class="navigationMobileContentItem">
		        		...
		        		<div class="navigationMobileDropdown">
							...
							<div class="navigationMobileDropdownAdditional">
							    ...
							    <a href="http://www.torontopubliclibrary.ca/kidsspace/">KidsSpace (12 and under)</a>
...
<script type="text/javascript">
	...
	if (scrollBarWidth > 0) {
		jQuery(".navigationMobileHeaderElement.searchMobile").css("margin-right", scrollBarWidth + "px");;
	}
	jQuery(".navigationMobileHeaderElement.account").click(function(evt) {
		jQuery(".accountMenuMobile.signedIn").slideToggle("fast");
		if (jQuery(evt.target).closest(".navigationMobileHeaderElement.account").hasClass("active")) {
			jQuery(evt.target).closest(".navigationMobileHeaderElement.account").removeClass("active");
		}
		else {
			jQuery(evt.target).closest(".navigationMobileHeaderElement.account").addClass("active");
		}
		jQuery(".navigationMobileDropdown").css("display", "none");
		jQuery(".menuHamburger").removeClass("active");
		jQuery(".searchBarMobile").css("display", "none");
		jQuery(".navigationMobileHeaderElement.searchMobile").removeClass("active");
	});
	jQuery(".navigationMobileHeaderElement.accountSignedOut").click(function(evt) {
		jQuery(".accountMenuMobile.signedOut").slideToggle("fast");
		if (jQuery(evt.target).closest(".navigationMobileHeaderElement.accountSignedOut").hasClass("active")) {
			jQuery(evt.target).closest(".navigationMobileHeaderElement.accountSignedOut").removeClass("active");
		}
		else {
			jQuery(evt.target).closest(".navigationMobileHeaderElement.accountSignedOut").addClass("active");
		}
		jQuery(".navigationMobileDropdown").css("display", "none");
		jQuery(".menuHamburger").removeClass("active");
		jQuery(".searchBarMobile").css("display", "none");
	...
	jQuery(".toggleNavigationMobileDropdownAdditional").click(function(evt) {
		jQuery(".navigationMobileDropdownAdditional").slideToggle("fast");
		if (jQuery(evt.target).closest(".toggleNavigationMobileDropdownAdditional").hasClass("active")) {
			jQuery(evt.target).closest(".toggleNavigationMobileDropdownAdditional").removeClass("active");
		}
		else {
			jQuery(evt.target).closest(".toggleNavigationMobileDropdownAdditional").addClass("active");
		}
	});
	jQuery(".navigationMobileHeaderElement.searchMobile").click(function(evt) {
		jQuery(".navigationMobileDropdown").css("display", "none");
		jQuery(".menuHamburger").removeClass("active");
		jQuery(".searchBarMobile").slideToggle("fast");
		if (jQuery(evt.target).closest(".navigationMobileHeaderElement.searchMobile").hasClass("active")) {
			jQuery(evt.target).closest(".navigationMobileHeaderElement.searchMobile").removeClass("active");
		}
		else {
			jQuery("#nav-search-terms").focus();
			jQuery(evt.target).closest(".navigationMobileHeaderElement.searchMobile").addClass("active");
		}
		jQuery(".accountMenuMobile").css("display", "none");
		jQuery(".navigationMobileHeaderElement.account").removeClass("active");
		jQuery(".navigationMobileHeaderElement.accountSignedOut").removeClass("active");
	});
	jQuery(".menuHamburger").click(function(evt) {
		jQuery(".navigationMobileDropdown").slideToggle("fast");
		if (jQuery(evt.target).closest(".menuHamburger").hasClass("active")) {
			jQuery(evt.target).closest(".menuHamburger").removeClass("active");
		}
		else {
			jQuery(evt.target).closest(".menuHamburger").addClass("active");
		}
		jQuery(".accountMenuMobile").css("display", "none");
		jQuery(".navigationMobileHeaderElement.account").removeClass("active");
		jQuery(".navigationMobileHeaderElement.accountSignedOut").removeClass("active");
	...
	jQuery(".navigation-dropdown").mouseover(function(evt) {
		var ariaExpanded = jQuery(evt.target).closest(".navigation-dropdown").attr("aria-expanded");
		if (ariaExpanded) {
			jQuery(evt.target).closest(".navigation-dropdown").attr("aria-expanded", true);
		}
	});
	jQuery(".navigation-dropdown").mouseout(function(evt) {
		var ariaExpanded = jQuery(evt.target).closest(".navigation-dropdown").attr("aria-expanded");
		if (ariaExpanded) {
			jQuery(evt.target).closest(".navigation-dropdown").attr("aria-expanded", false);
		}
	});
</script>

<script type="text/javascript">
	jQuery(".top-nav").focus(function(evt) {
		jQuery(".navigation-dropdown").removeClass("active");
		jQuery(this).closest(".navigation-dropdown").addClass("active");
	});

	jQuery("html").click(function(evt) {
	    if (jQuery(evt.target).closest("navigation-dropdown").length === 0) {
	    	jQuery(".navigation-dropdown").removeClass("active");
	    	jQuery("#account-menu").removeClass("active");
	    }
	});

	jQuery(".accountMenuHeader").focus(function(evt) {
		jQuery(this).closest("#account-menu").addClass("active");
	});

	jQuery(".linkCell").focus(function(evt) {
		jQuery("#account-menu").removeClass("active");
	});
	...
	if (environment === "prod") {
		...
		//this is temporary until dev sign-in starts working again
		// script.src = "https://betaaccount.torontopubliclibrary.ca/static/embeddable.js?v=1.2";
...
<footer role="contentinfo" class="global-footer">
	...
	<div class="row-wrap copyright">
		<div class="col-container full-width">
			<span class="col-footer">Toronto Public Library &#169; 2018</span>
		</div>
	</div>
