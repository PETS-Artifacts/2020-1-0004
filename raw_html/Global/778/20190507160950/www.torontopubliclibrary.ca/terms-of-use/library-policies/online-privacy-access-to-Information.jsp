...
<script type="text/javascript">(function(){ if (typeof(___zen) === "undefined") {setTimeout(arguments.callee, 50); return; }___zen.hic("__ZEHIC549", 1557245383, 1, 0, 60); })()</script><script type="text/javascript" async="async" src="/__zenedge/assets/hic.js?v=1552463629"></script></head>
		...
		<ul role="menu"> 
			<li class="megamenu-level-0" role="menuitem"> 
				...
				<ul role="menu"> 
					...
					<li class="megamenu-level-1" role="menuitem"> 
						<a href="/programs-and-classes/featured/eh-list.jsp" onClick="tracking('The eh List Author Series','megamenu - Programs');">The eh List Writer Series</a> 
					</li>
					<li class="megamenu-level-1" role="menuitem"> 
...
<footer role="contentinfo" class="global-footer">
	...
	<div class="row-wrap copyright">
		<div class="col-container full-width">
			<span class="col-footer">Toronto Public Library &#169; Tue May 07 12:09:51 EDT 2019</span>
		</div>
	</div>
...
<script type="text/javascript">window.NREUM||(NREUM={});NREUM.info={"applicationID":"92749200,194860963,194849064","applicationTime":556,"beacon":"bam.nr-data.net","queueTime":0,"licenseKey":"045c9927d3","transactionName":"Y1BVMUAAXkJUARAPXFoafTZiTkRURw8XOQMEB1MKVD4AAQcGERVWG1leB0AAQkhqUlRUV0RaWwxRCFVCGg0KClpaUGhVAlNUQUcLEgdQTWoHVQAFUVJWBxcVbAQFBQFGDm8BBVAAL11SWkUIUxVZXltMDhVD","agent":"","errorBeacon":"bam.nr-data.net"}</script><script type="text/javascript" async="async" src="/__zenedge/assets/f.js?v=1552463629"></script><script>(function () { var v = 1557245383 * 3.1415926535898; v = Math.floor(v); document.cookie = "__zjc2714="+v+"; expires=Tue, 07 May 2019 16:10:51 UTC; path=/"; })()</script></body>

</html>
<script id="f5_cspm">(function(){var f5_cspm={f5_p:'BCIEAMFDIEFEJEPPAANNIENHAONJMAEMAFKCPFNHNDOFIALDHKIELKOKLHNAFGPIGEIBAOGPCABIJDHJENDACCGPADLLDPILKHDHLONBMGFEGBMANKCBLAEIFIILOICJ',setCharAt:function(str,index,chr){if(index>str.length-1)return str;return str.substr(0,index)+chr+str.substr(index+1);},get_byte:function(str,i){var s=(i/16)|0;i=(i&15);s=s*32;return((str.charCodeAt(i+16+s)-65)<<4)|(str.charCodeAt(i+s)-65);},set_byte:function(str,i,b){var s=(i/16)|0;i=(i&15);s=s*32;str=f5_cspm.setCharAt(str,(i+16+s),String.fromCharCode((b>>4)+65));str=f5_cspm.setCharAt(str,(i+s),String.fromCharCode((b&15)+65));return str;},set_latency:function(str,latency){latency=latency&0xffff;str=f5_cspm.set_byte(str,40,(latency>>8));str=f5_cspm.set_byte(str,41,(latency&0xff));str=f5_cspm.set_byte(str,35,2);return str;},wait_perf_data:function(){try{var wp=window.performance.timing;if(wp.loadEventEnd>0){var res=wp.loadEventEnd-wp.navigationStart;if(res<60001){var cookie_val=f5_cspm.set_latency(f5_cspm.f5_p,res);window.document.cookie='f5avr1849470259aaaaaaaaaaaaaaaa='+encodeURIComponent(cookie_val)+';path=/';}
return;}}
catch(err){return;}
