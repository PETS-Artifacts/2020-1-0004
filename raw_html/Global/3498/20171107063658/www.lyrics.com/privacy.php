...
if (detectWidth() < screenSizeMobile) {
    ...
    loadScript('http://www.lyrics.com/adunits/prebid-mobile.js');
} else {
      googletag.cmd.push(function () {
         googletag.pubads().setTargeting("device", "desktop");
      });
    loadScript('http://www.lyrics.com/adunits/prebid-desktop.js');
}
...
<base href="http://www.lyrics.com/">
<link rel="stylesheet" href="http://fonts.googleapis.com/css?family=Droid+Sans:400,700|Droid+Serif:400,700,400italic,700italic|Droid+Sans+Mono|Yanone+Kaffeesatz:200,300,400,700|Goudy+Bookletter+1911|Lobster+Two:400,700,400italic,700italic|Original+Surfer|">
...
<link rel="search" type="application/opensearchdescription+xml" title="Lyrics.com" href="http://www.lyrics.com/open-search.xml">
...
<header id="header">
	<div id="header-int" class="clearfix">		
					<div id="user-login"><a href="login.php">Log in</a></div>
...
</form>		<div id="page-top-logo" onclick="location.href='http://www.lyrics.com/';"><img src="root/app_common/img/top_logo_lyr.png" alt="Lyrics.com" title="Lyrics.com"></div>
	</div>
			...
			<div class="col-xs-12 col-sm-3">
				<div class="row">
					<div class="col-xs-6 col-sm-5">
						<ul>
							<h5>Company</h5>
							<li><a href="http://www.lyrics.com/">Home</a></li>
					...
					<div class="col-xs-6 col-sm-7">
						<ul>
							...
							<li><a href="http://www.lyrics.com/toplyrics.php">Most Popular</a></li>
						</ul>
					</div>
				</div>
			</div>
				...
				<div class="row">
					<div class="col-xs-6 col-sm-6">
						<ul>
							...
							<li class="ex"><a href="http://www.lyrics.com/playlist.php">Your Playlist</a></li>
...
<script src="js/lyrc.js"></script></body>
</html>
<!-- Timer: 0.0239 secs | Server: 127.0.0.1 -->