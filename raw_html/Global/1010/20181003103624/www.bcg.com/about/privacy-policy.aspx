...
})(window['adrum-config'] || (window['adrum-config'] = {}));;/* Version 64575a4f0ccc435ef3de4778c280c647 v:4.5.1.1066, c:86477bc773f030c949c64d1135d9dc79b7f217f9, b:4.5.1.1066 */(function(){new function(){if(!window.ADRUM&&!0!==window["adrum-disable"]){var g=window.ADRUM={},x=window.console,B=x&&"function"==typeof x.log?x:{log:function(){}};window["adrum-start-time"]=window["adrum-start-time"]||(new Date).getTime();var v=this&&this.Zg||function(){var a=Object.Sj||{__proto__:[]}instanceof Array&&function(a,k){a.__proto__=k}||function(a,k){for(var e in k)k.hasOwnProperty(e)&&(a[e]=k[e])};return function(b,k){function e(){this.constructor=b}a(b,k);b.prototype=null===k?Object.create(k):
				...
				-->
					...
					<meta name="Edge-Cache-Tag" content="tcm:9-387-4 070 About" />
								...
								<script type="text/javascript" src="/static/js/modernizr.js"></script>
																...
																<link rel="stylesheet" type="text/css" href="/static/css/global.min.css?v=20180830104740"/>
...
<div class="user-info"><div class="login-container" data-placement="footer" data-bcg-module="login-widget"><span class="icon-profile-user-profile-icon icon"></span><p class="login-text">Log in</p></div></div>        <div class="flags sitefooter-flags">
    ...
    <ul class="base sitefooter-list sitefooter-list_base">
            <li class="sitefooter-list-item">&copy; 2018 The Boston Consulting Group</li>
                    <li class="sitefooter-list-item"><a href="/globalconfig/sitemap" data-digitaldata-location="Sitewide Footer" data-digitaldata-linkname="sitemap">SiteMap</a></li>
...
<section class="cookie-notification" data-bcg-module="cookie-notification">
  ...
  <script type="text/javascript" src="/static/js/global.min.js?v=20180822114936"></script>
