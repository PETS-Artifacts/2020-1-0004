...
//]]>
  ...
  <link rel="stylesheet" type="text/css" href="/static/css/global.min.css?v=20180730121956"/>
        ...
        <li class="primary-navigation__navLinks__navItem">
            ...
            <ul class="primary-navigation__navSubLinks">
              <li class="primary-navigation__navSubLinks__navTitle h2">
                ...
                <li class="primary-navigation__navSubLinks__navItem">
									<span class="primary-navigation__navLink">Career Paths</span>
                                      <ul class="linkList">
                        <li class="linkList__item">
                ...
                <li class="primary-navigation__navSubLinks__navItem">
									<span class="primary-navigation__navLink">Working At BCG</span>
                                      <ul class="linkList">
                        <li class="linkList__item">
...
<section class="cookie-notification" data-bcg-module="cookie-notification">
  ...
  <script type="text/javascript" src="/static/js/global.min.js?v=20180730122006"></script>
