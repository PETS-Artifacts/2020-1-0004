            ...
            <div class="pt4 pb3 submenu topNavTrending tl">
                <div class="mw8 center">
                    <ol class="list list-number">
                        <li><a href="/legalnews/popular-reads-on-jd-supra-95070/" class="lnk" onclick="ga('send', 'event', 'topnav', 'topnav-trending', 'topnav-trending');">[New!] Popular Reads on JD Supra</a></li>
<li><a href="/legalnews/electronic-health-records-and-hipaa-58650/" class="lnk" onclick="ga('send', 'event', 'topnav', 'topnav-trending', 'topnav-trending');">Electronic Health Records & HIPAA Security: A Design Problem Fixable With Blockchain Tech?</a></li>
<li><a href="/legalnews/data-security-law-managing-the-legal-95597/" class="lnk" onclick="ga('send', 'event', 'topnav', 'topnav-trending', 'topnav-trending');">Managing The Legal Risks Of Cloud And Collaboration Tools</a></li>
<li><a href="/legalnews/how-to-write-client-alerts-that-stand-59128/" class="lnk" onclick="ga('send', 'event', 'topnav', 'topnav-trending', 'topnav-trending');">How to Write Client Alerts That Stand Out</a></li>
<li><a href="/legalnews/high-security-how-to-minimize-marijuana-96536/" class="lnk" onclick="ga('send', 'event', 'topnav', 'topnav-trending', 'topnav-trending');">High Security: How to Minimize Marijuana Data Risks</a></li>
<li><a href="/legalnews/implementing-china-s-cybersecurity-law-90505/" class="lnk" onclick="ga('send', 'event', 'topnav', 'topnav-trending', 'topnav-trending');">Implementing China's Cybersecurity Law</a></li>
