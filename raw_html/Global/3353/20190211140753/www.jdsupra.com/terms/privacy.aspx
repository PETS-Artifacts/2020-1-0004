            ...
            <div class="pt4 pb3 submenu topNavTrending tl">
                <div class="mw8 center">
                    <ol class="list list-number">
                        <li><a href="/legalnews/the-year-in-tax-reform-popular-reads-in-83627/" class="lnk" onclick="ga('send', 'event', 'topnav', 'topnav-trending', 'topnav-trending');">The Year in Tax Reform - Popular Reads on JD Supra</a></li>
<li><a href="/legalnews/how-does-the-government-shutdown-affect-21559/" class="lnk" onclick="ga('send', 'event', 'topnav', 'topnav-trending', 'topnav-trending');">How Does the Government Shutdown Affect Immigration?</a></li>
<li><a href="/legalnews/taking-advantage-of-opportunity-zones-a-79671/" class="lnk" onclick="ga('send', 'event', 'topnav', 'topnav-trending', 'topnav-trending');">[Video] Taking Advantage of Opportunity Zones: A Panel Discussion</a></li>
<li><a href="/legalnews/deal-breaker-cyber-security-risk-in-20495/" class="lnk" onclick="ga('send', 'event', 'topnav', 'topnav-trending', 'topnav-trending');">Cyber Security Risk in Health Care Transactions</a></li>
<li><a href="/legalnews/first-punch-floyd-mayweather-and-dj-22676/" class="lnk" onclick="ga('send', 'event', 'topnav', 'topnav-trending', 'topnav-trending');">Floyd Mayweather and DJ Khaled Settle with SEC Over Unlawful Touting of ICOs</a></li>
<li><a href="/legalnews/blockchain-patents-and-patient-data-17523/" class="lnk" onclick="ga('send', 'event', 'topnav', 'topnav-trending', 'topnav-trending');">Blockchain Patents and Patient Data Pilots, Capital Markets, Mining Malware, More...</a></li>
                    ...
                    <div class="fl w-100 w-third-ns pa2">
                       <div class="fl"><i class="fas fa-user fa-lg fa-fw ba br-100 mb2 mr2 mt1 pa3 red tc" aria-hidden="true"></i></div> 
                        <ul class="list fl mt1 pl2">
                            ...
                            <li><a href="/search/searchResults.aspx?sTerm=worker%27s+compensation&tab=Authors" onclick="ga('send', 'event', 'topnav', 'topnav-findauthor-col2', 'topnav-findauthor-col2');">Worker&rsquo;s Compensation</a></li>
...
-->
<script type="text/javascript" src="/inc/dist/runtime~main.0d6272a31bbd3d9d1e19.js"></script><script type="text/javascript" src="/inc/dist/vendor.3beb4a02693aed5d2bc3.js"></script><script type="text/javascript" src="/inc/dist/main.03757a0512fb6c68f3ac.js"></script>  
