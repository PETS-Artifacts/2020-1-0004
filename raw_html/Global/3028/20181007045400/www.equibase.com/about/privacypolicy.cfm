...
<head>
	...
	<link rel="stylesheet" media="all" type="text/css" href="/bundles/styles.css?v=2018083001">
	<link rel="stylesheet" media="print" type="text/css" href="/css/printContentLayout.css?v=2018083001" />
	...
	<script src="/js/main.js?v=2018083001"></script>
	<script src="/js/jquery.selectbox-0.5.js"></script>
	<script src="/js/home/search.js?v=2018083001"></script>
	<script src="/js/home/racing-news.js?v=2018083001"></script>
	<script src="/js/recentPurchases.js?v=2018083001"></script>
...
<script type="text/javascript" src="/js/promoCodeInclude.js?v=2018083001"></script>

<script src="/bundles/scripts-header.js?v=2018083001"></script>
...
var headerMapping = googletag.sizeMapping().
    addSize([1190, 0], [[1170, 90], [970,250], [970, 90], [970,66], [728, 90], [1,1]]). //desktop
    addSize([990, 0], [[970, 90], [970,66], [728, 90], [1,1]]). //iPad landscape
    addSize([748,0], [[728, 90], [468,60], [1,1]]). //iPad portrait
    addSize([488, 0], [[300,250], [468, 60], [320, 50], [300,100], [320,100], [300, 50], [1,1]]). //mobile landscape
    addSize([0, 0], [[300,250], [320, 50], [320,100], [1,1]]). //mobile portrait
             build();
var sidebarMapping = googletag.sizeMapping().
	addSize([980, 0], [[300, 250], [300, 600], [300,1050], 'fluid', [1,1]]). //iPad landscape
	addSize([0, 0], []). //catch all - sidebar drops off at 975 width
             build();
    
	gptAdSlots[0] = googletag.defineSlot('/2542414/EQ_Desktop_ROS_728x90_ATF_Header', [[1170, 90], [970,250], [970, 90], [970,66], [728, 90], [468, 60], [320, 50], [320,100], [300,100], [300, 50]], 'headerAdDiv').defineSizeMapping(headerMapping).addService(googletag.pubads());
	gptAdSlots[1] = googletag.defineSlot('/2542414/EQ_Desktop_ROS_300x250_ATF_Sidebar1', [[300, 250], [300, 600], [300,1050], 'fluid'], 'adDiv1').defineSizeMapping(sidebarMapping).addService(googletag.pubads()).setTargeting("sticky", "yes");
					googletag.defineOutOfPageSlot('/2542414/EQ_OutOfPage', 'outOfPageAdDiv').addService(googletag.pubads());
});
	</script>
...
<script type='text/javascript'>
    ...
    var adConfig = {
		...
		{
            slotID: 'adhesionAdDiv',
            slotName: '/2542414/EQ_Mobile_Adhesion',
            sizes: [
                [320, 50]
            ]
        }]
...
<script type="text/javascript" src="https://n-cdn.areyouahuman.com/play/ZJFYkJE5SICN8qC78YCEaQsMw8PeMdzQFeIwtPBN?AYAH_P1=6f7c3a28-2708-4e01-9d29-3b364eae7146&AYAH_P2=&AYAH_P3=&AYAH_F1=2962&AYAH_F2=12423"></script>

<noscript><img src="https://n-cdn.areyouahuman.com/noscript/ZJFYkJE5SICN8qC78YCEaQsMw8PeMdzQFeIwtPBN?AYAH_P1=6f7c3a28-2708-4e01-9d29-3b364eae7146&AYAH_P2=&AYAH_P3=&AYAH_F1=2962&AYAH_F2=12423"></noscript></head>
				...
				<div class="">
					...
					<div class="col-xs-4 hidden-print">
						...
						<ol>
								...
								<li>
									<a href="/premium/eqpAXCISTrackSelections.cfm?tid=BEL">Belmont Park</a>
								</li>
							
								<li>
									<a href="/premium/eqpAXCISTrackSelections.cfm?tid=GPW">Gulfstream Park West</a>
								</li>
								...
								<li>
									<a href="/premium/eqpAXCISTrackSelections.cfm?tid=MNR">Mountaineer Casino Racetrack & Resort</a>
								</li>
								...
								<li>
									<a href="/premium/eqpAXCISTrackSelections.cfm?tid=WO">Woodbine</a>
								</li>
			...
			<div class="sf-mega">
				<div class="">
					...
					<div class="col-xs-4">
						...
						<ol>
							<li><a href="/Data.cfm/Product/STATS/FreeRace?productCode=SRL" onClick="ga('send', 'event', 'STATS Race Lens Free Race', 'click' 'STATS Race Lens Free Race');" target="_blank">Free Race</a></li>
			...
			<div class="sf-mega">
				<div class="">
					...
					<div class="col-xs-4">
						...
						<ol>
							<li><a href="https://www.ownerview.com/event/conference"><img src="http://www.equibase.com/content/images/ownerview.jpg" class="img-responsive"></a></li>
						</ol>
					</div>
...
<ul class="menu-bar">
	...
	<ul class="menu-bar">
		...
		<li><a href="/premium/eqpAXCISTrackSelections.cfm?tid=BEL">Belmont Park</a></li>
		
		<li><a href="/premium/eqpAXCISTrackSelections.cfm?tid=GPW">Gulfstream Park West</a></li>
		...
		<li><a href="/premium/eqpAXCISTrackSelections.cfm?tid=MNR">Mountaineer Casino Racetrack & Resort</a></li>
		...
		<li><a href="/premium/eqpAXCISTrackSelections.cfm?tid=WO">Woodbine</a></li>
...
<p><b>Please Note:</b> This privacy policy was last updated on February 3, 2014 and is subject to future change without notice.</p>
...
<p>Our site uses cookies to keep track of your shopping cart. We use cookies to deliver content specific to your interests, to save your password so you don't have to re-enter it each time you visit our site, and for other purposes.</p>
...
<!-- CONTENT GOES ABOVE HERE -->
	...
	<div class="sidebar col-xs-12 col-md-4 col-lg-3">
        ...
        <!-- /2542414/EQ_OutOfPage -->
			<div id='outOfPageAdDiv' class='adunit'>
				<script type='text/javascript'>
					googletag.cmd.push(function() { googletag.display('outOfPageAdDiv'); });
				</script>
			</div>
<!-- end: sidebar --> 
            ...
            <div class="row footer-marketplace">
                <div class="col-xs-12 col-xs-3"  style="width: 230px">
								...
								<h5 class="lightgoldtxt" style="margin: 15px 0px 5px 0px">Account Wagering</h5>
											...
											<div>
												<a style="color:white;" target="_blank" href="http://pubads.g.doubleclick.net/gampad/clk?id=4731111818&iu=/2542414/EQ_Click_Marketplace/MPL_Winners"> Winners CTOTB  (Sportech)</a>
											</div>
								...
								<h5 class="lightgoldtxt" style="margin: 15px 0px 5px 0px">Equine Products</h5>
											...
											<div>
												<a style="color:white;" target="_blank" href="http://pubads.g.doubleclick.net/gampad/clk?id=4616340418&iu=/2542414/EQ_Click_Marketplace/MPL_AbbeyRoad"> Abbey Road Supplements</a>
											</div>
								...
								<h5 class="lightgoldtxt" style="margin: 15px 0px 5px 0px">Racetracks</h5>
											...
											<div>
												<a style="color:white;" target="_blank" href="http://pubads.g.doubleclick.net/gampad/clk?id=4791220468&iu=/2542414/EQ_Click_Marketplace/MPL_NYRAaqu"> Aqueduct</a>
											</div>
											...
											<div>
												<a style="color:white;" target="_blank" href="http://pubads.g.doubleclick.net/gampad/clk?id=4666269273&iu=/2542414/EQ_Click_Marketplace/MPL_Woodbine"> Woodbine</a>
											</div>
								...
								<h5 class="lightgoldtxt" style="margin: 15px 0px 5px 0px">Racing News</h5>
											...
											<div>
												<a style="color:white;" target="_blank" href="http://pubads.g.doubleclick.net/gampad/clk?id=4815312863&iu=/2542414/EQ_Click_Marketplace/MPL_DRF"> Daily Racing Form</a>
											</div>
								...
								<h5 class="lightgoldtxt" style="margin: 15px 0px 5px 0px">Racing Partnerships</h5>
											...
											<div>
												<a style="color:white;" target="_blank" href="http://pubads.g.doubleclick.net/gampad/clk?id=4639694341&iu=/2542414/EQ_Click_Marketplace/MPL_PewterStables"> Pewter Stable</a>
											</div>
