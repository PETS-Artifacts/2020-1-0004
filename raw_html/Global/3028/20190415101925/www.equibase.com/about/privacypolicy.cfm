...
<head>
	...
	<link rel="stylesheet" media="all" type="text/css" href="/bundles/styles.css?v=2019030401">
	<link rel="stylesheet" media="print" type="text/css" href="/css/printContentLayout.css?v=2019030401" />
	...
	<script src="/js/main.js?v=2019030401"></script>
	<script src="/js/jquery.selectbox-0.5.js"></script>
	<script src="/js/home/search.js?v=2019030401"></script>
	<script src="/js/home/racing-news.js?v=2019030401"></script>
	<script src="/js/recentPurchases.js?v=2019030401"></script>
	...
	<title>Equibase | Privacy Policy</title>
...
<!-- Admiral Script-->
<script type="text/javascript">!(function(o,n,t){t=o.createElement(n),o=o.getElementsByTagName(n)[0],t.async=1,t.src="https://whisperingcrib.com/v2/0/yghb2Xf1O0XCDBuNKYvUP8Qnu2UJMaXibW5H2Ylb97X7uBkZmP_KZkPcEanqYfRy4T0",o.parentNode.insertBefore(t,o)})(document,"script"),(function(o,n){o[n]=o[n]||function(){(o[n].q=o[n].q||[]).push(arguments)}})(window,"admiral");!(function(n,e,r,t){function o(){if((function o(t){try{return(t=localStorage.getItem("v4ac1eiZr0"))&&0<t.split(",")[4]}catch(n){}return!1})()){var t=n[e].pubads();typeof t.setTargeting===r&&t.setTargeting("admiral-engaged","true")}}(t=n[e]=n[e]||{}).cmd=t.cmd||[],typeof t.pubads===r?o():typeof t.cmd.unshift===r?t.cmd.unshift(o):t.cmd.push(o)})(window,"googletag","function");;;;;</script>

<!-- Script from TS enables section targeting Cold Fusion -->
<script type="text/javascript"> var pageTarget = {"section": ""}; </script>


<script type="text/javascript" src="/js/promoCodeInclude.js?v=2019030401"></script>

<script src="/bundles/scripts-header.js?v=2019030401"></script>

<!-- begin: defaultAdDef.cfm template -->
...
var headerMapping = googletag.sizeMapping().
    addSize([1190, 0], [[728, 90], [970, 90], [1,1], [970,250], [1170, 90], [1170, 250]]). //desktop
    addSize([990, 0], [[728, 90], [970, 90], [1,1]]). //tablet landscape
    addSize([748,0], [[728, 90], [1,1]]). //tablet portrait
    addSize([0, 0], [[300,250], [320, 50], [320,100], [300,100], [300, 50], [1,1]]). //mobile
             build();
var sidebarMapping = googletag.sizeMapping().
	addSize([980, 0], [[300, 250], [300,600], [1,1], 'fluid']). //tablet landscape
	addSize([0, 0], []). //no ads when sidebar drops
             build();
    
	gptAdSlots[0] = googletag.defineSlot('/2542414/EQ_Desktop_ROS_728x90_ATF_Header', [[728, 90], [320, 50]], 'headerAdDiv').defineSizeMapping(headerMapping).addService(googletag.pubads());
	gptAdSlots[1] = googletag.defineSlot('/2542414/EQ_Desktop_ROS_300x250_ATF_Sidebar1', [[300, 250]], 'adDiv1').defineSizeMapping(sidebarMapping).addService(googletag.pubads()).setTargeting("sticky", "yes");
});
	</script>
	
<!-- dfp gpt targeting and execute -->
...
<!-- amazon bidder --->
<!-- begin: Amazon Bidder - GENERIC (top 4 placement on desktop, header on mobile) -->
<script type='text/javascript'>
...
<!-- end: Amazon Bidder -->
<!-- bRealTime bidder --->
<!-- begin: bRealTime wrapper - DYNAMIC (ORIGINAL) -->
<script src="//biddr.brealtime.com/12965094-959.js" type="text/javascript"></script>
<!-- end: bRealTime wrapper--> 
<!-- end: defaultAdDef.cfm template --> 
...
<script type="text/javascript" src="https://n-cdn.areyouahuman.com/play/ZJFYkJE5SICN8qC78YCEaQsMw8PeMdzQFeIwtPBN?AYAH_P1=d27d422a-1453-4ce9-9535-6c5b1797add2&AYAH_P2=&AYAH_P3=&AYAH_F1=2962&AYAH_F2=12423"></script>

<noscript><img src="https://n-cdn.areyouahuman.com/noscript/ZJFYkJE5SICN8qC78YCEaQsMw8PeMdzQFeIwtPBN?AYAH_P1=d27d422a-1453-4ce9-9535-6c5b1797add2&AYAH_P2=&AYAH_P3=&AYAH_F1=2962&AYAH_F2=12423"></noscript></head>
...
<ul class="sf-menu hidden-print" id="primary-nav">
				...
				<div class="">
					...
					<div class="col-xs-4 hidden-print">
						...
						<ol>
								...
								<li>
									<a href="/premium/eqpAXCISTrackSelections.cfm?tid=HAW">Hawthorne</a>
								</li>
							
								<li>
									<a href="/premium/eqpAXCISTrackSelections.cfm?tid=CT">Hollywood Casino At Charles Town Races</a>
								</li>
							
								<li>
									<a href="/premium/eqpAXCISTrackSelections.cfm?tid=KEE">Keeneland</a>
								</li>
			...
			<div class="sf-mega">
				<div class="">
					...
					<div class="col-xs-4 hidden-print">
						...
						<ol>
							<li><a href="/premium/eqbProductPage.cfm?pid=50495">Bruno With The Works - <font color="red">NEW!</font></a></li>
			...
			<div class="sf-mega">
				<div class="">
					...
					<div class="col-xs-4">
						...
						<ol>
							<li><a href="/Data.cfm/Product/STATS/FreeRace?productCode=SRL" onClick="ga('send', 'event', 'Nav Bar', 'click' 'STATS Race Lens Free Race');" target="_blank">Free Race</a></li>
				...
				<div class="">
					...
					<div class="col-xs-4">
						...
						<ol>
							...
							<li><a href="/content/ifharatings-home.cfm">IFHA World Rankings</a></li>
							<li><a href="/weeklyreports/index.cfm">Weekly Leader Reports</a></li>
							<li><a href="/compare/index.cfm">Compare Statistics  - <font color="red">NEW!</font></a> </a></li>
							<li><a href="/dailyInsights/dailyInsights.cfm">Daily Insights  - <font color="red">NEW!</font></a> </a></li>
						</ol>
					</div>
			...
			<div class="sf-mega">
				<div class="">
					...
					<div class="col-xs-4">
						...
						<ol>
							<li><a href="https://www.ownerview.com"><img src="http://www.equibase.com/content/images/ov-banner.png" class="img-responsive"></a></li>
						</ol>
					</div>
		...
		<li>
				...
				<div class="">
					...
					<div class="col-xs-4">
						...
						<ol>
							...
							<li><a href="/content/podcasts.cfm">Horse Racing Podcasts</a></li>
						</ol>
					</div>
			...
			<ul class="social-icons account-social-icon" >
			...
			<ul class="sf-menu hidden-print account-checkout-header"  >
				<li>
					
					<a href="/premium/CUSTOMERADMINMAIN.CFM?logon=Y" class="account" >
						
							<span id="myAccountSpan">Login</span>
						
						<div class='sf-mega' style='width:250px !important' id="accountLink-Desktop">
...
<ul class="menu-bar">
	<li >
		...
		<li class="menu-toggle">
			<a id="mobileAccountMenuText">My Account</a>
			<ul id="accountLink-Mobile" class="menu-bar">
			
				<a href="/premium/CUSTOMERADMINMAIN.CFM?logon=Y" class="account"><img src="/img/user-login.png" alt="Login" id="loginLink-Mobile"></a>
	...
	<ul class="menu-bar">
		...
		<li><a href="/premium/eqpAXCISTrackSelections.cfm?tid=HAW">Hawthorne</a></li>
		
		<li><a href="/premium/eqpAXCISTrackSelections.cfm?tid=CT">Hollywood Casino At Charles Town Races</a></li>
		
		<li><a href="/premium/eqpAXCISTrackSelections.cfm?tid=KEE">Keeneland</a></li>
...
<div id="headerAdWrapperDiv" class="header-ad hidden-print center" style="margin-bottom:15px; margin-left:0px; margin-right:0px;">
    <div id="headerAdDiv" >
        <script type='text/javascript'>
...
<script>
    $(document).ready(function(){
        var topBarHeight = $("#nav-bar").height();
        if(topBarHeight > 50){
            $("#headerAdWrapperDiv").css('margin-top', "calc(125px - " + topBarHeight + "px)");
        }else{
            $("#headerAdWrapperDiv").css('margin-top', "25px");
        }
    });
</script>
		</section>
  ...
  <!-- HEADER -->
  	<div class="row">
		<div class="col-xs-12">
			...
			<div class="breadcrumbs phone-hide">
				<a href="/index.cfm">Home</a> &raquo; <a href="#">About Equibase</a> &raquo; <a href="#">Privacy Policy</a>
			</div>
			<div id="addThis" class="phone-hide">
	<!-- AddThis Button BEGIN -->
	<div class="addthis_toolbox addthis_default_style">

		<!-- AddToAny BEGIN -->
<!--changed--><div class="a2a_kit a2a_kit_size_16 a2a_default_style">
<a class="a2a_dd" href="https://www.addtoany.com/share"></a>
<a class="a2a_button_facebook"></a>
<a class="a2a_button_twitter"></a>
<a class="a2a_button_google_plus"></a>
<a title="Print Screen" alt="Print Screen" onclick="window.print();" target="_blank" style="cursor:pointer;"><img border="0" src="/images/prient_icon.jpg"></a>
...
<section id="contentwrapper" class="l-section">
	<div class="row">
	...
	<h3 class="text-center">PRIVACY STATEMENT FOR <I>equibase.com</I></h3>

<p><b>Please Note:</b> This privacy policy was last updated on March 27, 2019 and is subject to future change without notice.</p>
<p>Equibase Company LLC has created this privacy statement in order to demonstrate our firm commitment to privacy. The following discloses our information gathering and dissemination practices for this website: <b><I>equibase.com</I></B>.</p>
<p>We use your IP address to help diagnose problems with our server, and to administer our web site. Your IP address is used to help identify you and your shopping cart and to gather broad demographic information.  We monitor access to the site via IP address for data scrapers and automated access of information on the site.  We block IP addresses engaging in these activities.</p>
<p>Our site uses cookies to keep track of your shopping cart. We use cookies to deliver content specific to your interests, to save your password so you don't have to re-enter it each time you visit our site, and for other purposes.  Some of the ads you receive on Web pages are customized based on predictions about your interests generated from your visits to different Websites in this browser and on other devices you may use.  To opt out of interest based advertising from specific participating companies, or from all participating companies, <a href="http://optout.aboutads.info/?c=2&lang=EN">click here</a>.  You can learn more about certain types of targeted advertising by visiting the <a href="http://www.aboutads.info/">Digital Advertising Alliance</a>.
</p>
...
<p>Aggregate demographic information collected via use of the site may be shared with advertisers and other partners. This aggregate information is not traceable to an individual user.</p>

<p>When registering at our site, your registration information is also sent to TrackMaster, a wholly-owned subsidiary of Equibase Company LLC so that your registration information can be used to purchase products and services at their website <b><I>trackmaster.com</I></b>.  It will be necessary for you to complete additional registration information at <b><I>trackmaster.com</I></b> before being able to make purchases at that site.  No additional registration information is required to make purchases at <i><b>equibase.com</b></i>.  Products and services on <b><I>trackmaster.com</I></b> are covered by a separate set of Terms and Conditions that will be provided for your approval before any purchases can be made.  Registration at our web site does not obligate you to make purchases at <b><I>trackmaster.com</I></b>.  Any questions concerning the terms and conditions for the <b><I>trackmaster.com</I></b> web site should be referred to TrackMaster via the contact information provide via that site.</p>
<p>This site contains links to other sites. <b><i>equibase.com</i></b> is not responsible for the privacy practices or the content of such web sites.</p>
...
<p>We work to protect the security of your information during transmission by using Secure Sockets Layer (SSL) software, which encrypts information you input.  This site has security measures in place to protect the loss, misuse and alteration of the information under our control.  <b><I>equibase.com</I></b> uses 128-bit encryption for all secure links, which adheres to Federal and International guidelines for secure server transactions.  We reveal only the last four digits of your credit card numbers when confirming an order. Equibase uses Tokenization of payment card information and does not keep, maintain or transmit payment card data.</p>

<p><i><b>equibase.com</b></i> is tested and certified daily to pass the McAfee Secure Security Scan. To help address concerns about possible hacker access to your confidential data, and the safety of visiting <i><b>equibase.com</b></i>, the "live" McAfee Secure mark appears only when this site passes the daily McAfee Secure tests.</p>

<h3>Opt Out Procedures for Mailings</h3>

<p>Our site provides users the opportunity to opt-out of receiving communications from Equibase Company and third parties at the point where we request registration information about the visitor.</p>

<p>This site gives users the option for removing their information from our database to not receive information about Equibase Products and Services.  In order to complete this request, the User must send a written request via e-mail, including their Customer ID to: <a class="dkbluesm" href="mailto:registration@equibase.com?subject=Equibase Mail List Remove">Equibase Mailing List Removal</a></p>

<p>This site gives users the option to no longer receive the Equibase Inside Track mailing.  In order to complete this request, the User must send a written request via e-mail, from the e-mail address used at registration, to: <a class="dkbluesm" href="mailto:insidetrack@equibase.com?subject=Inside Track Remove">Inside Track Removal</a></p>

<p>This site gives users the option to de-activate their Virtual Stable.  In order to complete this request, the User can do so from the <a class="dkbluesm" href="http://www.equibase.com/virtual/gvsVirtualStableMain.cfm?SID=1" target="_new">Virtual Stable Main Page</a>, or by sending a written request via e-mail, from the e-mail address used for the Virtual Stable, to: <a class="dkbluesm" href="mailto:feedback@equibase.com?subject=De-activate Virtual Stable">De-activate Virtual Stable</a></p>
...
<p>
Shelby Cook
<br>Online Services Coordinator
<br>Equibase Company LLC
<br>821 Corporate Drive
<br>Lexington, KY  40503
<br>1-800-333-2211
<br>scook@equibase.com
</p>
...
<div id="stickyDiv">
        ...
        <script>
//           var interStickyAd = $("#sticky1"),
//				interStickyAdLen = 750;

            var stickyAd = $("#stickyDiv"),
            anchorAd = $("#anchorDiv");
        </script>
	<!-- makes sure varable is set for cachebuster -->
			
	<!-- sticky js -->
			 <script src="/js/stickyAds.js?v=2019030401"></script> 
			...
			<section id="footer" class="l-section">
				<div class="row">
					<div class="col-xs-12">
						...
						<div> <!-- Marketplace footer links styled for desktop vs. mobile -->
							<div class="phone-hide tablet-show desktop-show">
...
<!-- begin: marketplace footer block-->
            ...
            <div class="row footer-marketplace">
                <div class="col-xs-12 col-xs-3"  style="width: 230px">
								...
								<h5 class="lightgoldtxt" style="margin: 15px 0px 5px 0px">Account Wagering</h5>
											...
											<div>
												<a style="color:white;" target="_blank" href="http://pubads.g.doubleclick.net/gampad/clk?id=5026299055&iu=/2542414/EQ_Click_Marketplace/MPL_HollywoodRaces"> Hollywood Races</a>
											</div>
										
											<div>
												<a style="color:white;" target="_blank" href="http://pubads.g.doubleclick.net/gampad/clk?id=4958690129&iu=/2542414/EQ_Click_Marketplace/MPL_MyWinners"> MyWinners</a>
											</div>
											...
											<div>
												<a style="color:white;" target="_blank" href="http://pubads.g.doubleclick.net/gampad/clk?id=4686048668&iu=/2542414/EQ_Click_Marketplace/MPL_TwinSpires"> TwinSpires</a>
											</div>
								...
								<h5 class="lightgoldtxt" style="margin: 15px 0px 5px 0px">Associations</h5>
									
											<div>
												<a style="color:white;" target="_blank" href="http://pubads.g.doubleclick.net/gampad/clk?id=4648924535&iu=/2542414/EQ_Click_Marketplace/MPL_HPBA"> National HBPA</a>
											</div>
								...
								<h5 class="lightgoldtxt" style="margin: 15px 0px 5px 0px">Equine Rehoming</h5>
									
											<div>
												<a style="color:white;" target="_blank" href="http://pubads.g.doubleclick.net/gampad/clk?id=4953926381&iu=/2542414/EQ_Click_Marketplace/MPL_ThoroughbredSportHorses"> Thoroughbred Sport Horses</a>
											</div>
								...
								<h5 class="lightgoldtxt" style="margin: 15px 0px 5px 0px">Equine Products</h5>
											...
											<div>
												<a style="color:white;" target="_blank" href="http://pubads.g.doubleclick.net/gampad/clk?id=4937080228&iu=/2542414/EQ_Click_Marketplace/MPL_AbbeyRoad"> Abbey Road Supplements</a>
											</div>
										
											<div>
												<a style="color:white;" target="_blank" href="https://www.bigdweb.com/category/thoroughbred+racing.do?code=EQUIBASE"> Big Dee's Tack & Vet Supplies</a>
											</div>
										
											<div>
												<a style="color:white;" target="_blank" href="http://pubads.g.doubleclick.net/gampad/clk?id=4894347324&iu=/2542414/EQ_Click_Marketplace/MPL_KER"> Kentucky Equine Research</a>
											</div>
										
											<div>
												<a style="color:white;" target="_blank" href="http://pubads.g.doubleclick.net/gampad/clk?id=4782548298&iu=/2542414/EQ_Click_Marketplace/MPL_SpeedSilks"> Speed Silks</a>
											</div>
								...
								<h5 class="lightgoldtxt" style="margin: 15px 0px 5px 0px">Publications</h5>
											...
											<div>
												<a style="color:white;" target="_blank" href="http://pubads.g.doubleclick.net/gampad/clk?id=4965912170&iu=/2542414/EQ_Click_Marketplace/MPL_BloodHorse"> BloodHorse</a>
											</div>
								...
								<h5 class="lightgoldtxt" style="margin: 15px 0px 5px 0px">Racetracks</h5>
											...
											<div>
												<a style="color:white;" target="_blank" href="http://pubads.g.doubleclick.net/gampad/clk?id=5030773802&iu=/2542414/EQ_Click_Marketplace/MPL_Woodbine"> Woodbine</a>
											</div>
								...
								<h5 class="lightgoldtxt" style="margin: 15px 0px 5px 0px">Racing Partnerships</h5>
											...
											<div>
												<a style="color:white;" target="_blank" href="http://pubads.g.doubleclick.net/gampad/clk?id=4838795985&iu=/2542414/EQ_Click_Marketplace/MPL_PewterStables"> Pewter Stable</a>
											</div>
    ...
    <!-- end: marketplace footer block -->
							...
							<div class="phone-show tablet-hide desktop-hide">
...
<!-- begin: marketplace footer block-->
    ...
    <!-- end: marketplace footer block -->
						...
						<!-- legal -->
						<div class="legal">
							Proprietary to and &copy; 2019 Equibase Company LLC. All Rights Reserved.<br>
...
<script>
    ...
    $(document).ready(function(){
        ...
        if (app.cookie && app.cookie.get("PAC") !== "" && app.cookie.get("PAC") !== null || (getCookie("PAC") != "")){

            $("#myAccountSpan").text("My Account");
            //Padding-top is what should be there but for some reason isn't being added.
            $('#accountLink-Desktop').html("<div class='col-xs-12 textcenter' style='padding-top:15px;'>" +
														"<ol>" +
															"<h2 class='lightgoldtxt'>My Account</h2>" +
															"<br style='display:block; content:\"\"; margin-top:10px;'>" +
															"<li style='background: ##ececec;'><a href='/premium/CUSTOMERADMINMAIN.CFM'>Account Services</a></li>" +
															"<li style='background: ##fff;'><a href='/premium/eebCustomerAccountHistorySelect.cfm'>Order History</a></li>" +
															"<li style='background: ##ececec;'><a href='/premium/eqbCustomerOffers.cfm'>Offers and Promotions</a></li>" +
														"</ol>" +
														"<ol class='product-purchase-hide'>" +
															"<hr class='product-purchase-hide'>" +
															"<h2 class='lightgoldtxt product-purchase-hide'>Recent Purchases:</h2>" +
															"<ol id='recentPurchasesDesktop' class='product-purchase-hide'></ol>" +
															"<hr class='product-purchase-hide'>" +
															"<li class='product-purchase-hide'><a href='/premium/eebDownloadProduct.cfm'>View All Recent Purchases</a></li>" +
														"</ol>" +
														"<ol>" +
															"<br>" +
															"<li><a href='/premium/eebCustomerLogout.cfm'>Log out</a>" +
														"</ol>" +
													"</div>" +
												  "</div>");
            $('#loginLink-Mobile').attr({
              alt: "My Account",
              src: "/img/user-action-account.png"
            });
            var mobileMenuAccountMenu = "";
            mobileMenuAccountMenu += "<li class='menu-section-title'>My Account</li>" +
                                                        "<li><a href='/premium/CUSTOMERADMINMAIN.CFM'>Account Services</a></li>" +
                                                        "<li><a href='/premium/eebCustomerAccountHistorySelect.cfm'>Order History</a></li>" +
                                                        "<li><a href='/premium/eqbCustomerOffers.cfm'>Offers and Promotions</a></li>" +
                                                        "<li class='menu-section-title product-purchase-hide'>Recent Purchases:</li>" +
                                                        "<li class='recentPurchasesMobile product-purchase-hide' id='recentPurchasesMobile'></li>" +
                                                        "<li class='product-purchase-hide'><a href='/premium/eebDownloadProduct.cfm'><u>View All Recent Purchases</u></a></li>" +
                                                        "<li><a href='/premium/eebCustomerLogout.cfm'>Log out</a>" +
                                                    "</ul>" +
                                                  "</li>";
            $("#accountLink-Mobile").html(mobileMenuAccountMenu);
            getAndDisplayRecentPurchases();
        }
        else {
            $('#myAccountSpan').text("Login");
            $('#loginLink-Mobile').attr({
              alt: "Login",
