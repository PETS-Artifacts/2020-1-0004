...
<!-- end: bRealTime wrapper-->
        ...
        <script>
            var stickyAd = $("#adDiv2"),
            anchorAd = $("#c-latest-information");
        </script>
		
<!-- makes sure varable is set for cachebuster -->
	<script src="/js/stickyAds.js?v=2018042301"></script> 
            ...
            <div class="row footer-marketplace">
                <div class="col-xs-12 col-xs-3"  style="width: 230px">
								...
								<h5 class="lightgoldtxt" style="margin: 15px 0px 5px 0px">Racetracks</h5>
											...
											<div>
												<a style="color:white;" target="_blank" href="http://pubads.g.doubleclick.net/gampad/clk?id=4638913112&iu=/2542414/EQ_Click_Marketplace/MPL_Woodbine"> Woodbine</a>
											</div>
