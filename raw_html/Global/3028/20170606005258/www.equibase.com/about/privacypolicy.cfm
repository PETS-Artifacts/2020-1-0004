...
<head>
	...
	<link rel="stylesheet" media="all" type="text/css" href="/bundles/styles.css?v=2017030901">
	<link rel="stylesheet" media="print" type="text/css" href="/css/printContentLayout.css?v=2017021602" />
	...
	<script src="/js/main.js?v=2017021301"></script>
	<script src="/js/jquery.selectbox-0.5.js"></script>
	<script src="/js/home/search.js?v=2017021301"></script>
	<script src="/js/home/racing-news.js?v=2017021301"></script>

	<script src="https://jwpsrv.com/library/8jaPKnGsEeSJyg6sC0aurw.js"></script>
   ...
   <style>
		...
		<script src='/js/adSetup.js?v=20170517'></script>	
    ...
    pageTarget.section = 'XXX';

    googletag.cmd.push(function() {
	if(pageTarget.section == ""){
    ...
    addSize([488, 0], [[468, 60], [320, 50], [300, 50], [1,1]]). //mobile landscape
    addSize([0, 0], [[320, 50], [300, 50], [1,1]]). //mobile portrait
             build()).setTargeting('section', pageTarget.section).addService(googletag.pubads());
	...
	<script src="/bundles/scripts-header.js"></script>
...
<ul class="sf-menu hidden-print" id="primary-nav">
				...
				<div class="">
					...
					<div class="col-xs-4 hidden-print">
						...
						<ol>
								...
								<li>
									<a href="/premium/eqpAXCISTrackSelections.cfm?tid=DEL">Delaware Park</a>
								</li>
								...
								<li>
									<a href="/premium/eqpAXCISTrackSelections.cfm?tid=TDN">Thistledown</a>
								</li>
		...
		<li class="stats-text">
			<a href="#"><span>STATS&trade;</span> Handicapping</a>
			...
			<div class="sf-mega">
				<div class="">
					...
					<div class="col-xs-4">
						...
						<a href="https://attendee.gotowebinar.com/register/76014019401607683?source=navigation" class="button btn-block">Sign up for next webinar</a>
...
<section id="site-bar" class="l-section">
			<div class="row">
				<div class="l-section-inner col-xs-12">
...
<ul class="menu-bar">
	...
	<ul class="menu-bar">
		...
		<li><a href="/premium/eqbProductPage.cfm?pid=50283">Ellis Starr</a></li>
		<li><a href="/premium/eqpAXCISHarnessSelections.cfm?SAP=TNH">Harness Selections</a></li>
		<li><a href="/premium/eqpSpanishSelections.cfm?SAP=TNH">En Espa̱ol</a></li>
		...
		<li><a href="/premium/eqpAXCISTrackSelections.cfm?tid=DEL">Delaware Park</a></li>
		...
		<li><a href="/premium/eqpAXCISTrackSelections.cfm?tid=TDN">Thistledown</a></li>
	...
	<!-- STATS Race Lens -->
		...
		<li><a href="https://attendee.gotowebinar.com/register/76014019401607683?source=navigation">Sign Up For Next Webinar</a></li>
...
<script>
	$(document).ready(function(){
		if($("#site-bar nav > ul li.menu-section-title").find("h3")){
			...
			<!-- BEGIN AD -->
					<div class="header-ad hidden-print center">
...
<script type="text/javascript" src="/js/promoCodeInclude.js?v=2017042801"></script>
...
<script type="text/javascript">stLight.options({publisher: "201583fb-6854-49a0-8ded-677db0b7b115", doNotHash: true, doNotCopy: true, hashAddressBar: true});</script>
  ...
  <!-- HEADER -->
	...
	<div class="addthis_toolbox addthis_default_style">
		...
		<span class="st_facebook" title="Facebook" st_processed="yes"><span style="text-decoration: none; color: rgb(0, 0, 0); display: inline-block; cursor: pointer; padding-left: 0px; padding-right: 0px; width: 16px;" class="stButton"><span class="chicklets facebook">&nbsp;</span></span></span>
		<span class="st_twitter" title="Twitter" st_processed="yes"><span style="text-decoration: none; color: rgb(0, 0, 0); display: inline-block; cursor: pointer; padding-left: 0px; padding-right: 0px; width: 16px;" class="stButton"><span class="chicklets twitter">&nbsp;</span></span></span>
		<span class="st_linkedin" title="LinkedIn" st_processed="yes"><span style="text-decoration: none; color: rgb(0, 0, 0); display: inline-block; cursor: pointer; padding-left: 0px; padding-right: 0px; width: 16px;" class="stButton"><span class="chicklets linkedin">&nbsp;</span></span></span>
		<span class="st_sharethis" st_processed="yes"><span style="text-decoration: none; color: rgb(0, 0, 0); display: inline-block; cursor: pointer; padding-left: 0px; padding-right: 0px; width: 16px;" class="stButton"><span class="chicklets sharethis">&nbsp;</span></span></span>
	...
	<script type="text/javascript" src="https://s7.addthis.com/js/250/addthis_widget.js####pubid=xa-4f58bc7208330c2b"></script>
	<!-- AddThis Button END -->
</div>
		</div>
	</div>
...
<!-- CONTENT GOES ABOVE HERE -->
 ...
 <script type='text/javascript'>
      googletag.cmd.push(function() {
        googletag.defineSlot('/2542414/EQ_Desktop_ROS_300x250_ATF_Sidebar1', [300, 250], 'adDiv1').defineSizeMapping(googletag.sizeMapping().
	addSize([1155, 0], [[300, 600], [300, 250]]). //desktop
	addSize([980, 0], [[300, 250], [300, 600]]). //iPad landscape
	addSize([0, 0], []). //catch all - sidebar drops off at 975 width
             build()).addService(googletag.pubads());
googletag.defineSlot('/2542414/EQ_Desktop_ROS_300x250_BTF_Sidebar2', [300, 250], 'adDiv2').defineSizeMapping(googletag.sizeMapping().
	addSize([1155, 0], [[300, 600], [300, 250], [160, 600]]). //desktop
	addSize([980, 0], [[300, 250], [300, 600], [160, 600]]). //iPad landscape
	addSize([0, 0], []). //catch all - sidebar drops off at 975 width
             build()).addService(googletag.pubads());
googletag.defineSlot('/2542414/EQ_Desktop_ROS_300x250_BTF_Sidebar3', [300, 250], 'adDiv3').defineSizeMapping(googletag.sizeMapping().
	addSize([1155, 0], [[300, 250]]). //desktop
	...
	<!-- BEGIN FOOTER SECTION -->
			<section id="footer" class="l-section">
				<div class="row">
					<div class="col-xs-12">
						<!-- footer links -->
						<div class="footer-links clearfix hidden-print">
							<ul>
						...
						<div class="row companyinfo hidden-print">
							<div class="col-xs-12 col-sm-9">
								...
								<div class="footer-logos">
									<a target="_blank" href="http://www.followhorseracing.com"></a>
									<a target="_blank" href="http://www.breederscup.com"></a>
									<a target="_blank" href="http://www.drf.com"></a>
									<a target="_blank" href="http://www.espn.com"></a>
									<a target="_blank" href="http://www.msnbc.com"></a>
									<a target="_blank" href="http://www.ntra.com"></a>
									<a target="_blank" href="http://www.thejockeyclub.com"></a>
									<a target="_blank" href="http://www.tra-online.com"></a>
									<a target="_blank" href="http://www.tvg.com"></a>
									<a target="_blank" href="http://www.xpressbet.com"></a>
								</div>
							</div>
						...
						<!-- legal -->
						<div class="legal">
							Proprietary to and &copy; 2017 Equibase Company LLC. All Rights Reserved.<br>
...
<script src="/bundles/scripts-footer.js?v=2017021601"></script>
<script>
