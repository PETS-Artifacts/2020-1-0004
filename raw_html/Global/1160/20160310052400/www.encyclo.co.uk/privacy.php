				...
				<div class="row">
                    <div class="span12" data-motopress-type="static" >
	                    <div class="content_box" style="margin-bottom:13px;margin-top:-5px;padding:0px;">
							<div><!-- encyclo.co.uk_Sub_728x90_top --><script type="text/javascript">document.write('<scr'+'ipt language="javascript1.1" src="http://ad.yieldpartners.com/symphony/impression?utid=000000068000500020001&click=[click]&ord=' + new Date().getTime() + '"></scri'+'pt>');</script></div>						</div>
					</div>
...
<!-- encyclo.co.uk_Sub_336x280 --><script type="text/javascript">document.write('<scr'+'ipt language="javascript1.1" src="http://ad.yieldpartners.com/symphony/impression?utid=000000068000500020005&click=[click]&ord=' + new Date().getTime() + '"></scri'+'pt>');</script>
