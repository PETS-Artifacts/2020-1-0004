					...
					<div class="pull-right" data-motopress-type="static">
						...
						<ul id="topnav" class="sf-menu">
							...
							<li class="color-3 icon-list-ul menu-item current-menu-item page_item current_page_item"><a href="http://www.encyclo.co.uk/words/A">More</a>
								...
								<li class="menu-item"><a href='http://www.encyclo.co.uk/begins-with.php' title='Categories''>Word starts with</a></li>
								<li class="menu-item"><a href='http://www.encyclo.co.uk/ends-with.php' title='Categories''>Word ends with</a></li>
								<li class="menu-item"><a href='http://www.encyclo.co.uk/contains.php' title='Categories''>Word contains</a></li>
								...
								<li class="menu-item"><a href="http://www.encyclopedie.fr/">Encyclopédie (FR)</a></li>
					...
					<div class="span3" data-motopress-type="dynamic-sidebar" data-motopress-sidebar-id="footer-sidebar-2">
						<div id="tag_cloud-3">
							...
							<div class="tagcloud">
								...
								<a href='http://www.encyclo.co.uk/begins-with.php' title='Categories' style='font-size: 22pt;'>Word starts with ...</a>
								<a href='http://www.encyclo.co.uk/ends-with.php' title='Categories' style='font-size: 22pt;'>Word ends with ...</a>
								<a href='http://www.encyclo.co.uk/contains.php' title='Categories' style='font-size: 22pt;'>Word contains ...</a>
								<a href='http://www.encyclo.co.uk/calendar/January.php' title='On this day in history' style='font-size: 22pt;'>On this day</a>
								<a href="http://www.encyclo.co.uk/webster/A/1">Webster's dictionary</a></li>
								...
								<a href='http://www.encyclo.co.uk/words/A' title='Words' style='font-size: 8pt;'>All words</a>
							</div>
						</div>
					</div>
					<div class="span3">
						<div id="my_poststypewidget-9"><h4 class="footer-widgets_h">Encyclo Websites</h4>
									<br><i class='icon-external-link'></i> <a class=wittrans href="http://www.encyclo.co.uk">English: Encyclo.co.uk</a></h4>
									<br><i class='icon-external-link'></i> <a class=wittrans href="http://www.enzyklo.de">German: Enzyklo.de</a></h4>
									<br><i class='icon-external-link'></i> <a class=wittrans href="http://www.encyclopedie.fr">French: Encyclopedie.fr</a></h4>
									<br><i class='icon-external-link'></i> <a class=wittrans href="http://www.encyclo.nl">Dutch: Encyclo.nl</a></h4>
						</div>
					</div>
				</div>	
			</div>
