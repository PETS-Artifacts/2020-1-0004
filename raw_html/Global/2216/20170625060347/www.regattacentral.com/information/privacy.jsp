...
<body>
	...
	<form id="userNmFrm">
		    <fieldset>
		        ...
		        <input type="hidden" name="csrfToken" value="5275822227853" />
		        </fieldset>
		        </form>
	</div>
...
<script type="text/javascript">window.NREUM||(NREUM={});NREUM.info={"errorBeacon":"bam.nr-data.net","licenseKey":"9974f40920","agent":"","beacon":"bam.nr-data.net","applicationTime":7,"applicationID":"3118184,3132377","transactionName":"MVRaZEBQVktZAU0KVggecmNiHlFWXg1LDlgSWFdeHUFKUU4DWhoXDEJI","queueTime":0}</script></body>
</html>
