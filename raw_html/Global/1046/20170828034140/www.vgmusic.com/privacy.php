...
<body style="background-image: url(/images/background.jpg)" onLoad="defaultStatus='Document: Done'">


<div style="text-align:center">
<p>
<a href="/"><img src="/images/mikey57a.gif" alt="You are surfing the Videogame Music Archive" width="468" height="60"></a>
</p>
...
<form id="searchbox_007557153183693834903:-vcc4ruk5dw" action="http://www.google.com/cse" style="margin:0px;padding:0px;">
<table border="0" cellpadding="0" style="margin-left: auto;margin-right: auto;">
<tr><td>
    <input type="hidden" name="cx" value="007557153183693834903:-vcc4ruk5dw">
...
<form action="http://www.vgmusic.com/cgi/redirect.pl" method="post" style="margin:0px;padding:0px;">
<table border="0" cellpadding="0" style="margin-left: auto;margin-right: auto;">
<tr><td>
<select name="info" size=1 onChange="newGo(this)">
   ...
   <option value="http://www.vgmusic.com/phpBB3/">VGMusic Forums &amp; Wishlist</option>
   <option value="http://www.vgmusic.com/new-files/">New-Files</option>
   <option value="http://www.vgmusic.com/new-files/upload/">Upload Files</option>
   <option value="http://www.vgmusic.com/contests/">Contests</option>
...
policy, please send an e-mail to <a href="mailto:siteadmin&#064;vgmusic.com">the webmasters</a>.
</p>

<p>
<big>IP addresses:</big><br>
...
This site makes no claim to the validity or responsibility of the additional information provided by the user.  Due to the <a href="http://www.ftc.gov/bcp/conline/edcams/kidzprivacy/biz.htm">COPPA</a> Act, users under the age of 13 must fill out the form <a href="http://www.vgmusic.com/coppaform.rtf">COPPA Form</a> and mail it to the address provided before being able to use the forums.
</p>

<p>
<big>Forum Private Messages:</big><br>
...
<p>
Attachments that violate the forum's <a href="http://www.vgmusic.com/faq/faq-frm.shtml#NiftyFeatures">rules regarding acceptable attachments</a> may be removed without warning.
...
<p>
<big>Advertising:</big><br>
Advertising is now provided by us for third parties.
</p>

<hr />
<table align="left" cellpadding="3" cellspacing="8">
<tr>

<td align="center"><a class="image" href="http://www.vgmusic.com/"><img class="image" border="0" hspace="15" width="35" height="40" alt="Return to Main Page" src="http://www.vgmusic.com/images/smwhero.gif"></a><br />
<a href="http://www.vgmusic.com/">Return to Main Page</a><br />
For more music</td>

<td align="center">
<form action="https://www.paypal.com/cgi-bin/webscr" method="post">
<input type="hidden" name="cmd" value="_xclick">
<input type="hidden" name="business" value="michael.b.newman&#064;gmail.com">
<input type="hidden" name="item_name" value="Video Game Music Archive Donation">
...
<hr>
<div style="text-align:center">
<p>Copyright &copy; 2017 Videogame Music Archive (<a href="http://www.vgmusic.com/">VGMusic.com</a>)</p>
</div>
<!-- end endpage.inc -->
