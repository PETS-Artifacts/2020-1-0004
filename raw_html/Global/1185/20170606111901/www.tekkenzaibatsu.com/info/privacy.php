...
<head>
<title>Privacy Policy - Tekken Zaibatsu</title>
...
<meta name="copyright" content="1999-2017 Tekken Zaibatsu" />
      ...
      <ul id="nav">
        <li class="index"><a href="/">Index</a>
          <span>
            ...
            <a href="/premium/members.php" class="subnav">Premium Members</a>
            <a href="/premium" class="subnav">Movie Archive</a>
            <a href="/premium/donate.php" class="subnav">Donate</a>
          </span>
        </li>
...
<div class="mobilehide">
  <div style="width: 1010px; height: 30px; margin-bottom: 8px;"><a href="http://www.tekken.namco/preorder" target="_blank"><img src="/images/ads/ttt_1010.jpg" width="1010" height="30" border="0" alt="Tekken Tag Tournament 2" /></a></div>
</div>
-->
  ...
  <div id="crumbs">
    <ul>
      <li><a href="/">Home</a></li>
<li><a href="index.php">Site Info</a></li>
<li>Privacy Policy</li>
    </ul>
  </div>
  <div id="adbanner"><!-- 728x90 Leaderboard ad code for TekkenZaibatsu.com -->
<noscript>
<a href="http://media.adfrontiers.com/pq?t=c&s=2222&ac=19&at=1&rnd=16685&xvk=19778">
<img height=90 width =728 src="http://media.adfrontiers.com/pq?t=i&s=2222&ac=19&at=1&rnd=16685&xvk=19778" border=0>
</a>
</noscript>
...
(function () {
    ...
    document.write('<scr' + ipt + ' language="javascript" src="http://media.adfrontiers.com/pq?t=j2&s=2222&ac=19&at=1&xvk=' + rnd + '">');
...
<div id="clear"></div>
  ...
  <div id="leftcol">
    ...
    <div class="clearbox">
      This site is not directed to children under the age of 13. We 
      prohibit forum registration by and will not knowingly collect personally 
      identifiable information from anyone under 13. No information should 
      be submitted to or posted by guests under 13 years of age, this 
      includes submissions of publically viewed content such as public 
      forum posts or game FAQs.<br />
      <br />
      Tekken Zaibatsu does not provide any personally identifying information, 
      regardless of its source, to any third party for any purpose whatsoever 
      from our guests under 13 years of age. No information collected 
      from guests under 13 years of age is used for any marketing or promotional 
      purposes whatsoever.<br />
      <br />
      The only individually identifiable information we currently collect 
      is aggregate data ,submitted content or email addresses, which are 
      volunteered by visitors wishing to participate in public forums, 
      submit site content or sign up for free email services.<br />
      <br />
      Tekken Zaibatsu does not sell, trade, lease or distribute any personal 
      information of its registered forum users. However, any users who 
      wish to participate in the public forums are required to provide 
      a valid email address as a condition of participation, which will 
      be publicly viewable along with any and all of their postings.<br />
      <br />
      Tekken Zaibatsu does not consider your IP as private personal information 
      and therefore does not warrant its protection in this regard. We 
      only collect IP addresses to facilitate system administration, to 
      report aggregate information to our advertisers, and to audit the 
      use of our site. We do not link IP addresses to anything personally 
      identifiable, which means that a user&#8217;s session will be logged, 
      but the user remains anonymous to us. We can and will use IP addresses 
      to identify a user when we feel it is necessary to enforce compliance 
      with our forum rules or terms of use or to protect our services 
      and site.<br />
      <br />
      Visitors should be aware that when you are on Tekken Zaibatsu, you 
      could be directed to other sites that are beyond our control. For 
      example, if you click on a banner advertisement or click a link 
      that takes you off our site. These other sites may send their own 
      ...
      don&#8217;t know. While Tekken Zaibatsu strives to protect its users&#8217; 
      ...
      risk.<br />
      <br />
      Tekken Zaibatsu is not responsible for communication and information 
      exchange offered by its free e-mail service through Everyone.Net. 
  ...
  <div id="rightbar">
      ...
      <div class="innerbox">
        <div id="sidenav">
          <ul>
            <li><a href="faq.php">Tekken Zaibatsu FAQs</a></li>
            <li><a href="sitemap.php">Zaibatsu Site Map</a></li>
            <li><a href="contact.php">Contact Staff</a></li>
            <li><a href="submitfaq.php">Submitting FAQs</a></li>
            <li><a href="submitart.php">Submitting Art</a></li>
            <li><a href="terms.php">Terms of Use</a></li>
            <li><a href="privacy.php">Privacy Policy</a></li>
          </ul>
        </div>
      </div>
    </div>    <div id="adbanner"><!-- 300x250 Medium Rectangle ad code for TekkenZaibatsu.com -->
<noscript>
<a href="http://media.adfrontiers.com/pq?t=c&s=2222&ac=19&at=2&rnd=63419&xvk=6458">
<img height=250 width =300 src="http://media.adfrontiers.com/pq?t=i&s=2222&ac=19&at=2&rnd=63419&xvk=6458" border=0>
</a>
</noscript>
<script language="javascript">
(function () {
    var ipt = "ipt";
    var rnd = Math.random() * 99999999;
    document.write('<scr' + ipt + ' language="javascript" src="http://media.adfrontiers.com/pq?t=j2&s=2222&ac=19&at=2&xvk=' + rnd + '">');
    document.write('</scr' + ipt + '>');
}());
</script>
<!-- (c) 2017 J Carter Marketing --></div>
...
<div id="footer">
  <div class="content">
    ...
    <div id="copyright">
      <span class="rights">Design & Content &copy;1999-2017 Tekken Zaibatsu - All Rights Reserved</span>
    ...
    <div id="links">
      <div class="list">
        <ul>
          ...
          <li><a href="/premium/members.php">Premium Members</a></li>
          <li><a href="/premium">Movie Archive</a></li>
          <li><a href="/premium/donate.php">Donate</a></li>
          <br />
