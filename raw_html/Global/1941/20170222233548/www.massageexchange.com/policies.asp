          ...
          <ul class="right">
            ...
            <li class="has-dropdown"><a href="/tips/faq.asp">Help</a>
				<ul class="dropdown">
					...
					<li class="divider"></li>
					<li><a href="https://cash.neweramediaworks.com" target="_blank">Become an Affiliate</a></li>
				</ul>
			</li>
...
<div class="row text-left" data-equalizer>
    ...
    <a href="/membership/gift.asp">Gift Membership <img src="/images/icon-gift-tiny.gif" alt="Gift" style="border:none; vertical-align:middle" /> </a> <br>
        ...
        <a href="https://cash.neweramediaworks.com" target="_blank" >Earn $$ as an Affiliate</a> 
    </div>
    <div class="small-6 medium-4 column" data-equalizer-watch>
  ...
  <a class="item pop" target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fwww%2Emassageexchange%2Ecom">
    <i class="fi-social-facebook"></i>

  </a>
  <a class="item pop" target="_blank" href="https://twitter.com/intent/tweet?text=Visit+https%3A%2F%2Fwww%2Emassageexchange%2Ecom">
    <i class="fi-social-twitter"></i>

  </a>
  <a class="item pop" target="_blank" href="https://plus.google.com/share?url=https%3A%2F%2Fwww%2Emassageexchange%2Ecom">
    <i class="fi-social-google-plus"></i>

  </a>
  <a class="item" href="mailto:?subject=You%20might%20like%20https%3A%2F%2Fwww%2Emassageexchange%2Ecom">
    <i class="fi-mail"></i>
