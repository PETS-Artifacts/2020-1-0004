...
.control-group.warning input, .control-group.warning textarea, .control-group.warning .uneditable-input {
    width: 280px;
    padding: 5px;
    height: 30px;
}
...
<div><a href="/klas-2018.asp"><img class="tab-w" src="images/home/curemd_klas.png" alt="CureMD KLAS" /></a> </div>
</div>
...
<li class="action-contact action" id="contact-number">
<a href="tel:+17186849298"><i class="contact-icon-phone2"></i>
<span class="peep-text2">Support</span>
<span class="peep-text down">718-684-9298</span></a>
</li>
