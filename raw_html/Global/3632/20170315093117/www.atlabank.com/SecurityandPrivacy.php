...
<br>We are committed to ensuring that your accounts remain secure and private. Here are some tips that will help you feel comfortable as well as give you some peace of mind in all your online activities.</p>
				...
				<div>
					<ul>
						<li>If you receive a suspicious email using Atlantic Bank’s name and asking for personal or Atlantic Bank account information, immediately forward the email to <a href="/cdn-cgi/l/email-protection#200041544c414e5449436041544c4142414e4b0e434f4d"><span class="bluetextlinks"><u><span class="__cf_email__" data-cfemail="e180958d808f958882a180958d8083808f8acf828e8ccf">[email&#160;protected]</span><script data-cfhash='f9e31' type="text/javascript">/* <![CDATA[ */!function(t,e,r,n,c,a,p){try{t=document.currentScript||function(){for(t=document.getElementsByTagName('script'),e=t.length;e--;)if(t[e].getAttribute('data-cfhash'))return t[e]}();if(t&&(c=t.previousSibling)){p=t.parentNode;if(a=c.getAttribute('data-cfemail')){for(e='',r='0x'+a.substr(0,2)|0,n=2;a.length-n;n+=2)e+='%'+('0'+('0x'+a.substr(n,2)^r).toString(16)).slice(-2);p.replaceChild(document.createTextNode(decodeURIComponent(e)),c)}p.removeChild(t)}}catch(u){}}()/* ]]> */</script></u></span></a> We will never send you an email asking for your online username or password.</li>
