...
<h2>Privacy policy</h2>
		<ol>
			...
			send it. We do not ask for or record your name or any other 
			demographic data. We do not share 
			...
			<li>This server is based in Chicago, USA. We manage it from wherever 
			...
			place cookies in your browser.</li>
			<li>For example, if we ever decide to display Google advertising, then Google uses 
			...
			AboutAds.info</a>, but then you may see less relevant advertising 
			...
			<li>Webb-site.com is free and not-for-profit, but we are 
			experimenting with advertising as one of several possible means of 
			supporting the future sustainability of the site if and when the 
			founder ceases his financial support for it. We hope you don't find 
			that off-putting but as always, <a href="../contact">feedback is 
			welcome</a>.</li>
</ol>
<div class="clear"></div>
<hr>
