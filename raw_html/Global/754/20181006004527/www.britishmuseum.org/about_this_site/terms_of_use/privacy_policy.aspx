...
</title><meta http-equiv="Content-Type" content="text/html;charset=utf-8" /><script type="text/javascript">window.NREUM||(NREUM={});NREUM.info = {"beacon":"bam.nr-data.net","errorBeacon":"bam.nr-data.net","licenseKey":"24faa59c77","applicationID":"6028717","transactionName":"NF1aZBYAV0FZWkwNDg0XeWM0Tl1XXlhNCBVNWUtAHA==","queueTime":0,"applicationTime":145,"ttGuid":"698F3EA245FE7BAD","agent":""}</script>
...
<meta name="twitter:image" content="https://www.britishmuseum.org/images/twitter_480x480.jpg" />
...
<body class="width_960 ">
    ...
    $(document).ready(function(){        
		console.log("ready...");
        $.getJSON("https://www2.britishmuseumshoponline.org/services/GetCookiePolicyValue/?callback=?",function(data) {
    ...
    <div id="headerBar">
            ...
            <div class="search">
                ...
                <div class="searchOptions">
                    ...
                    <ul>
                        ...
                        <li><a href="https://britishmuseumshoponline.org/page/search">Search the shop<i class="link-arrow"></i></a></li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="shop-button">
            <div class="cta smallButton transparent">
                <a href="https://www.britishmuseumshoponline.org">British Museum shop<i class="link-arrow"></i></a>
            </div>
        </div>
...
color:#000;
		...
		<form method="post" action="/about_this_site/terms_of_use//" id="enewsNullForm-footer"></form><form class="margin16pxB alpha omega clear" id="adestra_footer_form" class="formLayout" action="https://britishmuseum.msgfocus.com/s/" method="POST" ><input type="hidden" name="_account_id" value="1552"><input type="hidden" name="_table_id" value="8"><input type="hidden" name="_list_id" value="126"><input type="hidden" name="_dedupe" value="1">
            ...
            <div class="follow">           
                ...
                <ul class="bm-social">
                    ...
                    <li class="icon-facebook"><a href="https://www.facebook.com/britishmuseum" title="Facebook" style="margin-left:-5px">&#xe616;</a></li>
                    <li class="icon-twitter"><a href="https://twitter.com/britishmuseum" title="Twitter">&#xe619;</a></li>
                    <li class="icon-google-plus"><a href="https://plus.google.com/103128144782058926318/posts" title="Google+">&#xe61a;</a></li>
                    <li class="icon-youtube"><a href="https://www.youtube.com/user/britishmuseum" title="YouTube">&#xe61b;</a></li>
                    <li class="icon-soundcloud"><a href="https://soundcloud.com/britishmuseum" title="SoundCloud">&#xe620;</a></li>
                    <li class="icon-pinterest"><a href="https://www.pinterest.com/britishmuseum/" title="Pinterest">&#xe61c;</a></li>
                    <li class="icon-instagram"><a href="https://instagram.com/britishmuseum/" title="Instagram">&#xe61d;</a></li>
                    <li class="icon-tumblr"><a href="https://britishmuseum.tumblr.com/" title="RSS">&#xe621;</a></li>
                    <li class="icon-rss"><a href="https://blog.britishmuseum.org/feed" title="RSS">&#xe61e;</a></li>
        ...
        <div class="grid_4 omega">
                    ...
                    <ul class="footerLinks">
                        ...
                        <li><a href="https://www.finds.org.uk/" title="Portable Antiquities Scheme">Portable Antiquities Scheme</a></li>
...
$(window).load(function(){
	$('#footer_submit_button').on('click',function(e){
		...
		$('#return_page_footer').val('https://emails.britishmuseum.org/k/British-Museum/sign_up_form_from_website_box?email=' + theEmail);
