    ...
    <div id="headerBar">
        ...
        <div class="shop-button">
            <div class="cta smallButton transparent">
                <a href="http://www.britishmuseumshoponline.org">British Museum shop<span></span></a>
            </div>
        </div>
            ...
            <div id="subMenuWrapper">
                <div id="primaryMenu">
                    <div class="navigation horizontal section hideFirstChild">
                                ...
                                <li class="deepLink"><a href="/default.aspx" title="Welcome to the British Museum">Welcome to the British Museum</a></li>
        ...
        <div id="footer">
            <div id="footer-inner" class="clearfix"> 
                ...
                <div class="grid_4 omega">
                                ...
                                <li><a href="/about_this_site/footer_components/modern_slavery_act_statement.aspx" onclick="window.open(this.href, '_blank'); return false;" onkeypress="if (event.keyCode==13) {window.open(this.href, '_blank'); return false;}" title="Modern Slavery Act Statement">Modern Slavery Act Statement</a></li>
