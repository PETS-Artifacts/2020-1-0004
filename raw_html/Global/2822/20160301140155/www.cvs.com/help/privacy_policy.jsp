...
<body>
	...
	<link type="text/css" rel="stylesheet" media="all"
		...
		<div class="skip"><a href="#skipHeader">Skip Navigation
		Links</a></div>

		<div id="headWrap">
		<div id="headRow01Wrap">
...
<form id="signin_dialog_val" action="https://www.cvs.com/account/login.jsp?_DARGS=/CVSApp/account/fragments/signin-dialog.jsp" method="post" autocomplete="off"><input name="_dyncharset" value="ISO-8859-1" type="hidden"></input><input name="_dynSessConf" value="928984944814040192" type="hidden"></input><div class="signinoverlaywrapperLarge">
    <input name="/atg/userprofiling/ProfileFormHandler.loginErrorURL" value="https://www.cvs.com/account/login.jsp?screenname=/help/privacy_policy.jsp&pagevalue=head&page=loginError" type="hidden"><input name="_D:/atg/userprofiling/ProfileFormHandler.loginErrorURL" value=" " type="hidden"><input id="loginSuccInp" name="/atg/userprofiling/ProfileFormHandler.loginSuccessURL" value="http://www.cvs.com/help/privacy_policy.jsp" type="hidden"><input name="_D:/atg/userprofiling/ProfileFormHandler.loginSuccessURL" value=" " type="hidden"><h3 class="text-red s16b mt0 ht19" style="margin-bottom:0px">Sign In or Create an Account</h3>
    ...
    <div id="emailDiv"><label for="loginPopup"><b>Email Address</b></label>
    <input id="loginPopup" maxlength="46" name="/atg/userprofiling/ProfileFormHandler.value.login" value="" type="text" size="25"><input name="_D:/atg/userprofiling/ProfileFormHandler.value.login" value=" " type="hidden"></div>
    <div id="passwordDiv" class="mt25"><label for="passwordPopup"><b>Password </b></label>
    <input id="passwordPopup" maxlength="25" name="/atg/userprofiling/ProfileFormHandler.value.password" value="" type="password" autocomplete="off" size="25"><input name="_D:/atg/userprofiling/ProfileFormHandler.value.password" value=" " type="hidden"></div>
...
<div class="overlayContent">
  ...
  <form action="https://www.cvs.com/account/login.jsp?_DARGS=/CVSApp/account/fragments/common-overlays.jsp" method="post"><input name="_dyncharset" value="ISO-8859-1" type="hidden"></input><input name="_dynSessConf" value="928984944814040192" type="hidden"></input>
  ...
  <input name="/atg/userprofiling/ProfileFormHandler.rxTiedSuccessURL" value="/pharmacy/center.jsp?tab=summary" type="hidden"><input name="_D:/atg/userprofiling/ProfileFormHandler.rxTiedSuccessURL" value=" " type="hidden">
    ...
    <div class="signinoverlaywrapper">
      ...
      <div class="signinL">
        ...
        <p><label for="loginPopup"><b>Email</b><span class="mandatory">*</span></label>
        ...
        <p><label for="passwordPopup"><b>Password</b><span class="mandatory">*</span></label>
        ...
        <button type="submit" class="cvsbtn btn-red-med" id="login"
				...
				<input id="loginHandle" name="loginHandle" value="" type="hidden"><input name="_D:loginHandle" value=" " type="hidden">
      </div>
      <div class="vert-line"></div>
      <div class="createAcnt">
...
<form id="fftmOptIn" name="fftmOptIn" action="/home.jsp?_DARGS=/CVSApp/account/fragments/common-overlays.jsp.1" method="post"><input name="_dyncharset" value="ISO-8859-1" type="hidden"></input><input name="_dynSessConf" value="928984944814040192" type="hidden"></input>
...
<form id="fftmErrorOptIn" name="fftmErrorOptIn" action="/home.jsp?_DARGS=/CVSApp/account/fragments/common-overlays.jsp.2" method="post"><input name="_dyncharset" value="ISO-8859-1" type="hidden"></input><input name="_dynSessConf" value="928984944814040192" type="hidden"></input>
...
<div class="overlayContent">
<form id="pharmacyfftmOptIn" name="pharmacyfftmOptIn" action="/pharmacy/pharmacy-homepage.jsp?_DARGS=/CVSApp/account/fragments/common-overlays.jsp.3" method="post"><input name="_dyncharset" value="ISO-8859-1" type="hidden"></input><input name="_dynSessConf" value="928984944814040192" type="hidden"></input>
...
<div class="overlayContent">
<form id="pharmacyfftmErrorOptIn" name="pharmacyfftmErrorOptIn" action="/pharmacy/pharmacy-homepage.jsp?_DARGS=/CVSApp/account/fragments/common-overlays.jsp.4" method="post"><input name="_dyncharset" value="ISO-8859-1" type="hidden"></input><input name="_dynSessConf" value="928984944814040192" type="hidden"></input>
...
<div class="overlayContent">
<form id="myaccountfftmOptIn" name="myaccountfftmOptIn" action="/account/my-account.jsp?_DARGS=/CVSApp/account/fragments/common-overlays.jsp.5" method="post"><input name="_dyncharset" value="ISO-8859-1" type="hidden"></input><input name="_dynSessConf" value="928984944814040192" type="hidden"></input>
  <h3 class="text-red s16b mt0 ht19" style="margin-bottom:0px">Want to Learn More about Your New Prescriptions?</h3>
  <p class="mb70">Every time you start a new ongoing prescription, we'll send you helpful information about your medication to <span class="bold"></span>.</p>
  <button type="button" class="cvsbtn overlayBtn btn-red-med" id="successOverlay" name="successOverlay" title="Sign Up Now" onclick="this.disabled=1; this.form.submit();">
          <span class="left"></span>
...
<div class="overlayContent">
<form id="myaccountfftmErrorOptIn" name="myaccountfftmErrorOptIn" action="/account/my-account.jsp?_DARGS=/CVSApp/account/fragments/common-overlays.jsp.6" method="post"><input name="_dyncharset" value="ISO-8859-1" type="hidden"></input><input name="_dynSessConf" value="928984944814040192" type="hidden"></input>
...
<div class="overlayContent">
<form id="fftmOptOut" name="fftmOptOut" action="/home.jsp?_DARGS=/CVSApp/account/fragments/common-overlays.jsp.7" method="post"><input name="_dyncharset" value="ISO-8859-1" type="hidden"></input><input name="_dynSessConf" value="928984944814040192" type="hidden"></input>
...
<div class="overlayContent">
<form id="fftmErrorOptOut" name="fftmErrorOptOut" action="/home.jsp?_DARGS=/CVSApp/account/fragments/common-overlays.jsp.8" method="post"><input name="_dyncharset" value="ISO-8859-1" type="hidden"></input><input name="_dynSessConf" value="928984944814040192" type="hidden"></input>
  <h3 class="text-red s16b mt0 ht19" style="margin-bottom:0px">Prefer Not to Receive New Prescription Information?</h3>
...
<div class="overlayContent">
<form id="pharmacyfftmOptOut" name="pharmacyfftmOptOut" action="/pharmacy/pharmacy-homepage.jsp?_DARGS=/CVSApp/account/fragments/common-overlays.jsp.9" method="post"><input name="_dyncharset" value="ISO-8859-1" type="hidden"></input><input name="_dynSessConf" value="928984944814040192" type="hidden"></input>
  <h3 class="text-red s16b mt0 ht19" style="margin-bottom:0px">Prefer Not to Receive New Prescription Information?</h3>
  <p class="mb50">When you opt out, we'll no longer send New Prescription Information emails to <span class="bold"></span>.</p>
  <span class="mr10"><button type="submit" class="cvsbtn overlayBtn btn-red-med" id="successOverlay" name="successOverlay" title="Opt Out" data-otype="pagecontent" data-odiv="enrollSuccessOverlay" rel="#cvs-overlay" onclick="this.disabled=1; this.form.submit();">
          <span class="left"></span>
...
<div class="overlayContent">
<form id="pharmacyfftmErrorOptOut" name="pharmacyfftmErrorOptOut" action="/pharmacy/pharmacy-homepage.jsp?_DARGS=/CVSApp/account/fragments/common-overlays.jsp.10" method="post"><input name="_dyncharset" value="ISO-8859-1" type="hidden"></input><input name="_dynSessConf" value="928984944814040192" type="hidden"></input>
...
<div class="overlayContent">
<form id="myaccountfftmOptOut" name="myaccountfftmOptOut" action="/account/my-account.jsp?_DARGS=/CVSApp/account/fragments/common-overlays.jsp.11" method="post"><input name="_dyncharset" value="ISO-8859-1" type="hidden"></input><input name="_dynSessConf" value="928984944814040192" type="hidden"></input>
...
<div class="overlayContent">
<form id="myaccountfftmErrorOptOut" name="myaccountfftmErrorOptOut" action="/account/my-account.jsp?_DARGS=/CVSApp/account/fragments/common-overlays.jsp.12" method="post"><input name="_dyncharset" value="ISO-8859-1" type="hidden"></input><input name="_dynSessConf" value="928984944814040192" type="hidden"></input>
...
<div class="overlayContent">
  ...
  <form id="emailDrugInfoLogin" name="emailDrugInfoLogin" action="https://www.cvs.com/account/login.jsp?_DARGS=/CVSApp/account/fragments/common-overlays.jsp.13" method="post"><input name="_dyncharset" value="ISO-8859-1" type="hidden"></input><input name="_dynSessConf" value="928984944814040192" type="hidden"></input>
    <div class="signinoverlaywrapper mb20">
      ...
      <div class="signinL">
        ...
        <p style="margin-bottom: 5px !important;"><label for="passwordPopup"><b>Password</b> <span class="mandatory">*</span></label>
...
<div class="overlayContent">
  ...
  <form id="unenrollLogin" name="unenrollLogin" action="https://www.cvs.com/account/login.jsp?_DARGS=/CVSApp/account/fragments/common-overlays.jsp.14" method="post"><input name="_dyncharset" value="ISO-8859-1" type="hidden"></input><input name="_dynSessConf" value="928984944814040192" type="hidden"></input>
    <div class="signinoverlaywrapper mb20">
...
<div class="overlayContent">
  ...
  <form id="emailPharmacyLogin" name="emailPharmacyLogin" action="https://www.cvs.com/account/login.jsp?_DARGS=/CVSApp/account/fragments/common-overlays.jsp.15" method="post"><input name="_dyncharset" value="ISO-8859-1" type="hidden"></input><input name="_dynSessConf" value="928984944814040192" type="hidden"></input>
    <div class="signinoverlaywrapper">
...
<form id="notificationtabs" name="notificationtabs" action="https://www.cvs.com/account/login.jsp?_DARGS=/CVSApp/account/fragments/common-overlays.jsp.16" method="post"><input name="_dyncharset" value="ISO-8859-1" type="hidden"></input><input name="_dynSessConf" value="928984944814040192" type="hidden"></input>
   <div class="signinoverlaywrapper">
    ...
    <p><label for="loginPopup"><b>Email </b></label>
    ...
    <p><label for="passwordPopup"><b>Password </b></label>
...
<form action="/redirect/logout.jsp?_DARGS=/CVSApp/common/fragments/header/header.jsp" method="post"><input name="_dyncharset" value="ISO-8859-1" type="hidden"></input><input name="_dynSessConf" value="928984944814040192" type="hidden"></input><div id="headRow01" class="floatContainer">
			<div id="tabsBlock" class="floatContainer floatLeft"><a id="navTab_01" title="CVS.com" class="navTab floatLeft selected" href="http://www.cvs.com/">CVS.com</a><a href="/minuteclinic" id="navTab_03"
				class="navTab floatLeft" title="+ minute clinic">+ Minute Clinic</a>
			<a id="navTab_02" title="CVS Photo" class="navTab floatLeft" href="/account/sso/intersite-sso-service.jsp?target=photo">CVS Photo</a><a
									href="http://optical.cvs.com/default.asp?Session=Clear&relayState=homePage"
									id="navTab_04" class="navTab floatLeft" title="Optical">Optical</a>
							</div>
			<ul id="accountBlock" class="floatContainer floatRight">
				<li id="weeklyAd" class="floatRight last"><a
					href="/weeklyad/browse/browse-home.jsp#Browse"
					title="View Weekly Store Ad">myWeekly Ad</a></li>
				<li class="floatRight">
				<a title="Find CVS Store Locations" href="http://www.cvs.com/store-locator/landing">Store Locator</a><span class="link_dev">|</span></li>
				<li class="floatRight "><a mporgnav href="http://es.cvs.com/"
...
">Espa&ntilde;ol</a>
				<span class="link_dev">|</span></li>
				<li class="floatRight header_top_links_small"></li>
				<li class="floatRight header_top_links header_top_links_small">
				<span class="or">or</span>
						<a href="https://www.cvs.com/account/signup.jsp?screenname=/help/privacy_policy.jsp%26performSearch%3Dtrue&pagevalue=head">Create an Account</a><span class="link_dev">|</span>
					</li>

				<li class="floatRight header_top_links header_top_links_small">
				<a href="#" id="signInOverlay" title="opens in a new window"
							data-otype="pagecontent" data-odiv="cvsLoginOverlay"
							rel="#cvs-overlay" class="noarrow overlay mr3"> Sign In</a>

						</li>

				<li class="floatRight "><b class="header_top_links header_top_links_small mr5">Welcome
						to CVS.com!</b>
					<span class="link_dev">|</span></li>
			</ul>
			</div>
		<input name="_DARGS" value="/CVSApp/common/fragments/header/header.jsp" type="hidden"></input></form></div>
		<div id="headRow02Wrap">
		<div id="headRow02">
		<div id="navWrapper">
		<div class="opinionlab" id="opinionlab_header"></div>
		<div id="cvsLogo" class="floatLeft col col1"><a title="Go to CVS home" href="http://www.cvs.com/"><span class="icon-cvs-logo"></span>
							</a></div>
...
<!-- ITPR012105 Home/Deals Fix - Start -->
			<!-- ITPR012105 Home/Deals Fix for global header - Start -->
							<!-- Existing - Start -->
												<!-- #CR04340 - Bing hot fix project - Start -->
												<!-- Store Selected -->
														
														<div class="row1" id="glfs-dMyCVS">
															<div id="dMyCVS" class="selected">
																<div class="cvs-storepickup-icon">
																	<span class="textR bold">myCVS<sup>&reg;</sup></span> 
																	<span class="bold">Store</span>
																</div>
																<div class="cvs_store_logo_selector">
																	<p class="address">10100 SOUTH MAIN STREET,&nbsp;ARCHDALE,&nbsp;NC&nbsp;27263&nbsp;&nbsp;|&nbsp;</p>
																	<!-- <p class="address">,&nbsp;,&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;</p>-->
																	<p class="chgStore"><a href="#" title="opens in a new window" data-otype="pagecontent" data-odiv="storeOverlay" rel="#cvs-overlay" class="noarrow overlay mr3 storeSelectOverlay" data-info='{"event_name" : "BOPUS:StoreSelector:ChangeMyCVSStore", "event_category" : "BOPUS" }'>Change Store</a></p>
																	<div class="clear"></div>
																</div>
															</div>
														</div>	
													...
													<!-- #CR04340 - Bing hot fix project - End -->
												<!-- Existing - End-->
											<!-- ITPR012105 Home/Deals Fix for global header - End -->
						<!-- ITPR012105 Home/Deals Fix - End -->
		<div id="top-nav-container">
		<ul id="top-nav-tabs">
			<li id="pharmacy-top-nav-tab" class="floatLeft col col1 top-nav-tab">
 			<a id="pharmacy-flyout-tab" href="https://www.cvs.com/pharmacy/pharmacy-homepage.jsp"
				class="tab menu-phrmacy" title="Pharmacy">Pharmacy</a>
				<div id="pharmacy-flyout" class="sublevel twoCols">
			<ul class="sublevel-nav">
			<div class="menu_footer_img_pharmacy"><script type="text/javascript">
							/*  $(document).ready(function(){ */
                $('.menu_footer_img_pharmacy').load("/bizcontent/monetization/general/mjx/flydown_pharmacy.html?src=slot");
                /* }); */
							 </script>
							</div>
							<li>
																		<a data-url=/bizcontent/general/flydowns/rx/flydown_medicare.html href="/healthinsurance/medicare/allplans.html">																			
														 Accepts All Medicare Plans</a>
																 <div class="menu-data-load-cont ">	
																	</div>	</li>
																	<li>
																		<a data-url=/bizcontent/general/flydowns/rx/flydown_digital_rx.html href="/pharmacy/pharmacy-homepage.jsp">																			
														 Pharmacy</a>
																 <div class="menu-data-load-cont ">	
																	</div>	</li>
																	<li>
																		<a data-url=/bizcontent/general/flydowns/rx/flydown_refill.html href="/pharmacy/center.jsp?tab=summary">																			
														 Refill Prescriptions</a>
																 <div class="menu-data-load-cont ">	
																	</div>	</li>
																	<li>
																		<a data-url=/bizcontent/general/flydowns/rx/flydown_transfer.html href="/checkout/rx/rx_transfer_pharmacy_info.jsp">																			
														 Transfer Prescriptions</a>
																 <div class="menu-data-load-cont ">	
																	</div>	</li>
																	<li>
																		<a data-url=/bizcontent/general/flydowns/rx/flydown_new-prescriptions.html href="/checkout/rx/rx_new_prescription.jsp">																			
														 New Prescriptions</a>
																 <div class="menu-data-load-cont ">	
																	</div>	</li>
																	<li>
																		<a data-url=/bizcontent/general/flydowns/rx/flydown_viewprint.html href="/pharmacy/center.jsp?tab=order_history">																			
														 Print Prescription History</a>
																 <div class="menu-data-load-cont ">	
																	</div>	</li>
																	<li>
																		<a data-url=/bizcontent/general/flydowns/rx/flydown_family.html href="/promo/promoLandingTemplate.jsp?promoLandingId=familymanagement">																			
														 Family Rx Management</a>
																 <div class="menu-data-load-cont ">	
																	</div>	</li>
																	<li>
																		<a data-url=/bizcontent/general/flydowns/rx/flydown_drugs.html href="https://www.cvs.com/drug">																			
														 Drug Information</a>
																 <div class="menu-data-load-cont ">	
																	</div>	</li>
																	<li>
																		<a data-url=/bizcontent/general/flydowns/rx/flydown_health_info.html href="http://health.cvs.com/GetContent.aspx?token=f75979d3-9c7c-4b16-af56-3e122a3f19e3">																			
														 Health Information</a>
																 <div class="menu-data-load-cont ">	
																	</div>	</li>
																	<li>
																		<a data-url=/bizcontent/general/flydowns/rx/flydown_programs.html href="/promo/promoLandingTemplate.jsp?promoLandingId=pharmacy-services">																			
														 Programs &amp; Services</a>
																 <div class="menu-data-load-cont ">	
																	</div>	</li>
																	<div id='home_menu_deals_dynamic_Pharmacy'>
													<script type="text/javascript">
																$(document).ready(function(){
																var pos='home_menu_deals_dynamic_Pharmacy';
																
																
																$('#'+pos).load("/bizcontent/general/flydowns/rx/flydown_chapterextras.html?src=slot");
																});
														</script>
													</div>	
													</ul>
			...
			<li id="shop-top-nav-tab" class="floatLeft col col2 top-nav-tab">
			<a id="shop-flyout-tab" href="http://www.cvs.com/shop/"
				class="tab menu-shop" title="Shop">Shop</a>
				<div id="shop-flyout" class="sublevel twoCols">
			<ul class="sublevel-nav">
			
			 <div class="menu_footer_img_shop"><script type="text/javascript">
							/*  $(document).ready(function(){ */
                $('.menu_footer_img_shop').load("/bizcontent/monetization/general/mjx/flydown_shop.html?src=slot");
               /*  }); */
							 </script>
							</div>
							<li>
																		<a data-url=/bizcontent/general/flydowns/shop/flydown_shop.html href="/shop">																			
														 Shop</a>
																 <div class="menu-data-load-cont ">	
																	</div>	</li>
																	<li>
																		<a data-url=/bizcontent/general/flydowns/shop/flydown_shop_vitamins.html href="/shop/vitamins/N-3rZieZ2k">																			
														 Vitamins</a>
																 <div class="menu-data-load-cont ">	
																	</div>	</li>
																	<li>
																		<a data-url=/bizcontent/general/flydowns/shop/flydown_shop_baby.html href="/shop/baby-child/N-3rZe6tkZ2k">																			
														 Baby and Child</a>
																 <div class="menu-data-load-cont ">	
																	</div>	</li>
																	<li>
																		<a data-url=/bizcontent/general/flydowns/shop/flydown_shop_beauty.html href="/shop/beauty/N-3rZe7upZ2k">																			
														 Beauty</a>
																 <div class="menu-data-load-cont ">	
																	</div>	</li>
																	<li>
																		<a data-url=/bizcontent/general/flydowns/shop/flydown_shop_diet_nutrition.html href="/shop/diet-nutrition/N-3rZe7elZ2k">																			
														 Diet and Nutrition</a>
																 <div class="menu-data-load-cont ">	
																	</div>	</li>
																	<li>
																		<a data-url=/bizcontent/general/flydowns/shop/flydown_shop_health_medicine.html href="/shop/health-medicine/N-3rZidZ2k">																			
														 Health and Medicine</a>
																 <div class="menu-data-load-cont ">	
																	</div>	</li>
																	<li>
																		<a data-url=/bizcontent/general/flydowns/shop/flydown_shop_home_medical.html href="/shop/home-health-care/N-3rZe6z7Z2k">																			
														 Home Health Care</a>
																 <div class="menu-data-load-cont ">	
																	</div>	</li>
																	<li>
																		<a data-url=/bizcontent/general/flydowns/shop/flydown_shop_household.html href="/shop/household-grocery/N-3rZe7ejZ2k">																			
														 Household &amp; Grocery</a>
																 <div class="menu-data-load-cont ">	
																	</div>	</li>
																	<li>
																		<a data-url=/bizcontent/general/flydowns/shop/flydown_shop_personal_care.html href="/shop/personal-care/N-3rZifZ2k">																			
														 Personal Care</a>
																 <div class="menu-data-load-cont ">	
																	</div>	</li>
																	<li>
																		<a data-url=/bizcontent/general/flydowns/shop/flydown_shop_sexual_health.html href="/shop/sexual-health/N-3rZe79tZ2k">																			
														 Sexual Health</a>
																 <div class="menu-data-load-cont ">	
																	</div>	</li>
																	<li>
																		<a data-url=/bizcontent/general/flydowns/shop/flydown_shop_skincare.html href="/shop/skin-care/N-3rZe76oZ2k">																			
														 Skin Care</a>
																 <div class="menu-data-load-cont ">	
																	</div>	</li>
																	<div id='home_menu_deals_dynamic_Shop'>
													<script type="text/javascript">
																$(document).ready(function(){
																var pos='home_menu_deals_dynamic_Shop';
																
																
																$('#'+pos).load("/bizcontent/general/flydowns/shop/flydown_chapterextras_allergy.html?src=slot");
																});
														</script>
													</div>	
													</ul>
			<div class="menu-data-load-cont" id="menu-data-load-2333"></div>
			</div>
			
			</li>

                                      <li id="deals-top-nav-tab" class="floatLeft col col3 top-nav-tab">
			<a id="deals-flyout-tab" href="http://www.cvs.com/deals/deals.jsp"
				class="tab menu-deals" title="Deals"><span class="hidebehindimage">Deals</span></a>
				<div id="deals-flyout" class="sublevel twoCols">
			   <ul class="sublevel-nav">

                <div class="menu_footer_img_deals"><script type="text/javascript">
							 /* $(document).ready(function(){ */
                $('.menu_footer_img_deals').load("/bizcontent/monetization/general/mjx/flydown_deals.html?src=slot");
                /* }); */
							 </script>
							</div>
							<li>
																		<a data-url=/bizcontent/general/flydowns/deals/flydown_shop.html href="/shop">																			
														 Shop</a>
																 <div class="menu-data-load-cont ">	
																	</div>	</li>
																	<li>
																		<a data-url=/bizcontent/general/flydowns/deals/flydown_deals.html href="/deals/deals.jsp">																			
														 Deals</a>
																 <div class="menu-data-load-cont ">	
																	</div>	</li>
																	<li>
																		<a data-url=/bizcontent/general/flydowns/deals/flydown_weeklyad-general.html href="http://www.cvs.com/weeklyad/browse/browse-home.jsp#Browse">																			
														 myWeekly Ad</a>
																 <div class="menu-data-load-cont ">	
																	</div>	</li>
																	<li>
																		<a data-url=/bizcontent/general/flydowns/deals/flydown_extracare.html href="/extracare/landing.jsp">																			
														 ExtraCare</a>
																 <div class="menu-data-load-cont ">	
																	</div>	</li>
																	<li>
																		<a data-url=/bizcontent/general/flydowns/deals/flydown_shipandsave.html href="/shop/online-deals/_/N-3vZ2k?pt=SHOP&amp;searchTerm=ship-and-save">																			
														 Ship &amp; Save</a>
																 <div class="menu-data-load-cont ">	
																	</div>	</li>
																	<div id='home_menu_deals_dynamic_Deals'>
													<script type="text/javascript">
																$(document).ready(function(){
																var pos='home_menu_deals_dynamic_Deals';
																
																
																$('#'+pos).load("/bizcontent/general/flydowns/deals/flydown_leftnav.html?src=slot");
																});
														</script>
													</div>	
													</ul>
			    <div class="menu-data-load-cont" id="menu-data-load-2333"></div>
			    					...
			    					<li id="extracare-top-nav-tab" class="floatLeft col col4 top-nav-tab">
			<a id="extracare-flyout-tab" href="https://www.cvs.com/extracare/landing.jsp"
				class="tab menu-extracare" title="ExtraCare"><span
				class="hidebehindimage">ExtraCare</span></a>
				<div id="extracare-flyout" class="sublevel twoCols">
				<ul class="sublevel-nav">

                 <div class="menu_footer_img_extracare"><script type="text/javascript">
							/*  $(document).ready(function(){ */
                $('.menu_footer_img_extracare').load("/bizcontent/monetization/general/mjx/flydown_extracare.html?src=slot");
              /*   }); */
							 </script>
							</div>
							<li>
																		<a data-url=/bizcontent/general/flydowns/extracare/flydown_ec_app_only.html href="/extracare/landing.jsp">																			
														 What&#39;s New</a>
																 <div class="menu-data-load-cont ">	
																	</div>	</li>
																	<li>
																		<a data-url=/bizcontent/general/flydowns/extracare/flydown_ec_myEC.html href="/extracare/landing.jsp?t=mySavingRewards">																			
														 Savings &amp; Rewards</a>
																 <div class="menu-data-load-cont ">	
																	</div>	</li>
																	<li>
																		<a data-url=/bizcontent/general/flydowns/extracare/flydown_ec_beauty.html href="/promo/promoLandingTemplate.jsp?promoLandingId=beautyclub-member">																			
														 ExtraCare Beauty Club</a>
																 <div class="menu-data-load-cont ">	
																	</div>	</li>
																	<div id='home_menu_deals_dynamic_Extracare'>
													<script type="text/javascript">
																$(document).ready(function(){
																var pos='home_menu_deals_dynamic_Extracare';
																
																
																$('#'+pos).load("/bizcontent/general/flydowns/extracare/flydown_ec_leftnav.html?src=slot");
																});
														</script>
													</div>	
													</ul>
		   ...
		   <div class="menu-data-load-cont" id="menu-data-load-2333"></div>
			...
			<!--<link rel="stylesheet" href="/webcontent/components/SearchTypeAhead/src/app/assets/css/search.css"></link>
			<script src="/webcontent/components/SearchTypeAhead/src/app/assets/lib/angular.min.js"></script>
			<script src="/webcontent/components/SearchTypeAhead/src/app/assets/lib/angular.sanitize.js"></script>
			<script src="/webcontent/components/SearchTypeAhead/src/app/assets/lib/ui-bootstrap-tpls-0.13.1.js"></script>
			<script src="/webcontent/components/SearchTypeAhead/src/app/components/Search/app.js"></script>
			<script src="/webcontent/components/SearchTypeAhead/src/app/components/Search/searchDirective.js"></script>
			<script src="/webcontent/components/SearchTypeAhead/src/app/components/Search/searchController.js"></script>
			<script src="/webcontent/components/SearchTypeAhead/src/app/components/Search/searchFactory.js"></script>-->
			...
			<li class="floatLeft col col5 top-nav-tab"><form name="GlobalSearchForm" id="GlobalSearchForm" method="get" action='/search/N-0' >
				<input type="hidden" id="pt" name="pt" value='help' />
					...
					<div id="searchTypeahead">
								...
								<button type="submit" id="searchBoxSubmit" onclick="filterSessionAuthChar();"><img
		...
		<div id="shoppingCartContainer" class="floatLeft col col3">
						<a href="/checkout/fs/shoppingcart_items.jsp" id="miniCartButton"
								title="My Basket"></a>

							</div>


					<div class="dMyPastPurch">
					<a class="noarrow overlay mr3" rel="#cvs-overlay"
						data-odiv="cvsLoginOverlay" data-otype="pagecontent"
						title="opens in a new window" id="signInOverlayPP" href="#"><img
						src="/webcontent/images/common/reorderCheck-2x.png" width="11"
						height="11" class="iMyPastPurchIcon"> My Past Purchases</a>
				</div>
			<div class="clear"></div>
		</div>
		</div>
...
<div class="simple_overlay" id="cvs-overlay">	
	...
	<a id="overlayClose" class="close" title="Close">Close</a>		
</div>
...
<div class="disclaimer_overlay" id="disclaimer-cvs-overlay">
	...
	<a id="disclaimer-overlayClose" class="close" title="Close"></a>
</div>
...
<script type="text/javascript" src="/webcontent/js/module-header.js"></script>
	...
	<!-- 203 -->
	<!-- DISPLAY TIME- 2016-03-01 09:01:54.802 -->
	<!-- Code to display the server instance and the timestamp - END -->

	<div style="text-align: center;">
	<div style="margin: 0 auto; width: 960px;"><iframe url="#"
		id="ie_flash_shim_iframe" align="center" frameborder="0"></iframe> <iframe
		url="#" id="ie_flash_shim_iframe2" frameborder="0"></iframe></div>
	</div>
	<script type="text/javascript">
...
<p>Effective Date: January 13, 2016</p><br>
<p>This Privacy Policy describes the practices of CVS Pharmacy, Inc. (&ldquo;CVS,&rdquo; &ldquo;we&rdquo; or &ldquo;us&rdquo;) in connection with information collected through CVS.com and other websites and mobile applications operated by us and from which you are accessing this Privacy Policy (collectively, the &ldquo;Services&rdquo;). By using the Services, you agree to the terms of this Privacy Policy. If you have any questions or concerns about this Privacy Policy, or about the way your information is collected and used, please call us toll-free at (888) 607-4287.</p><br>
		<p><b>To the extent that information collected through the Services is patient information provided to obtain pharmacy services, this information is governed by the <br>
		CVS/pharmacy</b> <a href="http://www.cvshealth.com/patient-privacy" target="new" class="link_red">Notice of Privacy Practices</a><strong> and not this Privacy Policy</strong>. If you have questions about which policy applies to information you have provided, please do not hesitate to 
         <a href="/help/help_contact_us.jsp" class="link_red">Contact Us</a>,				
		or call us toll-free at (888) 607-4287</p>
		<br>
		<p>We may change this Privacy Policy. The &ldquo;Effective Date&rdquo; legend at the top of this page indicates when this Privacy Policy was last revised. Any changes will become effective when we post the revised Privacy Policy on the Services. Your use of the Services following these changes means that you accept the revised Privacy Policy. </p><br>
		<p>In some circumstances, CVS/pharmacy use of your information will also be subject to the requirements of the Health Information Portability and Accountability Act (frequently referred to as 'HIPAA'). For example, when you are submitting information for prescription refills we are subject to the requirements of HIPAA. In those circumstances, the terms of CVS/pharmacy HIPAA Notice of Privacy Practices will apply. If you have questions about which policy applies to information you have submitted, please do not hesitate to 
         <a href="/help/help_contact_us.jsp" class="link_red">Contact Us</a>,				
				or call us toll-free at (888) 607-4287. </p> <br>
  <p>Any changes in our Privacy Policy will appear on this page so that you are aware of the data we collect and how we use it. If you register and provide us with a valid email address, we will notify you by email of any significant changes to this Privacy Policy. You will be given the opportunity to opt in to any significant new uses of personal information if that information was collected prior to the change in this policy. If you do not opt in to any significant new uses of your personal information, that information will continue to be governed by the policy in effect at the time your information was collected. If you do not register, we will not have your email address and cannot provide you with any notifications of Privacy Policy changes.</p>
  <br>
		<h2 class="subhead_red_big">Who May Use the Services</h2>
		<p>The Services are not directed to users under the age of 13. We do not knowingly collect personal information online from any person we know to be under the age of 13 and instruct users under 13 not to send us any information to or through the Services.</p>
		<br>
        <p>The Services are designed for users from, and are controlled and operated by us from, the United States. By using the Services, you consent to the transfer of your information to the United States, which may have different data protection rules than those of your country.</p>
   		<br>
		<h2 class="subhead_red_big">The Personal Information We Collect</h2>
			<p>We want you to understand how personal information you provide to us is collected and used. We collect and store your personal information when you provide it to us or to our service providers, such as in the following situations:</p><br>
			<p><b>Transactions:</b> We or our service providers collect personal information from you when you enter into a transaction with us, such as when you order photos, arrange to pick up your retail order outside a CVS store, or have your order delivered to your home.</p><br>
			<p><b>Registration:</b> We collect your personal information when you register on the Services.<strong></strong></p>
                    <br>
            <p><b>Payment (Billing) Information:</b> For all orders, we ask for credit card information.</p><br>
            <p><b>Storage:</b> If you choose to create an online account, we will store billing and shipping information as a convenience to you for future purchases, and we will store information about your orders for order tracking and status retrieval purposes.</p>
            <br>
            <p><b>Contact Information:</b> CVS collects personal information from users of the Services who are interested in receiving information about our products or services, such as e-mail alerts, newsletters, and other notifications.</p><br>
            <p><b><strong>Surveys</strong>:</b> From time to time, CVS requests information from users via surveys on the Services. Participation in these surveys is voluntary, and the information collected is used in accordance with this Privacy Policy.</p><br>
  ...
  <h2 class="subhead_red_big">Use and Disclosure of Personal Information</h2>
			<p>We use your personal information to respond to your requests, such as to fulfill your order, contact you with information about your order, send you email alerts, send you newsletters, and to provide you with related customer service. We may also use your information to send marketing communications and administrative information to you, including through the use of push notifications in our apps.</p>
			<br>
            <p>We may use personal information to personalize your experience on the Services, including by presenting products and offers tailored to you, and for our business purposes, such as data analysis, audits, fraud monitoring and prevention, developing our Services and new products and services, determining the effectiveness of our promotional campaigns, and operating and expanding our business activities.</p>
			<br>
            <p>We may use and disclose your personal information to facilitate social sharing functionality that you initiate. If you choose to connect your social media account with your Services account or otherwise engage in social sharing on the Services, your personal information may be shared with your friends, contacts or others associated with your social media account, with other Services users, and with your social media account provider. By connecting your Services account and your social media account, you authorize us to share information with your social media account provider, and you understand that the use of the information we share will be governed by the social media site&rsquo;s privacy policy.</p>
			<br>
            <p>In the event that CVS or some or all of our business, assets or stock are sold or transferred (including in connection with any bankruptcy or similar proceedings) or used as security, or to the extent we engage in business negotiations with third parties, personal information may be transferred to or shared with third parties as part of any such transaction or negotiation.</p>
			<br>
            <p>To the extent permitted by applicable law, we may provide personal information to our affiliated businesses or to our business partners, who may use it to send you marketing and other communications.</p>
			<br>
            <p>We may disclose personal information to our service providers, who provide services such as website hosting, data analysis, payment processing, order fulfilment, information technology and related infrastructure provision, customer service, email delivery, auditing, and other services.</p>
			<br>
			...
			<br>
            <p>We may use and disclose information that does not personally identify you (including the information described under &ldquo;Cookies and Other Technologies,&rdquo; below) for any purpose, except to the extent limited by applicable law. If we are required to treat such information as personal information under applicable law, then we may use it for all the purposes for which we use and disclose personal information.</p>
			<br>
  ...
  <h2 class="subhead_red_big">Prescription Drug Plan Information</h2>
			<p>If you are a member of a prescription drug plan (&ldquo;Plan&rdquo;) managed by CVS/caremark and have filled prescriptions with CVS in the past, you may use cvs.com to access your Plan information instead of having to log in separately through www.caremark.com. Plan information is maintained separately by CVS/caremark on behalf of Plans for their Plan members.</p>
            <br>
              <h2 class="subhead_red_big">Links</h2>
			<p>The Services may contain links to, or otherwise make available, third-party websites, services, or other resources not operated by us or on our behalf (&ldquo;Third Party Services&rdquo;). These links are provided as a convenience only and do not constitute an affiliation with, endorsement or sponsorship of the Third Party Services. In particular, you acknowledge that photo processing and order pick-up or delivery services provided in connection with the Services are provided by, respectively, Snapfish and Curbside, or other third parties, and not by CVS. Any information you provide to such third parties is not subject to the terms of this Privacy Policy, and we are not responsible for the privacy or security of the information you provide to them or their handling of your information. We recommend that you review the privacy policy of any third party to whom you provide personal information online.</p>
            <br>
            <h2 class="subhead_red_big">Security</h2>
			<p>We seek to use reasonable physical, technical, and administrative safeguards to protect personal information within our organization. Unfortunately, no data transmission or storage system can be guaranteed to be 100% secure. If you have reason to believe that your interaction with us is no longer secure (for example, if you feel that the security of your account with us has been compromised), please immediately contact us in accordance with the &ldquo;Contact Information&rdquo; section below.</p>
            <br>
			...
			<br>
            <p>Our use of cookies also allows us to collect and retain certain information about a website user, such as the type of Web browser used by our customer. Reviewing our Web server logs and our customers' use of our site helps us to, among other purposes, statistically monitor how many people are using our site and for what purpose.</p>
			<br>
            <p>Your IP address is a number that is automatically assigned to the computer that you are using by your Internet Service Provider. An IP address may be identified and logged automatically in our server log files whenever a user accesses the Services, along with the time of the visit and the page(s) that were visited. Collecting IP addresses is standard practice and is done automatically by many websites, applications and other services. We use IP addresses for purposes such as calculating usage levels of the Services, helping diagnose server problems, and administering the Services.</p>
			<br>
            <p>We may use Adobe Flash Local Stored Objects (&ldquo;LSOs&rdquo;) and other technologies to, among other things, collect and store information about your use of the Services. If you do not want Flash LSOs stored on your computer, you can adjust the settings of your Flash player to block Flash LSO storage using the tools contained in the Website Storage Settings Panel. You can also control Flash LSOs by going to the Global Storage Settings Panel and following the instructions (which may include instructions that explain, for example, how to delete existing Flash LSOs (referred to &ldquo;information&rdquo; on the Macromedia site), how to prevent Flash LSOs from being placed on your computer without your being asked, and (for Flash Player 8 and later) how to block Flash LSOs that are not being delivered by the operator of the page you are on at the time). Please note that setting the Flash Player to restrict or limit acceptance of Flash LSOs may reduce or impede the functionality of some Flash applications.</p>
			<br>
		...
		<p>You can take yourself off our email list for promotional offers at any time by updating your Email Communications preference in your Account Profile in the <a href="/account/my-account.jsp" class="link_red">My Account</a> section or by following the instructions contained in such emails. If you opt out of receiving promotional emails from us, we may still send you important administrative messages, from which you cannot opt out.</p><br>
			...
			<p>You can request the removal or modification of the personal information you have provided to us by sending an email to the appropriate area under &ldquo;Contact Us&rdquo;. For your protection, we may only implement requests with respect to the personal information associated with the particular email address that you use to send us your request, and we may need to verify your identity and obtain information on the context in which you provided your personal information before implementing your request. We will try to accommodate your request as soon as reasonably practicable.</p><br>
        ...
        <h2 class="subhead_red_big">Your Responsibility</h2>
			...
			<p>&#8226; Authorize, monitor, and control access to and use of your CVS.com account, User ID and password.</p>
			<p>&#8226; Promptly inform us of any need to deactivate a password or an account by calling Customer Care at (888) 607-4287</p>
			<br>
				<h2 class="subhead_red_big">Contact Information</h2>
			<p>If you have any questions or concerns about this statement, or about the way your information is collected and used, please                                                                     	
			...
			<p class="space">CVS Health Corporation<br>
				1 CVS Drive<br>
...
<div class="module_box_white">
	...
	<a href="http://www.cvs.com/patientprivacy" target="new" class="text_gray_dark">Patient Privacy</a>
</div>
...
<div id="footerOuterWrap">
		<div id="footerWrapper">
			<div id="footer">
			<form action="http://www.cvs.com/email/" method="post" class="floatContainer">
					...
					<div id="socialMedia">
						...
						<ul class="floatRight">
								<li><a title="Follow us on Facebook" href="http://www.facebook.com/CVS"><span class="icon-facebook-icon"></span></a></li>
								<li><a title="Follow us on Twitter" href="http://twitter.com/CVS_Extra"><span class="icon-twitter-icon"></span></a></li>
								<li><a title="Follow us on Youtube" href="http://www.youtube.com/cvspharmacyvideos"><span class="icon-youtube-icon"></span></a></li>
								<li><a title="Follow us on your Phone" href="http://www.cvs.com/mobility"><span class="icon-cellphone-icon"></span></a></li>
						</ul>
					</div>
				</form>
...
<div id="footer-links">
	...
	<div class="footer-column">
        ...
        <a href="/checkout/rx/rx_express_refill_container.jsp">Rapid Refill</a><br><a href="/bizcontent/general/footer/pharmacy-customer-bill-of-rights-for-language-services.pdf">New York Patient Bill of Rights</a><br><br>
        <p>Questions? <br>Call 1-888-607-4287</p>
    ...
    <div class="footer-column">
        ...
        <a href=" /minuteclinic/">MinuteClinic</a><br><br>
    ...
    <div class="footer-column">
		<a href="/deals/deals.jsp" class="promoLinkred">Deals</a><br>
  		<a href="/myweeklyad">myWeekly Ad</a><br>
   		<a href="/onlinesales">Online Offers</a><br>
        <a href="http://print.coupons.com/alink.asp?go=14415oj9710">In-Store Offers</a><br><p style="line-height: 0px;">&nbsp;</p>
    ...
    <div class="footer-column">
		<a class="promoLinkred" href="/help/help_index.jsp">Help</a><br>
  		<a href="/help/help_contact_us.jsp">Contact Us</a><br>
        ...
        <a href="http://www.caremark.com">Caremark.com</a>
	</div><!-- end.footer-column -->
	...
	<a href="http://www.cvshealth.com" class="promoLinkred">Corporate Information</a><br>
  	<a href="http://www.cvshealth.com">CVSHealth.com</a><br>
        <a href="http://investors.cvshealth.com">Investors</a><br>
        ...
        <a href="http://www.cvshealth.com/patient-privacy">Patient Privacy</a><br>
        ...
        <a href="http://www.cvspharmacyacquisitions.com/">Sell Your Pharmacy</a><br>
...
<script src="/bizcontent/analytics/js/wttags.js" type="text/javascript"></script>
				...
				<div id="policy">
						...
						<a href="http://www.cvs.com/accessibility">Accessibility</a>|
						<a href="/help/privacy_policy.jsp">Privacy Policy</a>|
						<span>&copy; Copyright 1999 - 2016 CVS.com</span>
					</div>
				</div>
		            ...
		            <div id="vippsLogo" class="vcenter">
	                 <a href="http://vipps.nabp.net/verify.asp"><img src="/webcontent/images/common/vipps.jpg" alt="Visit VIPPS" />
								</a></div>
...
<script type="text/javascript">
	...
	TealiumDeferred
		._openRegistration(3000); // 3 seconds
</script>
...
<div>
		...
		<div class="storeselectoverlaywrapper">
			...
			<div class="dModalTitle">Change Your Store</div>
			
			<div class="dModalContentBox">
				<div class="dModalContentBoxTitle">Current <span class="CVS-Red">myCVS</span> Store</div>
				<div class="storedt" style="display: none;">0.5 mi</div>
				<div class="srAddress">
					10100 SOUTH MAIN STREET,ARCHDALE,NC27263</div>
			</div>
			<form action="#" name="storesearchform">
				...
				<div id="dSearchActionHdr">
					<input type="text" class="border-box" value="" id="iSearch" name="storesearch">
					<div class="storeselectorerror"></div>
					<div id="suggestStoreId"></div>
			...
			<div style="display:none;" id="dSearchResultsHdr">
				<div id="dSearchResultsHdrTxt"><span>Search Results For:</span><br></div>
				<div id="dSearchResultsStartOver"><a title="Start Over" href="#" id="aStartOver">Start Over</a></div>
				<div class="clear"></div>
			</div>
			<div class="loadingcontainer" id="dStoreResultsLoading"><img alt="Loading" src="../../../../webcontent/images/common/loading_lg.gif"></div>
			<div id="dFavStoresHdr">
				<div id="dChooseFavMsg">Or choose from one of your favorite stores:</div>
