...
<form id="signin_dialog_val" action="https://www.cvs.com/account/login.jsp?_DARGS=/CVSApp/account/fragments/signin-dialog.jsp" method="post" autocomplete="off"><input name="_dyncharset" value="ISO-8859-1" type="hidden"></input><input name="_dynSessConf" value="-1159704100672010564" type="hidden"></input><div class="signinoverlaywrapperLarge">
    <input id="loginErrorInp" name="/atg/userprofiling/ProfileFormHandler.loginErrorURL" value="https://www.cvs.com/account/login.jsp?screenname=/help/privacy_policy.jsp&pagevalue=head&page=loginError" type="hidden"><input name="_D:/atg/userprofiling/ProfileFormHandler.loginErrorURL" value=" " type="hidden"><input id="loginSuccInp" name="/atg/userprofiling/ProfileFormHandler.loginSuccessURL" value="https://www.cvs.com/help/privacy_policy.jsp" type="hidden"><input name="_D:/atg/userprofiling/ProfileFormHandler.loginSuccessURL" value=" " type="hidden"><h3 class="text-red s16b mt0 ht19" style="margin-bottom:0px">Sign In or Create an Account</h3>
    ...
    <input id="loginPopup" maxlength="46" onblur="utagCommonUtility.captureUnEncryptedEmail(this);" name="/atg/userprofiling/ProfileFormHandler.value.login" value="" onfocus="utagCommonUtility.signInFormFocus(this);" type="text" size="25"><input name="_D:/atg/userprofiling/ProfileFormHandler.value.login" value=" " type="hidden"></div>
...
<div class="overlayContent">
  ...
  <form action="https://www.cvs.com/account/login.jsp?_DARGS=/CVSApp/account/fragments/common-overlays.jsp" method="post"><input name="_dyncharset" value="ISO-8859-1" type="hidden"></input><input name="_dynSessConf" value="-1159704100672010564" type="hidden"></input>
...
<form id="fftmOptIn" name="fftmOptIn" action="/home.jsp?_DARGS=/CVSApp/account/fragments/common-overlays.jsp.1" method="post"><input name="_dyncharset" value="ISO-8859-1" type="hidden"></input><input name="_dynSessConf" value="-1159704100672010564" type="hidden"></input>
...
<form id="fftmErrorOptIn" name="fftmErrorOptIn" action="/home.jsp?_DARGS=/CVSApp/account/fragments/common-overlays.jsp.2" method="post"><input name="_dyncharset" value="ISO-8859-1" type="hidden"></input><input name="_dynSessConf" value="-1159704100672010564" type="hidden"></input>
...
<div class="overlayContent">
<form id="pharmacyfftmOptIn" name="pharmacyfftmOptIn" action="/pharmacy/pharmacy-homepage.jsp?_DARGS=/CVSApp/account/fragments/common-overlays.jsp.3" method="post"><input name="_dyncharset" value="ISO-8859-1" type="hidden"></input><input name="_dynSessConf" value="-1159704100672010564" type="hidden"></input>
...
<div class="overlayContent">
<form id="pharmacyfftmErrorOptIn" name="pharmacyfftmErrorOptIn" action="/pharmacy/pharmacy-homepage.jsp?_DARGS=/CVSApp/account/fragments/common-overlays.jsp.4" method="post"><input name="_dyncharset" value="ISO-8859-1" type="hidden"></input><input name="_dynSessConf" value="-1159704100672010564" type="hidden"></input>
...
<div class="overlayContent">
<form id="myaccountfftmOptIn" name="myaccountfftmOptIn" action="/account/my-account.jsp?_DARGS=/CVSApp/account/fragments/common-overlays.jsp.5" method="post"><input name="_dyncharset" value="ISO-8859-1" type="hidden"></input><input name="_dynSessConf" value="-1159704100672010564" type="hidden"></input>
  <h3 class="text-red s16b mt0 ht19" style="margin-bottom:0px">Want to Learn More about Your New Prescriptions?</h3>
  <p class="mb70">Every time you start a new ongoing prescription, we'll send you helpful information about your medication to <span class="bold"></span>.</p>
  <button type="button" class="cvsbtn overlayBtn btn-red-med" id="successOverlay" name="successOverlay" title="Sign Up Now" onclick="this.disabled=1; this.form.submit();">
          <span class="left"></span>
...
<div class="overlayContent">
<form id="myaccountfftmErrorOptIn" name="myaccountfftmErrorOptIn" action="/account/my-account.jsp?_DARGS=/CVSApp/account/fragments/common-overlays.jsp.6" method="post"><input name="_dyncharset" value="ISO-8859-1" type="hidden"></input><input name="_dynSessConf" value="-1159704100672010564" type="hidden"></input>
...
<div class="overlayContent">
<form id="fftmOptOut" name="fftmOptOut" action="/home.jsp?_DARGS=/CVSApp/account/fragments/common-overlays.jsp.7" method="post"><input name="_dyncharset" value="ISO-8859-1" type="hidden"></input><input name="_dynSessConf" value="-1159704100672010564" type="hidden"></input>
...
<div class="overlayContent">
<form id="fftmErrorOptOut" name="fftmErrorOptOut" action="/home.jsp?_DARGS=/CVSApp/account/fragments/common-overlays.jsp.8" method="post"><input name="_dyncharset" value="ISO-8859-1" type="hidden"></input><input name="_dynSessConf" value="-1159704100672010564" type="hidden"></input>
  <h3 class="text-red s16b mt0 ht19" style="margin-bottom:0px">Prefer Not to Receive New Prescription Information?</h3>
...
<div class="overlayContent">
<form id="pharmacyfftmOptOut" name="pharmacyfftmOptOut" action="/pharmacy/pharmacy-homepage.jsp?_DARGS=/CVSApp/account/fragments/common-overlays.jsp.9" method="post"><input name="_dyncharset" value="ISO-8859-1" type="hidden"></input><input name="_dynSessConf" value="-1159704100672010564" type="hidden"></input>
  <h3 class="text-red s16b mt0 ht19" style="margin-bottom:0px">Prefer Not to Receive New Prescription Information?</h3>
  <p class="mb50">When you opt out, we'll no longer send New Prescription Information emails to <span class="bold"></span>.</p>
  <span class="mr10"><button type="submit" class="cvsbtn overlayBtn btn-red-med" id="successOverlay" name="successOverlay" title="Opt Out" data-otype="pagecontent" data-odiv="enrollSuccessOverlay" rel="#cvs-overlay" onclick="this.disabled=1; this.form.submit();">
          <span class="left"></span>
...
<div class="overlayContent">
<form id="pharmacyfftmErrorOptOut" name="pharmacyfftmErrorOptOut" action="/pharmacy/pharmacy-homepage.jsp?_DARGS=/CVSApp/account/fragments/common-overlays.jsp.10" method="post"><input name="_dyncharset" value="ISO-8859-1" type="hidden"></input><input name="_dynSessConf" value="-1159704100672010564" type="hidden"></input>
...
<div class="overlayContent">
<form id="myaccountfftmOptOut" name="myaccountfftmOptOut" action="/account/my-account.jsp?_DARGS=/CVSApp/account/fragments/common-overlays.jsp.11" method="post"><input name="_dyncharset" value="ISO-8859-1" type="hidden"></input><input name="_dynSessConf" value="-1159704100672010564" type="hidden"></input>
...
<div class="overlayContent">
<form id="myaccountfftmErrorOptOut" name="myaccountfftmErrorOptOut" action="/account/my-account.jsp?_DARGS=/CVSApp/account/fragments/common-overlays.jsp.12" method="post"><input name="_dyncharset" value="ISO-8859-1" type="hidden"></input><input name="_dynSessConf" value="-1159704100672010564" type="hidden"></input>
...
<div class="overlayContent">
  ...
  <form id="emailDrugInfoLogin" name="emailDrugInfoLogin" action="https://www.cvs.com/account/login.jsp?_DARGS=/CVSApp/account/fragments/common-overlays.jsp.13" method="post"><input name="_dyncharset" value="ISO-8859-1" type="hidden"></input><input name="_dynSessConf" value="-1159704100672010564" type="hidden"></input>
...
<div class="overlayContent">
  ...
  <form id="unenrollLogin" name="unenrollLogin" action="https://www.cvs.com/account/login.jsp?_DARGS=/CVSApp/account/fragments/common-overlays.jsp.14" method="post"><input name="_dyncharset" value="ISO-8859-1" type="hidden"></input><input name="_dynSessConf" value="-1159704100672010564" type="hidden"></input>
    <div class="signinoverlaywrapper mb20">
...
<div class="overlayContent">
  ...
  <form id="emailPharmacyLogin" name="emailPharmacyLogin" action="https://www.cvs.com/account/login.jsp?_DARGS=/CVSApp/account/fragments/common-overlays.jsp.15" method="post"><input name="_dyncharset" value="ISO-8859-1" type="hidden"></input><input name="_dynSessConf" value="-1159704100672010564" type="hidden"></input>
    <div class="signinoverlaywrapper">
...
<form id="notificationtabs" name="notificationtabs" action="https://www.cvs.com/account/login.jsp?_DARGS=/CVSApp/account/fragments/common-overlays.jsp.16" method="post"><input name="_dyncharset" value="ISO-8859-1" type="hidden"></input><input name="_dynSessConf" value="-1159704100672010564" type="hidden"></input>
   <div class="signinoverlaywrapper">
...
<script>
		...
		<script>
			...
			<script src="/webcontent/components/geoLocFavStoreV2/prod/app/assets/js/geoLocFavStore.min.js"></script>
				...
				<form action="/redirect/logout.jsp?_DARGS=/CVSApp/common/fragments/header/header_v2.jsp" method="post"><input name="_dyncharset" value="ISO-8859-1" type="hidden"></input><input name="_dynSessConf" value="-1159704100672010564" type="hidden"></input><div class="signIn">
							...
							<li class="head-storeLocator" data-info='{"event_name" : "CVS:Desktop:Header:StoreLocator", "event_category" : "CVS Desktop Header" }'>
								<a title="Find CVS Store Locations" href="http://www.cvs.com/store-locator/landing?icid=CVSHeader:StoreLocator">Store Locator</a></li>
			...
			<div class="head-l-logoRow">
				<div class="head-container">	
					<div class="head-l-leftColumn">
						...
						<a title="Go to CVS home" class="siteLogo sprite sprite-siteLogo" href="http://www.cvs.com/?icid=CVSHeader:CVSLogo">CVS Pharmacy Home
											</a></div>
					<div class="head-l-rightColumn">
...
<script type="text/javascript" src="/webcontent/js/module-header.js"></script>
	...
	<!-- 212 -->
	<!-- DISPLAY TIME- 2018-08-01 21:47:41.3 -->
...
<p>Effective Date: April 10, 2018</p><br>
...
<script type="text/javascript">
					...
					server_timestamp : "2018:08:01-21:47:41",								
					platform : "dweb",								
					...
					UTCNO : "yR8pR4MG24E7optoV8NkqQ==",								
					unencrypted_cvs_profile_id : "12424487655",								
					language : "EN",								
					page_name : "",								
					UTECNID : "",								
