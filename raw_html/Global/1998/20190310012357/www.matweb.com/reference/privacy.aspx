...
<script src="/WebResource.axd?d=vpsFt0bxnO6pP61uNj-54u5TpD0eXUyqZrT-0ACsme_T8J68c3bfLrgR7BGfG8DTw0ZFFdaY1HY2baDI1pHMLu9t--o1&amp;t=636271527297880478" type="text/javascript"></script>
...
<table class="tabletight" style="width:100%; text-align:center;background-image: url(/images/gray.gif);">
  ...
  <tr >
    ...
    Data sheets for over <span class="greeting">130,000</span>  metals, plastics, ceramics, and composites.</span></td>
  </tr>
...
<li>To provide  third parties such as advertisers with aggregated (anonymous) information about our usership patterns. </li>
...
<p>Upon request we provide site visitors with access to unique identifier information (e.g., email address and password) that we maintain about them, transaction information (e.g., dates on which customers made purchases, amounts and types of purchases) that we maintain about them, contact information (e.g., name, address, phone number) that we maintain about them, and/or a description of information that we maintain about them.  Consumers can access this information through our user account page or by contacting us at the above address.</p>
...
<p>Upon request we offer users who are covered by the European Union's General Data Protection Regulation the opportunity to have all of their personal data removed from our system by contacting us at the above address.</p>

<p>We provide links to other Web sites from MatWeb.  These other Web sites are not subject to our Privacy Policy.</p>

<p>With respect to cookies: We use cookies to store visitors preferences, record session information, such as search terms, categories and materials viewed, and record past activity at our site in order to provide better service when visitors return to our site.  These cookies do not contain any personal information that can be read by other Web sites. Third parties may be placing and reading cookies on MatWeb's users' browsers, or using web beacons to collect information as a result of ad serving on MatWeb.</p>
...
<a href="https://twitter.com/MatWeb" class="twitter-follow-button" data-show-count="false" data-show-screen-name="false">Follow @MatWeb</a> <script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src="//platform.twitter.com/widgets.js";fjs.parentNode.insertBefore(js,fjs);}}(document,"script","twitter-wjs");</script>
        ...
        <tr>
                ...
                <td style="background-image:url(/images/gray.gif);">
                        ...
                        <br /><br />
                        The contents of this web site, the MatWeb logo, and "MatWeb" are Copyright 1996-2019
