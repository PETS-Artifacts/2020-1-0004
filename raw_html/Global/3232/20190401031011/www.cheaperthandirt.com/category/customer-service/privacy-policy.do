...
<meta name="description" content="" />
    ...
    <meta property="og:title" content="Customer ServicePrivacy Policy- - Cheaper Than Dirt" /> 
	<meta property="og:description" content="" /> 
	<meta property="og:type" content="website" />
	<meta property="og:url" content="https://www.cheaperthandirt.com/category/customer-service/privacy-policy.do" />
	<meta property="og:image" content="https://www.cheaperthandirt.com/images/cheaperthandirt/en_us/global/globalnav/logo01.png" />
		<meta property="og:site_name" content="Cheaper Than Dirt" />
	
	<meta name="twitter:card" content="summary_large_image">
	<meta name="twitter:site" content="@cheaperthandirt">
	<meta name="twitter:title" content="Customer ServicePrivacy Policy- - Cheaper Than Dirt"> 
	<meta name="twitter:description" content=""> 
	<meta name="twitter:image" content="https://www.cheaperthandirt.com/images/cheaperthandirt/en_us/global/globalnav/logo01.png" />
    ...
    <link rel='stylesheet' type='text/css' href='/wro/4f7491d54971cbd8a49126502ffdd415/HEAD-CATEGORY-cheaperthandirt.css?minimize=true'><link rel='stylesheet' type='text/css' href='/wro/31bede808314995319551d9999308c85/SITE-cheaperthandirt.css?minimize=true'><link rel='stylesheet' type='text/css' href='/text/content/global/overrides.css'><script src='/wro/7dcd30b529fcafdab40f55072aabc6b/HEAD.js?minimize=true'></script>
...
</script><script type='text/javascript' src='//3237090-prod.rfksrv.com/rfk/js/11243-3237090/init.js'></script><script type="application/ld+json">
{
	"@context" : "http://schema.org",
    "@type" : "Corporation",
    "name":"Cheaper Than Dirt",
    "url" : "https://www.cheaperthandirt.com/category/customer-service/privacy-policy.do",
    "contactPoint" : [{
      "@type" : "ContactPoint",
      "telephone" : "+1-800-421-8047",
      "email": "help@CheaperThanDirt.com",
      "contactType" : "customer service"
    }],
    "logo" : "https://www.cheaperthandirt.com/images/cheaperthandirt/en_us/global/globalnav/logo01.png",
    "sameAs" : [
      "https://www.facebook.com/cheaperthandirt", "https://twitter.com/CheaperThanDirt", "https://www.pinterest.com/cheaperthandirt/", "https://www.youtube.com/user/CheaperThanDirtVideo"
 ]	
},
</script><link href='//fonts.googleapis.com/css?family=Raleway:700,800,900' rel='stylesheet' type='text/css'>
...
<!-- Google Conversion Tracking Head -->
<!-- Global site tag (gtag.js) - Google Ads: 1036305056 -->
<script async src="https://www.googletagmanager.com/gtag/js?id=AW-1036305056"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'AW-1036305056');
</script><!-- SP-2016-23936 - Add Emarsys Pixel to every page -->
<script type="text/javascript">
...
<div id="mlLiteLoginApp">
    ...
    <span data-ml-rk="lbl.basket.liteRegistration.guest">Create An Account</span>
...
<div class="ml-lite-registration-wrapper">
    <div class="toggle-options">
        ...
        <a href="javascript:void(0);" class="toggle-option" data-ng-show="model.show.newShopper" tabindex="0" onclick="MarketLive.LiteRegistration.showHideSection('guest');">
            <span id="guest" class="toggle-button">Create An Account</span>
            <div class="arrow-wrapper"><div class="arrow"></div></div>
        </a>
...
<div id="guestSection" class="sub-section-wrapper">
            <script type='text/javascript'>
                ...
                <div class="section-description">Create an account for faster checkout, easy access to order history, and to earn reward points for every dollar you spend! Use a valid email address to register.</div>
...
<script type="text/javascript">
	function cloudannex_liteRegistration_createAccount(user_email, first_name, last_name) {
		var siteId = '9411111';
		var accessToken = '59ToJtxPB68NsV0neDFT';
		var customerEmail= '';
		var customerName= '';
		var customerLastName= '';
		user_email = user_email === undefined || user_email == null ? customerEmail : user_email;
		first_name = first_name === undefined || first_name == null ? customerName: first_name;
		last_name = last_name === undefined || last_name == null ? customerLastName: last_name;
		...
		xmlhttp.send("user_email=" + user_email + "&first_name=" + first_name
				+ "&last_name=" + last_name + "&actionid=" + actionId
				+ "&siteid=" + siteId + "&token=" + accessToken);
	}
	
</script>
<script type="text/javascript">
	function cloudannex_accountSetup_visitSite(user_email, first_name, last_name) {
		var siteId = '9411111';
		var accessToken = '59ToJtxPB68NsV0neDFT';
		var customerEmail= '';
		var customerName= '';
...
<div id="globalHeaderInclude" class="ml-global-include ml-global-include-header collapse">
  ...
  -->
        Share your latest AR build or photos from the range with #RangeDayFriday for a chance to win a new firearm! <a href="/category/contest.do" title="#RangeDayFriday Contest from Cheaper Than Dirt">Get the details.</a>
</div>
            </div>
        </div>
    </div>
            ...
            <div class="ml-header-content-wrapper">
                <div class="ml-header-content">
                    ...
                    <div class="ml-ctd-custom-header hidden-xs">
                        <div class="ml-ctd-header-tagline hidden-sm hidden-md">
                            America's Ultimate Shooting Sports Discounter</div>
                        <div class="ml-ctd-custom-navigation">
                            <ul class="nav nav-pills">
                            	<li><a href="/category/sale-items.do?sku_instock_b=true">Shop Clearance</a></li>
                                ...
                                <li><a href="/category/all-brands.do">Shop Brands</a></li>
                                </ul>
                        </div>
                        </div>
                    ...
                    <div class="ml-ctd-custom-header hidden-sm hidden-md hidden-lg">
                        <div class="ml-ctd-custom-navigation">
                            <ul class="nav nav-pills">
                            	<li><a href="/category/sale-items.do?sku_instock_b=true">Shop Clearance</a></li>
        						<li><a href="/category/new-items.do?c=509903&sku_instock_b=true&pp=30&sortby=ourPicksAscend&cx=0">Shop New Arrivals</a></li>
...
</div><div class="ctd-customtag-header-include"><div class="hidden-sm" style="line-height:30px;background-color:#c62128;width:100%;color:#fff;text-align:center">Welcome to Cheaper Than Dirt! Free Shipping on All $99+ Orders. <a href="/category/current+promotions.do">No clubs or codes required.</a></div>
</div>
...
<!-- SP-2016-23936 - Add Emarsys Pixel to every page -->
	<script type="text/javascript">
		 ScarabQueue.push(['category', 'Home >Customer Service >Privacy Policy']);
	</script>
<!-- SP-2016-23936 -->
</div>
...
<!--<div class="commonHeader group"><h1>Privacy Policy</h1></div> -->
	...
	<div class="homeFill">
		<p>Your privacy is paramount to us at CTD, Inc. (&ldquo;Cheaper Than Dirt&rdquo;). We are committed to protecting your personal information. This Privacy Policy will explain what information we collect and how it is used. </p>
      <p>Throughout this Privacy Policy we&rsquo;ll refer to our websites and other products and services collectively as &ldquo;Services.&rdquo;</p>
		...
		<p>The information we collect from you is used to improve services, performance, enhance your shopping experience, and communicate with you. </p>
        <p>We strive to make it easy for you to update your account, remove addresses and credit cards, and unsubscribe from communications at any point.  </p>
      <p>We collect information in three ways: if and when you provide information to us, automatically through use of our Services, and from outside sources. </p>
<p><strong>Information You Provide to Us</strong>
<p>It&rsquo;s likely not a surprise we collect information that you provide to us. The amount and type of information depends on the context and how we use the information. Here are some examples:</p>
<ul>
  <li><strong>Basic Account Information:&nbsp;</strong>We ask for basic information from you in order to set up your account. For example, we require individuals who sign up for a CheaperThanDirt.com account to provide a valid email address–and that&rsquo;s it. You may provide us with more information–like your name, address, social media profiles–but we don&rsquo;t require that information to create your account.<br>
    <br>
  </li>
  <li><strong>Transaction and Billing Information:</strong>&nbsp;If you buy something from us you will provide additional personal and payment information that is required to process the transaction and your payment, such as your name, credit card information, contact information and, potentially, your preferred local FFL dealer.<br>
    <br>
  </li>
  <li><strong>Communications with Us: </strong>You may also provide us information when you respond to surveys, communicate with our team via email, phone, or live chat, post a question to us via social media, leave a review, or post a question and/or answer on a product page. </li>
</ul>
<p><strong>Information We Collect Automatically</strong></p>
<p>We also collect some information automatically:</p><ul>
  <li><strong>Log Information:&nbsp;</strong>Like most websites, we collect information that web browsers, mobile devices, and servers typically make available, such as the browser type, IP address, unique device identifiers, language preference, referring site, the date and time of access, operating system, and mobile network information. We collect log information when you use our Services–for example, when you visit or make a purchase on our website.<br>
    <br>
  </li>
  <li><strong>Usage Information:</strong>&nbsp;We collect information about what happens when you use our Services (e.g., page views, orders, referrals, button clicks) along with information about your device (e.g., mobile screen size, name of cellular network, and mobile device manufacturer). We use this information to, for example, provide our Services to you, as well as get insights on how people use our Services, so we can make our Services better.<br>
    <br>
  </li>
  <li><strong>Location Information:&nbsp;</strong>We may determine the approximate location of your device from your IP address. We collect and use this information to, for example, calculate how many people visit our Services from certain geographic regions. <br>
    <br>
  </li>
  <li><strong>Information from Cookies &amp; Other Technologies:&nbsp;</strong>A cookie is a string of information that a website stores on a visitor&rsquo;s computer, and that the visitor&rsquo;s browser provides to the website each time the visitor returns. Pixel tags (also called web beacons) are small blocks of code placed on websites and e-mails. Cheaper Than Dirt uses cookies and other technologies like pixel tags to help us identify and track visitors, usage, and access preferences for our Services, as well as track and understand e-mail campaign effectiveness and to deliver targeted ads.</li>
</ul>
<p><strong>Information We Collect from Other Sources</strong></p>
		<p>We may also get information about you from other sources. For example, if you create or log into your CheaperThanDirt.com account through another service (like Google or Facebook) or if you connect your website or account to a social media service (like Instagram) through our <a href="/?ca=landing" title="Cheaper Than Dirt Loyalty Rewards Program">loyalty program</a>, we will receive information from that service (such as your username and basic profile information) via the authorization procedures used by that service. The information we receive depends on which services you authorize and any options that are available.</p>
<p>We may also get information from third party services about individuals who are not yet our customers, which we may use, for example, for marketing and advertising purposes.</p>
		<h3><strong>How We Use Information</strong></h3>
		<p>We use information about you as mentioned above and as follows:</p>
        <ul>
          <li>To provide our Services–for example, to process your order and ship items to you, to award you points for loyalty or referral actions;<br>
            <br>
          </li>
          <li>To further develop our Services–for example by adding new features that we think our customers will enjoy or will help them to find products they want more efficiently or make purchasing those items quicker and easier;<br>
            <br>
          </li>
          <li>To monitor and analyze trends and better understand how users interact with our Services, which helps us improve our Services and make them easier to use;<br>
            <br>
          </li>
          <li>To monitor and protect the security of our Services, detect and prevent fraudulent transactions and other illegal activities, fight spam, and protect the rights and property of Cheaper Than Dirt and others;<br>
            <br>
          </li>
          <li>To communicate with you about offers and promotions offered by Cheaper Than Dirt, solicit your feedback, or keep you up to date on new products; and<br>
            <br>
          </li>
          <li>To personalize your experience using our Services, provide product recommendations and serve relevant advertisements.</li>
        </ul>
      ...
      <ul>
        <li><strong>Subsidiaries, Employees, and Independent Contractors</strong><strong>:</strong>&nbsp;We may disclose information about you to our subsidiaries, our employees, and individuals who are our independent contractors that need to know the information in order to help us provide our Services or to process the information on our behalf. We require our subsidiaries, employees, and independent contractors to follow this Privacy Policy for personal information that we share with them.<br>
          <br>
        </li>
        <li><strong>Third Party Vendor</strong><strong>s:</strong>&nbsp;We may share information about you with third party vendors who need to know information about you in order to provide their services to us. This group includes vendors that help us provide our Services to you (like payment providers that process your credit and debit card information) and those that help us understand and enhance our Services (like analytics providers). We require vendors to agree to privacy commitments in order to share information with them.<br>
          <br>
        </li>
        <li><strong>As Required by Law:&nbsp;</strong>We may disclose information about you in response to a subpoena, court order, or other governmental request.<br>
          <br>
        </li>
        <li><strong>To Protect Rights and Property:&nbsp;</strong>We may disclose information about you when we believe in good faith that disclosure is reasonably necessary to protect the property or rights of Cheaper Than Dirt, third parties, or the public at large. <br>
          <br>
        </li>
        <li><strong>Business Transfer</strong><strong>s:</strong>&nbsp;In connection with any merger, sale of company assets, or acquisition of all or a portion of our business by another company, or in the unlikely event that Cheaper Than Dirt goes out of business or enters bankruptcy, user information would likely be one of the assets that is transferred or acquired by a third party. If any of these events were to happen, this Privacy Policy would continue to apply to your information and the party receiving your information may continue to use your information, but only consistent with this Privacy Policy.<br>
          <br>
        </li>
        <li><strong>With Your Consent:</strong>&nbsp;We may share and disclose information with your consent or at your direction. For example, we may share your information with third parties with which you authorize us to do so, such as the social media services that you share to via our referral and Tell a Friend features.<br>
          <br>
        </li>
      ...
      <p><strong>Information Shared Publicly</strong></p>
      <p>Information that you choose to make public is, not surprisingly, disclosed publicly. That means that information like your product reviews, product questions and answers, and photo contest entries submitted via social media platforms. Public information may also be indexed by search engines. Please keep all of this in mind when deciding what you would like to share.</p>
	  <h3><strong>Privacy Choices</strong></h3>
	  <p>You have several choices available when it comes to information about you:</p>
      <ul>
        <li><strong>Limit the Information that You Provide:</strong>&nbsp;If you have an account with us, you can choose not to provide the optional account information, profile information, and transaction and billing information. Please keep in mind that if you do not provide this information, certain features of our Services–including the ability to purchase online–may not be accessible.<br>
          <br>
        </li>
        <li><strong>Limit Access to Information On Your Mobile Device:</strong>&nbsp;Your&nbsp;mobile device operating system should provide you with the ability to discontinue our ability to collect location information. If you do so, you may not be able to use certain features.<br>
          <br>
        </li>
        <li><strong>Opt-Out of Electronic Communications:</strong>&nbsp;You may opt out of receiving promotional messages from us. Just follow the instructions in those messages. If you opt out of promotional messages, we may still send you other messages, like those about your account, order status and legal notices.<br>
          <br>
        </li>
        <li><strong>Set Your Browser to Reject Cookies:</strong>&nbsp;You can choose to set your browser to remove or reject browser cookies with the drawback that certain features of Cheaper Than Dirt&rsquo;s websites may not function properly without the aid of cookies.</li>
      </ul>
	  <h3><strong>A Few More Things</strong></h3>
      <p><strong>Transferring Information</strong></p>
      <p>Cheaper Than Dirt leverages global resources. By accessing or using the Services or otherwise providing information to us, you consent to the processing, transfer, and storage of information in and to the U.S. and other countries, which may have rights and protections that are different from those in your home country.</p>
      <p><strong>Privacy Policy Changes</strong></p>
      <p>Although most changes are likely to be minor, Cheaper Than Dirt may change its Privacy Policy from time to time. Cheaper Than Dirt encourages visitors to frequently check this page for any changes to its Privacy Policy. Your continued use of the Services after any change in this Privacy Policy will constitute your consent to such change.</p>
	  <p>If you have questions regarding this Privacy Policy or wish to have your information removed from some or all of our databases, please <a href="/category/customer-service/contact-us.do" title="Contact Cheaper Than Dirt">contact us</a>. </p>
      <p align="center">Cheaper Than Dirt<br>
        2524 NE Loop 820<br>
      Fort Worth, TX 76106</p>
      <p>&nbsp;</p>
      <p>&nbsp;</p>
      <p><em>Policy Last Updated: April 2018</em></p>
  </div></div>
	</div>
</div>
	    ...
	    <div class="ml-navleft-body-wrapper">
	        <div class="col-sm-12 col-md-12"><ul class="ml-leftNav-category-wrapper">
              ...
              <li class="ml-navleft-topCats-active">
                    <a data-category-type="$singleCatType" href="/category/customer-service.do"><h2> Customer Service </h2></a>
                    ...
                    <li class="ml-navleft-cats-inactive">
                        <a data-category-type="$singleCatType" href="/category/customer-service/contact-us.do">Contact Us</a>
                </li>
                    ...
                    <li class="ml-navleft-cats-inactive">
                        <a data-category-type="$singleCatType" href="/category/customer-service/faqs.do">FAQs</a>
                </li>
                    ...
                    <li class="ml-navleft-cats-inactive">
                        <a data-category-type="$singleCatType" href="/category/customer-service/our-story.do">Our Story</a>
                </li>
                    ...
                    <li class="ml-navleft-cats-inactive">
                        <a data-category-type="$singleCatType" href="/category/customer-service/our-guarantee.do">Our Guarantee</a>
                </li>
                    ...
                    <li class="ml-navleft-cats-inactive">
                        <a data-category-type="$singleCatType" href="/category/customer-service/shipping-info.do">Shipping Info</a>
                </li>
                    ...
                    <li class="ml-navleft-cats-inactive">
                        <a data-category-type="$singleCatType" href="/category/customer-service/return-policy.do">Return Policy</a>
                </li>
              ...
              <li class="ml-navleft-cats-active">
                    <a data-category-type="$singleCatType" href="/category/customer-service/privacy-policy.do">Privacy Policy</a>
                    ...
                    <li class="ml-navleft-cats-inactive">
                        <a data-category-type="$singleCatType" href="/category/customer-service/terms-of-use.do">Terms of Use</a>
                </li>
                    ...
                    <li class="ml-navleft-cats-inactive">
                        <a data-category-type="$singleCatType" href="/category/customer-service/careers.do">Careers</a>
                </li>
...
.ml-footer-global-container .ml-global-include .ml-custom-include-content div{
	font-size: 24px;
	text-transform: uppercase;
...
<img src="/images/cheaperthandirt/en_us/global/globalgraphics/guarantee.png">
</div>
...
<div class="container">
	  ...
	  <div class="ml-footer-links-wrapper">
		  <div class="ml-footer-mini-wrapper">
			  <div class="ml-footer-mini">
                  <div class="ml-footer-phone-number"><a href="tel:1-800-421-8047">Call Us! 1-800-421-8047</a></div>
			  </div>
		  </div>
				   ...
				   <div id="footerColumn-2" class="ml-footer-links-section ml-footer-mini-on">
					<div class="contentSectionContainer">
					   	...
					   	<div id="footerItem-2-1" class="footerItem ">
									...
									<div id="footerItem-2-9" class="footerItem ">
											<a href="#" onClick="window.open('https://www.cheaperthandirt.com/text/pdf/firearmsale.pdf');;return false;">Firearm Sales Form</a>
												</div>
									<div id="footerItem-2-10" class="footerItem ">
											<a href="/category/knowledge/how+to+buy+a+gun+online.do">How to Buy a Gun Online</a>
												</div>
									</div>
				   <div id="footerColumn-3" class="ml-footer-links-section ml-footer-mini-on">
					<div class="contentSectionContainer">
					   	...
					   	<div id="footerItem-3-1" class="footerItem ">
									...
									<div id="footerItem-3-12" class="footerItem ">
											<a href="/home.do?ca=landing">Rewards Program</a>
												</div>
									</div>
				   <div id="footerColumn-4" class="ml-footer-links-section ml-footer-mini-on">
					<div class="contentSectionContainer">
					   	...
					   	<div id="footerItem-4-1" class="footerItem dtOnly">
									...
									<div id="footerItem-4-8" class="footerItem ">
											<a href="/category/current+promotions.do">Current Promotions</a>
												</div>
									</div>
				   </div>
	  </div>
  ...
  <div class="ml-footer-bottom">
	  <div class="ml-footer-copyright">
		...
		<span>&copy; 2018 Copyright, entire contents by CTD, Inc.<br> Cheaper Than Dirt! and the Cheaper Than Dirt symbol are registered trademarks of Direct Investments, Ltd.<br> All Rights Reserved</span><br>2019 &nbsp;Cheaper Than Dirt</div>
	  <div class="ml-footer-security">
		  <div class="ml-footer-security-block"><div class="ml-footer-security-1"><table width="135" border="0" cellpadding="2" cellspacing="0" title="Click to Verify - This site chose Symantec SSL for secure e-commerce and confidential communications."><tr><td width="135" align="center" valign="top"><script type="text/javascript" src="https://seal.websecurity.norton.com/getseal?host_name=www.cheaperthandirt.com&amp;size=L&amp;use_flash=NO&amp;use_transparent=No&amp;lang=en"></script><br /><a href="https://www.websecurity.symantec.com/ssl-certificate" target="_blank"  style="color:#000000; text-decoration:none; font:bold 10px verdana,sans-serif; letter-spacing:.5px;text-align:center; margin:0px; padding:0px;"> ABOUT SSL CERTIFICATES</a></td></tr></table></div><div class="ml-footer-security-2"></div></div>
		  </div>
  </div>
...
<script type='text/javascript' src='/wro/85ba2ff326680989f54dd669afd9fec/FOOTER.js?minimize=true'></script><script type='text/javascript' src='/wro/8f6f16d9a1624e63b82981a4df96e67a/P2P.js?minimize=true'></script><link rel='stylesheet' type='text/css' href='/wro/e39b8a7312910b246ac29a192b427ed/P2P.css?minimize=true'><script type='text/javascript'>
    $('body').focusfinder();
        ...
        MarketLive.SocialLogin.socialAnnexLogin = new MarketLive.SocialLogin.SocialAnnexLogin(
            {
                'siteId':               '9411111',
                'format':               '',
                'signatures':           ['{"key":"::9411111:8886726716058305309:1554088211225","token":"y2WtxDs9B8jXoENg5rW00gwoJ5UsLZHiGszAQdnHCmo%3D"}', '{"key":"::9411111:7961149620619410197:1554088211225","token":"%2F0cHGV7g8yXYFllAFsh2RS5c35YTrAEeflKAdWkvN68%3D"}', '{"key":"::9411111:5770300737249091594:1554088211225","token":"MJxtViOv3IHWLyjLkFatvB4iI2eaShLiVVFaf8kInb0%3D"}'],
...
$('#accountSetupForm').on('submit', function () {
    fbq('track', 'CompleteRegistration');
    cloudannex_liteRegistration_createAccount($('#accountSetupForm #newCustomerEmail').val());
    cloudannex_accountSetup_visitSite($('#accountSetupForm #newCustomerEmail').val());
    //return false;
});
</script><script>
...
<script type="text/javascript">window.NREUM||(NREUM={});NREUM.info={"errorBeacon":"bam.nr-data.net","licenseKey":"85a7277884","agent":"","beacon":"bam.nr-data.net","applicationTime":23,"applicationID":"26499519","transactionName":"b11UZkoDW0ZZVkNeDlYXZUJKC1tSe1pZQxNXVFpXSk12YXx2VkMEX1dES3sNW0FKWltbBEoXU0pdAUBBXQ==","queueTime":0}</script></body>
