...
<title>Dans Tools - About the site.</title>
  ...
  <script> 
    ...
    var adUnits = [{
      ...
      sizes: [[970,90],[728, 90], [ 320,50 ], [ 468,60 ]],
      bids: [{
            bidder: 'conversant',
            params: {
                site_id: '',
...
<script>
      window.onload = function() {
        setTimeout(function() {
          ...
          var promos = document.querySelectorAll(".tktdw");
...
<div class="tktdw2" style="background-color:#FCFCFC;width: 728px;height:90px;padding:10px;border:1px solid #cccccc;text-align:left;">\
<h4 style="margin-top:0px;margin-bottom:2px">\
<i class="fa fa-envelope"></i> <a href="http://www.danstools.com/email-validator">Try the Email Validation Tool</a></h4>\
Verify whether an email address is valid and exists before sending an email.  API available.\
</div>\
</center>';
...
<i class="fa fa-envelope glyphicon glyphicon-envelope"></i> <a href="http://www.danstools.com/email-validator">Try the Email Validation Tool</a></h5>\
Verify whether an email address is valid and exists before sending an email.  API available.\
</div>\
</center>';
		    var promotwo = document.querySelector(".tktdw2");
