...
<script>
      window.onload = function() {
        setTimeout(function() {
          ...
          var promos = document.querySelectorAll(".bttxqn");
...
<div class="bttxqn2" style="background-color:#FCFCFC;width: 728px;height:90px;padding:10px;border:1px solid #cccccc;text-align:left;">\
...
Get competitive SEO intelligence, backlinks, rankings, keyword research, with SEMrush.\
		    ...
		    var promotwo = document.querySelector(".bttxqn2");
