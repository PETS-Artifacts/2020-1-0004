<!DOCTYPE html> <html lang="en"> <!-- --> <head> <title>Privacy Policy</title> <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" /> <link rel="stylesheet" href="/style/default.css" type="text/css" />
...
<!--
	...
	document.CS_StaticURL = "https://www.eeoc.gov/";
	document.CS_DynamicURL = "https://www1.eeoc.gov/";
// -->
</script>
...
<script id="_fed_an_ua_tag" language="javascript" src="https://dap.digitalgov.gov/Universal-Federated-Analytics-Min.js?agency=EEOC&pua=ua-33523145-2"></script>
<link rel="stylesheet" href="/commonspot/commonspot.css" type="text/css" id="cs_maincss" /> </head><body lang="en" class="CS_Document"><a name="__topdoc__"></a><script src="/commonspot/pagemode/always-include-common.js" type="text/javascript"></script><script type="text/javascript">
<!--
...
// -->
		</script><div id="cs_control_1369" class="cs_control CS_Element_DHTML_Menu"></div>
 ...
 <div id="view">
  ...
  <img src="/graphics/seal.png" height="90" width="90" alt="EEOC Seal" id="seal">
...
<p id="eeoc"><a href="/index.cfm">U.S. Equal Employment<br>Opportunity Commission</a></p>
    ...
    <a href="https://www1.eeoc.gov/eeoc/newsroom/index.cfm?xml=eeoc_press,RSS2.0full"><img src="/graphics/rss_32x32x32.png" alt="RSS News Feed" title="RSS" border="0" height="24" style="position: relative; top: 12px;"></a> 
    <a href="http://www.twitter.com/useeoc/"><img src="/graphics/twitter_32x32x32.png" alt="Twitter" title="Twitter" border="0" height="24" style="position: relative; top: 12px;"></a> 
...
<ul class="dropdown">
	...
	<li><a href="/eeoc/">About EEOC</a>
	  <ul class="drop">
		...
		<li><a href="/eeoc/commission.cfm">The Commission &amp; the General Counsel</a></li>
	  ...
	  <li><a href="/eeoc/foia/index.cfm">FOIA</a></li>
    <li><a href="/eeoc/privacy/index.cfm">Privacy</a></li>
    ...
    <li><a href="/employers/index.cfm">Employers / Small Business</a>
	  <ul class="drop">
		<li><a href="/employers/index.cfm" class="first">Overview</a></li>
    <li><a href="/employers/smallbusiness/index.cfm">Small Business Resource Center</a>
      <ul>
        <li><a href="/employers/smallbusiness/requirements.cfm">Small Business Requirements</a></li>
        <li><a href="/employers/smallbusiness/faq/index.cfm">Frequently Asked Questions</a></li>
        <li><a href="/employers/smallbusiness/tips.cfm">Tips for Small Businesses</a></li>
        <li><a href="/employers/smallbusiness/checklists/index.cfm">Making an Employment Decision?</span></a></li>
        <li><a href="/employers/smallbusiness/resources.cfm">EEOC Resources</a></li>
        <li><a href="/employers/smallbusiness/assistance.cfm">Small Business Assistance</a></li>
        <li><a href="/employers/smallbusiness/factsheets.cfm">Small Business Fact Sheet</a></li>
        <li><a href="/employers/smallbusiness/videos.cfm">Small Business Videos</a></li>
        <li><a href="/employers/smallbusiness/glossary.cfm">EEOC Glossary</a></li>
        <li><a href="/employers/smallbusiness/contact.cfm">Contact Us</a></li>
      </ul>
    </li>
...
<!-- sitecues badge -->
  ...
  &nbsp; <a href="mailto:?Subject=Link from U.S. Equal Employment Opportunity Commission website&Body=Here's a link to a page on the U.S. Equal Employment Opportunity Commission website that you might be interested in...%0a%0ahttps://www.eeoc.gov/Root Site/privacy.cfm"><img src="/graphics/mail.png" alt="Email" title="Email this page"></a>&nbsp;
...
<p>Please see our <a class="CP___PAGEID_189152" href="https://www.eeoc.gov/social_media_policies.cfm">comments policy and privacy notice</a> for Facebook, Twitter, YouTube and other social media.<br>
</p>
