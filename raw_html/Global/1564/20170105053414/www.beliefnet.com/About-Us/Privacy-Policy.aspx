...
<title>Privacy Policy - Beliefnet</title>
    ...
    <meta http-equiv="last-modified" content="2016-09-07@00:00:00 Z" />
...
<meta property="fb:app_id" content="478918965481542" />
    ...
    <script type="text/javascript" src="/bundles/modernizr.js?v=II0rlld__rXZIft54iibWcIFM7sUV01aUAVwGfSxwW41" async></script>

    <link href="/styles/beliefnet-styles.css?v=N4bEmek_-3trPeIZ-PwkiKaK53FtutkenS5vIYYquvc1" rel="stylesheet"/>
    ...
    <script type="text/javascript" src="http://a.postrelease.com/serve/load.js?async=true" async></script>
    <!-- End Nativo Native Ads -->

        <script type="text/javascript">
            function bnetFireEvent(eventName) {
            ...
            function BnetIncludeScript(source, id, callback) {
            ...
            // Get URL Parameter
            function bnetGetParameter(url, name) {
        ...
        <script type="text/javascript">
            BnetIncludeScript("/bundles/beliefnet-highpriority.js?v=0kxMV4oRBW8Rt4xcaAcyJ0cQQdHxjjIMcERtrGA7I0o1", "bnet-high-priority", function () {
                BnetIncludeScript("/bundles/beliefnet-jquery.js?v=RFsfEcoXSLEVcVn5XbWrji4xD17RgsYUinJedWpZ2vk1", "bnet-jquery", function () {
                    BnetIncludeScript("/bundles/beliefnet-scripts.js?v=gk8-G0t9eKySA9849nW-EkQYLoToJdGub52CDJUf1bQ1", "bnet-scripts", function () {
                        console.log("Firing Event : Scripts Loaded")
                        bnetFireEvent("Beliefnet:ScriptsLoaded");
                    });
                });
            });
        </script>
...
<li class="score-menu-list-item" data-ux-args="{&quot;ClickMessagesTransmitting&quot;:[]}" data-ux-module="score_bootstrap/Components/MenuListItem" data-ux-state="pending"><a href="http://www.beliefnet.com/wellness/health/movemberit.aspx">MovemberIt</a></li>
    </ul>
</li>
...
<li class="score-menu-list-item" data-ux-args="{&quot;ClickMessagesTransmitting&quot;:[]}" data-ux-module="score_bootstrap/Components/MenuListItem" data-ux-state="pending"><a href="http://www.beliefnet.com/love-family/recipes.aspx">Recipes</a></li>
...
<li class="score-menu-list-item" data-ux-args="{&quot;ClickMessagesTransmitting&quot;:[]}" data-ux-module="score_bootstrap/Components/MenuListItem" data-ux-state="pending"><a href="http://www.beliefnet.com/video.aspx">Videos</a></li>
    ...
    <div id="jump-to" class="collapse">
        ...
        <div class="text-center score-component score-center-text social-wrapper">
            <div class="pw pw-widget ra1-pw-classicWidget ra1-pw_size_large pw-layout-horizontal ra1-pw-classicWidget ra1-pw-size-large horizontal" pw:url="http://www.beliefnet.com/about-us/privacy-policy.aspx">
    ...
    <div class="score-column1 ">
        ...
        <div class="score-component ad ad-container ad-decoration  visible-xs-block">
            <div id="div-gpt-ad-208209602-1" class="DFPAdSlot ad-notice "></div>
        </div>
...
<aside class="section-tag document-header decoration">
    ...
    <div itemscope itemtype="http://schema.org/WebPage" class="pageWrappe page-wrapperr">
        <div class="container">
    <div class="score-column1 ">
        <div class="score-center">
...
<p style="margin: 12pt 0in; line-height: 16.5pt; background: white;">(b). <span style="text-decoration: underline;">Newsletters; Email Alerts</span>: During the subscription process you will be required to provide subscriber data, which may include PII such as your full name and e-mail address (such information is the “Subscriber PII”) and zip code (such information is the “Subscriber Non-PII,” collectively with Subscriber PII the “Subscriber Data”). If you would like to unsubscribe from any Beliefnet newsletter or email alert, please use the unsubscribe link on the bottom of such newsletter or email.</p>
...
<p style="line-height: 16.5pt; background: white;">The purpose of Criteo Email is to find visitors of Criteo advertising clients’ properties (websites, apps and newsletters) and send them personalized emails. Criteo uses cookies to single out users and then personalize ads based on their browsing experience. To learn more or opt out of Criteo Email <a href="http://privacy.criteoemail.com/us/privacy-policy.html">click here</a> (link to Criteo privacy policy at <a href="http://privacy.criteoemail.com/us/privacy-policy.html">http://privacy.criteoemail.com/us/privacy-policy.html</a>)</p>
...
<p style="line-height: 16.5pt; background: white;"><strong><span style="text-decoration: underline;">E. USE: BELIEFNET’S USE OF PII</span></strong></p>
...
<p style="line-height: 16.5pt; background: white;">If you would like to communicate with us about this Privacy Policy or Beliefnet’s collection or use of your PII, or request Beliefnet to delete your PII, please contact Beliefnet c/o: BN Media Associates, LLC, 999 Waterside Drive, Ste. 1910, Norfolk, VA 23510, Attn: Stephanie Bauer, Beliefnet Internet Privacy Officer. E-mail: <a href="mailto:sbauer@beliefnetstaff.com.">sbauer@beliefnetstaff.com.</a></p>
...
<br>
If you have questions or concerns regarding privacy, your use of the Beliefnet Site, or the collection and use of PII, you may contact Beliefnet c/o: BN Media Associates, LLC, 999 Waterside Drive, Ste. 1910, Norfolk, VA, 23510 Attn: Stephanie Bauer, Beliefnet Internet Privacy Officer. Telephone: (757) 200-9944. E-mail: <a href="mailto:sbauer@beliefnetstaff.com">sbauer@beliefnetstaff.com</a>.</p>
<br>
<br>
</div>
</main>
    ...
    <div class="score-right">
        <div class="bnet-affix ">
    

        <div class="score-component ad ad-container   hidden-xs">
            <div id="div-gpt-ad-147566822-2" class="DFPAdSlot ad-notice "></div>
        </div>
        ...
        <div class="score-component ad ad-container   hidden-xs">
            <div id="div-gpt-ad-585652693-3" class="DFPAdSlot "></div>
        </div>


        <div class="score-component ad ad-container   visible-xs-block">
            <div id="div-gpt-ad-585652693-4" class="DFPAdSlot  alt-text alt-pos-above"></div>
        </div>


        <div class="score-component ad ad-container   hidden-xs">
            <div id="div-gpt-ad-585652693-5" class="DFPAdSlot "></div>
        </div>
...
<li class="score-menu-list-item hidden-sm hidden-md hidden-lg" data-ux-args="{&quot;ClickMessagesTransmitting&quot;:[]}" data-ux-module="score_bootstrap/Components/MenuListItem" data-ux-state="pending"><a href="#" onclick="javascript:Beliefnet.viewFullDesktopSite();return false;">See Full Site</a></li>
</ul>
...
<script type="text/javascript">
    ...
    {
        adUnits = [{"code":"div-gpt-ad-208209602-1","sizes":[[320,100],[320,50],[300,100],[300,50]],"bids":[{"bidder":"yieldbot","params":{"psn":"3e70","slot":"Mob_Prem1_Top"}},{"bidder":"pagescience","params":{"placementId":"9258156"}},{"bidder":"sovrn","params":{"tagid":"390497"}}]}];
    }
    else // Is Desktop
    {
        adUnits = [{"code":"div-gpt-ad-top-nav","sizes":[[728,90],[970,90],[970,66],[970,250]],"bids":[{"bidder":"yieldbot","params":{"psn":"e36d","slot":"DT_ATF_Top"}},{"bidder":"pagescience","params":{"placementId":"9258156"}},{"bidder":"sovrn","params":{"tagid":"390496"}}]},{"code":"div-gpt-ad-147566822-2","sizes":[[300,250],[300,600]],"bids":[{"bidder":"yieldbot","params":{"psn":"e36d","slot":"DT_ATF_Right"}},{"bidder":"pagescience","params":{"placementId":"9258183"}},{"bidder":"sovrn","params":{"tagid":"390494"}},{"bidder":"sovrn","params":{"tagid":"390495"}}]}];
    }
        ...
        standard: {
            ...
            adserverTargeting: [{
                ...
                val: function(bidResponse) {
                    ...
                    if (cpm < 1.25) { // 0.00 -> 1.25
                        return (Math.floor(cpm * 20) / 20).toFixed(2); // 0.05 inc
                    } else if (cpm < 2.00) { // 1.25 -> 2.00
                        return (Math.floor(cpm * 4) / 4).toFixed(2); // 0.25 inc
                    } else if (cpm < 2.50) { // 2.00 -> 2.50
                        return (Math.floor(cpm * 10) / 10).toFixed(2); // 0.10 inc
                    } else if (cpm < 20.00) { // 2.50 -> 20.00
                        return (Math.floor(cpm * 2) / 2).toFixed(2); // 0.50 inc
                    } else {
                        return '20.00';
                    }
                }
        ...
        openx: {
            ...
            adserverTargeting: [{
                ...
                val: function(bidResponse) {
                    ...
                    var cpm = bidResponse.cpm;
                    if (cpm < 1.25) { // 0.00 -> 1.25
                        bid = (Math.floor(cpm * 20) / 20).toFixed(2); // 0.05 inc
                    } else if (cpm < 2.00) { // 1.25 -> 2.00
                        bid = (Math.floor(cpm * 4) / 4).toFixed(2); // 0.25 inc
                    } else if (cpm < 2.50) { // 2.00 -> 2.50
                        bid = (Math.floor(cpm * 10) / 10).toFixed(2); // 0.10 inc
                    } else if (cpm < 20.00) { // 2.50 -> 20.00
                        bid = (Math.floor(cpm * 2) / 2).toFixed(2); // 0.50 inc
                    } else {
                        bid = 20.00;
                    }

                    //Returns creativeSize_bidBucket as the value
                    return bidResponse.width + "x" + bidResponse.height + "_" + (bid * 100);
                }
            },{
                key: "ox_pb_won",
                val: function (bidResponse) {
...
<script>
    ...
    function bnetInitializeDFPAds()
    {
        var bnetAds = document.getElementsByClassName("DFPAdSlot");
        for(var i = 0; i < bnetAds.length; i++)
        {
            var a = bnetAds[i];

            googletag.display(a.id);
            console.log("Loading Ad Slot " + (i+1) + ": " + a.id);
        }

        DFP.AdInitializationComplete = true;
        console.log("Firing Event: Ad Initialization Complete");
        bnetFireEvent("Beliefnet:AdInitializationComplete");
    }
    ...
    function sendAdserverRequest() {
        ...
        googletag.cmd.push(function() {
            pbjs.que.push(function() {
                ...
                if(typeof DFP != "undefined" && DFP.AdConfigurationComplete)
                {
                    // Initialize Ads
                    bnetInitializeDFPAds();
                    // Refresh Ads
                    googletag.pubads().refresh();

                    console.log("DFP Refresh Initiated");
                } else {
                    console.log("Ads not fully configured. Waiting for AdConfigurationComplete event");
                    document.addEventListener("Beliefnet:AdConfigurationComplete", function (e) {
                        // Initialize Ads
                        bnetInitializeDFPAds();
                        // Refresh Ads
                        googletag.pubads().refresh();
...
<!-- End Other Header Bidders -->
<!-- Begin Beliefnet DFP Configuration Data -->
<script type="text/javascript">
    var pageCount = bnetGetCookie("CAM01cookie");
    ...
    (function() {
        DFP.config = {
            ...
            source:     bnetGetParameter(document.URL, "utm_source"),
            medium:     bnetGetParameter(document.URL, "utm_medium"),
            campaign:   bnetGetParameter(document.URL, "utm_campaign"),
            contentid:  "5e0d0289",
            title:      "Privacy Policy",
            pagenum:    bnetGetParameter(document.URL, 'p'),
            pagecount:  ((typeof pageCount == 'undefined') ? "" : pageCount),
            pageurl:    location.protocol + '//' + location.host + location.pathname,
            type:       "beliefnet-content-page"
        }

        DFP.positions = ['DT_ATF_Top', 'Mob_Prem1_Top', 'DT_ATF_Right', 'DT_OutofPage', 'Mob_OutofPage', 'DT_Skin_OutofPage'];
        ...
        DFP.AdConfigurationComplete = false;
        DFP.AdInitializationComplete = false;
...
<!-- End Beliefnet DFP Configuration Data -->
<!-- Begin Google Tag Services Load -->
<script>
    (function () {
...
<!-- End Google Tag Services Load -->
<!-- Begin DFP Configuration -->
<script type="text/javascript">
    googletag.cmd.push(function() {
        console.log("Configuring DFP");
DFP.RegisterSlot(googletag.defineSlot(DFP.config.hierarchy, [[728, 90], [970, 90], [970, 66], [970, 250]], "div-gpt-ad-top-nav")
	.addService(googletag.pubads())
    .defineSizeMapping(googletag.sizeMapping().
        addSize([0,0], []). // Mobile
        addSize([768,576], [[728, 90], [970, 90], [970, 66], [970, 250]]). // Desktop
        build())
	.setCollapseEmptyDiv(true)
	.setTargeting("pos", "DT_ATF_Top"),    false);DFP.RegisterSlot(googletag.defineSlot(DFP.config.hierarchy, [[320, 100], [320, 50], [300, 100], [300, 50]], "div-gpt-ad-208209602-1")
	.addService(googletag.pubads())
    .defineSizeMapping(googletag.sizeMapping().
        ...
        build())
	.setCollapseEmptyDiv(true)
	.setTargeting("pos", "Mob_Prem1_Top"),    true);DFP.RegisterSlot(googletag.defineSlot(DFP.config.hierarchy, [[300, 250], [300, 600]], "div-gpt-ad-147566822-2")
	.addService(googletag.pubads())
    .defineSizeMapping(googletag.sizeMapping().
        addSize([0,0], []). // Mobile
        ...
        build())
	.setCollapseEmptyDiv(true)
	.setTargeting("pos", "DT_ATF_Right"),    false);DFP.RegisterSlot(googletag.defineOutOfPageSlot(DFP.config.hierarchy, "div-gpt-ad-585652693-3")
	.addService(googletag.pubads())
    .defineSizeMapping(googletag.sizeMapping().
        addSize([0,0], []). // Mobile
        ...
        build())
	.setCollapseEmptyDiv(true)
	.setTargeting("pos", "DT_OutofPage"),    false);DFP.RegisterSlot(googletag.defineOutOfPageSlot(DFP.config.hierarchy, "div-gpt-ad-585652693-4")
	.addService(googletag.pubads())
    .defineSizeMapping(googletag.sizeMapping().
        ...
        build())
	.setCollapseEmptyDiv(true)
	.setTargeting("pos", "Mob_OutofPage"),    true);DFP.RegisterSlot(googletag.defineOutOfPageSlot(DFP.config.hierarchy, "div-gpt-ad-585652693-5")
	.addService(googletag.pubads())
    .defineSizeMapping(googletag.sizeMapping().
        addSize([0,0], []). // Mobile
        addSize([768,576], [1,1]). // Desktop
        build())
	.setCollapseEmptyDiv(true)
	.setTargeting("pos", "DT_Skin_OutofPage"),    false);
        ...
        // Page URL
        googletag.pubads().setTargeting("page_url", DFP.config.pageurl);
        ...
        // Content Type
        googletag.pubads().setTargeting("type", DFP.config.type);
        ...
        googletag.pubads().addEventListener('slotRenderEnded', function (event) {
            ...
            {
                console.log("Firing Event: Ad Load Complete");
                // Fire off the event declaring the Ad Load has completed
                bnetFireEvent("Beliefnet:AdLoadComplete");
            }
        });
        ...
        // Enabled Single Request Mode
        googletag.pubads().enableSingleRequest();

        // Enable Ads
        googletag.enableServices();

        DFP.AdConfigurationComplete = true;
        console.log("Firing Event: Ad Configuration Complete");
        // Fire off event declaring the ad configuration is complete
        bnetFireEvent("Beliefnet:AdConfigurationComplete");
    });
</script>
<!-- End DFP Configuration -->
<!-- End DFP Ad Scripts -->
