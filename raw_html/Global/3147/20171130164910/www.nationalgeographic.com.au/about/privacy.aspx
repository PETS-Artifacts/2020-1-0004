	...
	<!-- Chook TV -->
	<link href="/chooktv/dist/chooktv.css?v=27" rel="stylesheet" type="text/css" />
	<!--[if lt IE 9]>
		<script src="/chooktv/dist/chooktv-ie.min.js?v=27"></script>
	<![endif]-->
					...
					<span class="Elements">
						...
						<a href="#" class="Button Toggle">
							...
							<li id="Content_Content_CollapsedNavigation_MenuRepeater_DropdownRepeater_7_Item_2" class="Last">
								<a id="Content_Content_CollapsedNavigation_MenuRepeater_DropdownRepeater_7_Link_2" href="/app/" class="App">
					...
					<span class="Elements">
						...
						<a href="#" class="Button Toggle">
							...
							<li id="Content_Content_Navigation_MenuRepeater_DropdownRepeater_6_Item_2" class="Last">
								<a id="Content_Content_Navigation_MenuRepeater_DropdownRepeater_6_Link_2" href="/app/" class="App">
									<span class="Text">App</span>
								</a>
							</li>
 ...
 --><li class="Last">
 		<a href="https://instagram.com/natgeoau" target="_blank">
			...
			<span class="Text">Instagram</span>
				...
				<a class="Logo" href="/">
					<img src="/includes/images/logo.png?v=27" alt="National Geographic" class="White" />
					<img src="/includes/images/logo-inverted.png?v=27" alt="National Geographic" class="Black" />
				</a>
...
<div id="Content_Content_ctl02_InputWrapControl" class="InputWrap Required HideError">
	...
	<div class="InputParent">
		...
		<!-- Options -->
			...
			<img src="http://cdn.natgeotv.com.au/misc/newsletter.jpg?v=27&azure=false&scale=both&width=1920&height=400&mode=crop" alt="" />
		</div>
		...
		<div class="Footer">
			<div class="Top">
				<div class="Wrapper">
					<div class="Left">
						<a class="Logo" href="/tvguide/"><img src="/includes/images/logo.png?v=27" alt="National Geographic" width="166" /></a>
...
<div id="Content_Content_ctl04_Link_InputWrapControl" class="InputWrap Required">
	...
	<a href="#" class="Background"><!-- Background --></a>
		...
		<!-- Gallery -->
			...
			<!-- Chook -->
			<script type="text/javascript" src="/includes/js/chook/chook.js?v=27"></script>
			<script type="text/javascript" src="/includes/js/chook/forms.js?v=27"></script>
			
			<!-- Layout -->
			<script type="text/javascript" src="/includes/js/layout.js?v=27"></script>
	...
	<!-- Chook TV -->
    <script type="text/javascript" src="/chooktv/dist/chooktv.js?v=27"></script>

	<!-- Plugins -->
	<script type="text/javascript" src="/includes/js/plugins/webfont.min.js?v=27"></script>
	<script type="text/javascript" src="/includes/js/plugins/packery.min.js?v=27"></script>
	<script type="text/javascript" src="/includes/js/plugins/tweenmax.min.js?v=27"></script>
	<script type="text/javascript" src="/includes/js/plugins/jquery.mobile.min.js?v=27"></script>

	<!-- Chook -->
	<script type="text/javascript" src="/includes/js/chook/connect.js?v=27"></script>
	<script type="text/javascript" src="/includes/js/chook/play.js?v=27"></script>
	<script type="text/javascript" src="/includes/js/chook/lazyloader.js?v=27"></script>
	<script type="text/javascript" src="/includes/js/chook/slider.js?v=27"></script>
	<script type="text/javascript" src="/includes/js/chook/modals.js?v=27"></script>
	<script type="text/javascript" src="/includes/js/chook/share.js?v=27"></script>
	<script type="text/javascript" src="/includes/js/chook/gallery.js?v=27"></script>
