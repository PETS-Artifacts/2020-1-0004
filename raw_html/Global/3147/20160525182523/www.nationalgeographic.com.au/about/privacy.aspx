	...
	<!-- Chook TV -->
	<link href="/chooktv/chookplayer/dist/chookplayer.css?v=13" rel="stylesheet" type="text/css" />
 ...
 --><li class="Last">
 		<a href="https://instagram.com/natgeotvau" target="_blank">
			...
			<span class="Text">Instagram</span>
				...
				<a class="Logo" href="/">
					<img src="/includes/images/logo.png?v=13" alt="National Geographic" class="White" />
					<img src="/includes/images/logo-inverted.png?v=13" alt="National Geographic" class="Black" />
				</a>
...
<div id="Content_Content_ctl02_InputWrapControl" class="InputWrap Required HideError">
	...
	<div class="InputParent">
		...
		<!-- Options -->
			...
			<img src="http://cdn.natgeotv.com.au/misc/newsletter.jpg?scale=both&width=1920&height=400&mode=crop" alt="" />
		</div>
		...
		<div class="Footer">
			<div class="Top">
				<div class="Wrapper">
					<div class="Left">
						<a class="Logo" href="/tvguide/"><img src="/includes/images/logo-inverted.png?v=13" alt="National Geographic" /></a>
...
<div id="Content_Content_ctl04_Link_InputWrapControl" class="InputWrap Required">
	...
	<a href="#" class="Background"><!-- Background --></a>
		...
		<!-- Gallery -->
			...
			<!-- Chook -->
			<script type="text/javascript" src="/includes/js/chook/chook.js?v=13"></script>
			<script type="text/javascript" src="/includes/js/chook/forms.js?v=13"></script>
			
			<!-- Layout -->
			<script type="text/javascript" src="/includes/js/layout.js?v=13"></script>
	...
	<!-- Chook TV -->
	<script type="text/javascript" src="/chooktv/chookplayer/dist/chookplayer.min.js?v=13"></script>

	<!-- Plugins -->
	<script type="text/javascript" src="/includes/js/plugins/webfont.min.js?v=13"></script>
	<script type="text/javascript" src="/includes/js/plugins/packery.min.js?v=13"></script>
	<script type="text/javascript" src="/includes/js/plugins/tweenmax.min.js?v=13"></script>
	<script type="text/javascript" src="/includes/js/plugins/jquery.mobile.min.js?v=13"></script>

	<!-- Chook -->
	<script type="text/javascript" src="/includes/js/chook/connect.js?v=13"></script>
	<script type="text/javascript" src="/includes/js/chook/play.js?v=13"></script>
	<script type="text/javascript" src="/includes/js/chook/lazyloader.js?v=13"></script>
	<script type="text/javascript" src="/includes/js/chook/slider.js?v=13"></script>
	<script type="text/javascript" src="/includes/js/chook/modals.js?v=13"></script>
	<script type="text/javascript" src="/includes/js/chook/share.js?v=13"></script>
	<script type="text/javascript" src="/includes/js/chook/gallery.js?v=13"></script>
