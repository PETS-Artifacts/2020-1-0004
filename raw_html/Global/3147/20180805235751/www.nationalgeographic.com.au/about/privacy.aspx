...
<!-- Menu -->
<ul id="Content_Content_CollapsedNavigation_Wrapper" class="Menu C9">
			...
			<li id="Content_Content_CollapsedNavigation_MenuRepeater_Item_7" class="Item Parent Text Travel C8">
				<div class="Container">
					<span class="Elements">
						<a id="Content_Content_CollapsedNavigation_MenuRepeater_Link_7" class="Link" href="/travel/">
							<span class="Text">Travel</span>
						</a>
						<a href="#" class="Button Collapse">
							<span class="Sprite Left"><!-- Sprite --></span>
						...
						<a href="#" class="Button Toggle">
							...
							<li id="Content_Content_CollapsedNavigation_MenuRepeater_DropdownRepeater_7_Item_0">
								<a id="Content_Content_CollapsedNavigation_MenuRepeater_DropdownRepeater_7_Link_0" href="/travel/destinations" class="Destinations">
									<span class="Text">Destinations</span>
								</a>
							</li>
						
							<li id="Content_Content_CollapsedNavigation_MenuRepeater_DropdownRepeater_7_Item_1">
								<a id="Content_Content_CollapsedNavigation_MenuRepeater_DropdownRepeater_7_Link_1" href="/travel/trip-types" class="Trip Types">
									<span class="Text">Trip Types</span>
								</a>
							</li>
						
							<li id="Content_Content_CollapsedNavigation_MenuRepeater_DropdownRepeater_7_Item_2">
								<a id="Content_Content_CollapsedNavigation_MenuRepeater_DropdownRepeater_7_Link_2" href="/travel/why-travel-with-us" class="Why Travel With Us">
									<span class="Text">Why Travel With Us?</span>
								</a>
							</li>
						
							<li id="Content_Content_CollapsedNavigation_MenuRepeater_DropdownRepeater_7_Item_3" class="Last">
								<a id="Content_Content_CollapsedNavigation_MenuRepeater_DropdownRepeater_7_Link_3" href="/travel/how-to-book" class="How To Book">
									<span class="Text">How To Book</span>
								</a>
							</li>
			...
			<li id="Content_Content_CollapsedNavigation_MenuRepeater_Item_8" class="Item Span Parent Text More Last C9">
				<div class="Container">
					<span class="Elements">
						<span id="Content_Content_CollapsedNavigation_MenuRepeater_Link_8" class="Link">
						...
						<a href="#" class="Button Toggle">
							...
							<li id="Content_Content_CollapsedNavigation_MenuRepeater_DropdownRepeater_8_Item_0">
								<a id="Content_Content_CollapsedNavigation_MenuRepeater_DropdownRepeater_8_Link_0" href="/events/" class="Events">
									<span class="Text">Events</span>
								</a>
							</li>
						
							<li id="Content_Content_CollapsedNavigation_MenuRepeater_DropdownRepeater_8_Item_1" class="Last">
								<a id="Content_Content_CollapsedNavigation_MenuRepeater_DropdownRepeater_8_Link_1" href="/win/" class="Win">
...
<!-- Menu -->
<ul id="Content_Content_Navigation_Wrapper" class="Menu C9">
			...
			<li id="Content_Content_Navigation_MenuRepeater_Item_6" class="Item Parent Text Travel HideBelowHamburger C7">
				<div class="Container">
					<span class="Elements">
						<a id="Content_Content_Navigation_MenuRepeater_Link_6" class="Link" href="/travel/">
							<span class="Text">Travel</span>
						</a>
						<a href="#" class="Button Collapse">
							<span class="Sprite Left"><!-- Sprite --></span>
						...
						<a href="#" class="Button Toggle">
							...
							<li id="Content_Content_Navigation_MenuRepeater_DropdownRepeater_6_Item_0">
								<a id="Content_Content_Navigation_MenuRepeater_DropdownRepeater_6_Link_0" href="/travel/destinations" class="Destinations">
									<span class="Text">Destinations</span>
								</a>
							</li>
						
							<li id="Content_Content_Navigation_MenuRepeater_DropdownRepeater_6_Item_1">
								<a id="Content_Content_Navigation_MenuRepeater_DropdownRepeater_6_Link_1" href="/travel/trip-types" class="Trip Types">
									<span class="Text">Trip Types</span>
								</a>
							</li>
						
							<li id="Content_Content_Navigation_MenuRepeater_DropdownRepeater_6_Item_2">
								<a id="Content_Content_Navigation_MenuRepeater_DropdownRepeater_6_Link_2" href="/travel/why-travel-with-us" class="Why Travel With Us">
									<span class="Text">Why Travel With Us?</span>
								</a>
							</li>
						
							<li id="Content_Content_Navigation_MenuRepeater_DropdownRepeater_6_Item_3" class="Last">
								<a id="Content_Content_Navigation_MenuRepeater_DropdownRepeater_6_Link_3" href="/travel/how-to-book" class="How To Book">
									<span class="Text">How To Book</span>
								</a>
							</li>
			...
			<li id="Content_Content_Navigation_MenuRepeater_Item_7" class="Item Span Parent Text More HideBelowHamburger C8">
				<div class="Container">
					<span class="Elements">
						<span id="Content_Content_Navigation_MenuRepeater_Link_7" class="Link">
							<span class="Text">More</span>
						</span>
						<a href="#" class="Button Collapse">
							<span class="Sprite Left"><!-- Sprite --></span>
						...
						<a href="#" class="Button Toggle">
							...
							<li id="Content_Content_Navigation_MenuRepeater_DropdownRepeater_7_Item_0">
								<a id="Content_Content_Navigation_MenuRepeater_DropdownRepeater_7_Link_0" href="/events/" class="Events">
									<span class="Text">Events</span>
								</a>
							</li>
						
							<li id="Content_Content_Navigation_MenuRepeater_DropdownRepeater_7_Item_1" class="Last">
								<a id="Content_Content_Navigation_MenuRepeater_DropdownRepeater_7_Link_1" href="/win/" class="Win">
									<span class="Text">Win</span>
								</a>
							</li>
			...
			<li id="Content_Content_Navigation_MenuRepeater_Item_8" class="Item Icon Expand Last C9">
				<div class="Container">
					<span class="Elements">
						<a id="Content_Content_Navigation_MenuRepeater_Link_8" class="Link" href="#">
	...
	If you are not satisfied with the outcome of our assessment of your complaint, you may wish to contact the Office of the Australian Information Commissioner (<a href="http://www.oaic.gov.au/privacy/privacy-complaints">click here for information</a>).</p>
		...
		<div class="Newsletter">
			<div>
				...
				<form action="" data-action="/includes/ajax/subscribe.aspx?ListID=1" class="Validate" autocomplete="off">
					...
					<span class="Elements">
						...
						<a href="#" class="Button Toggle">
							...
							<li id="Content_Content_Sitemap_MenuRepeater_DropdownRepeater_1_Item_5">
								<a id="Content_Content_Sitemap_MenuRepeater_DropdownRepeater_1_Link_5" href="/events/" class="Events">
									<span class="Text">Events</span>
								</a>
							</li>
						
							<li id="Content_Content_Sitemap_MenuRepeater_DropdownRepeater_1_Item_6" class="Last">
								<a id="Content_Content_Sitemap_MenuRepeater_DropdownRepeater_1_Link_6" href="/register/" class="Register">
...
<div id="Content_Content_ctl04_Link_InputWrapControl" class="InputWrap Required">
	...
	<script type="text/javascript">
		$(function () {
			...
			$('.JamesCameronMrec').click(function (event) {
				var href = $(this).attr('href');
				event.preventDefault();
				secondTracker._trackEvent('Mrec', 'Click', href);
				setTimeout(function () {
					window.location.href = href;
				}, 200);
			});
			...
			$('a').filter(function () {
				var href = $(this).attr('href');
				return href !== undefined && href !== null && href.length && href.indexOf('://') !== -1 && href.indexOf('nationalgeographic.com.au') === -1;
			}).click(function (event) {
				var href = $(this).attr('href');
				event.preventDefault();
				secondTracker._trackEvent('Outbound Link', 'Click', href);
				setTimeout(function () {
					window.location.href = href;
				}, 100);
			});
