	...
	<!-- Chook TV -->
    <link href="/chooktv/dist/chooktv.css?v=20" rel="stylesheet" type="text/css" />
    <!--[if lt IE 9]>
        <script src="/chooktv/dist/chooktv-ie.min.js?v=20"></script>
    <![endif]-->
 ...
 --><li class="Last">
 		<a href="https://instagram.com/natgeoau" target="_blank">
			...
			<span class="Text">Instagram</span>
				...
				<a class="Logo" href="/">
					<img src="/includes/images/logo.png?v=20" alt="National Geographic" class="White" />
					<img src="/includes/images/logo-inverted.png?v=20" alt="National Geographic" class="Black" />
				</a>
...
<div id="Content_Content_ctl02_InputWrapControl" class="InputWrap Required HideError">
	...
	<div class="InputParent">
		...
		<!-- Options -->
			...
			<img src="http://cdn.natgeotv.com.au/misc/newsletter.jpg?v=20&azure=false&scale=both&width=1920&height=400&mode=crop" alt="" />
		</div>
		...
		<div class="Footer">
			<div class="Top">
				<div class="Wrapper">
					<div class="Left">
						<a class="Logo" href="/tvguide/"><img src="/includes/images/logo.png?v=20" alt="National Geographic" width="166" /></a>
...
<div id="Content_Content_ctl04_Link_InputWrapControl" class="InputWrap Required">
	...
	<a href="#" class="Background"><!-- Background --></a>
		...
		<!-- Gallery -->
			...
			<!-- Chook -->
			<script type="text/javascript" src="/includes/js/chook/chook.js?v=20"></script>
			<script type="text/javascript" src="/includes/js/chook/forms.js?v=20"></script>
			
			<!-- Layout -->
			<script type="text/javascript" src="/includes/js/layout.js?v=20"></script>
	...
	<!-- Chook TV -->
    <script type="text/javascript" src="/chooktv/dist/chooktv.js?v=20"></script>

	<!-- Plugins -->
	<script type="text/javascript" src="/includes/js/plugins/webfont.min.js?v=20"></script>
	<script type="text/javascript" src="/includes/js/plugins/packery.min.js?v=20"></script>
	<script type="text/javascript" src="/includes/js/plugins/tweenmax.min.js?v=20"></script>
	<script type="text/javascript" src="/includes/js/plugins/jquery.mobile.min.js?v=20"></script>

	<!-- Chook -->
	<script type="text/javascript" src="/includes/js/chook/connect.js?v=20"></script>
	<script type="text/javascript" src="/includes/js/chook/play.js?v=20"></script>
	<script type="text/javascript" src="/includes/js/chook/lazyloader.js?v=20"></script>
	<script type="text/javascript" src="/includes/js/chook/slider.js?v=20"></script>
	<script type="text/javascript" src="/includes/js/chook/modals.js?v=20"></script>
	<script type="text/javascript" src="/includes/js/chook/share.js?v=20"></script>
	<script type="text/javascript" src="/includes/js/chook/gallery.js?v=20"></script>
