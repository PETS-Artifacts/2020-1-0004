...
<nav aria-label="Primary navigation" class="navbar navbar-inverse" id="nav-primary">
	...
	<ul class="nav navbar-nav">				
				...
				<button aria-expanded="false" class="btn navbar-btn dropdown-toggle" data-toggle="dropdown" type="button">
					<span><span aria-hidden="true" class="fa fa-users"></span><span class="sr-only"><span>Find information for...</span></span></span>
			...
			<div class="navbar-right">
							...
							<a class="btn navbar-btn" href="http://give.uci.edu/"><span><span class="sr-only"> </span>Donate<span class="sr-only"> to UCI</span></span></a>
