...
<script src="/ScriptResource.axd?d=x6wALODbMJK5e0eRC_p1LWQJvrEj0xpoNnHEB73hO3-9v0VFIqB-9TF_BCsTJkBEeT0bYsz-dxT_WDvetL6TfM8kl8KE3hEbhofmIPF04bdKmHKb0&amp;t=ffffffffda74082d" type="text/javascript"></script>
<script src="/ScriptResource.axd?d=P5lTttoqSeZXoYRLQMIScL8L1ur96FNi0GHMFWWp48C4IAeB3hckg0DjXC-QBu6dJBk7uj-6lcZZxM9sLywP5E_7UIWO28H1jRY2y00GGJoWRriC0&amp;t=ffffffffda74082d" type="text/javascript"></script>
        <div class="container">
            <script type="text/javascript">
//<![CDATA[
               ...
               <li class="dropdown ">
                        ...
                        <a noref id="thisIsTheSearchPlaceholderId" class="nav-searchbox-class stickydropdown-toggle hidden-xs" title="Search" style="margin-left: 20px; margin-top: -3px;">
                            <div id="thisIsTheSearchBoxWrapperId" class="typeahead-searchbox-glyphicon-wrapper" >
                                ...
                                <input type="text" placeholder="Search"
                                       ...
                                       style="border: 0px; color: #333; /*border-bottom: 1px solid #858585;*/ background-color: transparent;"/>

                                <i id="thisIsTheBigGlyphiconId" class="glyphicon glyphicon-search hidden-sm nav-search-glyphicon-class" style="color: #858585; padding-bottom: 2px;padding-right: 2px;margin-left: -5px;">
                                </i>
                ...
                <li class="dropdown">
                    ...
                    <div class="dropdown-menu list-group pull-right" style="min-width: 300px;">
                        ...
                        <a href="/api/" class="list-group-item" target="_self">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-1 col-sm-1">
                <br /><div class="visible-xs visible-sm">&nbsp;<br /></div>
                ...
                <br /><br />
                <a href="https://play.google.com/store/apps/details?id=com.tradingeconomics.android"><img alt="Android app on Google Play"src="/images/google-play.png" /></a>
            </div>
...
<script>
	...
	ta_opts.universe = 'economic,forex,commodity,idx,bond';
	ta_opts.field = 'url';
	ta_opts.origins = 'te';
    ...
    <script async src="https://d3fy651gv2fhd3.cloudfront.net/scripts/iec-config-typeahead.js?v=20180525"></script>
    ...
    if ($("#estimates-ad").length == 0) {
        ...
        if (TESymbol != '') {
            if (window.location.href.indexOf("forecast") == -1 && window.location.pathname.split('/').length == 3) {
                ...
                estimatesUrl = window.location.href + "/survey";
...
<script src="https://d3fy651gv2fhd3.cloudfront.net/scripts/bloodhound.gr.js" type="text/javascript"></script>
    ...
    <script src="/scripts/search.1.0.0.js?v=20180510" type="text/javascript"></script>
