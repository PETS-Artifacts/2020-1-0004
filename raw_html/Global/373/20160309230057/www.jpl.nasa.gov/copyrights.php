            ...
            <div class='modal_menu'>
              <header class='site_header clearfix'>
                <div class='brand_area'>
                  ...
                  <div class='brand2'>
                    <div class='jpl_logo'>
                      <a class='' href='http://www.jpl.nasa.gov/' id='jpl_logo' title=''>Jet Propulsion Laboratory</a>
                    </div>
                    <div class='caltech_logo'>
                      <a class='' href='http://www.jpl.nasa.gov/' id='caltech_logo' title=''>California Institute of Technology</a>
                    </div>
                  </div>
  				        <img alt='' class='print_only print_logo' src='/assets/images/logo_nasa_trio_black@2x.png'>
                </div>
              ...
              <div class='grid_layout'>
                <div class='directory'>
                  ...
                  <div class='nav_item'>
                    ...
                    <ul class='subnav'>
                      <li>
                        <a href="/about">director's message</a>
                      </li>
                      <li>
                  ...
                  <div class='nav_item'>
                    ...
                    <ul class='subnav'>
                      ...
                      <li>
                        <a href="/news/mediaroom.php">media room</a>
                      </li>
                      <li>
                  ...
                  <div class='nav_item'>
                    ...
                    <ul class='subnav'>
                      ...
                      <li>
                        <a href="/events/open-house.php">open house</a>
                      </li>
                      <li>
		  ...
		  <article>
			...
			<div class='clearfix' id='primary_column'>
			  <div class='wysiwyg_content'>
				...
				<p>
				  We continually strive to ensure the pages on this Web site are accessible to individuals with disabilities in accordance with
				  <a href='http://www.section508.gov'>Section 508 of the Rehabilitation Act</a>.
				  <a href='mailto:jpl508report@list.jpl.nasa.gov' target='_blank'>jpl508report@list.jpl.nasa.gov</a>.
				</p>
				<p>
                ...
                <div class='sitemap_block'>
                  ...
                  <div class='footer_sitemap_item'>
                    ...
                    <ul class='subnav'>
                      ...
                      <li>
                        <a href="http://photojournal.jpl.nasa.gov/">Photojournal</a>
                      </li>
                      <li>
                ...
                <div class='sitemap_block'>
                  <div class='footer_sitemap_item'>
                    ...
                    <ul class='subnav'>
                      ...
                      <li>
                        <a href="http://planetquest.jpl.nasa.gov">Planetquest / Exoplanets</a>
                      </li>
                      <li>
