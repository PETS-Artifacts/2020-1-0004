...
--><link rel="stylesheet" type="text/css" href="/a/css/common/fonts.css" />

<link rel="stylesheet" type="text/css" href="http://cdn.addictinggames.com/a/min/css/global.min.css?c=30"/>
	<link rel="stylesheet" type="text/css" href="http://cdn.addictinggames.com/a/min/css/footerPages.min.css?c=30"/>
	...
	var agChannel = '';
            ...
            ADG.globals.GTM_TIMEOUT = 5000; //Wait 5 seconds
        </script>
...
<script>
    ...
    googletag.cmd.push(function() {
        ...
        // ==========================================================================================
        ADG.globals.adRefreshRate30 = ADG.globals.adRefreshRate ? ADG.globals.adRefreshRate : 30000;
        ADG.globals.adRefreshRate120 = ADG.globals.adRefreshRate ? ADG.globals.adRefreshRate : 120000;
        ...
        window.setInterval(function(){
            if(typeof pbjs_refreshBid === 'function') {
                pbjs_refreshBid(slotArray120);
            } else {
             googletag.pubads().refresh(slotArray120);
            }	  
        }, ADG.globals.adRefreshRate120);	      
        window.setInterval(function(){
            if(typeof pbjs_refreshBid === 'function') {
                pbjs_refreshBid(slotArray30);
            } else {
                googletag.pubads().refresh(slotArray30);
            }	  
        }, ADG.globals.adRefreshRate30);	    

    	// ==================
    	// Accept-2, Accept-3 
    	// ==================
    	var gameTopAd = [[728, 90], [960, 1]];
    	var nonGameTopAd = [[728, 90], [960, 1], [970, 40], [970, 66], [970, 90], [970, 250]];
    	var footerAd =  [[728, 90], [970, 40], [970, 66], [970, 90], [970, 250]];
    	var topAd = nonGameTopAd;
    	
    	

        var leaderboardSlot = googletag.defineSlot('/4678/addictinggames_web/' + ADG.globals.adZones.leaderboard, topAd, 'div-gpt-ad-leaderboard').addService(googletag.pubads());
        slotArray120.push(leaderboardSlot);
        ...
        var rectangleSlot = googletag.defineSlot('/4678/addictinggames_web/' + ADG.globals.adZones.rectangle, [[300, 250]], 'div-gpt-ad-rectangle').addService(googletag.companionAds()).addService(googletag.pubads());
        slotArray30.push(rectangleSlot);
        
        
            googletag.defineOutOfPageSlot('/4678/addictinggames_web/' + ADG.globals.adZones.interstitial, 'div-gpt-ad-oop').addService(googletag.pubads());
...
<!-- End Quantcast tag --><div id="headerWrapper">
		<div id="agContainer">
			<div id="navTop">
	<div id="navLeft">
		<a href="http://www.addictinggames.com/index.jsp"><img src="/a/img/agLogo_n.png" height="40" width="205" alt="AddictingGames" class="fltL" /></a>
		<div id="searchBarOuter">
			<div id="searchBarInner">
				<input id="nsmInput" type="text" value="Search AddictingGames..." />
				<div id="nsmSubmitLink"></div>
			</div>
		</div>
	</div>
	<div id="loginContainer">
        <div id="facebookConnectLink"></div>
		<div id="uimLoginLink"></div>
		<script type="text/javascript">
			ag.userObject = {};
		</script>
	</div>
...
<ul class="navTabs">
	<li class="">
		<a title="Games" target="_top" href="http://www.addictinggames.com/index.jsp" class="ga-nav">GAMES</a>
	</li>
	<li class="">
	...
	<li class="customNavTabs">
			<a title="" target="_top" href="http://video5.break.com/campaigns/LuckyCharms_hubPg/index.html" class="ga-nav">
				<img src="http://cdn.addictinggames.com/content-items/toggle-header-content.png" alt="Lucky Charms"> </a>
		</li>
	<li class="customNavTabs">
        <a title="" target="_top" href="http://www.addictinggames.com/strategy-games/forge-of-gods-game.jsp" class="ga-nav">
          <img src="http://www.addictinggames.com/a/img/sponsor/logo_ForgeOfGods.png" alt="Forge of Gods"> </a>
      </li>
    </ul>
...
<div id="categoryNavContainer">
	<ul id="categoryNav">
		...
		<li id="headerMore"><a id="headerMoreText" href="#">More</a><span id="headerMoreArrow"></span></li>
	</ul>
</div>
<div id="headerMoreFilters">
	<div>
	<ul id="firstMoreList" class="moreList">
		<li>Tags:</li>
	</ul>
	<ul class="moreList"><li><a href="http://www.addictinggames.com/tag/stick-figure-games.jsp" id="tag_stick-figure" class="navTagLink">Stick Figure</a></li>
		...
		</ul><ul class="moreList"><li><a href="http://www.addictinggames.com/tag/escape-games.jsp" id="tag_escape" class="navTagLink">Escape</a></li>
		...
		</ul><ul class="moreList"><li><a href="http://www.addictinggames.com/tag/hard-games.jsp" id="tag_hard" class="navTagLink">Hard</a></li>
		...
		</ul><ul class="moreList"><li><a href="http://www.addictinggames.com/tag/word-games.jsp" id="tag_word" class="navTagLink">Word</a></li>
		...
		</ul><ul class="moreList"><li><a href="http://www.addictinggames.com/tag/war-games.jsp" id="tag_war" class="navTagLink">War</a></li>
...
</div><div id="footerCopy" class="clearfix">
	<div class="clearfix">
	...
	<div id="reskinWrapper">
		<div id="div-gpt-ad-leaderboard" class="leaderboard-ad"  >
    <script>
        googletag.cmd.push(function () {
...
<div id="agContentWrapper" 
			>
			<div id="agContent" class="clearfix">
				<div id="footerPageNavigation">
	<ul>
	<li>
		<a href="/about/about-us.jsp"><span>About Us</span></a>
	</li>
	<li>
		<a href="/support/contact-us.jsp"><span>Contact Us</span></a>
	</li>
	<li>
		<a href="/about/advertisers.jsp"><span>Advertise with Us</span></a>
	</li>
	<li>
		<a href="/game/upload.jsp"><span>Developer Center</span></a>
	</li>


	<li>
		<a href="/help/help.jsp"><span>Help</span></a>
	</li>
	<li>
		<a href="/help/parents.jsp"><span>For Parents</span></a>
	</li>
	<li>
		<a href="/help/content-ratings.jsp"><span>What Our Warnings Mean</span></a>
	</li>

	<li>
		<a class="selected"  href="/legal/privacy-policy.jsp"><span>Privacy Policy</span></a>
	</li>
	<li>
		<a href="/legal/terms-use.jsp"><span>Terms of Use</span></a>
	</li>
	<li>
		<a href="/legal/user-submission-agreement.jsp"><span>User Submission Agreement</span></a>
	</li>
	<li>
		<a href="/legal/currency-agreement.jsp"><span>Virtual Currency Agreement</span></a>
	</li>
	<li>
		<a href="/legal/copyright.jsp"><span>Copyright Compliance Policy</span></a>
	</li>
</ul>
</div>

<div id="footerPageContent">
	<p align="center" class="pageTitle">
...
<script src="http://cdn.addictinggames.com/a/min/js/globalJsBodyPre.min.js?c=30"></script>
	<script type="text/javascript" src="http://cdn.addictinggames.com/a/js/libExternal/ag-coda.js?c=30"></script>
 		<script type="text/javascript" src="http://cdn.addictinggames.com/a/min/js/globalJsBodyPost.min.js?c=30"></script>
	<script type="text/javascript">
	...
	if ( ag.pageName === '' ) {
		ag.initialOmnitureEvents['pageName'] = window.location.pathname;
	} else {
		ag.initialOmnitureEvents['pageName'] = ag.pageName;
	}
	ag.initialOmnitureEvents['eVar13'] = ag.pageName;

	btg.Controller.sendPageCall( ag.initialOmnitureEvents );
</script>
<div id="js-footer" class="Footer">
    <div id="footerCategoryNav" class="clearfix">
        <ul class="clearfix">
            <li>
    ...
    <section class="footerFollowUs">
        <h3>Follow Us</h3>

        <div class="fb-page" data-href="https://www.facebook.com/AddictingGames" data-small-header="true" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="false" data-show-posts="false"><div class="fb-xfbml-parse-ignore"><blockquote cite="https://www.facebook.com/AddictingGames"><a href="https://www.facebook.com/AddictingGames">AddictingGames</a></blockquote></div></div>

        <a href="https://twitter.com/AddictingGames" class="twitter-follow-button" data-show-count="false">Follow @AddictingGames</a>
        <div class="g-follow" data-annotation="none" data-height="20" data-href="https://plus.google.com/103249522362605848405" data-rel="publisher"></div>
    </section>

    <section class="footerMoreCoolGames">
        <h3>More Cool Games</h3>
        <a href="http://www.shockwave.com/online/word-games.jsp">Word Games</a><br>
        <a href="http://www.shockwave.com">Free Online Games</a><br>
        <a href="http://www.shockwave.com/download.jsp">Download Games</a><br>
        <a href="http://www.shockwave.com/online/jigsaw-games.jsp">Jigsaw Puzzle Games</a><br>
    </section>

    <section class="footerContactUs">
        <h3>Contact</h3>
        <a href="/about/about-us.jsp">About Us</a><br>
        <a href="/help/help.jsp">Help</a><br>
        <a href="/support/contact-us.jsp">Contact Us</a><br>
        <a href="/game/upload.jsp">Submit a Game</a><br>
        <a href="/help/parents.jsp">For Parents</a><br>
    </section>

    <section class="footerMoreInfo">
        <h3>More Info</h3>
        <a href="/legal/terms-use.jsp" onclick="ag.setFindingMethod( event, ag.persistMetrics.push( 'prop26', agPageName ));">Terms of Use</a><br>
        <a href="/legal/currency-agreement.jsp">Virtual Currency Agreement</a><br>
        <a href="/legal/privacy-policy.jsp" onclick="ag.setFindingMethod( event, ag.persistMetrics.push( 'prop26', agPageName ));">Privacy Policy</a><br>
        <a href="/legal/copyright.jsp">Copyright Compliance</a><br>
        <a href="/help/content-ratings.jsp">What Do Our Warnings Mean</a><br>
    </section>

    <section class="footerCopyright">
        <p>Copyright &#169; 2017 Defy Media, LLC; all rights reserved.</p>
    ...
    <div id="footerStripeTape"></div>
    <div id="footerDuctTape"></div>
</div>

<!-- PAGEOK -->
<iframe src="http://images.webads.nl/stir/addictinggames_stir.htm" width="0" height="0" frameborder="no"></iframe><div id="fb-root"></div><div class="modalWrapper">
<div id="modalOverlay">
	<span id="modalTitle"></span>
	<span id="alternateAction"></span>
	<span id="modalCloseButton"></span>
	<div id="modalContent" class="clearfix"></div>
</div>
</div>
<div id="modalOverlayFogger"></div><div id="fragmentRoot"></div><script type="text/javascript">ag.staticAssetServer =  'cdn.addictinggames.com';</script>
<script type="text/javascript" src="http://ajax.googleapis.com/ajax/libs/jquery/2.1.4/jquery.min.js"></script>
<script type="text/javascript" src="http://cdn.addictinggames.com/a/min/js/global.min.js?c=30"></script>
	</div>
    <script type="text/javascript">
...
</script><!-- Ad Blocker Test & Tracking -->
