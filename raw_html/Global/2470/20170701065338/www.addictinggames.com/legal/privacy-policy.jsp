...
<link rel="stylesheet" type="text/css" href="http://cdn.addictinggames.com/a/min/css/global.min.css?c=31"/>
	<link rel="stylesheet" type="text/css" href="http://cdn.addictinggames.com/a/min/css/footerPages.min.css?c=31"/>
...
<ul class="navTabs">
	...
	<li class="customNavTabs">
			<a title="" target="_top" href="http://bit.ly/2rXtQfc" class="ga-nav">
				<img src="http://www.addictinggames.com/content-items/lego_friends_logo_w.png" alt="LEGO Friends"> </a>
		</li>
	<li class="customNavTabs">
...
<script src="http://cdn.addictinggames.com/a/min/js/globalJsBodyPre.min.js?c=31"></script>
	<script type="text/javascript" src="http://cdn.addictinggames.com/a/js/libExternal/ag-coda.js?c=31"></script>
 		<script type="text/javascript" src="http://cdn.addictinggames.com/a/min/js/globalJsBodyPost.min.js?c=31"></script>
	<script type="text/javascript">
...
<script type="text/javascript" src="http://cdn.addictinggames.com/a/min/js/global.min.js?c=31"></script>
	</div>
    <script type="text/javascript">
