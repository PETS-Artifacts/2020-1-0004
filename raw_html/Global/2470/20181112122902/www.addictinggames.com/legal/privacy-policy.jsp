...
--><script type="text/javascript">
	...
	</script><link rel="stylesheet" type="text/css" href="http://cdn.addictinggames.com/a/min/css/app.min.css?c=31"/>
	<script>
            ag.ADG = ag.ADG || {};
        ...
        <!-- FPS Networks/AddictingGames.com -->
    <script type="text/javascript" src="https://portal.cdn.yollamedia.com/storage/tag/ps3a21ed9389c3c60c71ddfc8340dceed451a88b5a.js"></script>
...
<div id="headerMoreFilters" class="headerMoreFilters">
	...
	<div id="reskinWrapper" class="reskinWrapper">
		...
		<div class="BlockContainer pt-3 pb-3">
			<div class="ympb_target text-center" data-type="desktop-leaderboard-template" data-subtype="728x90,970x90,970x250"></div>
<div class="ympb_target text-center" data-type="mobile-leaderboard-template" data-subtype="320x50"></div>
</div>
...
<script type="text/javascript" src="http://cdn.addictinggames.com/a/min/js/libs.min.js?c=31"></script>
		<script type="text/javascript" src="http://cdn.addictinggames.com/a/min/js/app.min.js?c=31"></script>
...
</script><div class="ympb_target" data-type="desktop-adhesion"></div>
<div class="ympb_target" data-type="mobile-adhesion"></div></body>
</html>