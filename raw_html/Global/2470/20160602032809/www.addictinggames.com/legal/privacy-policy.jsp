...
<link rel="stylesheet" type="text/css" href="http://cdn.addictinggames.com/a/min/css/global.min.css?c=7"/>
	<link rel="stylesheet" type="text/css" href="http://cdn.addictinggames.com/a/min/css/footerPages.min.css?c=7"/>
...
<script>
    ...
    // refreshRate variable for custom ad refresh rate in seconds - converted to miliseconds
    ...
    googletag.cmd.push(function() {
        googletag.defineSlot('/4678/addictinggames_web', [[728, 90], [970, 40], [970, 66], [970, 90], [970, 250], [960, 1]], 'div-gpt-ad-leaderboard').addService(googletag.pubads());
        googletag.defineSlot('/4678/addictinggames_web', [[300, 250]], 'div-gpt-ad-rectangle').addService(googletag.pubads());
        
            googletag.defineOutOfPageSlot('/4678/addictinggames_web', 'div-gpt-ad-oop').addService(googletag.pubads());
...
<script src="http://cdn.addictinggames.com/a/min/js/globalJsBodyPre.min.js?c=7"></script>
	<script type="text/javascript" src="http://cdn.addictinggames.com/a/js/libExternal/ag-coda.js?c=7"></script>
 		<script type="text/javascript" src="http://cdn.addictinggames.com/a/min/js/globalJsBodyPost.min.js?c=7"></script>
	<script type="text/javascript">
...
<div id="js-footer" class="Footer">
    ...
    <section class="footerMoreCoolGames">
        ...
        <a href="http://apps.facebook.com/addictinggames">Addicting Games</a><br>
    </section>
...
<script type="text/javascript" src="http://cdn.addictinggames.com/a/min/js/global.min.js?c=7"></script>
	</div>
    <script type="text/javascript">
...
<script>
	if (window.canRunAds === undefined) {
	  // adblocker detected, show console log
	  console.log('adblocker detected');
	  dataLayer.push({
	  	eCategory : 'ad block test',
	  	eAction : 'ad blocked',
	  	event : 'trackEvent'
	  });
	} else {
		console.log('canRunAds is set to ' + canRunAds);
		dataLayer.push({
			eCategory : 'ad block test',
			eAction	: 'not ad blocked',
			event : 'trackEvent'
		});
	}
