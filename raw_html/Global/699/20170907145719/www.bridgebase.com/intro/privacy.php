...
<div class="navtable">
   &nbsp;&nbsp;&nbsp;<a href="http://www.bridgebase.com/">Home</a>
 		...
 		<div id="navbar" class="nav navbar-collapse collapse">
				...
				<div class="container">
					<ul class="nav navbar-nav">
						<li><a href="http://www.bridgebase.com/vugraph/schedule.php" target="_blank">Vugraph Schedule</a></li>
						<li><a href="http://www.bridgebase.com/myhands/index.php" target="_blank">Hand Records</a></li>
						<li><a href="http://www.bridgebase.com/points/index.php" target="_blank">BBO Points</a></li>
...
<br />
<br />
<div style=background-color:yellow;>We will ask you for your username, password, and a valid email address during the registration process.</div>
<br />
<div style=background-color:yellow;>You need not enter your real name in the registration form or your profile. The public portion of your profile (Name, country, skill level, other information) will be visible to every other member of the site.
</div>
<p>
...
<p>
<span style=background-color:yellow;> BBO may also disclose your personal information to cooperate with our partners in abuse-related investigations.</span> For instance: ACBL requires that BBO report the names of players who have been banned from ACBL games.
<p>
...
<p>
<div style=background-color:yellow;> The public portion of your profile (Name, email, country, skill level, other information) will be visible to every other member of the site. 
</div>
<p>
...
We sometimes use your local storage ( typically, your hard drive ) to store your preferences (for example: screen size, screen position ).
If you choose to have the Site remember your username and password, the Site will encrypt these fields weakly and save them in local storage. 
<p>
<span style=background-color:yellow;> Your chat logs, including your private chat logs, are recorded  to local storage in some versions of the Site.</span>
You have the ability to direct that these versions of the Site stop recording chat. You also have the abilty to erase previously logged chat. Both can be found in the Preferences section of the Site.
<p>
Some versions of the Site grant you the ability to automatically save hands that you have either played or viewed.  
You have the ability to specify that these versions of the Site stop recording hands. This can be specified in the Preferences section of the Site.
...
BBO welcomes your comments regarding this privacy statement. If you have questions about this statement or believe that we have not adhered to it, please contact us by clicking <a href=mailto:support@bridgebase.com>here</a>.  You may also contact us through postal mail at the address provided below and we will use commercially reasonable efforts to promptly determine and remedy the problem.
...
<br><!-- END CONTENT -->
    ...
    <div class="container bbo_footer" >
        <div class="row">
            ...
            <footer>
                &copy; 2017 Bridge Base Online, Inc. &bull;
