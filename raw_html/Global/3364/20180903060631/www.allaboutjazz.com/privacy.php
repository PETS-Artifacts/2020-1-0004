...
<head class="notie">
	...
	<link rel="stylesheet" href="//www.allaboutjazz.com/css-not-cached/aaj_v9-04-2018.css" media="all" />
...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-1973392-1"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());
  gtag('config', 'UA-1973392-1');
</script>
...
<body class="body-www">
<header class="header aaj-header">
	<nav class="navbar navbar-default navbar-fixed-top">		
		<div class="container primary">	
			<div class="navbar-header pull-left">
				<a href="//www.allaboutjazz.com" title="All About Jazz" class="navbar-logo pull-left">
					All About Jazz
				</a>
...
<li class="nav-search li-last">
	...
	<div class="container">
		...
		<p class="text-large">
		<span class="hide-360"><a title="All About Jazz home page" href="//www.allaboutjazz.com">Home</a> &#187;</span>	
	Privacy Policy		</p>
...
<p>All About Jazz / Jazz Near You is 100% GDPR compliant and though we store a user's email address upon registration, subsequent use of that email address is for internal communication purposes only (e.g. private messages and Jazz Near You email subscription). As stated above, a user's email address and general location are not shared. The weekly Jazz Near You eblast is an opt-in mailing. To unsubscribe, either click the unsubscribe link in the weekly email or uncheck the subscribe box on your member settings page.</p>
...
<div class="flex-container showcase-block bottom-20">
	<div id="showcaseSlider" class="flexslider clearfix"><!--feat-cont-box-->
		<ul class="slides clearfix">
						<li>					
				<img class="showcase-img rad-5" src="//www.allaboutjazz.com/images/ads/showcase/orderitem-710-448696445.jpg" width="350" height="400" />
				<div class="showcase-album">
<a href="http://bit.ly/2PdfQGv" class="pic-100" title="Order Family Feeling by Terell Stafford">
<img src="https://s3.amazonaws.com/allaboutjazz/coverart/large/f83897b940e48abf9f3f13698d0b7057.jpg" width="100" height="100" alt="Family Feeling - showcase release by Terell Stafford" />
</a>
<a href="http://bit.ly/2PdfQGv" class="btn btn-warning btn-xs btn-block" title="Order Family Feeling by Terell Stafford"><i class="fa fa-shopping-cart"></i> Buy Now</a>
				</div>
				<h4><span>Family Feeling</span> by <a href="//musicians.allaboutjazz.com/terellstafford">Terell Stafford</a></h4>
			</li>
						<li>					
				<img class="showcase-img rad-5" src="//www.allaboutjazz.com/images/ads/showcase/orderitem-4822-129573806.png" width="350" height="400" />
				<div class="showcase-album">
<a href="http://bit.ly/2wKcgMu" class="pic-100" title="Order Songs on the eve of dismissal by Chris Abelen">
<img src="https://s3.amazonaws.com/allaboutjazz/coverart/large/18a165ad45952aea5c1617bd52c3a478.jpg" width="100" height="100" alt="Songs on the eve of dismissal - showcase release by Chris Abelen" />
</a>
<a href="http://bit.ly/2wKcgMu" class="btn btn-warning btn-xs btn-block" title="Order Songs on the eve of dismissal by Chris Abelen"><i class="fa fa-shopping-cart"></i> Buy Now</a>
				</div>
				<h4><span>Songs on the eve of...</span> by <a href="//musicians.allaboutjazz.com/chrisabelen">Chris Abelen</a></h4>
			</li>
						<li>					
				<img class="showcase-img rad-5" src="//www.allaboutjazz.com/images/ads/showcase/orderitem-4750-1542277252.jpg" width="350" height="400" />
				<div class="showcase-album">
<a href="http://bit.ly/2oiCK33" class="pic-100" title="Order Venetian Blinds by Mike Freeman">
<img src="https://s3.amazonaws.com/allaboutjazz/coverart/large/d0721537629511a3299b653d9e62b725.jpg" width="100" height="100" alt="Venetian Blinds - showcase release by Mike Freeman" />
</a>
<a href="http://bit.ly/2oiCK33" class="btn btn-warning btn-xs btn-block" title="Order Venetian Blinds by Mike Freeman"><i class="fa fa-shopping-cart"></i> Buy Now</a>
				</div>
				<h4><span>Venetian Blinds</span> by <a href="//musicians.allaboutjazz.com/mikefreeman">Mike Freeman</a></h4>
			</li>
						<li>					
				<img class="showcase-img rad-5" src="//www.allaboutjazz.com/images/ads/showcase/orderitem-4712-643734167.jpg" width="350" height="400" />
				<div class="showcase-album">
<a href="http://bit.ly/2mexQmg" class="pic-100" title="Order Encontros - Orquestra Atlantica by Antonio Adolfo">
<img src="https://s3.amazonaws.com/allaboutjazz/coverart/large/682ab2d81bdef163263b9366f627b923.jpg" width="100" height="100" alt="Encontros - Orquestra Atlantica - showcase release by Antonio Adolfo" />
</a>
<a href="http://bit.ly/2mexQmg" class="btn btn-warning btn-xs btn-block" title="Order Encontros - Orquestra Atlantica by Antonio Adolfo"><i class="fa fa-shopping-cart"></i> Buy Now</a>
				</div>
				<h4><span>Encontros - Orquestra...</span> by <a href="//musicians.allaboutjazz.com/antonioadolfo">Antonio Adolfo</a></h4>
			</li>
					</ul>			
...
<div class="hide-992">
		<!-- District M SuperTag Script for 204432 / AAJ code -->
	<script type='text/javascript' src='//st.districtm.ca/params.204432.js'></script>
	<script type='text/javascript'>
...
<div class="bottom-20">
	<h4>
		<a href="//bit.ly/2MxV5U9" class="callout-link" title="Featured Product or Event">Featured Event <i class="fa fa-arrow-right"></i></a>
	</h4>
	<a target="_blank" href="//bit.ly/2MxV5U9">
		<img class="img-responsive bottom-10" src="//www.allaboutjazz.com/images/ads/bigbopper/orderitem-4438-1334465189.jpg">
	</a>
	<a target="_blank" href="//bit.ly/2MxV5U9">First Annual Jazz Industry Day Conference scheduled for September 13 in Philadelphia</a>
</div>
<hr>
...
<div class="row bottom-60">
	...
	<div class="col-xs-6 col-sm-3 bottom-20 col-foot">
		<h3>Services</h3>
		<ul> 
			<li><a href="//news.allaboutjazz.com/download-the-all-about-jazz-musician-starter-guide.php" target="_blank">Musician Primer</a></li>
	...
	<div class="col-xs-6 col-sm-3 bottom-20 col-foot">
		...
		<ul>					
			...
			<li><a href="//www.jazznearyou.com/faq.php" target="_blank">Support FAQ</a></li>						
...
<div class="row bottom-20 text-center">        
	<a href="//www.allaboutjazz.com/" title="The most comprehensive jazz resource on Earth!">
		...
		<img src="//www.allaboutjazz.com/images/aaj-logo-horizontal.svg" alt="All About Jazz logo" width="220" />
	</a>
</div>
<a href="#" class="up"><i class="fa fa-arrow-up"></i></a>
<p class="text-center">&copy; 2018 <a href="//www.allaboutjazz.com/">All About Jazz</a> | <a href="//www.allaboutjazz.com/privacy_2018.php">Privacy Policy</a></p>		</div>
</footer>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
		...
		<h4 class="modal-title">Join Our Community / Welcome Back!</h4>
      </div>
      <div class="modal-body">
        <ul class="nav nav-pills" role="tablist" id="login_ul">
            <li id="signinli" role="presentation" class="active"><a id="a_signin" href="#signinli_tab" aria-controls="signinli_tab" role="tab" data-toggle="pill">Member? Sign in</a></li>
            <li id="signupli" role="presentation"><a id="a_signup" href="#signupli_tab" aria-controls="signupli_tab" role="tab" data-toggle="pill">Sign up</a></li>
        </ul>
		...
		<button class="btn btn-success" type="submit" id="bsubmit">Sign in</button>
            ...
            <div id="signupli_tab" role="tabpanel" class="tab-pane fade">
				<form method="POST" action="#" id="signupform" class="container-fluid">
					<p>Membership has its privileges. <a href="//www.allaboutjazz.com/php/membership.php" target="_blank">Learn more</a>.</p>
					<hr>
<div class="row">
...
<div class="row" id="p_city" >
  <label for="city_subd" class="col-xs-12 col-sm-6 control-label">Closest City</label>
  <div class="col-xs-12 col-sm-6">
...
<div class="modal fade" id="sitemap_overlay" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
	...
	<ul>
		<li><a href="/php/article_center.php" title="Search our article archive">19,898 Articles</a></li>
		<li><a href="/php/review_center.php" title="Search our review archive">48,406 Album Reviews</a></li>
		<li><a href="/php/contributor_center.php" title="Meet the staff">1,240 Contributors</a></li>
	</ul>
</div>
    					</div>
					<div class="col-xs-12 col-sm-3">
				...
				<div class="row modal-text-content">
					...
					<div class="col-xs-12 col-sm-4">
						...
						<ul>				
							...
							<li><a href="//www.allaboutjazz.com/php/article_center.php?in_type=244">In Pictures Column</a></li>							
						</ul>
					</div>
					<div class="col-xs-12 col-sm-4">
						<h3>For Pros</h3>
										...
										<h3>Gallery Stats</h3>
<ul>
	<li><span>163,219 Images</span></li>
	<li><span>210 Visual Artists</span></li>
	<li><span>11,635 Uploaders</span></li>
</ul>
    					</div>
				</div>
			</div>
			<div role="tabpanel" class="tab-pane fade in" id="musicians_tab">
				<div class="row modal-text-content">
					<div class="col-xs-12 col-sm-6">
						...
						<form id="aajsearch_musician_form" action="//musicians.allaboutjazz.com/index.php" method="post">
							<div class="row">
								<label class="col-xs-12 col-sm-4">by <strong>name</strong></label>
								<div class="col-xs-12 col-sm-8">
									<input name="in_name" id="aajsearch_musician" type="text" value="">
									<input name="aajsearch_musician_id" id="aajsearch_musician_id" type="hidden" value="">
								</div>
							</div>
							<div class="row">
							...
							<div class="row">
								<div class="col-xs-12 col-sm-8 pull-right">
									<button id="msearch_button" type="button" class="btn btn-success">Find!</button>
								</div>
							</div>
						</form>
						<hr>
...
<script src="//www.allaboutjazz.com/js2/privacy.js"></script>
<script>
