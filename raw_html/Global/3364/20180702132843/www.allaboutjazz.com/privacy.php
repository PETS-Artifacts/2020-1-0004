...
<a href="https://amzn.to/2G3ZJ8l" class="btn btn-warning btn-xs btn-block" title="Order Dreaming Spirits by Mark Egan"><i class="fa fa-shopping-cart"></i> Buy Now</a>
				...
				<h4><span>Dreaming Spirits</span> by <a href="//musicians.allaboutjazz.com/markegan">Mark Egan</a></h4>
						...
						<li>					
				<img class="showcase-img rad-5" src="//www.allaboutjazz.com/images/ads/showcase/orderitem-4536-6865414.jpg" width="350" height="400" />
				<div class="showcase-album">
<a href="http://bit.ly/2tjvRB5" class="pic-100" title="Order Meeting of Minds by Bob Mintzer">
<img src="https://s3.amazonaws.com/allaboutjazz/coverart/large/03b8cbf4294cef2ebff11c9905beca6f.jpg" width="100" height="100" alt="Meeting of Minds - showcase release by Bob Mintzer" />
</a>
<a href="http://bit.ly/2tjvRB5" class="btn btn-warning btn-xs btn-block" title="Order Meeting of Minds by Bob Mintzer"><i class="fa fa-shopping-cart"></i> Buy Now</a>
				</div>
				<h4><span>Meeting of Minds</span> by <a href="//musicians.allaboutjazz.com/bobmintzer">Bob Mintzer</a></h4>
			</li>
						<li>					
...
<a href="http://bit.ly/2IhF3zr" class="btn btn-warning btn-xs btn-block" title="Order Sebastiana by Ricardo Bacelar"><i class="fa fa-shopping-cart"></i> Buy Now</a>
				...
				<h4><span>Sebastiana</span> by <a href="//musicians.allaboutjazz.com/ricardobacelar">Ricardo Bacelar</a></h4>
						...
						<li>					
				<img class="showcase-img rad-5" src="//www.allaboutjazz.com/images/ads/showcase/orderitem-4454-1218004645.jpg" width="350" height="400" />
				<div class="showcase-album">
<a href="http://bit.ly/2kX4wA9" class="pic-100" title="Order Still Dreaming by Joshua Redman">
<img src="https://s3.amazonaws.com/allaboutjazz/coverart/large/9dae96cd67fdc51e39f9dad653a71bd7.jpg" width="100" height="100" alt="Still Dreaming - showcase release by Joshua Redman" />
</a>
<a href="http://bit.ly/2kX4wA9" class="btn btn-warning btn-xs btn-block" title="Order Still Dreaming by Joshua Redman"><i class="fa fa-shopping-cart"></i> Buy Now</a>
				</div>
				<h4><span>Still Dreaming</span> by <a href="//musicians.allaboutjazz.com/joshuaredman">Joshua Redman</a></h4>
			</li>
					</ul>			
...
<div class="bottom-20">
	<h4>
		<a href="//bit.ly/2sXHjCz" class="callout-link" title="Featured Product or Event">Featured Event <i class="fa fa-arrow-right"></i></a>
	</h4>
	<a target="_blank" href="//bit.ly/2sXHjCz">
		<img class="img-responsive bottom-10" src="//www.allaboutjazz.com/images/ads/bigbopper/orderitem-4505-1789809077.png">
	</a>
	<a target="_blank" href="//bit.ly/2sXHjCz">Latin Love Boat Valentine's Day Weekend 2019 - Book Now!</a>
</div>
<hr>
...
<div class="modal fade" id="sitemap_overlay" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
	...
	<ul>
		<li><a href="/php/article_center.php" title="Search our article archive">19,693 Articles</a></li>
		<li><a href="/php/review_center.php" title="Search our review archive">48,085 Album Reviews</a></li>
		<li><a href="/php/contributor_center.php" title="Meet the staff">1,233 Contributors</a></li>
	</ul>
</div>
    					</div>
					<div class="col-xs-12 col-sm-3">
				...
				<div class="row modal-text-content">
					...
					<div class="col-xs-12 col-sm-4">
						<h3>For Pros</h3>
										...
										<h3>Gallery Stats</h3>
<ul>
	<li><span>160,074 Images</span></li>
	<li><span>208 Visual Artists</span></li>
	<li><span>11,467 Uploaders</span></li>
</ul>
    					</div>
				</div>
			</div>
