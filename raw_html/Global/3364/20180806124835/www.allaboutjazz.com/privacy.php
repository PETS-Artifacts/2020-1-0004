...
<head class="notie">
	...
	<link rel="stylesheet" href="//www.allaboutjazz.com/css-not-cached/aaj_v7-10-2018.css" media="all" />
...
<div class="flex-container showcase-block bottom-20">
	<div id="showcaseSlider" class="flexslider clearfix"><!--feat-cont-box-->
		<ul class="slides clearfix">
						<li>					
				<img class="showcase-img rad-5" src="//www.allaboutjazz.com/images/ads/showcase/orderitem-4549-377693521.jpg" width="350" height="400" />
...
<div class="bottom-20">
	<h4>
		<a href="//bit.ly/2v6Ehfu" class="callout-link" title="Featured Product or Event">Featured Event <i class="fa fa-arrow-right"></i></a>
	</h4>
	<a target="_blank" href="//bit.ly/2v6Ehfu">
		<img class="img-responsive bottom-10" src="//www.allaboutjazz.com/images/ads/bigbopper/orderitem-3553-453007850.png">
	</a>
	<a target="_blank" href="//bit.ly/2v6Ehfu">Ottawa JazzWorks Jazz Camp And Composers Symposium, August 13-19, 2018. Register Now!</a>
</div>
<hr>
...
<div class="modal fade" id="sitemap_overlay" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
	...
	<ul>
		<li><a href="/php/article_center.php" title="Search our article archive">19,801 Articles</a></li>
		<li><a href="/php/review_center.php" title="Search our review archive">48,265 Album Reviews</a></li>
		<li><a href="/php/contributor_center.php" title="Meet the staff">1,234 Contributors</a></li>
	</ul>
</div>
    					</div>
					<div class="col-xs-12 col-sm-3">
				...
				<div class="row modal-text-content">
					...
					<div class="col-xs-12 col-sm-4">
						<h3>For Pros</h3>
										...
										<h3>Gallery Stats</h3>
<ul>
	<li><span>161,268 Images</span></li>
	<li><span>208 Visual Artists</span></li>
	<li><span>11,503 Uploaders</span></li>
</ul>
    					</div>
				</div>
			</div>
