...
<head class="notie">
	...
	<link rel="stylesheet" href="//www.allaboutjazz.com/css-not-cached/aaj_v1-5-2019.css" media="all" />
...
</script><script src="//www.allaboutjazz.com/compressor.php?params=js/jquery.autocomplete-min/paginator3000/jquery.flexslider-min/aaj_search_bootstrap/follow/aaj_login_v3/contrib_bootstrap/v1.js"></script>
<!-- Google Captcha -->
		...
		<div class="container primary">	
			...
			<div class="collapse navbar-collapse pull-left" id="navbar_collapse">
				<ul class="nav navbar-nav">
					...
					<li class="li-last">
						<a href="//media.allaboutjazz.com/radio.php" title="Radio Free Jazz">Radio</a>
					</li>					
				</ul>
			</div><!--/.nav-collapse -->
...
<li class="nav-search li-last">
	...
	<div class="pattern">	
		...
		-->
		<div class="link-about" style="background:red !important;">
			<a href="https://www.allaboutjazz.com/php/polls.php" title="Jazz Polls" style="color: #fff;">JAZZ POLLS |</a> <a href="https://www.allaboutjazz.com/php/poll_result.php?id=21" title="Cast your vote!" style="color: #fff;">VOTE</a>
		</div>
...
<h4 class="bottom-20 uppercase"><a href="//www.allaboutjazz.com/php/showcase.php" title="About New Album Showcase">Album Showcase</a></h4>
<div class="flex-container showcase-block bottom-20">
	<div id="showcaseSlider" class="flexslider clearfix"><!--feat-cont-box-->
		<ul class="slides clearfix">
						<li>					
				<img class="showcase-img rad-5" src="//www.allaboutjazz.com/images/ads/showcase/orderitem-5452-145171685.jpg" width="350" height="400" />
				<div class="showcase-album">
<a href="http://bit.ly/2DEQQ72" class="pic-100" title="Order Trio Tapestry by Joe Lovano">
<img src="https://s3.amazonaws.com/allaboutjazz/coverart/large/2cce1eef27f995811829dba3bbecd11a.jpg" width="100" height="100" alt="Trio Tapestry - showcase release by Joe Lovano" />
</a>
<a href="http://bit.ly/2DEQQ72" class="btn btn-warning btn-xs btn-block" title="Order Trio Tapestry by Joe Lovano"><i class="fa fa-shopping-cart"></i> Buy Now</a>
				</div>
				<h4><span>Trio Tapestry</span> by <a href="//musicians.allaboutjazz.com/joelovano">Joe Lovano</a></h4>
			</li>
						<li>					
				<img class="showcase-img rad-5" src="//www.allaboutjazz.com/images/ads/showcase/orderitem-5296-789561118.jpg" width="350" height="400" />
				<div class="showcase-album">
<a href="https://amzn.to/2AtJTni" class="pic-100" title="Order East Of The Sun by Michael Kocour">
<img src="https://www.allaboutjazz.com/coverart/large/EOfSCover.jpg" width="100" height="100" alt="East Of The Sun - showcase release by Michael Kocour" />
</a>
<a href="https://amzn.to/2AtJTni" class="btn btn-warning btn-xs btn-block" title="Order East Of The Sun by Michael Kocour"><i class="fa fa-shopping-cart"></i> Buy Now</a>
				</div>
				<h4><span>East Of The Sun</span> by <a href="//musicians.allaboutjazz.com/michaelkocour">Michael Kocour</a></h4>
			</li>
						<li>					
				<img class="showcase-img rad-5" src="//www.allaboutjazz.com/images/ads/showcase/orderitem-5303-579974233.jpg" width="350" height="400" />
				<div class="showcase-album">
<a href="https://amzn.to/2FZUw56" class="pic-100" title="Order Picture in Black and White by Tessa Souter">
<img src="https://s3.amazonaws.com/allaboutjazz/coverart/large/60bb8db5c57501e6761af900f8bbc20c.jpg" width="100" height="100" alt="Picture in Black and White - showcase release by Tessa Souter" />
</a>
<a href="https://amzn.to/2FZUw56" class="btn btn-warning btn-xs btn-block" title="Order Picture in Black and White by Tessa Souter"><i class="fa fa-shopping-cart"></i> Buy Now</a>
				</div>
				<h4><span>Picture in Black and White</span> by <a href="//musicians.allaboutjazz.com/tessasouter">Tessa Souter</a></h4>
			</li>
					</ul>			
    ...
    <div class="bottom-40 sbar-item sbar-item--height2">    
...
<p class="text-center">&copy; 2019 <a href="//www.allaboutjazz.com/">All About Jazz</a> | <a href="//www.allaboutjazz.com/privacy_2018.php">Privacy Policy</a></p>	</div>
</footer>
...
<div class="modal fade" id="signuped" tabindex="-1" role="dialog">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				We sent a confirmation message to <span id="newperson_email"></span>. Look for it, then click the link to activate your account. If you don’t see the email in your inbox, check your spam, bulk or promotions folder.<br/>
...
<div class="modal fade" id="sitemap_overlay" tabindex="-1" role="dialog">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
      ...
      <div class="modal-body">
		<ul class="nav nav-pills" role="tablist" id="ul_seach">
			...
			<li role="presentation"><a href="#reviews_tab" aria-controls="reviews_tab" role="tab" data-toggle="pill">Reviews</a></li>
      ...
      <div role="tabpanel" class="tab-pane fade in" id="member_tab">
			...
			<div role="tabpanel" class="tab-pane fade in" id="reviews_tab">
				<div class="row modal-text-content">
					<div class="col-xs-12 col-sm-6">	
						<h3>Search Reviews</h3>
						<form action="//www.allaboutjazz.com/php/review_center.php" method="get">
							<div class="row">
								<label class="col-xs-12 col-sm-4">by <strong>musician</strong></label>
								<div class="col-xs-12 col-sm-8">
									<input type="text" id="aajsearch_artist_review" name="in_artist" value="" />
								</div>
							</div>
							<div class="row">
								<label class="col-xs-12 col-sm-4">by <strong>record label</strong></label>
								<div class="col-xs-12 col-sm-8">
									<input type="text" id="aajsearch_label_review" name="in_label" value="">
								</div>
							</div>
							<div class="row">
								<label class="col-xs-12 col-sm-4">by <strong>year released</strong></label>
								<div class="col-xs-12 col-sm-8">
							...
							<div class="row">
								<label class="col-xs-12 col-sm-4">by <strong>star rating</strong></label>
								<div class="col-xs-12 col-sm-8">
									<select name="contrib_rating"><option value="">&nbsp;</option><option value="10">5</option><option value="9">4 &frac12</option><option value="8">4</option><option value="7">3 &frac12</option><option value="6">3</option><option value="5">2 &frac12</option><option value="4">2</option><option value="3">1 &frac12</option><option value="2">1</option><option value="1">&frac12</option><option value="0">0</option></select>
								</div>
							</div>		
	...
	<ul>
		<li><a href="/php/article_center.php" title="Search our article archive">20,485 Articles</a></li>
		<li><a href="/php/review_center.php" title="Search our review archive">49,204 Album Reviews</a></li>
		<li><a href="/php/contributor_center.php" title="Meet the staff">1,259 Contributors</a></li>
	</ul>
</div>
    					</div>
					<div class="col-xs-12 col-sm-3">
				...
				<div class="row modal-text-content">
					...
					<div class="col-xs-12 col-sm-4">
						<h3>For Pros</h3>
										...
										<h3>Gallery Stats</h3>
<ul>
	<li><span>170,411 Images</span></li>
	<li><span>215 Visual Artists</span></li>
	<li><span>12,249 Uploaders</span></li>
</ul>
    					</div>
				</div>
			</div>
					...
					<div class="col-xs-12 col-sm-6">	
						...
						<form action="//news.allaboutjazz.com/index.php" method="post">
							...
							<div class="row">
								...
								<div class="col-xs-12 col-sm-8">
									<input name="in_source" id="aajsearch_newssource" type="text" value="">
									<input name="aajsearch_newssource_id" id="aajsearch_newssource_id" type="hidden" value="">
									<!-- <select name="in_entity"></select> -->
								</div>
							</div>
...
<a target="_blank" href="https://itunes.apple.com" title="Shop for music at iTunes" target="_blank"><img src="https://www.allaboutjazz.com/images/ituneslogo106x22.png" width="106" height="22" /></a>
					</div>
				</div>
				<hr />
				<div class="row modal-text-content">
...
<div id="amzn-assoc-ad-861809e9-d0c0-42d9-8808-3aaa15febaa8"></div><script async src="//z-na.amazon-adsystem.com/widgets/onejs?MarketPlace=US&adInstanceId=861809e9-d0c0-42d9-8808-3aaa15febaa8"></script></body>
</html>