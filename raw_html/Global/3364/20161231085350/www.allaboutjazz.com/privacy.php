...
<head class="notie">
	...
	<!--<meta property="og:url" content="https://www.allaboutjazz.com/privacy.php" />-->
...
<link rel="stylesheet" href="//www.allaboutjazz.com/css/2016/bootstrap.min.css" media="all" />
...
<script>
  ...
  ga('send', 'pageview');
	...
	<script src="//www.allaboutjazz.com/js2/jquery-2.1.3.min.js"></script>
<!--<![endif]-->
...
<div class="page-box">
	...
	<nav class="navbar navbar-default navbar-fixed-top">
		<div class="container primary">
			<button title="Search All About Jazz" data-toggle="modal" data-target="#search_overlay" class="btn btn-xs btn-primary" id="btn-search">
			...
			<div class="collapse navbar-collapse" id="navbar_collapse">
				<ul class="nav navbar-nav">
					...
					<li>
						<a href="//media.allaboutjazz.com/" title="Download Thousands of Free MP3s">Downloads</a>
					</li>
					<li><a title="View Local Events, Venue Listings and More!" href="//www.jazznearyou.com" target="_blank">Events</a></li>					
					<li>
						<a href="//photos.allaboutjazz.com" title="Jazz Image Gallery">Gallery</a>
					</li>					
					<li>
			...
			<ul class="nav navbar-right">
				<li class="dropdown li-only" id="nav-follow">
					...
					<ul class="dropdown-menu">				
						<li>
							<a href="//twitter.com/AllAboutJazz" target="_blank" title="Visit All About Jazz on Twitter"><i class="fa fa-twitter"></i>Twitter</a>
						</li>
						<li>
						...
						<li>
							<a href="//plus.google.com/+Allaboutjazz" target="_blank" title="All About Jazz on Google"><i class="fa fa-google-plus"></i>Google +</a>
						</li>					
						<li>
							<a href="//www.allaboutjazz.com/php/live/rss.php" title="Subscribe to the All About Jazz RSS Feeds"><i class="fa fa-rss"></i>RSS</a>
						</li>
						<li>
							<a href="//www.allaboutjazz.com/php/live/index.php" title="Use the All About Jazz Content Widgets on Your Website or blog"><i class="fa fa-cog"></i>Widgets</a>
						</li>				
					</ul>
				</li>
			</ul>
    ...
    <div class="container">
		...
		<div id="logo-aaj" class="logo-container">
            <h2><a href="//www.allaboutjazz.com" title="All About Jazz">All About Jazz</a></h2>
        </div>
	...
	<li id="status-load">
		<img src="//www.allaboutjazz.com/icon/049.gif" alt="" width="40" height="5" /> <span>Loading...</span>
	</li>
	<li class="authorization"><a  onclick="signin(1); return false;" href="javascript:void(0);" title="Sign up and get a free local concert calendar newsletter plus much more!" data-toggle="modal" data-target="#login-box">Sign Up</a></li>
...
<div class="flex-container showcase-block bottom-20">
	<div id="showcaseSlider" class="flexslider clearfix"><!--feat-cont-box-->
		<ul class="slides clearfix">
						<li>					
				<img class="showcase-img" src="//www.allaboutjazz.com/images/ads/showcase/orderitem-461-1410716425.jpg" alt="">
				<div class="showcase-album">
<a href="http://apple.co/2iftoTk" class="pic-100" title="Order Song by Jobic Le Masson">
<img src="https://www.allaboutjazz.com/coverart/large/song.jpg" width="100" height="100" alt="Song - showcase release by Jobic Le Masson" />
</a>
<a href="http://apple.co/2iftoTk" class="btn btn-warning btn-xs" title="Order “Song” by Jobic Le Masson"><i class="fa fa-shopping-cart"></i> Buy Now</a>
				</div>
				<h4><span>Song</span> by <a href="//musicians.allaboutjazz.com/jobiclemasson">Jobic Le Masson</a></h4>
			</li>
						<li>					
				<img class="showcase-img" src="//www.allaboutjazz.com/images/ads/showcase/orderitem-2401-1726334650.jpg" alt="">
				<div class="showcase-album">
<a href="http://bit.ly/2hzIgtO" class="pic-100" title="Order Pacific Lounge by David Herzhaft">
<img src="https://www.allaboutjazz.com/coverart/large/Finalcoverweb.jpg" width="100" height="100" alt="Pacific Lounge - showcase release by David Herzhaft" />
</a>
<a href="http://bit.ly/2hzIgtO" class="btn btn-warning btn-xs" title="Order “Pacific Lounge” by David Herzhaft"><i class="fa fa-shopping-cart"></i> Buy Now</a>
				</div>
				<h4><span>Pacific Lounge</span> by <a href="//musicians.allaboutjazz.com/davidherzhaft">David Herzhaft</a></h4>
			</li>
						<li>					
				<img class="showcase-img" src="//www.allaboutjazz.com/images/ads/showcase/orderitem-2297-1288975772.jpg" alt="">
				<div class="showcase-album">
<a href="http://bit.ly/2fZagVm" class="pic-100" title="Order Forgive And Forget by Terell Stafford">
<img src="https://www.allaboutjazz.com/coverart/large/terellstaffordforgive.jpg" width="100" height="100" alt="Forgive And Forget - showcase release by Terell Stafford" />
</a>
<a href="http://bit.ly/2fZagVm" class="btn btn-warning btn-xs" title="Order “Forgive And Forget” by Terell Stafford"><i class="fa fa-shopping-cart"></i> Buy Now</a>
				</div>
				<h4><span>Forgive And Forget</span> by <a href="//musicians.allaboutjazz.com/terellstafford">Terell Stafford</a></h4>
			</li>
						<li>					
				<img class="showcase-img" src="//www.allaboutjazz.com/images/ads/showcase/orderitem-2492-533342838.jpeg" alt="">
				<div class="showcase-album">
<a href="http://apple.co/2iefTmK" class="pic-100" title="Order We Are One by Ingrid Nomad">
<img src="https://www.allaboutjazz.com/coverart/large/1-IMG_1742-002600x600.jpg" width="100" height="100" alt="We Are One - showcase release by Ingrid Nomad" />
</a>
<a href="http://apple.co/2iefTmK" class="btn btn-warning btn-xs" title="Order “We Are One” by Ingrid Nomad"><i class="fa fa-shopping-cart"></i> Buy Now</a>
				</div>
				<h4><span>We Are One</span> by <a href="//musicians.allaboutjazz.com/ingridnomad">Ingrid Nomad</a></h4>
			</li>
						<li>					
				<img class="showcase-img" src="//www.allaboutjazz.com/images/ads/showcase/orderitem-710-1186338520.jpg" alt="">
				<div class="showcase-album">
<a href="http://amzn.to/2iFdXVy" class="pic-100" title="Order Day & Night by Lisa Hilton">
<img src="https://www.allaboutjazz.com/coverart/large/61jz4h010aL_.jpeg" width="100" height="100" alt="Day & Night - showcase release by Lisa Hilton" />
</a>
<a href="http://amzn.to/2iFdXVy" class="btn btn-warning btn-xs" title="Order “Day & Night” by Lisa Hilton"><i class="fa fa-shopping-cart"></i> Buy Now</a>
				</div>
				<h4><span>Day & Night</span> by <a href="//musicians.allaboutjazz.com/lisahilton">Lisa Hilton</a></h4>
			</li>
					</ul>			
		<!-- //github.com/woothemes/FlexSlider/wiki/FlexSlider-Properties -->
			...
			<div class="bottom-40" id="jazzstory_section">
				<div class="pull-right caption-text top-10">
					<a href="//bit.ly/1S2FuJz" title="Submit Your Jazz Story">About Jazz Story</a>
				</div>
				<h2 class="bottom-20"><a href="//www.allaboutjazz.com/php/member_stories.php" class="callout-link" title="Jazz Stories">Jazz Stories <i class="fa fa-arrow-right"></i></a> </h2>
				<blockquote class="quote-text">
				<div id="firstpart_story">
					<p>I was first exposed to jazz by three of my uncles who bought a lot of Jazz: Ahmed Jamal, Miles, Jimmy Smith, Brubeck, etc.  For 
Christmas when I was in the 8th grade I requested and got Quincy Jones - Gula Metari & Walking in Space albums</p>
				...
				<div id="lastpart_story" style="display:none;">
					<p>I was first exposed to jazz by three of my uncles who bought a lot of Jazz: Ahmed Jamal, Miles, Jimmy Smith, Brubeck, etc.  For 
Christmas when I was in the 8th grade I requested and got Quincy Jones - Gula Metari & Walking in Space albums. My Dad was... Whaaat... and I still have the albums! Now I program TheBocX.com!</p>
			...
			<a href="//www.allaboutjazz.com/php/profile.php?id=31934" title="Visit Philip Dorsey"><img src="https://www.allaboutjazz.com/photos/profile/dj-phil-702x402.png" class="pic-60 f-left pic-round" height="60" alt="View Philip Dorsey's All About Jazz profile" /></a> By <a href="//www.allaboutjazz.com/php/profile.php?id=31934">Philip Dorsey</a>
...
<div class="rad-5 padding-20 bottom-20 border-1">
	<h4><a href="//media.allaboutjazz.com" class="callout-link">Track of the Day <i class="fa fa-arrow-right"></i></a></h4>
	<a href="//media.allaboutjazz.com/media.php?id=10952" target="_blank">
		<img src="https://www.allaboutjazz.com/coverart/large/2017-SOCIALISTS-TwilightFall_CD-cover_1425px.jpg" width="200" height="200" alt="Intransitory" />
	</a>
	<br /><br /><strong class="aaj">Track</strong>
	<br /><a class="aaj" href="//media.allaboutjazz.com/media.php?id=10952" target="_blank">Intransitory</a>
	<br /><br /><strong class="aaj">Artist/Band</strong>
	<br /><a class="aaj" href="//musicians.allaboutjazz.com/musician.php?id=98394" target="_blank">Chelsea McBride's Socialist Night School</a>
			<br /><br /><strong class="aaj">Album</strong>
		<br /><em><a class="aaj" href="https://itunes.apple.com/ca/album/the-twilight-fall/id1182035948" target="_blank">The Twilight Fall</a></em>
	</div>
		...
		<div class="container">
			<div class="row bottom-60 text-center">
				<div class="col-xs-12 col-sm-4">
									<a href="//www.jazznearyou.com/" title="Live Jazz Near You!">
						<span class="small">visit our partner website</span>
						<i class="footer-logo jny_footer_logo"></i>
						<p class="small">jazz events, festivals, and venues</p>
					</a>
								</div>
				<div class="col-xs-12 col-sm-4">	
					<h3>Follow Us</h3>
					<div class="social">
						<a class="btn ico-32 icon-facebook pic-round" role="button" href="https://www.facebook.com/allaboutjazz" title="All About Jazz on Facebook"><i class="fa fa-facebook"></i></a>
						<a class="btn ico-32 icon-twitter pic-round" role="button" href="https://twitter.com/AllAboutJazz" title="All About Jazz on Twitter"><i class="fa fa-twitter"></i></a>
						<a class="btn ico-32 icon-google pic-round" role="button" href="//plus.google.com/+Allaboutjazz" title="All About Jazz on Google+"><i class="fa fa-google"></i></a>
						<a class="btn ico-32 icon-rss pic-round" role="button" href="//www.allaboutjazz.com/php/live/rss.php" title="All About Jazz RSS"><i class="fa fa-rss"></i></a>
						<a class="btn ico-32 icon-widget pic-round" role="button" href="//www.allaboutjazz.com/php/live/index.php" title="All About Jazz Widgets"><i class="fa fa-cog"></i></a>
					</div>
				</div>
				<div class="col-xs-12 col-sm-4">
			...
			<div class="row bottom-60">
				<div class="col-xs-6 col-sm-3 bottom-20 col-foot">
					<h5>Community</h5>
					<ul>
						<li><a href="//www.allaboutjazz.com/php/article.php?id=298">Welcome</a></li>
						<li><a href="//www.allaboutjazz.com/php/article.php?id=45574">Join Us</a></li>
						<li><a href="//www.allaboutjazz.com/php/contributor_center.php">Staff Directory</a></li> 	
						<li><a href="//news.allaboutjazz.com/all-about-jazz-member-benefits-sign-up-today.php">Member Benefits</a></li>
				...
				<div class="col-xs-6 col-sm-3 bottom-20 col-foot">
					<h5>Services</h5>
					<ul> 
						<li><a href="//musicians.allaboutjazz.com/toolkit.php">Musician Toolkit</a></li>
						<li><a href="//www.jazznearyou.com/event_edit.php">Add Event</a></li>
						<li><a href="//www.jazznearyou.com/guide_center.php">Add Business</a></li>
						<li><a href="//www.jazznearyou.com/channels.php">Event Distribution</a></li>
						<li><a href="//www.jazznearyou.com/newsletter.php">On Demand Calendar</a></li>						
					</ul>
				</div>
				<div class="col-xs-6 col-sm-3 bottom-20 col-foot">
					<h5>Get in touch</h5>
					<ul>
						...
						<li><a href="//www.allaboutjazz.com/php/contactus.php">Make Suggestion</a></li>
						<li><a href="//www.allaboutjazz.com/php/contactus.php">Report Bug</a></li>
						<li><a href="//www.jazznearyou.com/faq.php">FAQ</a></li>
						<li><a href="//www.allaboutjazz.com/php/submit_contributor_inquiry.php?id=1">Contact Us</a></li>						
					</ul>
				</div>
				<div class="col-xs-6 col-sm-3 bottom-20 col-foot">
					<h5>Advertise</h5>
					<ul>
						...
						<li><a href="//www.allaboutjazz.com/php/advertising/about.php">About</a></li>					
	...
	<div class="footer-bottom">
		<div class="container">
			<div class="col-xs-12 col-sm-3">
				&copy; 2016 All About Jazz | <a href="//www.allaboutjazz.com/privacy.php">Privacy Policy</a>
			</div>
...
<div class="cointent-gumshoe"
    data-publisher-id="1624"
    data-article-id="a1"
    data-render-option="viewOnly"
    data-­per­-session="true"
    data-­close­-button="true"
    data-logo="https://www.allaboutjazz.com/icon/all_about_jazz_logo-300x300.png"
    data-logo-size="large"
    data-url= "https://www.allaboutjazz.com/photos/2010/cointent_background.jpg"
    data-header-text="Please disable your ad blocker for All About Jazz and Jazz Near You"
    data-subheader-text="We depend on advertising revenue to maintain our platform, so please view our websites with ads to support us. Thank you!">
</div>
<!-- Modal -->
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <ul class="nav nav-pills" role="tablist" id="login_ul">
            <li id="signinli" role="presentation" class="active"><a id="a_signin" href="#signinli_tab" aria-controls="signinli_tab" role="tab" data-toggle="pill">Already a member? Sign in</a></li>
            <li id="signupli" role="presentation" class="pull-right"><a id="a_signup" href="#signupli_tab" aria-controls="signupli_tab" role="tab" data-toggle="pill">Not a member? Sign up</a></li>
        </ul>
...
<div class="row">
  <label class="col-xs-12 col-sm-6 control-label">Try Jazz Near You
	<span class="help-block">A weekly guide to local events</span>
  </label>
  <div class="col-xs-12 col-sm-6">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <ul class="nav nav-pills" role="tablist" id="ul_seach">
			...
			<li role="presentation"><a href="#search_download" aria-controls="search_download" role="tab" data-toggle="pill">Music</a></li>
            <li role="presentation"><a href="#search_musician" aria-controls="search_musician" role="tab" data-toggle="pill">Musician</a></li>
			<li role="presentation"><a href="#search_album" aria-controls="search_album" role="tab" data-toggle="pill">Album</a></li>
			<li role="presentation"><a href="#search_gallery" aria-controls="search_gallery" role="tab" data-toggle="pill">Gallery</a></li>
			<li role="presentation"><a href="#search_birth" aria-controls="search_birth" role="tab" data-toggle="pill">Birthday</a></li>
		        </ul>
        <div class="tab-content">
            <div role="tabpanel" class="tab-pane fade in active" id="search_article">
                <form action="//www.allaboutjazz.com/php/article_center.php" method="get" class="container-fluid">
                    <div class="row">
                        <div class="col-xs-12 col-sm-4">
					...
					<div class="row">
                        ...
                        <div class="col-xs-12 col-sm-8">
                            <select name="in_type"><option value=0>&nbsp;</option><option value="85">AAJ PRO</option><option value="236">Advice to new listeners...</option><option value="74">African Jazz</option><option value="169">Afrobeat Diaries</option><option value="1">Airplay 101</option><option value="107">All About Jazz: South Africa</option><option value="38">Anatomy of a Standard</option><option value="239">Artist Tribute</option><option value="4">Ask Ken</option><option value="140">Audio High Product Profile</option><option value="111">Audio Reviews</option><option value="136">Back Roads Beat</option><option value="83">Bailey's Bundles</option><option value="184">Behind the Lens With...</option><option value="79">Best of / Year End</option><option value="145">Big Band Caravan</option><option value="125">Big Band in the Sky</option><option value="7">Big Band Report</option><option value="134">Big Jazz Nerd</option><option value="160">Bill Anschell's Notes from the Lobby</option><option value="8">Biographies</option><option value="126">Book Excerpts</option><option value="9">Book Reviews</option><option value="72">Building a Jazz Library</option><option value="163">Built to Sound</option><option value="189">Catching Up With</option><option value="100">CD/LP/Track Review</option><option value="71">Compare & Contrast</option><option value="138">Confessions of a Piano Player</option><option value="89">Contemporary Vibes</option><option value="133">Contributor News</option><option value="157">Cool Vic Files</option><option value="191">Cymbalism</option><option value="158">Dan's Den</option><option value="229">Desert Island List</option><option value="112">Digital Music</option><option value="116">Discography</option><option value="110">Download Reviews</option><option value="225">Drum Addiction</option><option value="68">DVD/Film Reviews</option><option value="96">Extended Analysis</option><option value="205">First Impressions</option><option value="23">First Time I Saw</option><option value="177">Forgotten Finds</option><option value="198">Fre-Formation</option><option value="149">From Far and Wide</option><option value="25">From the Inside Out</option><option value="144">Future Jazz</option><option value="181">Future Theory, Future Practice</option><option value="27">General Articles</option><option value="28">Genius Guide to Jazz</option><option value="42">Getting Into Jazz</option><option value="174">Gnome Notes</option><option value="220">Guitarist's Rendezvous</option><option value="197">Hardly Strictly Jazz</option><option value="47">Hi-Res Jazz</option><option value="95">Highly Opinionated</option><option value="108">History of Jazz Timeline</option><option value="235">I Love Jazz!</option><option value="30">Improvise!</option><option value="31">In 10</option><option value="137">In the Artist's Own Words</option><option value="216">In The Biz</option><option value="117">In the Studio</option><option value="32">Interviews</option><option value="119">Jazz and the Net</option><option value="148">Jazz Art</option><option value="170">Jazz Biofiles</option><option value="131">Jazz Ed</option><option value="207">Jazz Emerges</option><option value="156">Jazz Fiction</option><option value="22">Jazz For Kids</option><option value="33">Jazz From The Vinyl Junkyard</option><option value="102">Jazz Humor</option><option value="190">Jazz in the Aquarian Age</option><option value="93">Jazz Journal</option><option value="221">Jazz Near Me</option><option value="58">Jazz Poetry</option><option value="118">Jazz Primer</option><option value="11">Jazz Raconteurs</option><option value="175">Jazz That Scratches, Swings and Pops</option><option value="34">Jazz Uncorked</option><option value="35">Jazzin' Around Europe</option><option value="168">JazzLife UK</option><option value="37">Journey into Jazz</option><option value="40">Late Night Thoughts on Jazz</option><option value="43">Liner Notes</option><option value="130">Listen To This!</option><option value="52">Live From New York</option><option value="186">Live From Philadelphia</option><option value="19">Live Reviews</option><option value="44">London Calling</option><option value="155">Making Music</option><option value="103">Meet the Staff</option><option value="82">Megaphone</option><option value="210">Mentoring the Millennials</option><option value="146">Misterioso</option><option value="176">Mixed Tape</option><option value="161">Mr. P.C.'s Guide to Jazz Etiquette...</option><option value="84">Multiple Reviews</option><option value="127">Muse From the Front</option><option value="153">Music and the Creative Spirit</option><option value="48">Music Biz 101</option><option value="49">Music Theory</option><option value="50">Musings In Cb</option><option value="224">Musings of a Jazz Piano Teacher</option><option value="97">Must Hear Review</option><option value="214">My Blue Note Obsession</option><option value="120">My Favourite Things</option><option value="45">New & Noteworthy</option><option value="232">New Discovery</option><option value="36">New York @ Night</option><option value="51">New York Beat</option><option value="80">Nite & Disk</option><option value="104">Nordic Sounds</option><option value="115">Not For Sale</option><option value="165">Old, New, Borrowed and Blue</option><option value="188">On and Off the Grid</option><option value="182">On the Road With...</option><option value="65">One LP</option><option value="54">Open Ears</option><option value="240">Opinion</option><option value="55">Opinion/Editorial</option><option value="24">Out and About: The Super Fans</option><option value="56">Out-of-Print</option><option value="206">Philosophisticated Lady</option><option value="132">Podcast</option><option value="147">Previews</option><option value="139">Product Reviews</option><option value="3">Profiles</option><option value="178">Race and Jazz</option><option value="231">Radio Playlist</option><option value="106">Readers Write Back</option><option value="59">Reassessing</option><option value="39">Record Label Profiles</option><option value="219">Rediscovery</option><option value="233">Reminisce</option><option value="212">Rethinking Jazz Cultures</option><option value="60">Rhythm In Every Guise</option><option value="98">Roads Less Travelled</option><option value="203">Scumbles</option><option value="77">Shrinktunes</option><option value="113">Spirit of '76</option><option value="101">Straight From The Vault</option><option value="185">Stretch Movement</option><option value="122">Swing Set</option><option value="141">Take Five With...</option><option value="183">Talkin' Blues</option><option value="217">Talking 2 Musicians</option><option value="209">Tell Me More</option><option value="211">The 10 CDs in the CD player of...</option><option value="162">The Art and Science of Jazz</option><option value="167">The Art Of The Artist To Fan Relationship</option><option value="223">The Audiophile</option><option value="238">The best show I ever attended was...</option><option value="218">The Big Question</option><option value="172">The Business of Jazz</option><option value="135">The Cool Vic Files</option><option value="194">The Doorman's Diary</option><option value="237">The first jazz record I bought was...</option><option value="234">The First Time I Discovered Jazz...</option><option value="88">The Low End</option><option value="46">The Millenaissance</option><option value="195">The Moment's Energy</option><option value="201">The Mort Report</option><option value="215">The Vinyl Post</option><option value="187">The Write Stuff</option><option value="222">Top Ten List</option><option value="202">Under the Radar</option><option value="166">Unsung Heroes</option><option value="228">Video</option><option value="128">Video Feature</option><option value="142">Vinyl Vibe</option><option value="199">We Travel the Spaceways</option><option value="69">Website News</option><option value="230">What I'm Listening to Now List</option><option value="143">What is Jazz?</option><option value="70">Wide Open Jazz and Beyond</option><option value="171">Working Out to Jazz</option></select>
                        </div>
                    </div>
					<div class="row">
                        <div class="col-xs-12 col-sm-4">
            ...
            <div role="tabpanel" class="tab-pane fade in" id="search_news">
                <form action="//news.allaboutjazz.com/index.php" method="post" class="container-fluid">
                    <div class="row">
                        <div class="col-xs-12 col-sm-4">
                            <label>by <strong>title</strong></label>
                        </div>
            ...
            <div role="tabpanel" class="tab-pane fade in" id="search_download">
                <form action="//media.allaboutjazz.com/index.php" method="get" class="container-fluid">
                    <div class="row">
                        <div class="col-xs-12 col-sm-4">
                            <label>by <strong>musician</strong></label>
                        </div>
            ...
            <div role="tabpanel" class="tab-pane fade in" id="search_musician">
                <form action="//musicians.allaboutjazz.com/index.php" method="post" class="container-fluid">
                    <div class="row">
                        <div class="col-xs-12 col-sm-4">
			...
			<div role="tabpanel" class="tab-pane fade in" id="search_album">
                <form action="//musicians.allaboutjazz.com/album_center.php" method="post" class="container-fluid">
                    <div class="row">
                        <div class="col-xs-12 col-sm-4">
                            <label>by <strong>title</strong></label>
                        </div>
            ...
            <div role="tabpanel" class="tab-pane fade in" id="search_gallery">
                <form action="//photos.allaboutjazz.com/index.php" method="get" class="container-fluid">
                    <div class="row">
                        <div class="col-xs-12 col-sm-4">
			  ...
			  <div role="tabpanel" class="tab-pane fade in" id="search_birth">
          <form action="//www.allaboutjazz.com/php/birthday.php" method="get" class="container-fluid">
				<div class="row">
					<label class="col-xs-12 col-sm-4 control-label" for="name">by <strong>name</strong></label>	
					<div class="col-xs-12 col-sm-8">
						<input id="aajsearch_musicianbirth" type="text" name="name" class="form-control" value="" />
					</div>
				</div>		
				<div class="row">
					<label class="col-xs-12 col-sm-4 control-label" for="name">by <strong>m/d/y</strong></label>
					<div class="col-xs-12 col-sm-8">
						<div class="row">
							<div class="col-sm-4">
		...
		<p><br /><a href="//www.allaboutjazz.com/php/search.php">More database search options</a>
		or search <strong>with Google</strong></p>
...
@media only screen and (max-width: 1239px), (max-device-width: 1239px) {
	...
	#sitemap_overlay .modal-body { font: normal 16px/1.4 Verdana,Arial,sans-serif; }
	#sitemap_overlay .tab-content li { border-bottom: 1px solid #ccc; border-top: 1px solid #fff; }
	#sitemap_overlay .tab-content li a { display: block; padding: 6px 0; }
	#sitemap_overlay .tab-content li:first-child { border-top: 0; }
	#sitemap_overlay .tab-content li:last-child { border-bottom: 0; }
	#sitemap_overlay .modal-body .nav-pills li { }
	#sitemap_overlay .modal-body .nav-pills li a { }
	#sitemap_overlay .tab-content > .tab-pane { padding: 0;}
	#sitemap_overlay .modal-body h3 { font-family: Arial; font-size: 20px; font-weight: bold; margin: 20px 0;}
...
<div class="modal fade" id="sitemap_overlay" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title">All About Jazz: quick links</h4>
		<div class="social pull-right">
			<a class="btn ico-32 icon-facebook pic-round" role="button" href="//www.facebook.com/allaboutjazz" title="All About Jazz on Facebook"><i class="fa fa-facebook"></i></a>
			<a class="btn ico-32 icon-twitter pic-round" role="button" href="//twitter.com/AllAboutJazz" title="All About Jazz on Twitter"><i class="fa fa-twitter"></i></a>
			<a class="btn ico-32 icon-google pic-round" role="button" href="//plus.google.com/+Allaboutjazz" title="All About Jazz on Google+"><i class="fa fa-google"></i></a>
			<a class="btn ico-32 icon-rss pic-round" role="button" href="//www.allaboutjazz.com/php/live/rss.php" title="All About Jazz RSS"><i class="fa fa-rss"></i></a>
			<a class="btn ico-32 icon-widget pic-round" role="button" href="//www.allaboutjazz.com/php/live/index.php" title="All About Jazz Widgets"><i class="fa fa-cog"></i></a>
		</div>
      ...
      <div class="modal-body">
		<ul class="nav nav-pills" role="tablist" id="ul_seach">
            <li role="presentation" class="active"><a href="#member_tab" aria-controls="member_tab" role="tab" data-toggle="pill">Hello</a></li>
			<li role="presentation"><a href="#albums_tab" aria-controls="albums_tab" role="tab" data-toggle="pill">Albums</a></li>
			<li role="presentation"><a href="#articles_tab" aria-controls="articles_tab" role="tab" data-toggle="pill">Articles</a></li>
			<li role="presentation"><a href="#media_tab" aria-controls="media_tab" role="tab" data-toggle="pill">Downloads</a></li>
			<li role="presentation"><a href="#jny_tab" aria-controls="jny_tab" role="tab" data-toggle="pill">Events</a></li>
            <li role="presentation"><a href="#gallery_tab" aria-controls="gallery_tab" role="tab" data-toggle="pill">Gallery</a></li>
        ...
        <div class="tab-content">
            <div role="tabpanel" class="tab-pane fade in active" id="member_tab">
				<div class="row modal-text-content">
					<div class="col-xs-12 col-sm-3">
											<h3>Hello!</h3>
						<ul>
							<li>Not an AAJ member? <a  onclick="signin(1); return false;" href="javascript:void(0);" title="Sign up and get a free local concert calendar newsletter plus much more!" data-toggle="modal" data-target="#login-box" data-dismiss="modal">Sign Up</a></li>
							<li><a onclick="signin(0); return false;"  href="javascript:void(0);" data-toggle="modal" data-target="#login-box" data-dismiss="modal">Sign In</a> to your member account!</li>
						</ul>
										</div>
					<div class="col-xs-12 col-sm-3">
						<h3>General</h3>
						<ul>
							...
							<li><a href="//www.allaboutjazz.com/php/faq.php">FAQ</a></li>
							<li><a href="//www.allaboutjazz.com/privacy.php">Privacy</a></li>
							<li><a href="//www.allaboutjazz.com/php/contactus.php">Contact Us</a></li>
							<li><a href="//www.allaboutjazz.com/php/contributor_center.php">Staff</a></li>
						</ul>
					</div>
					<div class="col-xs-12 col-sm-3">
						<h3>Contribute</h3>
											<p>Login to your All About Jazz member account to submit articles and press releases, upload images, edit musician profiles, add events and business listings, communicate with other members via personal messages, submit inqueries or contribute any content.</p>
										</div>
					<div class="col-xs-12 col-sm-3">
						...
						<ul>
							...
							<li><a href="//www.allaboutjazz.com/php/advertising/demographics.php">Demographics</a></li>
							<li><a href="//news.allaboutjazz.com/become-a-jazz-near-you-partner.php">Partner Up!</a></li>
							<li><a href="https://jazznearyou.com/partners.php">Jazz Near You Partners</a></li>
						</ul>
					</div>
				</div>
			</div>
			...
			<div role="tabpanel" class="tab-pane fade in" id="articles_tab">
				<div class="row modal-text-content">
					<div class="col-xs-12 col-sm-6">	
					...
					<div class="col-xs-12 col-sm-3">
						<h3>General</h3>
						<ul>			
							<li><a href="https://www.allaboutjazz.com/php/article_center.php">Articles</a></li>
							<li><a href="https://www.allaboutjazz.com/php/article_center.php?type=featured" title="Featured Jazz articles">Featured</a></li>
							<li><a href="https://www.allaboutjazz.com/php/top_articles.php?t=read" title="Popular Jazz articles">Popular</a></li>
							<li><a href="https://www.allaboutjazz.com/php/top_articles.php" title="Recommended Jazz articles">Recommended</a></li>	
							<li><a href="https://www.allaboutjazz.com/php/future_articles.php" title="Future Jazz articles">Future</a></li>
							<li><a href="https://www.allaboutjazz.com/php/review_center.php">Reviews</a></li>
							<li><a href="https://www.allaboutjazz.com/php/facts.php">Facts</a></li>
						</ul>
					</div>
					<div class="col-xs-12 col-sm-3">
						<h3>My All About Jazz</h3>
											<p><a  onclick="signin(0); return false;" href="javascript:void(0);" title="Sign up and get a free local concert calendar newsletter plus much more!" data-toggle="modal" data-target="#login-box" data-dismiss="modal">Login</a> or <a  onclick="signin(1); return false;" href="javascript:void(0);" title="Sign up and get a free local concert calendar newsletter plus much more!" data-toggle="modal" data-target="#login-box" data-dismiss="modal">Sign Up</a> to build your personalized All About Jazz experience!</p>
											<h3>Community</h3>
						<ul>
							<li><a href="https://www.allaboutjazz.com/php/member_stories.php">Member Stories</a></li>
							<li><a href="https://www.allaboutjazz.com/php/person_kudos.php">Users Dig All About Jazz!</a></li>
						</ul>
					</div>
				</div>
			</div>
			<div role="tabpanel" class="tab-pane fade in" id="media_tab">
				<div class="row modal-text-content">
					...
					<div class="col-xs-12 col-sm-4">
						<h3>General</h3>
						<ul>				
							<li><a href="https://media.allaboutjazz.com/jazzvideos.php">Jazz Videos</a></li>
							<li><a href="https://media.allaboutjazz.com/jazzdownloads.php?type=recommended">Recommended MP3s</a></li>
							<li><a href="https://media.allaboutjazz.com/jazzdownloads.php?type=day&amp;day=30">Most Popular MP3s - Last 30 days</a></li>
							<li><a href="https://media.allaboutjazz.com/jazzdownloads.php?type=day&amp;day=60">Most Popular MP3s - Last 60 days</a></li>
							<li><a href="https://media.allaboutjazz.com/jazzdownloads.php?type=day&amp;day=90">Most Popular MP3s - Last 90 days</a></li>
							<li><a href="https://media.allaboutjazz.com/yearend_downloads.php?this_year=2016">Most Popular MP3s - 2016</a></li>								
							<li><a href="https://media.allaboutjazz.com/jazzdownloads.php?type=top">Top 200 All-Time</a></li>
						</ul>
					</div>
					<div class="col-xs-12 col-sm-4">
						<h3>Pro Links</h3>
											<p><a  onclick="signin(0); return false;" href="javascript:void(0);" title="Sign up and get a free local concert calendar newsletter plus much more!" data-toggle="modal" data-target="#login-box" data-dismiss="modal">Login</a> or <a  onclick="signin(1); return false;" href="javascript:void(0);" title="Sign up and get a free local concert calendar newsletter plus much more!" data-toggle="modal" data-target="#login-box" data-dismiss="modal">Sign Up</a> to upload your MP3. We select a new track daily to feature it in All About Jazz "Download of the day" section!</p>
										</div>
				</div>
			</div>
			<div role="tabpanel" class="tab-pane fade in" id="jny_tab">
				<div class="row modal-text-content">
					<div class="col-xs-12 col-sm-4">
						<h3>Live Jazz in Your Area</h3>
						<ul>
							<li><a href="//jazznearyou.com/">Jazz Near You</a></li>
							<li><a href="//jazznearyou.com/calendar.php">Upcoming Events</a></li>
							<li><a href="//jazznearyou.com/entities.php?type=7">Venues Near You</a></li>
							<li><a href="//jazznearyou.com/guide_center.php">Local Businesses</a></li>
							<li><a href="//jazznearyou.com/news.php">Local News</a></li>
						</ul>
						<button title="Search All About Jazz" data-toggle="modal" data-target="#search_overlay" class="btn btn-xs btn-primary" id="btn-search" data-dismiss="modal">
							<i class="fa fa-search"></i> Search Jazz Near You
						</button>
					</div>
					<div class="col-xs-12 col-sm-4">
						<h3>Options</h3>
						<ul>
							<li><a href="//jazznearyou.com/app.php" target="_blank">Jazz Near You Calendar App</a></li>
							<li><a href="//jazznearyou.com/newsletter.php">Get Events to Your Mailbox</a></li>	
							<li><a href="//jazznearyou.com/calendar-link-generator.php">Place Live Calendar on Your Site</a></li>					
						<!--	
							<li><a href="//jazznearyou.com/templates/rss/nyc-events-rss.xml" target="_blank">RSS Feed</a></li>
							<li><a href="//jazznearyou.com/icals/nyc.ics" target="_blank">iCal File</a></li>
						-->
							<li><a href="//jazznearyou.com/channels.php">Event Distribution Explained</a></li>
							<li><a href="//jazznearyou.com/websites-around-the-world.php">Select a City</a></li>
						</ul>
					</div>
					<div class="col-xs-12 col-sm-4">
						<h3>Pro Links</h3>
											<p><a  onclick="signin(0); return false;" href="javascript:void(0);" title="Sign up and get a free local concert calendar newsletter plus much more!" data-toggle="modal" data-target="#login-box" data-dismiss="modal">Login</a> to create a listing for your jazz industry related businesses, upload single or recurring events, or export your events with an XML file. Read about <a href="//jazznearyou.com/channels.php">Jazz Near You event distribution platform</a>.</p>
										</div>
				</div>
			</div>
			...
			<div role="tabpanel" class="tab-pane fade in" id="gallery_tab">
				<div class="row modal-text-content">
					...
					<div class="col-xs-12 col-sm-4">
						<h3>General</h3>
						<ul>				
							<li><a href="https://photos.allaboutjazz.com/?t=featured">Featured</a></li>	
							<li><a href="https://photos.allaboutjazz.com/?t=thisweek">This Week</a></li>
							<li><a href="https://photos.allaboutjazz.com/?t=pop">Popular</a></li>						
							<li><a href="https://photos.allaboutjazz.com/?t=recommended">Recommended</a></li>
							<li><a href="https://photos.allaboutjazz.com/?t=pro">Professionals</a></li>
							<li><a href="https://photos.allaboutjazz.com/pro_photographers.php">Active Visual Artists</a></li>
						</ul>
					</div>
					<div class="col-xs-12 col-sm-4">
						<h3>Pro Links</h3>
											<p><a  onclick="signin(0); return false;" href="javascript:void(0);" title="Sign up and get a free local concert calendar newsletter plus much more!" data-toggle="modal" data-target="#login-box" data-dismiss="modal">Login</a> or <a  onclick="signin(1); return false;" href="javascript:void(0);" title="Sign up and get a free local concert calendar newsletter plus much more!" data-toggle="modal" data-target="#login-box" data-dismiss="modal">Sign Up</a> to upload your jazz images. Share your live jazz experience, promote yourself or your band, showcase your professional jazz photography services!</p>
										</div>
				</div>
			</div>
			<div role="tabpanel" class="tab-pane fade in" id="musicians_tab">
				<div class="row modal-text-content">
					...
					<div class="col-xs-12 col-sm-3">
						<h3>General</h3>
						<ul>			
							<li><a href="https://musicians.allaboutjazz.com/musicians.php">All Musician Profiles</a></li>
							...
							<li><a href="https://musicians.allaboutjazz.com/jazzbirthdays.php">Jazz Birthdays All Year Round</a></li>
							<li><a href="https://www.allaboutjazz.com/php/birthday.php">Born on this day</a></li>
							<li><a href="https://musicians.allaboutjazz.com/musician_kudos.php">Musicians Dig All About Jazz!</a></li>
						</ul>
					</div>
					<div class="col-xs-12 col-sm-3">
						<h3>Pro Links</h3>
											<p><a  onclick="signin(0); return false;" href="javascript:void(0);" title="Sign up and get a free local concert calendar newsletter plus much more!" data-toggle="modal" data-target="#login-box" data-dismiss="modal">Login</a> or <a  onclick="signin(1); return false;" href="javascript:void(0);" title="Sign up and get a free local concert calendar newsletter plus much more!" data-toggle="modal" data-target="#login-box" data-dismiss="modal">Sign Up</a> to create or claim and edit your musician profile page. Check out our vast collection of <a title="Promotional Opportunities For Jazz Musicians" href="//musicians.allaboutjazz.com/toolkit.php">promo services</a>!</p>
										</div>
				</div>
			</div>
			<div role="tabpanel" class="tab-pane fade in" id="news_tab">
				<div class="row modal-text-content">
					...
					<div class="col-xs-12 col-sm-3">
						<h3>General</h3>
						<ul>				
							<li><a href="https://news.allaboutjazz.com/index.php?t=local">Local</a></li>
							<li><a href="https://news.allaboutjazz.com/index.php?t=industry">Industry</a></li>	
							<li><a href="https://news.allaboutjazz.com/index.php?in_type=13">Website</a></li>									
							<li><a href="https://news.allaboutjazz.com/news_readcount.php?t=current">Popular</a></li>
							<li><a href="https://news.allaboutjazz.com/news_readcount.php?t=recommended">Recommended</a></li>
						</ul>
					</div>
					<div class="col-xs-12 col-sm-3">
						<h3>Press Release Distribution</h3>
											<p><a  onclick="signin(0); return false;" href="javascript:void(0);" title="Sign up and get a free local concert calendar newsletter plus much more!" data-toggle="modal" data-target="#login-box" data-dismiss="modal">Login</a> or <a  onclick="signin(1); return false;" href="javascript:void(0);" title="Sign up and get a free local concert calendar newsletter plus much more!" data-toggle="modal" data-target="#login-box" data-dismiss="modal">Sign Up</a> to use All About Jazz Press Release Distribution services. Check out <a href="//news.allaboutjazz.com/about.php">About</a> and <a href="//news.allaboutjazz.com/faq.php">FAQ</a> pages.</li>
										</div>
				</div>
			</div>		
				</div>
...
<link rel="stylesheet" href="//www.allaboutjazz.com/css/main-style.min.css" media="all" />


<script src="//www.allaboutjazz.com/js2/bootstrap.min.js"></script>
<script src="//www.allaboutjazz.com/js2/main_v2015.js"></script></body>
</html>