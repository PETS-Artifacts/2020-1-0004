...
<![endif]-->
	...
	<script src="//cdn.districtm.ca/merge/merge.v4.2.113790.js"></script>

	<!-- Skimlinks code for iTunes, WWS, Ticketmaster, Ticketweb, and Sheet Music Plus -->
	<script type="text/javascript" src="//s.skimresources.com/js/41401X1072392.skimlinks.js"></script>
...
<li class="nav-search li-last">
	...
	<p class="breadcrumbs_line nowrap overflow pull-left">
        <a title="All About Jazz home page" href="//www.allaboutjazz.com">Home</a> &#187;
			Privacy Policy    </p>
	<a href="//www.allaboutjazz.com/php/advertising/index.php" class="hide-768 pull-right link-special"><i class="fa fa-star" aria-hidden="true"></i> ADVERTISE WITH US</a>
    </div>
			...
			<!-- /1038983/Leaderboard_Top -->
			<div id='div-gpt-ad-1420041696178-0' style='height:90px; width:728px;'>
			<script>
			googletag.cmd.push(function() { googletag.display('div-gpt-ad-1420041696178-0'); });
			</script>
			</div>   
		</div>
...
<div class="flex-container showcase-block bottom-20">
	<div id="showcaseSlider" class="flexslider clearfix"><!--feat-cont-box-->
		<ul class="slides clearfix">
						<li>					
				<img class="showcase-img" src="//www.allaboutjazz.com/images/ads/showcase/orderitem-3149-1245102227.jpg" alt="">
				<div class="showcase-album">
<a href="http://bit.ly/2fZhjD9" class="pic-100" title="Order You Already Know by Dave Potter">
<img src="https://s3.amazonaws.com/allaboutjazz/coverart/large/705_cover_POTTER.jpg" width="100" height="100" alt="You Already Know - showcase release by Dave Potter" />
</a>
<a href="http://bit.ly/2fZhjD9" class="btn btn-warning btn-xs" title="Order “You Already Know” by Dave Potter"><i class="fa fa-shopping-cart"></i> Buy Now</a>
				</div>
				<h4><span>You Already Know</span> by <a href="//musicians.allaboutjazz.com/davepotter">Dave Potter</a></h4>
			</li>
						<li>					
				<img class="showcase-img" src="//www.allaboutjazz.com/images/ads/showcase/orderitem-641-299219575.jpg" alt="">
				<div class="showcase-album">
<a href="http://bit.ly/2wlmOQC" class="pic-100" title="Order Far from Over by Vijay Iyer">
<img src="https://s3.amazonaws.com/allaboutjazz/coverart/large/vijay_iyer_sextet_far_from_over_allaboutjazz_ka.jpg" width="100" height="100" alt="Far from Over - showcase release by Vijay Iyer" />
</a>
<a href="http://bit.ly/2wlmOQC" class="btn btn-warning btn-xs" title="Order “Far from Over” by Vijay Iyer"><i class="fa fa-shopping-cart"></i> Buy Now</a>
				</div>
				<h4><span>Far from Over</span> by <a href="//musicians.allaboutjazz.com/vijayiyer">Vijay Iyer</a></h4>
			</li>
						<li>					
				<img class="showcase-img" src="//www.allaboutjazz.com/images/ads/showcase/orderitem-710-479583953.jpg" alt="">
				<div class="showcase-album">
<a href="http://bit.ly/2v86vVW" class="pic-100" title="Order Oblivion by Gerald Beckett">
<img src="https://s3.amazonaws.com/allaboutjazz/coverart/large/552dd368fc30462d5cc7d14bc442d5ef.jpg" width="100" height="100" alt="Oblivion - showcase release by Gerald Beckett" />
</a>
<a href="http://bit.ly/2v86vVW" class="btn btn-warning btn-xs" title="Order “Oblivion” by Gerald Beckett"><i class="fa fa-shopping-cart"></i> Buy Now</a>
				</div>
				<h4><span>Oblivion</span> by <a href="//musicians.allaboutjazz.com/geraldbeckett">Gerald Beckett</a></h4>
			</li>
					</ul>			
		<!-- //github.com/woothemes/FlexSlider/wiki/FlexSlider-Properties -->
			...
			<div class="bottom-40" id="jazzstory_section">
				...
				<blockquote class="quote-text"><p>I love jazz because it represents freedom on some many levels, both musically and socially. 
I was first exposed to jazz at a very young age since my family was friends with Wes Montgomery.
I've met many jazz icons from old school like Eddie Henderson to new school such as Sean Jones on my jazz radio show in 
Laguna 
Beach California.
The best show I ever attended was Pat Martino paying tribute to Wes Montgomery.
The first jazz record I bought was Wes Montgomery's Bumpin' on Sunset.
My advice to new listeners is tune into Jazz Quest Radio to find your entry point into jazz and read articles on All About Jazz!</p>
			<i class="fa fa-caret-down"></i>
			</blockquote>
			<p class="quote-author">
			<a href="https://www.allaboutjazz.com/php/profile.php?id=173262" title="Visit Tommy Benson"><img src="https://s3.amazonaws.com/allaboutjazz/photos/profile/6162ae888453a5ecc630527bdeebb04a.jpg" class="pic-60 f-left pic-round" height="60" alt="View Tommy Benson's All About Jazz profile" /></a> By <a href="https://www.allaboutjazz.com/php/profile.php?id=173262">Tommy Benson</a>
			<br />Member since: 2017
			</p>
		</div>    <div class="bottom-20 sbar-item sbar-item--height2">
        <div class="adblock_300x250">
        	<!-- /1038983/300x250_Right_Middle -->
...
<div class="bottom-20">
	...
	<a href="//media.allaboutjazz.com/media.php?id=11158" target="_blank">
		<img src="https://s3.amazonaws.com/allaboutjazz/coverart/large/laszlogardony_seriousplay_db.jpg" width="200" height="200" alt="Serious Play" />
	</a>
	<br /><br /><strong class="aaj">Track</strong>
	<br /><a class="aaj" href="//media.allaboutjazz.com/media.php?id=11158" target="_blank">Serious Play</a>
	<br /><br /><strong class="aaj">Artist/Band</strong>
	<br /><a class="aaj" href="//musicians.allaboutjazz.com/laszlogardony" target="_blank">Laszlo Gardony</a>
	<br /><br /><strong class="aaj">Album</strong>
	<br /><em><a class="aaj" href="https://www.amazon.com/Serious-Play-Laszlo-Gardony/dp/B071FTD6ZK" target="_blank">Serious Play</a></em>

</div>
     
    <div class="bottom-20">
		<div class="adblock_300x600">   
			<!-- /1038983/300x600_Half_Page -->
			<div id='div-gpt-ad-1499885873152-0' style='height:600px; width:300px;'>
			<script>
			googletag.cmd.push(function() { googletag.display('div-gpt-ad-1499885873152-0'); });
			</script>
			</div>
		</div>
    </div>    
			...
			<div class="row bottom-60">
				<div class="col-xs-6 col-sm-3 bottom-20 col-foot">
					...
					<ul>
						...
						<!-- <li><a href="http://forums.allaboutjazz.com">Chat Bot</a></li> -->
					</ul>				
				</div>
				<div class="col-xs-6 col-sm-3 bottom-20 col-foot">
					<h5>Services</h5>
					<ul> 
						<li><a href="//musicians.allaboutjazz.com/toolkit.php">Professional Toolkit</a></li>
	...
	<div class="footer-bottom">
		<div class="container">
			...
			<div class="col-xs-10 col-sm-8">          
				<strong class="title">We inform jazz fans and alert them to local shows. And while we're at it, we're improving audience attendance and building active jazz communities worldwide.</strong>
			</div>
...
<div class="modal fade" id="sitemap_overlay" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
		...
		<div class="social pull-right">
			...
			<a target="_blank" class="btn ico-32 icon-google pic-round" role="button" href="//plus.google.com/+Allaboutjazz" title="All About Jazz on Google+"><i class="fa fa-google"></i></a>
					...
					<div class="col-xs-12 col-sm-6">	
						...
						<form action="//www.allaboutjazz.com/php/article_center.php" method="get">
							...
							<div class="row">
								...
								<div class="col-xs-12 col-sm-8">
									<select name="in_type"><option value=0>&nbsp;</option><option value="85">AAJ PRO</option><option value="74">African Jazz</option><option value="169">Afrobeat Diaries</option><option value="107">All About Jazz: South Africa</option><option value="38">Anatomy of a Standard</option><option value="4">Ask Ken</option><option value="136">Back Roads Beat</option><option value="83">Bailey's Bundles</option><option value="184">Behind the Lens With...</option><option value="79">Best of / Year End</option><option value="145">Big Band Caravan</option><option value="125">Big Band in the Sky</option><option value="7">Big Band Report</option><option value="134">Big Jazz Nerd</option><option value="160">Bill Anschell's Notes from the Lobby</option><option value="245">Blues Deluxe</option><option value="126">Book Excerpts</option><option value="9">Book Reviews</option><option value="72">Building a Jazz Library</option><option value="163">Built to Sound</option><option value="189">Catching Up With</option><option value="100">CD/LP/Track Review</option><option value="71">Compare & Contrast</option><option value="138">Confessions of a Piano Player</option><option value="89">Contemporary Vibes</option><option value="133">Contributor News</option><option value="157">Cool Vic Files</option><option value="191">Cymbalism</option><option value="158">Dan's Den</option><option value="112">Digital Music</option><option value="116">Discography</option><option value="110">Download Reviews</option><option value="225">Drum Addiction</option><option value="68">DVD/Film Reviews</option><option value="96">Extended Analysis</option><option value="205">First Impressions</option><option value="23">First Time I Saw</option><option value="177">Forgotten Finds</option><option value="198">Fre-Formation</option><option value="149">From Far and Wide</option><option value="25">From the Inside Out</option><option value="144">Future Jazz</option><option value="181">Future Theory, Future Practice</option><option value="27">General Articles</option><option value="28">Genius Guide to Jazz</option><option value="42">Getting Into Jazz</option><option value="174">Gnome Notes</option><option value="54">Guilty Pleasures</option><option value="220">Guitarist's Rendezvous</option><option value="197">Hardly Strictly Jazz</option><option value="47">Hi-Res Jazz</option><option value="95">Highly Opinionated</option><option value="108">History of Jazz</option><option value="30">Improvise!</option><option value="244">In Pictures</option><option value="137">In the Artist's Own Words</option><option value="216">In The Biz</option><option value="117">In the Studio</option><option value="32">Interview</option><option value="119">Jazz and the Net</option><option value="148">Jazz Art</option><option value="170">Jazz Biofiles</option><option value="207">Jazz Emerges</option><option value="156">Jazz Fiction</option><option value="22">Jazz For Kids</option><option value="33">Jazz From The Vinyl Junkyard</option><option value="210">Jazz Goes to College</option><option value="102">Jazz Humor</option><option value="190">Jazz in the Aquarian Age</option><option value="93">Jazz Journal</option><option value="221">Jazz Near Me</option><option value="58">Jazz Poetry</option><option value="118">Jazz Primer</option><option value="252">Jazz Quest</option><option value="11">Jazz Raconteurs</option><option value="175">Jazz That Scratches, Swings and Pops</option><option value="34">Jazz Uncorked</option><option value="35">Jazzin' Around Europe</option><option value="168">JazzLife UK</option><option value="246">Jazzmatazz</option><option value="248">Jazzmatazz</option><option value="249">Jazzmatazz</option><option value="37">Journey into Jazz</option><option value="40">Late Night Thoughts on Jazz</option><option value="43">Liner Notes</option><option value="130">Listen To This!</option><option value="52">Live From New York</option><option value="186">Live From Philadelphia</option><option value="19">Live Reviews</option><option value="44">London Calling</option><option value="155">Making Music</option><option value="103">Meet the Staff</option><option value="82">Megaphone</option><option value="176">Mixed Tape</option><option value="161">Mr. P.C.'s Guide to Jazz Etiquette...</option><option value="84">Multiple Reviews</option><option value="127">Muse From the Front</option><option value="153">Music and the Creative Spirit</option><option value="50">Musings In Cb</option><option value="224">Musings of a Jazz Piano Teacher</option><option value="97">Must Hear Review</option><option value="214">My Blue Note Obsession</option><option value="120">My Favourite Things</option><option value="45">New & Noteworthy</option><option value="36">New York @ Night</option><option value="51">New York Beat</option><option value="80">Nite & Disk</option><option value="104">Nordic Sounds</option><option value="115">Not For Sale</option><option value="165">Old, New, Borrowed and Blue</option><option value="188">On and Off the Grid</option><option value="182">On the Road With...</option><option value="65">One LP</option><option value="55">Opinion</option><option value="24">Out and About: The Super Fans</option><option value="56">Out-of-Print</option><option value="206">Philosophisticated Lady</option><option value="132">Podcast</option><option value="147">Previews</option><option value="139">Product Reviews</option><option value="3">Profiles</option><option value="178">Race and Jazz</option><option value="106">Readers Write Back</option><option value="59">Reassessing</option><option value="39">Record Label Profiles</option><option value="219">Rediscovery</option><option value="60">Rhythm In Every Guise</option><option value="98">Roads Less Travelled</option><option value="203">Scumbles</option><option value="77">Shrinktunes</option><option value="113">Spirit of '76</option><option value="101">Straight From The Vault</option><option value="185">Stretch Movement</option><option value="122">Swing Set</option><option value="141">Take Five With...</option><option value="183">Talkin' Blues</option><option value="217">Talking 2 Musicians</option><option value="209">Tell Me More</option><option value="162">The Art and Science of Jazz</option><option value="167">The Art Of The Artist To Fan Relationship</option><option value="223">The Audiophile</option><option value="218">The Big Question</option><option value="135">The Cool Vic Files</option><option value="194">The Doorman's Diary</option><option value="88">The Low End</option><option value="195">The Moment's Energy</option><option value="201">The Mort Report</option><option value="215">The Vinyl Post</option><option value="222">Top Ten List</option><option value="202">Under the Radar</option><option value="166">Unsung Heroes</option><option value="128">Video Feature</option><option value="199">We Travel the Spaceways</option><option value="69">Website News</option><option value="211">What I'm Listening to Now</option><option value="143">What is Jazz?</option><option value="70">Wide Open Jazz and Beyond</option><option value="171">Working Out to Jazz</option></select>
								</div>
							</div>
							<div class="row">
	...
	<h3>Article Stats</h3>
	<ul>
		<li><a href="/php/article_center.php" title="Search our article archive">18,823 Articles</a></li>
		<li><a href="/php/review_center.php" title="Search our review archive">46,460 Album Reviews</a></li>
		<li><a href="/php/contributor_center.php" title="Meet the staff">1,182 Contributors</a></li>
	</ul>
</div>
    					</div>
					<div class="col-xs-12 col-sm-3">
				...
				<div class="row modal-text-content">
					...
					<div class="col-xs-12 col-sm-4">
						<h3>Pro Links</h3>
										...
										<h3>Gallery Stats</h3>
<ul>
	<li><span>150,518 Images</span></li>
	<li><span>204 Visual Artists</span></li>
	<li><span>11,120 Uploaders</span></li>
</ul>
    					</div>
				</div>
			</div>
			...
			<div role="tabpanel" class="tab-pane fade in" id="shop_tab">
				<div class="row modal-text-content">
					<div class="col-xs-12">
<h3>A simple way to support All About Jazz and Jazz Near You.</h3>
...
<a href=http://www.amazon.com/b?_encoding=UTF8&camp=1789&creative=9325&linkCode=ur2&node=34&site-redirect=&tag=alabja00-20><img src="https://www.allaboutjazz.com/images/vinyl_160x22.png" width="106" height="22" border="0" /></a> 
...
<!--<link rel="stylesheet" href="//www.allaboutjazz.com/css/main-style.min.css" media="all" /> // contains animate css -->
