...
window.aWY=!!window.aWY;try{(function(){try{var oo,Oo,Zo=1,Io=1;for(var jo=0;jo<Oo;++jo)Zo+=2,Io+=3;oo=Zo+Io;window.IO===oo&&(window.IO=++oo)}catch(lo){window.IO=oo}var Lo=!0;function SO(O){O&&(Lo=!1,document.cookie="brav=ad");return Lo}function _O(){}SO(window[_O.name]===_O);SO("function"!==typeof ie9rgb4);SO(/\x3c/.test(function(){return"\x3c"})&!/x3d/.test(function(){return"'x3'+'d';"}));
var lO=window.attachEvent||/mobi/i.test(window["\x6e\x61vi\x67a\x74\x6f\x72"]["\x75\x73e\x72A\x67\x65\x6et"]),LO=+new Date+6E5,oz,Sz,Jz=setTimeout,oZ=lO?3E4:6E3;function OZ(){if(!document.querySelector)return!0;var O=+new Date,s=O>LO;if(s)return SO(!1);s=Sz&&oz+oZ<O;s=SO(s);oz=O;Sz||(Sz=!0,Jz(function(){Sz=!1},1));return s}OZ();var zZ=[17795081,27611931586,1558153217];
function sZ(O){O="string"===typeof O?O:O.toString(36);var s=window[O];if(!s.toString)return;var _=""+s;window[O]=function(O,_){Sz=!1;return s(O,_)};window[O].toString=function(){return _}}for(var SZ=0;SZ<zZ.length;++SZ)sZ(zZ[SZ]);SO(!1!==window.aWY);
(function _Z(){if(!OZ())return;var s=!1;function _(s){for(var I=0;s--;)I+=J(document.documentElement,null);return I}function J(s,I){var _="vi";I=I||new l;return _o(s,function(s){s.setAttribute("data-"+_,I.Li());return J(s,I)},null)}function l(){this.Zs=1;this.Os=0;this.Jo=this.Zs;this.c=null;this.Li=function(){this.c=this.Os+this.Jo;if(!isFinite(this.c))return this.reset(),this.Li();this.Os=this.Jo;this.Jo=this.c;this.c=null;return this.Jo};this.reset=function(){this.Zs++;this.Os=0;this.Jo=this.Zs}}
var L=!1;function I(s,I){if(!OZ())return;var _=document.createElement(s);I=I||document.body;I.appendChild(_);_&&_.style&&(_.style.display="none");OZ()}function so(I,_){if(!OZ())return;_=_||I;var J="|";function l(s){s=s.split(J);var I=[];for(var _=0;_<s.length;++_){var L="",zo=s[_].split(",");for(var so=0;so<zo.length;++so)L+=zo[so][so];I.push(L)}return I}var so=0,_o="datalist,details,embed,figure,hrimg,strong,article,formaddress|audio,blockquote,area,source,input|canvas,form,link,tbase,option,details,article";
_o.split(J);_o=l(_o);_o=new RegExp(_o.join(J),"g");while(_o.exec(I))_o=new RegExp((""+new Date)[8],"g"),s&&(L=OZ()),++so;return OZ()?_(so&&1):void 0}function _o(s,_,J){if(!OZ())return;(J=J||L)&&I("div",s);s=s.children;var l=0;for(var so in s){J=s[so];try{J instanceof HTMLElement&&(_(J),++l)}catch(_o){}}return OZ()?l:void 0}so(_Z,_);OZ()})();var IZ=34;window.Ss={Is:""};function z(O){return 928>O}
function Z(O){var s=arguments.length,_=[];for(var J=1;J<s;++J)_.push(arguments[J]-O);return String.fromCharCode.apply(String,_)}function S(O,s){O+=s;return O.toString(36)}(function jZ(s){return s?0:jZ(s)*jZ(s)})(OZ());})();}catch(x){document.cookie='brav=oex'+x;}finally{ie9rgb4=void(0);};function ie9rgb4(a,b){return a>>b>>0};

})();

</script>
</APM_DO_NOT_TOUCH>
<script type="text/javascript" src="/TSbd/0841594ed5ab2000084421cf6f5be4b96681346861ac69194c96957e8eb83c682dd711bea42e87eb?type=3"></script>
<script src="http://www.tarc.edu.my/assets/js/ace-extra.js"></script>
		...
		<link rel="stylesheet" href="http://www.tarc.edu.my/assets/css/red.css">
        ...
        <div  class="rd-navbar-nav-wrap">
          <div class="rd-navbar-nav-inner">
            ...
            <ul class="rd-navbar-nav">
             <li><a href="http://www.tarc.edu.my/" target="_self"><span class="fa-stack fa-lg">  	<i class="fa fa-circle fa-stack-2x red"></i> 	<i class="fa fa-home fa-stack-1x fa-inverse"></i></span> Home </a>
            </ul>
