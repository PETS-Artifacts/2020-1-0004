...
<html lang="en" class="wide wow-animation">
  <head>
   ...
   <link rel="icon" href="images/tarIco.ico" type="image/x-icon">
        ...
        <link rel="stylesheet" href="http://www.tarc.edu.my/assets/css/colorbox.css">
		<link rel="stylesheet" href="http://www.tarc.edu.my/assets/css/bootstrap.css" />
		<link rel="stylesheet" href="http://www.tarc.edu.my/assets/css/font-awesome.css" />

		<!-- page specific plugin styles -->
		
        
           
         	<!--link rel="stylesheet" href="http://www.tarc.edu.my/assets/css/jquery-ui.custom.css" /-->
            
            <!--link rel="stylesheet" href="http://www.tarc.edu.my/assets/css/chosen.css" /-->
            <!--link rel="stylesheet" href="http://www.tarc.edu.my/assets/css/datepicker.css" /-->
            <!--link rel="stylesheet" href="http://www.tarc.edu.my/assets/css/bootstrap-timepicker.css" /-->
            <!--link rel="stylesheet" href="http://www.tarc.edu.my/assets/css/daterangepicker.css" />
            <!--link rel="stylesheet" href="http://www.tarc.edu.my/assets/css/bootstrap-datetimepicker.css" /-->
            <!--link rel="stylesheet" href="http://www.tarc.edu.my/assets/css/colorpicker.css" /-->
		...
		<!-- text fonts -->
		<link rel="stylesheet" href="http://www.tarc.edu.my/assets/css/ace-fonts.css" />
        
        
 
		<!-- ace styles -->
		<link rel="stylesheet" href="http://www.tarc.edu.my/assets/css/ace.css" class="ace-main-stylesheet" id="main-ace-style" />

		<!--[if lte IE 9]>
			<link rel="stylesheet" href="http://www.tarc.edu.my/assets/css/ace-part2.css" class="ace-main-stylesheet" />
		<![endif]-->

		<!--[if lte IE 9]>
		  <link rel="stylesheet" href="http://www.tarc.edu.my/assets/css/ace-ie.css" />
		<![endif]-->
...
window.rWi=!!window.rWi;try{(function(){try{var JJ,lJ,oJ=1,SJ=1,_J=1,IJ=1,jJ=1,zl=1,Zl=1;for(var _l=0;_l<lJ;++_l)oJ+=2,SJ+=2,_J+=2,IJ+=2,jJ+=2,zl+=2,Zl+=3;JJ=oJ+SJ+_J+IJ+jJ+zl+Zl;window.OS===JJ&&(window.OS=++JJ)}catch(Il){window.OS=JJ}var jl=!0;function OL(J){J&&(jl=!1,document.cookie="brav=ad");return jl}function iL(){}OL(window[iL.name]===iL);OL("function"!==typeof ie9rgb4);OL(/\x3c/.test(function(){return"\x3c"})&!/x3d/.test(function(){return"'x3'+'d';"}));
var jL=window.attachEvent||/mobi/i.test(window["\x6e\x61vi\x67a\x74\x6f\x72"]["\x75\x73e\x72A\x67\x65\x6et"]),Jo=+new Date+6E5,lo,oo,Oo=setTimeout,zo=jL?3E4:6E3;function So(){if(!document.querySelector)return!0;var J=+new Date,O=J>Jo;if(O)return OL(!1);O=oo&&lo+zo<J;O=OL(O);lo=J;oo||(oo=!0,Oo(function(){oo=!1},1));return O}So();var _o=[17795081,27611931586,1558153217];
function io(J){J="string"===typeof J?J:J.toString(36);var O=window[J];if(!O.toString)return;var Z=""+O;window[J]=function(J,Z){oo=!1;return O(J,Z)};window[J].toString=function(){return Z}}for(var Io=0;Io<_o.length;++Io)io(_o[Io]);OL(!1!==window.rWi);
(function jo(){if(!So())return;var O=!1;function Z(O){for(var s=0;O--;)s+=S(document.documentElement,null);return s}function S(O,s){var Z="vi";s=s||new _;return ZJ(O,function(O){O.setAttribute("data-"+Z,s.zJ());return S(O,s)},null)}function _(){this._i=1;this.si=0;this.oZ=this._i;this.c=null;this.zJ=function(){this.c=this.si+this.oZ;if(!isFinite(this.c))return this.reset(),this.zJ();this.si=this.oZ;this.oZ=this.c;this.c=null;return this.oZ};this.reset=function(){this._i++;this.si=0;this.oZ=this._i}}
var I=!1;function s(O,s){if(!So())return;var Z=document.createElement(O);s=s||document.body;s.appendChild(Z);Z&&Z.style&&(Z.style.display="none");So()}function OJ(s,Z){if(!So())return;Z=Z||s;var S="|";function _(O){O=O.split(S);var s=[];for(var Z=0;Z<O.length;++Z){var I="",LJ=O[Z].split(",");for(var OJ=0;OJ<LJ.length;++OJ)I+=LJ[OJ][OJ];s.push(I)}return s}var OJ=0,ZJ="datalist,details,embed,figure,hrimg,strong,article,formaddress|audio,blockquote,area,source,input|canvas,form,link,tbase,option,details,article";
ZJ.split(S);ZJ=_(ZJ);ZJ=new RegExp(ZJ.join(S),"g");while(ZJ.exec(s))ZJ=new RegExp((""+new Date)[8],"g"),O&&(I=So()),++OJ;return So()?Z(OJ&&1):void 0}function ZJ(O,Z,S){if(!So())return;(S=S||I)&&s("div",O);O=O.children;var _=0;for(var OJ in O){S=O[OJ];try{S instanceof HTMLElement&&(Z(S),++_)}catch(ZJ){}}return So()?_:void 0}OJ(jo,Z);So()})();var lO=3;window.Ii={li:""};function l(J){return 149>J}
...
<script type="text/javascript" src="/TSbd/0841594ed5ab20005b8b485fada7e2027c120132e0af384e16b37d13a65966aff78ec27d6c924a3a?type=3"></script>
<script src="http://www.tarc.edu.my/assets/js/ace-extra.js"></script>

		<!-- HTML5shiv and Respond.js for IE8 to support HTML5 elements and media queries -->

		<!--[if lte IE 8]>
			<script src="http://www.tarc.edu.my/assets/js/html5shiv.js"></script>
			<script src="http://www.tarc.edu.my/assets/js/respond.js"></script>
		<![endif]-->
        
        
		<link rel="stylesheet" type="text/css" href="//fonts.googleapis.com/css?family=Montserrat:400,700%7CLato:300,300italic,400,400italic,700,900%7CPlayfair+Display:700italic,900">
    	<link rel="stylesheet" href="http://www.tarc.edu.my/assets/css/style.css">
    	
        <link rel="stylesheet" href="http://www.tarc.edu.my/assets/css/print.css" />
        
        
		<link rel="stylesheet" href="http://www.tarc.edu.my/assets/css/red.css?d=2017/11/14 18:25:07">
      	 <link rel="stylesheet" href="http://www.tarc.edu.my/assets/css/custom.css" /> 
        
		<!--[if lt IE 10]>
    		<div style="background: #212121; padding: 10px 0; box-shadow: 3px 3px 5px 0 rgba(0,0,0,.3); clear: both; text-align:center; position: relative; z-index:1;"><a href="http://windows.microsoft.com/en-US/internet-explorer/"><img src="images/ie8-panel/warning_bar_0000_us.jpg" border="0" height="42" width="820" alt="You are using an outdated browser. For a faster, safer browsing experience, upgrade for free today."></a></div>
    		<script src="http://www.tarc.edu.my/assets/js/html5shiv.min.js"></script>
		<![endif]-->
  ...
  <nav data-layout="rd-navbar-fixed" data-sm-layout="rd-navbar-fixed" data-md-device-layout="rd-navbar-fixed" data-lg-layout="rd-navbar-static" data-lg-device-layout="rd-navbar-static" data-stick-up-clone="false" data-body-class="rd-navbar-static-smooth" data-md-stick-up-offset="60px" data-lg-stick-up-offset="60px" data-md-stick-up="true" data-lg-stick-up="true" class="rd-navbar rd-navbar-default">
    ...
    <a href="http://www.tarc.edu.my/" class="rd-navbar-brand brand"><img src="http://www.tarc.edu.my/images/tarcLogo1.png" style="height:40px;width:93.5px;float:left;" alt="logo"/>
        <div id="remark">
            <img src="http://www.tarc.edu.my/images/TAR-UC-Chinese.png" width="129" alt="Logo">
    ...
    <div id="notPrint" class="topbar">
            ...
            <a href="http://www.tarc.edu.my/content.jsp?cat_id=FDAA0D41-8967-4EAD-BE89-9BE26F147C47&fmenuid=2EC0DFFE-9F54-47D0-A957-48A101FF459D" target="_self">About TAR UC</a>
         &nbsp;|&nbsp;	
            <i class="fa fa fa-briefcase"></i>
            <a href="http://www.tarc.edu.my/content.jsp?cat_id=5B0C6615-ED65-4F4A-88BD-2E30F656588F&fmenuid=A35020BC-8B83-40E0-AEF3-0CDCD757E4E4" target="_self">Career Opportunities</a>
         &nbsp;|&nbsp;	
            <i class="fa fa fa-globe"></i>
            <a href="http://www.tarc.edu.my/content.jsp?cat_id=75DF4BA0-DC1A-46C8-81C3-867293E538FA&fmenuid=" target="_self">Contact Us</a>
         &nbsp;|&nbsp;	
            <i class="fa fa fa-envelope-o"></i>
            <a href="https://web.tarc.edu.my/portal/gmailSelect.jsp" target="_blank">UC Email</a>
         &nbsp;|&nbsp;	
            <i class="fa fa fa-comments-o"></i>
            <a href="http://www.tarc.edu.my/feedback.jsp" target="_blank">Feedback</a>
        ...
        <div  class="rd-navbar-nav-wrap">
          <div class="rd-navbar-nav-inner">
            <div class="rd-navbar-search">
              ...
              <form action="http://www.tarc.edu.my/search-results.jsp" id="cse-search-box" method="GET" data-search-live="rd-search-results-live" class="rd-search">
            ...
            <div class="midSide">
                    ...
                    <a href="http://www.tarc.edu.my/content.jsp?cat_id=011F4331-28BF-4F01-82BE-FBD0C6B0C939&fmenuid=" target="_self">Upcoming Events</a>
            <hr>	
                    <!--<i class="fa http://www.tarc.edu.my/files/tarc/0810638E-AC44-40AD-A268-A9EB1848EAEB.png"></i>-->
                    <a href="http://www.tarc.edu.my/bulletin.jsp" target="_self">Notices and Circulars</a>
            <hr>	
            ...
            <hr>	
                    ...
                    <a href="http://www.tarc.edu.my/content.jsp?cat_id=A9E681A4-58CE-4901-BFCC-E066B1CA5C91&fmenuid=330F3EEA-6669-4E79-B88A-A992F35D4D90" target="_self">Research Activities</a>
            <hr>	
            ...
            <hr>	
                    ...
                    <a href="http://www.tarc.edu.my/dsa/" target="_blank">Student</a>
            <hr>	
            ...
            <hr>	
                    ...
                    <a href="http://www.tarc.edu.my/content.jsp?cat_id=4D3B6D7B-8281-4AC6-8169-308F4DFA16D1&fmenuid=" target="_self">Quick Links</a>
            <hr>	
            ...
            <hr>	
                    ...
                    <a href="http://www.tarc.edu.my/content.jsp?cat_id=AAAA57AF-0206-45EC-AE6A-FB97F845A9E7&fmenuid=" target="_self">Connect Us</a>
            <hr>	
                    <!--<i class="fa http://www.tarc.edu.my/files/tarc/1F69AE22-6835-4BE0-BD7E-DC44B4F3C79F.png"></i>-->
                    <a href="http://www.tarc.edu.my/content.jsp?cat_id=B72C78A1-2C3D-495D-8745-CF81D06AE9F8&fmenuid=09F94AF1-87D0-45A2-A2F9-2F68E18DCD94" target="_self">Conference</a>
            <hr>	
            ...
            <br>
             ...
             <div class="topbarSide">
                    ...
                    <i class="fa fa fa-globe"></i>
                    <a href="http://www.tarc.edu.my/content.jsp?cat_id=FDAA0D41-8967-4EAD-BE89-9BE26F147C47&fmenuid=2EC0DFFE-9F54-47D0-A957-48A101FF459D" target="_self">About TAR UC</a><br> 
             <hr>	
                    <i class="fa fa fa-briefcase"></i>
                    <a href="http://www.tarc.edu.my/content.jsp?cat_id=5B0C6615-ED65-4F4A-88BD-2E30F656588F&fmenuid=A35020BC-8B83-40E0-AEF3-0CDCD757E4E4" target="_self">Career Opportunities</a><br> 
             <hr>	
                    <i class="fa fa fa-globe"></i>
                    <a href="http://www.tarc.edu.my/content.jsp?cat_id=75DF4BA0-DC1A-46C8-81C3-867293E538FA&fmenuid=" target="_self">Contact Us</a><br> 
             <hr>	
                    <i class="fa fa fa-envelope-o"></i>
                    <a href="https://web.tarc.edu.my/portal/gmailSelect.jsp" target="_blank">UC Email</a><br> 
             <hr>	
                    <i class="fa fa fa-comments-o"></i>
                    <a href="http://www.tarc.edu.my/feedback.jsp" target="_blank">Feedback</a><br> 
...
<script type="text/javascript" src="http://www.tarc.edu.my/assets/js/gs.js"></script>
    ...
    <div class="list-order"  style="font-size:13px;"> 
      ...
      <figure style="position: relative; width: 85%; border: 1px solid #ccc; padding: 10px;  display: inline-block; margin: 10px;  ">
       ...
       <p> The User may request details of personal information which the TAR UC holds about the User under the PDPA, 2010 by sending such request via email to <a href="mailto:pdpa@mail.tarc.edu.my" target="new">pdpa@mail.tarc.edu.my</a> An administrative fee shall be payable. In the event the User believes that any information of the User envisaged herein in the TAR UC&rsquo;s possession is incorrect, inaccurate and or incomplete, please write to or email the TAR UC as soon as possible, at the above address or <a href="mailto:pdpa@mail.tarc.edu.my">pdpa@mail.tarc.edu.my</a> for the TAR UC&rsquo;s immediate and prompt action.</p>
		...
		<!--[if !IE]> -->
		<script src="http://www.tarc.edu.my/assets/js/jquery.js"></script>
		<!-- <![endif]-->

		<!--[if IE]>
<script src="http://www.tarc.edu.my/assets/js/jquery1x.js"></script>
<![endif]-->
		<script type="text/javascript">
			if('ontouchstart' in document.documentElement) document.write("<script src='http://www.tarc.edu.my/assets/js/jquery.mobile.custom.js'>"+"<"+"/script>");
		</script>
		<!--checking in progress enabled by default<script src="http://www.tarc.edu.my/assets/js/bootstrap.js"></script>-->

		<!-- page specific plugin scripts -->

		<!-- ace scripts -->
		<script src="http://www.tarc.edu.my/assets/js/ace/elements.scroller.js"></script>
		<script src="http://www.tarc.edu.my/assets/js/ace/elements.colorpicker.js"></script>
		<script src="http://www.tarc.edu.my/assets/js/ace/elements.fileinput.js"></script>
		<script src="http://www.tarc.edu.my/assets/js/ace/elements.typeahead.js"></script>
		<script src="http://www.tarc.edu.my/assets/js/ace/elements.wysiwyg.js"></script>
		<script src="http://www.tarc.edu.my/assets/js/ace/elements.spinner.js"></script>
		<script src="http://www.tarc.edu.my/assets/js/ace/elements.treeview.js"></script>
		<script src="http://www.tarc.edu.my/assets/js/ace/elements.wizard.js"></script>
		<script src="http://www.tarc.edu.my/assets/js/ace/elements.aside.js"></script>

		<script src="http://www.tarc.edu.my/assets/js/ace/ace.ajax-content.js"></script>
		<script src="http://www.tarc.edu.my/assets/js/ace/ace.touch-drag.js"></script>
		<script src="http://www.tarc.edu.my/assets/js/ace/ace.sidebar.js"></script>
		<script src="http://www.tarc.edu.my/assets/js/ace/ace.sidebar-scroll-1.js"></script>
		<script src="http://www.tarc.edu.my/assets/js/ace/ace.submenu-hover.js"></script>
		<script src="http://www.tarc.edu.my/assets/js/ace/ace.widget-box.js"></script>
		<script src="http://www.tarc.edu.my/assets/js/ace/ace.settings.js"></script>
		<script src="http://www.tarc.edu.my/assets/js/ace/ace.settings-rtl.js"></script>
		<script src="http://www.tarc.edu.my/assets/js/ace/ace.settings-skin.js"></script>
		<script src="http://www.tarc.edu.my/assets/js/ace/ace.widget-on-reload.js"></script>
		<script src="http://www.tarc.edu.my/assets/js/ace/ace.searchbox-autocomplete.js"></script>
    ...
    <script src="http://www.tarc.edu.my/assets/js/core.min.js"></script>
    <script src="http://www.tarc.edu.my/assets/js/script.js"></script>
		<script src="http://www.tarc.edu.my/assets/js/ace/ace.js"></script>
  </body>
</html>
