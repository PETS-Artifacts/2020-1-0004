...
<html lang="en" class="wide wow-animation">
  <head>
   ...
   <link rel="icon" href="images/tarIco.ico" type="image/x-icon">
		...
		<link rel="stylesheet" href="http://www.tarc.edu.my/assets/css/red.css?d=2018/02/22 17:43:42">
...
<![endif]-->
        ...
        <div class="shell">
          <div class="range">
            ...
            <div class="cell-xs-12" style="padding:0px;">
	...
	width: 100%;
           ...
           <script type="text/javascript">
            $(document).ready(function() {
					...
					var server = new Date("Feb 22, 2018 17:43:42 +0800"); 
					//server.setMinutes(server.getMinutes() + 5); 
					server.setSeconds(server.getSeconds() + 80); 
					return server; 
					}
