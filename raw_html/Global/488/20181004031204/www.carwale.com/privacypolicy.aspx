...
<link rel="stylesheet" href="https://stc.aeplcdn.com/staticminv2/css/cw-common-style-b05ab8bf49.css" type="text/css" >
<link rel="stylesheet" href="https://stc.aeplcdn.com/staticminv2/cwfontawesome/cw-font-awesome-15370348a1.css" type="text/css" >
<link rel="stylesheet" href="https://stc.aeplcdn.com/staticminv2/css/location-plugin-6253d34341.css" type="text/css" >
<script   type="text/javascript"   src="https://stc.aeplcdn.com/staticminv2/js/frameworks-2913c6000a.js"  ></script>
<style>
	@font-face {
...
<script type='text/javascript'>
googletag.cmd.push(function () {googletag.pubads().setTargeting('CarType', 'None');});googletag.cmd.push(function () {googletag.pubads().setTargeting('LeadCount', '0');});googletag.cmd.push(function () {googletag.pubads().setTargeting('ModelsList', 'NA');});googletag.cmd.push(function () {googletag.pubads().setTargeting('BodyStyleList', 'NA');});googletag.cmd.push(function () {googletag.pubads().setTargeting('BudgetSegmentList', 'NA');});googletag.cmd.push(function () {googletag.pubads().setTargeting('CarCount', '0');});gtag('event', 'page_view', {'send_to': 'AW-999894061','CarType': 'None','LeadCount': '0','ModelsList': 'NA','BodyStyleList': 'NA','BudgetSegmentList': 'NA','CarCount': '0'});</script>
...
<script type="text/javascript">
	landingPage = false
	testDriveCampaignIds = [6185,6268,6873,3842,5212,6929]
</script>
...
<div id="header" class="header-fixed main-nav-header">
	...
	<div class="leftfloat margin-top10 min-width230">
	 ...
	 <nav id="cw-top-navigation-wrapper">
			...
			<!-- ko if:  historyModels().length > 0 && trendingModels().length > 0 --><div class="global-search-section bg-white padding-bottom20 trendindcars-dumy-class hide"><!-- ko if:historyModels().length > 0 --><div class="history-search"><div class="search-title font12 text-light-grey">Recently Viewed</div><ul class="search-list-section margin-bottom10" data-bind="foreach: historyModels"><li data-bind="attr: { class: isSponsored ? 'ad-search-list text-bold text-black' : '' }"><span data-bind="attr: { class: isSponsored ? 'ad-text-icon text-white padding-right10' : 'recent-clock cwmsprite padding-right10' }, text: isSponsored ? 'Ad' : ''"></span><a data-bind="attr: { href: '/' + Common.utils.formatSpecial(makeName) + '-cars/' + maskingName + '/' }, event: { click: function () { GetGlobalSearchCampaigns.logClicks($data, 'history', 'global-search-popup-cars', $index(), false); return true; } }"><span class="model-search-name" data-bind="text: makeName + ' ' + modelName"></span></a></li></ul></div><!-- /ko --><!-- ko if:trendingModels().length > 0 --><div class="trending-search"><div class="search-title font12 text-light-grey">Trending Searches</div><ul class="search-list-section"><!-- ko foreach: trendingModels --><li data-bind="attr: { class: $data.hasOwnProperty('adPosition') ? 'ad-search-list text-bold text-black' : '' }"><span data-bind="attr: { class: $data.hasOwnProperty('adPosition') ? 'ad-text-icon text-white padding-right10' : 'trending-icon cwmsprite padding-right10' }, text: $data.hasOwnProperty('adPosition') ? 'Ad' : ''"></span><a data-bind="attr: { href: '/' + Common.utils.formatSpecial(makeName) + '-cars/' + maskingName + '/' }, event: { click: function () { GetGlobalSearchCampaigns.logClicks($data, 'trending', 'global-search-popup-cars', $index(), false); return true; } }"><span class="model-search-name" data-bind="text: makeName + ' ' + modelName"></span></a></li><!-- /ko --></ul></div><!-- /ko --></div><!-- /ko-->
			</div>
			<div class="clear"></div>
		</nav>
		...
		<section class="container">
			...
			<div class="grid-12">
				<div class="padding-bottom15 text-center">
					<div class='inline-block ad-slot'><div class='text-right font11 text-medium-grey'>Ad</div><div id='div-gpt-ad-1396440332273-4' data-load-immediate='false' style='margin:0px auto 0px auto;'><script type='text/javascript'>googletag.cmd.push(function () { googletag.display('div-gpt-ad-1396440332273-4'); });</script></div></div>
				</div>
			</div>
			<div class="clear"></div>
		</section>
			...
			<div class="container">
				<div class="grid-12">
					<div class="content-box-shadow content-inner-block-10 margin-bottom20" id="privacy-policy">
						...
						<h1 class="font30 text-black border-solid-bottom padding-bottom10 special-skin-text">Privacy Policy</h1>
						<p>
						...
						we encourage you to opt out of the receipt of certain communications in your profile. You may make changes to your profile at any time.<br>
						By using CarWale.com and filling any form on our site, you authorize us & both our current and future associate partners (including but not limited to financial partners and several automotive partners) to communicate with you via SMS, Email, Phone or any other means to offer you their and our services, imparting product knowledge, offering promotional offers listed on the website & offers offered by the associated third parties, regardless of your DNC or DND status.
						</p>
						<br />
						<span class="text-bold">
						...
						<p>
							...
							We might share much of our data, including browsing behavior and personal information about you, with our parent, affiliates, subsidiaries, and 
							joint ventures that are committed to serving your online trading needs and related services, throughout the world. To the extent that these 
							entities (including dealers, car manufacturers, banks, NBFCs etc.) have access to your information, they will treat it at least as protectively 
							as they treat information they obtain from their other users. Our parent, affiliates, subsidiaries, and joint ventures follow privacy practices 
							no less protective of all users than our practices described in this document, to the extent allowed by applicable law. CarWale, its parent, 
							affiliates, subsidiaries, its joint ventures, or any combination of such, will share some or all of your personal information with another 
							business entity should we plan to, merge with, or be acquired by that business entity. Should such a combination occur, we will require that 
							the new combined entity follow this Privacy Policy with respect to your personal information.
						</p>
						<br />
						<p>
							6. Legal Requests <br>
...
<script  type="text/javascript"  src="https://stc.aeplcdn.com/staticminv2/js/plugins-166baa000e.js" ></script>
<script   type="text/javascript"  src="https://stc.aeplcdn.com/staticminv2/src/graybox-a39cfd2589.js" ></script>
<script   type="text/javascript"  src="https://stc.aeplcdn.com/staticminv2/js/adsense-e1e8ac6247.js" ></script>
<script   type="text/javascript"  src="https://stc.aeplcdn.com/staticminv2/js/v2/app/clientcache-dedf89e722.js" ></script>
<script   type="text/javascript"  src="https://stc.aeplcdn.com/staticminv2/js/globalsearch-3e8db6850f.js" ></script>
<script   type="text/javascript"  src="https://stc.aeplcdn.com/staticminv2/js/sponsorednavigation-01e2ea26e0.js" ></script>
<script  type="text/javascript"  src="https://stc.aeplcdn.com/staticminv2/js/error-logger-6d7b43f4fa.js" ></script>
<script   type="text/javascript"  src="https://stc.aeplcdn.com/staticminv2/js/common-eff8410125.js" ></script>
<script   type="text/javascript"  src="https://stc.aeplcdn.com/staticminv2/js/lead-conversion-tracking-b00583b029.js" ></script>
<script   type="text/javascript"  src="https://stc.aeplcdn.com/staticminv2/js/cookie-migration-d7965c94d1.js" ></script>
<script   type="text/javascript"  src="https://stc.aeplcdn.com/staticminv2/js/newcar-common-ed18fd86ac.js" ></script>
<script   type="text/javascript"  src="https://stc.aeplcdn.com/staticminv2/js/v2/app/cwtracking-41e836e420.js" ></script>
<script   type="text/javascript"  src="https://stc.aeplcdn.com/staticminv2/js/location-plugin-07cd139abe.js" ></script>
<script   type="text/javascript"  src="https://stc.aeplcdn.com/staticminv2/js/pricebreakup-02e8bd2ab8.js" ></script>
<script type="text/javascript">
