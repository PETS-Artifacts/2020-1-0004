...
<link rel="stylesheet" href="https://stc.aeplcdn.com/staticminv1/css/cw-common-style-926cac8546.css" type="text/css" >
...
<script type="text/javascript">
	landingPage = false
	testDriveCampaignIds = [6239,6185,7385,7559]
</script>
...
<div id="header" class="header-fixed main-nav-header">
	...
	<div class="leftfloat margin-top10">
	 ...
	 <nav id="cw-top-navigation-wrapper">
			...
			<!-- ko if:  historyModels().length > 0 && trendingModels().length > 0 --><div class="global-search-section bg-white padding-bottom20 trendindcars-dumy-class hide"><!-- ko if:historyModels().length > 0 --><div class="history-search"><div class="search-title font12 text-light-grey">Recently Viewed</div><ul class="search-list-section margin-bottom10" data-bind="foreach: historyModels"><li data-bind="attr: { class: isSponsored ? 'ad-search-list text-bold text-black' : '' }"><span data-bind="attr: { class: isSponsored ? 'ad-text-icon text-white padding-right10' : 'recent-clock cwmsprite padding-right10' }, text: isSponsored ? 'Ad' : ''"></span><a data-bind="attr: { href: '/' + Common.utils.formatSpecial(makeName) + '-cars/' + maskingName + '/' }, event: { click: function () { GetGlobalSearchCampaigns.logClicks($data, 'history', 'global-search-popup-cars', $index(), false); return true; } }"><span class="model-search-name" data-bind="text: makeName + ' ' + modelName"></span></a></li></ul></div><!-- /ko --><!-- ko if:trendingModels().length > 0 --><div class="trending-search"><div class="search-title font12 text-light-grey">Trending Searches</div><ul class="search-list-section"><li><span class="trending-icon cwmsprite padding-right10"></span><a href="/featured/trackday2018/" data-role="click-tracking" data-event="CWInteractive" data-action="trending_click" data-cat="Search_Global_Desktop" data-label="Trackday 2018"><span class="model-search-name">Trackday 2018</span></a></li><!-- ko foreach: trendingModels --><li data-bind="attr: { class: $data.hasOwnProperty('adPosition') ? 'ad-search-list text-bold text-black' : '' }"><span data-bind="attr: { class: $data.hasOwnProperty('adPosition') ? 'ad-text-icon text-white padding-right10' : 'trending-icon cwmsprite padding-right10' }, text: $data.hasOwnProperty('adPosition') ? 'Ad' : ''"></span><a data-bind="attr: { href: '/' + Common.utils.formatSpecial(makeName) + '-cars/' + maskingName + '/' }, event: { click: function () { GetGlobalSearchCampaigns.logClicks($data, 'trending', 'global-search-popup-cars', $index() + 1, false); return true; } }"><span class="model-search-name" data-bind="text: makeName + ' ' + modelName"></span></a></li><!-- /ko --></ul></div><!-- /ko --></div><!-- /ko-->
			</div>
			<div class="clear"></div>
		</nav>
...
<script   type="text/javascript"  src="https://stc.aeplcdn.com/staticminv1/js/v2/app/clientcache-dedf89e722.js" ></script>
...
<script  type="text/javascript"  src="https://stc.aeplcdn.com/staticminv1/js/error-logger-6d7b43f4fa.js" ></script>
<script   type="text/javascript"  src="https://stc.aeplcdn.com/staticminv1/js/common-1a8a385355.js" ></script>
...
<script   type="text/javascript"  src="https://stc.aeplcdn.com/staticminv1/js/newcar-common-58ae2626ea.js" ></script>
<script   type="text/javascript"  src="https://stc.aeplcdn.com/staticminv1/js/v2/app/cwtracking-4b6900d56e.js" ></script>
<script   type="text/javascript"  src="https://stc.aeplcdn.com/staticminv1/js/location-plugin-9f8bf189dd.js" ></script>
<script   type="text/javascript"  src="https://stc.aeplcdn.com/staticminv1/js/pricebreakup-41d19976ee.js" ></script>
<script type="text/javascript">
