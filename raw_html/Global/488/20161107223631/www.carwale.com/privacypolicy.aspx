...
<link href="/css/cw-common-style.css?201610201409098402" rel="stylesheet" type="text/css">
...
<nav id="nav">
    ...
    <ul class="navUL">
        ...
        <li>
            <a href="/the-great-indian-hatchback-of-2016/">
                <span class="cwsprite forum-icon"></span>
                <span class="navbarTitle">Hatchback Survey</span>
                <span class="ae-sprite ae-new-label-icon"></span>
            </a>
        </li>
        <li>
     ...
     <nav id="cw-top-navigation-wrapper">
            <div id="top-navbar-list-content" class="leftfloat">
                <ul id="cw-top-navbar">
                                    ...
                                    <div class="nested-lt-column3 leftfloat">
                                        <ul class="nested-panel-list">
                                           ...
                                           <li><a href="/new-car-launches/">New Launches</a>
                                            ...
                                            <li onload="dataLayer.push({event:'CWInteractive',cat:'HDFC_navigation_desktop',act:'Link_clicked'})"><a href="/finance/hdfc/?utm=dnavigation" target="_blank" class="text-black block">Loans<span></span></a></li>                                      
                                        </ul>
                                    </div>
                                    <div class="clear"></div>
                                </div>
                                <div class="grid-4 omega padding-left50 border-light-left">
                                    ...
                                    <div class="nc-nested-right-panel single-card">
                                        ...
                                        <div class="nested-rt-column">
                                            <a class="nested-panel-image-preview margin-bottom10" href="/the-great-indian-hatchback-of-2016/" data-role="click-tracking" data-event="CWInteractive" data-action="Quick-research-model-click" data-cat="TopMenuabtest" data-label="kwidsurveyclick">
                                                <img src="http://imgd1.aeplcdn.com/0x0/cw/es/renault-kwid/kwid-survey-image-nav.jpg" />
                                            </a>
                                            <div class="nested-panel-image-details">
                                                <p class="text-bold margin-bottom5">The Great Indian Hatchback 2016</p>
                                                <p class="text-black margin-bottom5 font10">Have your voice heard</p>
                                                <a class="nested-rt-target-link margin-top5 font10" data-role="click-tracking" data-event="CWInteractive" data-action="Quick-research-model-click" data-cat="TopMenuabtest" data-label="kwidsurveyclick" href="/the-great-indian-hatchback-of-2016/">Take Survey</a>
                                            </div>
                                        </div>
                                        <div class="clear"></div>
                                    </div>
                                ...
                                <div class="grid-4 omega font15 text-black">
                                    ...
                                    <div class="nested-lt-column4 leftfloat">
                                        <ul class="nested-panel-list">
                                            <li><a href="/used/carvaluation/">Check Car Valuation</a></li>
                                            <li><a href="/dealer/dealershowroom.aspx">Locate Dealer</a></li>
                                            <li><a href="/insurance/?utm=dnavigation">Insurance</a></li>
                                        </ul>
                                    </div>
                                    <div class="clear"></div>
                                </div>
                    ...
                    <li class="navbar-primary-link">
                         <div class="top-nav-label">
                             <span class="margin-right5" onclick="window.location='/electriccars/'">All about Electric</span>
...
<script type="text/javascript" src="http://st2.aeplcdn.com/v2/js/common.js?201610271651015604"></script>
<script type="text/javascript" src="http://st2.aeplcdn.com/v2/js/newcar-common.js?201609221810304581"></script>
<script type="text/javascript" src="http://st2.aeplcdn.com/v2/js/cwTracking.js?201606091733560250"></script>
<script type="text/javascript">
