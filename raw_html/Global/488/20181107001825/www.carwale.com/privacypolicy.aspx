...
<link rel="stylesheet" href="https://stc.aeplcdn.com/staticminv2/css/cw-common-style-739dd4624d.css" type="text/css" >
...
<script type="text/javascript">
	landingPage = false
	testDriveCampaignIds = [6185,6268,6873,3842,5212,6929,8250,3831,7548]
</script>
...
<div id="header" class="header-fixed main-nav-header">
	...
	<!-- CW Doodle start-->
	<a href="/advantage/" title="Happy Diwali - Festive Offers" class="doodle__container" data-cwtccat="ESProperties" data-cwtcact="Click" data-cwtclbl="adtype=Doodle_d|doodletype=Diwali" data-role="click-tracking" data-event="CWInteractive" data-cat="Doodle_d" data-action="Doodle_d_Click" data-label="Diwali">
...
<style>
#header {	background-color: rgba(14, 64, 91,.9); background-color: #0e405b\9; } .header-fixed-white { position: relative !important; }
.doodle__container {
    position: absolute;
    bottom: 0;
    left: 185px;
...
.doodle__animation-block {
 ...
 .doodle__hexagaon {
  ...
  left: 10px;
  display: inline-block;
  background: url('https://imgd.aeplcdn.com/0x0/cw/static/icons/doodle/diwali/hexagon-bg.svg') no-repeat center/contain;
  width: 54px;
  height: 50px;
...
.doodle__right-cloud {
 ...
 .doodle__right-cloud {
  ...
  right: 0;
  top: 16px;
  background: url('https://imgd.aeplcdn.com/0x0/cw/static/icons/doodle/diwali/right-cloud.svg') no-repeat center/contain;
}
 .doodle__left-cloud {
  width: 17px;
  top: 16px;
  left: -7px;
  background: url('https://imgd.aeplcdn.com/0x0/cw/static/icons/doodle/diwali/left-cloud.svg') no-repeat center/contain;
}
 .doodle__flag {
  position: absolute;
  top: -1px;
  ...
  width: 20px;
  height: 10px;
  background: url('https://imgd.aeplcdn.com/0x0/cw/static/icons/doodle/diwali/flag.svg') no-repeat center/contain;
}
 .doodle__star {
  display: inline-block;
  position: absolute;
  width: 2px;
  height: 2px;
  background: url('https://imgd.aeplcdn.com/0x0/cw/static/icons/doodle/diwali/star-one.svg') no-repeat center/cover;
}
 .doodle__star-one {
  top: 13px;
  left: 13px;
  -webkit-animation: staranimation 3s linear infinite;
  -moz-animation: staranimation 3s linear infinite;
  -ms-animation: staranimation 3s linear infinite;
  -o-animation: staranimation 3s linear infinite;
 ...
 .doodle__star-two {
	top: 30px;
	left: 10px;
	-webkit-animation: staranimation 3s linear 1s infinite;
	-moz-animation: staranimation 3s linear 1s infinite;
 ...
 .doodle__star-three {
	top: 40px;
	left: 22px;
	-webkit-animation: staranimation 3s linear 2s infinite;
	-moz-animation: staranimation 3s linear 2s infinite;
	-ms-animation: staranimation 3s linear 2s infinite;
	-o-animation: staranimation 3s linear 2s infinite;
	animation: staranimation 3s linear 2s infinite;
	will-change: transform , opacity;
}
 .doodle__star-four {
	top: 18px;
	right: 17px;
	-webkit-animation: staranimation 3s linear 3s infinite;
	-moz-animation: staranimation 3s linear 3s infinite;
	-ms-animation: staranimation 3s linear 3s infinite;
	-o-animation: staranimation 3s linear 3s infinite;
	animation: staranimation 3s linear 3s infinite;
	will-change: transform , opacity;
}
 .doodle__star-five {
	top: 6px;
 ...
 .firework-one {
	top: 12px;
	left: 7px;
	background: url('https://imgd.aeplcdn.com/0x0/cw/static/icons/doodle/diwali/cracker-one.svg') no-repeat center/contain;
	-webkit-animation: crackeranimation 3s linear 1s infinite;
	-moz-animation: crackeranimation 3s linear 1s infinite;
 ...
 .firework-two {
	top: 18px;
	left: 23px;
	background: url('https://imgd.aeplcdn.com/0x0/cw/static/icons/doodle/diwali/cracker-three.svg') no-repeat center/contain;
	-webkit-animation: crackeranimation 3s linear 2s forwards;
	-moz-animation: crackeranimation 3s linear 2s forwards;
	-ms-animation: crackeranimation 3s linear 2s forwards;
	-o-animation: crackeranimation 3s linear 2s forwards;
	animation: crackeranimation 3s linear 2s forwards;
	will-change: transform , opacity;
}
 .firework-three {
	top: 28px;
	left: 14px;
	background: url('https://imgd.aeplcdn.com/0x0/cw/static/icons/doodle/diwali/cracker-two.svg') no-repeat center/contain;
	-webkit-animation: crackeranimation 3s linear 3s infinite;
	-moz-animation: crackeranimation 3s linear 3s infinite;
	-ms-animation: crackeranimation 3s linear 3s infinite;
	-o-animation: crackeranimation 3s linear 3s infinite;
	animation: crackeranimation 3s linear 3s infinite;
	will-change: transform , opacity;
}
 .doodle__lantern {
	display: inline-block;
 ...
 .lantern-one {
	...
	top: -9px;
	left: 13px;
	background: url('https://imgd.aeplcdn.com/0x0/cw/static/icons/doodle/diwali/lantern-one.svg') no-repeat center bottom/contain;
	-webkit-transition: all linear 1s;
	-moz-transition: all linear 1s;
	-ms-transition: all linear 1s;
	-o-transition: all linear 1s;
	transition: all linear 1s;
	-webkit-animation: lanternscaleanimation 3s linear 3s forwards, lanternswinganimation 3s linear 6s infinite;
	-moz-animation: lanternscaleanimation 3s linear 3s forwards, lanternswinganimation 3s linear 6s infinite;
	-ms-animation: lanternscaleanimation 3s linear 3s forwards, lanternswinganimation 3s linear 6s infinite;
	-o-animation: lanternscaleanimation 3s linear 3s forwards, lanternswinganimation 3s linear 6s infinite;
	animation: lanternscaleanimation 3s linear 3s forwards, lanternswinganimation 3s linear 6s infinite;
	will-change: transform , opacity;
}
 .lantern-two {
	width: 16px;
	...
	top: -28px;
	right: 11px;
	background: url('https://imgd.aeplcdn.com/0x0/cw/static/icons/doodle/diwali/lantern-two.svg') no-repeat center bottom/contain;
	-webkit-animation: lanternscaleanimation 3s linear 3s forwards, lanternswinganimation 3s linear 6s infinite;
	-moz-animation: lanternscaleanimation 3s linear 3s forwards, lanternswinganimation 3s linear 6s infinite;
	-ms-animation: lanternscaleanimation 3s linear 3s forwards, lanternswinganimation 3s linear 6s infinite;
	-o-animation: lanternscaleanimation 3s linear 3s forwards, lanternswinganimation 3s linear 6s infinite;
 ...
 @-webkit-keyframes crackeranimation {
    0% {
        -webkit-transform: scale(0);
        -moz-transform: scale(0);
        -ms-transform: scale(0);
 ...
 @-webkit-keyframes lanternscaleanimation {
    0% {
 ...
 @keyframes lanternscaleanimation {
    0% {
        -webkit-transform: translateY(-100%);
        -moz-transform: translateY(-100%);
        -ms-transform: translateY(-100%);
 ...
 @-webkit-keyframes lanternswinganimation {
    0%,
    100% {
        -webkit-transform: rotate(10deg);
        -moz-transform: rotate(10deg);
 ...
 @keyframes lanternswinganimation {
    0%,
    100% {
        -webkit-transform: rotate(10deg);
        -moz-transform: rotate(10deg);
...
@media screen and (min-width:768px) and (max-width: 1024px){ .doodle__container {display: none; }#cw-top-navbar {margin-left: 0;}} @media screen and (min-width: 1025px) {#cw-top-navbar {margin-left: 70px;}}
</style>
	<!-- CW Doodle end-->  
...
<script   type="text/javascript"  src="https://stc.aeplcdn.com/staticminv2/js/globalsearch-5648dea525.js" ></script>
...
<script   type="text/javascript"  src="https://stc.aeplcdn.com/staticminv2/js/common-1f74bf93e2.js" ></script>
...
<script   type="text/javascript"  src="https://stc.aeplcdn.com/staticminv2/js/v2/app/cwtracking-4cd35c2fd8.js" ></script>
<script   type="text/javascript"  src="https://stc.aeplcdn.com/staticminv2/js/location-plugin-abed4ca456.js" ></script>
<script   type="text/javascript"  src="https://stc.aeplcdn.com/staticminv2/js/pricebreakup-af4facb1eb.js" ></script>
<script type="text/javascript">
