...
<link rel="SHORTCUT ICON" href="http://imgd1.aeplcdn.com/0x0/cw/design15/carwale.png?staticimgsfix" />
...
<link href="/css/cw-common-style.css?201610051702317900" rel="stylesheet" type="text/css">
<script type="text/javascript" src="http://st2.aeplcdn.com/v2/js/frameworks.js?20160419032055"></script>
<!-- for IE to understand the new elements of HTML5 like header, footer, section and so on -->
<!--[if lt IE 9]>
    <script src="http://st2.aeplcdn.com/v2/js/html5.js"></script>
<![endif]-->
<!--[if IE]><script language="javascript" src="http://st2.aeplcdn.com/v2/src/excanvas.js"></script><![endif]-->
...
<script type="text/javascript">
    ...
    var REDIRECT = 'http://www.carwale.com/loading/googleredirect.html'; 
</script>
...
<nav id="nav">
    ...
    <ul class="navUL">
        ...
        <li>
            <a href="/electriccars/">
                <span class="cwsprite electriccar-icon"></span>
                <span class="navbarTitle">All about Electric</span>
                <span class="ae-sprite ae-new-label-icon"></span>
            </a>
        </li>
        
        <li>
            <a href="/finance/hdfc/?utm=dnavigation" data-role="click-tracking" data-event="CWInteractive" data-action="Link_clicked" data-cat="HDFC_navigation_desktop">
     ...
     <nav id="cw-top-navigation-wrapper">
            <div id="top-navbar-list-content" class="leftfloat">
                <ul id="cw-top-navbar">
                                ...
                                <div class="grid-8 font15 text-black">
                                    ...
                                    <div class="nested-lt-column3 leftfloat">
                                        <ul class="nested-panel-list">
                                           ...
                                           <li><a href="/electriccars/">All about Electric<span class="margin-left5 cwsprite new-red-tag-icon"></span></a></li>
                                    ...
                                    <div class="nc-nested-right-panel single-card"> <!-- conditional single-card class -->
                                       <div class="nested-rt-column">
                                            <a class="nested-panel-image-preview margin-bottom10" href="/nissan-cars/micra/">
                                                <img src="http://imgd4.aeplcdn.com/174x98/cw/cars/nissan/micra.jpg" />
                                            </a>
                                        ...
                                        <div class="uc-rv-nested-right-panel text-center">
                                            <div class="nested-rt-column bg-white">
                                                <a class="nested-panel-image-preview margin-bottom10" href="/used/cars-for-sale/#kms=0-&year=0-&budget=0-4">
                                                    <img src="http://img.aeplcdn.com/design15/d/swift.jpg?v=2" />
                                                </a>
                                                <div class="nested-panel-image-details">
                                                    <div class="font13 ">
                                                        Upto
                                            ...
                                            <div class="nested-rt-column bg-white">
                                                <a class="nested-panel-image-preview margin-bottom10" href="/used/cars-for-sale/#kms=0-&year=0-&budget=4-8" >
                                                    <img src="http://img.aeplcdn.com/design15/d/verna.jpg" />
                                                </a>
                                                <div class="nested-panel-image-details">
                                                    <div class="font13 ">
                                                        Between
                    ...
                    <li class="navbar-primary-link">
                         <div class="top-nav-label">
                             <span class="margin-right5">Loans &amp; Insurance</span>
                            <span class="fa fa-caret-down"></span>
                        </div>
                        <div class="top-nav-nested-panel">
                            <div class="container padding-top50 padding-bottom50 loans-insur-nested-panel">
                               <div class="grid-6 padding-right100">
                                    <h3 class="font24 margin-bottom5"><a href="/insurance/?utm=dnavigation" class="text-black block"><span class="cwsprite nested-insurance-icon inline-block margin-right10"></span><span class="inline-block loans-insur-nested-label">Insurance</span></a></h3>
                                    <p class="font14 line-height">Car insurance provides protection to the car's owner against third-party liabilities, theft or damage to the car.</p>
                               </div>
                               <div class="grid-6 padding-left55 padding-right55"> 
                                    <h3 class="font24 margin-bottom5"><a href="/finance/hdfc/?utm=dnavigation" class="text-black block" data-role="click-tracking" data-event="CWInteractive" data-action="Link_clicked" data-cat="HDFC_navigation_desktop"><span class="cwsprite nested-loan-icon inline-block margin-right10"></span><span class="inline-block loans-insur-nested-label">Loans</span></a></h3>
                                    <p class="font14 line-height">Get instant EMI quotes for your dream car, customised to your needs.</p>
                               </div>
                               <div class="clear"></div>
                             </div>
                        </div>
        ...
        <div id="cw-topnav-right-section" class="rightfloat">
            ...
            <div id="userLoggedin" class="loggedin-box rounded-corner50 hide">
                ...
                <span class="login-with-photo hide" id="profilepic2">
                    <img src="http://img.carwale.com/grey.gif">
                </span>
            </div>
            <div class="clear"></div>
        </div>
...
<script type='text/javascript'>
	            ...
	            <div class="grid-12">
                    <div class="content-box-shadow content-inner-block-10 margin-bottom20">
		                ...
		                <p>
			                ...
			                to our services available under the domain and sub-domains of <a href="http://www.Carwale.com" target="_blank" onclick="return top.js.OpenExtLink(window,event,this)"> www.CarWale.com </a> ( <a href="http://Carwale.com" target="_blank" onclick="return top.js.OpenExtLink(window,event,this)"> <q>CarWale.com</q></a> or "Site") and apply generally 
    ...
    <div class="container">
        <div class="grid-12 text-center border-solid-bottom margin-bottom20 padding-bottom25">
                    ...
                    <div class="grid-4">
                        <a href="http://www.cartrade.com" target="_blank" class="cwsprite ct-logo"></a>
                    </div>
                    <div class="grid-4">
                        <a href="http://www.bikewale.com/" target="_blank" class="cwsprite bw-logo"></a>
                    </div>
                 </div>
                ...
                <div class="grid-12">
                    ...
                    <div class="grid-3">
                        ...
                        <ul class="margin-top15">
                            <li>
                                <a href="http://www.carwale.com/m/">View CarWale on Mobile</a>
                            </li>
                        </ul>
                    </div>
                </div>
...
<div id="askexpertsidebanner" class="ask-expert text-white text-center padding-bottom5 padding-top5 padding-left10 padding-right15 rounded-corner-no-right box-shadow cur-pointer">
    ...
    <div class="ask-expert-content inline-block">
        ...
        <span id="ATEConditional" class="toll-free-text font10 block">(8 AM - 10 PM)</span>
...
<script type="text/javascript" src="http://st2.aeplcdn.com/v2/js/plugins.js?201608110333423122"></script>
<script type="text/javascript" src="http://st2.aeplcdn.com/v2/src/graybox.js?201608081857173735"></script>
<script type="text/javascript" src="http://st2.aeplcdn.com/v2/js/adsense.js?201609061235368363"></script>
<script type="text/javascript" src="http://st2.aeplcdn.com/v2/js/common.js?201610051338292951"></script>
<script type="text/javascript" src="http://st2.aeplcdn.com/v2/js/newcar-common.js?201609221810304581"></script>
<script type="text/javascript" src="http://st2.aeplcdn.com/v2/js/cwTracking.js?201609281034470766"></script>
