...
<link href="/css/cw-common-style.css?201609011903067923" rel="stylesheet" type="text/css">
     ...
     <nav id="cw-top-navigation-wrapper">
            <div id="top-navbar-list-content" class="leftfloat">
                <ul id="cw-top-navbar">
                                ...
                                <div class="grid-8 font15 text-black">
                                    <div class="nested-lt-column1 leftfloat">
                                        <ul class="nested-panel-list">
                                            ...
                                            <li><a href="/advantage">New Car Discounts<span class="margin-left5 cwsprite new-red-tag-icon"></span></a></li>
                                ...
                                <div class="grid-4 omega padding-left50 border-light-left">
                                    ...
                                    <div class="nc-nested-right-panel single-card"> <!-- conditional single-card class -->
                                       <div class="nested-rt-column">
                                            <a class="nested-panel-image-preview margin-bottom10" href="/tata-cars/zest/">
                                                <img src="http://imgd4.aeplcdn.com/174x98/cw/cars/tata/zest.jpg" />
                                            </a>
                                            <div class="nested-panel-image-details">
                                                <a href="/tata-cars/zest/" class="font15 text-black text-bold margin-bottom5" title="Tata Zest">Tata Zest</a>
                                                <span class="font14">
                                                    <span class="fa fa-rupee"></span>
                                                    <span>5.18L Onwards</span>
                                                </span>
                                                <div class="font13 ">
                                                    Avg. Ex-Showroom
                                                    <span></span>
                                                </div>
                                                <a id="headerOnRoadLink" class="nested-rt-target-link margin-top5" onclick="initQuickPQ('', '585', '9');" href="javascript:void(0);">Check On-Road Price</a>
                                            </div>
                                        </div>
                                        <div class="clear"></div>
                                    </div>
                    ...
                    <li class="navbar-primary-link">
                        <div class="top-nav-label">
                            <span class="margin-right5">Loans</span>
                            <span class="fa fa-caret-down"></span>
                        </div>
                        <div class="top-nav-nested-panel">
                            <div class="container padding-top50 padding-bottom50 loans-insur-nested-panel">
                                
                                <div class="padding-left55 padding-right55" style="margin:0 auto; width:700px">
                                    <h3 class="font24 margin-bottom5" onload="dataLayer.push({event:'CWNonInteractive',cat:'BBLinkImpressions_desktop',act:'finance_Navigation_Menu'})"><a href="https://www.google.com/url?q=https%3A%2F%2Fwww.bankbazaar.com%2Fcar-loan.html%3FWT.mc_id%3Dbb01%7CCL%7CNavigationMenu_desktop%26utm_source%3Dbb01%26utm_medium%3Ddisplay%26utm_campaign%3Dbb01%26variant%3Dslide%26variantOptions%3DmobileRequired&sa=D&sntz=1&usg=AFQjCNFfW4dOpgEJ9WThOAp2c7LI-Yi-0Q" target="_blank" class="text-black block"><span class="cwsprite nested-loan-icon inline-block margin-right10"></span><span class="inline-block loans-insur-nested-label">Loans<sup class="font10 text-unbold">Ad</sup></span></a></h3>
                                    <p class="font14 line-height">Get the best Car Loan offers with lowest EMI quotes from our finance partner Bankbazaar.</p>
                                </div>
                                <div class="clear"></div>
                            </div>
                        </div>
    ...
    <div class="container">
        ...
        <div class="grid-3">
            ...
            <ul class="margin-top15">
                ...
                <li>
                    <a target="_blank" href="http://www.bikewale.com/">BikeWale</a>
                </li>
            </ul>
        </div>
        <div class="clear"></div>
...
<script type="text/javascript" src="http://st2.aeplcdn.com/v2/js/common.js?20160901134906"></script>
<script type="text/javascript" src="http://st2.aeplcdn.com/v2/js/newcar-common.js?201608041948318025"></script>
<script type="text/javascript" src="http://st2.aeplcdn.com/v2/js/cwTracking.js?201606091733560249"></script>
<script type="text/javascript">
