...
<link href="/css/cw-common-style.css?201604291539561804" rel="stylesheet" type="text/css">
...
<div id="loc-widget" class="loc-widget position-rel">
        <span id="closeLocIcon" class="cwsprite cross-md-dark-grey position-abt pos-top20 pos-right20 font20 cur-pointer"></span>
        <figure class="loc-figure text-center padding-top5">
            <img src="http://imgd2.aeplcdn.com/0x0/cw/design15/city-location.jpg" height="110">
            <figcaption id="loc-title" class="font18 text-black text-bold padding-top10">Please enter your City</figcaption>
        </figure>
        <div class="cityNameWrap table margin-auto position-rel padding-bottom30">
            <input type="text" placeholder="Type your city, e.g. Mumbai" class="cityName" searchtype="citySearch"id="placesQuery" autocomplete="off" />
            <span class="fa fa-spinner fa-spin position-abt pos-right10 pos-top10 text-black" style="display:none;right:35px;"></span>
            <!--<div class="error-msg text-red hide">Please enter city</div>-->
        </div>
    </div>
    <div class="clear"></div>
...
<script type="text/javascript" src="http://st2.aeplcdn.com/v2/js/common.js?201605021623360516"></script>
<script type="text/javascript" src="http://st2.aeplcdn.com/v2/js/newcar-common.js?201605021554513297"></script>
<script type="text/javascript" src="http://st2.aeplcdn.com/v2/js/jquery.autocomplete.multiselect.js?20160419032055"></script>
