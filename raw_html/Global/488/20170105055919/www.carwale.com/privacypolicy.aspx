...
<link rel="SHORTCUT ICON" href="https://imgd1.aeplcdn.com/0x0/cw/design15/carwale.png?staticimgsfix" />

<link rel="stylesheet" type="text/css" href="https://fonts.googleapis.com/css?family=Open+Sans:300,400,400i,600,700">
<link href="/css/cw-common-style.css?201612281746262190" rel="stylesheet" type="text/css">

<script type="text/javascript" src="https://st.aeplcdn.com/v7/js/frameworks.js?20160419032055"></script>
<!-- for IE to understand the new elements of HTML5 like header, footer, section and so on -->
<!--[if lt IE 9]>
    <script src="https://st.aeplcdn.com/v7/js/html5.js"></script>
<![endif]-->
<!--[if IE]><script language="javascript" src="https://st.aeplcdn.com/v7/src/excanvas.js"></script><![endif]-->
...
<nav id="nav">
    ...
    <ul class="navUL">
        ...
        <li>
            <a href="/the-great-indian-hatchback-of-2016/" data-role="click-tracking" data-event="CWInteractive" data-action="Main-Menu-item-Hover" data-cat="TopMenuabtest" data-label="KwidResultLinkClick">
                <span class="cwsprite forum-icon"></span>
                <span class="navbarTitle">Great Indian HatchBack</span>
            </a>
        </li>
        <li>
            <a href="/trackday2016/" data-role="click-tracking" data-event="CWInteractive" data-action="Main-Menu-item-Click" data-cat="TopMenuabtest" data-label="Trackday_click">
                <span class="cwsprite trackday-icon"></span>
     ...
     <nav id="cw-top-navigation-wrapper">
            <div id="top-navbar-list-content" class="leftfloat">
                <ul id="cw-top-navbar">
                                ...
                                <div class="grid-4 omega padding-left50 border-light-left">
                                    ...
                                    <div class="nc-nested-right-panel single-card">
                                        <!-- conditional single-card class -->                                        
                                            ...
                                            <!-- conditional single-card class -->
                                            <div class="grid-6">
                                                <p class="text-bold " style="margin-bottom:24px;">All About Electric</p>
                                                <a class="nested-panel-image-preview margin-bottom10" href="/electriccars/" data-role="click-tracking" data-event="CWInteractive" data-action="Quick-research-model-click" data-cat="TopMenuabtest" data-label="e2oplusclick">
                                                ...
                                                <div class="nested-panel-image-details margin-top20">
                                                    <p class="text-black margin-bottom5 font12">The New e2oPlus</p>
                                                    <a class="nested-rt-target-link margin-top5 font13" data-role="click-tracking" data-event="CWInteractive" data-action="Quick-research-model-click" data-cat="TopMenuabtest" data-label="e2oplusclick" href="/electriccars/">Explore More</a>
                                                </div>
                                            </div>
                                            <div class="grid-6">
                                                <p class="text-bold margin-bottom5">Great Indian Hatchback</p>
                                                <a class="nested-panel-image-preview margin-bottom10" href="/the-great-indian-hatchback-of-2016/" data-role="click-tracking" data-event="CWInteractive" data-action="Main-Menu-item-Hover" data-cat="TopMenuabtest" data-label="KwidResultLinkClick">
                                                ...
                                                <div class="nested-panel-image-details margin-top20">
                                                    <p class="text-black margin-bottom5 font12">The Renault Kwid</p>
                                                    <a class="nested-rt-target-link margin-top5 font13" data-role="click-tracking" data-event="CWInteractive" data-action="Main-Menu-item-Hover" data-cat="TopMenuabtest" data-label="KwidResultLinkClick" href="/the-great-indian-hatchback-of-2016/">Explore More</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="uc-rv-nested-right-panel text-center">
                                            <div class="nested-rt-column bg-white">
                                                <a class="nested-panel-image-preview margin-bottom10" href="/used/cars-for-sale/#kms=0-&year=0-&budget=0-4">
                                                    <img src="https://img.aeplcdn.com/design15/d/swift.jpg?v=2" />
                                                </a>
                                            ...
                                            <div class="nested-rt-column bg-white">
                                                <a class="nested-panel-image-preview margin-bottom10" href="/used/cars-for-sale/#kms=0-&year=0-&budget=4-8" >
                                                    <img src="https://img.aeplcdn.com/design15/d/verna.jpg" />
                                                </a>
                                                <div class="nested-panel-image-details">
                                                    <div class="font13 ">
                                                        Between
                    ...
                    <li class="navbar-primary-link">
                         <div class="top-nav-label">
                             <span class="margin-right5" onclick="window.location = '/trackday2016/'" data-role="click-tracking" data-event="CWInteractive" data-action="Main-Menu-item-Click" data-cat="TopMenuabtest" data-label="Trackday_click">Track Day 2016</span>
        ...
        <div id="cw-topnav-right-section" class="rightfloat">
            ...
            <div id="userLoggedin" class="loggedin-box rounded-corner50 hide">
                ...
                <span class="login-with-photo hide" id="profilepic2">
                    <img src="https://img.carwale.com/grey.gif">
                </span>
            </div>
            <div class="clear"></div>
        </div>
...
<script type="text/javascript" src="https://st.aeplcdn.com/v7/js/plugins.js?201612151139104857"></script>
<script type="text/javascript" src="https://st.aeplcdn.com/v7/src/graybox.js?201608110333823122"></script>
<script type="text/javascript" src="https://st.aeplcdn.com/v7/js/adsense.js?201608110333823122"></script>
<script type="text/javascript" src="https://st.aeplcdn.com/v7/js/common.js?201701031856394355"></script>
<script type="text/javascript" src="https://st.aeplcdn.com/v7/js/cookie-migration.js?201701041606423948"></script>
<script type="text/javascript" src="https://st.aeplcdn.com/v7/js/newcar-common.js?201612151139104857"></script>
<script type="text/javascript" src="https://st.aeplcdn.com/v7/js/v2/app/cwTracking.js?201611151710189896"></script>
<script type="text/javascript">
