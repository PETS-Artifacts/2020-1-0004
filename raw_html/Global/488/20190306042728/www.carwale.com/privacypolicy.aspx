...
<script type="text/javascript">
	...
	<style type="text/css">
		/* Desktop Background skin change style */
		body.special-skin-body .ask-expert.expert-visible {right: -100%;}
		body.special-skin-body {
			background: #000 url("https://imgd.aeplcdn.com/0x0/cw/es/skinning/xuv300/d/xuv300-model-page-skinning.jpg?v=12") center top repeat-y;
		}
		body.home-special-page { background-color: #000; background-image: url("https://imgd.aeplcdn.com/0x0/cw/es/skinning/xuv300/d/xuv300-wp-to-pq.jpg"), url("https://imgd.aeplcdn.com/0x0/cw/es/skinning/xuv300/d/xuv300-pq-to-ft.jpg"); background-repeat: no-repeat,no-repeat; background-position: center 564px, center 2560px;}
		body.special-skin-body .cw-tabs .bg-white{background-color: transparent;}
		.update-skin-change-bg .cw-tabs-data{background-color: white;}
		 body.special-landing-page.special-skin-body { background-position: center 130px; }
		body.special-skin-body .cw-tabs-data, body.special-skin-body .special-padding { padding: 10px; }
		#divFullDesc p { color: #fff;}
		body.special-skin-body .header-fixed-with-bg {background-color: rgba(0, 0, 0,.9);}
		body.special-skin-body #header.main-nav-header.header-landing:hover {background-color: rgba(0, 0, 0,.9);}
		 body.special-skin-body .welcome-box-hp {margin-top: 85px;}
		body.special-skin-body:not(.no-skinning) .header-fixed {background-color: rgba(0, 0, 0,.9);}
		body.special-skin-body .mileage-section {margin-top: 15px;}
		body.special-skin-body:not(.no-skinning) .breadcrumb__item {color: #fff;}
		body.special-skin-body:not(.no-skinning) .breadcrumb__item + .breadcrumb__item:before {border-color: #fff;}
		.update-skin-change-bg.fixed-tabs-desktop {background-color: #000;}
		.update-skin-change-bg .filter-tab .cw-tabs-flex ul {border: none;}
		.update-skin-change-bg.fixed-tabs-desktop .cw-tabs-flex li.active {color: #fff;}
		.update-skin-change-bg.fixed-tabs-desktop .cw-tabs-flex li {color: #fff;}
		.update-skin-change-bg.fixed-tabs-desktop .cw-tabs-flex li:hover:not(.disabled) {color: #fff;}
		body .no-padding {
			padding: 0;
		}
		.section-primary-title.special-skin-text {font-size: 25px; font-weight: 500;}
		body.special-skin-body .section {background-color: transparent;}
		body.special-skin-body .section-head {
			padding: 0;
		}
		.no-skinning.hatchback-outer-container .breadcrumb__item {
			color: #6f6f6f !important;
		}
		.no-skinning.hatchback-outer-container .breadcrumb__item + .breadcrumb__item:before {
			border-color: #6f6f6f !important;
		}
		body.no-skinning {
			background: none;
		}
		body.special-skin-body .forum-skin .startBy { color: #fff; }
	</style>    
	<style>
		/* Mobile & Desktop Common Style */
		body .m-no-bg-color, body .no-bg-color, .m-no-bg-color, .no-bg-color { background: none; border: none; box-shadow: none; }
		body.m-special-skin-body .m-special-skin-text, body.special-skin-body .special-skin-text, body.special-skin-body .m-special-skin-text {color: #ffffff !important;}
		.m-update-skin-change-bg .cw-tabs-panel, .update-skin-change-bg .cw-tabs-panel {background: transparent;}
		body.m-special-skin-body .offer-footer {margin-left: -10px; margin-right: -10px; padding: 10px;}
	</style>
...
<script   type="text/javascript"  src="https://stc.aeplcdn.com/staticminv2/js/v2/app/cwtracking-df37795ca4.js" ></script>
