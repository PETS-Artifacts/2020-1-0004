...
<title itemprop="name">Privacy Policy - CarWale</title>
<meta name="keywords" content="" />
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<meta itemprop="description" name="description" content="CarWale Privacy Policy" />
...
<link rel="stylesheet" href="https://stc.aeplcdn.com/staticminv1/css/cw-common-style-a0dba47fa5.css" type="text/css" >
<link rel="stylesheet" href="https://stc.aeplcdn.com/staticminv1/cwfontawesome/cw-font-awesome-d4282e61f2.css" type="text/css" >
<link rel="stylesheet" href="https://stc.aeplcdn.com/staticminv1/css/location-plugin-6253d34341.css" type="text/css" >
<script   type="text/javascript"   src="https://stc.aeplcdn.com/staticminv1/js/frameworks-2913c6000a.js"  ></script>
<!-- for IE to understand the new elements of HTML5 like header, footer, section and so on -->
<!--[if lt IE 9]>
	<script     src="https://stc.aeplcdn.com/staticminv1/js/html5-ea8eacfc1b.js"  ></script>
<![endif]-->
<!--[if IE]><script   language="javascript"   src="https://stc.aeplcdn.com/staticminv1/src/excanvas-6cbed2c0ea.js"  ></script><![endif]-->
...
<script type='text/javascript'>
	googletag.cmd.push(function () {        
		googletag.pubads().setTargeting('CarType', 'NA');
		googletag.pubads().setTargeting('LeadCount', '0');
		googletag.pubads().setTargeting('ModelsList', 'NA');
		googletag.pubads().setTargeting('BodyStyleList', 'NA');
		googletag.pubads().setTargeting('BudgetSegmentList', 'NA');
		googletag.pubads().setTargeting('CarCount', '0');        
	});
</script>
<style>
	#privacy-policy p { padding-top: 10px; text-align:justify; letter-spacing:0.6px; } 
</style>
</head>
...
<div id="header" class="header-fixed main-nav-header">
	...
	<div class="leftfloat margin-top10">
	 ...
	 <nav id="cw-top-navigation-wrapper">
			...
			<!-- ko if:  historyModels().length > 0 && trendingModels().length > 0 --><div class="global-search-section bg-white padding-bottom20 trendindcars-dumy-class hide"><!-- ko if:historyModels().length > 0 --><div class="history-search"><div class="search-title font12 text-light-grey">Recently Viewed</div><ul class="search-list-section margin-bottom10" data-bind="foreach: historyModels"><li data-bind="attr: { class: isSponsored ? 'ad-search-list text-bold text-black' : '' }"><span data-bind="attr: { class: isSponsored ? 'ad-text-icon text-white padding-right10' : 'recent-clock cwmsprite padding-right10' }, text: isSponsored ? 'Ad' : ''"></span><a data-bind="attr: { href: '/' + Common.utils.formatSpecial(makeName) + '-cars/' + maskingName + '/' }, event: { click: function () { GetGlobalSearchCampaigns.logClicks($data, 'history', 'global-search-popup-cars', $index(), false); return true; } }"><span class="model-search-name" data-bind="text: makeName + ' ' + modelName"></span></a></li></ul></div><!-- /ko --><!-- ko if:trendingModels().length > 0 --><div class="trending-search"><div class="search-title font12 text-light-grey">Trending Searches</div><ul class="search-list-section" data-bind="foreach: trendingModels"><li data-bind="attr: { class: $data.hasOwnProperty('adPosition') ? 'ad-search-list text-bold text-black' : '' }"><span data-bind="attr: { class: $data.hasOwnProperty('adPosition') ? 'ad-text-icon text-white padding-right10' : 'trending-icon cwmsprite padding-right10' }, text: $data.hasOwnProperty('adPosition') ? 'Ad' : ''"></span><a data-bind="attr: { href: '/' + Common.utils.formatSpecial(makeName) + '-cars/' + maskingName + '/' }, event: { click: function () { GetGlobalSearchCampaigns.logClicks($data, 'trending', 'global-search-popup-cars', $index(), false); return true; } }"><span class="model-search-name" data-bind="text: makeName + ' ' + modelName"></span></a></li></ul></div><!-- /ko --></div><!-- /ko-->
			</div>
			<div class="clear"></div>
		</nav>
...
<script type='text/javascript'>
	googletag.cmd.push(function () { googletag.display('div-gpt-ad-1398233965520-4'); });
		...
		<section class="bg-light-grey padding-top20">
			<div class="container">
				<div class="grid-12">
					<div class="content-box-shadow content-inner-block-10 margin-bottom20" id="privacy-policy">
	   ...
	   <footer class="bg-footer padding-top50 padding-bottom30 padding-left20 padding-right20"><div class=""><div class="grid-12 text-center border-solid-bottom margin-bottom20"><div class="grid-4 padding-bottom25"><a href="/" class="cwsprite cw-logo"></a><p class="text-medium-grey font14 margin-top5 margin-left60">ask the experts</p><div class="grid-6"><p class="text-white font14 margin-top15 margin-bottom10">Popular Makes</p><ul class="popular-links"><li><a href="/marutisuzuki-cars/" title="Maruti Suzuki Cars in India - Prices (GST Rates), Reviews, Photos & More - CarWale">Maruti Suzuki</a></li><li><a href="/honda-cars/" title="Honda Cars in India - Prices (GST Rates), Reviews, Photos & More - CarWale">Honda</a></li><li><a href="/hyundai-cars/" title="Hyundai Cars in India - Prices (GST Rates), Reviews, Photos & More - CarWale">Hyundai</a></li><li><a href="/mahindra-cars/" title="Mahindar Cars in India - Prices (GST Rates), Reviews, Photos & More - CarWale">Mahindra</a></li><li><a href="/tata-cars/" title="Tata Cars in India - Prices (GST Rates), Reviews, Photos & More - CarWale">Tata</a></li></ul></div>
				<div class="grid-6"><p class="text-white font14 margin-top15 margin-bottom10">Popular Models</p><ul class="popular-links">
							<li><a href="/marutisuzuki-cars/baleno/" title="Baleno Price (GST Rates), Images, Mileage, Colours">Baleno</a></li>
							<li><a href="/marutisuzuki-cars/dzire/" title="Dzire Price (GST Rates), Images, Mileage, Colours">Dzire</a></li>
							<li><a href="/tata-cars/tiago/" title="Tiago Price (GST Rates), Images, Mileage, Colours">Tiago</a></li>
							<li><a href="/marutisuzuki-cars/vitara-brezza/" title="Vitara Brezza Price (GST Rates), Images, Mileage, Colours">Vitara Brezza</a></li>
							<li><a href="/marutisuzuki-cars/swift/" title="Swift Price (GST Rates), Images, Mileage, Colours">Swift</a></li>
					</ul></div>
			</div><div class="grid-4"><a href="https://www.cartrade.com" target="_blank" class="cwsprite ct-logo"></a></div><div class="grid-4"><a href="https://www.bikewale.com/" target="_blank" class="cwsprite bw-logo"></a><p class="text-white font14 margin-top15 margin-bottom10">Popular Bikes</p><ul><li><a href="https://www.bikewale.com/bajaj-bikes/pulsar/" title="Bajaj Pulsar 150 Price, Images, Colours, Mileage &amp; Reviews | BikeWale">Bajaj Pulsar 150</a></li><li><a href="https://www.bikewale.com/hero-bikes/pleasure/" title="Hero Pleasure Price, Images, Colours, Mileage &amp; Reviews | BikeWale">Pleasure</a></li><li><a href="https://www.bikewale.com/yamaha-bikes/fascino/" title="Yamaha Fascino Price, Images, Colours, Mileage &amp; Reviews | BikeWale">Fascino</a></li></ul></div></div><div class="clear"></div><div class="grid-12"><div class="grid-4"><p class="font18 text-white margin-top50 margin-bottom10">Join us on</p><div class="footer-social-icons"><a href="https://facebook.com/carwale" target="_blank" title="Facebook" class="margin-right15"><span class="fa fa-facebook"></span></a><a href="https://twitter.com/carwale" target="_blank" title="Twitter" class="margin-right15"><span class="fa fa-twitter"></span></a><a href="https://www.google.com/+CarWale" target="_blank" title="Google+"><span class="fa fa-google-plus"></span></a></div></div><div class="grid-2"><p class="font18 text-white margin-bottom20">Company</p><ul><li><a href="/aboutus.aspx">About Us</a></li><li><a href="/career.aspx">Careers</a></li><li><a href="/advertiseWithUs.aspx">Advertise with us</a></li><li><a href="/forums/">Forums</a></li><li><a href="/sitemap.aspx">Sitemap</a></li></ul></div><div class="grid-3"><p class="font18 text-white margin-bottom20">Support</p><ul><li><a href="mailto:contact@carwale.com">contact@carwale.com</a></li></ul></div><div class="grid-3"><p class="font18 text-white margin-bottom30">Download Mobile App</p><div class="margin-bottom15"><a href="https://play.google.com/store/apps/details?id=com.carwale&referrer=utm_source%3DCarWaleDesktopWebsite%26utm_medium%3DFooter%26utm_campaign%3DCarWale%2520Website%2520Footer" target="_blank" class="cwsprite gplay-icon"></a></div><div><a href="https://itunes.apple.com/in/app/carwale/id910137745?mt=8" target="_blank" class="cwsprite app-store-icon"></a></div></div></div><div class="clear"></div><div class="border-solid-top text-white margin-top25 padding-top25"><div class="grid-6 alpha font16">&copy; CarWale India</div><div class="grid-6 omega text-right font13"><a href="/visitoragreement.aspx" class="text-white">Visitor Agreement </a>&
				<a href="/privacypolicy.aspx" class="text-white">Privacy Policy</a></div></div><div class="clear"></div></div></footer>
...
<script type="text/javascript">
	...
	var askingAreaCityId = [1,2,10,12];
</script>
<script  type="text/javascript"  src="https://stc.aeplcdn.com/staticminv1/js/plugins-166baa000e.js" ></script>
<script   type="text/javascript"  src="https://stc.aeplcdn.com/staticminv1/src/graybox-a39cfd2589.js" ></script>
<script   type="text/javascript"  src="https://stc.aeplcdn.com/staticminv1/js/adsense-e1e8ac6247.js" ></script>
<script   type="text/javascript"  src="https://stc.aeplcdn.com/staticminv1/js/v2/app/clientcache-9494170b73.js" ></script>
<script   type="text/javascript"  src="https://stc.aeplcdn.com/staticminv1/js/globalsearch-3e8db6850f.js" ></script>
<script   type="text/javascript"  src="https://stc.aeplcdn.com/staticminv1/js/sponsorednavigation-01e2ea26e0.js" ></script>
<script   type="text/javascript"  src="https://stc.aeplcdn.com/staticminv1/js/common-ee08805061.js" ></script>
<script   type="text/javascript"  src="https://stc.aeplcdn.com/staticminv1/js/lead-conversion-tracking-a981c3accd.js" ></script>
<script   type="text/javascript"  src="https://stc.aeplcdn.com/staticminv1/js/cookie-migration-d7965c94d1.js" ></script>
<script   type="text/javascript"  src="https://stc.aeplcdn.com/staticminv1/js/newcar-common-a5cf385911.js" ></script>
<script   type="text/javascript"  src="https://stc.aeplcdn.com/staticminv1/js/v2/app/cwtracking-38b85dca68.js" ></script>
<script   type="text/javascript"  src="https://stc.aeplcdn.com/staticminv1/js/location-plugin-119fb030bb.js" ></script>
<script   type="text/javascript"  src="https://stc.aeplcdn.com/staticminv1/js/pricebreakup-d3fbbf95a8.js" ></script>
<script type="text/javascript">
	...
	<script>
		//CW Track Code
		Common.googleApiKey = 'AIzaSyDrZC3lZKzy4l8QX0PSqbGPPyJ50mJRv0I';
...
<script data-obct type="text/javascript">
	...
	! function(_window, _document) {
		var OB_ADV_ID = '000f19b964704c0545015e2868f10ada02';
		if (_window.obApi) {
			return;
		}
