...
<wb_p id="_wb_curr_url">https://www.indiastudychannel.com/errors/Error.aspx?Message=An+error+occurred.+Code%3a+0cb1513f-8981-49ea-b463-27614cd9c419%3cbr+%2f%3ePlease+try+to+access+the+feature+again+by+pressing+the+back+button+on+the+browser.</wb_p>
<wb_p>As it appears live May 26, 2019 3:30:03 AM UTC</wb_p>
...
<script type="text/javascript">
  function doRedir()
  {   
    var redirUrl = "/web/20190526033003/https://www.indiastudychannel.com/errors/Error.aspx?Message=An+error+occurred.+Code%3a+0cb1513f-8981-49ea-b463-27614cd9c419%3cbr+%2f%3ePlease+try+to+access+the+feature+again+by+pressing+the+back+button+on+the+browser.";
...
<!-- End of Record Banner Output output -->
    ...
    <form method="post" action="./Error.aspx?Message=An+error+occurred.+Code%3a+0cb1513f-8981-49ea-b463-27614cd9c419%3cbr+%2f%3ePlease+try+to+access+the+feature+again+by+pressing+the+back+button+on+the+browser." id="form1">
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="" />
				...
				<table width="85%" cellpadding="5" cellspacing="1" bgcolor="red">
					<tr bgcolor="white">
						<td align="center">
							...
							<br>
							<font color="red">
								<span id="lblMessage">An error occurred. Code: 0cb1513f-8981-49ea-b463-27614cd9c419<br />Please try to access the feature again by pressing the back button on the browser.</span>
							</font>
							<br>
							<br>
...
<!--
     FILE ARCHIVED ON 3:30:03 May 26, 2019 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 3:30:04 May 26, 2019.
