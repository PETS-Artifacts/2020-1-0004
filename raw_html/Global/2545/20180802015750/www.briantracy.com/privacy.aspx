...
<!DOCTYPE html>
<html lang="en">
<head><meta charset="UTF-8" /><meta name="viewport" content="width=device-width, initial-scale=1" /><title>Privacy Policy | Brian Tracy</title><link rel="shortcut icon" href="/favicon.ico" /><link rel="publisher" href="https://plus.google.com/+BrianTracyOfficialPage/" />
<!--
...
header a:hover{background:#000f2e;background:url(data:image/svg+xml;base64,PD94bWwgdmVyc2lvbj0iMS4wIiA/Pgo8c3ZnIHhtbG5zPSJod…EiIGhlaWdodD0iMSIgZmlsbD0idXJsKCNncmFkLXVjZ2ctZ2VuZXJhdGVkKSIgLz4KPC9zdmc+);background:-moz-linear-gradient(top,#000f2e 0%,#0b3355 100%);background:-webkit-gradient(linear,left top,left bottom,color-stop(0%,#000f2e),color-stop(100%,#0b3355));background:-webkit-linear-gradient(top,#000f2e 0%,#0b3355 100%);background:-o-linear-gradient(top,#000f2e 0%,#0b3355 100%);background:-ms-linear-gradient(top,#000f2e 0%,#0b3355 100%);background:linear-gradient(to bottom,#000f2e 0%,#0b3355 100%);filter:progid:DXImageTransform.Microsoft.gradient(startColorstr='#000f2e',endColorstr='#0b3355',GradientType=0)}
...
.toggle:hover{background:#000f2e;background:url(data:image/svg+xml;base64,PD94bWwgdmVyc2lvbj0iMS4wIiA/Pgo8c3ZnIHhtbG5zPSJod…EiIGhlaWdodD0iMSIgZmlsbD0idXJsKCNncmFkLXVjZ2ctZ2VuZXJhdGVkKSIgLz4KPC9zdmc+);background:-moz-linear-gradient(top,#000f2e 0%,#0b3355 100%);background:-webkit-gradient(linear,left top,left bottom,color-stop(0%,#000f2e),color-stop(100%,#0b3355));background:-webkit-linear-gradient(top,#000f2e 0%,#0b3355 100%);background:-o-linear-gradient(top,#000f2e 0%,#0b3355 100%);background:-ms-linear-gradient(top,#000f2e 0%,#0b3355 100%);background:linear-gradient(to bottom,#000f2e 0%,#0b3355 100%);filter:progid:DXImageTransform.Microsoft.gradient(startColorstr='#000f2e',endColorstr='#0b3355',GradientType=0)}
...
<script type="text/javascript">
    var aryLoadCSS=['/assets2/v10/css/bootstrap.min.css','/assets2/v10/css/style2.css','/assets2/v10/css/font-awesome.min.css'];
    var aryLoadJS = ['/assets2/v10/js/bootstrap.min.js'];
    dataLayer = [];
</script>

    <link rel="canonical" href="https://www.briantracy.com/privacy.aspx"/>
<!-- Google Tag Manager -->
<noscript><iframe src="//www.googletagmanager.com/ns.html?id=GTM-PSZPM6"
height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
<script>(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':
new Date().getTime(),event:'gtm.js'});var f=d.getElementsByTagName(s)[0],
j=d.createElement(s),dl=l!='dataLayer'?'&l='+l:'';j.async=true;j.src=
  '//www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);
  })(window,document,'script','dataLayer','GTM-PSZPM6');</script>
<!-- End Google Tag Manager -->

<script>
  (function(i,s,o,g,r,a,m){i['GoogleAnalyticsObject']=r;i[r]=i[r]||function(){(i[r].q=i[r].q||[]).push(arguments)},i[r].l=1*new Date();a=s.createElement(o),m=s.getElementsByTagName(o)[0];a.async=1;a.src=g;m.parentNode.insertBefore(a,m) })(window,document,'script','//www.google-analytics.com/analytics.js','ga');
  ga('create', 'UA-6124354-1', 'auto');
...
<a href="/">
<img alt="Brian Tracy International" itemprop="logo" class="image-logo" src='data:image/png;base64,'>
...
<ul>
<li><a href="https://results.briantracy.com/a-letter-from-brian" target="_blank">Get Coached by Brian</a></li>
...
<li><a href="/speaking/calendar.aspx" class="long-menu">Brian's Speaking Calendar</a></li>
...
<div>
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="/wEPDwUJNDMyNDU0NjAzD2QWAmYPZBYEAgMPZBYCAgEPFgIeBFRleHQFKjxsaT48YSBocmVmPScvbG9naW4uYXNweCc+TG9naW48L2E+PC9saT4NCmQCBw9kFgICAQ8WAh8ABQQyMDE4ZGR1ARfTBfc7fHnTBIt76NOu" />
</div>
  ...
  <div class="container container-page-text">
    <div class="row">
      <div class="col-sm-8">
        ...
        <h1 class="#top">BRIAN TRACY INTERNATIONAL <br>PRIVACY NOTICE</h1>

        <h2>Terms of Use, Privacy, and GDPR Compliance</h2>
        <p>The new General Data Protection Regulation (GDPR) went into effect on 25th May 2018. Brian Tracy International is updating its privacy policy to provide you with increased transparency into the personal data it collects, how it is used, and the controls you have over your personal data. By using the Brian Tracy International website, and all affiliated Brian Tracy International pages, you are accepting the practices described in this Privacy Policy.</p>
        <p>Brian Tracy International knows that you care how information about you is used and shared, and we appreciate your trust that we will do so carefully and sensibly. The protection of your personal data, and compliance with GDPR is a very important concern. We therefore deal with your personal data in compliance with the applicable legal data protection provisions.</p>
        <p>For information on specific aspects of our GDPR compliance, please click the appropriate link below.</p>

        <ul>
          <li><a href="#top">Privacy Policy and Use of Website</a></li>
          <li><a href="#terms-and-conditions">Terms and Conditions</a></li>
          <li><a href="#data-protection">Data Protection</a></li>
          <li><a href="#user-info">How we collect member, visitor or user information</a></li>
          <li><a href="#data-transfer">Data Transfer</a></li>
          <li><a href="#request-records">Request record of your data</a></li>
        </ul>

        <p>If you have any questions or concerns, please contact your personal Asset Manager, or <a href="mailto:rob@brandetize.com">the Brian Tracy International Data Protection Officer</a></p>
        <p>This Privacy Policy sets forth the policies and practices with respect to information or data that is received or gathered regarding members, visitors and users (collectively “you” and “your”). <a href="https://briantracy.com/">www.briantracy.com</a> and all related sites of Brian Tracy International may be referred to collectively as “<a href="https://briantracy.com/">www.briantracy.com</a>”, “Brian Tracy International”, “us”, “we”, “Site”, “Website” or “the Company”</p>
        <p>CAREFULLY READ THIS PRIVACY POLICY BECAUSE BY YOUR USE OF THIS SITE AND ITS SERVICES YOU WILL BE EXPRESSLY SIGNIFYING THAT YOU AGREE TO THIS POLICY AND THAT YOU ASSENT TO THE TERMS OF THIS AGREEMENT, INCLUDING THE USE OF ANY PERSONAL INFORMATION THAT YOU SUPPLY OR THAT IS COLLECTED ABOUT YOU AS DETAILED IN THIS PRIVACY POLICY. IF YOU DO NOT EXPRESSLY AGREE WITH ALL OF THE TERMS OF THIS PRIVACY POLICY YOU SHOULD NOT USE THIS SITE OR ITS SERVICES.</p>

        <h2 id="terms-and-conditions">Terms and Conditions</h2>

        <h3>Copyright and Trademark Rights</h3>
        <p>The texts, images, graphics and the layout of this website displayed on this website are subject to copyright. Violations of this will be prosecuted both under civil and criminal law. Reproduction of all or part of this website is only permitted with the prior written consent of Brian Tracy International. The individual use does not authorize the transfer of content to third parties. Trademarks used on this website are protected and all rights are owned by the respective trademark owners.</p>

        <h2 id="data-protection">Data Protection</h2>
        <p>For us, Brian Tracy International, the protection of your personal data is a very important concern. It is therefore natural for us to deal with your personal data in compliance with the applicable legal data protection provisions.</p>
        <p>With this privacy policy we explain to you which data in the context of the use of this website are collected, processed and used for which purposes and which rights you are entitled to.</p>

        <h3>Data Collection and Processing When Visiting Our Website</h3>
        <p>As is usual with many websites, the retrieval of the individual web pages from our web servers and the web analytics software Google Analytics we use automatically collects and processes the following non-personal data:  </p>

        <h3>Collection and Processing of Personal Data and Consent</h3>
        <p>We collect, process and use personal data such as your name, postal address, email address or other contact details <strong>only if they have been entered by you on the website and transmitted to us</strong> and to the extent that such collection, processing and use is permitted by law or covered by your consent.</p>
        <p>The use of certain services of our website such as, information and study requirements, the contact form, the callback service and the registration for our newsletter makes the collection, processing and use of personal data necessary. In this case, we take the requirement of data economy seriously and only collect those personal data marked as mandatory in the respective online forms that are required for the purpose of using and processing the respective service. The personal data provided in the other form fields are voluntary and used by us for the purpose of being able to address you more personally and / or individually or to increase the service for you, for example through the possibility of queries. For each of these services, we point out to you, at the appropriate place on our website, the purposes for which we collect, process and use the respective personal data. Any collection, processing and use of your personal data will only be for the stated purposes and to the extent necessary to achieve these purposes.</p>
        <p>In addition, if your prior consent is required for certain data collection, processing and use, such as service telephone calls and the use of our newsletter or our information e-mails, we will, of course, ask you for your consent beforehand at the corresponding section of our website ask. These declarations of consent are recorded by us and can be accessed by you at any time at the appropriate place on our website. We recommend that you print out the declarations of consent for your own documents. <strong>You are entitled to revoke your given consent at any time in whole or in part with effect for the future.</strong> Even such a revocation will be logged by us.</p>
        <p>When necessary/requested, your data will be destroyed in compliance with all GDPR rules and requirements.</p>

        <h2 id="user-info">How We Collect Member, Visitor or User Information</h2>
        <p>The information we gather falls into two categories:</p>
        <ol>
          <li>Information collected as a result of you navigating through the Site.</li>
          <li>Personal information you voluntarily supply when you subscribe, order, post a message, photo, video or sound recording, send a message to another user, or participate in a chat room, complete a survey, enter a contest, or apply for a promotional product.</li>
        </ol>
        <p>The first type of information we collect can be thought of as "passive" information in that we collect certain details about your visit to our site without you actively inputting any identifying information. This type of passive information that we collect and store in our databases, may include one or more of the following types of information ("Data"): your Internet Protocol (IP) address; the name of the domain name from which you access the Internet; the IP address of the Website from which you linked to the Site or our network of sites; browser data; email address data; and the date and time you access our Site and its functions. For example, when a visitor, member, subscriber, or other Site user requests web pages from the Site’s server, clicks on banners or other links or otherwise uses or views the Site’s services, products or other functions, we or our agents may automatically collect some information ("Data") about the visitor, member, subscriber or user. This information may include the IP address from which the Site is being accessed, the pages or links that were requested, the special preferences or requests of the user and cookie information received from the computer of the visitor, member, subscriber or user. While the collection of Data described above could be thought of as passive, the second way we collect information is more active.</p>
        <p>For example, we may ask you to provide personal information. Whether or not you provide this personal information is completely optional. This "Optional Information" may include your name, username, e-mail address, physical address (or part of it such as your zip code), telephone number, gender, marital status, occupation, education and any special interests or affiliations. Additional "Optional Information," such as a credit card number, expiration date, security code and billing address may be requested for participation in special promotions or offers, or for billing and shipping information. We may also use "Optional Information" to verify identity, and protect against fraud. When a subscriber, member or user of this Site sends any personal communication or correspondence, by any means, to the Site, another Site User, the Company or any employees, agents or representatives of Company or Site, we may collect and use any and all such information and all other Data regarding that communication including the I.P. address the communication originated from. Once you submit personal information to the Company or Site we may collect and store information about your activities on the Site.  </p>
        
        <h3>Cookies</h3>
        <p>Cookies are one of the tools that we use to passively collect Data.  </p>
        <p>Internet cookies are alphanumeric identifiers that transfer to your computer’s hard drive through your Web browser to enable our systems to recognize your browser and to provide personalized features and marketing. Cookies are used for authenticating, tracking and maintaining specific information about users, such as site preferences or shopping cart contents. Most Internet browsers allow the option to enable or disable cookies. You may disable cookies, but this may make portions of this Site unusable. Cookies are simple pieces of data unable to perform any operation by themselves. They are neither spyware nor viruses, despite the detection of cookies from certain sites by many anti-spyware products. This Site uses cookies to make the browsing experience of our members, subscribers and users more efficient and convenient. Our system will use cookies to remember your web preferences, and to assist us in tracking and targeting the interests, preferences and desires of our Site users to present the most appropriate messages, offers and other communications to our users, and to generally enhance their experience at our Site. Any and all information about Site visitors, members, subscribers or users collected by the Company, the Site or any agents or affiliates of Company or Site, through the use of cookies or other similar means may be included in our database and used in a manner consistent with this Privacy Policy.  </p>
        <p>We use remarketing pixels from sites including, but not limited to, Google, Facebook, and Twitter to aid in customized, targeted follow-up advertising. These third-party vendors show our ads on sites across the Internet by using cookies based on past visits to our website. Anyone can opt-out of Google’s use of cookies by visiting Google’s Ads Settings (<a href="https://www.google.com/settings/ads">https://www.google.com/settings/ads</a>). Anyone can opt-out of a third-party vendor’s use of cookies by visiting the Network Advertising Initiative opt-out page (<a href="https://www.networkadvertising.org/managing/opt_out.asp">https://www.networkadvertising.org/managing/opt_out.asp</a>).  </p>
        
        <h3>You May Encounter Third Parties on Our Site</h3>
        <p>We want to inform you that third parties such as affiliates and advertisers use cookies on or in association with our Site. We often have no access or control over these cookies. We may also allow third party service providers to deliver special offers or services to Site users. We urge you to consult the privacy policies of any third party that you encounter on this Site.  </p>
        
        <h3>Clear Gifs ("web Beacons")</h3>
        <p>Clear GIFs, also known as "web beacons" or "single-pixel GIF’s" are very small images (typically 1 x 1 pixel) that help websites understand their customers better. While any type of file can operate as a web beacon, clear GIFs are most popular because their very small file size prevents them from interfering in the websites’ operation. Clear GIFs function like cookies, in that they are used to track and measure online actions taken by website users. In contrast to cookies clear GIFs are not stored on a user’s hard drive, but are embedded into the graphics, text or other components of web pages. Web pages and graphical emails use codes that tell your computer what to do when a page is opened. While they typically contain text and graphics that you see on the screen, often web pages also contain instructions or tags' that then ask the website's server to send you further content (such as an image or a block of text that changes frequently). Web beacons are retrieved in the same way as the text and graphics that you see on a website or in an email, and the action of calling the material from another server allows the event to be counted. When a user's browser requests information from our Site we may use GIFs to gather "passive" information such as the IP address of your computer; the time the material was viewed; the type of browser that retrieved the image; and the prior existence of cookies from our Site. This is information that could be gathered through the use of cookies. Web beacons do not give any "extra" information away. They are simply a convenient way for us to gather the simple statistics and manage cookies. Clear GIFs may be used by third parties to monitor activity on the Site. Turning off the browser's cookies will prevent web beacons from tracking your specific activity, but web beacons may still record an anonymous visit from your IP address.  </p>
        
        <h2>Facebook</h2>
        <p>Facebook Tools are used on the website and may use cookies, web beacons, and other storage technologies to collect or receive information from your websites and elsewhere on the internet and use that information to provide measurement services and target adds. You can opt out of the collection and find more information on your choices here: <a href="http://www.aboutads.info/choices">http://www.aboutads.info/choices</a> and <a href="http://www.youronlinechoices.eu">http://www.youronlinechoices.eu</a>.  </p>
        
        <h2>Google Analytics</h2>
        <p>This website uses Google Analytics, a web analytics service provided by Google Inc. (“Google”). Google Analytics uses so-called “cookies”, text files that are stored on your computer and that allow an analysis of the use of the website by you. The information generated by the cookie about your use of this website is usually transmitted to a Google server in the USA and stored there. However, if IP anonymisation is activated on this website, your IP address will be shortened by Google beforehand within member states of the European Union or other parties to the Agreement on the European Economic Area.  </p>
        <p>Only in exceptional cases will the full IP address be sent to a Google server in the US and shortened there. On behalf of the operator of this website, Google will use this information to evaluate your use of the website, to compile reports on website activity and to provide other services related to website activity and internet usage to the website operator. The IP address provided by Google Analytics as part of Google Analytics will not be merged with other Google data.  </p>
        ...
        <h2>Your rights</h2>
        <h3>Information and Information Rights</h3>
        <p>At any time you have the right to information about the data stored about you, their origin and recipient as well as the purpose of the storage. You can contact us at the following address: support@briantracy.com or at the postal address 2840 Fifth Ave., Suite 400, San Diego, CA 92103. If you have any questions about our privacy policy or if you wish to receive more detailed information, you can also contact us at these addresses.  </p>
        ...
        <p>If you are a newsletter subscriber, you always have the option of no longer receiving them. At the bottom of each newsletter there is an opt-out option. Simply click on “Please click here to unsubscribe”.  </p>
        
        <h2>Correct/Update</h2>
        <p>Our customers can correct, access and update pertinent Personally Identifiable Information obtained through the site. Mechanisms include online, email, telephone, postal mail etc. This helps to assure that the information we collect is accurate and up to date. You can correct, access, and update your personal information by emailing the address <a href="mailto:support@briantracy.com">here</a>.  </p>
        
        <h2 id="request-records">Request Record of your Stored Data</h2>
        <p>To request a report on what data has been stored related to your account, or to request that we delete all associated data, please email us <a href="mailto:support@briantracy.com">here</a>.  </p>
        
        <h2>Conditions of Use, Notices and Revisions</h2>
        <p>If you choose to visit Brian Tracy International, your visit and any dispute over privacy is subject to this Notice and our Conditions of Use, including limitations on damages, arbitration of disputes, and application of the law of the Luxembourg. Our business changes constantly. This Notice and the Conditions of Use will change also, and use of information that we gather now is subject to the Privacy Notice in effect at the time of use.  </p>
        
        <h2>Change of Privacy Policy</h2>
        <p>From time to time, it may be necessary to change this privacy policy, for example as a result of the further development of our website or legal changes. Brian Tracy International therefore reserves the right to change the privacy policy at any time with effect for the future. We therefore recommend that you read this privacy policy again at regular intervals.  </p>

        <p><strong>Brian Tracy International</strong><br> Phone: 1-858-436-7300<br> Fax: 1-858-436-7301<br> Email: <a href="mailto:support@briantracy.com">support@briantracy.com</a><br> 2840 Fifth Ave., Suite 400, San Diego, CA 92103<br> Website: <a href="www.briantracy.com">www.briantracy.com</a>  </p>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-12 col-md-8">
                <ul>
                    <li class="google"><a target="_blank" href="https://plus.google.com/+BrianTracyOfficialPage/posts">Google+</a></li>
                    ...
                    <li class="youtube"><a target="_blank" href="https://www.youtube.com/user/BrianTracySpeaker">Youtube</a></li>
                </ul>
            </div>
        </div>
    </div>
		...
		<div class="row">
            <div class="col-sm-6 col-md-2">
		        ...
		        <ul>
                    ...
                    <li><a href="/files/pages/library/">Mobile Apps</a></li>
		        </ul>
		    </div>
	    	...
	    	<div class="col-sm-6 col-md-2">
		        ...
		        <ul>
		            ...
		            <li><a href="https://www.youtube.com/user/BrianTracySpeaker" target="_blank">Youtube</a></li>
		        </ul>
    		</div>-->
		    <div class="col-sm-6 col-md-2">
		    ...
		    <div class="container">
		        <div class="row">
		            ...
		            <div class="col-sm-12 col-md-4 col-md-offset-4 right">
	    	            <p><small>© Copyright 2001-2018 Brian Tracy International.<br>All Rights Reserved.</small></p>
		            </div>
		        </div>  
		    </div>
	    </div>
