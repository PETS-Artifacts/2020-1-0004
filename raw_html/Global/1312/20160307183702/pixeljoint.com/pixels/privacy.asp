...
<script src="http://cdn.jquerytools.org/1.2.2/tiny/jquery.tools.min.js" type="text/javascript"></script><!--PROFILE TABS-->
...
<script>(function(d, s, id) {
  ...
  js.src = "//connect.facebook.net/en_US/all.js#xfbml=1&appId=109025315789375";
  fjs.parentNode.insertBefore(js, fjs);
}(document, 'script', 'facebook-jssdk'));</script>
<div class="fb-like" data-href="http://pixeljoint.com" data-send="false" data-layout="button_count" data-width="90" data-show-faces="true" data-colorscheme="dark"></div>
		</div>
		<div id='footer-links'>
