...
<meta http-equiv="X-UA-Compatible" content="IE=edge" />
    <script type="text/javascript" src="/ScriptSet/MrJqueryScripts.js?version=201610311659320554"></script>
    <script type="text/javascript" src="/ScriptSet/MrScripts.js?version=201610311659320554"></script>
    <script type="text/javascript" src="/Scripts/CheckAuthCookie.js?version=201610311659320554"></script>
    <link href="/StyleSet/MrMainStyles.css?version=201611040023004374" rel="stylesheet" type="text/css" />
...
<div class="aspNetHidden">
    ...
    <div id="MR_GlobalWrapper" class=' fixed-headerVisitor-float'>    
        <!--[if gt IE 9]><!-->
...
<div class="mrw_master_header visitor">
    ...
    <div class="mr_header">
        <div class="mr_header_elements" itemscope itemtype="http://schema.org/Organization">
            <a itemprop="url" href="/" title="Go to MyRegistry Home">
                <div class="mr_logo">
                    <img itemprop="logo" src="/Images/MRlogo_500.png" alt="MyRegistry Logo" style="display: none;" />
                    <i class="hide">MyRegistry Logo</i>
                </div>
            </a>
            
            <div class="header_login_button">
                <a id="HomePage_TopMenu_Login" href='/login.aspx' data-popup='1' >
                    Login</a>
            </div>
            <div class="header_login_button">
                <a id="HomePage_TopMenu_Signup" href="/Signup.aspx"">Sign up</a>
            </div>
...
<script type="text/javascript">
    $(".left_bar_menu").ready(function() {
        $(".content_left_bar_menu dl dt a").click(function() {
            //alert(1);
        });
    });
</script>
<div class="left_bar_menu">
    ...
    <div class="content_left_bar_menu">
        <dl>    
            ...
            <dt><a class="lnkSignup" id="HomePage_LeftBar_Signup" href="/?param=signup">Sign up</a>
                <a class="lnkLogin" href="/Login.aspx">
                    Login
                </a></dt>
            
            <dt><a class="mobile_link_left_menu" href="/Info/SmartPhoneApps/">GET THE MOBILE APP</a></dt>
            <dt>
                <div class="left_bar_menu_line"></div>    
            </dt>
                
                
            <dt onclick="openLivechat();"><span class="chat_small_icon"></span><a class="text_with_icon">
                CHAT WITH US</a> </dt>
            
        </dl>
        <div class="left_bar_menu_faq"><a href="/Info/Faq.aspx">FAQs</a></div>
        
    </div>
</div>

    
    <div class="communityDockBanner">
        <div id="div-gpt-ad-1466026334395-0"></div>
    </div>
</div>
    ...
    <div class="mrw_container">
        <h1 class="headerV2">
            MyRegistry LLC Privacy Statement</h1>
        <div class="content">
            <p>
            ...
            <div class="forms_end">
                <div style="display:inline-block">
                    This Terms and Conditions Statement is effective June 9, 2016<br />
                    <strong>Last Updated</strong>: 06/9/2016</div>                
            </div>
        </div>
    </div>
...
<div class="footer">
    <div class="mr_inner_footer">
            ...
            <a class="mr_footer_store_link mr_14_geo_regular" target="_blank" href="https://shop.myregistry.com/SearchResults.asp?Cat=100">
                Bridesmaid</a> <a class="mr_footer_store_link mr_14_geo_regular" target="_blank"
                    href="https://shop.myregistry.com/SearchResults.asp?Cat=200">Groomsmen</a>
            <a class="mr_footer_store_link mr_14_geo_regular" target="_blank" href="https://shop.myregistry.com/SearchResults.asp?Cat=300">
                Wedding Favors</a> <a class="mr_footer_store_link mr_14_geo_regular" target="_blank"
                    href="http://kitchenware.myregistry.com/">Kitchen &amp; Housewares</a> <a class="mr_footer_store_link mr_14_geo_regular"
                        href="https://shop.myregistry.com/SearchResults.asp?Cat=400" target="_blank">Baby
                        Favors</a> <a class="mr_footer_store_link mr_14_geo_regular" href="https://babygifts.myregistry.com/"
    ...
    <div id="cssmenu_footer" style="margin: 3px 0px 0px;">
        <ul>
            <li class="active has-sub"><a href="javascript:void(0);"><span>COMPANY INFO</span></a>
                <ul>
                    ...
                    <li><a target="_blank" href="https://www.myregistry.com/blog/"><span>Blog</span></a></li>
            ...
            <li class="has-sub"><a href="javascript:void(0);"><span>FOR MEMBERS</span></a>
                <ul>
                    ...
                    <li><a href="/Info/SmartPhoneApps/">Our Mobile Apps</a></li>
                    <li><a href="/Info/CashGifts.aspx">Cash Gift Service</a></li>
                    <li><a target="_self" href="/Info/storeswelike.aspx">Prescreened Retailers</a></li>
                    
                    <li><a target="_self" href="/Members/ShareRegistry/">Display Your Registry</a></li>
                </ul>
            </li>
        ...
        <ul>
            <li class="has-sub"><a href="javascript:void(0);"><span>NONPROFITS/ORGANIZATIONS</span></a>
                <ul>
                    ...
                    <li><a target="_self" href="/Info/storeswelikeOrg.aspx">Prescreened Retailers</a></li>
        ...
        <ul>   
            <li class="has-sub">
                ...
                <a href="javascript:void(0);"><span>QUICK LINKS</span></a>
                <ul>
                    <li><a target="_self" href="/wedding-registry.aspx">Wedding Registry</a></li>
                    <li><a target="_self" href="/baby-registry.aspx">Baby Registry</a></li>
                    <li><a target="_self" href="/wish-list.aspx">Wish list</a></li>
                </ul>
            
                <div class="mr_home_extraspace"></div>
                
                <a href="javascript:void(0);"><span>FOR PARTNERS</span></a>
                <ul>
                    <li><a target="_self" href="/gift-registry-software/">Gift Registry Software</a></li>
                    <li><a target="_self" href="/registrywidget/login.aspx">Partner Login</a></li>
