...
<link rel="stylesheet" href="/templates/orange_responsive/css_f/app.css" />
...
<body id="about-privacy" class="about  ">
...
<li class="menu-entry "><a class="membership" href="/members/subscription">Membership</a></li>
</ul>
<ul class="menu vertical large-horizontal">
...
<li class="menu-entry" id="guides_dropdown_2"><a class="guides" data-toggle="navbar-guidesmenu-slidersmall">Guides</a>
...
<ul class="vertical large-horizontal menu guidelist game_not_eso">
...
<ul class="vertical large-horizontal menu guidelist game_not_wow">
<li><a class="guide eso-lv" href="/guides/eso/leveling">Leveling &amp;<br /> Champion Points</a></li>
</ul>
</ul>
</li>
<li class="menu-entry"><a href="/forum" class="forum">Forum</a></li>
...
<div class="reveal fast" id="loginpanel" data-reveal data-animation-in="fade-in" data-animation-out="fade-out">
<div class="titlebar">
...
<a class="button common-facebook" href="https://www.facebook.com/v2.11/dialog/oauth?state=login&client_id=410642722464055&redirect_uri=https%3A%2F%2Fzygorguides.com%2Fmembers%2Fplugins%2Fprotect%2Ffblogin%2Fcallback.php&scope=email,public_profile">Facebook</a>
<a class="button common-google" href="https://accounts.google.com/o/oauth2/auth?response_type=code&redirect_uri=https%3A%2F%2Fzygorguides.com%2Fmembers%2Fplugins%2Fprotect%2Fgooglepluslogin%2Fcallback.php&client_id=1033862950067-9vcmm62iti6s3an16dak2e7fkroh0th9.apps.googleusercontent.com&scope=https%3A%2F%2Fwww.googleapis.com%2Fauth%2Fyoutube.readonly+openid+email+profile&access_type=offline&approval_prompt=auto&state=login">Google</a>
</div>
<div class="common-or">
<div class="circle">OR</div>
</div>
<div class="loginway">Log in with Zygor account</div>
<div class="inputbox">
<div class="user"><input class="common-inverse" type="text" name="amember_login" placeholder="Username or email" /></div>
<div class="form-error"></div>
</div>
<div class="inputbox">
<div class="password"><input class="common-inverse password" type="password" name="amember_pass" placeholder="Password" /></div>
<div class="form-error"></div>
</div>
...
<div class="checkbox">
<input type="checkbox" name="amember_remember">
<div class="image"></div>
</div>
</label>
</div>
				...
				if (data.success) {
					...
					form
						...
						.queue(function() {
							...
							window.location=data.target || "/members";
							$(this).dequeue();
						});
				} else {
					var msg;
					switch (data.code) {
						...
						case "no_such_user": form.find(".user+.form-error").addClass("is-visible").html("User data not found.");  form.find(".user").addClass("invalid"); break;
						case "login_incorrect": form.find(".password+.form-error").addClass("is-visible").html("Wrong password.");  form.find(".password").addClass("invalid"); break;
...
<a class="zygorlogo" href="/">Zygor</a>
</div>
<div class="top-bar-left">
<ul class="vertical large-horizontal menu">
<li class="hide-for-large menu-entry"><a href="/" class="home">Home</a></li>
<li class="menu-entry" id="guides_dropdown_1"><a class="guides" data-toggle="navbar-guidesmenu-sliderlarge">Guides</a>
<ul id="navbar-guidesmenu-slidersmall" class="hide-for-large menu vertical guidesmenu " style="display:none;" data-toggler=".tmp_toggler_bxskjfnbkdlgn">
<div class="gametitle">World of Warcraft</div>
<ul class="vertical large-horizontal menu guidelist game_not_eso">
<li><a class="guide wow-ll" href="/guides/wow/leveling-loremaster">Leveling &amp;<br /> Loremaster</a></li>
...
<h6 class="about-updated">Updated May 25th, 2018</h6>
<p>Here at Zygor Guides we value your privacy and it is our policy to make it clear what data we collect and how we use it, as well give you full control over this data.</p>
</div>
</div>
<div class="collect">
<div class="container">
<h2>The Data We Collect:</h2>
<p>When you create a Zygor Account we collect and store the following information.</p>
<h4>On our local server we collect and store:</h4>
<p>Your username, first and last name, and email address. Passwords are not stored and are encrypted in a way that can only be used for login purposes and thus cannot be retrieved in the event of a security breach.</p>
<p>If you choose to link your social media and/or discord accounts (completely optional) we are able to access select profile information through those third party services. You will be shown what info we will gain access to and be asked for approval before any accounts are linked.</p>
<p>Almost all user interactivity on the site is handled via cookies stored locally on each users device. Additionally, we track user behavior and interaction using Google and Facebook tracking pixels.</p>
<h4>If you purchase a Zygor Elite subscription our payment processor Recurly collects and stores:</h4>
<p>Your Payment info and your billing address. If you use Paypal only a "token" is stored rather than your full info. This information is not stored locally on our servers but externally on Recurly's servers. Recurly is GDPR complaint as of May 25th.</p>
<p>Additionally, when you sign up for an account your email is automatically added to our Aweber (third party mailing list service) newsletter.</p>
<div class="addresses">
<div class="address">
Recurly, Inc. (<a href="https://recurly.com/">https://recurly.com/</a>)<br />
400 Alabama Street <br />
Suite 202 <br />
San Francisco, CA <br />
94110, USA<br />
</div>
<div class="address">
AWeber Communications (<a href="https://www.aweber.com/">https://www.aweber.com/</a>)<br />
1100 Manor Drive <br />
Chalfont, PA <br />
18914, USA<br />
</div>
...
<p>We monitor and store access logs to our server and install client. Our client is able to track and send us anonymous usage statistics about which guides you install and use.</p>
</div>
</div>
<div class="why">
<div class="container">
<h2>Why We Collect and Store This Data</h2>
<p>The data on our local server is used to create an account profile for customers, grant access to consumer products, and allow users to use website features such as the forums and user feedback sections.</p>
<p>The data stored through our third party payment processor Recurly is used to bill and process monthly payments for premium consumer services like Zygor Elite.</p>
<p>Users are auto-enrolled to our newsletter in order to provide important information about our products and services.</p>
<p>Usage statistics are used to determine the size of our user base and which products are most popular in order to focus our efforts.</p>
<p>Your access patterns (dates, IP addresses, browser versions) are also stored for security reasons and fraud protection.</p>
<p>Cookies are used to handle user logins and keep them logged in as they use the site. They are also used to track when affiliates send traffic to our site that results in a sale in order to provide commissions.</p>
<p>Google tracking pixels are used for Google Analytics to learn more about user behavior and test the sales effectiveness of individual pages. Facebook tracking pixels are used to test the sales results of Zygor ads running on Facebook.</p>
</div>
</div>
<div class="options">
<div class="container">
<h2>Your Data and Privacy Options:</h2>
<p>All locally stored information can be edited manually through the website.</p>
<p>Through our support ticket system you can request changes to the information stored by our payment processor, and/or request that your account be closed and all your data completely removed both locally and through Recurly. This will be done promptly and you will be notified when this process is complete. We are also working on adding ways that you can do all of this manually as well.</p>
<p>You can unsubscribe from our newsletter by clicking the "Unsubscribe" link at the bottom of each email.</p>
</div>
</div>
<div class="protect">
<div class="container">
<h2>How We Protect Your Data:</h2>
<p>The portions of our website used for account registration are secured via SSL. Billing information is stored solely on Recurly's servers and is never actually transmitted through our servers, thus reducing the risk of man-in-the-middle attacks.</p>
<p>All information stored at Recurly uses the highest security which can be read about here: <a href="https://recurly.com/security/">https://recurly.com/security/</a></p>
<p>If there is ever a security breach we will notify you and let you know what we're doing to make sure it doesn't happen again.</p>
<p>We will also routinely audit and update our policies to make sure they meet the highest privacy standards.</p>
</div>
</div>
...
<li><a title="Join" href="/members/signup.php">Join</a></li>
...
<li><a title="Live Chat Contact" href="http://support.zygorguides.com">Live Chat Contact</a></li>
<li><a title="Submit a Ticket" href="http://support.zygorguides.com">Submit a Ticket</a></li>
<li><a title="Community Forum" href="/forum/">Community Forum</a></li>
...
<input class="email common-dark" id="awf_field-12907303" type="text" name="email" value="" tabindex="500" placeholder="your email" />
...
<div class="row">
<div class="small-12 large-6 column">Copyright &copy; 2017 Zygor Guides, LLC.<br />All Rights Reserved. </div>
<div class="small-12 large-6 column linkbox">
<a href="http://www.zygorguides.com/about/tos.php">Terms of Use</a>
<a href="http://www.zygorguides.com/about/privacy.php">Privacy Policy</a>
<a href="http://www.zygorguides.com/about/company.php">Company Info</a>
<a href="http://www.zygorguides.com/affiliates/">Affiliates</a>
</div>
...
<script type="text/javascript" async>
	...
	ga('create', 'UA-3226305-1', 'auto'); // , { 'allowLinker': true}

	/*
	if (document.location.pathname.indexOf("signup-elite")>-1) {
		var dimensionValue = getParameterByName("from") || "n/a";
		if (dimensionValue) ga('set', 'dimension2', dimensionValue);
		//ga('send','pageview', document.location.pathname); // + window.location.search
	}
	*/

	ga('send','pageview', document.location.pathname);

	// did "thanks" give us an Ecommerce product to track?
	if (typeof _ga_trans !== 'undefined') {
		for (var i in _ga_trans) {
			ga(_ga_trans[i][0],_ga_trans[i][1],_ga_trans[i][2]);
		}
	}
</script>
...
<script>
	...
	fbq('init', '645431472286544');
	fbq('track', "PageView");</script>
<noscript><img height="1" width="1" style="display:none" src="https://www.facebook.com/tr?id=645431472286544&ev=PageView&noscript=1" /></noscript>
