...
<option value="21" >Print</option>";
<option value="22" >Public Sector</option>";
<option value="23" >Private Sector</option>";
...
Fax: (868) 622-0426<br>
E-mail: <a href="mailto:info@WhosWhoTnt.com">info@WhosWhoTnT.com</a><br>
...
<!--CONTAINER CLOSING TAGS-->
		...
		<div class="blue_across">
         <ul>
          <li><a href="btt.php" alt="Business in Trinidad & Tobago" title="Business in Trinidad & Tobago">BTT News</a></li>
        <li><a href="aboutwhoswhotnt.php" alt="About Who's Who TNT" title="About Who's Who TNT">About</a></li>
        <li><a href="publishersnote.php" alt="Publisher's Note" title="Publisher's Note">Publisher's Note</a></li>
                <li><a href="publications.php" alt="Publications" title="Publications">Publications</a></li>
        <li><a href="ttfacts.php" alt="T + T Facts" title="T+T Facts">T &amp; T Facts</a></li>	
        <li><a href="termsofuse.php" alt="Terms of Use" title="Terms of Use">Terms Of Use</a></li>
        
        <li><a href="privacypolicy.php" alt="privacypolicy.php" title="Privacy Policy">Privacy Policy</a></li>
           <li><a href="testominials.php" alt="Who's Who  Testimonials" title="Who's Who  Testimonials"> Testimonials</a></li>
         <li><a href="contact.php" alt="Who's Who Contact Us" title="Who's Who Contact Us">Contact Us</a></li>
          </ul>
        </div>
 		<div class="foot_logo"> <img src="images/newfootlogo.png" alt="Who's Who" title="Who's Who">
</div>
       ...
       <li><strong>Email:</strong> info@whoswhotnt.com</li>
       </ul>
         </div>
