<!DOCTYPE html><!--[if lt IE 7]><html class="no-js lt-ie9 lt-ie8 lt-ie7" xsl="http://www.w3.org/1999/XSL/Transform xmlns:fb="http://www.facebook.com/2008/fbml""><![endif]--><!--[if IE 7]><html class="no-js lt-ie9 lt-ie8" xsl="http://www.w3.org/1999/XSL/Transform xmlns:fb="http://www.facebook.com/2008/fbml""> <![endif]--><!--[if IE 8]><html class="no-js lt-ie9" xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fb="http://www.facebook.com/2008/fbml"><![endif]--><!--[if gt IE 8]><!--><html class="no-js" xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fb="http://www.facebook.com/2008/fbml" xmlns:scr="urn:scr.this"><!--<![endif]--><head><meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1" /><meta name="verify-v1" content="jKqgZt8qtZUt+IrazV2fydKUZG2KKR8QEUoYjH9tth4=" /><meta http-equiv="Content-Type" content="text/html; charset=utf-8" /><title>Privacy Policy | InformIT
    ...
    </script><noscript xmlns:msxsl="urn:schemas-microsoft-com:xslt"><img height="1" width="1" alt="" style="display:none" src="https://www.facebook.com/tr?id=730048657068506&amp;ev=PixelInitialized" /></noscript></head><body><div class="wrapper"><div id="content" class="about privacy layoutSingleColumn"><div id="columnPrimary"><h1>Privacy Policy</h1><div class="pst freeform"><h3>Information Collection and Use</h3>
<br /><p>InformIT.com is operated from 800 East 96th Street, Indianapolis, IN, 46240, and is operated by Pearson Education, Inc. ("Company"). We can be reached by email at <strong><a href="mailto:comments@informit.com">comments@informit.com</a></strong>.</p>

<p>We will not sell, share, or rent Personally Identifying Information to others in ways different from what is disclosed in this statement. InformIT.com collects information from our users at several different points on our web site. Pearson Education recognizes the importance of protecting the privacy of Personal Identifying Information about you as a user of our web site. </p>
<p>We consider the following to be Personal Identifying Information: your email address, name, password, mailing address, phone number and credit card information. This web site does not collect Personal Identifying Information about a user other than information that is voluntarily provided to our Company; in this way, we can serve the user's needs as well as our own legitimate business purposes. (For example, we retain the Personal Identifying Information that a user provides when he or she chooses to register with InformIT.com).</p>
...
<p>If you have any questions about the security at our web site, you can send an e-mail to <strong><a href="mailto:comments@informit.com">comments@informit.com</a></strong>.</p>

<h3>Correction/Updating Personal Information</h3><br />
<p>If a user's personally identifiable information changes (such as your postal address or email address), we provide a way to correct or update that user's personal data provided to us. This can be done on the <strong><a href="https://memberservices.informit.com/my_account/login.aspx?partner=53">Account page</a></strong>. If a user no longer desires our service and desires to delete his or her account, please contact us at <strong><a href="mailto:customer-service@informit.com">customer-service@informit.com</a></strong> and we will process the deletion of a user's account.</p>

<h3>Choice/Opt-out</h3><br />
<p>Users can always make an informed choice as to whether they should proceed with certain services offered by InformIT. If you choose to remove yourself from our mailing list(s) simply visit the following page and uncheck any communication you no longer want to receive: 
<strong><a href="/u.aspx">www.informit.com/u.aspx</a></strong>. If you choose to remove yourself from the abandoned cart email, simply click the unsubscribe link at the bottom of any abandoned cart reminder email.</p>
