...
window._vp_page_guid = '8121bc62-9b47-454f-bbe8-47984fc56832';
...
try {
window._sessionCacheToken = "gP6JazUsVWy400dc0ckh3A";
}
 catch (jsEx) { vp.bootstrap.logException(jsEx); }
//]]>
</script>
...
<link rel="apple-touch-icon" sizes="60x60" href="/vp/images/vp-site/common/logo/vistaprint-favorites-60-60-2014.png"/>
        ...
        <img src="https://vispri.d2.sc.omtrdc.net/b/ss/vispri.vprt.bot/1/G.5--NS/636292493929773040?ns=vispri&g=http://www.vistaprint.com/customer-care/privacy-and-security.aspx&pageName=No Page Name:Unknown&v5=152400&c43=ANY:HCP:T:" style="display: none;">
<script type="text/javascript">
var utag_data = {
...
vp.sales.Taxonomy.TrackElements(jQuery('a.menu-top-button[data-item=17501]'), '965|1');
vp.sales.Taxonomy.TrackElements(jQuery('a.menu-top-button[data-item=15659]'), '965|1');
...
<div class="menu-container menu-skin-taxonomy" id="taxonomyItem14896">
    <div class="menu-item">
		...
		<div class="menu-item">
			<a href="/business-cards/sizes-and-shapes/slim-business-cards" data-item="17811">
		...
		<div class="menu-item">
			<a href="/business-cards/sizes-and-shapes/square-business-cards" data-item="17812">
...
<div class="dialog-content" id="promoDetailsDialog" data-dialog-title="Offer Details" data-dialog-enablehistory="false">
    <p class="promo-details-description">Up to 25% off select clothing products. Discount percentages may vary on options, upgrades, and accessories.</p>
    <p class="promo-details-terms">Savings apply to: T-shirts, Polo Shirts, Hats and Hoodies. Discount does not apply to T-shirt upgrades.</p>
        ...
        <div class="promo-applied-state">
            <div class="promo-drawer-centered-container">
                <div class="promo-applied-message promo-drawer-centered-content">
                    <h3 class="basic promo-applied-header">Promo code <span class="promo-code promo-code-value">CLOTHING25</span> has been applied:</h3>
                    <div class="text-large"><span class="promo-description">Up to 25% off select clothing products. Discount percentages may vary on options, upgrades, and accessories.</span> <a href="#here" class="current-coupon-details">Details</a></div>
...
<div class="input-with-button input-with-button-beside">
    <input class="stylized-input" type="text" name="promoCodeEntry" id="promoCodeEntry" value="CLOTHING25" />
...
Have a <span class="underline">promo code</span>?                </div>
        ...
        <div class="drawer-closed-state promo-applied-state drawer-title-bar">
            ...
            <div class="drawer-handle-left">
                <div class="drawer-handle-background"></div>
                <div class="drawer-title drawer-title-applied">Promo code <span class="promo-code-value">CLOTHING25</span> has been applied</div>
            </div>
            <div class="drawer-handle-right">
                <div class="drawer-handle-background"></div>
                <div class="drawer-title drawer-title-entry ">
...
<div id="divMachineId" style="display:none">ac59449f6b81089029b34dc5ab5cedf3</div>
