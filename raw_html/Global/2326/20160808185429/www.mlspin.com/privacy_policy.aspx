...
<table border="0" cellspacing="0" cellpadding="0" style="width: 1000px; margin-top: 4px;
    ...
    <div id="divContainer">
        ...
        <p>
            ...
            MLS PIN does NOT share a customer’s personal data with, or transfer it to, any third
            persons or entities, except that MLS PIN may share its customers’ names, contact
            telephone numbers and email addresses with, or transfer them to, a third party that
            provides an MLS PIN approved product or service to MLS PIN’s customers. MLS PIN
            will provide customers’ email addresses to a third party only if the product or
            service, as approved, cannot function without those email addresses and only if
            the email addresses are used by the third party solely to assure that function.
        </p>
        <p>
