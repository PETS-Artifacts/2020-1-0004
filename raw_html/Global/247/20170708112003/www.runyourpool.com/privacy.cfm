...
<html lang="en">
  <head>
    ...
    <link href="/assets/themes/paperclip/css/main.css?r=6" rel="stylesheet">
	...
	@media (min-width:992px) {
		.branding-custom.navbar-default {background-color: #1f5f3b !important}
		.branding-custom.navbar-default .navbar-nav>li>a:focus, .branding-custom.navbar-default .navbar-nav>li>a:hover,.branding-custom.navbar-default .navbar-nav > li > a {color:#ffffff;}
	}
	@media (max-width:992px) {
	.branding-custom .navbar-header {background-color: #1f5f3b !important}
	}
	
	.navbar-default .navbar-toggle {border-color:#bbb;background-color:#fff}
	#leagueName {color:#ffffff !important;}
  ...
  <body>
    <!-- Navigation -->
    <div class="navbar navbar-default navbar-fixed-top branding-standard" role="navigation">
      <div class="container">
        <div class="navbar-header">
		  <div class="logo-container">
			  <a class="navbar-brand" href="https://www.runyourpool.com"><img src="//www.runyourpool.com/images/RYPLogos/logo_white.png" alt="..."></a>
		  </div>
    ...
    <footer>
		...
		<div class="container">
			<div id="footerMain">
				...
				<br /><br />
				Copyright &#169; 2004-2017 RYP Technologies, LLC<br />
