...
<div class="col-sm-6 col-nopadding"><a href="https://www.xump.com/science/toys-gifts-sale-2018.cfm"><img src="https://www.xump.com/images/ToysGiftsSale2018A.png" alt="Toys and Gifts Sale 2018" title="Toys and Gifts Sale 2018" border="0" class="img-responsive"></a></div>

<div class="col-sm-6 col-nopadding"><a href="https://www.xump.com/science/toys-gifts-sale-2018.cfm"><img src="https://www.xump.com/images/ToysGiftsSale2018B.png" alt="Educational Science Sale 2018" title="Educational Science Sale 2018" border="0" class="img-responsive"></a></div>
...
'The mathematician's patterns, like the painter's or the poets, must be beautiful; the ideas, like the colours or the words, must fit together in a harmonious way. Beauty is the first test: there is no permanent place in the world for ugly mathematics.'<br><br><A HREF='http://en.wikipedia.org/wiki/Godfrey_Hardy' TARGET='_blank'><B>Godfrey Hardy</B></A><BR>(<I>1877-1947</I>)
                            ...
                            <div id="featured-owl" class="owl-carousel">
                                ...
                                <div class="item">
                                    <div class="featured-post">
                                        <a href="https://www.xump.com/science/MagneticGyroFlyWheel.cfm" class="news-image"><IMG SRC="https://www.xump.com/images/products/MagneticGyroFlyWheel-150A.jpg" ALT="Magnetic Gyro-Fly Wheel." title="Magnetic Gyro-Fly Wheel." BORDER="0" class="img-responsive"></a>
                                        <div class="post-text">                                            
                                            <h4>Magnetic Gyro-Fly Wheel</h4>
                                ...
                                <div class="item">
                                    <div class="featured-post">
                                        <a href="https://www.xump.com/science/NewtonsCradle.cfm" class="news-image"><IMG SRC="https://www.xump.com/images/products/NewtonsCradle-150A.jpg" ALT="Newtons Cradle - Large - 7 inches." title="Newtons Cradle - Large - 7 inches." BORDER="0" class="img-responsive"></a>
                                        <div class="post-text">                                            
                                            <h4>Newtons Cradle - Large - 7 inches</h4>
                                            <ul class="authar-info">
                                                <li>$19</li>                                            </ul>
                                        </div>
                                    </div>
                                ...
                                <div class="item">
                                    <div class="featured-post">
                                        <a href="https://www.xump.com/science/The-Original-Hoberman-Sphere.cfm" class="news-image"><IMG SRC="https://www.xump.com/images/products/The-Original-Hoberman-Sphere-150A.jpg" ALT="The Original Hoberman Sphere." title="The Original Hoberman Sphere." BORDER="0" class="img-responsive"></a>
                                        <div class="post-text">                                            
                                            <h4>The Original Hoberman Sphere</h4>
                                            <ul class="authar-info">
                                                <li>$37.99</li>                                            </ul>
                                        </div>
                                    </div>
                                ...
                                <div class="item">
                                    <div class="featured-post">
                                        <a href="https://www.xump.com/science/Periodic-Table-Reference-Card.cfm" class="news-image"><IMG SRC="https://www.xump.com/images/products/Periodic-Table-Reference-Card-150A.jpg" ALT="Periodic Table Reference Cards - 10 pack." title="Periodic Table Reference Cards - 10 pack." BORDER="0" class="img-responsive"></a>
                                        <div class="post-text">                                            
                                            <h4>Periodic Table Reference Cards - 10 pack</h4>
                                            <ul class="authar-info">
                                                <li>$2.99</li>                                            </ul>
                                        </div>
                                    </div>
                                ...
                                <div class="item">
                                    <div class="featured-post">
                                        <a href="https://www.xump.com/science/Jr-Scientist-Mini-Electric-Guitar.cfm" class="news-image"><IMG SRC="https://www.xump.com/images/products/Jr-Scientist-Mini-Electric-Guitar-150A.jpg" ALT="Jr. Scientist Mini Electric Guitar Kit." title="Jr. Scientist Mini Electric Guitar Kit." BORDER="0" class="img-responsive"></a>
                                        <div class="post-text">                                            
                                            <h4>Jr. Scientist Mini Electric Guitar Kit</h4>
                                            <ul class="authar-info">
                                                <li>$49</li>                                            </ul>
                                        </div>
                                    </div>
                                ...
                                <div class="item">
                                    <div class="featured-post">
                                        <a href="https://www.xump.com/science/TK-Candy-Chemistry-Kit.cfm" class="news-image"><IMG SRC="https://www.xump.com/images/products/TK-Candy-Chemistry-Kit-150A.jpg" ALT="Candy Chemistry Kit ." title="Candy Chemistry Kit ." BORDER="0" class="img-responsive"></a>
                                        <div class="post-text">                                            
                                            <h4>Candy Chemistry Kit </h4>
                                            <ul class="authar-info">
                                                <li>$31</li>                                            </ul>
                                        </div>
                                    </div>
                                ...
                                <div class="item">
                                    <div class="featured-post">
                                        <a href="https://www.xump.com/science/Continuous-Movement-Kaleidoscope.cfm" class="news-image"><IMG SRC="https://www.xump.com/images/products/Continuous-Movement-Kaleidoscope-150A.jpg" ALT="Blue Magic Wand Kaleidoscope." title="Blue Magic Wand Kaleidoscope." BORDER="0" class="img-responsive"></a>
                                        <div class="post-text">                                            
                                            <h4>Blue Magic Wand Kaleidoscope</h4>
                                            <ul class="authar-info">
                                                <li>$12</li>                                            </ul>
                                        </div>
                                    </div>
                    ...
                    <div class="col-sm-4 footer-box">
						<div class="about-inner">
                            ...
                            <ul>
                                ...
                                <li><i class="ti-mobile"></i>562-492-9560</li>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-xs-12 col-sm-5 col-md-5">
                        <div class="copy">&copy; Copyright 1995-2018 PhysLink.com</div>
                    </div>
