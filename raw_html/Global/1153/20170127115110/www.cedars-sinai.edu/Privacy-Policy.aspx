...
<html lang="en">
  ...
  <body>
<!-- Google Tag Manager -->
<noscript><iframe src="//www.googletagmanager.com/ns.html?id=GTM-BQDX&gtm_auth=JWJ4p6LbW5PFAyopW6U_Ng&gtm_preview=env-181&gtm_cookies_win=x"
height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
<script>(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':
new Date().getTime(),event:'gtm.js'});var f=d.getElementsByTagName(s)[0],
j=d.createElement(s),dl=l!='dataLayer'?'&l='+l:'';j.async=true;j.src=
'//www.googletagmanager.com/gtm.js?id='+i+dl+'&gtm_auth=JWJ4p6LbW5PFAyopW6U_Ng&gtm_preview=env-181&gtm_cookies_win=x';f.parentNode.insertBefore(j,f);
		...
		<div class="header__search">
			<ul class="header__search-wrap mobile-nav--link-spacing">
				<li class="header__search-field">
					<form name="gs" method="get" id="suggestion_form" action="https://esdsearchweb1.csmc.edu/search" onsubmit="return (this.q.value == '') ? false : true;">
