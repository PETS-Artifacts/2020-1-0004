...
<br/>
2.2	Usage & log data
When you use the Service, we automatically collect certain information, including: (i) information about your type of subscription and your interactions with the Service, including with advertising, products and services which are offered, linked to or made available on the Service; (ii) the details of the queries you make; (iii) technical data, which may include the URL you are coming from, your IP address, unique device ID, network and computer performance, browser type, language and identifying information, transactional information enabling digital rights management, and operating system; and (iv) location information. If you have connected your account to Google, we may receive similar information related to your interactions with the Service on Google. We may store this information so that it can be used for the purposes explained in Section 3.
<br/>
2.3	Other Services
You may integrate your MTGprice account with third party services besides Google (“Other Integrated Services”). If you do, we may receive, use and share the categories of information described above, including information made publically available on or through your account of such Other Integrated Service, in accordance with this Privacy Policy.
<br/>
2.4	Payment data
...
A cookie is a small text file that resides on your computer, mobile phone, or other device, and allows us or our business partners to recognize your device when you return to the Service. We may use cookies to perform functions essential to the operation of the Service, track site usage and trends, provide advertising on the Service, and improve and customize your MTGprice experience. We may also allow certain business partners to place or recognize cookies for those purposes. Learn more about how we use cookies and other similar standard Internet technologies at the bottom of this Privacy Policy.

<h3>3.	How we use the information we collect</h3>
We may use the information we collect, including your personal information, to: (i) provide, personalize, and improve your experience with the Service and products and services made available through the Service, for example by providing customized or localized content and advertising; (ii) ensure technical functioning of the Service and products and services made available through the Service, develop new products and services, and analyze your use of the Service, including your interaction with applications, advertising, products and services that are made available, linked to or offered in the Service; (iii) communicate with you for Service-related purposes, including promotional e-mails or messages; (iv) enable and promote the Service, including features and content of the Service and products and services made available through the Service, such as sharing, user interactions, notifications and suggestions, and integration with third party services; (v) enforce this Privacy Policy, the Terms and Conditions of Use, and the Mobile Terms, including to protect the rights, property or safety of MTGprice, users or any other person and the copyright-protected content of the Service; and (vi) as otherwise stated in this Privacy Policy.
...
<br/>
4.1 Sharing with Google and other services
If you connect to MTGprice using Google or otherwise connect your MTGprice account to an Other Integrated Service, the default setting is generally that MTGprice automatically shares your activity and activity-related stories with that service. You understand that such information may be attributed to your account on Google or the Other Integrated Service and may be published on such service. See section 5 below to learn how you can disable sharing of information on Google and Other Integrated Services.
...
<br/>
4.2	Sharing with Third Party Applications
...
<br/>
4.3	Service providers and others
...
You can access and amend some of the information we keep on you through your settings. To learn more about the information we store about you, e-mail privacy@MTGprice.com. We will respond within a reasonable period of time upon verification of your identity.
...
We use cookies for four general purposes, as explained below:

 
<ul>
<li>Essential Operational - These cookies are necessary to allow us to operate the MTGprice Service as you have requested. For example, they let us recognize what type of subscriber you are and then provide you with services accordingly.</li>	   
<li>Performance	We use these cookies to analyze how the MTGprice Service is used or is performing. We use this information to maintain, operate and continually improve the MTGprice Service.</li>
<li>Functional	These cookies let us operate certain functions of the MTGprice Service in line with the choices you make. These cookies mean that when you come back to the MTGprice Service, we can provide you with our services as you have asked for them to be provided, such as knowing your username, remembering how you have customized our services and reminding you of music you have enjoyed.</li>	   
<li>Targeting/advertising	We use these cookies to serve you with advertisements through the MTGprice Service. Some advertisements may be relevant to you and your interests. These cookies may also help us and our business partners regulate the advertisements you receive and measure their effectiveness.</li>	 
</ul>
As above, our business partners may use their cookies on the MTGprice Service, for the same general purposes identified above. For more information about the use of cookies and how to block them, visit www.allaboutcookies.org, www.youronlinechoices.eu (Europe) or www.aboutads.info/choices/ (United States). Most web browsers also allow you to manage your cookie preferences.
<br/>You can set your browser to refuse cookies, or delete certain cookies. This may impair or prevent due functioning of the Service.
<br/>We may use standard Internet technologies similar to cookies like these:
<br/>Clear GIFs: We may use “clear GIFs” (aka “web bugs”), which are small image files that we embed into our e-mail newsletters, to learn whether you opened or forwarded the newsletter or clicked on any of the content. This information tells us about our newsletters’ effectiveness and helps us ensure that we’re delivering information that you find interesting.
<br/>HTML5 Local Storage: We use HTML5 local storage for frequency capping purposes and to provide you with relevant advertising. We do not use HTML5 local storage to collect any personal data or to track your activity on our websites.
<br/>
		...
		<div class="container">
			<div class="row">			
				...
				<div class="span3 footer-pad">
					...
					<div id="footer-blog-title" class="footer-blog"><a href="http://blog.mtgprice.com/2016/03/29/protrader-cube-watch-shadows-over-innistrad-edition/" class="footer-blog-image-link"><img src="http://s.mtgprice.com/images/unknown.png" style="height: 100%;"></a></div>
					<div id="footer-blog-summary" class="disp-inline"><strong><a href="http://blog.mtgprice.com/2016/03/29/protrader-cube-watch-shadows-over-innistrad-edition/" class="footer-blog-image">PROTRADER: Cube Watch, Shadows over Innistrad Edition (Part One)</a><br/>By: <a href="http://blog.mtgprice.com">Danny Brown</a></strong></div>
				</div><!-- /span -->
			</div><!-- /row -->
		</div>
	</div><!-- /pre-footer -->
