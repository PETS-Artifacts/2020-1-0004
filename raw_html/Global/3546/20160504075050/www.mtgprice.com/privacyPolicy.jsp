		...
		<div class="container">
			<div class="row">			
				...
				<div class="span3 footer-pad">
					...
					<div id="footer-blog-title" class="footer-blog"><a href="http://blog.mtgprice.com/2016/04/28/mtg-fast-finance-episode-15/" class="footer-blog-image-link"><img src="http://s.mtgprice.com/images/Travis%20Allen.jpg" style="height: 100%;"></a></div>
					<div id="footer-blog-summary" class="disp-inline"><strong><a href="http://blog.mtgprice.com/2016/04/28/mtg-fast-finance-episode-15/" class="footer-blog-image">MTG Fast Finance Episode 15</a><br/>By: <a href="http://blog.mtgprice.com/author/tallen">Travis Allen</a></strong></div>
				</div><!-- /span -->
			</div><!-- /row -->
		</div>
	</div><!-- /pre-footer -->
