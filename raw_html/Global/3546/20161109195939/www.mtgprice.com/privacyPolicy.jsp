...
<div id="footers" class="footer-wrap">
	<div id="pre-footer" style="height:270px">
		<div class="container">
			<div class="row">
				...
				<div class="span6 footer-pad right-border">
                    <div class="ad-tag" data-ad-name="sticky_mrec" data-ad-size="auto"></div>
                    <script>(deployads = window.deployads || []).push({});</script>
                </div><!-- /span -->
				<div class="span3 footer-pad">
					<h4>MTGFinance articles</h4>
					<div id="footer-blog-title" class="footer-blog"><a href="http://blog.mtgprice.com/2016/10/31/speculating-on-magic-cards-introducing-specscore/" class="footer-blog-image-link"><img src="http://s.mtgprice.com/images/James%20Chillcott.jpg" style="height: 100%;"></a></div>
					<div id="footer-blog-summary" class="disp-inline"><strong><a href="http://blog.mtgprice.com/2016/10/31/speculating-on-magic-cards-introducing-specscore/" class="footer-blog-image">Speculating on Magic Cards: Introducing SpecScore</a><br/>By: <a href="http://blog.mtgprice.com/author/jameschillcott">James Chillcott</a></strong></div>
				</div><!-- /span -->
			</div><!-- /row -->
		</div>
	</div><!-- /pre-footer -->
	...
	<div id="footer">
		<div class="container">
			<div class="row">
				<div class="span6">
					(c) 2016 Quantitative Methods, Inc. All Magic: the Gathering images and descriptions (c) Hasboro.
				</div> <!-- /span6 -->				
