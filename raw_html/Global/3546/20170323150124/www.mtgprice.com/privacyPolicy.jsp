		...
		<div class="container">
			<div class="row">
				...
				<div class="span3 footer-pad">
					...
					<div id="footer-blog-title" class="footer-blog"><a href="http://blog.mtgprice.com/2017/03/13/protrader-the-watchtower-31317/" class="footer-blog-image-link"><img src="https://s.mtgprice.com/images/Travis%20Allen.jpg" style="height: 100%;"></a></div>
					<div id="footer-blog-summary" class="disp-inline"><strong><a href="http://blog.mtgprice.com/2017/03/13/protrader-the-watchtower-31317/" class="footer-blog-image">The Watchtower 3/13/17</a><br/>By: <a href="https://blog.mtgprice.com/author/tallen">Travis Allen</a></strong></div>
				</div><!-- /span -->
			</div><!-- /row -->
		</div>
	</div><!-- /pre-footer -->
