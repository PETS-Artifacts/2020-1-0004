		...
		<div class="container">
			<div class="row">
				...
				<div class="span3 footer-pad">
					...
					<div id="footer-blog-title" class="footer-blog"><a href="http://blog.mtgprice.com/2017/01/20/protrader-week-1-plans/" class="footer-blog-image-link"><img src="https://s.mtgprice.com/images/unknown.png" style="height: 100%;"></a></div>
					<div id="footer-blog-summary" class="disp-inline"><strong><a href="http://blog.mtgprice.com/2017/01/20/protrader-week-1-plans/" class="footer-blog-image">PROTRADER: Week 1 Plans</a><br/>By: <a href="https://blog.mtgprice.com">Ross Lennon</a></strong></div>
				</div><!-- /span -->
			</div><!-- /row -->
		</div>
	</div><!-- /pre-footer -->
