		...
		<div class="container">
			<div class="row">			
				...
				<div class="span3 footer-pad">
					...
					<div id="footer-blog-title" class="footer-blog"><a href="http://blog.mtgprice.com/2016/03/01/protrader-checking-in-with-planeswalkers/" class="footer-blog-image-link"><img src="http://s.mtgprice.com/images/unknown.png" style="height: 100%;"></a></div>
					<div id="footer-blog-summary" class="disp-inline"><strong><a href="http://blog.mtgprice.com/2016/03/01/protrader-checking-in-with-planeswalkers/" class="footer-blog-image">PROTRADER: Checking in with Planeswalkers</a><br/>By: <a href="http://blog.mtgprice.com">Danny Brown</a></strong></div>
				</div><!-- /span -->
			</div><!-- /row -->
		</div>
	</div><!-- /pre-footer -->
